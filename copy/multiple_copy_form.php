...
function Fill_Value_Of_Version_Number_Field_For_Searching_In_Table(new_pp_number)
{
    ...
    $.ajax({
	 		...
	 		{   
	 			...
	 			$.ajax({
			 		url: 'copy/returning_pp_number.php',
			 		dataType: 'text',
			 		type: 'post',
			 		contentType: 'application/x-www-form-urlencoded',
			 		data: customer_data,
...
function search_pp_with_design(design)
{
	// alert(design);
	//alert(pp_number_for_searching);+
	var value_for_data= 'design='+encodeURIComponent(design);
...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
				...
				<div class="panel-heading" style="color:#191970;"><b>Copy Standard & Process</b></div> <!-- This will create a upper block for FORM (Just Beautification) -->
