...
$lab_approval_date =$splitted_data[0];
...
$inspection_report_for_folding = $_POST['inspection_report_for_folding'];
$folding_quantity = $_POST['folding_quantity'];
$rejected_quantity = $_POST['rejected_quantity'];
$reworkable_quantity = $_POST['reworkable_quantity'];
$remark_for_folding = $_POST['remark_for_folding'];
...
$select_sql_for_duplicacy="select * from `inspection_and_folding` WHERE 
...
{
    $insert_sql_statement="insert into inspection_and_folding 
    (
            `trf_no`,`pp_number`,`shift`,`week_in_year`,`customer_name`,`design_name`,`version_number`,`style_name`,
            `color`,`construction_name`,`process_name`, `before_trolley_number`, `trolly_number`,`finish_width`,`quantity`,inspection_report_status,
            folding_quantity,rejected_quantity,reworkable_quantity,`remarks`,
        ...
        values (
            ...
            '$color','$construction_name','$process_name','$before_trolley_number', '$trolly_number','$finish_width_in_inch','$quantity',
            '$inspection_report_for_folding','$folding_quantity','$rejected_quantity','$reworkable_quantity',
            '$remark_for_folding','$user_id','$user_name', NOW())";
