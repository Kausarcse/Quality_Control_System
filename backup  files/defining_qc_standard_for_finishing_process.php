...
<div id="div_color_fastness_to_washing" style="display: none">
     ...
     <div class="form-group form-group-sm">
    			...
    			<div class="col-sm-3 text-center">
    				 <label class="control-label" for="cf_to_washing_color_change_value" style="color:#00008B;"> Color Fastness to Washing <span id="cf_to_washing_color_change_test_method">(ISO 105 C6)</span>
    				 </label>
    			</div>
