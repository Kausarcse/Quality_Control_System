...
// $sql_qc_sanforizing="select id from qc_result_for_sanforizing_process where pp_number = '$trf_pp_number'";
// $res_sql_qc_sanforizing=mysqli_query($con,$sql_qc_sanforizing) or die(mysqli_error($con));
// $row_for_id=mysqli_fetch_assoc($res_sql_qc_sanforizing);

// $sanforizing_id = $row_for_id['id'];


$sql_for_sanforizing="select * from qc_result_for_sanforizing_process where pp_number = '$trf_pp_number' and 
...
$row_for_sanforizing = mysqli_fetch_array( $result_for_sanforizing);
...
<script type='text/javascript' src='process_qc_result/qc_result_for_sanforizing_process_form_validation.js'></script>
...
{   
	var db_table_name="defining_qc_standard_for_sanforizing_process";
...
*/  
 ...
 function sending_data_of_qc_result_for_sanforizing_process_form_for_saving_in_database()
 {


       var validate = Sanforizing_Form_Validation();
       var url_encoded_form_data = $("#qc_result_for_sanforizing_process_form").serialize(); //This will read all control elements value of the form	
       if(validate != false)
	   {


		  	 $.ajax({
			 		url: 'process_qc_result/edit_qc_result_for_sanforizing_process_saving.php',
			 		dataType: 'text',
			 		type: 'post',
			 		contentType: 'application/x-www-form-urlencoded',
 ...
 }//End of function sending_data_of_qc_result_for_sanforizing_process_form_for_saving_in_database()
...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
			...
			<body id="target">
				...
				<div class="panel-heading" style="color:#191970;"><b>Qc Result For Sanforizing Process / <a href="#">Edit</a></b></div> <!-- This will create a upper block for FORM (Just Beautification) -->

				<form class="form-horizontal" action="" style="margin-top:10px;" name="qc_result_for_sanforizing_process_form" id="qc_result_for_sanforizing_process_form">
...
<div id="div_cf_to_rubbing" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_rubbing_dry_value" name="cf_to_rubbing_dry_value" value="<?php echo $row_for_sanforizing['cf_to_rubbing_dry_value'] ?>"  style="color:#00008B; margin-top:23px;">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_rubbing_wet_value" name="cf_to_rubbing_wet_value" value="<?php echo $row_for_sanforizing['cf_to_rubbing_wet_value'] ?>">
 ...
 <div id="div_dimensional_stability_to_washing" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="dimensional_stability_to_warp_washing_before_iron_value" name="dimensional_stability_to_warp_washing_before_iron_value" value="<?php echo $row_for_sanforizing['dimensional_stability_to_warp_washing_before_iron_value'] ?>"   style="color:#00008B; margin-top:23px;">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="dimensional_stability_to_weft_washing_before_iron_value" name="dimensional_stability_to_weft_washing_before_iron_value" value="<?php echo $row_for_sanforizing['dimensional_stability_to_weft_washing_before_iron_value'] ?>">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="dimensional_stability_to_warp_washing_after_iron_value" name="dimensional_stability_to_warp_washing_after_iron_value"  value="<?php echo $row_for_sanforizing['dimensional_stability_to_warp_washing_after_iron_value'] ?>"   style="color:#00008B; margin-top:23px;">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="dimensional_stability_to_weft_washing_after_iron_value" name="dimensional_stability_to_weft_washing_after_iron_value" value="<?php echo $row_for_sanforizing['dimensional_stability_to_weft_washing_after_iron_value'] ?>">
...
<div id="div_yarn_count" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="warp_yarn_count_value" name="warp_yarn_count_value" value="<?php echo $row_for_sanforizing['warp_yarn_count_value'] ?>"   style="color:#00008B; margin-top:23px;">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="weft_yarn_count_value" name="weft_yarn_count_value" value="<?php echo $row_for_sanforizing['weft_yarn_count_value'] ?>">
  ...
  <div id="div_no_of_threads" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="no_of_threads_in_warp_value" name="no_of_threads_in_warp_value" value="<?php echo $row_for_sanforizing['no_of_threads_in_warp_value'] ?>"   style="color:#00008B; margin-top:23px;">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="no_of_threads_in_weft_value" name="no_of_threads_in_weft_value" value="<?php echo $row_for_sanforizing['no_of_threads_in_weft_value'] ?>">
...
<div id="div_mass_per_unit_area" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="mass_per_unit_per_area_value" name="mass_per_unit_per_area_value" value="<?php echo $row_for_sanforizing['mass_per_unit_per_area_value'] ?>"   style="color:#00008B; margin-top:23px;">
...
<div id="div_resistance_to_surface_fuzzing_and_pilling" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="surface_fuzzing_and_pilling_value" name="surface_fuzzing_and_pilling_value" value="<?php echo $row_for_sanforizing['surface_fuzzing_and_pilling_value'] ?>"    style="color:#00008B; margin-top:23px;">
...
<div id="div_tensile_properties" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="tensile_properties_in_warp_value" name="tensile_properties_in_warp_value" value="<?php echo $row_for_sanforizing['tensile_properties_in_warp_value'] ?>"   style="color:#00008B; margin-top:23px;">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="tensile_properties_in_weft_value" name="tensile_properties_in_weft_value" value="<?php echo $row_for_sanforizing['tensile_properties_in_weft_value'] ?>">
  ...
  <div id="div_tear_force" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="tear_force_in_warp_value" name="tear_force_in_warp_value" value="<?php echo $row_for_sanforizing['tear_force_in_warp_value'] ?>"   style="color:#00008B; margin-top:23px;">
...
<div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="tear_force_in_weft_value" name="tear_force_in_weft_value" value="<?php echo $row_for_sanforizing['tear_force_in_weft_value'] ?>">
 ...
 <div id="div_seam_slippage" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="seam_slippage_resistance_in_warp_value" name="seam_slippage_resistance_in_warp_value" value="<?php echo $row_for_sanforizing['seam_slippage_resistance_in_warp_value'] ?>"   style="color:#00008B; margin-top:23px;">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="seam_slippage_resistance_in_weft_value" name="seam_slippage_resistance_in_weft_value" value="<?php echo $row_for_sanforizing['seam_slippage_resistance_in_weft_value'] ?>">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="seam_slippage_resistance_iso_2_in_warp_value" name="seam_slippage_resistance_iso_2_in_warp_value" value="<?php echo $row_for_sanforizing['seam_slippage_resistance_iso_2_in_warp_value'] ?>"   style="color:#00008B; margin-top:23px;">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="seam_slippage_resistance_iso_2_in_weft_value" name="seam_slippage_resistance_iso_2_in_weft_value" value="<?php echo $row_for_sanforizing['seam_slippage_resistance_iso_2_in_weft_value'] ?>">
...
<div id="div_seam_strength" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="seam_strength_in_warp_value" name="seam_strength_in_warp_value" value="<?php echo $row_for_sanforizing['seam_strength_in_warp_value'] ?>"   style="color:#00008B; margin-top:23px;">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="seam_strength_in_weft_value" name="seam_strength_in_weft_value" value="<?php echo $row_for_sanforizing['seam_strength_in_weft_value'] ?>">
...
<div id="div_seam_properties" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="seam_properties_seam_slippage_iso_astm_d_in_warp_value" name="seam_properties_seam_slippage_iso_astm_d_in_warp_value" value="<?php echo $row_for_sanforizing['seam_properties_seam_slippage_iso_astm_d_in_warp_value'] ?>"   style="color:#00008B; margin-top:23px;">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="seam_properties_seam_slippage_iso_astm_d_in_weft_value" name="seam_properties_seam_slippage_iso_astm_d_in_weft_value" value="<?php echo $row_for_sanforizing['seam_properties_seam_slippage_iso_astm_d_in_weft_value'] ?>">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="seam_properties_seam_strength_iso_astm_d_in_warp_value" name="seam_properties_seam_strength_iso_astm_d_in_warp_value" value="<?php echo $row_for_sanforizing['seam_properties_seam_strength_iso_astm_d_in_warp_value'] ?>"   style="color:#00008B; margin-top:23px;">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="seam_properties_seam_strength_iso_astm_d_in_weft_value" name="seam_properties_seam_strength_iso_astm_d_in_weft_value" value="<?php echo $row_for_sanforizing['seam_properties_seam_strength_iso_astm_d_in_weft_value'] ?>">
            ...
            <input type="hidden" id="uom_of_seam_properties_seam_strength_iso_astm_d_in_weft" name="uom_of_seam_properties_seam_strength_iso_astm_d_in_weft"  value="uom_of_seam_properties_seam_strength_iso_astm_d_in_weft">
                        ...
                        <div class="form-group form-group-sm" id="form-group_for_hand_feel">
				            <label class="control-label col-sm-3" for="hand_feel" style="margin-right:15px;color:#00008B;">Hand Feel:</label>
				                <input type="radio" class="form-check-input"  value="OK" id="hand_feel" name="hand_feel" <?php if($row_for_sanforizing['hand_feel']=="OK"){ echo "checked";}?>>
				                <label class="form-check-label control-label" for="hand_feel" style="margin-right:15px;">OK</label>
				                <input type="radio" class="form-check-input"  value="Not OK" id="hand_feel" name="hand_feel" <?php if($row_for_sanforizing['hand_feel']=="Not OK"){ echo "checked";}?>>
						...
						<label class="control-label col-sm-3" for="status" style="margin-right:15px;color:#00008B;">Status:</label>
								<input type="radio" class="form-check-input"  value="OK" id="status" name="status" <?php if($row_for_sanforizing['status']=="OK"){ echo "checked";}?>>
								<label class="form-check-label control-label" for="status" style="margin-right:15px;">OK</label>
								<input type="radio" class="form-check-input"  value="Not OK" id="status" name="status" <?php if($row_for_sanforizing['status']=="Not OK"){ echo "checked";}?>>
						...
						<div class="form-group form-group-sm" id="form-group_for_remarks">
								...
								<div class="col-sm-6">
									<textarea class='form-control' id='remarks' name='remarks' rows='5' value="<?php echo $row_for_sanforizing['remarks'] ?>"><?php echo $row_for_sanforizing['remarks'] ?></textarea>
								</div>
						...
						<label class="control-label col-sm-3" for="current_state" style="margin-right:15px;color:#00008B;">NOTE(IS IT A LAST PROCESS):</label>
								<input type="radio" class="form-check-input"  value="PP Completed" id="current_state" name="current_state" <?php if($row_for_sanforizing['current_state']=="PP Completed"){ echo "checked";}?>>
								<label class="form-check-label control-label" for="current_state" style="margin-right:15px;">Yes</label>
								<input type="radio" class="form-check-input"  value="PP in progress" id="current_state" name="current_state" <?php if($row_for_sanforizing['current_state']=="PP in progress"){ echo "checked";}?>>
						...
						<div class="form-group form-group-sm">
								<div class="col-sm-offset-3 col-sm-6">
									<button type="button" class="btn btn-primary" onClick="sending_data_of_qc_result_for_sanforizing_process_form_for_saving_in_database()">Save</button>
