...
// $sql_qc_desizing="select id from qc_result_for_desizing_process where pp_number = '$trf_pp_number'";
// $res_sql_qc_desizing=mysqli_query($con,$sql_qc_desizing) or die(mysqli_error($con));
// $row_for_id=mysqli_fetch_assoc($res_sql_qc_desizing);

// $desizing_id = $row_for_id['id'];


$sql_for_desizing="select * from qc_result_for_desizing_process where pp_number = '$trf_pp_number' and 
...
//  echo $row_for_desizing['id'];
//  echo $row_for_desizing['pp_number'];

?>


<script type='text/javascript' src='process_qc_result/qc_result_for_desizing_process_form_validation.js'></script>
...
{   
	var db_table_name="defining_qc_standard_for_desizing_process";
...
*/  
 ...
 function sending_data_of_qc_result_for_desizing_process_form_for_saving_in_database()
 {


       var validate = Desizing_Form_Validation();
       var url_encoded_form_data = $("#qc_result_for_desizing_process_form").serialize(); //This will read all control elements value of the form	
       if(validate != false)
	   {


		  	 $.ajax({
			 		url: 'process_qc_result/edit_qc_result_for_desizing_process_saving.php',
			 		dataType: 'text',
			 		type: 'post',
			 		contentType: 'application/x-www-form-urlencoded',
 ...
 }//End of function sending_data_of_qc_result_for_desizing_process_form_for_saving_in_database()
...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
			...
			<body id="target">
				...
				<div class="panel-heading" style="color:#191970;"><b>Qc Result For Desizing Process / <a href="#">Edit</a></b></div> <!-- This will create a upper block for FORM (Just Beautification) -->

				<form class="form-horizontal" action="" style="margin-top:10px;" name="qc_result_for_desizing_process_form" id="qc_result_for_desizing_process_form">
      ...
      <div class="form-group form-group-sm" id="form-group_for_machine_speed_value">
         ...
         <div class="col-sm-2 text-center">
            ...
            <div class="col-sm-2 text-center">
             ...
             <input type="text" class="form-control" id="machine_speed" name="machine_speed" value="<?php echo $row_for_desizing['machine_speed']?>" required>
      ...
      <div class="form-group form-group-sm" id="form-group_for_bath_temperature_value">
         ...
         <div class="col-sm-2 text-center">
            ...
            <div class="col-sm-2 text-center">
             ...
             <input type="text" class="form-control" id="bath_temperature" name="bath_temperature" value="<?php echo $row_for_desizing['bath_temperature']?>" required>
 ...
 <div id="div_bath_ph">  <!-- start of <div id="div_bath_ph"> -->
						...
						<div class="form-group form-group-sm" id="form-group_for_bath_ph">
								...
								<div class="col-sm-2" style="padding-right:4px;">
									<input type="text" class="form-control" id="bath_ph" name="bath_ph" value="<?php echo $row_for_desizing['bath_ph']?>" required>
								</div>
						...
						<label class="control-label col-sm-3" for="status" style="margin-right:15px;color:#00008B;">Status:</label>
								<input type="radio" class="form-check-input"  value="OK" id="status" name="status" <?php if($row_for_desizing['status']=="OK"){ echo "checked";}?>>
								<label class="form-check-label control-label" for="status" style="margin-right:15px;">OK</label>
								<input type="radio" class="form-check-input"  value="Not OK" id="status" name="status" <?php if($row_for_desizing['status']=="Not OK"){ echo "checked";}?>>
							...
							<div class="form-group form-group-sm" id="form-group_for_remarks">
								...
								<div class="col-sm-5">
									<textarea class='form-control' id='remarks' name='remarks' rows='5' value="<?php echo $row_for_desizing['remarks']?>"><?php echo $row_for_desizing['remarks']?></textarea>
								</div>
						...
						<div class="form-group form-group-sm" id="form-group_for_current_state">
						   <label class="control-label col-sm-3" for="current_state" style="margin-right:15px;color:#00008B;">NOTE(IS IT A LAST PROCESS):</label>
								<input type="radio" class="form-check-input"  value="PP Completed" id="current_state" name="current_state" <?php if($row_for_desizing['current_state']=="PP Completed"){ echo "checked";}?>>
								<label class="form-check-label control-label" for="current_state" style="margin-right:15px;">Yes</label>
								<input type="radio" class="form-check-input"  value="PP in progress" id="current_state" name="current_state" <?php if($row_for_desizing['current_state']=="PP in progress"){ echo "checked";}?>>
						...
						<div class="form-group form-group-sm">
								<div class="col-sm-offset-3 col-sm-5">
									<button type="button" class="btn btn-primary" onClick="sending_data_of_qc_result_for_desizing_process_form_for_saving_in_database()">Save</button>
