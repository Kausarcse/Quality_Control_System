...
//  echo $sql_qc_finishing="select id from qc_result_for_finishing_process where pp_number = '$trf_pp_number' and 
...
//  $res_sql_qc_finishing=mysqli_query($con,$sql_qc_finishing) or die(mysqli_error($con));
//  $row_for_id=mysqli_fetch_assoc($res_sql_qc_finishing);

// $finishing_id = $row_for_id['id'];


 $sql_for_finishing="select * from qc_result_for_finishing_process where pp_number = '$trf_pp_number' and 
standard_for_which_process = '$trf_process_name' and version_number = '$trf_version_name' and color = '$trf_color' and 
finish_width_in_inch = '$trf_finish_width_in_inch'";
$result_for_finishing= mysqli_query($con,$sql_for_finishing) or die(mysqli_error($con));
$row_for_finishing = mysqli_fetch_array( $result_for_finishing);
...
<script type='text/javascript' src='process_qc_result/qc_result_for_finishing_process_form_validation.js'></script>
...
{   
	var db_table_name="defining_qc_standard_for_finishing_process";
...
*/  
 ...
 function sending_data_of_qc_result_for_finishing_process_form_for_saving_in_database()
 {


       var validate = Finishing_Form_Validation();
       var url_encoded_form_data = $("#qc_result_for_finishing_process_form").serialize(); //This will read all control elements value of the form	
       if(validate != false)
	   {

		  	 $.ajax({
			 		url: 'process_qc_result/edit_qc_result_for_finishing_process_saving.php',
			 		dataType: 'text',
			 		type: 'post',
			 		contentType: 'application/x-www-form-urlencoded',
 ...
 }//End of function sending_data_of_qc_result_for_finishing_process_form_for_saving_in_database()
...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
			<body id="target">
				...
				<div class="panel-heading" style="color:#191970;"><b>Qc Result For Finishing Process / <a href="#">Edit</a></b></div> <!-- This will create a upper block for FORM (Just Beautification) -->

				<form class="form-horizontal" action="" style="margin-top:10px;" name="qc_result_for_finishing_process_form" id="qc_result_for_finishing_process_form">
...
<div id="div_cf_to_rubbing" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_rubbing_dry_value" name="cf_to_rubbing_dry_value" value="<?php echo $row_for_finishing['cf_to_rubbing_dry_value']?>"  style="color:#00008B; margin-top:23px;">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_rubbing_wet_value" name="cf_to_rubbing_wet_value" value="<?php echo $row_for_finishing['cf_to_rubbing_wet_value']?>">
...
<div id="div_dimensional_stability_to_washing" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="dimensional_stability_to_warp_washing_before_iron_value" name="dimensional_stability_to_warp_washing_before_iron_value" value="<?php echo $row_for_finishing['dimensional_stability_to_warp_washing_before_iron_value']?>"   style="color:#00008B; margin-top:23px;">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="dimensional_stability_to_weft_washing_before_iron_value" name="dimensional_stability_to_weft_washing_before_iron_value" value="<?php echo $row_for_finishing['dimensional_stability_to_weft_washing_before_iron_value']?>" >
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="dimensional_stability_to_warp_washing_after_iron_value" name="dimensional_stability_to_warp_washing_after_iron_value" value="<?php echo $row_for_finishing['dimensional_stability_to_warp_washing_after_iron_value']?>"   style="color:#00008B; margin-top:23px;">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="dimensional_stability_to_weft_washing_after_iron_value" name="dimensional_stability_to_weft_washing_after_iron_value" value="<?php echo $row_for_finishing['dimensional_stability_to_weft_washing_after_iron_value']?>">
...
<div id="div_yarn_count"  style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="warp_yarn_count_value" name="warp_yarn_count_value" value="<?php echo $row_for_finishing['warp_yarn_count_value']?>"  style="color:#00008B; margin-top:23px;">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="weft_yarn_count_value" name="weft_yarn_count_value" value="<?php echo $row_for_finishing['weft_yarn_count_value']?>">
 ...
 <div id="div_no_of_threads" style="display: none;" >
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="no_of_threads_in_warp_value" name="no_of_threads_in_warp_value" value="<?php echo $row_for_finishing['no_of_threads_in_warp_value']?>"   style="color:#00008B; margin-top:23px;">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="no_of_threads_in_weft_value" name="no_of_threads_in_weft_value" value="<?php echo $row_for_finishing['no_of_threads_in_weft_value']?>">
 ...
 <div id="div_mass_per_unit_area" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="mass_per_unit_per_area_value" name="mass_per_unit_per_area_value" value="<?php echo $row_for_finishing['mass_per_unit_per_area_value']?>"   style="color:#00008B; margin-top:23px;">
...
<div id="div_resistance_to_surface_fuzzing_and_pilling" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="surface_fuzzing_and_pilling_value" name="surface_fuzzing_and_pilling_value" value="<?php echo $row_for_finishing['surface_fuzzing_and_pilling_value']?>"   style="color:#00008B; margin-top:23px;">
...
<div id="div_tensile_properties" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="tensile_properties_in_warp_value" name="tensile_properties_in_warp_value" value="<?php echo $row_for_finishing['tensile_properties_in_warp_value']?>"   style="color:#00008B; margin-top:23px;">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="tensile_properties_in_weft_value" name="tensile_properties_in_weft_value" value="<?php echo $row_for_finishing['tensile_properties_in_weft_value']?>">
 ...
 <div id="div_tear_force" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="tear_force_in_warp_value" name="tear_force_in_warp_value" value="<?php echo $row_for_finishing['tear_force_in_warp_value']?>"   style="color:#00008B; margin-top:23px;">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="tear_force_in_weft_value" name="tear_force_in_weft_value" value="<?php echo $row_for_finishing['tear_force_in_weft_value']?>" >
 ...
 <div id="div_seam_slippage" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="seam_slippage_resistance_in_warp_value" name="seam_slippage_resistance_in_warp_value" value="<?php echo $row_for_finishing['seam_slippage_resistance_in_warp_value']?>"   style="color:#00008B; margin-top:23px;">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="seam_slippage_resistance_in_weft_value" name="seam_slippage_resistance_in_weft_value"  value="<?php echo $row_for_finishing['seam_slippage_resistance_in_weft_value']?>">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="seam_slippage_resistance_iso_2_in_warp_value" name="seam_slippage_resistance_iso_2_in_warp_value" value="<?php echo $row_for_finishing['seam_slippage_resistance_iso_2_in_warp_value']?>"   style="color:#00008B; margin-top:23px;">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="seam_slippage_resistance_iso_2_in_weft_value" name="seam_slippage_resistance_iso_2_in_weft_value" value="<?php echo $row_for_finishing['seam_slippage_resistance_iso_2_in_weft_value']?>">
 ...
 <div id="div_seam_strength" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="seam_strength_in_warp_value" name="seam_strength_in_warp_value" value="<?php echo $row_for_finishing['seam_strength_in_warp_value']?>"   style="color:#00008B; margin-top:23px;">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="seam_strength_in_weft_value" name="seam_strength_in_weft_value" value="<?php echo $row_for_finishing['seam_strength_in_weft_value']?>">
 ...
 <div id="div_seam_properties" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="seam_properties_seam_slippage_iso_astm_d_in_warp_value" name="seam_properties_seam_slippage_iso_astm_d_in_warp_value" value="<?php echo $row_for_finishing['seam_properties_seam_slippage_iso_astm_d_in_warp_value']?>"   style="color:#00008B; margin-top:23px;">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="seam_properties_seam_slippage_iso_astm_d_in_weft_value" name="seam_properties_seam_slippage_iso_astm_d_in_weft_value" value="<?php echo $row_for_finishing['seam_properties_seam_slippage_iso_astm_d_in_weft_value']?>">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="seam_properties_seam_strength_iso_astm_d_in_warp_value" name="seam_properties_seam_strength_iso_astm_d_in_warp_value" value="<?php echo $row_for_finishing['seam_properties_seam_strength_iso_astm_d_in_warp_value']?>"   style="color:#00008B; margin-top:23px;">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="seam_properties_seam_strength_iso_astm_d_in_weft_value" name="seam_properties_seam_strength_iso_astm_d_in_weft_value" value="<?php echo $row_for_finishing['seam_properties_seam_strength_iso_astm_d_in_weft_value']?>">
 ...
 <div id="div_abrasion_resistance" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="abrasion_resistance_no_of_thread_break_value" name="abrasion_resistance_no_of_thread_break_value" value="<?php echo $row_for_finishing['abrasion_resistance_no_of_thread_break_value']?>"   style="color:#00008B; margin-top:23px;">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="abrasion_resistance_c_change_value" name="abrasion_resistance_c_change_value" value="<?php echo $row_for_finishing['abrasion_resistance_c_change_value']?>">
  ...
  <div id="div_mass_loss_in_abrasion" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="mass_loss_in_abrasion_value" name="mass_loss_in_abrasion_value" value="<?php echo $row_for_finishing['mass_loss_in_abrasion_value']?>"   style="color:#00008B; margin-top:23px;">
...
<div id="div_color_fastness_to_washing" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_washing_color_change_value" name="cf_to_washing_color_change_value" value="<?php echo $row_for_finishing['cf_to_washing_color_change_value']?>"   style="color:#00008B; margin-top:23px;">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_washing_staining_value" name="cf_to_washing_staining_value" value="<?php echo $row_for_finishing['cf_to_washing_staining_value']?>">
     ...
     <div class="form-group form-group-sm " for="value_for_cf_to_washing_staining">
            <div class="row" for="Acetate_for_staining">
                  ...
                  <div class="col-sm-2">
                        <input type='text' id='acetate_cf_washing' name='acetate_cf_washing' class='form-control ' value="<?php echo $row_for_finishing['cf_to_washing_staining_value_for_acetate']?>">
                  </div>
            </div>
            <div class=" row" for="Cottom_for_stating">
                  ...
                  <div class="col-sm-2">
                        <input type='text' id='cotton_cf_washing' name='cotton_cf_washing' class='form-control' value="<?php echo $row_for_finishing['cf_to_washing_staining_value_for_cotton']?>">
                  </div>
            </div>
            <div class=" row" for="Mylon_for_stating">
                  ...
                  <div class="col-sm-2">
                        <input type='text' id='mylon_cf_washing' name='mylon_cf_washing' class='form-control'  value="<?php echo $row_for_finishing['cf_to_washing_staining_value_for_mylon']?>"> 
                  </div>
            </div>
            <div class=" row" for="Polyester_for_stating">
                  ...
                  <div class="col-sm-2">
                        <input type='text' id='polyester_cf_washing'  name='polyester_cf_washing' class='form-control'  value="<?php echo $row_for_finishing['cf_to_washing_staining_value_for_polyester']?>"> 
                  </div>
            </div>
            <div class=" row" for="Acrylic_for_stating">
                  ...
                  <div class="col-sm-2">
                        <input type='text' id='acrylic_cf_washing' name='acrylic_cf_washing' class='form-control'  value="<?php echo $row_for_finishing['cf_to_washing_staining_value_for_acrylic']?>"> 
                  </div>
            </div>
            <div class=" row" for="Wool_for_stating">
                  ...
                  <div class="col-sm-2">
                        <input type='text' id='wool_cf_washing' name='wool_cf_washing' class='form-control'  value="<?php echo $row_for_finishing['cf_to_washing_staining_value_for_wool']?>"> 
                  </div>
            </div>
  ...
  <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_washing_cross_staining_value" name="cf_to_washing_cross_staining_value" value="<?php echo $row_for_finishing['cf_to_washing_cross_staining_value']?>">
 ...
 <div id="div_cf_to_dry_cleaning" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_dry_cleaning_color_change_value" name="cf_to_dry_cleaning_color_change_value" value="<?php echo $row_for_finishing['cf_to_dry_cleaning_color_change_value']?>"   style="color:#00008B; margin-top:23px;">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_dry_cleaning_staining_value" name="cf_to_dry_cleaning_staining_value" value="<?php echo $row_for_finishing['cf_to_dry_cleaning_staining_value']?>">
     ...
     <div class="form-group form-group-sm " for="value_for_cf_to_dry_cleaning_staining">
            <div class="row" for="Acetate_for_stating">
                  ...
                  <div class="col-sm-2">
                        <input type='text' id='acetate_cf_dry_cleaning' name='acetate_cf_dry_cleaning' class='form-control '  value="<?php echo $row_for_finishing['cf_to_dry_cleaning_staining_value_for_acetate']?>"> 
                  </div>
            </div>
            <div class=" row" for="Cottom_for_stating">
                  <div class=" col-sm-6">
                  ...
                  <div class="col-sm-2">
                        <input type='text' id='cotton_cf_dry_cleaning' name='cotton_cf_dry_cleaning' class='form-control'  value="<?php echo $row_for_finishing['cf_to_dry_cleaning_staining_value_for_cotton']?>">
                  </div>
            </div>
            <div class=" row" for="Mylon_for_stating">
                  <div class=" col-sm-6">
                  ...
                  <div class="col-sm-2">
                        <input type='text' id='mylon_cf_dry_cleaning' name='mylon_cf_dry_cleaning' class='form-control'   value="<?php echo $row_for_finishing['cf_to_dry_cleaning_staining_value_for_mylon']?>">
                  </div>
            </div>
            <div class=" row" for="Polyester_for_stating">
                  <div class=" col-sm-6">
                  ...
                  <div class="col-sm-2">
                        <input type='text' id='polyester_cf_dry_cleaning'  name='polyester_cf_dry_cleaning' class='form-control'  value="<?php echo $row_for_finishing['cf_to_dry_cleaning_staining_value_for_polyester']?>">
                  </div>
            </div>
            <div class=" row" for="Acrylic_for_stating">
                  <div class=" col-sm-6">
                  ...
                  <div class="col-sm-2">
                        <input type='text' id='acrylic_cf_dry_cleaning' name='acrylic_cf_dry_cleaning' class='form-control'   value="<?php echo $row_for_finishing['cf_to_dry_cleaning_staining_value_for_acrylic']?>">
                  </div>
            </div>
            <div class=" row" for="Wool_for_stating">
                  <div class=" col-sm-6">
                  ...
                  <div class="col-sm-2">
                        <input type='text' id='wool_cf_dry_cleaning' name='wool_cf_dry_cleaning' class='form-control'   value="<?php echo $row_for_finishing['cf_to_dry_cleaning_staining_value_for_wool']?>">
                  </div>
            </div>
 ...
 <div id="div_cf_to_perspiration_acid" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_perspiration_acid_color_change_value" name="cf_to_perspiration_acid_color_change_value" value="<?php echo $row_for_finishing['cf_to_perspiration_acid_color_change_value']?>"  style="color:#00008B; margin-top:23px;">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_perspiration_acid_staining_value" name="cf_to_perspiration_acid_staining_value" value="<?php echo $row_for_finishing['cf_to_perspiration_acid_staining_value']?>">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_perspiration_acid_cross_staining_value" name="cf_to_perspiration_acid_cross_staining_value" value="<?php echo $row_for_finishing['cf_to_perspiration_acid_cross_staining_value']?>">
     ...
     <div class="form-group form-group-sm " for="value_for_cf_to_cf_to_perspiration_acid_staining">
            <div class="row" for="Acetate_for_stating">
                  ...
                  <div class="col-sm-2">
                        <input type='text' id='acetate_cf_to_perspiration_acid' name='acetate_cf_to_perspiration_acid' class='form-control ' value="<?php echo $row_for_finishing['cf_to_perspiration_acid_staining_value_for_acetate']?>">
                  </div>
            </div>
            <div class=" row" for="Cottom_for_stating">
                  <div class=" col-sm-6">
                  ...
                  <div class="col-sm-2">
                        <input type='text' id='cotton_cf_to_perspiration_acid' name='cotton_cf_to_perspiration_acid' class='form-control' value="<?php echo $row_for_finishing['cf_to_perspiration_acid_staining_value_for_cotton']?>">
                  </div>
            </div>
            <div class=" row" for="Mylon_for_stating">
                  <div class=" col-sm-6">
                  ...
                  <div class="col-sm-2">
                        <input type='text' id='mylon_cf_to_perspiration_acid' name='mylon_cf_to_perspiration_acid' class='form-control'  value="<?php echo $row_for_finishing['cf_to_perspiration_acid_staining_value_for_mylon']?>">
                  </div>
            </div>
            <div class=" row" for="Polyester_for_stating">
                  <div class=" col-sm-6">
                  ...
                  <div class="col-sm-2">
                        <input type='text' id='polyester_cf_to_perspiration_acid'  name='polyester_cf_to_perspiration_acid' class='form-control'  value="<?php echo $row_for_finishing['cf_to_perspiration_acid_staining_value_for_polyester']?>">
                  </div>
            </div>
            <div class=" row" for="Acrylic_for_stating">
                  <div class=" col-sm-6">
                  ...
                  <div class="col-sm-2">
                        <input type='text' id='acrylic_cf_to_perspiration_acid' name='acrylic_cf_to_perspiration_acid' class='form-control'  value="<?php echo $row_for_finishing['cf_to_perspiration_acid_staining_value_for_acrylic']?>">
                  </div>
            </div>
            <div class=" row" for="Wool_for_stating">
                  <div class=" col-sm-6">
                  ...
                  <div class="col-sm-2">
                        <input type='text' id='wool_cf_to_perspiration_acid' name='wool_cf_to_perspiration_acid' class='form-control'  value="<?php echo $row_for_finishing['cf_to_perspiration_acid_staining_value_for_wool']?>">
                  </div>
            </div>
 ...
 <div id="div_cf_to_perspiration_alkali" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_perspiration_alkali_color_change_value" name="cf_to_perspiration_alkali_color_change_value" value="<?php echo $row_for_finishing['cf_to_perspiration_alkali_color_change_value']?>"  style="color:#00008B; margin-top:23px;" value="">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_perspiration_alkali_staining_value" name="cf_to_perspiration_alkali_staining_value" value="<?php echo $row_for_finishing['cf_to_perspiration_alkali_staining_value']?>">
     ...
     <div class="form-group form-group-sm " for="value_for_cf_to_cf_to_perspiration_alkali_staining">
            <div class="row" for="Acetate_for_stating">
                  ...
                  <div class="col-sm-2">
                        <input type='text' id='acetate_cf_to_perspiration_alkali' name='acetate_cf_to_perspiration_alkali' class='form-control ' value="<?php echo $row_for_finishing['cf_to_perspiration_alkali_staining_value_for_acetate']?>">
                  </div>
            </div>
            <div class=" row" for="Cottom_for_stating">
                  <div class=" col-sm-6">
                  ...
                  <div class="col-sm-2">
                        <input type='text' id='cotton_cf_to_perspiration_alkali' name='cotton_cf_to_perspiration_alkali' class='form-control' value="<?php echo $row_for_finishing['cf_to_perspiration_alkali_staining_value_for_cotton']?>">
                  </div>
            </div>
            <div class=" row" for="Mylon_for_stating">
                  <div class=" col-sm-6">
                  ...
                  <div class="col-sm-2">
                        <input type='text' id='mylon_cf_to_perspiration_alkali' name='mylon_cf_to_perspiration_alkali' class='form-control'  value="<?php echo $row_for_finishing['cf_to_perspiration_alkali_staining_value_for_mylon']?>">
                  </div>
            </div>
            <div class=" row" for="Polyester_for_stating">
                  <div class=" col-sm-6">
                  ...
                  <div class="col-sm-2">
                        <input type='text' id='polyester_cf_to_perspiration_alkali'  name='polyester_cf_to_perspiration_alkali' class='form-control'  value="<?php echo $row_for_finishing['cf_to_perspiration_alkali_staining_value_for_polyester']?>">
                  </div>
            </div>
            <div class=" row" for="Acrylic_for_stating">
                  <div class=" col-sm-6">
                  ...
                  <div class="col-sm-2">
                        <input type='text' id='acrylic_cf_to_perspiration_alkali' name='acrylic_cf_to_perspiration_alkali' class='form-control'  value="<?php echo $row_for_finishing['cf_to_perspiration_alkali_staining_value_for_acrylic']?>">
                  </div>
            </div>
            <div class=" row" for="Wool_for_stating">
                  <div class=" col-sm-6">
                  ...
                  <div class="col-sm-2">
                        <input type='text' id='wool_cf_to_perspiration_alkali' name='wool_cf_to_perspiration_alkali' class='form-control'  value="<?php echo $row_for_finishing['cf_to_perspiration_alkali_staining_value_for_wool']?>">
                  </div>
            </div>
	   ...
	   <div class="form-group form-group-sm">
	      ...
	      <div class="col-sm-2" for="value">
	            ...
	            <input type="text" class="form-control" id="cf_to_perspiration_alkali_cross_staining_value" name="cf_to_perspiration_alkali_cross_staining_value" value="<?php echo $row_for_finishing['cf_to_perspiration_alkali_cross_staining_value']?>">
 ...
 <div id="div_cf_to_water" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_water_color_change_value" name="cf_to_water_color_change_value"  value="<?php echo $row_for_finishing['cf_to_water_color_change_value']?>"   style="color:#00008B; margin-top:23px;">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_water_staining_value" name="cf_to_water_staining_value" value="<?php echo $row_for_finishing['cf_to_water_staining_value']?>">
     ...
     <div class="form-group form-group-sm " for="value_for_cf_to_water_staining">
            <div class="row" for="Acetate_for_stating">
                  ...
                  <div class="col-sm-2">
                        <input type='text' id='acetate_cf_to_water' name='acetate_cf_to_water' class='form-control 'value="<?php echo $row_for_finishing['cf_to_water_staining_value_for_acetate']?>"> 
                  </div>
            </div>
            <div class=" row" for="Cottom_for_stating">
                  <div class=" col-sm-6">
                  ...
                  <div class="col-sm-2">
                        <input type='text' id='cotton_cf_to_water' name='cotton_cf_to_water' class='form-control' value="<?php echo $row_for_finishing['cf_to_water_staining_value_for_cotton']?>"> 
                  </div>
            </div>
            <div class=" row" for="Mylon_for_stating">
                  <div class=" col-sm-6">
                  ...
                  <div class="col-sm-2">
                        <input type='text' id='mylon_cf_to_water' name='mylon_cf_to_water' class='form-control'  value="<?php echo $row_for_finishing['cf_to_water_staining_value_for_mylon']?>"> 
                  </div>
            </div>
            <div class=" row" for="Polyester_for_stating">
                  <div class=" col-sm-6">
                  ...
                  <div class="col-sm-2">
                        <input type='text' id='polyester_cf_to_water'  name='polyester_cf_to_water' class='form-control'  value="<?php echo $row_for_finishing['cf_to_water_staining_value_for_polyester']?>">
                  </div>
            </div>
            <div class=" row" for="Acrylic_for_stating">
                  <div class=" col-sm-6">
                  ...
                  <div class="col-sm-2">
                        <input type='text' id='acrylic_cf_to_water' name='acrylic_cf_to_water' class='form-control'  value="<?php echo $row_for_finishing['cf_to_water_staining_value_for_acrylic']?>">
                  </div>
            </div>
            <div class=" row" for="Wool_for_stating">
                  <div class=" col-sm-6">
                  ...
                  <div class="col-sm-2">
                        <input type='text' id='wool_cf_to_water' name='wool_cf_to_water' class='form-control'  value="<?php echo $row_for_finishing['cf_to_water_staining_value_for_wool']?>">
                  </div>
            </div>
	     ...
	     <div class="form-group form-group-sm">
	      ...
	      <div class="col-sm-2" for="value">
	            ...
	            <input type="text" class="form-control" id="cf_to_water_cross_staining_value" name="cf_to_water_cross_staining_value" value="<?php echo $row_for_finishing['cf_to_water_cross_staining_value']?>">
  ...
  <div id="div_color_fastness_to_water_spotting" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_water_spotting_surface_value" name="cf_to_water_spotting_surface_value" value="<?php echo $row_for_finishing['cf_to_water_spotting_surface_value']?>"   style="color:#00008B; margin-top:23px;">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_water_spotting_edge_value" name="cf_to_water_spotting_edge_value" value="<?php echo $row_for_finishing['cf_to_water_spotting_edge_value']?>">
    ...
    <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_water_spotting_cross_staining_value" name="cf_to_water_spotting_cross_staining_value" value="<?php echo $row_for_finishing['cf_to_water_spotting_cross_staining_value']?>">
  ...
  <div id="div_resistance_to_surface_wetting" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="resistance_to_surface_wetting_before_wash_value" name="resistance_to_surface_wetting_before_wash_value"  value="<?php echo $row_for_finishing['resistance_to_surface_wetting_before_wash_value']?>"   style="color:#00008B; margin-top:23px;">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="resistance_to_surface_wetting_after_one_wash_value" name="resistance_to_surface_wetting_after_one_wash_value"  value="<?php echo $row_for_finishing['resistance_to_surface_wetting_after_one_wash_value']?>">
     ...
     <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="resistance_to_surface_wetting_after_five_wash_value" name="resistance_to_surface_wetting_after_five_wash_value" value="<?php echo $row_for_finishing['resistance_to_surface_wetting_after_five_wash_value']?>">
  ...
  <div id="div_cf_to_hydrolysis_of_reactive_dyes" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_hydrolysis_of_reactive_dyes_color_change_value" name="cf_to_hydrolysis_of_reactive_dyes_color_change_value" value="<?php echo $row_for_finishing['cf_to_hydrolysis_of_reactive_dyes_color_change_value']?>"   style="color:#00008B; margin-top:23px;">
...
<div id="div_cf_to_oxidative_bleach_damage" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_oxidative_bleach_damage_color_change_value" name="cf_to_oxidative_bleach_damage_color_change_value" value="<?php echo $row_for_finishing['cf_to_oxidative_bleach_damage_color_change_value']?>"   style="color:#00008B; margin-top:23px;">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_oxidative_bleach_damage_value" name="cf_to_oxidative_bleach_damage_value" value="<?php echo $row_for_finishing['cf_to_oxidative_bleach_damage_value']?>">
  ...
  <div id="div_cf_to_phenolic_yellowing" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_phenolic_yellowing_staining_value" name="cf_to_phenolic_yellowing_staining_value" value="<?php echo $row_for_finishing['cf_to_phenolic_yellowing_staining_value']?>"   style="color:#00008B; margin-top:23px;">
...
<div id="div_migration_of_color_into_pvc" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_pvc_migration_staining_value" name="cf_to_pvc_migration_staining_value" value="<?php echo $row_for_finishing['cf_to_pvc_migration_staining_value']?>"  style="color:#00008B; margin-top:23px;">
...
<div id="div_cf_to_saliva_staining" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_saliva_color_change_value" name="cf_to_saliva_color_change_value" value="<?php echo $row_for_finishing['cf_to_saliva_color_change_value']?>"   style="color:#00008B; margin-top:23px;">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_saliva_staining_value" name="cf_to_saliva_staining_value" value="<?php echo $row_for_finishing['cf_to_saliva_staining_value']?>">
     ...
     <div class="form-group form-group-sm " for="value_for_cf_to_saliva_staining">
            <div class="row" for="Acetate_for_stating">
                  ...
                  <div class="col-sm-2">
                        <input type='text' id='acetate_cf_to_saliva' name='acetate_cf_to_saliva' class='form-control ' value="<?php echo $row_for_finishing['cf_to_saliva_staining_value_for_acetate']?>">
                  </div>
            </div>
            <div class=" row" for="Cottom_for_stating">
                  <div class=" col-sm-6">
                  ...
                  <div class="col-sm-2">
                        <input type='text' id='cotton_cf_to_saliva' name='cotton_cf_to_saliva' class='form-control' value="<?php echo $row_for_finishing['cf_to_saliva_staining_value_for_cotton']?>">
                  </div>
            </div>
            <div class=" row" for="Mylon_for_stating">
                  <div class=" col-sm-6">
                  ...
                  <div class="col-sm-2">
                        <input type='text' id='mylon_cf_to_saliva' name='mylon_cf_to_saliva' class='form-control'  value="<?php echo $row_for_finishing['cf_to_saliva_staining_value_for_mylon']?>">
                  </div>
            </div>
            <div class=" row" for="Polyester_for_stating">
                  <div class=" col-sm-6">
                  ...
                  <div class="col-sm-2">
                        <input type='text' id='polyester_cf_to_saliva'  name='polyester_cf_to_saliva' class='form-control'  value="<?php echo $row_for_finishing['cf_to_saliva_staining_value_for_polyester']?>">
                  </div>
            </div>
            <div class=" row" for="Acrylic_for_stating">
                  <div class=" col-sm-6">
                  ...
                  <div class="col-sm-2">
                        <input type='text' id='acrylic_cf_to_saliva' name='acrylic_cf_to_saliva' class='form-control'  value="<?php echo $row_for_finishing['cf_to_saliva_staining_value_for_acrylic']?>">
                  </div>
            </div>
            <div class=" row" for="Wool_for_stating">
                  <div class=" col-sm-6">
                  ...
                  <div class="col-sm-2">
                        <input type='text' id='wool_cf_to_saliva' name='wool_cf_to_saliva' class='form-control'  value="<?php echo $row_for_finishing['cf_to_saliva_staining_value_for_wool']?>">
                  </div>
            </div>
...
<div id="div_cf_to_chlorine_water" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_chlorinated_water_color_change_change_value" name="cf_to_chlorinated_water_color_change_change_value" value="<?php echo $row_for_finishing['cf_to_chlorinated_water_color_change_change_value']?>"   style="color:#00008B; margin-top:23px;">
...
<div id="div_cf_to_chlorine_bleach" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_cholorine_bleach_color_change_value" name="cf_to_cholorine_bleach_color_change_value" value="<?php echo $row_for_finishing['cf_to_cholorine_bleach_color_change_value']?>"   style="color:#00008B; margin-top:23px;">
...
<div id="div_cross_staining" style="display: none;">
	...
	<div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cross_staining_value" name="cross_staining_value" value="<?php echo $row_for_finishing['cross_staining_value']?>">
 ...
 <div id="div_formaldehyde_content" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="formaldehyde_content_value" name="formaldehyde_content_value"  value="<?php echo $row_for_finishing['formaldehyde_content_value']?>"   style="color:#00008B; margin-top:23px;">
...
<div id="div_ph" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="ph_value" name="ph_value" value="<?php echo $row_for_finishing['ph_value']?>"    style="color:#00008B; margin-top:23px;">
  ...
  <div id="div_water_absorption" style="display: none;">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2 text-center">
               ...
               <select  class="form-control" id="description_or_type_for_water_absorption" name="description_or_type_for_water_absorption"  style="color:#00008B; margin-top:23px;">
                      ...
                      <?php
                                      $description_or_type_for_water_absorption = $row_for_finishing['description_or_type_for_water_absorption'];
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="water_absorption_value" name="water_absorption_value"  value="<?php echo $row_for_finishing['water_absorption_value']?>"   style="color:#00008B; margin-top:23px;">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="water_absorption_b_wash_thirty_sec_value" name="water_absorption_b_wash_thirty_sec_value" value="<?php echo $row_for_finishing['water_absorption_b_wash_thirty_sec_value']?>">
     ...
     <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="water_absorption_b_wash_max_value" name="water_absorption_b_wash_max_value" value="<?php echo $row_for_finishing['water_absorption_b_wash_max_value']?>">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="water_absorption_a_wash_thirty_sec_value" name="water_absorption_a_wash_thirty_sec_value" value="<?php echo $row_for_finishing['water_absorption_a_wash_thirty_sec_value']?>">
 ...
 <div id="div_spirality" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="spirality_value" name="spirality_value" value="<?php echo $row_for_finishing['spirality_value']?>"   style="color:#00008B; margin-top:23px;">
...
<div id="div_smoothness_appearance" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="smoothness_appearance_value" name="smoothness_appearance_value" value="<?php echo $row_for_finishing['smoothness_appearance_value']?>"   style="color:#00008B; margin-top:23px;">
 ...
 <div id="div_print_durability" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="print_durability_value" name="print_durability_value" value="<?php echo $row_for_finishing['print_durability_value']?>"   style="color:#00008B; margin-top:23px;">
...
<div id="div_iron_ability_of_woven_fabric" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="iron_ability_of_woven_fabric_value" name="iron_ability_of_woven_fabric_value" value="<?php echo $row_for_finishing['iron_ability_of_woven_fabric_value']?>"  style="color:#00008B; margin-top:23px;">
...
<div id="div_cf_to_artificial_day_light" style="display: none;">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            <input type="text" class="form-control" id="cf_to_artificial_day_light_value" name="cf_to_artificial_day_light_value" value="<?php echo $row_for_finishing['cf_to_artificial_day_light_value']?>"   style="color:#00008B; margin-top:23px;">
      </div>
  ...
  <div class="form-group form-group-sm " for="value_for_cf_to_artificial_day_light">
               ...
               <div class="row" for="cf_to_light_shade_color_1">
                        ...
                        <div class="col-sm-2">
                        <input type='text' id='cf_to_light_shade_color_1' name='cf_to_light_shade_color_1' class='form-control ' value="<?php echo $row_for_finishing['cf_to_light_shade_color_1']?>">
                        </div>
                        <div class="col-sm-2">
                              <input type='text' id='cf_to_light_shade_color_1_value' name='cf_to_light_shade_color_1_value' class='form-control ' value="<?php echo $row_for_finishing['cf_to_light_shade_color_1_value']?>">
                        </div>
               </div>
               ...
               <div class="row" for="cf_to_light_shade_color_2">
                        ...
                        <div class="col-sm-2">
                        <input type='text' id='cf_to_light_shade_color_2' name='cf_to_light_shade_color_2' class='form-control ' value="<?php echo $row_for_finishing['cf_to_light_shade_color_2']?>"> 
                        </div>
                        <div class="col-sm-2">
                              <input type='text' id='cf_to_light_shade_color_2_value' name='cf_to_light_shade_color_2_value' class='form-control ' value="<?php echo $row_for_finishing['cf_to_light_shade_color_2_value']?>">
                        </div>
               </div>
               ...
               <div class="row" for="cf_to_light_shade_color_3">
                        ...
                        <div class="col-sm-2">
                        <input type='text' id='cf_to_light_shade_color_3' name='cf_to_light_shade_color_3' class='form-control ' value="<?php echo $row_for_finishing['cf_to_light_shade_color_3']?>"> 
                        </div>
                        <div class="col-sm-2">
                              <input type='text' id='cf_to_light_shade_color_3_value' name='cf_to_light_shade_color_3_value' class='form-control ' value="<?php echo $row_for_finishing['cf_to_light_shade_color_3_value']?>"> 
                        </div>
               </div>
               ...
               <div class="row" for="cf_to_light_shade_color_4">
                        ...
                        <div class="col-sm-2">
                        <input type='text' id='cf_to_light_shade_color_4' name='cf_to_light_shade_color_4' class='form-control ' value="<?php echo $row_for_finishing['cf_to_light_shade_color_4']?>"> 
                        </div>
                        <div class="col-sm-2">
                              <input type='text' id='cf_to_light_shade_color_4_value' name='cf_to_light_shade_color_4_value' class='form-control ' value="<?php echo $row_for_finishing['cf_to_light_shade_color_4_value']?>"> 
                        </div>
               </div>
               ...
               <div class="row" for="cf_to_light_shade_color_5">
                        ...
                        <div class="col-sm-2">
                        <input type='text' id='cf_to_light_shade_color_5' name='cf_to_light_shade_color_5' class='form-control' value="<?php echo $row_for_finishing['cf_to_light_shade_color_5']?>"> 
                        </div>
                        <div class="col-sm-2">
                              <input type='text' id='cf_to_light_shade_color_5_value' name='cf_to_light_shade_color_5_value' class='form-control ' value="<?php echo $row_for_finishing['cf_to_light_shade_color_5_value']?>">
                        </div>
               </div>
               ...
               <div class="row" for="cf_to_light_shade_color_6">
                        ...
                        <div class="col-sm-2">
                        <input type='text' id='cf_to_light_shade_color_6' name='cf_to_light_shade_color_6' class='form-control ' value="<?php echo $row_for_finishing['cf_to_light_shade_color_6']?>"> 
                        </div>
                        <div class="col-sm-2">
                              <input type='text' id='cf_to_light_shade_color_6_value' name='cf_to_light_shade_color_6_value' class='form-control ' value="<?php echo $row_for_finishing['cf_to_light_shade_color_6_value']?>"> 
                        </div>
               </div>
               ...
               <div class="row" for="cf_to_light_shade_color_7">
                        ...
                        <div class="col-sm-2">
                        <input type='text' id='cf_to_light_shade_color_7' name='cf_to_light_shade_color_7' class='form-control ' value="<?php echo $row_for_finishing['cf_to_light_shade_color_7']?>"> 
                        </div>
                        <div class="col-sm-2">
                              <input type='text' id='cf_to_light_shade_color_7_value' name='cf_to_light_shade_color_7_value' class='form-control ' value="<?php echo $row_for_finishing['cf_to_light_shade_color_7_value']?>"> 
                        </div>
               </div>
...
<div id="div_moisture_content" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="moisture_content_value" name="moisture_content_value" value="<?php echo $row_for_finishing['moisture_content_value']?>"  style="color:#00008B; margin-top:23px;">
...
<div id="div_evaporation_rate" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="evaporation_rate_quick_drying_value" name="evaporation_rate_quick_drying_value" value="<?php echo $row_for_finishing['evaporation_rate_quick_drying_value']?>"   style="color:#00008B; margin-top:23px;">
...
<div id="div_fiber_content" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="total_cotton_content_value" name="total_cotton_content_value" value="<?php echo $row_for_finishing['total_cotton_content_value']?>"   style="color:#00008B; margin-top:23px;">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="total_total_Polyester_content_value" name="total_total_Polyester_content_value" value="<?php echo $row_for_finishing['total_total_Polyester_content_value']?>">
     ...
     <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="total_other_fiber_value" name="total_other_fiber_value" value="<?php echo $row_for_finishing['total_other_fiber_value']?>">
...
<div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="warp_cotton_content_value" name="warp_cotton_content_value" value="<?php echo $row_for_finishing['warp_cotton_content_value']?>"   style="color:#00008B; margin-top:23px;">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="warp_Polyester_content_value" name="warp_Polyester_content_value" value="<?php echo $row_for_finishing['warp_Polyester_content_value']?>">
  ...
  <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="warp_other_fiber_value" name="warp_other_fiber_value" value="<?php echo $row_for_finishing['warp_other_fiber_value']?>">
...
<div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="weft_cotton_content_value" name="weft_cotton_content_value" value="<?php echo $row_for_finishing['weft_cotton_content_value']?>"   style="color:#00008B; margin-top:23px;">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="weft_Polyester_content_value" name="weft_Polyester_content_value" value="<?php echo $row_for_finishing['weft_Polyester_content_value']?>">
    ...
    <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="weft_other_fiber_value" name="weft_other_fiber_value" value="<?php echo $row_for_finishing['weft_other_fiber_value']?>">
...
<div class="col-sm-3 text-center">
     ...
     <?php
                 $appearance_after_wash_radio = $row_for_finishing['test_method_for_appearance_after_wash'];
...
<div id="div_appearance_after_wash_fabric" style="display: none">        
      <div class="form-group form-group-sm">
            ...
            <?php
            $appearance_after_washing_cycle_fabric_wash=$row_for_finishing['appearance_after_washing_cycle_fabric_wash'];
            ...
            <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_fabric_color_change_value" name="appearance_after_washing_fabric_color_change_value" value="<?php echo $row_for_finishing['appear_after_wash_fabric_color_change_value']?>" required>
         ...
         <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_fabric_cross_staining_value" name="appearance_after_washing_fabric_cross_staining_value" value="<?php echo $row_for_finishing['appearance_after_washing_fabric_cross_staining_value']?>" required>
         ...
         <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_fabric_surface_fuzzing_value" name="appearance_after_washing_fabric_surface_fuzzing_value" value="<?php echo $row_for_finishing['appearance_after_washing_fabric_surface_fuzzing_value']?>" required>
         ...
         <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_fabric_surface_pilling_value" name="appearance_after_washing_fabric_surface_pilling_value" value="<?php echo $row_for_finishing['appearance_after_washing_fabric_surface_pilling_value']?>" required>
         ...
         <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_fabric_crease_before_ironing_value" name="appearance_after_washing_fabric_crease_before_ironing_value" value="<?php echo $row_for_finishing['appearance_after_washing_fabric_crease_before_ironing_value']?>" required>
         ...
         <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_fabric_crease_after_ironing_value" name="appearance_after_washing_fabric_crease_after_ironing_value" value="<?php echo $row_for_finishing['appearance_after_washing_fabric_crease_after_ironing_value']?>" required>
         ...
         <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_fabric_loss_of_print_value" name="appearance_after_washing_fabric_loss_of_print_value" value="<?php echo $row_for_finishing['appearance_after_washing_fabric_loss_of_print_value']?>" required>
         ...
         <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_fabric_abrasive_mark_value" name="appearance_after_washing_fabric_abrasive_mark_value" value="<?php echo $row_for_finishing['appearance_after_washing_fabric_abrasive_mark_value']?>" required>
         ...
         <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_fabric_odor_value" name="appearance_after_washing_fabric_odor_value" value="<?php echo $row_for_finishing['appearance_after_washing_fabric_odor_value']?>" required>
         ...
         <div class="form-group form-group-sm">
                  ...
                  <textarea class="form-control" name="appearance_after_washing_other_observation_fabric" id="appearance_after_washing_other_observation_fabric" cols="30" rows="2" value="<?php echo $row_for_finishing['appearance_after_washing_other_observation_fabric']?>" required><?php echo $row_for_finishing['appearance_after_washing_other_observation_fabric']?></textarea>
...
<div class="form-group form-group-sm">
            ...
            <?php
                  $appearance_after_washing_cycle_garments_wash=$row_for_finishing['appearance_after_washing_cycle_garments_wash'];
            ...
            <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_garments_color_change_without_suppressor_value" name="appearance_after_washing_garments_color_change_without_suppressor_value" value="<?php echo $row_for_finishing['appear_after_wash_garments_color_change_without_sup_value']?>" required>
         ...
         <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_garments_color_change_with_suppressor_value" name="appearance_after_washing_garments_color_change_with_suppressor_value" value="<?php echo $row_for_finishing['appear_after_wash_garments_color_change_with_sup_value']?>" required>
         ...
         <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_garments_cross_staining_value" name="appearance_after_washing_garments_cross_staining_value" value="<?php echo $row_for_finishing['appearance_after_washing_garments_cross_staining_value']?>" required>
         ...
         <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_garmentsdifferential_shrinkage_value" name="appearance_after_washing_garmentsdifferential_shrinkage_value" value="<?php echo $row_for_finishing['appearance_after_washing_garments_differential_shrinkage_value']?>" required>
         ...
         <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_garments_surface_fuzzing_value" name="appearance_after_washing_garments_surface_fuzzing_value" value="<?php echo $row_for_finishing['appearance_after_washing_garments_surface_fuzzing_value']?>" required>
         ...
         <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_garments_surface_pilling_value" name="appearance_after_washing_garments_surface_pilling_value" value="<?php echo $row_for_finishing['appearance_after_washing_garments_surface_pilling_value']?>" required>
         ...
         <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_garments_crease_after_ironing_value" name="appearance_after_washing_garments_crease_after_ironing_value" value="<?php echo $row_for_finishing['appearance_after_washing_garments_crease_after_ironing_value']?>" required>
         ...
         <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_garments_abrasive_mark_value" name="appearance_after_washing_garments_abrasive_mark_value"  value="<?php echo $row_for_finishing['appearance_after_washing_garments_abrasive_mark_value']?>"  required>
         ...
         <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_garments_seam_breakdown_value" name="appearance_after_washing_garments_seam_breakdown_value" value="<?php echo $row_for_finishing['appearance_after_washing_garments_seam_breakdown_value']?>" required>
         ...
         <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_garments_seam_puckering_roping_after_iron_value" name="appearance_after_washing_garments_seam_puckering_roping_after_iron_value" value="<?php echo $row_for_finishing['appearance_after_washing_garments_seam_puckering_roping_after_ir']?>" required>
         ...
         <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_garments_detachment_of_interlining_value" name="appearance_after_washing_garments_detachment_of_interlining_value" value="<?php echo $row_for_finishing['appearance_after_washing_garments_detachment_of_interlining_valu']?>" required>
         ...
         <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_garments_change_in_handle_or_appearance_value" name="appearance_after_washing_garments_change_in_handle_or_appearance_value" value="<?php echo $row_for_finishing['appearance_after_washing_garments_change_in_handle_value']?>" required>
         ...
         <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_garments_effect_accessories_value" name="appearance_after_washing_garments_effect_accessories_value" value="<?php echo $row_for_finishing['appearance_after_washing_garments_effect_accessories_value']?>" required>
         ...
         <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_garments_spirality_value" name="appearance_after_washing_garments_spirality_value" value="<?php echo $row_for_finishing['appearance_after_washing_garments_spirality_value']?>" required>
         ...
         <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_garments_detachment_or_fraying_of_ribbons_value" name="appearance_after_washing_garments_detachment_or_fraying_of_ribbons_value"  value="<?php echo $row_for_finishing['appearance_after_washing_garments_detachment_or_fraying_of_ribbo']?>" required>
         ...
         <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_garments_loss_of_print_value" name="appearance_after_washing_garments_loss_of_print_value" value="<?php echo $row_for_finishing['appearance_after_washing_garments_loss_of_print_value']?>" required>
         ...
         <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_garments_care_level_value" name="appearance_after_washing_garments_care_level_value" value="<?php echo $row_for_finishing['appearance_after_washing_garments_care_level_value']?>" required>
         ...
         <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_garments_odor_value" name="appearance_after_washing_garments_odor_value" value="<?php echo $row_for_finishing['appearance_after_washing_garments_odor_value']?>" required>
         ...
         <div class="form-group form-group-sm">
                  ...
                  <textarea class="form-control" name="appearance_after_washing_other_observation_garments" id="appearance_after_washing_other_observation_garments" cols="30" rows="2" value="<?php echo $row_for_finishing['appearance_after_washing_other_observation_garments']?>" required><?php echo $row_for_finishing['appearance_after_washing_other_observation_garments']?></textarea>
...
<!-- -------------------------------------------------------------------------------end Appearance after wash---------------------------------------------------------------------------------------------------------------------- -->
						...
						<label class="control-label col-sm-4" for="status" style="margin-right:15px;color:#00008B;">Status:</label>
								<input type="radio" class="form-check-input"  value="OK" id="status" name="status" <?php if($row_for_finishing['status']=="OK"){ echo "checked";}?>>
								<label class="form-check-label control-label" for="status" style="margin-right:15px;">OK</label>
								<input type="radio" class="form-check-input"  value="Not OK" id="status" name="status" <?php if($row_for_finishing['status']=="Not OK"){ echo "checked";}?>>
						...
						<div class="form-group form-group-sm" id="form-group_for_remarks">
								...
								<div class="col-sm-5">
									<textarea class='form-control' id='remarks' name='remarks' rows='5' value="<?php echo $row_for_finishing['remarks']?>"><?php echo $row_for_finishing['remarks']?></textarea>
								</div>
						   ...
						   <label class="control-label col-sm-3" for="current_state" style="margin-right:15px;color:#00008B;">NOTE(IS IT A LAST PROCESS):</label>
								<input type="radio" class="form-check-input"  value="PP Completed" id="current_state" name="current_state" <?php if($row_for_finishing['current_state']=="PP Completed"){ echo "checked";}?>>
								<label class="form-check-label control-label" for="current_state" style="margin-right:15px;">Yes</label>
								<input type="radio" class="form-check-input"  value="PP in progress" id="current_state" name="current_state" <?php if($row_for_finishing['current_state']=="PP in progress"){ echo "checked";}?>>
						...
						<div class="form-group form-group-sm">
								<div class="col-sm-offset-3 col-sm-5">
									<button type="button" class="btn btn-primary" onClick="sending_data_of_qc_result_for_finishing_process_form_for_saving_in_database()">Save</button>
