...
$select_sql_for_duplicacy="select * from `qc_result_for_printing_process` where 
						...
						and status= '$status' and remarks='$remarks' and  `date`='$date' AND current_state = '$current_state' ";
...
{
	$update_sql_statement="UPDATE `qc_result_for_printing_process` SET 
    `cf_to_rubbing_dry_value` ='$cf_to_rubbing_dry_value',
    `cf_to_rubbing_wet_value` ='$cf_to_rubbing_wet_value', status= '$status', remarks='$remarks', `date`='$date', current_state = '$current_state'
    WHERE 
