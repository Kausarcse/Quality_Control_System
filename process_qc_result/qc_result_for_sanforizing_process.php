...
*/  
 ...
 function sending_data_of_qc_result_for_sanforizing_process_form_for_saving_in_database()
 {
       ...
       if(validate != false)
	   {
		  	 ...
		  	 $.ajax({
			 		url: 'process_qc_result/qc_result_for_sanforizing_process_saving.php',
			 		dataType: 'text',
			 		type: 'post',
			 		contentType: 'application/x-www-form-urlencoded',
...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
			...
			<body id="target">
				...
				<div class="panel-heading" style="color:#191970;"><b>Qc Result For Sanforizing Process</b></div> <!-- This will create a upper block for FORM (Just Beautification) -->
            ...
            <div class="form-group form-group-sm" id="form-group_for_pp_number" onchange="Fill_Value_Of_Version_Number_Field(this.value)">
                  ...
                  <div class="form-group form-group-sm" id="form-group_for_style">
								<label class="control-label col-sm-3" for="style" style="color:#00008B;">Style:</label>
								<div class="col-sm-5" style="padding-right:4px;">
									<input type="text" class="form-control" id="style" name="style" value="<?php if (isset($result_for_trf['style'])) echo $result_for_trf['style']?>" placeholder="Enter Style" readonly required>
								</div>
						</div> <!-- End of <div class="form-group form-group-sm" id="form-group_for_"> -->
            ...
            <input type="hidden" id="uom_of_seam_properties_seam_strength_iso_astm_d_in_weft" name="uom_of_seam_properties_seam_strength_iso_astm_d_in_weft"  value="uom_of_seam_properties_seam_strength_iso_astm_d_in_weft">
						...
						<div class="form-group form-group-sm">
								<div class="col-sm-offset-3 col-sm-6">
									<button type="button" class="btn btn-primary" onClick="sending_data_of_qc_result_for_sanforizing_process_form_for_saving_in_database()">Submit</button>
