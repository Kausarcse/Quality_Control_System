...
*/  
 ...
 function sending_data_of_qc_result_for_ready_for_printing_process_form_for_saving_in_database()
 {
       ...
       if(validate != false)
	   {
		  	 ...
		  	 $.ajax({
			 		url: 'process_qc_result/qc_result_for_ready_for_printing_process_saving.php',
			 		dataType: 'text',
			 		type: 'post',
			 		contentType: 'application/x-www-form-urlencoded',
...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
			...
			<body id="target">
				...
				<div class="panel-heading" style="color:#191970;"><b>Qc Result For Ready For Printing Process</b></div> <!-- This will create a upper block for FORM (Just Beautification) -->
                  ...
                  <input type="hidden" class="form-control" id="uom_of_whiteness" name="uom_of_whiteness" placeholder="Enter Uom Of whiteness" value="(°)">
						...
						<div class="form-group form-group-sm">
								<div class="col-sm-offset-3 col-sm-6">
									<button type="button" class="btn btn-primary" onClick="sending_data_of_qc_result_for_ready_for_printing_process_form_for_saving_in_database()">Submit</button>
