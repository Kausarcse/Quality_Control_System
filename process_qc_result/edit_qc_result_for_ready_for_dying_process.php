...
// $sql_qc_ready_for_dying="select id from qc_result_for_ready_for_dying_process where pp_number = '$trf_pp_number'";
// $res_sql_qc_ready_for_dying=mysqli_query($con,$sql_qc_ready_for_dying) or die(mysqli_error($con));
// $row_for_id=mysqli_fetch_assoc($res_sql_qc_ready_for_dying);

// $ready_for_dying_id = $row_for_id['id'];


$sql_for_ready_for_dying="select * from qc_result_for_ready_for_dying_process where pp_number = '$trf_pp_number' and 
...
$result_for_ready_for_dying= mysqli_query($con,$sql_for_ready_for_dying) or die(mysqli_error($con));
$row_for_ready_for_dying = mysqli_fetch_array( $result_for_ready_for_dying);
...
<script type='text/javascript' src='process_qc_result/qc_result_for_ready_for_dying_process_form_validation.js'></script>
...
{   
	var db_table_name="defining_qc_standard_for_ready_for_dying_process";
...
*/  
  ...
  document.getElementById('standard_for_which_process').value='Ready For Dying'; 

}/* End of function fill_up_qc_standard_additional_info(version_details)*/
 function sending_data_of_qc_result_for_ready_for_dying_process_form_for_saving_in_database()
 {


       var validate = Ready_For_Dying_Form_Validation();
       var url_encoded_form_data = $("#qc_result_for_ready_for_dying_process_form").serialize(); //This will read all control elements value of the form	
       if(validate != false)
	   {


		  	 $.ajax({
			 		url: 'process_qc_result/edit_qc_result_for_ready_for_dying_process_saving.php',
			 		dataType: 'text',
			 		type: 'post',
			 		contentType: 'application/x-www-form-urlencoded',
 ...
 }//End of function sending_data_of_qc_result_for_ready_for_dying_process_form_for_saving_in_database()
...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
			...
			<body id="target">
				...
				<div class="panel-heading" style="color:#191970;"><b>Qc Result For Ready For Dying Process / <a href="#">Edit</a></b></div> <!-- This will create a upper block for FORM (Just Beautification) -->

				<form class="form-horizontal" action="" style="margin-top:10px;" name="qc_result_for_ready_for_dying_process_form" id="qc_result_for_ready_for_dying_process_form">
					...
					<!-- 	<div class="form-group form-group-sm" id="form-group_for_total_short_or_excess_in_percentage">
						...
						<div class="form-group form-group-sm" id="form-group_for_whiteness_value">
			              ...
			              <div class="col-sm-2 text-center">
			                ...
			                <input type="text" class="form-control" id="whiteness_left_value" name="whiteness_left_value" value="<?php echo $row_for_ready_for_dying['whiteness_left_value'] ?>" style="padding-right:4px;" required>
			              </div>
			              
			              
			              <div class="col-sm-2 text-center">
			                <label for="whiteness_value" style="font-size:12px; color:#000066;">Center</label>
			                <input type="text" class="form-control" id="whiteness_center_value" name="whiteness_center_value" value="<?php echo $row_for_ready_for_dying['whiteness_center_value'] ?>" style="padding-right:4px;" required>
			              </div>

			              <div class="col-sm-2 text-center">
			                <label for="whiteness_value" style="font-size:12px; color:#000066;">Right</label>
			                <input type="text" class="form-control" id="whiteness_right_value" name="whiteness_right_value" value="<?php echo $row_for_ready_for_dying['whiteness_right_value'] ?>" style="padding-right:4px;" required>
			              </div>
                ...
                <div class="col-sm-6" style="padding-right:4px;">
                  <input type="hidden" class="form-control" id="uom_of_whiteness" name="uom_of_whiteness" placeholder="Enter Uom Of whiteness" value="(°)">
			          	...
			          	<div class="form-group form-group-sm" id="form-group_for_bowing_and_skew">
			                ...
			                <div class="col-sm-6" style="padding-right:4px;">
			                  <input type="text" class="form-control" id="bowing_and_skew_value" name="bowing_and_skew_value" value="<?php echo $row_for_ready_for_dying['bowing_and_skew_value'] ?>" required>
			                </div>
			            </div> <!-- End of <div class="form-group form-group-sm" id="form-group_for_"> -->
						...
						<div class="form-group form-group-sm" id="form-group_for_ph_value">
				              ...
				              <div class="col-sm-2 text-center">
				                <label for="whiteness_value" style="font-size:12px; color:#000066;">Left</label>
				                <input type="text" class="form-control" id="ph_left_value" name="ph_left_value" value="<?php echo $row_for_ready_for_dying['ph_left_value'] ?>" style="padding-right:4px;" required>
				              </div>
				              
				              
				              <div class="col-sm-2 text-center">
				                <label for="whiteness_value" style="font-size:12px; color:#000066;">Center</label>
				                <input type="text" class="form-control" id="ph_center_value" name="ph_center_value" value="<?php echo $row_for_ready_for_dying['ph_center_value'] ?>" style="padding-right:4px;" required>
				              </div>

				              <div class="col-sm-2 text-center">
				                <label for="whiteness_value" style="font-size:12px; color:#000066;">Right</label>
				                <input type="text" class="form-control" id="ph_right_value" name="ph_right_value" value="<?php echo $row_for_ready_for_dying['ph_right_value'] ?>" style="padding-right:4px;" required>
				              </div>
						...
						<label class="control-label col-sm-3" for="status" style="margin-right:15px;color:#00008B;">Status:</label>
								<input type="radio" class="form-check-input"  value="OK" id="status" name="status" <?php if($row_for_ready_for_dying['status']=="OK"){ echo "checked";}?>>
								<label class="form-check-label control-label" for="status" style="margin-right:15px;">OK</label>
								<input type="radio" class="form-check-input"  value="Not OK" id="status" name="status" <?php if($row_for_ready_for_dying['status']=="Not OK"){ echo "checked";}?>>
						...
						<div class="form-group form-group-sm" id="form-group_for_remarks">
								...
								<div class="col-sm-6">
									<textarea class='form-control' id='remarks' name='remarks' rows='5' value="<?php echo $row_for_ready_for_dying['remarks'] ?>"><?php echo $row_for_ready_for_dying['remarks'] ?></textarea>
								</div>
						...
						<div class="form-group form-group-sm" id="form-group_for_current_state">
						   <label class="control-label col-sm-3" for="current_state" style="margin-right:15px;color:#00008B;">NOTE(IS IT A LAST PROCESS):</label>
								<input type="radio" class="form-check-input"  value="PP Completed" id="current_state" name="current_state" <?php if($row_for_ready_for_dying['current_state']=="PP Completed"){ echo "checked";}?>>
								<label class="form-check-label control-label" for="current_state" style="margin-right:15px;">Yes</label>
								<input type="radio" class="form-check-input"  value="PP in progress" id="current_state" name="current_state" <?php if($row_for_ready_for_dying['current_state']=="PP in progress"){ echo "checked";}?>>
						...
						<div class="form-group form-group-sm">
								<div class="col-sm-offset-3 col-sm-6">
									<button type="button" class="btn btn-primary" onClick="sending_data_of_qc_result_for_ready_for_dying_process_form_for_saving_in_database()">Save</button>
