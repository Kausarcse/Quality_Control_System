...
$select_sql_for_duplicacy="select * from `qc_result_for_singe_and_desize_process` where 
...
flame_intensity_value = '$flame_intensity_value' and
machine_speed = '$machine_speed' and
bath_temperature = '$bath_temperature' and
bath_ph = '$bath_ph' and status= '$status' and remarks='$remarks' and current_state='$current_state' and `date`='$date'";
...
else if(mysqli_num_rows($result) < 1)
{
 ...
 $update_sql_statement="UPDATE `qc_result_for_singe_and_desize_process` SET 
							flame_intensity_value = '$flame_intensity_value',
							machine_speed = '$machine_speed',
							bath_temperature = '$bath_temperature',
							bath_ph = '$bath_ph', status= '$status', remarks='$remarks', `current_state`='$current_state', `date`='$date'
							WHERE 
							`pp_number`='$pp_number' and 
							`version_number`='$version_number' and 
							`customer_name`='$customer_name' and 
