...
$select_sql_for_duplicacy="select * from `qc_result_for_ready_for_printing_process` where 
...
{
	$update_sql_statement="UPDATE `qc_result_for_ready_for_printing_process` SET 
