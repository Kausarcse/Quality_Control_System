...
$test_result_table_column=$splitted_data[2];
 ...
 pwvci.pp_quantity from $test_result_table ptftri, pp_wise_version_creation_info pwvci where ptftri.pp_number = pwvci.pp_number, ( ((pwvci.pp_quantity - ptftri.after_trolley_or_batcher_qty) * 100)/ pwvci.pp_quantity) short_excess and ptftri.version_id = pwvci.version_id 
...
// $sql_qc_mercerize="select id from qc_result_for_mercerize_process where pp_number = '$trf_pp_number'";
// $res_sql_qc_mercerize=mysqli_query($con,$sql_qc_mercerize) or die(mysqli_error($con));
// $row_for_id=mysqli_fetch_assoc($res_sql_qc_mercerize);

// $mercerize_id = $row_for_id['id'];


$sql_for_mercerize="select * from qc_result_for_mercerize_process where pp_number = '$trf_pp_number' and 
...
$row_for_mercerize = mysqli_fetch_array( $result_for_mercerize);

?>


<script type='text/javascript' src='process_qc_result/qc_result_for_mercerize_process_form_validation.js'></script>
...
function Fill_Value_Of_Version_Number_Field(pp_number)
{
	...
	//var db_table_name="defining_qc_standard_for_ready_for_mercerize_process";
		var db_table_name="defining_qc_standard_for_mercerize_process";
...
*/
 ...
 function sending_data_of_qc_result_for_mercerize_process_form_for_saving_in_database()
 {


       var validate = Mercerize_Form_Validation();
       var url_encoded_form_data = $("#qc_result_for_mercerize_process_form").serialize(); //This will read all control elements value of the form
       if(validate != false)
	   {


		  	 $.ajax({
			 		url: 'process_qc_result/edit_qc_result_for_mercerize_process_saving.php',
			 		dataType: 'text',
			 		type: 'post',
			 		contentType: 'application/x-www-form-urlencoded',
 ...
 }//End of function sending_data_of_qc_result_for_mercerize_process_form_for_saving_in_database()
...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
			...
			<body id="target">
				...
				<div class="panel-heading" style="color:#191970;"><b>Qc Result For Mercerize Process / <a href="#">Edit</a></b></div> <!-- This will create a upper block for FORM (Just Beautification) -->


				<form class="form-horizontal" action="" style="margin-top:10px;" name="qc_result_for_mercerize_process_form" id="qc_result_for_mercerize_process_form">
				...
				<div class="form-group form-group-sm" id="form-group_for_pp_number" onchange="Fill_Value_Of_Version_Number_Field(this.value)">
					...
					<div class="form-group form-group-sm" id="form-group_for_whiteness_value_in_fabric">
					    <label class="control-label col-sm-3" for="whiteness_value_in_left_side_of_fabric" style="color:#00008B; margin-top:23px;"><span id="for_whiteness_value_in_right_side_of_fabric_test_name_label">Whiteness-Berger:</span></label>
					    
					    <div class="col-sm-1 text-center">
					      <label for="whiteness_value" style="font-size:12px; color:#000066;">Left</label>
					      <input type="text" class="form-control" id="whiteness_value_in_left_side_of_fabric" name="whiteness_value_in_left_side_of_fabric" value="<?php echo $row_for_mercerize['whiteness_value_in_left_side_of_fabric']?>" style="padding-right:4px;" required>
					    </div>
					    
					    
					    <div class="col-sm-2 text-center">
					      <label for="whiteness_value" style="font-size:12px; color:#000066;">Center</label>
					      <input type="text" class="form-control" id="whiteness_value_in_center_of_fabric" name="whiteness_value_in_center_of_fabric" value="<?php echo $row_for_mercerize['whiteness_value_in_center_of_fabric']?>" style="padding-right:4px;" required>
					    </div>

					    
					    <div class="col-sm-2 text-center" style="padding-right:4px;">
					      <label for="whiteness_value" style="font-size:12px; color:#000066;">Right</label>
					      <input type="text" class="form-control" id="whiteness_value_in_right_side_of_fabric" name="whiteness_value_in_right_side_of_fabric" value="<?php echo $row_for_mercerize['whiteness_value_in_right_side_of_fabric']?>" required>
					    </div>

					</div>  <!-- End <div class="form-group form-group-sm" id="form-group_for_whiteness_value"> -->

                                                 <!--  Start Test Name Result Entry Box -->


						<div class="form-group form-group-sm" id="form-group_for_uom_of_whiteness">
								<!-- <label class="control-label col-sm-3" for="uom_of_whiteness" style="color:#00008B;">Uom Of Whiteness:</label> -->
								<div class="col-sm-5" style="padding-right:4px;">
					...
					<div class="form-group form-group-sm" id="form-group_for_residual_sizing_material_value">
					    ...
					    <div class="col-sm-1 text-center">
					      <label for="residual_sizing_value" style="font-size:12px; color:#000066;">Left</label>
					      <input type="text" class="form-control" id="residual_sizing_value_in_left_side_of_fabric" name="residual_sizing_value_in_left_side_of_fabric" value="<?php echo $row_for_mercerize['residual_sizing_value_in_left_side_of_fabric']?>" style="padding-right:4px;" required>
					    </div>
					    
					    
					    <div class="col-sm-2 text-center">
					      <label for="residual_sizing_value" style="font-size:12px; color:#000066;">Center</label>
					      <input type="text" class="form-control" id="residual_sizing_value_in_center_of_fabric" name="residual_sizing_value_in_center_of_fabric" value="<?php echo $row_for_mercerize['residual_sizing_value_in_center_of_fabric']?>" style="padding-right:4px;" required>
					    </div>

					    
					    <div class="col-sm-2 text-center" style="padding-right:4px;">
					      <label for="residual_sizing_value" style="font-size:12px; color:#000066;">Right</label>
					      <input type="text" class="form-control" id="residual_sizing_value_in_right_side_of_fabric" name="residual_sizing_value_in_right_side_of_fabric" value="<?php echo $row_for_mercerize['residual_sizing_value_in_right_side_of_fabric']?>" required>
					    </div>
					</div>  <!-- End <div class="form-group form-group-sm" id="form-group_for_whiteness_value"> -->
			

						<div class="form-group form-group-sm" id="form-group_for_uom_of_residual_sizing">
								<!-- <label class="control-label col-sm-3" for="uom_of_residual_sizing" style="color:#00008B;">Uom Of Residual Sizing:</label> -->
								<div class="col-sm-5" style="padding-right:4px;">
									<input type="hidden" class="form-control" id="uom_of_residual_sizing" name="uom_of_residual_sizing" placeholder="Enter Uom Of residual_sizing" value="value">
								</div>
						</div> <!-- End of <div class="form-group form-group-sm" id="form-group_for_"> -->

					<div class="form-group form-group-sm" id="form-group_for_absorbency_value_in_left_side_of_fabric">
					    ...
					    <div class="col-sm-1 text-center">
					      ...
					      <input type="text" class="form-control" id="absorbency_value_in_left_side_of_fabric" name="absorbency_value_in_left_side_of_fabric" value="<?php echo $row_for_mercerize['absorbency_value_in_left_side_of_fabric']?>" style="padding-right:4px;" required>
					    </div>
					    
					    
					    <div class="col-sm-2 text-center">
					      <label for="absorbency_value" style="font-size:12px; color:#000066;">Center</label>
					      <input type="text" class="form-control" id="absorbency_value_in_center_of_fabric" name="absorbency_value_in_center_of_fabric" value="<?php echo $row_for_mercerize['absorbency_value_in_center_of_fabric']?>" style="padding-right:4px;" required>
					    </div>

					    
					    <div class="col-sm-2 text-center" style="padding-right:4px;">
					      <label for="absorbency_value" style="font-size:12px; color:#000066;">Right</label>
					      <input type="text" class="form-control" id="absorbency_value_in_right_side_of_fabric" name="absorbency_value_in_right_side_of_fabric" value="<?php echo $row_for_mercerize['absorbency_value_in_right_side_of_fabric']?>" required>
					    </div>
						...
						<div class="form-group form-group-sm" id="form-group_for_uom_of_absorbency_value">
								<!-- <label class="control-label col-sm-3" for="uom_of_absorbency_value" style="color:#00008B;">Uom Of Absorbency Value:</label> -->
								<div class="col-sm-5" style="padding-right:4px;">
									<input type="hidden" class="form-control" id="uom_of_absorbency_value" name="uom_of_absorbency_value" placeholder="Enter Uom Of Absorbency Value" value="mm">
								</div>
						</div> <!-- End of <div class="form-group form-group-sm" id="form-group_for_"> -->
					...
					<div class="form-group form-group-sm" id="form-group_for_residual_sizing_material_value">
					   ...
					   <label class="control-label col-sm-3" for="ph_value" style="color:#00008B;"><span id="for_ph_test_name_label"><sub>P</sub>H</span><span id="for_ph_test_name_label"></span> (Drop Test Method):</label>
					    ...
					    <div class="col-sm-1 text-center">
					      <label for="ph_value" style="font-size:12px; color:#000066;">Left</label>
					      <input type="text" class="form-control" id="ph_value_in_left_side_of_fabric" name="ph_value_in_left_side_of_fabric" value="<?php echo $row_for_mercerize['ph_value_in_left_side_of_fabric']?>" style="padding-right:4px;" required>
					    </div>
					    
					    
					    <div class="col-sm-2 text-center">
					      <label for="ph_value" style="font-size:12px; color:#000066;">Center</label>
					      <input type="text" class="form-control" id="ph_value_value_in_center_of_fabric" name="ph_value_value_in_center_of_fabric" value="<?php echo $row_for_mercerize['ph_value_value_in_center_of_fabric']?>" style="padding-right:4px;" required>
					    </div>

					    
					    <div class="col-sm-2 text-center" style="padding-right:4px;">
					      <label for="ph_value" style="font-size:12px; color:#000066;">Right</label>
					      <input type="text" class="form-control" id="ph_value_value_in_right_side_of_fabric" name="ph_value_value_in_right_side_of_fabric" value="<?php echo $row_for_mercerize['ph_value_value_in_right_side_of_fabric']?>" required>
					    </div>
					</div>  <!-- End <div class="form-group form-group-sm" id="form-group_for_whiteness_value"> -->
						...
						<div class="form-group form-group-sm" id="form-group_for_uom_of_ph">
								<!-- <label class="control-label col-sm-3" for="uom_of_ph" style="color:#00008B;">Uom Of Ph:</label> -->
								<div class="col-sm-5" style="padding-right:4px;">
									<input type="hidden" class="form-control" id="uom_of_ph" name="uom_of_ph" placeholder="Enter Uom Of Ph" value="value">
								</div>
						</div> <!-- End of <div class="form-group form-group-sm" id="form-group_for_"> -->
						...
						<input type="radio" class="form-check-input"  value="OK" id="status" name="status" <?php if($row_for_mercerize['status']=="OK"){ echo "checked";}?>>
								<label class="form-check-label control-label" for="status" style="margin-right:15px;">OK</label>
								<input type="radio" class="form-check-input"  value="Not OK" id="status" name="status" <?php if($row_for_mercerize['status']=="NOT OK"){ echo "checked";}?>>
						...
						<div class="form-group form-group-sm" id="form-group_for_remarks">
								...
								<div class="col-sm-5">
									<textarea class='form-control' id='remarks' name='remarks' rows='5' value="<?php echo $row_for_mercerize['remarks']?>"><?php echo $row_for_mercerize['remarks']?></textarea>
								</div>
						...
						<div class="form-group form-group-sm" id="form-group_for_current_state">
						   <label class="control-label col-sm-3" for="current_state" style="margin-right:15px;color:#00008B;">NOTE(IS IT A LAST PROCESS):</label>
								<input type="radio" class="form-check-input"  value="PP Completed" id="current_state" name="current_state" <?php if($row_for_mercerize['current_state']=="PP Completed"){ echo "checked";}?>>
								<label class="form-check-label control-label" for="current_state" style="margin-right:15px;">Yes</label>
								<input type="radio" class="form-check-input"  value="PP in progress" id="current_state" name="current_state" <?php if($row_for_mercerize['current_state']=="PP in progress"){ echo "checked";}?>>
						...
						<div class="form-group form-group-sm">
								<div class="col-sm-offset-3 col-sm-5">
									<button type="button" class="btn btn-primary" onClick="sending_data_of_qc_result_for_mercerize_process_form_for_saving_in_database()">Save</button>
