...
*/
 ...
 function sending_data_of_qc_result_for_mercerize_process_form_for_saving_in_database()
 {
       ...
       if(validate != false)
	   {
		  	 ...
		  	 $.ajax({
			 		url: 'process_qc_result/qc_result_for_mercerize_process_saving.php',
			 		dataType: 'text',
			 		type: 'post',
			 		contentType: 'application/x-www-form-urlencoded',
...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
			...
			<body id="target">
				...
				<div class="panel-heading" style="color:#191970;"><b>Qc Result For Mercerize Process</b></div> <!-- This will create a upper block for FORM (Just Beautification) -->
				...
				<div class="form-group form-group-sm" id="form-group_for_pp_number" onchange="Fill_Value_Of_Version_Number_Field(this.value)">
					...
					<div class="form-group form-group-sm" id="form-group_for_whiteness_value_in_fabric">
					    ...
					    <div class="col-sm-1 text-center">
					      ...
					      <input type="text" class="form-control" id="whiteness_value_in_left_side_of_fabric" name="whiteness_value_in_left_side_of_fabric" placeholder="Enter Whiteness Value In Left Side Of Fabric" style="padding-right:4px;" required>
					    </div>
					    
					    
					    <div class="col-sm-2 text-center">
					      <label for="whiteness_value" style="font-size:12px; color:#000066;">Center</label>
					      <input type="text" class="form-control" id="whiteness_value_in_center_of_fabric" name="whiteness_value_in_center_of_fabric" placeholder="Enter Whiteness Value In Center Side Of Fabric" style="padding-right:4px;" required>
					    </div>
					    ...
					    <div class="col-sm-2 text-center" style="padding-right:4px;">
					      ...
					      <input type="text" class="form-control" id="whiteness_value_in_right_side_of_fabric" name="whiteness_value_in_right_side_of_fabric" placeholder="Enter Whiteness Value In Right Side Of Fabric" required>
					    </div>
					...
					<div class="form-group form-group-sm" id="form-group_for_residual_sizing_material_value">
					    ...
					    <div class="col-sm-1 text-center">
					      ...
					      <input type="text" class="form-control" id="residual_sizing_value_in_left_side_of_fabric" name="residual_sizing_value_in_left_side_of_fabric" placeholder="Enter residual_sizing Value In Left Of Fabric" style="padding-right:4px;" required>
					    </div>
					    
					    
					    <div class="col-sm-2 text-center">
					      <label for="residual_sizing_value" style="font-size:12px; color:#000066;">Center</label>
					      <input type="text" class="form-control" id="residual_sizing_value_in_center_of_fabric" name="residual_sizing_value_in_center_of_fabric" placeholder="Enter residual_sizing Value In Center Of Fabric" style="padding-right:4px;" required>
					    </div>

					    
					    <div class="col-sm-2 text-center" style="padding-right:4px;">
					      <label for="residual_sizing_value" style="font-size:12px; color:#000066;">Right</label>
					      <input type="text" class="form-control" id="residual_sizing_value_in_right_side_of_fabric" name="residual_sizing_value_in_right_side_of_fabric" placeholder="Enter residual_sizing Value In Right Of Fabric" required>
					    </div>
					</div>  <!-- End <div class="form-group form-group-sm" id="form-group_for_whiteness_value"> -->
					...
					<div class="form-group form-group-sm" id="form-group_for_absorbency_value_in_left_side_of_fabric">
					    ...
					    <div class="col-sm-1 text-center">
					      ...
					      <input type="text" class="form-control" id="absorbency_value_in_left_side_of_fabric" name="absorbency_value_in_left_side_of_fabric" placeholder="Enter Absorbency Value In Left Side Of Fabric" style="padding-right:4px;" required>
					    </div>
					    
					    
					    <div class="col-sm-2 text-center">
					      <label for="absorbency_value" style="font-size:12px; color:#000066;">Center</label>
					      <input type="text" class="form-control" id="absorbency_value_in_center_of_fabric" name="absorbency_value_in_center_of_fabric" placeholder="Enter Absorbency Value In Center Of Fabric" style="padding-right:4px;" required>
					    </div>

					    
					    <div class="col-sm-2 text-center" style="padding-right:4px;">
					      <label for="absorbency_value" style="font-size:12px; color:#000066;">Right</label>
					      <input type="text" class="form-control" id="absorbency_value_in_right_side_of_fabric" name="absorbency_value_in_right_side_of_fabric" placeholder="Enter Absorbency Value In Right Of Fabric" required>
					    </div>
					...
					<div class="form-group form-group-sm" id="form-group_for_residual_sizing_material_value">
					   ...
					   <label class="control-label col-sm-3" for="ph_value" style="color:#00008B;"><span id="for_ph_test_name_label"><sub>P</sub>H</span><span id="for_ph_test_name_label"></span> (Drop Test Method):</label>
					    ...
					    <div class="col-sm-1 text-center">
					      ...
					      <input type="text" class="form-control" id="ph_value_in_left_side_of_fabric" name="ph_value_in_left_side_of_fabric" placeholder="Enter Ph Value In Left Of Fabric" style="padding-right:4px;" required>
					    </div>
					    
					    
					    <div class="col-sm-2 text-center">
					      <label for="ph_value" style="font-size:12px; color:#000066;">Center</label>
					      <input type="text" class="form-control" id="ph_value_value_in_center_of_fabric" name="ph_value_value_in_center_of_fabric" placeholder="Enter Ph Value In Center Of Fabric" style="padding-right:4px;" required>
					    </div>

					    
					    <div class="col-sm-2 text-center" style="padding-right:4px;">
					      <label for="ph_value" style="font-size:12px; color:#000066;">Right</label>
					      <input type="text" class="form-control" id="ph_value_value_in_right_side_of_fabric" name="ph_value_value_in_right_side_of_fabric" placeholder="Enter Ph Value In Right Of Fabric" required>
					    </div>
					</div>  <!-- End <div class="form-group form-group-sm" id="form-group_for_whiteness_value"> -->
						...
						<div class="form-group form-group-sm" id="form-group_for_uom_of_ph">
								...
								<div class="col-sm-5" style="padding-right:4px;">
									<input type="hidden" class="form-control" id="uom_of_ph" name="uom_of_ph" placeholder="Enter Uom Of Ph" value="">
								</div>
						</div> <!-- End of <div class="form-group form-group-sm" id="form-group_for_"> -->
						...
						<label class="control-label col-sm-3" for="current_state" style="margin-right:15px;color:#00008B;">NOTE(IS IT A LAST PROCESS):</label>
								...
								<i class="glyphicon glyphicon-remove" onclick="Reset_Radio_Button('current_state')" style="margin-top:6px;"></i>
						</div> <!-- End of <div class="form-group form-group-sm" id="form-group_for_current_state"> -->

						<div class="form-group form-group-sm">
								<div class="col-sm-offset-3 col-sm-5">
									<button type="button" class="btn btn-primary" onClick="sending_data_of_qc_result_for_mercerize_process_form_for_saving_in_database()">Submit</button>
