...
// $sql_qc_bleaching="select id from qc_result_for_bleaching_process where pp_number = '$trf_pp_number'";
// $res_sql_qc_bleaching=mysqli_query($con,$sql_qc_bleaching) or die(mysqli_error($con));
// $row_for_id=mysqli_fetch_assoc($res_sql_qc_bleaching);

// $bleaching_id = $row_for_id['id'];


$sql_for_bleaching="select * from qc_result_for_bleaching_process where pp_number = '$trf_pp_number' and 
...
$row_for_bleaching = mysqli_fetch_array( $result_for_bleaching);
?>
...
<script type='text/javascript' src='process_qc_result/qc_result_for_bleaching_process_form_validation.js'></script>
...
{   
	var db_table_name="defining_qc_standard_for_bleaching_process";
...
*/  
 ...
 function sending_data_of_qc_result_for_bleaching_process_form_for_saving_in_database()
 {


       var validate = Bleaching_Form_Validation();
       var url_encoded_form_data = $("#qc_result_for_bleaching_process_form").serialize(); //This will read all control elements value of the form	
       if(validate != false)
	   {


		  	 $.ajax({
			 		url: 'process_qc_result/edit_qc_result_for_bleaching_process_saving.php',
			 		dataType: 'text',
			 		type: 'post',
			 		contentType: 'application/x-www-form-urlencoded',
 ...
 }//End of function sending_data_of_qc_result_for_bleaching_process_form_for_saving_in_database()
...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<body id="target">
			...
			<div class="panel-heading" style="color:#191970;"><b>Qc Result For Bleaching Process / <a href="">Edit</a></b></div> <!-- This will create a upper block for FORM (Just Beautification) -->

				<form class="form-horizontal" action="" style="margin-top:10px;" name="qc_result_for_bleaching_process_form" id="qc_result_for_bleaching_process_form">
				...
				<div class="form-group form-group-sm" id="form-group_for_pp_number" onchange="Fill_Value_Of_Version_Number_Field(this.value)">
					...
					<!-- 	<div class="form-group form-group-sm" id="form-group_for_total_short_or_excess_in_percentage">
						...
						<div class="form-group form-group-sm" id="form-group_for_whiteness_value">
								<label class="control-label col-sm-3" for="whiteness_value" style="color:#00008B;">Whiteness-Berger:</label>
								<div class="col-sm-5" style="padding-right:4px;">
									<input type="text" class="form-control" id="whiteness_value" name="whiteness_value" value="<?php echo $row_for_bleaching['whiteness_value']?>" required>
								</div>
						</div> <!-- End of <div class="form-group form-group-sm" id="form-group_for_"> -->
                       ...
                       <div class="form-group form-group-sm" id="form-group_for_residual_sizing_material_value">
								...
								<div class="col-sm-5" style="padding-right:4px;">
									<input type="text" class="form-control" id="residual_sizing_material_value" name="residual_sizing_material_value" value="<?php echo $row_for_bleaching['residual_sizing_material_value']?>" required>
								</div>
						</div> <!-- End of <div class="form-group form-group-sm" id="form-group_for_"> -->

						<div class="form-group form-group-sm" id="form-group_for_uom_of_residual_sizing_material">
								<!-- <label class="control-label col-sm-3" for="uom_of_residual_sizing_material" style="color:#00008B;">Uom Of Residual Sizing Material:</label> -->
								<div class="col-sm-5" style="padding-right:4px;">
									<input type="hidden" class="form-control" id="uom_of_residual_sizing_material" name="uom_of_residual_sizing_material" placeholder="Enter Uom Of Residual Sizing Material" value="value">
								</div>
						</div> <!-- End of <div class="form-group form-group-sm" id="form-group_for_"> -->
						...
						<div class="form-group form-group-sm" id="form-group_for_absorbency_value">
								...
								<div class="col-sm-5" style="padding-right:4px;">
									<input type="text" class="form-control" id="absorbency_value" name="absorbency_value" value="<?php echo $row_for_bleaching['absorbency_value']?>" required>
								</div>
						</div> <!-- End of <div class="form-group form-group-sm" id="form-group_for_"> -->

						<div class="form-group form-group-sm" id="form-group_for_uom_of_absorbency">
								<!-- <label class="control-label col-sm-3" for="uom_of_absorbency" style="color:#00008B;">Uom Of Absorbency:</label> -->
								<div class="col-sm-5" style="padding-right:4px;">
									<input type="hidden" class="form-control" id="uom_of_absorbency" name="uom_of_absorbency" placeholder="Enter Uom Of Absorbency" value="value">
								</div>
						</div> <!-- End of <div class="form-group form-group-sm" id="form-group_for_"> -->


						<div class="form-group form-group-sm" id="form-group_for_resistance_to_surface_fuzzing_and_pilling_value">
								<label class="control-label col-sm-3" for="resistance_to_surface_fuzzing_and_pilling_value" style="color:#00008B;"><span id="for_resistance_to_surface_fuzzing_and_pilling_test_name_label">Resistance to Surface Fuzzing and Pilling</span><span id="for_resistance_to_surface_fuzzing_and_pilling_test_method"> (ISO 12945-2):</label>
								<div class="col-sm-5" style="padding-right:4px;">
									<input type="text" class="form-control" id="resistance_to_surface_fuzzing_and_pilling_value" name="resistance_to_surface_fuzzing_and_pilling_value" value="<?php echo $row_for_bleaching['resistance_to_surface_fuzzing_and_pilling_value']?>" required>
								</div>
						</div> <!-- End of <div class="form-group form-group-sm" id="form-group_for_"> -->

						<div class="form-group form-group-sm" id="form-group_for_uom_of_resistance_to_surface_fuzzing_and_pilling">
								<!-- <label class="control-label col-sm-3" for="uom_of_resistance_to_surface_fuzzing_and_pilling" style="color:#00008B;">Uom Of Resistance to Surface Fuzzing and Pilling:</label> -->
								<div class="col-sm-5" style="padding-right:4px;">
									<input type="hidden" class="form-control" id="uom_of_resistance_to_surface_fuzzing_and_pilling" name="uom_of_resistance_to_surface_fuzzing_and_pilling" placeholder="Enter Uom Of Resistance to Surface Fuzzing and Pilling" value="value">
								</div>
						</div> <!-- End of <div class="form-group form-group-sm" id="form-group_for_"> -->
						...
						<div class="form-group form-group-sm" id="form-group_for_ph_value">
								...
								<div class="col-sm-5" style="padding-right:4px;">
									<input type="text" class="form-control" id="ph_value" name="ph_value" value="<?php echo $row_for_bleaching['ph_value']?>" required>
								</div>
						...
						<label class="control-label col-sm-3" for="status" style="margin-right:15px;color:#00008B;">Status:</label>
								<input type="radio" class="form-check-input"  value="OK" id="status" name="status" <?php if($row_for_bleaching['status']=="OK"){ echo "checked";}?>>
								<label class="form-check-label control-label" for="status" style="margin-right:15px;">OK</label>
								<input type="radio" class="form-check-input"  value="Not OK" id="status" name="status"  <?php if($row_for_bleaching['status']=="Not OK"){ echo "checked";}?>>
						...
						<div class="form-group form-group-sm" id="form-group_for_remarks">
								...
								<div class="col-sm-5" style="padding-right:4px;">
									<textarea type="text" class="form-control" id="remarks" name="remarks" value="<?php echo $row_for_bleaching['remarks']?>" required> <?php echo $row_for_bleaching['remarks']?></textarea>
								</div>
						</div> <!-- End of <div class="form-group form-group-sm" id="form-group_for_"> -->
						...
						<div class="form-group form-group-sm" id="form-group_for_current_state">
						   <label class="control-label col-sm-3" for="current_state" style="margin-right:15px;color:#00008B;">NOTE(IS IT A LAST PROCESS):</label>
								<input type="radio" class="form-check-input"  value="PP Completed" id="current_state" name="current_state" <?php if($row_for_bleaching['current_state']=="PP Completed"){ echo "checked";}?>>
								<label class="form-check-label control-label" for="current_state" style="margin-right:15px;">Yes</label>
								<input type="radio" class="form-check-input"  value="PP in progress" id="current_state" name="current_state" <?php if($row_for_bleaching['current_state']=="PP in progress"){ echo "checked";}?>>
						...
						<div class="form-group form-group-sm">
								<div class="col-sm-offset-3 col-sm-5">
									<button type="button" class="btn btn-primary" onClick="sending_data_of_qc_result_for_bleaching_process_form_for_saving_in_database()">Save</button>
