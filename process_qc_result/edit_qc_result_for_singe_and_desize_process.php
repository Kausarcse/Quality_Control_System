...
// $sql_qc_singe_and_desize="select id from qc_result_for_singe_and_desize_process where pp_number = '$trf_pp_number'";
// $res_sql_qc_singe_and_desize=mysqli_query($con,$sql_qc_singe_and_desize) or die(mysqli_error($con));
// $row_for_id=mysqli_fetch_assoc($res_sql_qc_singe_and_desize);

// $singe_and_desize_id = $row_for_id['id'];


$sql_for_singe_desige="select * from qc_result_for_singe_and_desize_process where pp_number = '$trf_pp_number' and 
...
//  echo $row_for_singe_desige['id'];
//  echo $row_for_singe_desige['pp_number'];

?>


<script type='text/javascript' src='process_qc_result/qc_result_for_singe_and_desize_process_form_validation.js'></script>
...
{   
	var db_table_name="defining_qc_standard_for_singe_and_desize_process";
...
*/  
 ...
 function sending_data_of_qc_result_for_singe_and_desize_process_form_for_saving_in_database()
 {


       var validate = Singe_And_Desize_Form_Validation();
       var url_encoded_form_data = $("#qc_result_for_singe_and_desize_process_form").serialize(); //This will read all control elements value of the form	
       if(validate != false)
	   {


		  	 $.ajax({
			 		url: 'process_qc_result/edit_qc_result_for_singe_and_desize_process_saving.php',
			 		dataType: 'text',
			 		type: 'post',
			 		contentType: 'application/x-www-form-urlencoded',
...
*/			 				}
 ...
 }//End of function sending_data_of_qc_result_for_singe_and_desize_process_form_for_saving_in_database()
...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
			...
			<body id="target">
				...
				<div class="panel-heading" style="color:#191970;"><b>Qc Result For Singe And Desize Process / <a href="#">Edit</a></b></div> <!-- This will create a upper block for FORM (Just Beautification) -->

				<form class="form-horizontal" action="" style="margin-top:10px;" name="qc_result_for_singe_and_desize_process_form" id="qc_result_for_singe_and_desize_process_form">
...
<div id="div_flame_intensity">
      ...
      <div class="form-group form-group-sm" id="form-group_for_flame_intensity_value">
         ...
         <div class="col-sm-2 text-center">
            ...
            <div class="col-sm-2 text-center">
             ...
             <input type="text" class="form-control" id="flame_intensity_value" name="flame_intensity_value" value="<?php echo $row_for_singe_desige['flame_intensity_value']?>" required>
      ...
      <div class="form-group form-group-sm" id="form-group_for_machine_speed_value">
         ...
         <div class="col-sm-2 text-center">
            ...
            <div class="col-sm-2 text-center">
             ...
             <input type="text" class="form-control" id="machine_speed" name="machine_speed" value="<?php echo $row_for_singe_desige['machine_speed']?>" required>
 ...
 <div id="div_bath_temperature">


      <div class="form-group form-group-sm" id="form-group_for_bath_temperature_value">
              
                    <label class="control-label col-sm-3" for="bath_temperature_value" style="color:#00008B;"><span id="for_bath_temperature_test_name_label">Bath Temperature</span><span id="bath_temperature_test_method"></span></label>
         ...
         <div class="col-sm-2 text-center">
                  <!-- <label for="description_or_type" style="font-size:12px; color:#000066;">Direction/Type</label> -->
                  <label class="control-label" for="description_or_type" style="color:#00008B;"> </label>
                  <input type="hidden" class="form-control" id="bath_temperature_test_method" name="bath_temperature_test_method" value="%">
            ...
            <div class="col-sm-2 text-center">
             ...
             <input type="text" class="form-control" id="bath_temperature" name="bath_temperature" value="<?php echo $row_for_singe_desige['bath_temperature']?>" required>

           </div>

           <div class="col-sm-2 text-center" id="form-group_for_uom_of_bath_temperature" style="display: none;">
								<label class="control-label col-sm-3" for="uom_of_bath_temperature" style="color:#00008B;">Uom Of Bath Temperature:</label>
								<div class="col-sm-5" style="padding-right:4px;">
									<input type="text" class="form-control" id="uom_of_bath_temperature" name="uom_of_bath_temperature" placeholder="Enter Uom Of Bath Temperature" required>
								</div>
	      </div> <!-- End of <div class="form-group form-group-sm" id="form-group_for_"> -->
                
       
     </div><!-- End of <div class="form-group form-group-sm" id+"group_for_bath_temperature_value">-->

 </div>  <!-- End of <div id="div_bath_temperature"> -->
						
					
						
 <div id="div_bath_ph">  <!-- start of <div id="div_bath_ph"> -->

						<div class="form-group form-group-sm" id="form-group_for_bath_ph">
								<label class="control-label col-sm-3" for="bath_ph" style="color:#00008B;"><span id="for_bath_ph_test_name_label">Bath Ph</span><span id="for_bath_ph_test_method"> (Merck Universal Indicator)</span></label>
								...
								<div class="col-sm-1 text-center">
           						...
           						<div class="col-sm-2 text-center">
					                  <!-- <label for="description_or_type" style="font-size:12px; color:#000066;">Direction/Type</label> -->
					                  <label class="control-label" for="description_or_type" style="color:#00008B;"> </label>
					                  <input type="hidden" class="form-control" id="bath_ph_test_method" name="bath_ph_test_method" value="no value">

					           </div>

								<div class="col-sm-2" style="padding-right:4px;">
									<input type="text" class="form-control" id="bath_ph" name="bath_ph" value="<?php echo $row_for_singe_desige['bath_ph']?>" required>
								</div>


									<input type="hidden" class="form-control" id="uom_of_bath_ph" name="uom_of_bath_ph" value="value">
								
		</div> <!-- End of <div class="form-group form-group-sm" id="form-group_for_"> -->
</div><!-- End of <div id="div_bath_ph"> -->
						...
						<label class="control-label col-sm-3" for="status" style="margin-right:15px;color:#00008B;">Status:</label>
								<input type="radio" class="form-check-input"  value="OK" id="status" name="status" <?php if($row_for_singe_desige['status']=="OK"){ echo "checked";}?>>
								<label class="form-check-label control-label" for="status" style="margin-right:15px;">OK</label>
								<input type="radio" class="form-check-input"  value="Not OK" id="status" name="status" <?php if($row_for_singe_desige['status']=="Not OK"){ echo "checked";}?>>
							...
							<div class="form-group form-group-sm" id="form-group_for_remarks">
								...
								<div class="col-sm-5">
									<textarea class='form-control' id='remarks' name='remarks' rows='5' value="<?php echo $row_for_singe_desige['remarks']?>"><?php echo $row_for_singe_desige['remarks']?></textarea>
								</div>
						...
						<div class="form-group form-group-sm" id="form-group_for_current_state">
						   <label class="control-label col-sm-3" for="current_state" style="margin-right:15px;color:#00008B;">NOTE(IS IT A LAST PROCESS):</label>
								<input type="radio" class="form-check-input"  value="PP Completed" id="current_state" name="current_state" <?php if($row_for_singe_desige['current_state']=="PP Completed"){ echo "checked";}?>>
								<label class="form-check-label control-label" for="current_state" style="margin-right:15px;">Yes</label>
								<input type="radio" class="form-check-input"  value="PP in progress" id="current_state" name="current_state" <?php if($row_for_singe_desige['current_state']=="PP in progress"){ echo "checked";}?>>
						...
						<div class="form-group form-group-sm">
								<div class="col-sm-offset-3 col-sm-5">
									<button type="button" class="btn btn-primary" onClick="sending_data_of_qc_result_for_singe_and_desize_process_form_for_saving_in_database()">Save</button>
