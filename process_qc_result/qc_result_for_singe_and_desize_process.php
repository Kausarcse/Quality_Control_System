...
*/  
  ...
  document.getElementById('customer_id').value=splitted_version_details[4]; 
  document.getElementById('version_id').value=splitted_version_details[5]; */
 ...
 function sending_data_of_qc_result_for_singe_and_desize_process_form_for_saving_in_database()
 {
       ...
       if(validate != false)
	   {
		  	 ...
		  	 $.ajax({
			 		url: 'process_qc_result/qc_result_for_singe_and_desize_process_saving.php',
			 		dataType: 'text',
			 		type: 'post',
			 		contentType: 'application/x-www-form-urlencoded',
...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
			...
			<body id="target">
				...
				<div class="panel-heading" style="color:#191970;"><b>Qc Result For Singe And Desize Process</b></div> <!-- This will create a upper block for FORM (Just Beautification) -->
      ...
      <div class="form-group form-group-sm" id="form-group_for_flame_intensity_value">
         ...
         <div class="col-sm-2 text-center">
            ...
            <div class="col-sm-2 text-center">
             ...
             <input type="text" class="form-control" id="flame_intensity_value" name="flame_intensity_value" placeholder="Enter  Value" required>
      ...
      <div class="form-group form-group-sm" id="form-group_for_machine_speed_value">
         ...
         <div class="col-sm-2 text-center">
            ...
            <div class="col-sm-2 text-center">
             ...
             <input type="text" class="form-control" id="machine_speed" name="machine_speed" placeholder="Enter  Value" required>
      ...
      <div class="form-group form-group-sm" id="form-group_for_bath_temperature_value">
         ...
         <div class="col-sm-2 text-center">
            ...
            <div class="col-sm-2 text-center">
             ...
             <input type="text" class="form-control" id="bath_temperature" name="bath_temperature" placeholder="Enter Value" required>
 ...
 <div id="div_bath_ph">  <!-- start of <div id="div_bath_ph"> -->
						...
						<div class="form-group form-group-sm" id="form-group_for_bath_ph">
								...
								<div class="col-sm-2" style="padding-right:4px;">
									<input type="text" class="form-control" id="bath_ph" name="bath_ph" placeholder="Enter Ph" required>
								</div>
						...
						<div class="form-group form-group-sm">
								<div class="col-sm-offset-3 col-sm-5">
									<button type="button" class="btn btn-primary" onClick="sending_data_of_qc_result_for_singe_and_desize_process_form_for_saving_in_database()">Submit</button>
