...
// $sql_qc_scouring_bleaching="select id from qc_result_for_scouring_bleaching_process where pp_number = '$trf_pp_number'";
// $res_sql_qc_scouring_bleaching=mysqli_query($con,$sql_qc_scouring_bleaching) or die(mysqli_error($con));
// $row_for_id=mysqli_fetch_assoc($res_sql_qc_scouring_bleaching);

// $scouring_bleaching_id = $row_for_id['id'];


$sql_for_scouring_bleaching="select * from qc_result_for_scouring_bleaching_process where pp_number = '$trf_pp_number' and 
...
$row_for_scouring_bleaching = mysqli_fetch_array( $result_for_scouring_bleaching);
?>
...
*/  
 ...
 function sending_data_of_qc_result_for_scouring_bleaching_process_form_for_saving_in_database()
 {
       ...
       if(validate != false)
	   {
		  	 ...
		  	 $.ajax({
			 		url: 'process_qc_result/edit_qc_result_for_scouring_bleaching_process_saving.php',
			 		dataType: 'text',
			 		type: 'post',
			 		contentType: 'application/x-www-form-urlencoded',
...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
			...
			<body id="target">
				...
				<div class="panel-heading" style="color:#191970;"><b>Qc Result For Scouring Bleaching Process / <a href="#">Edit</a></b></div> <!-- This will create a upper block for FORM (Just Beautification) -->
				...
				<div class="form-group form-group-sm" id="form-group_for_pp_number" onchange="Fill_Value_Of_Version_Number_Field(this.value)">
						<label class="control-label col-sm-3" for="pp_number" style="margin-right:0px; color:#00008B;">PP Number:</label>
							<div class="col-sm-5">
								...
								<i class="glyphicon glyphicon-remove" onclick="reset_dropdown('pp_number')" style="margin-top:6px;"></i>
		 		...
		 		<div class="form-group form-group-sm" id="form-group_for_whiteness_value">
			              ...
			              <div class="col-sm-2 text-center">
			                ...
			                <input type="text" class="form-control" id="whiteness_left_value" name="whiteness_left_value" value="<?php echo $row_for_scouring_bleaching['whiteness_left_value'] ?>" style="padding-right:4px;" required>
			              </div>
			              
			              
			              <div class="col-sm-2 text-center">
			                <label for="whiteness_value" style="font-size:12px; color:#000066;">Center</label>
			                <input type="text" class="form-control" id="whiteness_center_value" name="whiteness_center_value" value="<?php echo $row_for_scouring_bleaching['whiteness_center_value'] ?>" style="padding-right:4px;" required>
			              </div>

			              <div class="col-sm-2 text-center">
			                <label for="whiteness_value" style="font-size:12px; color:#000066;">Right</label>
			                <input type="text" class="form-control" id="whiteness_right_value" name="whiteness_right_value" value="<?php echo $row_for_scouring_bleaching['whiteness_right_value'] ?>" style="padding-right:4px;" required>
			              </div>
			   ...
			   <div class="form-group form-group-sm" id="form-group_for_residual_sizing_material_value">
                   ...
                   <label class="control-label col-sm-3" for="residual_sizing_material_value" style="color:#00008B;"><span id="for_residual_sizing_material_test_name_label">Residual Sizing Material</span><span id="for_residual_sizing_material_test_method"> (Drop Test Method):</span></label>
                    ...
                    <div class="col-sm-2 text-center">
                      ...
                      <input type="text" class="form-control" id="residual_sizing_material_left_value" name="residual_sizing_material_left_value"  value="<?php echo $row_for_scouring_bleaching['residual_sizing_material_left_value'] ?>" style="padding-right:4px;" required>
                    </div>
                    
                    
                    <div class="col-sm-2 text-center">
                      <label for="residual_sizing_material_value" style="font-size:12px; color:#000066;">Center</label>
                      <input type="text" class="form-control" id="residual_sizing_material_center_value" name="residual_sizing_material_center_value" value="<?php echo $row_for_scouring_bleaching['residual_sizing_material_center_value'] ?>" style="padding-right:4px;" required>
                    </div>

                    <div class="col-sm-2 text-center">
                      <label for="residual_sizing_material_value" style="font-size:12px; color:#000066;">Right</label>
                      <input type="text" class="form-control" id="residual_sizing_material_right_value" name="residual_sizing_material_right_value" value="<?php echo $row_for_scouring_bleaching['residual_sizing_material_right_value'] ?>" style="padding-right:4px;" required>
                    </div>
	      	...
	      	<div class="form-group form-group-sm" id="form-group_for_absorbency_value">
                   ...
                   <label class="control-label col-sm-3" for="absorbency_value" style="color:#00008B;"><span id="for_absorbency_test_name_label">Absorbency</span><span id="for_absorbency_test_method"> (Capillary Method):</span></label>
                    ...
                    <div class="col-sm-2 text-center">
                      ...
                      <input type="text" class="form-control" id="absorbency_left_value" name="absorbency_left_value" value="<?php echo $row_for_scouring_bleaching['absorbency_left_value'] ?>" style="padding-right:4px;" required>
                    </div>
                    
                    
                    <div class="col-sm-2 text-center">
                      <label for="absorbency_value" style="font-size:12px; color:#000066;">Center</label>
                      <input type="text" class="form-control" id="absorbency_center_value" name="absorbency_center_value" value="<?php echo $row_for_scouring_bleaching['absorbency_center_value'] ?>" style="padding-right:4px;" required>
                    </div>

                    <div class="col-sm-2 text-center">
                      <label for="absorbency_value" style="font-size:12px; color:#000066;">Right</label>
                      <input type="text" class="form-control" id="absorbency_right_value" name="absorbency_right_value" value="<?php echo $row_for_scouring_bleaching['absorbency_right_value'] ?>" style="padding-right:4px;" required>
                    </div>
            ...
            <div class="form-group form-group-sm" id="form-group_for_resistance_to_surface_fuzzing_and_pilling_value">
                    ...
                    <div class="col-sm-2 text-center">
                      ...
                      <input type="text" class="form-control" id="resistance_to_surface_fuzzing_and_pilling_left_value" name="resistance_to_surface_fuzzing_and_pilling_left_value" value="<?php echo $row_for_scouring_bleaching['resistance_to_surface_fuzzing_and_pilling_left_value'] ?>" style="padding-right:4px;" required>
                    </div>
                    
                    
                    <div class="col-sm-2 text-center">
                      <label for="resistance_to_surface_fuzzing_and_pilling_value" style="font-size:12px; color:#000066;">Center</label>
                      <input type="text" class="form-control" id="resistance_to_surface_fuzzing_and_pilling_center_value" name="resistance_to_surface_fuzzing_and_pilling_center_value" value="<?php echo $row_for_scouring_bleaching['resistance_to_surface_fuzzing_and_pilling_center_value'] ?>" style="padding-right:4px;" required>
                    </div>

                    <div class="col-sm-2 text-center">
                      <label for="resistance_to_surface_fuzzing_and_pilling_value" style="font-size:12px; color:#000066;">Right</label>
                      <input type="text" class="form-control" id="resistance_to_surface_fuzzing_and_pilling_right_value" name="resistance_to_surface_fuzzing_and_pilling_right_value" value="<?php echo $row_for_scouring_bleaching['resistance_to_surface_fuzzing_and_pilling_right_value'] ?>" style="padding-right:4px;" required>
                    </div>
                ...
                <div class="col-sm-6" style="padding-right:4px;">
                  <input type="hidden" class="form-control" id="uom_of_resistance_to_surface_fuzzing_and_pilling" name="uom_of_resistance_to_surface_fuzzing_and_pilling" placeholder="Enter Uom Of resistance_to_surface_fuzzing_and_pilling" required>
                    ...
                    <div class="form-group form-group-sm" id="form-group_for_ph_value">
				              ...
				              <div class="col-sm-2 text-center">
				                <label for="whiteness_value" style="font-size:12px; color:#000066;">Left</label>
				                <input type="text" class="form-control" id="ph_left_value" name="ph_left_value" value="<?php echo $row_for_scouring_bleaching['ph_left_value'] ?>" style="padding-right:4px;" required>
				              </div>
				              
				              
				              <div class="col-sm-2 text-center">
				                <label for="whiteness_value" style="font-size:12px; color:#000066;">Center</label>
				                <input type="text" class="form-control" id="ph_center_value" name="ph_center_value" value="<?php echo $row_for_scouring_bleaching['ph_center_value'] ?>" style="padding-right:4px;" required>
				              </div>

				              <div class="col-sm-2 text-center">
				                <label for="whiteness_value" style="font-size:12px; color:#000066;">Right</label>
				                <input type="text" class="form-control" id="ph_right_value" name="ph_right_value" value="<?php echo $row_for_scouring_bleaching['ph_right_value'] ?>" style="padding-right:4px;" required>
				              </div>
						...
						<label class="control-label col-sm-3" for="status" style="margin-right:15px;color:#00008B;">Status:</label>
								<input type="radio" class="form-check-input"  value="OK" id="status" name="status" <?php if($row_for_scouring_bleaching['status']=="OK"){ echo "checked";}?>>
								<label class="form-check-label control-label" for="status" style="margin-right:15px;">OK</label>
								<input type="radio" class="form-check-input"  value="Not OK" id="status" name="status" <?php if($row_for_scouring_bleaching['status']=="Not OK"){ echo "checked";}?>>
						...
						<div class="form-group form-group-sm" id="form-group_for_remarks">
								...
								<div class="col-sm-6">
									<textarea class='form-control' id='remarks' name='remarks' rows='5' value="<?php echo $row_for_scouring_bleaching['remarks'] ?>"><?php echo $row_for_scouring_bleaching['remarks'] ?></textarea>
								</div>
						...
						<div class="form-group form-group-sm" id="form-group_for_current_state">
						   <label class="control-label col-sm-3" for="current_state" style="margin-right:15px;color:#00008B;">NOTE(IS IT A LAST PROCESS):</label>
								<input type="radio" class="form-check-input"  value="PP Completed" id="current_state" name="current_state" <?php if($row_for_scouring_bleaching['current_state']=="PP Completed"){ echo "checked";}?>>
								<label class="form-check-label control-label" for="current_state" style="margin-right:15px;">Yes</label>
								<input type="radio" class="form-check-input"  value="PP in progress" id="current_state" name="current_state" <?php if($row_for_scouring_bleaching['current_state']=="PP in progress"){ echo "checked";}?>>
						...
						<div class="form-group form-group-sm">
								<div class="col-sm-offset-3 col-sm-6">
									<button type="button" class="btn btn-primary" onClick="sending_data_of_qc_result_for_scouring_bleaching_process_form_for_saving_in_database()">Save</button>
