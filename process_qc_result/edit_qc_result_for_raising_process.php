...
// $sql_qc_raising="select id from qc_result_for_raising_process where pp_number = '$trf_pp_number'";
// $res_sql_qc_raising=mysqli_query($con,$sql_qc_raising) or die(mysqli_error($con));
// $row_for_id=mysqli_fetch_assoc($res_sql_qc_raising);

// $raising_id = $row_for_id['id'];


$sql_for_raising="select * from qc_result_for_raising_process where pp_number = '$trf_pp_number' and 
...
$row_for_raising = mysqli_fetch_array( $result_for_raising);

?>



<script type='text/javascript' src='process_qc_result/qc_result_for_raising_process_form_validation.js'></script>
...
{
	var db_table_name="defining_qc_standard_for_raising_process";
...
*/
 ...
 function sending_data_of_qc_result_for_raising_process_form_for_saving_in_database()
 {


       var validate = raising_Form_Validation();
       var url_encoded_form_data = $("#qc_result_for_raising_process_form").serialize(); //This will read all control elements value of the form
       if(validate != false)
	   {


		  	 $.ajax({
			 		url: 'process_qc_result/edit_qc_result_for_raising_process_saving.php',
			 		dataType: 'text',
			 		type: 'post',
			 		contentType: 'application/x-www-form-urlencoded',
...
*/			 				}
 ...
 }//End of function sending_data_of_qc_result_for_raising_process_form_for_saving_in_database()
...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
			...
			<body id="target">
				...
				<div class="panel-heading" style="color:#191970;"><b>Qc Result For Raising Process / <a href="#">Edit</a></b></div> <!-- This will create a upper block for FORM (Just Beautification) -->

				<form class="form-horizontal" action="" style="margin-top:10px;" name="qc_result_for_raising_process_form" id="qc_result_for_raising_process_form">
					...
					<!-- 	<div class="form-group form-group-sm" id="form-group_for_total_short_or_excess_in_percentage">
						...
						<div class="form-group form-group-sm" id="form-group_for_machine_name">
							...
							<div class="form-group form-group-sm" id="form-group_for_face_back">
							    ...
							    <div class="col-sm-5" style="padding-right:4px;">
							      <input type="text" class="form-control" id="face_back" name="face_back" value="<?php echo $row_for_raising['face_back'] ?>" required>
							    </div>
 ...
 <div id="div_tensile_properties" >
     ...
     <div class="form-group form-group-sm" id="form-group_for_tensile_properties_in_warp_value">
              
                    <label class="control-label col-sm-3" for="tensile_properties_in_warp_value" style="color:#00008B;"><span id="for_tensile_properties_in_warp_test_name_label">Tensile Properties </span><span id="tensile_properties_in_warp_test_method">(ISO 7211-5)</span></label>
         ...
         <div class="col-sm-2 text-center">
            ...
            <div class="col-sm-2 text-center">
             ...
             <input type="text" class="form-control" id="tensile_properties_in_warp_value" name="tensile_properties_in_warp_value" value="<?php echo $row_for_raising['tensile_properties_in_warp_value']?>" required>
      ...
      <div class="form-group form-group-sm" id="form-group_for_tensile_properties_in_weft_value">
         ...
         <div class="col-sm-2 text-center">
            ...
            <div class="col-sm-2 text-center">
             ...
             <input type="text" class="form-control" id="tensile_properties_in_weft_value" name="tensile_properties_in_weft_value" value="<?php echo $row_for_raising['tensile_properties_in_weft_value']?>" required>
...
<div id="div_tear_force">
     ...
     <div class="form-group form-group-sm" id="form-group_for_tear_force_in_warp_value">
                    ...
                    <label class="control-label col-sm-3" for="tear_force_in_warp_value" style="color:#00008B;"><span id="for_tear_force_in_warp_test_name_label"  style="display: none;">Tear Force </span><span id="tear_force_in_warp_test_method"  style="display: none;">(ISO 7211-5)</span></label>
         ...
         <div class="col-sm-2 text-center">
            ...
            <div class="col-sm-2 text-center">
             ...
             <input type="text" class="form-control" id="tear_force_in_warp_value" name="tear_force_in_warp_value" value="<?php echo $row_for_raising['tear_force_in_warp_value']?>" required>
      ...
      <div class="form-group form-group-sm" id="form-group_for_tear_force_in_weft_value">
                    ...
                    <label class="control-label col-sm-3" for="tear_force_in_weft_value" style="color:#00008B;"><span id="for_tear_force_in_weft_test_name_label">Tear Force </span><span id="tear_force_in_weft_test_method">(ISO 7211-5)</span></label>
         ...
         <div class="col-sm-2 text-center">
            ...
            <div class="col-sm-2 text-center">
             ...
             <input type="text" class="form-control" id="tear_force_in_weft_value" name="tear_force_in_weft_value" value="<?php echo $row_for_raising['tear_force_in_weft_value']?>" required>
            ...
            <input type="hidden" class="form-control" id="uom_of_tear_force_in_weft" name="uom_of_tear_force_in_weft" value="%" >  
							...
							<label class="control-label col-sm-3" for="hand_feel" style="margin-right:15px;color:#00008B;">hand_feel:</label>
									<input type="radio" class="form-check-input"  value="OK" id="hand_feel" name="hand_feel" <?php if($row_for_raising['hand_feel']=="OK"){ echo "checked";}?>>
									<label class="form-check-label control-label" for="hand_feel" style="margin-right:15px;">OK</label>
									<input type="radio" class="form-check-input"  value="Not OK" id="hand_feel" name="hand_feel" <?php if($row_for_raising['hand_feel']=="Not OK"){ echo "checked";}?>>
								...
								<div class="form-group form-group-sm" id="form-group_for_raising_quality">
								<label class="control-label col-sm-3" for="raising_quality" style="margin-right:15px;color:#00008B;">raising_quality:</label>
										<input type="radio" class="form-check-input"  value="OK" id="raising_quality" name="raising_quality" <?php if($row_for_raising['raising_quality']=="OK"){ echo "checked";}?>>
										<label class="form-check-label control-label" for="raising_quality" style="margin-right:15px;">OK</label>
										<input type="radio" class="form-check-input"  value="Not OK" id="raising_quality" name="raising_quality" <?php if($row_for_raising['raising_quality']=="Not OK"){ echo "checked";}?>>
										<label class="form-check-label control-label" for="raising_quality" style="margin-right:15px;">Not OK</label>
								</div> <!-- End of <div class="form-group form-group-sm" id="form-group_for_raising_quality"> -->
							...
							<label class="control-label col-sm-3" for="status" style="margin-right:15px;color:#00008B;">Status:</label>
									<input type="radio" class="form-check-input"  value="OK" id="status" name="status" <?php if($row_for_raising['status']=="OK"){ echo "checked";}?>>
									<label class="form-check-label control-label" for="status" style="margin-right:15px;">OK</label>
									<input type="radio" class="form-check-input"  value="Not OK" id="status" name="status" <?php if($row_for_raising['status']=="Not OK"){ echo "checked";}?>>
						...
						<div class="form-group form-group-sm" id="form-group_for_remarks">
								...
								<div class="col-sm-5" style="padding-right:4px;">
									<textarea type="text" class="form-control" id="remarks" name="remarks" value="<?php echo $row_for_raising['remarks']?>" required><?php echo $row_for_raising['remarks']?></textarea>
								</div>
						</div> <!-- End of <div class="form-group form-group-sm" id="form-group_for_"> -->
						...
						<div class="form-group form-group-sm" id="form-group_for_current_state">
						   <label class="control-label col-sm-3" for="current_state" style="margin-right:15px;color:#00008B;">NOTE(IS IT A LAST PROCESS):</label>
								<input type="radio" class="form-check-input"  value="PP Completed" id="current_state" name="current_state" <?php if($row_for_raising['current_state']=="PP Completed"){ echo "checked";}?>>
								<label class="form-check-label control-label" for="current_state" style="margin-right:15px;">Yes</label>
								<input type="radio" class="form-check-input"  value="PP in progress" id="current_state" name="current_state" <?php if($row_for_raising['current_state']=="PP in progress"){ echo "checked";}?>>
						...
						<div class="form-group form-group-sm">
								<div class="col-sm-offset-3 col-sm-5">
									<button type="button" class="btn btn-primary" onClick="sending_data_of_qc_result_for_raising_process_form_for_saving_in_database()">Save</button>
