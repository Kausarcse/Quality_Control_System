function Printing_Form_Validation()
{
  ...
  //     		return false;
		// }
		// else if(document.getElementById("rubbing_dry_value").value.trim()=="")
		// {
  //     		alert("Please Provide Rubbing Dry Value");
  //     		document.getElementById("rubbing_dry_value").focus();
  //     		return false;
		// }
		// else if(isNaN(document.getElementById("rubbing_dry_value").value.trim()))
		// {
  //     		alert("Rubbing Dry Value should be Numeric");
		// 	document.getElementById("rubbing_dry_value").value="";
  //     		document.getElementById("rubbing_dry_value").focus();
  //     		return false;
		// }
  ...
  //     		return false;
		// }*/
		// else if(document.getElementById("rubbing_wet_value").value.trim()=="")
		// {
  //     		alert("Please Provide Rubbing Wet Value");
  //     		document.getElementById("rubbing_wet_value").focus();
  //     		return false;
		// }
		// else if(isNaN(document.getElementById("rubbing_wet_value").value.trim()))
		// {
  //     		alert("Rubbing Wet Value should be Numeric");
		// 	document.getElementById("rubbing_wet_value").value="";
  //     		document.getElementById("rubbing_wet_value").focus();
  //     		return false;
		// }
