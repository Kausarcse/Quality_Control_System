function Sanforizing_Form_Validation()
{
  ...
  //     		return false;
		// }
		/*else if(document.getElementById("cf_to_rubbing_dry_value").value.trim()=="")
		{
      		alert("Please Provide Color Fastness To Rubbing Dry Value");
      		document.getElementById("cf_to_rubbing_dry_value").focus();
      		return false;
		}
		else if(isNaN(document.getElementById("cf_to_rubbing_dry_value").value.trim()))
		{
      		alert("Color Fastness To Rubbing Dry Value should be Numeric");
			document.getElementById("cf_to_rubbing_dry_value").value="";
      		document.getElementById("cf_to_rubbing_dry_value").focus();
      		return false;
		}
		...
		else if(document.getElementById("dimensional_stability_to_warp_washing_before_iron_value").value.trim()=="")
		{
      		alert("Please Provide Change In Warp For Washing Before Iron Value");
      		document.getElementById("dimensional_stability_to_warp_washing_before_iron_value").focus();
      		return false;
		}
		else if(isNaN(document.getElementById("dimensional_stability_to_warp_washing_before_iron_value").value.trim()))
		{
      		alert("Change In Warp For Washing Before Iron Value should be Numeric");
			document.getElementById("dimensional_stability_to_warp_washing_before_iron_value").value="";
      		document.getElementById("dimensional_stability_to_warp_washing_before_iron_value").focus();
      		return false;
		}
		...
		else if(document.getElementById("dimensional_stability_to_weft_washing_before_iron_value").value.trim()=="")
		{
      		alert("Please Provide Change In Warp For Washing After Iron Value");
      		document.getElementById("dimensional_stability_to_weft_washing_before_iron_value").focus();
      		return false;
		}
		else if(isNaN(document.getElementById("dimensional_stability_to_weft_washing_before_iron_value").value.trim()))
		{
      		alert("Change In Warp For Washing After Iron Value should be Numeric");
			document.getElementById("dimensional_stability_to_weft_washing_before_iron_value").value="";
      		document.getElementById("dimensional_stability_to_weft_washing_before_iron_value").focus();
      		return false;
		}
		...
		else if(document.getElementById("dimensional_stability_to_warp_washing_after_iron_value").value.trim()=="")
		{
      		alert("Please Provide Change In Weft For Washing After Iron Value");
      		document.getElementById("dimensional_stability_to_warp_washing_after_iron_value").focus();
      		return false;
		}
		else if(isNaN(document.getElementById("dimensional_stability_to_warp_washing_after_iron_value").value.trim()))
		{
      		alert("Change In Weft For Washing After Iron Value should be Numeric");
			document.getElementById("dimensional_stability_to_warp_washing_after_iron_value").value="";
      		document.getElementById("dimensional_stability_to_warp_washing_after_iron_value").focus();
      		return false;
		}
		...
		else if(document.getElementById("surface_fuzzing_and_pilling_value").value.trim()=="")
		{
      		alert("Please Provide Surface Fuzzing And Pilling Value");
      		document.getElementById("surface_fuzzing_and_pilling_value").focus();
      		return false;
		}
		else if(isNaN(document.getElementById("surface_fuzzing_and_pilling_value").value.trim()))
		{
      		alert("Surface Fuzzing And Pilling Value should be Numeric");
			document.getElementById("surface_fuzzing_and_pilling_value").value="";
      		document.getElementById("surface_fuzzing_and_pilling_value").focus();
      		return false;
		}
		...
		else if(document.getElementById("warp_yarn_tensile_properties_value").value.trim()=="")
		{
      		alert("Please Provide Warp Yarn Tensile Properties Value");
      		document.getElementById("warp_yarn_tensile_properties_value").focus();
      		return false;
		}
		else if(isNaN(document.getElementById("warp_yarn_tensile_properties_value").value.trim()))
		{
      		alert("Warp Yarn Tensile Properties Value should be Numeric");
			document.getElementById("warp_yarn_tensile_properties_value").value="";
      		document.getElementById("warp_yarn_tensile_properties_value").focus();
      		return false;
		}
		...
		else if(document.getElementById("warp_yarn_tear_force_value").value.trim()=="")
		{
      		alert("Please Provide Warp Yarn Tear Force Value");
      		document.getElementById("warp_yarn_tear_force_value").focus();
      		return false;
		}
		else if(isNaN(document.getElementById("warp_yarn_tear_force_value").value.trim()))
		{
      		alert("Warp Yarn Tear Force Value should be Numeric");
			document.getElementById("warp_yarn_tear_force_value").value="";
      		document.getElementById("warp_yarn_tear_force_value").focus();
      		return false;
		}
		...
		else if(document.getElementById("weft_yarn_tear_force_value").value.trim()=="")
		{
      		alert("Please Provide Weft Yarn Tear Force Value");
      		document.getElementById("weft_yarn_tear_force_value").focus();
      		return false;
		}
		else if(isNaN(document.getElementById("weft_yarn_tear_force_value").value.trim()))
		{
      		alert("Weft Yarn Tear Force Value should be Numeric");
			document.getElementById("weft_yarn_tear_force_value").value="";
      		document.getElementById("weft_yarn_tear_force_value").focus();
      		return false;
		}
		...
		else if(document.getElementById("warp_yarn_seam_value").value.trim()=="")
		{
      		alert("Please Provide Warp Yarn Seam Value");
      		document.getElementById("warp_yarn_seam_value").focus();
      		return false;
		}
		else if(isNaN(document.getElementById("warp_yarn_seam_value").value.trim()))
		{
      		alert("Warp Yarn Seam Value should be Numeric");
			document.getElementById("warp_yarn_seam_value").value="";
      		document.getElementById("warp_yarn_seam_value").focus();
      		return false;
		}
		...
		else if(document.getElementById("weft_yarn_seam_value").value.trim()=="")
		{
      		alert("Please Provide Weft Yarn Seam Value");
      		document.getElementById("weft_yarn_seam_value").focus();
      		return false;
		}
		else if(isNaN(document.getElementById("weft_yarn_seam_value").value.trim()))
		{
      		alert("Weft Yarn Seam Value should be Numeric");
			document.getElementById("weft_yarn_seam_value").value="";
      		document.getElementById("weft_yarn_seam_value").focus();
      		return false;
		}
		...
		else if(document.getElementById("seam_slippage_resistance_in_warp_value").value.trim()=="")
		{
      		alert("Please Provide Seam Slippage Resistance In Warp Value");
      		document.getElementById("seam_slippage_resistance_in_warp_value").focus();
      		return false;
		}
		else if(isNaN(document.getElementById("seam_slippage_resistance_in_warp_value").value.trim()))
		{
      		alert("Seam Slippage Resistance In Warp Value should be Numeric");
			document.getElementById("seam_slippage_resistance_in_warp_value").value="";
      		document.getElementById("seam_slippage_resistance_in_warp_value").focus();
      		return false;
		}
		...
		else if(document.getElementById("seam_slippage_resistance_in_weft_value").value.trim()=="")
		{
      		alert("Please Provide Seam Slippage Resistance In Weft Value");
      		document.getElementById("seam_slippage_resistance_in_weft_value").focus();
      		return false;
		}
		...
		else if(document.getElementById("seam_slippage_resistance_in_warp_mm_value").value.trim()=="")
		{
      		alert("Please Provide Seam Slippage Resistance In Warp Mm Value");
      		document.getElementById("seam_slippage_resistance_in_warp_mm_value").focus();
      		return false;
		}
		...
		else if(document.getElementById("seam_slippage_resistance_in_weft_mm_value").value.trim()=="")
		{
      		alert("Please Provide Seam Slippage Resistance In Weft Mm Value");
      		document.getElementById("seam_slippage_resistance_in_weft_mm_value").focus();
      		return false;
		}
