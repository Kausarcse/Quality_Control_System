...
<script type='text/javascript' src='process_qc_result/qc_result_for_steaming_process_form_validation.js'></script>
...
{   
	var db_table_name="defining_qc_standard_for_steaming_process";
...
*/  
 ...
 function sending_data_of_qc_result_for_steaming_process_form_for_saving_in_database()
 {


       var validate = Steaming_Form_Validation();
       var url_encoded_form_data = $("#qc_result_for_steaming_process_form").serialize(); //This will read all control elements value of the form	
       if(validate != false)
	   {


		  	 $.ajax({
			 		url: 'process_qc_result/qc_result_for_steaming_process_saving.php',
			 		dataType: 'text',
			 		type: 'post',
			 		contentType: 'application/x-www-form-urlencoded',
...
*/			 				}
 ...
 }//End of function sending_data_of_qc_result_for_steaming_process_form_for_saving_in_database()
...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
				...
				<div class="panel-heading" style="color:#191970;"><b>Qc Result For Steaming Process</b></div> <!-- This will create a upper block for FORM (Just Beautification) -->

				<form class="form-horizontal" action="" style="margin-top:10px;" name="qc_result_for_steaming_process_form" id="qc_result_for_steaming_process_form">
				...
				<div class="form-group form-group-sm" id="form-group_for_pp_number" onchange="Fill_Value_Of_Version_Number_Field(this.value)">
						...
						<div class="form-group form-group-sm">
								<div class="col-sm-offset-3 col-sm-5">
									<button type="button" class="btn btn-primary" onClick="sending_data_of_qc_result_for_steaming_process_form_for_saving_in_database()">Submit</button>
