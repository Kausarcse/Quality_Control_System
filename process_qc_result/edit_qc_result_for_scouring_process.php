...
// $sql_qc_scouring="select id from qc_result_for_scouring_process where pp_number = '$trf_pp_number'";
// $res_sql_qc_scouring=mysqli_query($con,$sql_qc_scouring) or die(mysqli_error($con));
// $row_for_id=mysqli_fetch_assoc($res_sql_qc_scouring);

// $scouring_id = $row_for_id['id'];


$sql_for_scouring="select * from qc_result_for_scouring_process where pp_number = '$trf_pp_number' and 
...
$row_for_scouring = mysqli_fetch_array( $result_for_scouring);
?>



<script type='text/javascript' src='process_qc_result/qc_result_for_scouring_process_form_validation.js'></script>
...
{   
	var db_table_name="defining_qc_standard_for_scouring_process";
...
*/  
 ...
 function sending_data_of_qc_result_for_scouring_process_form_for_saving_in_database()
 {


       var validate = Scouring_Form_Validation();
       
       var url_encoded_form_data = $("#qc_result_for_scouring_process_form").serialize(); //This will read all control elements value of the form	
       if(validate != false)
	   {


		  	 $.ajax({
			 		url: 'process_qc_result/edit_qc_result_for_scouring_process_saving.php',
			 		dataType: 'text',
			 		type: 'post',
			 		contentType: 'application/x-www-form-urlencoded',
...
*/			 				}
 ...
 }//End of function sending_data_of_qc_result_for_scouring_process_form_for_saving_in_database()
...
<div class="col-sm-12 col-md-12 col-lg-12">
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
			...
			<body id="target">
				...
				<div class="panel-heading" style="color:#191970;"><b>Qc Result For Scouring Process / <a href="#">Edit</a></b></div> <!-- This will create a upper block for FORM (Just Beautification) -->

				<form class="form-horizontal" action="" style="margin-top:10px;" name="qc_result_for_scouring_process_form" id="qc_result_for_scouring_process_form">
			   ...
			   <div class="form-group form-group-sm" id="form-group_for_residual_sizing_material_value">
                    ...
                    <label class="control-label col-sm-3" for="residual_sizing_material_value" style="color:#00008B; margin-top:23px;"><span id="for_residual_sizing_material_value_test_name_label">Residual Sizing Material</span><span id="for_residual_sizing_material_value_test_method"> (Drop Test Method):</span></label>
                    
                    <div class="col-sm-2 text-center">
                      <label for="residual_sizing_material_value" style="font-size:12px; color:#000066;">Left</label>
                      <input type="text" class="form-control" id="residual_sizing_material_left_value" name="residual_sizing_material_left_value" value="<?php echo $row_for_scouring['residual_sizing_material_left_value'] ?>" style="padding-right:4px;" required>
                    </div>
                    
                    
                    <div class="col-sm-2 text-center">
                      <label for="residual_sizing_material_value" style="font-size:12px; color:#000066;">Center</label>
                      <input type="text" class="form-control" id="residual_sizing_material_center_value" name="residual_sizing_material_center_value" value="<?php echo $row_for_scouring['residual_sizing_material_left_value'] ?>" style="padding-right:4px;" required>
                    </div>

                    <div class="col-sm-2 text-center">
                      <label for="residual_sizing_material_value" style="font-size:12px; color:#000066;">Right</label>
                      <input type="text" class="form-control" id="residual_sizing_material_right_value" name="residual_sizing_material_right_value" value="<?php echo $row_for_scouring['residual_sizing_material_left_value'] ?>" style="padding-right:4px;" required>
                    </div>
            ...
            <div class="form-group form-group-sm" id="form-group_for_uom_of_residual_sizing_material">
               <!--  <label class="control-label col-sm-3" for="uom_of_residual_sizing_material" style="color:#00008B;">Uom Of Residual Sizing Material</sup>:</label> -->
                <div class="col-sm-6" style="padding-right:4px;">
                  <input type="hidden" class="form-control" id="uom_of_residual_sizing_material" name="uom_of_residual_sizing_material" placeholder="Enter Uom Of residual_sizing_material" value="value">
                </div>
               <!--  <i class="glyresidual_sizing_materialicon glyresidual_sizing_materialicon-remove" onclick="Remove_Value_Of_This_Element('uom_of_residual_sizing_material')" style="margin-top:6px;"></i> -->
            </div> <!-- End of <div class="form-group form-group-sm" id="form-group_for_"> -->
			...
			<div class="form-group form-group-sm" id="form-group_for_absorbency_value">
                    ...
                    <label class="control-label col-sm-3" for="absorbency_value" style="color:#00008B; margin-top:23px;"> <span id="for_absorbency_value_test_name_label">Absorbency </span><span id="for_absorbency_value_test_method"> (Capillary Method):</span></label>
                    
                    <div class="col-sm-2 text-center">
                      <label for="absorbency_value" style="font-size:12px; color:#000066;">Left</label>
                      <input type="text" class="form-control" id="absorbency_left_value" name="absorbency_left_value" value="<?php echo $row_for_scouring['absorbency_left_value'] ?>" style="padding-right:4px;" required>
                    </div>
                    
                    
                    <div class="col-sm-2 text-center">
                      <label for="absorbency_value" style="font-size:12px; color:#000066;">Center</label>
                      <input type="text" class="form-control" id="absorbency_center_value" name="absorbency_center_value" value="<?php echo $row_for_scouring['absorbency_center_value'] ?>" style="padding-right:4px;" required>
                    </div>

                    <div class="col-sm-2 text-center">
                      <label for="absorbency_value" style="font-size:12px; color:#000066;">Right</label>
                      <input type="text" class="form-control" id="absorbency_right_value" name="absorbency_right_value" value="<?php echo $row_for_scouring['absorbency_right_value'] ?>" style="padding-right:4px;" required>
                    </div>
            ...
            <div class="form-group form-group-sm" id="form-group_for_uom_of_absorbency">
               <!--  <label class="control-label col-sm-3" for="uom_of_absorbency" style="color:#00008B;">Uom Of absorbency</sup>:</label> -->
                <div class="col-sm-6" style="padding-right:4px;">
                  <input type="hidden" class="form-control" id="uom_of_absorbency" name="uom_of_absorbency" placeholder="Enter Uom Of absorbency" value="mm">
                </div>
               <!--  <i class="glyabsorbencyicon glyabsorbencyicon-remove" onclick="Remove_Value_Of_This_Element('uom_of_absorbency')" style="margin-top:6px;"></i> -->
            </div> <!-- End of <div class="form-group form-group-sm" id="form-group_for_"> -->
            	...
            	<div class="form-group form-group-sm" id="form-group_for_resistance_to_surface_fuzzing_and_pilling_value">
                    ...
                    <label class="control-label col-sm-3" for="resistance_to_surface_fuzzing_and_pilling_value" style="color:#00008B; margin-top:23px;"><span id="for_resistance_to_surface_fuzzing_and_pilling_test_name_label">Resistance to Surface Fuzzing and Pilling</span><span id="for_resistance_to_surface_fuzzing_and_pilling_test_method"> (ISO 12945-2)</span> :</label>
                    
                    <div class="col-sm-2 text-center">
                      <label for="resistance_to_surface_fuzzing_and_pilling_value" style="font-size:12px; color:#000066;">Left</label>
                      <input type="text" class="form-control" id="resistance_to_surface_fuzzing_and_pilling_left_value" name="resistance_to_surface_fuzzing_and_pilling_left_value" value="<?php echo $row_for_scouring['resistance_to_surface_fuzzing_and_pilling_left_value'] ?>" style="padding-right:4px;" required>
                    </div>
                    
                    
                    <div class="col-sm-2 text-center">
                      <label for="resistance_to_surface_fuzzing_and_pilling_value" style="font-size:12px; color:#000066;">Center</label>
                      <input type="text" class="form-control" id="resistance_to_surface_fuzzing_and_pilling_center_value" name="resistance_to_surface_fuzzing_and_pilling_center_value" value="<?php echo $row_for_scouring['resistance_to_surface_fuzzing_and_pilling_center_value'] ?>" style="padding-right:4px;" required>
                    </div>

                    <div class="col-sm-2 text-center">
                      <label for="resistance_to_surface_fuzzing_and_pilling_value" style="font-size:12px; color:#000066;">Right</label>
                      <input type="text" class="form-control" id="resistance_to_surface_fuzzing_and_pilling_right_value" name="resistance_to_surface_fuzzing_and_pilling_right_value" value="<?php echo $row_for_scouring['resistance_to_surface_fuzzing_and_pilling_right_value'] ?>" style="padding-right:4px;" required>
                    </div>
            ...
            <div class="form-group form-group-sm" id="form-group_for_uom_of_resistance_to_surface_fuzzing_and_pilling">
                ...
                <div class="col-sm-6" style="padding-right:4px;">
                  <input type="hidden" class="form-control" id="uom_of_resistance_to_surface_fuzzing_and_pilling" name="uom_of_resistance_to_surface_fuzzing_and_pilling" placeholder="Enter Uom Of resistance_to_surface_fuzzing_and_pilling" value="value">
                </div>
                <i class="glyresistance_to_surface_fuzzing_and_pillingicon glyresistance_to_surface_fuzzing_and_pillingicon-remove" onclick="Remove_Value_Of_This_Element('uom_of_resistance_to_surface_fuzzing_and_pilling')" style="margin-top:6px;"></i>
            </div> <!-- End of <div class="form-group form-group-sm" id="form-group_for_"> -->


						<div class="form-group form-group-sm" id="form-group_for_ph_value">

				              <label class="control-label col-sm-3" for="ph_value" style="color:#00008B; margin-top:23px;"><span id="for_ph_value_test_name_label">P<sup>H</sup></span><span id="for_ph_value_test_method"> (Drop Test Method):</span> </label>
				              
				              <div class="col-sm-2 text-center">
				                <label for="whiteness_value" style="font-size:12px; color:#000066;">Left</label>
				                <input type="text" class="form-control" id="ph_left_value" name="ph_left_value" value="<?php echo $row_for_scouring['ph_left_value'] ?>" style="padding-right:4px;" required>
				              </div>
				              
				              
				              <div class="col-sm-2 text-center">
				                <label for="whiteness_value" style="font-size:12px; color:#000066;">Center</label>
				                <input type="text" class="form-control" id="ph_center_value" name="ph_center_value" value="<?php echo $row_for_scouring['ph_center_value'] ?>" style="padding-right:4px;" required>
				              </div>

				              <div class="col-sm-2 text-center">
				                <label for="whiteness_value" style="font-size:12px; color:#000066;">Right</label>
				                <input type="text" class="form-control" id="ph_right_value" name="ph_right_value" value="<?php echo $row_for_scouring['ph_right_value'] ?>" style="padding-right:4px;" required>
				              </div>
				          	...
				          	<div class="form-group form-group-sm" id="form-group_for_uom_of_ph">
				               ...
				               <!--  <i class="glyphicon glyphicon-remove" onclick="Remove_Value_Of_This_Element('uom_of_ph')" style="margin-top:6px;"></i> -->
				            </div> <!-- End of <div class="form-group form-group-sm" id="form-group_for_"> -->
						...
						<label class="control-label col-sm-3" for="status" style="margin-right:15px;color:#00008B;">Status:</label>
								<input type="radio" class="form-check-input"  value="OK" id="status" name="status" <?php if($row_for_scouring['status']=="OK"){ echo "checked";}?>>
								<label class="form-check-label control-label" for="status" style="margin-right:15px;">OK</label>
								<input type="radio" class="form-check-input"  value="Not OK" id="status" name="status" <?php if($row_for_scouring['status']=="Not OK"){ echo "checked";}?>>
						...
						<div class="form-group form-group-sm" id="form-group_for_remarks">
								...
								<div class="col-sm-6">
									<textarea class='form-control' id='remarks' name='remarks' rows='5' value="<?php echo $row_for_scouring['remarks'] ?>"><?php echo $row_for_scouring['remarks'] ?></textarea>
								</div>
						...
						<div class="form-group form-group-sm" id="form-group_for_current_state">
						   <label class="control-label col-sm-3" for="current_state" style="margin-right:15px;color:#00008B;">NOTE(IS IT A LAST PROCESS):</label>
								<input type="radio" class="form-check-input"  value="PP Completed" id="current_state" name="current_state" <?php if($row_for_scouring['current_state']=="PP Completed"){ echo "checked";}?>>
								<label class="form-check-label control-label" for="current_state" style="margin-right:15px;">Yes</label>
								<input type="radio" class="form-check-input"  value="PP in progress" id="current_state" name="current_state" <?php if($row_for_scouring['current_state']=="PP in progress"){ echo "checked";}?>>
						...
						<div class="form-group form-group-sm">
								<div class="col-sm-offset-3 col-sm-6">
									<button type="button" class="btn btn-primary" onClick="sending_data_of_qc_result_for_scouring_process_form_for_saving_in_database()">Save</button>
