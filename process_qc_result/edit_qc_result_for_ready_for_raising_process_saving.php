...
$ready_for_raising_quality=$_POST['ready_for_raising_quality'];
...
$select_sql_for_duplicacy="select * from `qc_result_for_ready_for_raising_process`
 ...
 `tear_force_in_weft_value` ='$tear_force_in_weft_value' and face_or_back='$face_or_back' and 
 hand_feel='$hand_feel' and ready_for_raising_quality='$ready_for_raising_quality' and 
...
{
	$update_sql_statement="UPDATE `qc_result_for_ready_for_raising_process` SET 
   `tensile_properties_in_warp_value` ='$tensile_properties_in_warp_value', 
	...
	face_or_back='$face_or_back', hand_feel='$hand_feel',
	 ready_for_raising_quality='$ready_for_raising_quality', 
	 status= '$status', remarks='$remarks', `date`='$date', current_state = '$current_state'  
    WHERE 
    `pp_number`='$pp_number' and 
    `version_number`='$version_number' and 
    `customer_name`='$customer_name' and 
