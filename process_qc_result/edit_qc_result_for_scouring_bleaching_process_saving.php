...
$select_sql_for_duplicacy="select * from `qc_result_for_scouring_bleaching_process` where 
...
{
    $update_sql_statement="UPDATE `qc_result_for_scouring_bleaching_process` SET 
