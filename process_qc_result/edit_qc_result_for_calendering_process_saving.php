...
mysqli_query($con,"START TRANSACTION") or die(mysqli_error($con));
        ...
        $select_sql_for_duplicacy="select * from `qc_result_for_calendering_process` where 
        ...
        hand_feel='$hand_feel' and status='$status' and remarks='$remarks' and current_state='$current_state' and  `date`='$date'
        ";
...
else if(mysqli_num_rows($result) < 1)
{
	...
	$update_sql_statement="UPDATE `qc_result_for_calendering_process` SET 
        ...
        hand_feel='$hand_feel', `status`='$status', remarks='$remarks', current_state='$current_state', `date`='$date'
        WHERE 
        `pp_number`='$pp_number' and 
        `version_number`='$version_number' and 
        `customer_name`='$customer_name' and 
