...
*/  
 ...
 function sending_data_of_qc_result_for_bleaching_process_form_for_saving_in_database()
 {
       ...
       if(validate != false)
	   {
		  	 ...
		  	 $.ajax({
			 		url: 'process_qc_result/qc_result_for_bleaching_process_saving.php',
			 		dataType: 'text',
			 		type: 'post',
			 		contentType: 'application/x-www-form-urlencoded',
...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<body id="target">
			...
			<div class="panel-heading" style="color:#191970;"><b>Qc Result For Bleaching Process</b></div> <!-- This will create a upper block for FORM (Just Beautification) -->
				...
				<div class="form-group form-group-sm" id="form-group_for_pp_number" onchange="Fill_Value_Of_Version_Number_Field(this.value)">
						...
						<div class="form-group form-group-sm" id="form-group_for_whiteness_value">
								...
								<div class="col-sm-5" style="padding-right:4px;">
									<input type="text" class="form-control" id="whiteness_value" name="whiteness_value" placeholder="Enter Whiteness Value" required>
								</div>
						</div> <!-- End of <div class="form-group form-group-sm" id="form-group_for_"> -->
                       ...
                       <div class="form-group form-group-sm" id="form-group_for_residual_sizing_material_value">
								...
								<div class="col-sm-5" style="padding-right:4px;">
									<input type="text" class="form-control" id="residual_sizing_material_value" name="residual_sizing_material_value" placeholder="Enter Residual Sizing Material Value" required>
								</div>
						</div> <!-- End of <div class="form-group form-group-sm" id="form-group_for_"> -->
						...
						<div class="form-group form-group-sm" id="form-group_for_absorbency_value">
								...
								<div class="col-sm-5" style="padding-right:4px;">
									<input type="text" class="form-control" id="absorbency_value" name="absorbency_value" placeholder="Enter Absorbency Value" required>
								</div>
						</div> <!-- End of <div class="form-group form-group-sm" id="form-group_for_"> -->
						...
						<div class="form-group form-group-sm" id="form-group_for_resistance_to_surface_fuzzing_and_pilling_value">
								...
								<div class="col-sm-5" style="padding-right:4px;">
									<input type="text" class="form-control" id="resistance_to_surface_fuzzing_and_pilling_value" name="resistance_to_surface_fuzzing_and_pilling_value" placeholder="Enter Resistance to Surface Fuzzing and Pilling Value" required>
								</div>
						</div> <!-- End of <div class="form-group form-group-sm" id="form-group_for_"> -->
						...
						<div class="form-group form-group-sm" id="form-group_for_ph_value">
								...
								<div class="col-sm-5" style="padding-right:4px;">
									<input type="text" class="form-control" id="ph_value" name="ph_value" placeholder="Enter Ph Value" required>
								</div>
						</div> <!-- End of <div class="form-group form-group-sm" id="form-group_for_"> -->
						...
						<div class="form-group form-group-sm" id="form-group_for_remarks">
								...
								<div class="col-sm-5" style="padding-right:4px;">
									<textarea type="text" class="form-control" id="remarks" name="remarks" placeholder="Enter Remarks" required> </textarea>
								</div>
						</div> <!-- End of <div class="form-group form-group-sm" id="form-group_for_"> -->
						...
						<div class="form-group form-group-sm">
								<div class="col-sm-offset-3 col-sm-5">
									<button type="button" class="btn btn-primary" onClick="sending_data_of_qc_result_for_bleaching_process_form_for_saving_in_database()">Submit</button>
