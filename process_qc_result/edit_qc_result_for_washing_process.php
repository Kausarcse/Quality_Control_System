...
// $sql_qc_washing="select id from qc_result_for_washing_process where pp_number = '$trf_pp_number'";
// $res_sql_qc_washing=mysqli_query($con,$sql_qc_washing) or die(mysqli_error($con));
// $row_for_id=mysqli_fetch_assoc($res_sql_qc_washing);

// $washing_id = $row_for_id['id'];


$sql_for_washing="select * from qc_result_for_washing_process where pp_number = '$trf_pp_number' and 
...
$row_for_washing = mysqli_fetch_array( $result_for_washing);
...
*/  
 ...
 function sending_data_of_qc_result_for_washing_process_form_for_saving_in_database()
 {
       ...
       if(validate != false)
	   {
		  	 ...
		  	 $.ajax({
			 		url: 'process_qc_result/edit_qc_result_for_washing_process_saving.php',
			 		dataType: 'text',
			 		type: 'post',
			 		contentType: 'application/x-www-form-urlencoded',
...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
			...
			<body id="target">
				...
				<div class="panel-heading" style="color:#191970;"><b>Qc Result For Washing Process / <a href="#">Edit</a></b></div> <!-- This will create a upper block for FORM (Just Beautification) -->
...
?>
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_rubbing_dry_value" name="cf_to_rubbing_dry_value" value="<?php echo $row_for_washing['cf_to_rubbing_dry_value'] ?>"   style="color:#00008B; margin-top:23px;">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_rubbing_wet_value" name="cf_to_rubbing_wet_value" value="<?php echo $row_for_washing['cf_to_rubbing_wet_value'] ?>">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_washing_color_change_value" name="cf_to_washing_color_change_value" value="<?php echo $row_for_washing['cf_to_washing_color_change_value'] ?>"  style="color:#00008B; margin-top:23px;">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_washing_staining_value" name="cf_to_washing_staining_value" value="<?php echo $row_for_washing['cf_to_washing_staining_value'] ?>">
  ...
  <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_washing_cross_staining_value" name="cf_to_washing_cross_staining_value" value="<?php echo $row_for_washing['cf_to_washing_cross_staining_value'] ?>">
 ...
 <div id="div_cf_to_dry_cleaning" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_dry_cleaning_color_change_value" name="cf_to_dry_cleaning_color_change_value" value="<?php echo $row_for_washing['cf_to_dry_cleaning_color_change_value'] ?>"   style="color:#00008B; margin-top:23px;">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_dry_cleaning_staining_value" name="cf_to_dry_cleaning_staining_value" value="<?php echo $row_for_washing['cf_to_dry_cleaning_staining_value'] ?>">
 ...
 <div id="div_cf_to_perspiration_acid" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_perspiration_acid_color_change_value" name="cf_to_perspiration_acid_color_change_value" value="<?php echo $row_for_washing['cf_to_perspiration_acid_color_change_value'] ?>"  style="color:#00008B; margin-top:23px;">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_perspiration_acid_staining_value" name="cf_to_perspiration_acid_staining_value" value="<?php echo $row_for_washing['cf_to_perspiration_acid_staining_value'] ?>">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_perspiration_acid_cross_staining_value" name="cf_to_perspiration_acid_cross_staining_value" value="<?php echo $row_for_washing['cf_to_perspiration_acid_cross_staining_value'] ?>">
 ...
 <div id="div_cf_to_perspiration_alkali" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_perspiration_alkali_color_change_value" name="cf_to_perspiration_alkali_color_change_value" value="<?php echo $row_for_washing['cf_to_perspiration_alkali_color_change_value'] ?>"   style="color:#00008B; margin-top:23px;">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_perspiration_alkali_staining_value" name="cf_to_perspiration_alkali_staining_value" value="<?php echo $row_for_washing['cf_to_perspiration_alkali_staining_value'] ?>">
	   ...
	   <div class="form-group form-group-sm">
	      ...
	      <div class="col-sm-2" for="value">
	            ...
	            <input type="text" class="form-control" id="cf_to_perspiration_alkali_cross_staining_value" name="cf_to_perspiration_alkali_cross_staining_value" value="<?php echo $row_for_washing['cf_to_perspiration_alkali_cross_staining_value'] ?>">
 ...
 <div id="div_cf_to_water" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_water_color_change_value" name="cf_to_water_color_change_value" value="<?php echo $row_for_washing['cf_to_water_color_change_value'] ?>"  style="color:#00008B; margin-top:23px;">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_water_staining_value" name="cf_to_water_staining_value" value="<?php echo $row_for_washing['cf_to_water_staining_value'] ?>">
	     ...
	     <div class="form-group form-group-sm">
	      ...
	      <div class="col-sm-2" for="value">
	            ...
	            <input type="text" class="form-control" id="cf_to_water_cross_staining_value" name="cf_to_water_cross_staining_value" value="<?php echo $row_for_washing['cf_to_water_cross_staining_value'] ?>">
  ...
  <div id="div_color_fastness_to_water_spotting" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_water_spotting_surface_value" name="cf_to_water_spotting_surface_value" value="<?php echo $row_for_washing['cf_to_water_spotting_surface_value'] ?>"  style="color:#00008B; margin-top:23px;">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_water_spotting_edge_value" name="cf_to_water_spotting_edge_value" value="<?php echo $row_for_washing['cf_to_water_spotting_edge_value'] ?>">
    ...
    <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_water_spotting_cross_staining_value" name="cf_to_water_spotting_cross_staining_value" value="<?php echo $row_for_washing['cf_to_water_spotting_cross_staining_value'] ?>">
  ...
  <div id="div_cf_to_hydrolysis_of_reactive_dyes" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_hydrolysis_of_reactive_dyes_color_change_value" name="cf_to_hydrolysis_of_reactive_dyes_color_change_value" value="<?php echo $row_for_washing['cf_to_hydrolysis_of_reactive_dyes_color_change_value'] ?>"   style="color:#00008B; margin-top:23px;">
 ...
 <div id="div_cf_to_oxidative_bleach_damage" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_oxidative_bleach_damage_color_change_value" name="cf_to_oxidative_bleach_damage_color_change_value" value="<?php echo $row_for_washing['cf_to_oxidative_bleach_damage_color_change_value'] ?>"   style="color:#00008B; margin-top:23px;">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_oxidative_bleach_damage_value" name="cf_to_oxidative_bleach_damage_value" value="<?php echo $row_for_washing['cf_to_oxidative_bleach_damage_value'] ?>">
 ...
 <div id="div_cf_to_phenolic_yellowing" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_phenolic_yellowing_staining_value" name="cf_to_phenolic_yellowing_staining_value" value="<?php echo $row_for_washing['cf_to_phenolic_yellowing_staining_value'] ?>"   style="color:#00008B; margin-top:23px;">
...
<div id="div_migration_of_color_into_pvc" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_pvc_migration_staining_value" name="cf_to_pvc_migration_staining_value" value="<?php echo $row_for_washing['cf_to_pvc_migration_staining_value'] ?>"   style="color:#00008B; margin-top:23px;">
...
<div id="div_cf_to_saliva" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_saliva_color_change_value" name="cf_to_saliva_color_change_value" value="<?php echo $row_for_washing['cf_to_saliva_color_change_value'] ?>"   style="color:#00008B; margin-top:23px;">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_saliva_staining_value" name="cf_to_saliva_staining_value" value="<?php echo $row_for_washing['cf_to_saliva_staining_value'] ?>">
...
<div id="div_cf_to_chlorine_water" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_chlorinated_water_color_change_change_value" name="cf_to_chlorinated_water_color_change_change_value" value="<?php echo $row_for_washing['cf_to_chlorinated_water_color_change_change_value'] ?>"   style="color:#00008B; margin-top:23px;">
...
<div id="div_cf_to_chlorine_bleach" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_cholorine_bleach_color_change_value" name="cf_to_cholorine_bleach_color_change_value" value="<?php echo $row_for_washing['cf_to_cholorine_bleach_color_change_value'] ?>"   style="color:#00008B; margin-top:23px;">
...
<div id="div_cf_to_peroxide_bleach" style="display: none;">
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cf_to_peroxide_bleach_color_change_value" name="cf_to_peroxide_bleach_color_change_value" value="<?php echo $row_for_washing['cf_to_peroxide_bleach_color_change_value'] ?>"   style="color:#00008B; margin-top:23px;">
...
</div>     <!--  End of <div id="div_cf_to_peroxide_bleach" style="display: none"> -->
...
<div id="div_cross_staining" style="display: none;">
	...
	<div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="cross_staining_value" name="cross_staining_value" value="<?php echo $row_for_washing['cross_staining_value'] ?>">
...
<div id="div_ph" style="display: none;">
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="ph_value" name="ph_value" value="<?php echo $row_for_washing['ph_value'] ?>"   style="color:#00008B; margin-top:23px;">
		...
		<label class="control-label col-sm-3" for="status" style="margin-right:15px;color:#00008B;">Status:</label>
				<input type="radio" class="form-check-input"  value="OK" id="status" name="status" <?php if($row_for_washing['status']=="OK"){ echo "checked";}?>>
				<label class="form-check-label control-label" for="status" style="margin-right:15px;">OK</label>
				<input type="radio" class="form-check-input"  value="Not OK" id="status" name="status" <?php if($row_for_washing['status']=="Not OK"){ echo "checked";}?>>
		...
		<div class="form-group form-group-sm" id="form-group_for_remarks">
				...
				<div class="col-sm-6">
					<textarea class='form-control' id='remarks' name='remarks' rows='5'  value="<?php echo $row_for_washing['remarks'] ?>" ><?php echo $row_for_washing['remarks'] ?></textarea>
				</div>
      ...
      <div class="form-group form-group-sm" id="form-group_for_current_state">
         <label class="control-label col-sm-3" for="current_state" style="margin-right:15px;color:#00008B;">NOTE(IS IT A LAST PROCESS):</label>
            <input type="radio" class="form-check-input"  value="PP Completed" id="current_state" name="current_state" <?php if($row_for_washing['current_state']=="PP Completed"){ echo "checked";}?>>
            <label class="form-check-label control-label" for="current_state" style="margin-right:15px;">Yes</label>
            <input type="radio" class="form-check-input"  value="PP in progress" id="current_state" name="current_state" <?php if($row_for_washing['current_state']=="PP in progress"){ echo "checked";}?>>
		...
		<div class="form-group form-group-sm">
				<div class="col-sm-offset-3 col-sm-6">
					<button type="button" class="btn btn-primary" onClick="sending_data_of_qc_result_for_washing_process_form_for_saving_in_database()">Save</button>
