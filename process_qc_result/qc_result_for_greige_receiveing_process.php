...
$refer_version_id = '';
$refer_style_name = '';
$refer_finish_width_in_inch = '';
$refer_greige_width_in_inch = '';
$refer_color = '';
$refer_pp_number = '';
$refer_received_quantity_in_meter = '';
...
//for refer result information
if(isset($splitted_data[3]))
{
   if ($splitted_data[3] != 'select') 
   {
   
      $refer_version_name = $splitted_data[3];
      $refer_design = $splitted_data[4];
      $refer_customer_name = $splitted_data[6];
      $refer_customer_id = $splitted_data[10];
      $refer_version_id = $splitted_data[11];
      $refer_style_name = $splitted_data[12];
      $refer_finish_width_in_inch = $splitted_data[13];
      $refer_greige_width_in_inch = $splitted_data[14];
      $refer_color = $splitted_data[15];
      $refer_pp_number = $splitted_data[16];
      $refer_received_quantity_in_meter = $splitted_data[17];
   
      $sql_for_refer_result="SELECT * from qc_result_for_greige_receiving_process WHERE pp_number = '$refer_pp_number' AND version_number = '$refer_version_name' AND customer_name = '$refer_customer_name' AND color = '$refer_color' AND style = '$refer_style_name' AND finish_width_in_inch = '$refer_finish_width_in_inch'";
   
      $result_for_refer_result=mysqli_query($con,$sql_for_refer_result) or die(mysqli_error($con));
      $result_for_refer = mysqli_fetch_array($result_for_refer_result);
   
      //actual test result data
      $warp_yarn_count_value = $result_for_refer['warp_yarn_count_value'];
      $weft_yarn_count_value = $result_for_refer['weft_yarn_count_value'];
      $no_of_threads_in_warp_value = $result_for_refer['no_of_threads_in_warp_value'];
      $no_of_threads_in_weft_value = $result_for_refer['no_of_threads_in_weft_value'];
      $mass_per_unit_per_area_value = $result_for_refer['mass_per_unit_per_area_value'];
      $gerige_width_value = $result_for_refer['gerige_width_value'];
      $polyester_fiber_content_value = $result_for_refer['polyester_fiber_content_value'];
      $cotton_fiber_content_value = $result_for_refer['cotton_fiber_content_value'];
      $other_fiber_content_value = $result_for_refer['other_fiber_content_value'];
 ...
 function sending_data_of_qc_result_for_greige_receiving_process_form_for_saving_in_database()
 {
      ...
      //var validate = greige_receiving_Form_Validation();
	   ...
	   {*/
		  	 ...
		  	 $.ajax({
			 		url: 'process_qc_result/qc_result_for_greige_receiving_process_saving.php',
			 		dataType: 'text',
			 		type: 'post',
			 		contentType: 'application/x-www-form-urlencoded',
...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
			...
			<body id="target">
				...
				<div class="panel-heading" style="color:#191970;"><b>Qc Result For Greige Receiving Process</b></div> <!-- This will create a upper block for FORM (Just Beautification) -->
     ...
     <div class="form-group form-group-sm" id="form-group_for_warp_yarn_count_value">
          ...
          <div class="col-sm-2 text-center">
            ...
            <div class="col-sm-2 text-center">
             ...
             <input type="text" class="form-control" id="warp_yarn_count_value" name="warp_yarn_count_value" placeholder="Enter  Value" value="<?php echo $warp_yarn_count_value; ?>" required>
      ...
      <div class="form-group form-group-sm" id="form-group_for_weft_yarn_count_value">
         ...
         <div class="col-sm-2 text-center">
            ...
            <div class="col-sm-2 text-center">
             ...
             <input type="text" class="form-control" id="weft_yarn_count_value" name="weft_yarn_count_value" placeholder="Enter  Value" value="<?php echo $weft_yarn_count_value; ?>" required>
     ...
     <div class="form-group form-group-sm" id="form-group_for_mass_per_unit_per_area_value">
          ...
          <div class="col-sm-2 text-center">
            ...
            <div class="col-sm-2 text-center">
             ...
             <input type="text" class="form-control" id="mass_per_unit_per_area_value" name="mass_per_unit_per_area_value" value="<?php echo $mass_per_unit_per_area_value; ?>" placeholder="Enter  Value" required>
     ...
     <div class="form-group form-group-sm" id="form-group_for_gerige_width_value">
          ...
          <div class="col-sm-2 text-center">
            ...
            <div class="col-sm-2 text-center">
             ...
             <input type="text" class="form-control" id="gerige_width_value" name="gerige_width_value" placeholder="Enter  Value" value="<?php echo $gerige_width_value; ?>" required>
      ...
      <div class="form-group form-group-sm" id="form-group_for_no_of_threads_in_warp_value">
         ...
         <div class="col-sm-2 text-center">
            ...
            <div class="col-sm-2 text-center">
             ...
             <input type="text" class="form-control" id="no_of_threads_in_warp_value" name="no_of_threads_in_warp_value" placeholder="Enter  Value" value="<?php echo $no_of_threads_in_warp_value; ?>" required>
    ...
    <div class="form-group form-group-sm" id="form-group_for_no_of_threads_in_weft_value">
         ...
         <div class="col-sm-2 text-center">
            ...
            <div class="col-sm-2 text-center">
             ...
             <input type="text" class="form-control" id="no_of_threads_in_weft_value" name="no_of_threads_in_weft_value" placeholder="Enter  Value" value="<?php echo $no_of_threads_in_weft_value; ?>" required>
      ...
      <div class="form-group form-group-sm" id="form-group_for_polyester_fiber_content_value">
         ...
         <div class="col-sm-2 text-center">
            ...
            <div class="col-sm-2 text-center">
             ...
             <input type="text" class="form-control" id="polyester_fiber_content_value" name="polyester_fiber_content_value" placeholder="Enter Value" value="<?php echo $polyester_fiber_content_value; ?>" required>
    ...
    <div class="form-group form-group-sm" id="form-group_for_cotton_fiber_content_value">
         ...
         <div class="col-sm-2 text-center">
            ...
            <div class="col-sm-2 text-center">
             ...
             <input type="text" class="form-control" id="cotton_fiber_content_value" name="cotton_fiber_content_value" placeholder="Enter  Value" value="<?php echo $cotton_fiber_content_value; ?>" required>
      ...
      <div class="form-group form-group-sm" id="form-group_for_other_fiber_content_value">
         ...
         <div class="col-sm-2 text-center">
            ...
            <div class="col-sm-2 text-center">
             ...
             <input type="text" class="form-control" id="other_fiber_content_value" name="other_fiber_content_value" placeholder="Enter  Value" value="<?php echo $other_fiber_content_value; ?>" required>
                  ...
                  <div class="form-group form-group-sm" id="form-group_for_current_status">
						<label class="control-label col-sm-3" for="current_status" style="margin-right:15px;color:#00008B;">NOTE(Greige receiving state):</label>
								<input type="radio" class="form-check-input"  value="Partial Greige Issued" id="current_status" name="current_status" checked>
								<label class="form-check-label control-label" for="current_status" style="margin-right:15px;">Partial Greige Issued</label>
								<input type="radio" class="form-check-input"  value="Greige Issued" id="current_status" name="current_status" >
						...
						<div class="form-group form-group-sm">
								<div class="col-sm-offset-3 col-sm-5">
									<button type="button" class="btn btn-primary" onClick="sending_data_of_qc_result_for_greige_receiving_process_form_for_saving_in_database()">Submit</button>
