...
*/
 ...
 function sending_data_of_qc_result_for_raising_process_form_for_saving_in_database()
 {
       ...
       if(validate != false)
	   {
		  	 ...
		  	 $.ajax({
			 		url: 'process_qc_result/qc_result_for_raising_process_saving.php',
			 		dataType: 'text',
			 		type: 'post',
			 		contentType: 'application/x-www-form-urlencoded',
...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
			...
			<body id="target">
				...
				<div class="panel-heading" style="color:#191970;"><b>Qc Result For Raising Process</b></div> <!-- This will create a upper block for FORM (Just Beautification) -->
				...
				<div class="form-group form-group-sm" id="form-group_for_pp_number" onchange="Fill_Value_Of_Version_Number_Field(this.value)">
						...
						<div class="form-group form-group-sm" id="form-group_for_machine_name">
							...
							<div class="form-group form-group-sm" id="form-group_for_face_back">
							    ...
							    <div class="col-sm-5" style="padding-right:4px;">
							      <input type="text" class="form-control" id="face_back" name="face_back" placeholder="Enter Face/Back" required>
							    </div>
     ...
     <div class="form-group form-group-sm" id="form-group_for_tensile_properties_in_warp_value">
         ...
         <div class="col-sm-2 text-center">
            ...
            <div class="col-sm-2 text-center">
             ...
             <input type="text" class="form-control" id="tensile_properties_in_warp_value" name="tensile_properties_in_warp_value" placeholder="Enter  Value" required>
      ...
      <div class="form-group form-group-sm" id="form-group_for_tensile_properties_in_weft_value">
         ...
         <div class="col-sm-2 text-center">
            ...
            <div class="col-sm-2 text-center">
             ...
             <input type="text" class="form-control" id="tensile_properties_in_weft_value" name="tensile_properties_in_weft_value" placeholder="Enter  Value" required>
     ...
     <div class="form-group form-group-sm" id="form-group_for_tear_force_in_warp_value">
         ...
         <div class="col-sm-2 text-center">
            ...
            <div class="col-sm-2 text-center">
             ...
             <input type="text" class="form-control" id="tear_force_in_warp_value" name="tear_force_in_warp_value" placeholder="Enter  Value" required>
      ...
      <div class="form-group form-group-sm" id="form-group_for_tear_force_in_weft_value">
         ...
         <div class="col-sm-2 text-center">
            ...
            <div class="col-sm-2 text-center">
             ...
             <input type="text" class="form-control" id="tear_force_in_weft_value" name="tear_force_in_weft_value" placeholder="Enter  Value" required>
            ...
            <input type="hidden" class="form-control" id="uom_of_tear_force_in_weft" name="uom_of_tear_force_in_weft" value="%" >  
							...
							<label class="control-label col-sm-3" for="hand_feel" style="margin-right:15px;color:#00008B;">hand_feel:</label>
								...
								<label class="control-label col-sm-3" for="raising_quality" style="margin-right:15px;color:#00008B;">raising_quality:</label>
										<input type="radio" class="form-check-input"  value="OK" id="raising_quality" name="raising_quality">
										<label class="form-check-label control-label" for="raising_quality" style="margin-right:15px;">OK</label>
										<input type="radio" class="form-check-input"  value="Not OK" id="raising_quality" name="raising_quality">
						...
						<div class="form-group form-group-sm">
								<div class="col-sm-offset-3 col-sm-5">
									<button type="button" class="btn btn-primary" onClick="sending_data_of_qc_result_for_raising_process_form_for_saving_in_database()">Submit</button>
