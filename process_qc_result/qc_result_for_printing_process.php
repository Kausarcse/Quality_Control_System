...
*/  
 ...
 function sending_data_of_qc_result_for_printing_process_form_for_saving_in_database()
 {
       ...
       if(validate != false)
	   {
		  	 ...
		  	 $.ajax({
			 		url: 'process_qc_result/qc_result_for_printing_process_saving.php',
			 		dataType: 'text',
			 		type: 'post',
			 		contentType: 'application/x-www-form-urlencoded',
...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
			...
			<body id="target">
				...
				<div class="panel-heading" style="color:#191970;"><b>Qc Result For Printing Process</b></div> <!-- This will create a upper block for FORM (Just Beautification) -->
				...
				<div class="form-group form-group-sm" id="form-group_for_pp_number" onchange="Fill_Value_Of_Version_Number_Field(this.value)">
						...
						<div class="form-group form-group-sm" id="form-group_for_machine_name">
						 ...
						 <div class="form-group form-group-sm" id="form-group_for_rubbing_value_in_fabric">
			              ...
			              <div class="col-sm-3 text-center">
			                ...
			                <input type="text" class="form-control" id="cf_to_rubbing_dry_value" name="cf_to_rubbing_dry_value" placeholder="Enter CF to Rubbing Dry Value" style="padding-right:4px;" required>
			              </div>
			              
			              
			              <div class="col-sm-3 text-center">
			                <label for="rubbing_value" style="font-size:12px; color:#000066;"> Wet</label>
			                <input type="text" class="form-control" id="cf_to_rubbing_wet_value" name="cf_to_rubbing_wet_value" placeholder="Enter Rubbing Wet Value" style="padding-right:4px;" required>
			              </div>
						...
						<div class="form-group form-group-sm">
								<div class="col-sm-offset-3 col-sm-6">
									<button type="button" class="btn btn-primary" onClick="sending_data_of_qc_result_for_printing_process_form_for_saving_in_database()">Submit</button>
