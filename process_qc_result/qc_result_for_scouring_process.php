...
*/  
 ...
 function sending_data_of_qc_result_for_scouring_process_form_for_saving_in_database()
 {
       ...
       if(validate != false)
	   {
		  	 ...
		  	 $.ajax({
			 		url: 'process_qc_result/qc_result_for_scouring_process_saving.php',
			 		dataType: 'text',
			 		type: 'post',
			 		contentType: 'application/x-www-form-urlencoded',
...
<div class="col-sm-12 col-md-12 col-lg-12">
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
			...
			<body id="target">
				...
				<div class="panel-heading" style="color:#191970;"><b>Qc Result For Scouring Process</b></div> <!-- This will create a upper block for FORM (Just Beautification) -->
			   ...
			   <div class="form-group form-group-sm" id="form-group_for_residual_sizing_material_value">
                    ...
                    <div class="col-sm-2 text-center">
                      ...
                      <input type="text" class="form-control" id="residual_sizing_material_left_value" name="residual_sizing_material_left_value" placeholder="Enter residual_sizing_material left Value" style="padding-right:4px;" required>
                    </div>
			...
			<div class="form-group form-group-sm" id="form-group_for_absorbency_value">
                    ...
                    <label class="control-label col-sm-3" for="absorbency_value" style="color:#00008B; margin-top:23px;"<span id="for_absorbency_value_test_name_label">Absorbency </span><span id="for_absorbency_value_test_method"> (Capillary Method):</label>
                  ...
                  <input type="hidden" class="form-control" id="uom_of_resistance_to_surface_fuzzing_and_pilling" name="uom_of_resistance_to_surface_fuzzing_and_pilling" placeholder="Enter Uom Of resistance_to_surface_fuzzing_and_pilling" value="value">
						...
						<div class="form-group form-group-sm">
								<div class="col-sm-offset-3 col-sm-6">
									<button type="button" class="btn btn-primary" onClick="sending_data_of_qc_result_for_scouring_process_form_for_saving_in_database()">Submit</button>
