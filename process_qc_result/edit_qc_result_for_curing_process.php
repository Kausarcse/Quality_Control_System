...
// $sql_qc_curing="select id from qc_result_for_curing_process where pp_number = '$trf_pp_number'";
// $res_sql_qc_curing=mysqli_query($con,$sql_qc_curing) or die(mysqli_error($con));
// $row_for_id=mysqli_fetch_assoc($res_sql_qc_curing);

// $curing_id = $row_for_id['id'];


$sql_for_curing="select * from qc_result_for_curing_process where pp_number = '$trf_pp_number' and 
...
$row_for_curing = mysqli_fetch_array( $result_for_curing);
...
<script type='text/javascript' src='process_qc_result/qc_result_for_curing_process_form_validation.js'></script>
...
{   
	var db_table_name="defining_qc_standard_for_curing_process";
...
*/  
 ...
 function sending_data_of_qc_result_for_curing_process_form_for_saving_in_database()
 {


       var validate = Curing_Form_Validation();
       var url_encoded_form_data = $("#qc_result_for_curing_process_form").serialize(); //This will read all control elements value of the form	
       if(validate != false)
	   {


		  	 $.ajax({
			 		url: 'process_qc_result/edit_qc_result_for_curing_process_saving.php',
			 		dataType: 'text',
			 		type: 'post',
			 		contentType: 'application/x-www-form-urlencoded',
 ...
 }//End of function sending_data_of_qc_result_for_curing_process_form_for_saving_in_database()
...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
			...
			<body id="target">
				...
				<div class="panel-heading" style="color:#191970;"><b>Qc Result For Curing Process / <a href="#">Edit</a></b></div> <!-- This will create a upper block for FORM (Just Beautification) -->

				<form class="form-horizontal" action="" style="margin-top:10px;" name="qc_result_for_curing_process_form" id="qc_result_for_curing_process_form">
...
while($row = mysqli_fetch_array($result_for_customer))
{
   ...
   {
      echo "<script>$('#div_appearence_after_wash_full').show()</script>";
   }
		...
		<div id="div_cf_to_rubbing" style="display: none;">
		   ...
		   <div class="form-group form-group-sm">
			     ...
			     <div class="col-sm-2" for="value">
			            ...
			            <input type="text" class="form-control" id="cf_to_rubbing_dry_value" name="cf_to_rubbing_dry_value" value="<?php echo $row_for_curing['cf_to_rubbing_dry_value']?>"   style="color:#00008B; margin-top:23px;">
		   ...
		   <div class="form-group form-group-sm">
			      ...
			      <div class="col-sm-2" for="value">
			            ...
			            <input type="text" class="form-control" id="cf_to_rubbing_wet_value" name="cf_to_rubbing_wet_value" value="<?php echo $row_for_curing['cf_to_rubbing_wet_value']?>">
...
<div id="div_dimensional_stability_to_washing" style="display: none;">
   ...
   <div class="form-group form-group-sm">        
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="dimensional_stability_to_warp_washing_before_iron_value" name="dimensional_stability_to_warp_washing_before_iron_value" value="<?php echo $row_for_curing['dimensional_stability_to_warp_washing_before_iron_value']?>"   style="color:#00008B; margin-top:23px;">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="dimensional_stability_to_weft_washing_before_iron_value" name="dimensional_stability_to_weft_washing_before_iron_value" value="<?php echo $row_for_curing['dimensional_stability_to_weft_washing_before_iron_value']?>">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="dimensional_stability_to_warp_washing_after_iron_value" name="dimensional_stability_to_warp_washing_after_iron_value" value="<?php echo $row_for_curing['dimensional_stability_to_warp_washing_after_iron_value']?>"   style="color:#00008B; margin-top:23px;">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="dimensional_stability_to_weft_washing_after_iron_value" name="dimensional_stability_to_weft_washing_after_iron_value" value="<?php echo $row_for_curing['dimensional_stability_to_weft_washing_after_iron_value']?>">
  	...
  	<div id="div_yarn_count" style="display: none;">
		   ...
		   <div class="form-group form-group-sm">		        
		     ...
		     <div class="col-sm-2" for="value">
		            ...
		            <input type="text" class="form-control" id="warp_yarn_count_value" name="warp_yarn_count_value" value="<?php echo $row_for_curing['warp_yarn_count_value']?>"   style="color:#00008B; margin-top:23px;">
		   ...
		   <div class="form-group form-group-sm">		       
		      ...
		      <div class="col-sm-2" for="value">
		            ...
		            <input type="text" class="form-control" id="weft_yarn_count_value" name="weft_yarn_count_value" value="<?php echo $row_for_curing['weft_yarn_count_value']?>">
...
<div id="div_no_of_threads" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="no_of_threads_in_warp_value" name="no_of_threads_in_warp_value" value="<?php echo $row_for_curing['no_of_threads_in_warp_value']?>"   style="color:#00008B; margin-top:23px;">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="no_of_threads_in_weft_value" name="no_of_threads_in_weft_value" value="<?php echo $row_for_curing['no_of_threads_in_weft_value']?>">
...
<div id="div_mass_per_unit_area" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="mass_per_unit_per_area_value" name="mass_per_unit_per_area_value" value="<?php echo $row_for_curing['mass_per_unit_per_area_value']?>"   style="color:#00008B; margin-top:23px;">
 ...
 <div id="div_resistance_to_surface_fuzzing_and_pilling" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="surface_fuzzing_and_pilling_value" name="surface_fuzzing_and_pilling_value" value="<?php echo $row_for_curing['surface_fuzzing_and_pilling_value']?>"   style="color:#00008B; margin-top:23px;">
...
<div id="div_tensile_properties" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="tensile_properties_in_warp_value" name="tensile_properties_in_warp_value" value="<?php echo $row_for_curing['tensile_properties_in_warp_value']?>"   style="color:#00008B; margin-top:23px;">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="tensile_properties_in_weft_value" name="tensile_properties_in_weft_value" value="<?php echo $row_for_curing['tensile_properties_in_weft_value']?>">
 ...
 <div id="div_tear_force" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="tear_force_in_warp_value" name="tear_force_in_warp_value" value="<?php echo $row_for_curing['tear_force_in_warp_value']?>"   style="color:#00008B; margin-top:23px;">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="tear_force_in_weft_value" name="tear_force_in_weft_value" value="<?php echo $row_for_curing['tear_force_in_weft_value']?>" >
  ...
  <div id="div_resistance_to_surface_wetting" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="resistance_to_surface_wetting_before_wash_value" name="resistance_to_surface_wetting_before_wash_value" value="<?php echo $row_for_curing['resistance_to_surface_wetting_before_wash_value']?>"   style="color:#00008B; margin-top:23px;">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-1 text-center">
       ...
       <div class="col-sm-1 text-center">
                <!-- <label for="description_or_type" style="font-size:12px; color:#000066;">Description/Type</label> -->
                <label class="control-label" for="description_or_type" style="color:#00008B;"> After 1 Washes </label>
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="resistance_to_surface_wetting_after_one_wash_value" name="resistance_to_surface_wetting_after_one_wash_value" value="<?php echo $row_for_curing['resistance_to_surface_wetting_after_one_wash_value']?>">
     ...
     <div class="form-group form-group-sm">
      ...
      <div class="col-sm-1 text-center">
       ...
       <div class="col-sm-1 text-center">
                <!-- <label for="description_or_type" style="font-size:12px; color:#000066;">Description/Type</label> -->
                <label class="control-label" for="description_or_type" style="color:#00008B;"> After 5 Washes </label>
      ...
      <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="resistance_to_surface_wetting_after_five_wash_value" name="resistance_to_surface_wetting_after_five_wash_value" value="<?php echo $row_for_curing['resistance_to_surface_wetting_after_five_wash_value']?>">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="formaldehyde_content_value" name="formaldehyde_content_value" value="<?php echo $row_for_curing['formaldehyde_content_value']?>"   style="color:#00008B; margin-top:23px;">
     </div>
...
<div id="div_ph" >
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="ph_value" name="ph_value" value="<?php echo $row_for_curing['ph_value']?>"   style="color:#00008B; margin-top:23px;">
...
<div id="div_smoothness_appearance" style="display: none;">
   ...
   <div class="form-group form-group-sm">
     ...
     <div class="col-sm-2" for="value">
            ...
            <input type="text" class="form-control" id="smoothness_appearance_value" name="smoothness_appearance_value" value="<?php echo $row_for_curing['smoothness_appearance_value']?>"   style="color:#00008B; margin-top:23px;">
...
<div id="div_appearence_after_wash_full" style="display: none;">
...
<div class="col-sm-3 text-center">
     ...
     <?php
                $appearance_after_wash_radio = $row_for_curing['test_method_for_appearance_after_wash'];
...
<div class="form-group form-group-sm">
            ...
            <?php
            echo $appearance_after_washing_cycle_fabric_wash=$row_for_curing['appearance_after_washing_cycle_fabric_wash'];
            ...
            <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_fabric_color_change_value" name="appearance_after_washing_fabric_color_change_value" value="<?php echo $row_for_curing['appear_after_wash_fabric_color_change_value']?>" required>
         ...
         <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_fabric_cross_staining_value" name="appearance_after_washing_fabric_cross_staining_value" value="<?php echo $row_for_curing['appearance_after_washing_fabric_cross_staining_value']?>" required>
         ...
         <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_fabric_surface_fuzzing_value" name="appearance_after_washing_fabric_surface_fuzzing_value" value="<?php echo $row_for_curing['appearance_after_washing_fabric_surface_fuzzing_value']?>" required>
         ...
         <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_fabric_surface_pilling_value" name="appearance_after_washing_fabric_surface_pilling_value" value="<?php echo $row_for_curing['appearance_after_washing_fabric_surface_pilling_value']?>" required>
         ...
         <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_fabric_crease_before_ironing_value" name="appearance_after_washing_fabric_crease_before_ironing_value" value="<?php echo $row_for_curing['appearance_after_washing_fabric_crease_before_ironing_value']?>" required>
         ...
         <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_fabric_crease_after_ironing_value" name="appearance_after_washing_fabric_crease_after_ironing_value" value="<?php echo $row_for_curing['appearance_after_washing_fabric_crease_after_ironing_value']?>" required>
         ...
         <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_fabric_loss_of_print_value" name="appearance_after_washing_fabric_loss_of_print_value" value="<?php echo $row_for_curing['appearance_after_washing_fabric_loss_of_print_value']?>" required>
         ...
         <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_fabric_abrasive_mark_value" name="appearance_after_washing_fabric_abrasive_mark_value" value="<?php echo $row_for_curing['appearance_after_washing_fabric_abrasive_mark_value']?>" required>
         ...
         <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_fabric_odor_value" name="appearance_after_washing_fabric_odor_value" value="<?php echo $row_for_curing['appearance_after_washing_fabric_odor_value']?>" required>
...
/* $appearance_after_washing_cycle_garments_wash="";
 $appearance_after_washing_cycle_garments_wash_1="";
 $appearance_after_washing_cycle_garments_wash_3="";
 $appearance_after_washing_cycle_garments_wash_5="";
 $appearance_after_washing_cycle_garments_wash_10="";
 $appearance_after_washing_cycle_garments_wash= $row_for_curing['appearance_after_washing_cycle_garments_wash'];
 $splitted_data_for_washing_cycle_garments=explode(',', $appearance_after_washing_cycle_garments_wash);
// 1 wash
 if($splitted_data_for_washing_cycle_garments[0]=="1 wash")
 {
    $appearance_after_washing_cycle_garments_wash_1="1 wash";
 }
 else if($splitted_data_for_washing_cycle_garments[0]=="3 wash")
 {
    $appearance_after_washing_cycle_garments_wash_3="3 wash";
 }
 else if($splitted_data_for_washing_cycle_garments[0]=="5 wash")
 {
    $appearance_after_washing_cycle_garments_wash_5=="5 wash";
 }
 else if($splitted_data_for_washing_cycle_garments[0]=="10 wash")
 {
    $appearance_after_washing_cycle_garments_wash_10="10 wash";
 }
// 3 wash
 if($splitted_data_for_washing_cycle_garments[1]=="1 wash")
 {
    $appearance_after_washing_cycle_garments_wash_1="1 wash";
 }
 else if($splitted_data_for_washing_cycle_garments[1]=="3 wash")
 {
    $appearance_after_washing_cycle_garments_wash_3="3 wash";
 }
 else if($splitted_data_for_washing_cycle_garments[1]=="5 wash")
 {
    $appearance_after_washing_cycle_garments_wash_5="5 wash";
 }
 else if($splitted_data_for_washing_cycle_garments[1]=="10 wash")
 {
    $appearance_after_washing_cycle_garments_wash_10="10 wash";
 }
// 5 wash
 if($splitted_data_for_washing_cycle_garments[2]=="1 wash")
 {
    $appearance_after_washing_cycle_garments_wash_1="1 wash";
 }
 else if($splitted_data_for_washing_cycle_garments[2]=="3 wash")
 {
    $appearance_after_washing_cycle_garments_wash_3="3 wash";
 }
 else if($splitted_data_for_washing_cycle_garments[2]=="5 wash")
 {
    $appearance_after_washing_cycle_garments_wash_5="5 wash";
 }
 else if($splitted_data_for_washing_cycle_garments[2]=="10 wash")
 {
    $appearance_after_washing_cycle_garments_wash_10="10 wash";
 }
//10 wash
   if($splitted_data_for_washing_cycle_garments[3]=="1 wash")
   {
      $appearance_after_washing_cycle_garments_wash_1="1 wash";
   }
   else if($splitted_data_for_washing_cycle_garments[3]=="3 wash")
   {
      $appearance_after_washing_cycle_garments_wash_3="3 wash";
   }
   else if($splitted_data_for_washing_cycle_garments[3]=="5 wash")
   {
      $appearance_after_washing_cycle_garments_wash_5="5 wash";
   }
   else if($splitted_data_for_washing_cycle_garments[3]=="10 wash")
   {
      $appearance_after_washing_cycle_garments_wash_10="10 wash";
   }
*/
//  $appearance_after_washing_cycle_garments_wash_1=$splitted_data_for_washing_cycle_garments[0];
//  $appearance_after_washing_cycle_garments_wash_3=$splitted_data_for_washing_cycle_garments[1];
//  $appearance_after_washing_cycle_garments_wash_5=$splitted_data_for_washing_cycle_garments[2];
//  $appearance_after_washing_cycle_garments_wash_10=$splitted_data_for_washing_cycle_garments[3];

//  echo $appearance_after_washing_cycle_garments_wash;
//   echo $appearance_after_washing_cycle_garments_wash_1;
//   echo $appearance_after_washing_cycle_garments_wash_3;
//   echo $appearance_after_washing_cycle_garments_wash_5;
//   echo $appearance_after_washing_cycle_garments_wash_10;
?>
...
<div class="form-group form-group-sm">
            ...
            <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_garments_color_change_without_suppressor_value" name="appearance_after_washing_garments_color_change_without_suppressor_value" value="<?php echo $row_for_curing['appear_after_wash_garments_color_change_without_sup_value']?>" required>
         ...
         <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_garments_color_change_with_suppressor_value" name="appearance_after_washing_garments_color_change_with_suppressor_value" value="<?php echo $row_for_curing['appear_after_wash_garments_color_change_with_sup_value']?>" required>
         ...
         <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_garments_cross_staining_value" name="appearance_after_washing_garments_cross_staining_value" value="<?php echo $row_for_curing['appearance_after_washing_garments_cross_staining_value']?>" required>
         ...
         <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_garmentsdifferential_shrinkage_value" name="appearance_after_washing_garmentsdifferential_shrinkage_value" value="<?php echo $row_for_curing['appearance_after_washing_garments_differential_shrinkage_value']?>" required>
         ...
         <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_garments_surface_fuzzing_value" name="appearance_after_washing_garments_surface_fuzzing_value" value="<?php echo $row_for_curing['appearance_after_washing_garments_surface_fuzzing_value']?>" required>
         ...
         <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_garments_surface_pilling_value" name="appearance_after_washing_garments_surface_pilling_value" value="<?php echo $row_for_curing['appearance_after_washing_garments_surface_pilling_value']?>" required>
         ...
         <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_garments_crease_after_ironing_value" name="appearance_after_washing_garments_crease_after_ironing_value" value="<?php echo $row_for_curing['appearance_after_washing_garments_crease_after_ironing_value']?>" required>
         ...
         <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_garments_abrasive_mark_value" name="appearance_after_washing_garments_abrasive_mark_value"  value="<?php echo $row_for_curing['appearance_after_washing_garments_abrasive_mark_value']?>"  required>
         ...
         <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_garments_seam_breakdown_value" name="appearance_after_washing_garments_seam_breakdown_value" value="<?php echo $row_for_curing['appearance_after_washing_garments_seam_breakdown_value']?>" required>
         ...
         <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_garments_seam_puckering_roping_after_iron_value" name="appearance_after_washing_garments_seam_puckering_roping_after_iron_value" value="<?php echo $row_for_curing['appearance_after_washing_garments_seam_puckering_roping_after_ir']?>" required>
         ...
         <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_garments_detachment_of_interlining_value" name="appearance_after_washing_garments_detachment_of_interlining_value" value="<?php echo $row_for_curing['appearance_after_washing_garments_detachment_of_interlining_valu']?>" required>
         ...
         <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_garments_change_in_handle_or_appearance_value" name="appearance_after_washing_garments_change_in_handle_or_appearance_value" value="<?php echo $row_for_curing['appearance_after_washing_garments_change_in_handle_value']?>" required>
         ...
         <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_garments_effect_accessories_value" name="appearance_after_washing_garments_effect_accessories_value" value="<?php echo $row_for_curing['appearance_after_washing_garments_effect_accessories_value']?>" required>
         ...
         <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_garments_spirality_value" name="appearance_after_washing_garments_spirality_value" value="<?php echo $row_for_curing['appearance_after_washing_garments_spirality_value']?>" required>
         ...
         <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_garments_detachment_or_fraying_of_ribbons_value" name="appearance_after_washing_garments_detachment_or_fraying_of_ribbons_value"  value="<?php echo $row_for_curing['appearance_after_washing_garments_detachment_or_fraying_of_ribbo']?>" required>
         ...
         <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_garments_loss_of_print_value" name="appearance_after_washing_garments_loss_of_print_value" value="<?php echo $row_for_curing['appearance_after_washing_garments_loss_of_print_value']?>" required>
         ...
         <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_garments_care_level_value" name="appearance_after_washing_garments_care_level_value" value="<?php echo $row_for_curing['appearance_after_washing_garments_care_level_value']?>" required>
         ...
         <div class="form-group form-group-sm">
               ...
               <input type="text" class="form-control" id="appearance_after_washing_garments_odor_value" name="appearance_after_washing_garments_odor_value" value="<?php echo $row_for_curing['appearance_after_washing_garments_odor_value']?>" required>
...
<!-- -------------------------------------------------------------------------------end Appearance after wash---------------------------------------------------------------------------------------------------------------------- -->
						...
						<label class="control-label col-sm-3" for="status" style="margin-right:15px;color:#00008B;">Status:</label>
								<input type="radio" class="form-check-input"  value="OK" id="status" name="status" <?php if($row_for_curing['status']=="OK"){ echo "checked";}?>>
								<label class="form-check-label control-label" for="status" style="margin-right:15px;">OK</label>
								<input type="radio" class="form-check-input"  value="Not OK" id="status" name="status" <?php if($row_for_curing['status']=="Not OK"){ echo "checked";}?>>
						...
						<div class="form-group form-group-sm" id="form-group_for_remarks">
								...
								<div class="col-sm-5">
									<textarea class='form-control' id='remarks' name='remarks' rows='5' value="<?php echo $row_for_curing['remarks']?>" ><?php echo $row_for_curing['remarks']?></textarea>
								</div>
                  ...
                  <div class="form-group form-group-sm" id="form-group_for_current_state">
						   <label class="control-label col-sm-3" for="current_state" style="margin-right:15px;color:#00008B;">NOTE(IS IT A LAST PROCESS):</label>
								<input type="radio" class="form-check-input"  value="PP Completed" id="current_state" name="current_state" <?php if($row_for_curing['current_state']=="PP Completed"){ echo "checked";}?>>
								<label class="form-check-label control-label" for="current_state" style="margin-right:15px;">Yes</label>
								<input type="radio" class="form-check-input"  value="PP in progress" id="current_state" name="current_state" <?php if($row_for_curing['current_state']=="PP in progress"){ echo "checked";}?>>
						...
						<div class="form-group form-group-sm">
								<div class="col-sm-offset-3 col-sm-5">
									<button type="button" class="btn btn-primary" onClick="sending_data_of_qc_result_for_curing_process_form_for_saving_in_database()">Save</button>
