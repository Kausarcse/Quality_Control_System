...
*/  
 ...
 function sending_data_of_qc_result_for_ready_for_mercerize_process_form_for_saving_in_database()
 {
       ...
       if(validate != false)
	   {
		  	 ...
		  	 $.ajax({
			 		url: 'process_qc_result/qc_result_for_ready_for_mercerize_process_saving.php',
			 		dataType: 'text',
			 		type: 'post',
			 		contentType: 'application/x-www-form-urlencoded',
...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
			...
			<body id="target">
				...
				<div class="panel-heading" style="color:#191970;"><b>Qc Result For Ready For Mercerize Process</b></div> <!-- This will create a upper block for FORM (Just Beautification) -->
				...
				<div class="form-group form-group-sm" id="form-group_for_pp_number" onchange="Fill_Value_Of_Version_Number_Field(this.value)">
						...
						<div class="form-group form-group-sm" id="form-group_for_bowing_and_skew_value">
								...
								<div class="col-sm-6" style="padding-right:4px;">
									<input type="text" class="form-control" id="bowing_and_skew_value" name="bowing_and_skew_value" placeholder="Enter Bowing And Skew Value" required>
								</div>
						</div> <!-- End of <div class="form-group form-group-sm" id="form-group_for_"> -->
					...
					<div class="form-group form-group-sm" id="form-group_for_whiteness_value_in_fabric"  >
						    ...
						    <div class="col-sm-2 text-center">
						      ...
						      <input type="text" class="form-control" id="Ph_value_in_left_side_of_fabric" name="Ph_value_in_left_side_of_fabric" placeholder="Enter PH Value In Left Side Of Fabric" style="padding-right:4px;" required>
						    </div>
						    
						   
						    <div class="col-sm-2 text-center">
						      <label for="ph_value" style="font-size:12px; color:#000066;">Center</label>
						      <input type="text" class="form-control" id="Ph_value_in_center_of_fabric" name="Ph_value_in_center_of_fabric" placeholder="Enter PH Value In Center Side Of Fabric" style="padding-right:4px;" required>
						    </div>

						    
						    <div class="col-sm-2 text-center" style="padding-right:4px;">
						      <label for="ph_value" style="font-size:12px; color:#000066;">Right</label>
						      <input type="text" class="form-control" id="Ph_value_in_right_of_fabric" name="Ph_value_in_right_of_fabric" placeholder="Enter PH Value In Right Side Of Fabric" style="padding-right:4px;" required >
						    </div>
						...
						<div class="form-group form-group-sm">
								<div class="col-sm-offset-3 col-sm-6">
									<button type="button" class="btn btn-primary" onClick="sending_data_of_qc_result_for_ready_for_mercerize_process_form_for_saving_in_database()">Submit</button>
