...
$select_sql_for_duplicacy="select * from `partial_test_for_test_result_info` where `pp_number`='$pp_number' and `process_name`='$process_name' and `version_number`='$version_number'
 AND	`before_trolley_number_or_batcher_number`='$before_trolley_number_or_batcher_number' AND
