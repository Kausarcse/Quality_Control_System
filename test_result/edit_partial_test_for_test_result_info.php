...
$row_for_test_result = mysqli_fetch_assoc($result);
...
*/      
        // alert(url_encoded_form_data);
		  	 ...
		  	 $.ajax({
			 		url: 'test_result/edit_partial_test_for_test_result_info_saving.php',
			 		dataType: 'text',
			 		type: 'post',
			 		contentType: 'application/x-www-form-urlencoded',
 ...
 function sending_data_for_edit_form_for_getting_data_from_database(value)
 {
                ...
                { 
                    ...
                    // var get_all_value=data_split_for_result[0]+"?fs?"+data_split_for_result[1]+"?fs?partial_test_for_test_result_info?fs?"+data_split_for_result[6]+"?fs?"+data_split_for_result[14];

                    // var get_all_value=data_split_for_result[0]+"?fs?partial_test_for_trf_info?fs?";
 ...
 function sending_data_for_test_result_edit(partial_test_for_test_result_id)
 {
   var partial_test_for_test_result_id=partial_test_for_test_result_id;
       ...
       $('#div_full_form').load("report/edit_partial_test_for_test_result_info.php?partial_test_for_test_result_id="+encodeURIComponent(partial_test_for_test_result_id));
       $('#div_table').hide();
 }
...
/***************************************************** FOR AUTO COMPLETE********************************************************************/
    ...
    <div class="col-sm-12 col-md-12 col-lg-12">
        <div class="panel panel-default" id="div_full_form">
             ...
             <div class="panel-heading" style="color:#191970;"><b>Test Result Form (Partial Test)/Edit</b></div> <!-- This will create a upper block for FORM (Just Beautification) -->
    ...
    <div class="panel panel-default">
           ...
           <thead>
            ...
            <?php 
                            ...
                            $row_for_pp_color=mysqli_fetch_array($result_for_pp_color);
                               ...
                               if($data_for_at=='PT' || $data_for_at='select')
                               {
         ...
         <!-- ............................................................................. For Report.................................................................................  -->
            ...
            <?php 
            if($row['trf_id']=='select'){
               $get_all_data= "?fs?".$row['version_id'].'?fs?'.$row['pp_number']."?fs?".$row['process_id']."?fs?".$row['style_name']."?fs?".$row['finish_width_in_inch']."?fs?".$row['before_trolley_number_or_batcher_number']."?fs?".$row['after_trolley_number_or_batcher_number']."?fs?".$row['after_trolley_or_batcher_qty'];
            }
            else
            {
              $get_all_data= $row['trf_id']."?fs?".$row['version_id'].'?fs?'.$row['pp_number']."?fs?".$row['process_id']."?fs?".$row['style_name']."?fs?".$row['finish_width_in_inch']."?fs?".$row['before_trolley_number_or_batcher_number']."?fs?".$row['after_trolley_number_or_batcher_number'];
            }
