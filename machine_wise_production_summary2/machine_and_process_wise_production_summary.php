...
function chart_maker(ctx, machine_name_for_array,value_for_today,value_for_todate_total,value_for_current_avg_day)
{
...
function exportF(elem) 
    ...
    function pdf_print()
    {
        ...
        var divContents = document.getElementById("machine_wise_summary_full_div").innerHTML;
