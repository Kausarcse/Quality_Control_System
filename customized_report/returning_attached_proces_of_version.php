...
*/   
		...
		/* $sql = 'select finish_width_in_inch,color,version_name  from `pp_wise_version_creation_info` order by `finish_width_in_inch`';*/
		 $sql = "select distinct process_name from `adding_process_to_version` where pp_number='$pp_number' and `version_name`='$version_number' and `color`='$color_value' order by process_id ASC";
