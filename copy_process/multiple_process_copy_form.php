...
$version_in_table=$split_pp_number[1];*/
...
<script>
   /**********************************************************For Getting Data from PP Monitoring*****************************************************************/
	/*document.getElementById('version_in_table').innerHTML='<?php echo $version_in_table ?>';*/
	

    /**********************************************************End of Getting Data from PP Monitoring*****************************************************************/
...
function Fill_Value_Of_Version_Number_Field_For_Searching(old_pp_number)
{
    ...
    $.ajax({
	 		url: 'copy_process/returning_version_number_details.php',
	 		dataType: 'text',
	 		type: 'post',
	 		contentType: 'application/x-www-form-urlencoded',
	 		data: value_for_data,
...
function Fill_Value_Of_Version_Number_Field_For_Searching_In_Table(new_pp_number)
{
    ...
    $.ajax({
	 		...
	 		{   
	 			...
	 			$.ajax({
			 		url: 'copy_process/returning_pp_number.php',
			 		dataType: 'text',
			 		type: 'post',
			 		contentType: 'application/x-www-form-urlencoded',
			 		data: customer_data,
...
function search_pp_with_design(design)
{
    ...
    $.ajax({
	 		url: 'copy_process/returning_pp_for_design.php',
	 		dataType: 'text',
	 		type: 'post',
	 		contentType: 'application/x-www-form-urlencoded',
	 		data: value_for_data,
...
function calculate_fiber_cotent()
{
 ...
 function sending_data_of_copy_form_previous_pp_for_saving_in_database()
 {
       ...
       var url_encoded_form_data = $("#copy_form_previous_pp").serialize(); 
		  	 ...
		  	 $.ajax({
			 		url: 'copy_process/multiple_process_copy_from_previous_pp.php',
			 		dataType: 'text',
			 		type: 'post',
			 		contentType: 'application/x-www-form-urlencoded',
...
<script>
    $('#datatable_for_copy').ddTableFilter();
  </script>
...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
				...
				<div class="panel-heading" style="color:#191970;"><b>Copy Process</b></div> <!-- This will create a upper block for FORM (Just Beautification) -->
