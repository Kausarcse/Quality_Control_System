...
*/			  $option=$option.'<option value="'.$row['version_id'].'">Version:'.$row['version_name'].', Style: '.$row['style_name'].', Color: '.$row['color'].', Finish Width:'.$row['finish_width_in_inch'].' ,Customer:'.$row['customer_name'].' ,Design:'.$row['design'].'</option>';
