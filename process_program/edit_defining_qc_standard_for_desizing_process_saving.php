...
$select_sql_for_duplicacy="select * from `defining_qc_standard_for_desizing_process` where 
...
else if( mysqli_num_rows($result) < 1)
{
	...
	$update_sql_statement="UPDATE defining_qc_standard_for_desizing_process SET
