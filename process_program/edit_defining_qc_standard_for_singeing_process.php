...
if(isset($_GET['singeing_id']))
{
   $singeing_id=$_GET['singeing_id'];
   $sql_for_singeing="select * from defining_qc_standard_for_singeing_process where `id`='$singeing_id'";
...
{
   $standard_for_which_process='Singeing';
   $pp_number = $_GET['pp_number'];
   $version_id = $_GET['version_number'];
   $sql_for_singeing = "SELECT * FROM `defining_qc_standard_for_singeing_process`
...
?>
<script type='text/javascript' src='process_program/defining_qc_standard_for_singeing_process_form_validation.js'></script>
...
{  
 ...
 function sending_data_of_edit_defining_qc_standard_for_singeing_process_form_for_saving_in_database()
 {
  

      //  //var validate = Singing_Desizing_Form_Validation();
	   //   var validate =true;
       var url_encoded_form_data = $("#defining_qc_standard_for_singeing_process_form").serialize(); //This will read all control elements value of the form
      ...
      //  if(validate != false)
	   // {
		  	 ...
		  	 $.ajax({
			 		url: 'process_program/edit_defining_qc_standard_for_singeing_process_saving.php',
			 		dataType: 'text',
			 		type: 'post',
 ...
 }//End of function sending_data_of_edit_defining_qc_standard_for_singeing_process_form_for_saving_in_database()
...
function delete_singe_and_desizing_process(singeing_id)
{
	var value_for_data= 'singeing_id='+singeing_id;
    
				$.ajax({
						url: 'process_program/deleting_singeing_process_standard.php',
						dataType: 'text',
						type: 'post',
						contentType: 'application/x-www-form-urlencoded',
						data: value_for_data,
...
<div class="col-sm-12 col-md-12 col-lg-12">
	...
	<div class="panel panel-default"> 
				...
				<div class="panel-heading" style="color:#191970;"><b>Edit Defining Standard For Singeing Process</b></div> <!-- This will create a upper block for FORM (Just Beautification) -->
                ...
                <div id='search_form_collpapsible_div_1' class="collapse in"> <!-- For Making Collapsible Section -->
                     ...
                     <form class="form-horizontal" action="" style="margin-top:10px;" name="defining_qc_standard_for_singeing_process_form_view" id="defining_qc_standard_for_singeing_process_form_view" data-toggle="collapse" data-target="#search_form_collpapsible_div">
	                       ...
	                       <table id="datatable-buttons" class="table table-striped table-bordered">
	                        <thead>
	                          ...
	                          <?php
                                          ...
                                          $res_for_singeing = mysqli_query($con, $sql_for_singeing);

                                            while ($row = mysqli_fetch_assoc($res_for_singeing))
                                            {
                                                ...
                                                <tr>
                                                    ...
                                                    <button type="submit" id="edit_singeing" name="edit_singeing"  class="btn btn-primary btn-xs" onclick="load_page('process_program/edit_defining_qc_standard_for_singeing_process.php?singeing_id=<?php echo $row['id'] ?>')"> Edit </button>
                                                    <span>  </span>
                                                    ...
                                                    {
                                                        ?>
                                                            <button type="button" id="delete_singeing" name="delete_singeing"  class="btn btn-danger btn-xs" onclick="delete_singe_and_desizing_process(<?php echo $row['id'];?>)" > Delete </button>
                                                        <?php
                                                    } 
                                                ?>
                                                        <!-- <button type="submit" id="delete_singeing" name="delete_singeing"  class="btn btn-danger btn-xs" onclick="load_page('process_program/deleting_singeing_process_standard.php?singeing_id=<?php echo $row['id'] ?>')"> Delete </button> -->
                                                </td>
                                                <?php
                 ...
                 </form>    <!-- End of <form class="form-horizontal" action="" style="margin-top:10px;" name="defining_qc_standard_for_singeing_process_form" id="defining_qc_standard_for_singeing_process_form"> -->
            
	            </div> <!-- End of <div class="panel-heading" style="color:#191970;"><b> singeing Standard Process List</b></div>  -->
          

   <button type="button" class="btn btn-info" id="buttn_for_load_form" onclick="load_full_form('<?php echo $row_for_singeing['customer_id']?>')">Load Form</button>
    ...
    <form class="form-horizontal" action="" style="margin-top:10px;" name="defining_qc_standard_for_singeing_process_form" id="defining_qc_standard_for_singeing_process_form">

			
					<!--	<label class="control-label col-sm-4" for="pp_number" style="margin-right:0px; color:#00008B;">PP Number:</label>-->
			
                        <input type="hidden" class="form-control" id="pp_number" name="pp_number" value="<?php echo $row_for_singeing['pp_number']?>" >
                        <input type="hidden" id="version_number" name="version_number" value="<?php echo $row_for_singeing['version_number']?>" >
						<input type="hidden" id="customer_name" name="customer_name" value="<?php echo $row_for_singeing['customer_name']?>">
						<input type="hidden" id="customer_id" name="customer_id" value="<?php echo $row_for_singeing['customer_id']?>">
						<input type="hidden" id="color" name="color" value="<?php echo $row_for_singeing['color']?>" >
						<input type="hidden" id="finish_width_in_inch" name="finish_width_in_inch"  value="<?php echo $row_for_singeing['finish_width_in_inch']?>">
                        <input type="hidden" id="standard_for_which_process" name="standard_for_which_process"  value="<?php echo $row_for_singeing['standard_for_which_process']?>">
						<input type="hidden" id="process_id" name="process_id"  value="proc_21">
			            <input type="hidden" id="test_method_id" name="test_method_id"  value="">
                        <input type="hidden" id="version_id" name="version_id" value="<?php echo $row_for_singeing['version_id']?>" >
	 ...
	 <div class="form-group form-group-sm" for="flame_intensity" id="div_flame_intensity" >
       ...
       <div class="col-sm-2 text-center">
          ...
          <div class="col-sm-1 text-center" for="min_value">
           ...
           <input type="text" class="form-control" id="flame_intensity_min_value" name="flame_intensity_min_value" value="<?php echo $row_for_singeing['flame_intensity_min_value']?>" required>

          </div>

          <div class="col-sm-1 text-center">

            <input type="text" class="form-control" id="flame_intensity_max_value" name="flame_intensity_max_value" value="<?php echo $row_for_singeing['flame_intensity_max_value']?>"  required>
      ...
      <div class="col-sm-3 text-center">
       ...
       <div class="col-sm-2 text-center">
          ...
          <input type="text" class="form-control" id="machine_speed_min_value" name="machine_speed_min_value" value="<?php echo $row_for_singeing['machine_speed_min_value']?>" required>

          </div>

          <div class="col-sm-1 text-center">

            <input type="text" class="form-control" id="machine_speed_max_value" name="machine_speed_max_value" value="<?php echo $row_for_singeing['machine_speed_max_value']?>" required>
...
<!-- *********************************** Designing Tabular Formar (Multi-Column Form Elements Here (End))*********************************** -->
						...
						<div class="form-group form-group-sm">
								<div class="col-sm-offset-3 col-sm-5">
									<button type="button" class="btn btn-primary" onClick="sending_data_of_edit_defining_qc_standard_for_singeing_process_form_for_saving_in_database()">Submit</button>
