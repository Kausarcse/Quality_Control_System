...
*/  document.getElementById('color').value=splitted_version_details[1];
 ...
 function sending_data_of_defining_qc_standard_for_raising_process_form_for_saving_in_database()
 {
       ...
       if(validate != false)
	   {
		  	 ...
		  	 $.ajax({
			 		url: 'process_program/defining_qc_standard_for_raising_process_saving.php',
			 		dataType: 'text',
			 		type: 'post',
			 		contentType: 'application/x-www-form-urlencoded',
...
<div class="col-sm-12 col-md-12 col-lg-12">
      ...
      <?php 
			...
			{
				?>
				<div class="panel-heading" style="color:#191970;"><b>Model For Raising Process</b></div> 
						...
						<div class="panel panel-default">
							<table id="datatable-buttons" class="table table-striped table-bordered">
								...
								<tbody>
									...
									$sql_for_raising = "SELECT * FROM `model_defining_qc_standard_for_raising_process` 
                          ...
                          <table id="datatable-buttons" class="table table-striped table-bordered">
                           ...
                           <tr>
                              ...
                              <td>
                                        ...
                                        <button type="button" id="delete_raising" name="delete_raising"  class="btn btn-info btn-xs" onclick="load_page('process_program/edit_defining_qc_standard_for_raising_process.php?raising_id=<?php echo $row['id'] ?>')"> Edit </button>
