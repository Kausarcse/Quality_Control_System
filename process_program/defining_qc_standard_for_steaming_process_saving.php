...
$select_sql_for_duplicacy =  "SELECT * from `defining_qc_standard_for_steaming_process` 
                              where 
...
else if( mysqli_num_rows($result) < 1)
{
	...
	$insert_sql_statement="INSERT into `defining_qc_standard_for_steaming_process`
                          ( 
                          `pp_number`,
                          `version_id`,
                          `version_number`,
