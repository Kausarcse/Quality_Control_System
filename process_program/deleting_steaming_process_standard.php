...
mysqli_query($con,"START TRANSACTION") or die(mysqli_error($con));
	...
	$delete_sql_statement="DELETE FROM `defining_qc_standard_for_steaming_process` WHERE `id`='$steaming_id'";
...
if($data_deleteion_hampering == "No" )
{
	...
	echo "Steaming Standard is Deleted.";
...
else
{
	...
	echo "Steaming Standard is not Deleted.";
