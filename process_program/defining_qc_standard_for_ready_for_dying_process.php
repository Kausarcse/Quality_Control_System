...
*/  document.getElementById('color').value=splitted_version_details[1];
 ...
 function sending_data_of_defining_qc_standard_for_ready_for_dying_process_form_for_saving_in_database()
 {
	   ...
	   {
		  	 $.ajax({
			 		url: 'process_program/defining_qc_standard_for_ready_for_dying_process_saving.php',
			 		dataType: 'text',
			 		type: 'post',
			 		contentType: 'application/x-www-form-urlencoded',
...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<?php 
			...
			{
				?>
				<div class="panel-heading" style="color:#191970;"><b>Model For Ready For Dyeing Process</b></div> 
						...
						<div class="panel panel-default">
							<table id="datatable-buttons" class="table table-striped table-bordered">
								...
								<tbody>
									...
									$sql_for_ready_for_dying = "SELECT * FROM `model_defining_qc_standard_for_ready_for_dying_process` 
                       ...
                       <div class="panel panel-default">
						  ...
						  <tr>
							 ...
							 <td>
                                       ...
                                       <button type="button" id="edit_ready_for_dying" name="edit_ready_for_dying"  class="btn btn-info btn-xs" onclick="load_page('process_program/edit_defining_qc_standard_for_ready_for_dying_process.php?ready_for_dying_id=<?php echo $row['id'] ?>')"> Edit </button>
       ...
       <div class="col-sm-2 text-center">
        ...
        <select  class="form-control" id="bowing_and_skew_tolerance_range_math_operator" name="bowing_and_skew_tolerance_range_math_operator" onchange="bowing_and_skew_cal_for_iso()">
          ...
          <div class="col-sm-1" for="tolerance">
            ...
            <input type="text" class="form-control" id="bowing_and_skew_tolerance_value" name="bowing_and_skew_tolerance_value" placeholder="Enter Tolerance Value" onchange="bowing_and_skew_cal_for_iso()" required>
          </div>
          ...
          <div class="col-sm-1 text-center" for="min_value">
            ...
            <input type="text" class="form-control" id="bowing_and_skew_min_value" name="bowing_and_skew_min_value" placeholder="Enter  Min Value" required>
          </div>
              
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="bowing_and_skew_max_value" name="bowing_and_skew_max_value" placeholder="Enter  Max Value" required>
       ...
       <div class="form-group form-group-sm" >
	      ...
	      <div class="col-sm-3 text-center">
	       ...
	       <div class="col-sm-2 text-center">
	                <!-- <label for="description_or_type" style="font-size:12px; color:#000066;">Direction/Type</label> -->
	                <label class="control-label" for="description_or_type" style="color:#00008B;"> </label>
	                <input type="hidden" class="form-control" id="test_method_for_ph" name="test_method_for_ph" value="">
