...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<?php 
			...
			{
				?>
				<div class="panel-heading" style="color:#191970;"><b>Model For Scouring Process</b></div> 
						...
						<div class="panel panel-default">
							<table id="datatable-buttons" class="table table-striped table-bordered">
								...
								<tbody>
									...
									$sql_for_scouring = "SELECT * FROM `model_defining_qc_standard_for_scouring_process` 
			...
			{
				?>
				<div class="panel-heading" style="color:#191970;"><b>Defining Qc Standard For Scouring Process</b></div> 
                             	...
                             	<tbody>
									...
									while ($row = mysqli_fetch_assoc($res_for_scouring))
									{
										...
										<tr>
											...
											<td>
												<button type="button" id="edit_scouring" name="edit_scouring"  class="btn btn-info btn-xs" onclick="load_page('process_program/edit_defining_qc_standard_for_scouring_process.php?scouring_id=<?php echo $row['id'] ?>')"> Edit </button>
												<?php 
												...
												else
												{
													...
													?>
												<!-- <button type="button" id="delete_scouring" name="delete_scouring"  class="btn btn-danger btn-xs" onclick="load_page('process_program/deleting_scouring_process_standard.php?scouring_id=<?php echo $row['id'] ?>')"> Delete </button> -->
											</td>
										</tr>
											<?php
        ...
        <div class="col-sm-3 text-center">
         ...
         <div class="col-sm-2 text-center">
          ...
          <div class="col-sm-1 text-center" for="min_value">
             ...
             <input type="text" class="form-control" id="resistance_to_surface_fuzzing_and_pilling_min_value" name="resistance_to_surface_fuzzing_and_pilling_min_value" placeholder="Enter  Min Value" required>

          </div>
              
          <div class="col-sm-1 text-center">
              
           <input type="text" class="form-control" id="resistance_to_surface_fuzzing_and_pilling_max_value" name="resistance_to_surface_fuzzing_and_pilling_max_value" placeholder="Enter  Max Value" required>
