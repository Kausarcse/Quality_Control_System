...
*/  document.getElementById('color').value=splitted_version_details[1];
 ...
 function sending_data_of_defining_qc_standard_for_ready_for_printing_process_form_for_saving_in_database()
 {
       ...
       if(validate != false)
	   {
		  	 ...
		  	 $.ajax({
			 		url: 'process_program/defining_qc_standard_for_ready_for_printing_process_saving.php',
			 		dataType: 'text',
			 		type: 'post',
			 		contentType: 'application/x-www-form-urlencoded',
...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<?php 
			...
			{
				?>
				<div class="panel-heading" style="color:#191970;"><b>Model For Ready For Print Process</b></div> 
				...
				<div id='search_form_collpapsible_div_1' class="collapse in"> 
					...
					<form class="form-horizontal" action="" style="margin-top:10px;" name="defining_qc_standard_for_ready_for_print_process_form_view" id="defining_qc_standard_for_ready_for_print_process_form_view" data-toggle="collapse" data-target="#search_form_collpapsible_div">
						<div class="panel panel-default">
							<table id="datatable-buttons" class="table table-striped table-bordered">
								...
								<tbody>
									...
									$sql_for_ready_for_print = "SELECT * FROM `model_defining_qc_standard_for_ready_for_printing_process` 
									...
									$res_for_ready_for_print = mysqli_query($con, $sql_for_ready_for_print);

									while ($row = mysqli_fetch_assoc($res_for_ready_for_print))
									{
			...
			{ 
				?>
				<div class="panel-heading" style="color:#191970;"><b>Defining Qc Standard For Ready for Printing Process</b></div> <!-- This will create a upper block for FORM (Just Beautification) -->
                       ...
                       <div class="panel panel-default">
						  ...
						  <tr>
							 ...
							 <td>
                                       ...
                                       <button type="button" id="edit_ready_for_printing" name="edit_ready_for_printing"  class="btn btn-info btn-xs" onclick="load_page('process_program/edit_defining_qc_standard_for_ready_for_printing_process.php?ready_for_printing_id=<?php echo $row['id'] ?>')"> Edit </button>
           ...
           <input type="text" class="form-control" id="ph_max_value" name="ph_max_value" placeholder="Enter Max Value" required>
						...
						<div class="form-group form-group-sm">
								<div class="col-sm-offset-3 col-sm-5">
									<button type="button" class="btn btn-primary" onClick="sending_data_of_defining_qc_standard_for_ready_for_printing_process_form_for_saving_in_database()">Submit</button>
