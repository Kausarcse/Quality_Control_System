...
if(isset($_GET['scouring_id']))
{
	$scouring_process_id=$_GET['scouring_id'];
	$sql_for_scouring_process="select * from defining_qc_standard_for_scouring_process where `id`='$scouring_process_id'";
	$result_for_scouring_process= mysqli_query($con,$sql_for_scouring_process) or die(mysqli_error($con));
	$row_for_scouring_process = mysqli_fetch_array( $result_for_scouring_process);
...
else
{
   ...
   $sql_for_scouring_process = "SELECT * FROM `defining_qc_standard_for_scouring_process`
...
*/ document.getElementById('color').value=splitted_version_details[1];
 ...
 function sending_data_of_defining_qc_standard_for_scouring_process_form_for_saving_in_database()
 {
       ...
       var url_encoded_form_data = $("#defining_qc_standard_for_scouring_process_form").serialize(); //This will read all control elements value of the form	
		  	 ...
		  	 $.ajax({
			 		url: 'process_program/edit_defining_qc_standard_for_scouring_process_form_saving.php',
			 		dataType: 'text',
			 		type: 'post',
			 		contentType: 'application/x-www-form-urlencoded',
...
function delete_scouring_process(scouring_id)
{
	var value_for_data= 'scouring_id='+scouring_id;
    
				$.ajax({
						url: 'process_program/deleting_scouring_process_standard.php',
						dataType: 'text',
						type: 'post',
						contentType: 'application/x-www-form-urlencoded',
						data: value_for_data,
...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
				...
				<div class="panel-heading" style="color:#191970;"><b>Edit Defining Qc Standard For Scouring Process</b></div> <!-- This will create a upper block for FORM (Just Beautification) -->
                ...
                <div id='search_form_collpapsible_div_1' class="collapse in"> <!-- For Making Collapsible Section -->
                     ...
                     <form class="form-horizontal" action="" style="margin-top:10px;" name="defining_qc_standard_for_scouring_process_form_view" id="defining_qc_standard_for_scouring_process_form_view" data-toggle="collapse" data-target="#search_form_collpapsible_div">
<!--
                       ...
                       <div class="panel panel-default">
                          <table id="datatable-buttons" class="table table-striped table-bordered">
                           <thead>
                             ...
                             <?php
										  ...
										  if(isset($scouring_process_id))
                                          {
											$sql_for_scouring = "SELECT * FROM `defining_qc_standard_for_scouring_process` WHERE `id`='$scouring_process_id'";
										}
                                          else
                                          {
                                             $sql_for_scouring = "SELECT * FROM `defining_qc_standard_for_scouring_process`
                                             WHERE `standard_for_which_process`='$standard_for_which_process' and `pp_number` = '$pp_number' and `version_id`='$version_id'  ORDER BY id ASC";
                                          }


                                          $res_for_scouring = mysqli_query($con, $sql_for_scouring);

                                          while ($row = mysqli_fetch_assoc($res_for_scouring))
                                          {
						  ...
						  <tr>
							 ...
							 <td>
							  		...
							  		<button type="submit" id="edit_scouring" name="edit_scouring"  class="btn btn-info btn-xs" onclick="load_page('process_program/edit_defining_qc_standard_for_scouring_process.php?scouring_id=<?php echo $row['id'] ?>')"> Edit </button>
									  <?php 
                                             ...
                                             {
                                                ?>
                                                   <button type="button" id="delete_scouring" name="delete_scouring"  class="btn btn-danger btn-xs" onclick="delete_scouring_process(<?php echo $row['id'];?>)" > Delete </button>
                                                <?php
                                             } 
                                       ?>
									  <!-- <button type="submit" id="delete_scouring" name="delete_scouring"  class="btn btn-danger btn-xs" onclick="load_page('process_program/deleting_scouring_process_standard.php?scouring_id=<?php echo $row['id'] ?>')"> Delete </button> -->
                               </td>
                              <?php
                ...
                </form>    <!-- End of <form class="form-horizontal" action="" style="margin-top:10px;" name="defining_qc_standard_for_scouring_process_form" id="defining_qc_standard_for_scouring_process_form"> -->

             </div> <!-- End of <div class="panel-heading" style="color:#191970;"><b> scouring Standard Process List</b></div>  -->

			 <button type="button" class="btn btn-info" id="buttn_for_load_form" onclick="load_full_form('<?php echo $row_for_scouring_process['customer_id']?>')">Load Form</button>


			 <div class="full_page_load" id="full_page_load" style="display: none;"> 

				<form class="form-horizontal text-center" action="" style="margin-top:10px;" name="defining_qc_standard_for_scouring_process_form" id="defining_qc_standard_for_scouring_process_form">

					

						<label>PP Number :<?php echo $row_for_scouring_process['pp_number']?><input type="hidden" class="form-control" id="pp_number" name="pp_number" value="<?php echo $row_for_scouring_process['pp_number']?>" readonly></label>  ,
						<label>Version Name :<?php echo $row_for_scouring_process['version_number']?><input type="hidden" id="version_number" name="version_number" value="<?php echo $row_for_scouring_process['version_number']?>" >  </label>  ,
					    <label>Customer Name :<?php echo $row_for_scouring_process['customer_name']?><input type="hidden" id="customer_name" name="customer_name" value="<?php echo $row_for_scouring_process['customer_name']?>"> </label>   ,
					    <input type="hidden" id="customer_id" name="customer_id" value="<?php echo $row_for_scouring_process['customer_id']?>">
					    <label>Color :<?php echo $row_for_scouring_process['color']?><input type="hidden" id="color" name="color" value="<?php echo $row_for_scouring_process['color']?>" > </label>    ,
					    <label>Finish Width :<?php echo $row_for_scouring_process['finish_width_in_inch']?><input type="hidden" id="finish_width_in_inch" name="finish_width_in_inch"  value="<?php echo $row_for_scouring_process['finish_width_in_inch']?>"> </label>
						<input type="hidden" id="version_id" name="version_id" value="<?php echo $row_for_scouring_process['version_id']?>" >

						<input type="hidden" id="standard_for_which_process" name="standard_for_which_process"  value="<?php echo $row_for_scouring_process['standard_for_which_process']?>">
						<input type="hidden" id="process_id" name="process_id"  value="proc_2">
...
<div id="div_residual_sizing_material"> 						
     ...
     <div class="form-group form-group-sm" >
		      ...
		      <div class="col-sm-3 text-center">
		         <label class="control-label"  style="color:#00008B;">Residual Sizing Material (Drop test method)<span id="residual_sizing_material_test_method"></span></label>
		      </div>
		       ...
		       <div class="col-sm-2 text-center">
		                ...
		                <input type="hidden" class="form-control" id="test_method_for_residual_sizing_material" name="test_method_for_residual_sizing_material">
             ...
             <div class="col-sm-1 text-center">
	          ...
	          <div class="col-sm-1 text-center" for="min_value">
	           ...
	           <input type="text" class="form-control" id="residual_sizing_material_min_value" name="residual_sizing_material_min_value" value="<?php echo $row_for_scouring_process['residual_sizing_material_min_value']?>" required>

	          </div>
	              
	          <div class="col-sm-1 text-center">
	              
	           <input type="text" class="form-control" id="residual_sizing_material_max_value" name="residual_sizing_material_max_value" value="<?php echo $row_for_scouring_process['residual_sizing_material_max_value']?>" required>
	      ...
	      <div class="col-sm-3 text-center">
	       ...
	       <div class="col-sm-2 text-center">
	          ...
	          <div class="col-sm-1 text-center" for="min_value">
	           ...
	           <input type="text" class="form-control" id="absorbency_min_value" name="absorbency_min_value" value="<?php echo $row_for_scouring_process['absorbency_min_value']?>" required>

	          </div>
	              
	          <div class="col-sm-1 text-center">
	              
	           <input type="text" class="form-control" id="absorbency_max_value" name="absorbency_max_value" value="<?php echo $row_for_scouring_process['absorbency_max_value']?>" required>
...
<div id="div_resistance_to_surface_fuzzing_and_pilling"> 
	...
	<div class="form-group form-group-sm" >
        ...
        <div class="col-sm-3 text-center">
           <label class="control-label"  style="color:#00008B;">Resistance to Surface Fuzzing & Pilling<span id="resistance_to_surface_fuzzing_and_pilling_test_method">(ISO 12945-2)</span></label>
        </div>
         ...
         <div class="col-sm-2 text-center">
          ...
          <div class="col-sm-1" for="unit">
            ...
            <hr style="color:#FF0000;border-top: 2px dashed #FF0000; margin-top:13px;"/>
            <input type="hidden" class="form-control" id="uom_of_resistance_to_surface_fuzzing_and_pilling" name="uom_of_resistance_to_surface_fuzzing_and_pilling" value="meter/min" >
          </div>

            
          <div class="col-sm-1 text-center" for="min_value">

             <input type="text" class="form-control" id="resistance_to_surface_fuzzing_and_pilling_min_value" name="resistance_to_surface_fuzzing_and_pilling_min_value" value="<?php echo $row_for_scouring_process['resistance_to_surface_fuzzing_and_pilling_min_value']?>" required>

          </div>
              
          <div class="col-sm-1 text-center">
              
           <input type="text" class="form-control" id="resistance_to_surface_fuzzing_and_pilling_max_value" name="resistance_to_surface_fuzzing_and_pilling_max_value" value="<?php echo $row_for_scouring_process['resistance_to_surface_fuzzing_and_pilling_max_value']?>" required>

         </div>
                
       
     </div><!-- End of <div class="form-group form-group-sm" resistance_to_surface_fuzzing_and_pilling_max_value-->					
...
<div id="div_ph"> 
	<div class="form-group form-group-sm" >
          ...
          <div class="col-sm-1 text-center" for="min_value">
           ...
           <input type="text" class="form-control" id="ph_min_value" name="ph_min_value" value="<?php echo $row_for_scouring_process['ph_min_value']?>" required>

          </div>
	              
          <div class="col-sm-1 text-center">
              
           <input type="text" class="form-control" id="ph_max_value" name="ph_max_value" value="<?php echo $row_for_scouring_process['ph_max_value']?>" required>
 						...
 						<div class="form-group form-group-sm">
								<div class="col-sm-offset-3 col-sm-5">
									<button type="button" class="btn btn-primary" onClick="sending_data_of_defining_qc_standard_for_scouring_process_form_for_saving_in_database()">Save</button>
