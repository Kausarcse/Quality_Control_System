...
else
{
   ...
   $sql_for_calendering_process = "SELECT * FROM `defining_qc_standard_for_calendering_process`
...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
				...
				<div class="panel-heading" style="color:#191970;"><b>Edit Defining Qc Standard For Calendering Process/Edit</b></div> <!-- This will create a upper block for FORM (Just Beautification) -->
                          ...
                          <div class="panel panel-default">
                              <table id="datatable-buttons" class="table table-striped table-bordered">
                                 ...
                                 <?php 
                                                 ...
                                                 if(isset($calendering_process_id))
                                                 {
                                                    $sql_for_calendering = "SELECT * FROM `defining_qc_standard_for_calendering_process` WHERE `id`='$calendering_process_id'"; 
                                                 }
                                                 else
                                                 {
                                  ...
                                  <tr>
                                     ...
                                     <td>
                                          ...
                                          <button type="submit" id="edit_calendering" name="edit_calendering"  class="btn btn-info btn-xs" onclick="load_page('process_program/edit_defining_qc_standard_for_calendering_process.php?calendering_id=<?php echo $row['id'] ?>')"> Edit </button>
                                          <?php 
          ...
          <!-------------------------------------------------------- To Load Full Form with Sync------------------------------------------------------------------------------- -->
           ...
           <button type="button" class="btn btn-info" id="buttn_for_load_form" onclick="load_full_form('<?php echo $row_for_calendering_process['customer_id']?>')">Load Form</button>
           ...
           <div class="full_page_load" id="full_page_load" style="display: none;">
            ...
            <label>PP Number :<?php echo $row_for_calendering_process['pp_number']?><input type="hidden" class="form-control" id="pp_number" name="pp_number" value="<?php echo $row_for_calendering_process['pp_number']?>" readonly></label>  ,
						<label>Version Name :<?php echo $row_for_calendering_process['version_number']?><input type="hidden" id="version_number" name="version_number" value="<?php echo $row_for_calendering_process['version_number']?>" >  </label>  ,
					   <label>Customer Name :<?php echo $row_for_calendering_process['customer_name']?><input type="hidden" id="customer_name" name="customer_name" value="<?php echo $row_for_calendering_process['customer_name']?>"> </label>   ,
					   <input type="hidden" id="customer_id" name="customer_id" value="<?php echo $row_for_calendering_process['customer_id']?>">
					   <label>Color :<?php echo $row_for_calendering_process['color']?><input type="hidden" id="color" name="color" value="<?php echo $row_for_calendering_process['color']?>" > </label>    ,
					   <label>Finish Width :<?php echo $row_for_calendering_process['finish_width_in_inch']?><input type="hidden" id="finish_width_in_inch" name="finish_width_in_inch"  value="<?php echo $row_for_calendering_process['finish_width_in_inch']?>"> </label>
                  <input type="hidden" id="version_id" name="version_id" value="<?php echo $row_for_calendering_process['version_id']?>" >
...
<div id="div_cf_to_rubbing" style="display: none">    
        ...
        <div class="form-group form-group-sm">
          ...
          <div class="col-sm-1" for="unit">
          	<hr style="color:#FF0000;border-top: 2px dashed #FF0000; margin-top:35px;"/>
            <input type="hidden" id="uom_of_cf_to_rubbing_dry" name="uom_of_cf_to_rubbing_dry"  value="<?php echo $row_for_calendering_process['uom_of_cf_to_rubbing_dry']?>">
          </div>
      ...
      <div class="form-group form-group-sm">
          ...
          <div class="col-sm-1" for="unit">
          	<hr style="color:#FF0000;border-top: 2px dashed #FF0000; margin-top:13px;"/>
            <input type="hidden" id="uom_of_cf_to_rubbing_wet" name="uom_of_cf_to_rubbing_wet"  value="<?php echo $row_for_calendering_process['uom_of_cf_to_rubbing_wet']?>">
          </div>
...
<div id="div_dimensional_stability_to_washing" style="display: none">
       ...
       <div class="form-group form-group-sm">
			...
			<div class="col-sm-3 text-center">
			 ...
			 <div class="col-sm-2 text-center">
	              ...
	              <input type="hidden" class="form-control" id="test_method_for_dimensional_stability_to_warp_washing_b_iron" name="test_method_for_dimensional_stability_to_warp_washing_b_iron" value="<?php echo $row_for_calendering_process['test_method_for_dimensional_stability_to_warp_washing_b_iron']?>">
	         ...
	         <div class="col-sm-2 text-center">
		          ...
		          <input type="text" class="form-control" id="washing_cycle_for_warp_for_washing_before_iron" name="washing_cycle_for_warp_for_washing_before_iron" value="<?php echo $row_for_calendering_process['washing_cycle_for_warp_for_washing_before_iron']?>">
		      </div>
          ...
          <div class="col-sm-1 text-center" for="min_value">
          	...
          	<input type="text" class="form-control" id="dimensional_stability_to_warp_washing_before_iron_min_value" name="dimensional_stability_to_warp_washing_before_iron_min_value" style="color:#00008B;margin-top:35px;" value="<?php echo $row_for_calendering_process['dimensional_stability_to_warp_washing_before_iron_min_value']?>">
             
          </div>
		          
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="dimensional_stability_to_warp_washing_before_iron_max_value" name="dimensional_stability_to_warp_washing_before_iron_max_value" style="color:#00008B;margin-top:35px;" value="<?php echo $row_for_calendering_process['dimensional_stability_to_warp_washing_before_iron_max_value']?>">
     ...
     <div class="form-group form-group-sm">
			...
			<div class="col-sm-3 text-center">
			 ...
			 <div class="col-sm-2 text-center">
	              ...
	              <input type="hidden" class="form-control" id="test_method_for_dimensional_stability_to_weft_washing_b_iron" name="test_method_for_dimensional_stability_to_weft_washing_b_iron" value="<?php echo $row_for_calendering_process['test_method_for_dimensional_stability_to_weft_washing_b_iron']?>">
	         ...
	         <div class="col-sm-2 text-center">
		          ...
		          <input type="text" class="form-control" id="washing_cycle_for_weft_for_washing_before_iron" name="washing_cycle_for_weft_for_washing_before_iron" value="<?php echo $row_for_calendering_process['washing_cycle_for_weft_for_washing_before_iron']?>">
		      </div>
 ...
 -->
          ...
          <div class="col-sm-1 text-center" for="min_value">
          	...
          	<input type="text" class="form-control" id="dimensional_stability_to_weft_washing_before_iron_min_value" name="dimensional_stability_to_weft_washing_before_iron_min_value" style="color:#00008B;" value="<?php echo $row_for_calendering_process['dimensional_stability_to_weft_washing_before_iron_min_value']?>">
             
          </div>
		          
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="dimensional_stability_to_weft_washing_before_iron_max_value" name="dimensional_stability_to_weft_washing_before_iron_max_value" style="color:#00008B;" value="<?php echo $row_for_calendering_process['dimensional_stability_to_weft_washing_before_iron_max_value']?>">
      ...
      <div class="form-group form-group-sm">
			...
			<div class="col-sm-3 text-center">
			 ...
			 <div class="col-sm-2 text-center">
	              ...
	              <input type="hidden" class="form-control" id="test_method_for_dimensional_stability_to_warp_washing_after_iron" name="test_method_for_dimensional_stability_to_warp_washing_after_iron" value="<?php echo $row_for_calendering_process['test_method_for_dimensional_stability_to_warp_washing_after_iron']?>">
	         ...
	         <div class="col-sm-2 text-center">
		          ...
		          <input type="text" class="form-control" id="washing_cycle_for_warp_for_washing_after_iron" name="washing_cycle_for_warp_for_washing_after_iron" value="<?php echo $row_for_calendering_process['washing_cycle_for_warp_for_washing_after_iron']?>">
		      </div>
          ...
          <div class="col-sm-1" for="unit">
          	 %
            <input type="hidden" id="uom_of_dimensional_stability_to_warp_washing_after_iron" name="uom_of_dimensional_stability_to_warp_washing_after_iron"  value="<?php echo $row_for_calendering_process['uom_of_dimensional_stability_to_warp_washing_after_iron']?>">
          </div>

		        
          <div class="col-sm-1 text-center" for="min_value">

          	<input type="text" class="form-control" id="dimensional_stability_to_warp_washing_after_iron_min_value" name="dimensional_stability_to_warp_washing_after_iron_min_value" style="color:#00008B;" value="<?php echo $row_for_calendering_process['dimensional_stability_to_warp_washing_after_iron_min_value']?>">
             
          </div>
		          
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="dimensional_stability_to_warp_washing_after_iron_max_value" name="dimensional_stability_to_warp_washing_after_iron_max_value" style="color:#00008B;" value="<?php echo $row_for_calendering_process['dimensional_stability_to_warp_washing_after_iron_max_value']?>">
     ...
     <div class="form-group form-group-sm">
			...
			<div class="col-sm-3 text-center">
			 ...
			 <div class="col-sm-2 text-center">
	              ...
	              <input type="hidden" class="form-control" id="test_method_for_dimensional_stability_to_weft_washing_after_iron" name="test_method_for_dimensional_stability_to_weft_washing_after_iron" value="<?php echo $row_for_calendering_process['test_method_for_dimensional_stability_to_weft_washing_after_iron']?>">
	         ...
	         <div class="col-sm-2 text-center">
		          ...
		          <input type="text" class="form-control" id="washing_cycle_for_weft_for_washing_after_iron" name="washing_cycle_for_weft_for_washing_after_iron" value="<?php echo $row_for_calendering_process['washing_cycle_for_weft_for_washing_after_iron']?>">
		      </div>
          ...
          <div class="col-sm-1" for="unit">
          	  %
            <input type="hidden" id="uom_of_dimensional_stability_to_weft_washing_after_iron" name="uom_of_dimensional_stability_to_weft_washing_after_iron"  value="<?php echo $row_for_calendering_process['uom_of_dimensional_stability_to_weft_washing_after_iron']?>">
          </div>

		        
          <div class="col-sm-1 text-center" for="min_value">

          	<input type="text" class="form-control" id="dimensional_stability_to_weft_washing_after_iron_min_value" name="dimensional_stability_to_weft_washing_after_iron_min_value" style="color:#00008B;" value="<?php echo $row_for_calendering_process['dimensional_stability_to_weft_washing_after_iron_min_value']?>">
             
          </div>
		          
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="dimensional_stability_to_weft_washing_after_iron_max_value" name="dimensional_stability_to_weft_washing_after_iron_max_value" style="color:#00008B;" value="<?php echo $row_for_calendering_process['dimensional_stability_to_weft_washing_after_iron_max_value']?>">
 ...
 <div id="div_resistance_to_surface_fuzzing_and_pilling"> 
      ...
      <div class="form-group form-group-sm" for="mass_per_unit_per_area_value">
          ...
          <div class="col-sm-1 text-center">
		    ...
		    <input type="hidden" name="uom_of_surface_fuzzing_and_pilling_value" id="uom_of_surface_fuzzing_and_pilling_value" value="<?php echo $row_for_calendering_process['uom_of_surface_fuzzing_and_pilling_value']?>">    
      ...
      <div class="form-group form-group-sm" for="seam_slippage_resistance_in_warp">
          ...
          <div class="col-sm-1 text-center">
              <select  class="form-control" id="seam_slippage_resistance_in_warp_tolerance_range_math_operator" name="seam_slippage_resistance_in_warp_tolerance_range_math_operator" onchange="seam_slippage_resistance_in_warp_cal()">
                    ...
                    <?php
                                      $seam_slippage_resistance_in_warp_tolerance_range_math_operator = $row_for_calendering_process['seam_slippage_resistance_in_warp_tolerance_range_math_operator'];
          ...
          <div class="col-sm-1" for="tolerance">
            ...
            <input type="text" class="form-control" id="seam_slippage_resistance_in_warp_tolerance_value" name="seam_slippage_resistance_in_warp_tolerance_value" value="<?php echo $row_for_calendering_process['seam_slippage_resistance_in_warp_tolerance_value']?>" onchange="seam_slippage_resistance_in_warp_cal()" required>
          </div>
          ...
          <div class="col-sm-1" for="unit">
             <select  class="form-control" id="uom_of_seam_slippage_resistance_in_warp" name="uom_of_seam_slippage_resistance_in_warp">
                      ...
                      <?php
                                      $uom_of_seam_slippage_resistance_in_warp = $row_for_calendering_process['uom_of_seam_slippage_resistance_in_warp'];
          ...
          <div class="col-sm-1 text-center" for="min_value">
          	...
          	<input type="text" class="form-control" id="seam_slippage_resistance_in_warp_min_value" name="seam_slippage_resistance_in_warp_min_value" value="<?php echo $row_for_calendering_process['seam_slippage_resistance_in_warp_min_value']?>" required>
          </div>
		          
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="seam_slippage_resistance_in_warp_max_value" name="seam_slippage_resistance_in_warp_max_value" value="<?php echo $row_for_calendering_process['seam_slippage_resistance_in_warp_max_value']?>" required>
           </div>
      ...
      <div class="form-group form-group-sm" for="seam_slippage_resistance_in_weft_value">
          ...
          <div class="col-sm-1 text-center">
              <select  class="form-control" id="seam_slippage_resistance_in_weft_tolerance_range_math_operator" name="seam_slippage_resistance_in_weft_tolerance_range_math_operator" onchange="seam_slippage_resistance_in_weft_cal()">
                      ...
                      <?php
                                      $seam_slippage_resistance_in_weft_tolerance_range_math_operator = $row_for_calendering_process['seam_slippage_resistance_in_weft_tolerance_range_math_operator'];
          ...
          <div class="col-sm-1" for="tolerance">
             ...
             <input type="text" class="form-control" id="seam_slippage_resistance_in_weft_tolerance_value" name="seam_slippage_resistance_in_weft_tolerance_value"  value="<?php echo $row_for_calendering_process['seam_slippage_resistance_in_weft_tolerance_value']?>" onchange="seam_slippage_resistance_in_weft_cal()" required>
          </div>
          ...
          <div class="col-sm-1" for="unit">
             <select  class="form-control" id="uom_of_seam_slippage_resistance_in_weft" name="uom_of_seam_slippage_resistance_in_weft">
                      ...
                      <?php
                                      $uom_of_seam_slippage_resistance_in_weft = $row_for_calendering_process['uom_of_seam_slippage_resistance_in_weft'];
          ...
          <div class="col-sm-1 text-center" for="min_value">
          	...
          	<input type="text" class="form-control" id="seam_slippage_resistance_in_weft_min_value" name="seam_slippage_resistance_in_weft_min_value" value="<?php echo $row_for_calendering_process['seam_slippage_resistance_in_weft_min_value']?>" required>
          </div>
		          
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="seam_slippage_resistance_in_weft_max_value" name="seam_slippage_resistance_in_weft_max_value" value="<?php echo $row_for_calendering_process['seam_slippage_resistance_in_weft_max_value']?>" required>
         ...
         <div class="col-sm-2 text-center">
          ...
          <div class="col-sm-1 text-center">
              <select  class="form-control" id="seam_slippage_resistance_iso_2_in_warp_tolerance_range_math_op" name="seam_slippage_resistance_iso_2_in_warp_tolerance_range_math_op" onchange="seam_slippage_resistance_iso_2_in_warp_cal()">
                ...
                <?php
                                      $seam_slippage_resistance_iso_2_in_warp_tolerance_range_math_op = $row_for_calendering_process['seam_slippage_resistance_iso_2_in_warp_tolerance_range_math_op'];
            ...
            <div class="col-sm-1 text-center">
                 <select  class="form-control" id="uom_of_seam_slippage_resistance_iso_2_in_warp_for_load" name="uom_of_seam_slippage_resistance_iso_2_in_warp_for_load">
                      ...
                      <?php
                                      $uom_of_seam_slippage_resistance_iso_2_in_warp_for_load = $row_for_calendering_process['uom_of_seam_slippage_resistance_iso_2_in_warp_for_load'];
          ...
          <div class="col-sm-1" for="tolerance">
             ...
             <select  class="form-control" id="seam_slippage_resistance_iso_2_in_warp_tolerance_value" name="seam_slippage_resistance_iso_2_in_warp_tolerance_value" onchange="seam_slippage_resistance_iso_2_in_warp_cal()">
                ...
                <?php
                                      $seam_slippage_resistance_iso_2_in_warp_tolerance_value = $row_for_calendering_process['seam_slippage_resistance_iso_2_in_warp_tolerance_value'];
          ...
          <div class="col-sm-1 text-center" for="min_value">
            ...
            <input type="text" class="form-control" id="seam_slippage_resistance_iso_2_in_warp_min_value" name="seam_slippage_resistance_iso_2_in_warp_min_value" value="<?php echo $row_for_calendering_process['seam_slippage_resistance_iso_2_in_warp_min_value']?>" required>
          </div>
              
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="seam_slippage_resistance_iso_2_in_warp_max_value" name="seam_slippage_resistance_iso_2_in_warp_max_value" value="<?php echo $row_for_calendering_process['seam_slippage_resistance_iso_2_in_warp_max_value']?>" required>
           </div>
     ...
     <div class="form-group form-group-sm" for="seam_slippage_resistance_iso_2_in_weft">
          ...
          <div class="col-sm-1 text-center">
              <select  class="form-control" id="seam_slippage_resistance_iso_2_in_weft_tolerance_range_math_op" name="seam_slippage_resistance_iso_2_in_weft_tolerance_range_math_op" onchange="seam_slippage_resistance_iso_2_in_weft_cal()">
                <option value="">Select operator Value</option>
                <?php
                                      $seam_slippage_resistance_iso_2_in_weft_tolerance_range_math_op = $row_for_calendering_process['seam_slippage_resistance_iso_2_in_weft_tolerance_range_math_op'];
           ...
           <div class="col-sm-1 text-center">
                 <select  class="form-control" id="uom_of_seam_slippage_resistance_iso_2_in_weft_for_load" name="uom_of_seam_slippage_resistance_iso_2_in_weft_for_load">
                      <option value="">Select Uom</option>
                                ...
                                <?php
                                      $uom_of_seam_slippage_resistance_iso_2_in_weft_for_load = $row_for_calendering_process['uom_of_seam_slippage_resistance_iso_2_in_weft_for_load'];
          ...
          <div class="col-sm-1" for="tolerance">
             ...
             <select  class="form-control" id="seam_slippage_resistance_iso_2_in_weft_tolerance_value" name="seam_slippage_resistance_iso_2_in_weft_tolerance_value" onchange="seam_slippage_resistance_iso_2_in_weft_cal()">
                <option value="">Select Tolerance Value</option>
                                ...
                                <?php
                                      $seam_slippage_resistance_iso_2_in_weft_tolerance_value = $row_for_calendering_process['seam_slippage_resistance_iso_2_in_weft_tolerance_value'];
          ...
          <div class="col-sm-1 text-center" for="min_value">
            ...
            <input type="text" class="form-control" id="seam_slippage_resistance_iso_2_in_weft_min_value" name="seam_slippage_resistance_iso_2_in_weft_min_value" value="<?php echo $row_for_calendering_process['seam_slippage_resistance_iso_2_in_weft_min_value']?>" required>
          </div>
              
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="seam_slippage_resistance_iso_2_in_weft_max_value" name="seam_slippage_resistance_iso_2_in_weft_max_value" value="<?php echo $row_for_calendering_process['seam_slippage_resistance_iso_2_in_weft_max_value']?>" required>
          </div>
...
<div id="div_seam_strength" style="display: none">
      ...
      <div class="form-group form-group-sm" for="seam_strength_in_warp_value">
          ...
          <div class="col-sm-1 text-center">
			  ...
			  <select  class="form-control" id="seam_strength_in_warp_value_tolerance_range_math_operator" name="seam_strength_in_warp_value_tolerance_range_math_operator" onchange="seam_strength_in_warp_cal()">
                      <option value="">Select Seam Strength in Warp Math Operator</option>
                                ...
                                <?php
                                      $seam_strength_in_warp_value_tolerance_range_math_operator = $row_for_calendering_process['seam_strength_in_warp_value_tolerance_range_math_operator'];
          ...
          <div class="col-sm-1" for="tolerance">
            ...
            <input type="text" class="form-control" id="seam_strength_in_warp_value_tolerance_value" name="seam_strength_in_warp_value_tolerance_value" value="<?php echo $row_for_calendering_process['seam_strength_in_warp_value_tolerance_value']?>" onchange="seam_strength_in_warp_cal()" required>
          </div>
          ...
          <div class="col-sm-1" for="unit">
             <select  class="form-control" id="uom_of_seam_strength_in_warp_value" name="uom_of_seam_strength_in_warp_value">
                      <option value="">Select Uom Of Seam Strength in Warp Properties</option>
                                ...
                                <?php
                                      $uom_of_seam_strength_in_warp_value = $row_for_calendering_process['uom_of_seam_strength_in_warp_value'];
          ...
          <div class="col-sm-1 text-center" for="min_value">
          	...
          	<input type="text" class="form-control" id="seam_strength_in_warp_value_min_value" name="seam_strength_in_warp_value_min_value" value="<?php echo $row_for_calendering_process['seam_strength_in_warp_value_min_value']?>" required>
          </div>
		          
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="seam_strength_in_warp_value_max_value" name="seam_strength_in_warp_value_max_value" value="<?php echo $row_for_calendering_process['seam_strength_in_warp_value_max_value']?>" required>
     ...
     <div class="form-group form-group-sm" for="seam_strength_in_weft_value">
          ...
          <div class="col-sm-1 text-center">
			  ...
			  <select  class="form-control" id="seam_strength_in_weft_value_tolerance_range_math_operator" name="seam_strength_in_weft_value_tolerance_range_math_operator" onchange="seam_strength_in_weft_cal()">
                      <option value="">Select  Math Operator</option>
                                ...
                                <?php
                                      $seam_strength_in_weft_value_tolerance_range_math_operator = $row_for_calendering_process['seam_strength_in_weft_value_tolerance_range_math_operator'];
          ...
          <div class="col-sm-1" for="tolerance">
            ...
            <input type="text" class="form-control" id="seam_strength_in_weft_value_tolerance_value" name="seam_strength_in_weft_value_tolerance_value" value="<?php echo $row_for_calendering_process['seam_strength_in_weft_value_tolerance_value']?>" onchange="seam_strength_in_weft_cal()" required>
          </div>
          ...
          <div class="col-sm-1" for="unit">
             <select  class="form-control" id="uom_of_seam_strength_in_weft_value" name="uom_of_seam_strength_in_weft_value">
                      <option value="">Select Uom </option>
                                ...
                                <?php
                                      $uom_of_seam_strength_in_weft_value = $row_for_calendering_process['uom_of_seam_strength_in_weft_value'];
          ...
          <div class="col-sm-1 text-center" for="min_value">
          	...
          	<input type="text" class="form-control" id="seam_strength_in_weft_value_min_value" name="seam_strength_in_weft_value_min_value"  value="<?php echo $row_for_calendering_process['seam_strength_in_weft_value_min_value']?>" required>
          </div>
		          
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="seam_strength_in_weft_value_max_value" name="seam_strength_in_weft_value_max_value"  value="<?php echo $row_for_calendering_process['seam_strength_in_weft_value_max_value']?>" required>
      ...
      <div class="col-sm-3 text-center">
       ...
       <div class="col-sm-2 text-center">
          ...
          <div class="col-sm-1 text-center">
                <select  class="form-control" id="seam_properties_seam_slippage_iso_astm_d_in_warp_tol_range_mt_op" name="seam_properties_seam_slippage_iso_astm_d_in_warp_tol_range_mt_op" onchange="seam_properties_seam_slippage_iso_astm_d_in_warp_cal()">
                   <option value="">Select Tolerance Value</option>
                                    ...
                                    <?php
                                      $seam_properties_seam_slippage_iso_astm_d_in_warp_tol_range_mt_op = $row_for_calendering_process['seam_properties_seam_slippage_iso_astm_d_in_warp_tol_range_mt_op'];
          ...
          <div class="col-sm-1" for="tolerance">
              ...
              <input type="text" class="form-control" id="seam_properties_seam_slippage_iso_astm_d_in_warp_tolerance_value" name="seam_properties_seam_slippage_iso_astm_d_in_warp_tolerance_value" value="<?php echo $row_for_calendering_process['seam_properties_seam_slippage_iso_astm_d_in_warp_tolerance_value']?>" onchange="seam_properties_seam_slippage_iso_astm_d_in_warp_cal()" required>
          </div>
          ...
          <div class="col-sm-1" for="unit">
             <select  class="form-control" id="uom_of_seam_properties_seam_slippage_iso_astm_d_in_warp" name="uom_of_seam_properties_seam_slippage_iso_astm_d_in_warp">
                      ...
                      <?php
                                      $uom_of_seam_properties_seam_slippage_iso_astm_d_in_warp = $row_for_calendering_process['uom_of_seam_properties_seam_slippage_iso_astm_d_in_warp'];
          ...
          <div class="col-sm-1 text-center" for="min_value">
            ...
            <input type="text" class="form-control" id="seam_properties_seam_slippage_iso_astm_d_in_warp_min_value" name="seam_properties_seam_slippage_iso_astm_d_in_warp_min_value" value="<?php echo $row_for_calendering_process['seam_properties_seam_slippage_iso_astm_d_in_warp_min_value']?>" required>
          </div>
              
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="seam_properties_seam_slippage_iso_astm_d_in_warp_max_value" name="seam_properties_seam_slippage_iso_astm_d_in_warp_max_value" value="<?php echo $row_for_calendering_process['seam_properties_seam_slippage_iso_astm_d_in_warp_max_value']?>" required>
           </div>
      ...
      <div class="col-sm-3 text-center">
       ...
       <div class="col-sm-2 text-center">
          ...
          <div class="col-sm-1 text-center">
              <select  class="form-control" id="seam_properties_seam_slippage_iso_astm_d_in_weft_tol_range_mt_op" name="seam_properties_seam_slippage_iso_astm_d_in_weft_tol_range_mt_op" onchange="seam_properties_seam_slippage_iso_astm_d_in_weft_cal()">
                <option value="">Select  Tolerance Value</option>
                                ...
                                <?php
                                      $seam_properties_seam_slippage_iso_astm_d_in_weft_tol_range_mt_op = $row_for_calendering_process['seam_properties_seam_slippage_iso_astm_d_in_weft_tol_range_mt_op'];
          ...
          <div class="col-sm-1" for="unit">
             <select  class="form-control" id="uom_of_seam_properties_seam_slippage_iso_astm_d_in_weft" name="uom_of_seam_properties_seam_slippage_iso_astm_d_in_weft">
                      <option value="">Select Uom </option>
                                ...
                                <?php
                                      $uom_of_seam_properties_seam_slippage_iso_astm_d_in_weft = $row_for_calendering_process['uom_of_seam_properties_seam_slippage_iso_astm_d_in_weft'];
          ...
          <div class="col-sm-1 text-center" for="min_value">
            ...
            <input type="text" class="form-control" id="seam_properties_seam_slippage_iso_astm_d_in_weft_min_value" name="seam_properties_seam_slippage_iso_astm_d_in_weft_min_value" value="<?php echo $row_for_calendering_process['seam_properties_seam_slippage_iso_astm_d_in_weft_min_value']?>" required>
          </div>
              
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="seam_properties_seam_slippage_iso_astm_d_in_weft_max_value" name="seam_properties_seam_slippage_iso_astm_d_in_weft_max_value" value="<?php echo $row_for_calendering_process['seam_properties_seam_slippage_iso_astm_d_in_weft_max_value']?>" required>
           </div>
       ...
       <div class="col-sm-2 text-center">
        ...
        <select  class="form-control" id="seam_properties_seam_strength_iso_astm_d_in_warp_tol_range_op" name="seam_properties_seam_strength_iso_astm_d_in_warp_tol_range_op" onchange="seam_properties_seam_strength_iso_astm_d_in_warp_cal()">
                      <option value="">Select Math Operator</option>
                                ...
                                <?php
                                      $seam_properties_seam_strength_iso_astm_d_in_warp_tol_range_op = $row_for_calendering_process['seam_properties_seam_strength_iso_astm_d_in_warp_tol_range_op'];
          ...
          <div class="col-sm-1" for="tolerance">
            ...
            <input type="text" class="form-control" id="seam_properties_seam_strength_iso_astm_d_in_warp_tolerance_value" name="seam_properties_seam_strength_iso_astm_d_in_warp_tolerance_value" value="<?php echo $row_for_calendering_process['seam_properties_seam_strength_iso_astm_d_in_warp_tolerance_value']?>" onchange="seam_properties_seam_strength_iso_astm_d_in_warp_cal()" required>
          </div>
          ...
          <div class="col-sm-1" for="unit">
             <select  class="form-control" id="uom_of_seam_properties_seam_strength_iso_astm_d_in_warp" name="uom_of_seam_properties_seam_strength_iso_astm_d_in_warp">
                      <option value="">Select Uom </option>
                                    ...
                                    <?php
                                      $uom_of_seam_properties_seam_strength_iso_astm_d_in_warp = $row_for_calendering_process['uom_of_seam_properties_seam_strength_iso_astm_d_in_warp'];
          ...
          <div class="col-sm-1 text-center" for="min_value">
            ...
            <input type="text" class="form-control" id="seam_properties_seam_strength_iso_astm_d_in_warp_min_value" name="seam_properties_seam_strength_iso_astm_d_in_warp_min_value" value="<?php echo $row_for_calendering_process['seam_properties_seam_strength_iso_astm_d_in_warp_min_value']?>" required>
          </div>
              
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="seam_properties_seam_strength_iso_astm_d_in_warp_max_value" name="seam_properties_seam_strength_iso_astm_d_in_warp_max_value" value="<?php echo $row_for_calendering_process['seam_properties_seam_strength_iso_astm_d_in_warp_max_value']?>" required>
       ...
       <div class="col-sm-2 text-center">
        ...
        <select  class="form-control" id="seam_properties_seam_strength_iso_astm_d_in_weft_tol_range_op" name="seam_properties_seam_strength_iso_astm_d_in_weft_tol_range_op" onchange="seam_properties_seam_strength_iso_astm_d_in_weft_cal()">
                      <option value="">Select Math Operator</option>
                                ...
                                <?php
                                      $seam_properties_seam_strength_iso_astm_d_in_weft_tol_range_op = $row_for_calendering_process['seam_properties_seam_strength_iso_astm_d_in_weft_tol_range_op'];
          ...
          <div class="col-sm-1" for="tolerance">
            ...
            <input type="text" class="form-control" id="seam_properties_seam_strength_iso_astm_d_in_weft_tolerance_value" name="seam_properties_seam_strength_iso_astm_d_in_weft_tolerance_value" value="<?php echo $row_for_calendering_process['seam_properties_seam_strength_iso_astm_d_in_weft_tolerance_value']?>" onchange="seam_properties_seam_strength_iso_astm_d_in_weft_cal()" required>
          </div>
          ...
          <div class="col-sm-1" for="unit">
             <select  class="form-control" id="uom_of_seam_properties_seam_strength_iso_astm_d_in_weft" name="uom_of_seam_properties_seam_strength_iso_astm_d_in_weft">
                      <option value="">Select Uom </option>
                                ...
                                <?php
                                      $uom_of_seam_properties_seam_strength_iso_astm_d_in_weft = $row_for_calendering_process['uom_of_seam_properties_seam_strength_iso_astm_d_in_weft'];
          ...
          <div class="col-sm-1 text-center" for="min_value">
            ...
            <input type="text" class="form-control" id="seam_properties_seam_strength_iso_astm_d_in_weft_min_value" name="seam_properties_seam_strength_iso_astm_d_in_weft_min_value" value="<?php echo $row_for_calendering_process['seam_properties_seam_strength_iso_astm_d_in_weft_min_value']?>" required>
          </div>
              
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="seam_properties_seam_strength_iso_astm_d_in_weft_max_value" name="seam_properties_seam_strength_iso_astm_d_in_weft_max_value" value="<?php echo $row_for_calendering_process['seam_properties_seam_strength_iso_astm_d_in_weft_max_value']?>" required>
          ...
          <div class="form-group form-group-sm">
                                <div class="col-sm-offset-3 col-sm-5">
                                    <button type="button" class="btn btn-primary" onClick="sending_data_of_defining_qc_standard_for_calendering_process_form_for_saving_in_database()">Save</button>
