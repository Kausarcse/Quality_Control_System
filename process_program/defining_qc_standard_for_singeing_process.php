...
*/ document.getElementById('color').value=splitted_version_details[1];
  ...
  document.getElementById('standard_for_which_process').value='Singeing';
  document.getElementById('process_id').value='proc_21';
 ...
 function sending_data_of_defining_qc_standard_for_singeing_process_form_for_saving_in_database()
 {
	   ...
	   //alert(url_encoded_form_data);
		  	 ...
		  	 $.ajax({
			 		url: 'process_program/defining_qc_standard_for_singeing_process_saving.php',
			 		dataType: 'text',
			 		type: 'post',
			 		contentType: 'application/x-www-form-urlencoded',
 ...
 }//End of function sending_data_of_defining_qc_standard_for_singeing_process_form_for_saving_in_database()
...
function delete_singeing_process(singeing_id)
{
...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<?php 
			...
			{
				?>
				<div class="panel-heading" style="color:#191970;"><b>Model For Singeing Process</b></div> 
						...
						<div class="panel panel-default">
							<table id="datatable-buttons" class="table table-striped table-bordered">
								...
								<tbody>
									...
									$sql_for_singeing = "SELECT * FROM `model_defining_qc_standard_for_singeing_process` 
			...
			{ 
				...
				<div class="panel-heading" style="color:#191970;"><b>Defining Standard For Singeing Process</b></div> <!-- This will create a upper block for FORM (Just Beautification) -->
	                    ...
	                    <div class="panel panel-default">
						  ...
						  <tr>
							 ...
							 <td>
                                      ...
                                      <button type="submit" id="edit_singeing" name="edit_singeing"  class="btn btn-info btn-xs" onclick="load_page('process_program/edit_defining_qc_standard_for_singeing_process.php?singeing_id=<?php echo $row['id'] ?>')"> Edit </button>
									  ...
									  <?php 
											 ...
											 {
												?>
													<button type="button" id="delete_singeing" name="delete_singeing"  class="btn btn-danger btn-xs" onclick="delete_singeing_process(<?php echo $row['id'];?>)" > Delete </button>
												<?php
											 } 
									  ?>
...
<!-- *********************************** Designing Tabular Formar (Multi-Column Form Elements Here (End))*********************************** -->
						...
						<div class="form-group form-group-sm">
								<div class="col-sm-offset-3 col-sm-5">
									<button type="button" class="btn btn-primary" onClick="sending_data_of_defining_qc_standard_for_singeing_process_form_for_saving_in_database()">Submit</button>
