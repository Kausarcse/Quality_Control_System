...
else
{
   ...
   $sql_for_curing_process = "SELECT * FROM `defining_qc_standard_for_curing_process`
...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
				...
				<div class="panel-heading" style="color:#191970;"><b>Edit Defining Qc Standard For Curing Process / Edit</b></div> <!-- This will create a upper block for FORM (Just Beautification) -->
                ...
                <div class="row" data-toggle="collapse" data-target="#search_form_collpapsible_div_1" onClick="change_up_down_arrow_icon_1(this.childNodes[5].childNodes[1].id)">
                          ...
                          <div class="panel panel-default">
                              <table id="datatable-buttons" class="table table-striped table-bordered">
                                 ...
                                 <?php 
                                                 ...
                                                 if(isset($curing_process_id))
                                                      {
                                                         $sql_for_curing = "SELECT * FROM `defining_qc_standard_for_curing_process` WHERE `id`='$curing_process_id'";
                                                      }
                                                      else
                                                      {
                 ...
                 <button type="button" class="btn btn-info" id="buttn_for_load_form" onclick="load_full_form('<?php echo $row_for_curing_process['customer_id']?>')">Load Form</button>
...
<div class="full_page_load" id="full_page_load" style="display: none;"> 
				...
				<form class="form-horizontal" action="" style="margin-top:10px;" name="defining_qc_standard_for_curing_process_form" id="defining_qc_standard_for_curing_process_form">
                        ...
                        <label>PP Number :<?php echo $row_for_curing_process['pp_number']?><input type="hidden" class="form-control" id="pp_number" name="pp_number" value="<?php echo $row_for_curing_process['pp_number']?>" readonly></label>  ,
						<label>Version Name :<?php echo $row_for_curing_process['version_number']?><input type="hidden" id="version_number" name="version_number" value="<?php echo $row_for_curing_process['version_number']?>" >  </label>  ,
					    <label>Customer Name :<?php echo $row_for_curing_process['customer_name']?><input type="hidden" id="customer_name" name="customer_name" value="<?php echo $row_for_curing_process['customer_name']?>"> </label>   ,
					    <input type="hidden" id="customer_id" name="customer_id" value="<?php echo $row_for_curing_process['customer_id']?>">
					    <label>Color :<?php echo $row_for_curing_process['color']?><input type="hidden" id="color" name="color" value="<?php echo $row_for_curing_process['color']?>" > </label>    ,
					    <label>Finish Width :<?php echo $row_for_curing_process['finish_width_in_inch']?><input type="hidden" id="finish_width_in_inch" name="finish_width_in_inch"  value="<?php echo $row_for_curing_process['finish_width_in_inch']?>"> </label>
                   <input type="hidden" id="version_id" name="version_id" value="<?php echo $row_for_curing_process['version_id']?>" >
...
<div id="div_dimensional_stability_to_washing" style="display: none">
       ...
       <div class="form-group form-group-sm">
			...
			<div class="col-sm-3 text-center">
	         ...
	         <div class="col-sm-2 text-center">
		          ...
		          <input type="text" class="form-control" id="washing_cycle_for_warp_for_washing_before_iron" name="washing_cycle_for_warp_for_washing_before_iron" value="<?php echo $row_for_curing_process['washing_cycle_for_warp_for_washing_before_iron']?>" required>
		      </div>
          ...
          <div class="col-sm-1 text-center" for="min_value">
          	...
          	<input type="text" class="form-control" id="dimensional_stability_to_warp_washing_before_iron_min_value" name="dimensional_stability_to_warp_washing_before_iron_min_value" style="color:#00008B;margin-top:35px;" value="<?php echo $row_for_curing_process['dimensional_stability_to_warp_washing_before_iron_min_value']?>" required>
             
          </div>
		          
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="dimensional_stability_to_warp_washing_before_iron_max_value" name="dimensional_stability_to_warp_washing_before_iron_max_value" style="color:#00008B;margin-top:35px;" value="<?php echo $row_for_curing_process['dimensional_stability_to_warp_washing_before_iron_max_value']?>" required>
     ...
     <div class="form-group form-group-sm">
			...
			<div class="col-sm-3 text-center">
	         ...
	         <div class="col-sm-2 text-center">
		          ...
		          <input type="text" class="form-control" id="washing_cycle_for_weft_for_washing_before_iron" name="washing_cycle_for_weft_for_washing_before_iron" value="<?php echo $row_for_curing_process['washing_cycle_for_weft_for_washing_before_iron']?>" required>
		      </div>
 ...
 -->
          ...
          <div class="col-sm-1 text-center" for="min_value">
          	...
          	<input type="text" class="form-control" id="dimensional_stability_to_weft_washing_before_iron_min_value" name="dimensional_stability_to_weft_washing_before_iron_min_value" style="color:#00008B;" value="<?php echo $row_for_curing_process['dimensional_stability_to_weft_washing_before_iron_min_value']?>" required>
             
          </div>
		          
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="dimensional_stability_to_weft_washing_before_iron_max_value" name="dimensional_stability_to_weft_washing_before_iron_max_value" style="color:#00008B;" value="<?php echo $row_for_curing_process['dimensional_stability_to_weft_washing_before_iron_max_value']?>" required>
     ...
     <div class="form-group form-group-sm">
                 ...
                 <div class="col-sm-1 text-center">
                   ...
                   <select  class="form-control" id="resistance_to_surface_wetting_before_wash_tol_range_math_op" name="resistance_to_surface_wetting_before_wash_tol_range_math_op" onchange="resistance_to_surface_wetting_before_wash_cal()">
                      <option value="">Select CF To Surface Wetting Staining Range Math Operator</option>
                                  ...
                                  <?php
                                      $resistance_to_surface_wetting_before_wash_tol_range_math_op = $row_for_curing_process['resistance_to_surface_wetting_before_wash_tol_range_math_op'];
                ...
                <div class="col-sm-1 text-center">
                    ...
                    <option value="">Select Tolerance Value</option>
                                  ...
                                  <?php
                                      $resistance_to_surface_wetting_before_wash_tolerance_value = $row_for_curing_process['resistance_to_surface_wetting_before_wash_tolerance_value'];
     ...
     <div class="form-group form-group-sm">
                 ...
                 <div class="col-sm-1 text-center">
                   ...
                   <select  class="form-control" id="resistance_to_surface_wetting_after_one_wash_tol_range_math_op" name="resistance_to_surface_wetting_after_one_wash_tol_range_math_op" onchange="resistance_to_surface_wetting_after_one_wash_cal()">
                      <option value="">Select CF To Surface Wetting Staining Range Math Operator</option>
                                  ...
                                  <?php
                                      $resistance_to_surface_wetting_after_one_wash_tol_range_math_op = $row_for_curing_process['resistance_to_surface_wetting_after_one_wash_tol_range_math_op'];
                ...
                <div class="col-sm-1 text-center">
                    ...
                    <option value="">Select Tolerance Value</option>
                                  ...
                                  <?php
                                      $resistance_to_surface_wetting_after_one_wash_tolerance_value = $row_for_curing_process['resistance_to_surface_wetting_after_one_wash_tolerance_value'];
     ...
     <div class="form-group form-group-sm">
                 ...
                 <div class="col-sm-1 text-center">
                   ...
                   <select  class="form-control" id="resistance_to_surface_wetting_after_five_wash_tol_range_math_op" name="resistance_to_surface_wetting_after_five_wash_tol_range_math_op" onchange="resistance_to_surface_wetting_after_five_wash_cal()">
                      <option value="">Select CF To Surface Wetting Staining Range Math Operator</option>
                                  ...
                                  <?php
                                      $resistance_to_surface_wetting_after_five_wash_tol_range_math_op = $row_for_curing_process['resistance_to_surface_wetting_after_five_wash_tol_range_math_op'];
                ...
                <div class="col-sm-1 text-center">
                      ...
                      <option value="">Select Tolerance Value</option>
                                  ...
                                  <?php
                                      $resistance_to_surface_wetting_after_five_wash_tolerance_value = $row_for_curing_process['resistance_to_surface_wetting_after_five_wash_tolerance_value'];
   ...
   <div class="form-group form-group-sm" id="div_smoothness_appearance" style="display: none">
          ...
          <div class="col-sm-2 text-center">
            <label class="control-label" for="washing_cycle" style="color:#00008B;">Washing Cycle</label>
		          <input type="text" class="form-control" id="smoothness_appearance_tolerance_washing_cycle" name="smoothness_appearance_tolerance_washing_cycle" value="<?php echo $row_for_curing_process['smoothness_appearance_tolerance_washing_cycle']?>" required>
		      </div>
             ...
             <label class="control-label" for="" style="color:#00008B;"></label>
                 ...
                 <select  class="form-control" id="smoothness_appearance_tolerance_range_math_op" name="smoothness_appearance_tolerance_range_math_op" onchange="smoothness_appearance_cal()">
                      <option value="">Select CF To Dry Cleaning cross staining Range Math Operator</option>
                                  ...
                                  <?php
                                      $smoothness_appearance_tolerance_range_math_op = $row_for_curing_process['smoothness_appearance_tolerance_range_math_op'];
              ...
              <label class="control-label" for="" style="color:#00008B;"></label>
                  ...
                  <select  class="form-control" id="smoothness_appearance_tolerance_value" name="smoothness_appearance_tolerance_value" onchange="smoothness_appearance_cal()">
                      <option value="">Select Tolerance Value</option>
                                  ...
                                  <?php
                                      $smoothness_appearance_tolerance_value = $row_for_curing_process['smoothness_appearance_tolerance_value'];
              ...
              <label class="control-label" for="" style="color:#00008B;"></label>
                   ...
                   <input type="text" class="form-control" id="smoothness_appearance_min_value" name="smoothness_appearance_min_value" value="<?php echo $row_for_curing_process['smoothness_appearance_min_value']?>" required>
              ...
              <label class="control-label" for="" style="color:#00008B;"></label>
                  ...
                  <input type="text" class="form-control" id="smoothness_appearance_max_value" name="smoothness_appearance_max_value" value="<?php echo $row_for_curing_process['smoothness_appearance_max_value']?>" required>
...
<div class="form-group form-group-sm">
     ...
     <?php
                  $appearance_after_wash_radio = $row_for_curing_process['test_method_for_appearance_after_wash_fabric'];
...
<div id="div_appearance_after_wash_fabric" style="display: none">         <!--div appearance after wash fabric------------------------------------------------------------------->
      ...
      <div class="form-group form-group-sm">
            ...
            <?php
            $appearance_after_washing_cycle_fabric_wash=$row_for_curing_process['appearance_after_washing_cycle_fabric_wash'];
            ...
            <div class="col-sm-2 text-center">
               ...
               <div class="col-sm-1 text-center">
                  ...
                  <select  class="form-control" id="appearance_after_washing_fabric_color_change_tolerance_range_math_operator" name="appearance_after_washing_fabric_color_change_tolerance_range_math_operator" onchange="appearance_after_washing_color_change_fabric_cal()">
                     ...
                     <?php
                                      $appearance_after_washing_fabric_color_change_math_op = $row_for_curing_process['appearance_after_washing_fabric_color_change_math_op'];
               ...
               <div class="col-sm-1 text-center">
                  <select  class="form-control" id="appearance_after_washing_fabric_color_change_tolerance_value" name="appearance_after_washing_fabric_color_change_tolerance_value" onchange="appearance_after_washing_color_change_fabric_cal()">
                     <option value="">Select Tolerance Value</option>
                     <?php
                                      $appearance_after_washing_fabric_color_change_tolerance_value = $row_for_curing_process['appearance_after_washing_fabric_color_change_tolerance_value'];
               ...
               <div class="col-sm-1 text-center" for="min_value">
                  ...
                  <input type="text" class="form-control" id="appearance_after_washing_fabric_color_change_min_value" name="appearance_after_washing_fabric_color_change_min_value" value="<?php echo $row_for_curing_process['appearance_after_washing_fabric_color_change_min_value']?>" required>
               </div>
                  
               <div class="col-sm-1 text-center">
                  
                  <input type="text" class="form-control" id="appearance_after_washing_fabric_color_change_max_value" name="appearance_after_washing_fabric_color_change_max_value" value="<?php echo $row_for_curing_process['appearance_after_washing_fabric_color_change_max_value']?>" required>
       ...
       <div class="col-sm-2 text-center">
        ...
        <div class="col-sm-1 text-center">
            ...
            <select  class="form-control" id="appearance_after_washing_fabric_cross_staining_tolerance_range_math_operator" name="appearance_after_washing_fabric_cross_staining_tolerance_range_math_operator" onchange="appearance_after_washing_cross_staining_fabric_cal()">
                 ...
                 <?php
                                      $appearance_after_washing_fabric_cross_staining_math_op = $row_for_curing_process['appearance_after_washing_fabric_cross_staining_math_op'];
         ...
         <div class="col-sm-1 text-center">
             <select  class="form-control" id="appearance_after_washing_fabric_cross_staining_tolerance_value" name="appearance_after_washing_fabric_cross_staining_tolerance_value" onchange="appearance_after_washing_cross_staining_fabric_cal()">
                 <option value="">Select Tolerance Value</option>
                 <?php
                                      $appearance_after_washing_fabric_cross_staining_tolerance_value = $row_for_curing_process['appearance_after_washing_fabric_cross_staining_tolerance_value'];
         ...
         <div class="col-sm-1 text-center" for="min_value">
              ...
              <input type="text" class="form-control" id="appearance_after_washing_fabric_cross_staining_min_value" name="appearance_after_washing_fabric_cross_staining_min_value" value="<?php echo $row_for_curing_process['appearance_after_washing_fabric_cross_staining_min_value']?>" required>
            
         </div>
             
         <div class="col-sm-1 text-center">
             
             <input type="text" class="form-control" id="appearance_after_washing_fabric_cross_staining_max_value" name="appearance_after_washing_fabric_cross_staining_max_value" value="<?php echo $row_for_curing_process['appearance_after_washing_fabric_cross_staining_max_value']?>" required>
       ...
       <div class="col-sm-2 text-center">
        ...
        <div class="col-sm-1 text-center">
            ...
            <select  class="form-control" id="appearance_after_washing_fabric_surface_fuzzing_tolerance_range_math_operator" name="appearance_after_washing_fabric_surface_fuzzing_tolerance_range_math_operator" onchange="appearance_after_washing_surface_fuzzing_fabric_cal()">
                 ...
                 <?php
                                      $appearance_after_washing_fabric_surface_fuzzing_math_op = $row_for_curing_process['appearance_after_washing_fabric_surface_fuzzing_math_op'];
         ...
         <div class="col-sm-1 text-center">
             <select  class="form-control" id="appearance_after_washing_fabric_surface_fuzzing_tolerance_value" name="appearance_after_washing_fabric_surface_fuzzing_tolerance_value" onchange="appearance_after_washing_surface_fuzzing_fabric_cal()">
                 <option value="">Select Tolerance Value</option>
                 <?php
                                      $appearance_after_washing_fabric_surface_fuzzing_tolerance_value = $row_for_curing_process['appearance_after_washing_fabric_surface_fuzzing_tolerance_value'];
         ...
         <div class="col-sm-1 text-center" for="min_value">
              ...
              <input type="text" class="form-control" id="appearance_after_washing_fabric_surface_fuzzing_min_value" name="appearance_after_washing_fabric_surface_fuzzing_min_value" value="<?php echo $row_for_curing_process['appearance_after_washing_fabric_surface_fuzzing_min_value']?>" required>
            
         </div>
             
         <div class="col-sm-1 text-center">
             
             <input type="text" class="form-control" id="appearance_after_washing_fabric_surface_fuzzing_max_value" name="appearance_after_washing_fabric_surface_fuzzing_max_value" value="<?php echo $row_for_curing_process['appearance_after_washing_fabric_surface_fuzzing_max_value']?>" required>
       ...
       <div class="col-sm-2 text-center">
        ...
        <div class="col-sm-1 text-center">
            ...
            <select  class="form-control" id="appearance_after_washing_fabric_surface_pilling_tolerance_range_math_operator" name="appearance_after_washing_fabric_surface_pilling_tolerance_range_math_operator" onchange="appearance_after_washing_surface_pilling_fabric_cal()">
                 ...
                 <?php
                                      $appearance_after_washing_fabric_surface_pilling_math_op = $row_for_curing_process['appearance_after_washing_fabric_surface_pilling_math_op'];
         ...
         <div class="col-sm-1 text-center">
             <select  class="form-control" id="appearance_after_washing_fabric_surface_pilling_tolerance_value" name="appearance_after_washing_fabric_surface_pilling_tolerance_value" onchange="appearance_after_washing_surface_pilling_fabric_cal()">
                 <option value="">Select Tolerance Value</option>
                 <?php
                                      $appearance_after_washing_fabric_surface_pilling_tolerance_value = $row_for_curing_process['appearance_after_washing_fabric_surface_pilling_tolerance_value'];
         ...
         <div class="col-sm-1 text-center" for="min_value">
              ...
              <input type="text" class="form-control" id="appearance_after_washing_fabric_surface_pilling_min_value" name="appearance_after_washing_fabric_surface_pilling_min_value"  value="<?php echo $row_for_curing_process['appearance_after_washing_fabric_surface_pilling_min_value']?>" required>
            
         </div>
             
         <div class="col-sm-1 text-center">
             
             <input type="text" class="form-control" id="appearance_after_washing_fabric_surface_pilling_max_value" name="appearance_after_washing_fabric_surface_pilling_max_value"  value="<?php echo $row_for_curing_process['appearance_after_washing_fabric_surface_pilling_max_value']?>" required>
 ...
 <div class="col-sm-2 text-center">
  ...
  <div class="col-sm-1 text-center">
      ...
      <select  class="form-control" id="appearance_after_washing_fabric_crease_before_ironing_tolerance_range_math_operator" name="appearance_after_washing_fabric_crease_before_ironing_tolerance_range_math_operator" onchange="appearance_after_washing_crease_before_ironing_fabric_cal()">
           ...
           <?php
                                      $appearance_after_washing_fabric_crease_before_iron_math_op = $row_for_curing_process['appearance_after_washing_fabric_crease_before_iron_math_op'];
   ...
   <div class="col-sm-1 text-center">
       <select  class="form-control" id="appearance_after_washing_fabric_crease_before_ironing_tolerance_value" name="appearance_after_washing_fabric_crease_before_ironing_tolerance_value" onchange="appearance_after_washing_crease_before_ironing_fabric_cal()">
           <option value="">Select Tolerance Value</option>
           <?php
                                      $appearance_after_washing_fabric_crease_before_iron_tolerance_val = $row_for_curing_process['appearance_after_washing_fabric_crease_before_iron_tolerance_val'];
   ...
   <div class="col-sm-1 text-center" for="min_value">
        ...
        <input type="text" class="form-control" id="appearance_after_washing_fabric_crease_before_ironing_min_value" name="appearance_after_washing_fabric_crease_before_ironing_min_value" value="<?php echo $row_for_curing_process['appearance_after_washing_fabric_crease_before_ironing_min_value']?>" required>
      
   </div>
       
   <div class="col-sm-1 text-center">
       
       <input type="text" class="form-control" id="appearance_after_washing_fabric_crease_before_ironing_max_value" name="appearance_after_washing_fabric_crease_before_ironing_max_value" value="<?php echo $row_for_curing_process['appearance_after_washing_fabric_crease_before_ironing_max_value']?>" required>
 ...
 <div class="col-sm-2 text-center">
  ...
  <div class="col-sm-1 text-center">
      ...
      <select  class="form-control" id="appearance_after_washing_fabric_crease_after_ironing_tolerance_range_math_operator" name="appearance_after_washing_fabric_crease_after_ironing_tolerance_range_math_operator" onchange="appearance_after_washing_crease_after_ironing_fabric_cal()">
           <option value="">Select appearance after washing surface pilling Range Math Operator</option>
           <?php
                                      $appearance_after_washing_fabric_crease_after_iron_math_op = $row_for_curing_process['appearance_after_washing_fabric_crease_after_iron_math_op'];
   ...
   <div class="col-sm-1 text-center">
       <select  class="form-control" id="appearance_after_washing_fabric_crease_after_ironing_tolerance_value" name="appearance_after_washing_fabric_crease_after_ironing_tolerance_value" onchange="appearance_after_washing_crease_after_ironing_fabric_cal()">
           <option value="">Select Tolerance Value</option>
           <?php
                                      $appearance_after_washing_fabric_crease_after_iron_tolerance_val = $row_for_curing_process['appearance_after_washing_fabric_crease_after_iron_tolerance_val'];
   ...
   <div class="col-sm-1 text-center" for="min_value">
        ...
        <input type="text" class="form-control" id="appearance_after_washing_fabric_crease_after_ironing_min_value" name="appearance_after_washing_fabric_crease_after_ironing_min_value"  value="<?php echo $row_for_curing_process['appearance_after_washing_fabric_crease_after_ironing_min_value']?>" required>
      
   </div>
       
   <div class="col-sm-1 text-center">
       
       <input type="text" class="form-control" id="appearance_after_washing_fabric_crease_after_ironing_max_value" name="appearance_after_washing_fabric_crease_after_ironing_max_value"  value="<?php echo $row_for_curing_process['appearance_after_washing_fabric_crease_after_ironing_max_value']?>" required>
...
<div class="form-group form-group-sm">
 ...
 <div class="col-sm-2 text-center">
  ...
  <div class="col-sm-1 text-center">
   ...
   <div class="col-sm-2 text-center">
        <input type="text"  class="form-control" id="appearance_after_washing_loss_of_print_fabric" name="appearance_after_washing_loss_of_print_fabric" value="<?php echo $row_for_curing_process['appearance_after_washing_loss_of_print_fabric']?>" required>
   </div> 
  ...
  <div class="col-sm-1 text-center">
   ...
   <div class="col-sm-2 text-center">
       ...
       <select  class="form-control" id="appearance_after_washing_fabric_abrasive_mark" name="appearance_after_washing_fabric_abrasive_mark">
            ...
            <?php
                                      $appearance_after_washing_fabric_abrasive_mark = $row_for_curing_process['appearance_after_washing_fabric_abrasive_mark'];
...
<div class="form-group form-group-sm">
 ...
 <div class="col-sm-2 text-center">
  ...
  <div class="col-sm-1 text-center">
   ...
   <div class="col-sm-2 text-center">
        <input type="text"  class="form-control" id="appearance_after_washing_odor_fabric" name="appearance_after_washing_odor_fabric" value="<?php echo $row_for_curing_process['appearance_after_washing_odor_fabric']?>" required>
   </div> 
...
<div class="form-group form-group-sm">
 ...
 <div class="col-sm-2 text-center">
   ...
   <div class="col-sm-6 text-center">
      <textarea class="form-control" name="appearance_after_washing_other_observation_fabric" id="appearance_after_washing_other_observation_fabric" cols="30" rows="2" value="<?php echo $row_for_curing_process['appearance_after_washing_other_observation_fabric']?>" required><?php echo $row_for_curing_process['appearance_after_washing_other_observation_fabric']?></textarea>
   </div> 
...
<div id="div_appearance_after_wash_garments" style="display: none">         <!--start div appearance after wash garments------------------------------------------------------------------->
      ...
      <div class="form-group form-group-sm">
            ...
            <?php
                  $appearance_after_washing_cycle_garments_wash=$row_for_curing_process['appearance_after_washing_cycle_garments_wash'];
            ...
            <div class="col-sm-2 text-center">
               ...
               <div class="col-sm-1 text-center">
                  ...
                  <select  class="form-control" id="appearance_after_washing_garments_color_change_without_suppressor_tolerance_range_math_operator" name="appearance_after_washing_garments_color_change_without_suppressor_tolerance_range_math_operator" onchange="appearance_after_washing_color_change_without_suppressor_garments_cal()">
                     <option value="">Select appearance after Washing Color Change Range Math Operator</option>
                     <?php
                                      $appear_after_washing_garments_color_change_without_sup_math_op = $row_for_curing_process['appear_after_washing_garments_color_change_without_sup_math_op'];
               ...
               <div class="col-sm-1 text-center">
                  <select  class="form-control" id="appearance_after_washing_garments_color_change_without_suppressor_tolerance_value" name="appearance_after_washing_garments_color_change_without_suppressor_tolerance_value" onchange="appearance_after_washing_color_change_without_suppressor_garments_cal()">
                     <option value="">Select Tolerance Value</option>
                     <?php
                                      $appear_after_washing_garments_color_change_without_sup_toler_val = $row_for_curing_process['appear_after_washing_garments_color_change_without_sup_toler_val'];
            ...
            <div class="col-sm-2 text-center">
               ...
               <div class="col-sm-1 text-center">
                  ...
                  <select  class="form-control" id="appearance_after_washing_garments_color_change_with_suppressor_tolerance_range_math_operator" name="appearance_after_washing_garments_color_change_with_suppressor_tolerance_range_math_operator" onchange="appearance_after_washing_color_change_with_suppressor_garments_cal()">
                     ...
                     <?php
                                      $appear_after_washing_garments_color_change_with_sup_math_op = $row_for_curing_process['appear_after_washing_garments_color_change_with_sup_math_op'];
               ...
               <div class="col-sm-1 text-center">
                  <select  class="form-control" id="appearance_after_washing_garments_color_change_with_suppressor_tolerance_value" name="appearance_after_washing_garments_color_change_with_suppressor_tolerance_value" onchange="appearance_after_washing_color_change_with_suppressor_garments_cal()">
                     <option value="">Select Tolerance Value</option>
                     <?php
                                      $appear_after_washing_garments_color_change_with_sup_toler_value = $row_for_curing_process['appear_after_washing_garments_color_change_with_sup_toler_value'];
               ...
               <div class="col-sm-1 text-center" for="min_value">
                  ...
                  <input type="text" class="form-control" id="appearance_after_washing_garments_color_change_with_suppressor_min_value" name="appearance_after_washing_garments_color_change_with_suppressor_min_value" value="<?php echo $row_for_curing_process['appear_after_washing_garments_color_change_with_sup_min_value']?>" required>
               </div>
                  
               <div class="col-sm-1 text-center">
                  
                  <input type="text" class="form-control" id="appearance_after_washing_garments_color_change_with_suppressor_max_value" name="appearance_after_washing_garments_color_change_with_suppressor_max_value" value="<?php echo $row_for_curing_process['appear_after_washing_garments_color_change_with_sup_max_value']?>" required>
       ...
       <div class="col-sm-2 text-center">
        ...
        <div class="col-sm-1 text-center">
            ...
            <select  class="form-control" id="appearance_after_washing_garments_cross_staining_tolerance_range_math_operator" name="appearance_after_washing_garments_cross_staining_tolerance_range_math_operator" onchange="appearance_after_washing_cross_staining_garments_cal()">
                 ...
                 <?php
                                      $appear_after_washing_garments_cross_staining_math_op = $row_for_curing_process['appear_after_washing_garments_cross_staining_math_op'];
         ...
         <div class="col-sm-1 text-center">
             <select  class="form-control" id="appearance_after_washing_garments_cross_staining_tolerance_value" name="appearance_after_washing_garments_cross_staining_tolerance_value" onchange="appearance_after_washing_cross_staining_garments_cal()">
                 <option value="">Select Tolerance Value</option>
                 <?php
                                      $appear_after_washing_garments_cross_staining_tolerance_value = $row_for_curing_process['appear_after_washing_garments_cross_staining_tolerance_value'];
         ...
         <div class="col-sm-1 text-center" for="min_value">
              ...
              <input type="text" class="form-control" id="appearance_after_washing_garments_cross_staining_min_value" name="appearance_after_washing_garments_cross_staining_min_value" value="<?php echo $row_for_curing_process['appearance_after_washing_garments_cross_staining_min_value']?>" required>
            
         </div>
             
         <div class="col-sm-1 text-center">
             
             <input type="text" class="form-control" id="appearance_after_washing_garments_cross_staining_max_value" name="appearance_after_washing_garments_cross_staining_max_value" value="<?php echo $row_for_curing_process['appearance_after_washing_garments_cross_staining_max_value']?>" required>
 ...
 <div class="col-sm-2 text-center">
  ...
  <div class="col-sm-1 text-center">
      ...
      <select  class="form-control" id="appearance_after_washing_garments_differential_shrinkage_tolerance_range_math_operator" name="appearance_after_washing_garments_differential_shrinkage_tolerance_range_math_operator" onchange="appearance_after_washing_differential_shrinkage_garments_cal()">
           ...
           <?php
                                      $appear_after_washing_garments_differential_shrink_math_op = $row_for_curing_process['appear_after_washing_garments_differential_shrink_math_op'];
   ...
   <div class="col-sm-1 text-center">
       <select  class="form-control" id="appearance_after_washing_garments__differential_shrinkage_tolerance_value" name="appearance_after_washing_garments__differential_shrinkage_tolerance_value" onchange="appearance_after_washing_differential_shrinkage_garments_cal()">
           <option value="">Select Tolerance Value</option>
           <?php
                                      $appear_after_washing_garments__differential_shrink_tolerance_val = $row_for_curing_process['appear_after_washing_garments__differential_shrink_tolerance_val'];
   ...
   <div class="col-sm-1 text-center" for="min_value">
        ...
        <input type="text" class="form-control" id="appearance_after_washing_garments__differential_shrinkage_min_value" name="appearance_after_washing_garments__differential_shrinkage_min_value" value="<?php echo $row_for_curing_process['appearance_after_washing_garments__differential_shrink_min_value']?>" required>
      
   </div>
       
   <div class="col-sm-1 text-center">
       
       <input type="text" class="form-control" id="appearance_after_washing_garments__differential_shrinkage_max_value" name="appearance_after_washing_garments__differential_shrinkage_max_value" value="<?php echo $row_for_curing_process['appearance_after_washing_garments__differential_shrink_max_value']?>" required>
       ...
       <div class="col-sm-2 text-center">
        ...
        <div class="col-sm-1 text-center">
            ...
            <select  class="form-control" id="appearance_after_washing_garments_surface_fuzzing_tolerance_range_math_operator" name="appearance_after_washing_garments_surface_fuzzing_tolerance_range_math_operator" onchange="appearance_after_washing_surface_fuzzing_garments_cal()">
                 ...
                 <?php
                                      $appear_after_washing_garments_surface_fuzzing_math_op = $row_for_curing_process['appear_after_washing_garments_surface_fuzzing_math_op'];
         ...
         <div class="col-sm-1 text-center">
             <select  class="form-control" id="appearance_after_washing_garments_surface_fuzzing_tolerance_value" name="appearance_after_washing_garments_surface_fuzzing_tolerance_value" onchange="appearance_after_washing_surface_fuzzing_garments_cal()">
                 <option value="">Select Tolerance Value</option>
                 <?php
                                      $appearance_after_washing_garments_surface_fuzzing_tolerance_val = $row_for_curing_process['appearance_after_washing_garments_surface_fuzzing_tolerance_val'];
         ...
         <div class="col-sm-1 text-center" for="min_value">
              ...
              <input type="text" class="form-control" id="appearance_after_washing_garments_surface_fuzzing_min_value" name="appearance_after_washing_garments_surface_fuzzing_min_value" value="<?php echo $row_for_curing_process['appearance_after_washing_garments_surface_fuzzing_min_value']?>" required>
            
         </div>
             
         <div class="col-sm-1 text-center">
             
             <input type="text" class="form-control" id="appearance_after_washing_garments_surface_fuzzing_max_value" name="appearance_after_washing_garments_surface_fuzzing_max_value" value="<?php echo $row_for_curing_process['appearance_after_washing_garments_surface_fuzzing_max_value']?>" required>
       ...
       <div class="col-sm-2 text-center">
        ...
        <div class="col-sm-1 text-center">
            ...
            <select  class="form-control" id="appearance_after_washing_garments_surface_pilling_tolerance_range_math_operator" name="appearance_after_washing_garments_surface_pilling_tolerance_range_math_operator" onchange="appearance_after_washing_surface_pilling_garments_cal()">
                 <option value="">Select appearance after washing surface pilling Range Math Operator</option>
                 <?php
                                      $appear_after_washing_garments_surface_pilling_math_op = $row_for_curing_process['appear_after_washing_garments_surface_pilling_math_op'];
         ...
         <div class="col-sm-1 text-center">
             <select  class="form-control" id="appearance_after_washing_garments_surface_pilling_tolerance_value" name="appearance_after_washing_garments_surface_pilling_tolerance_value" onchange="appearance_after_washing_surface_pilling_garments_cal()">
                 <option value="">Select Tolerance Value</option>
                 <?php
                                      $appearance_after_washing_garments_surface_pilling_tolerance_val = $row_for_curing_process['appearance_after_washing_garments_surface_pilling_tolerance_val'];
         ...
         <div class="col-sm-1 text-center" for="min_value">
              ...
              <input type="text" class="form-control" id="appearance_after_washing_garments_surface_pilling_min_value" name="appearance_after_washing_garments_surface_pilling_min_value" value="<?php echo $row_for_curing_process['appearance_after_washing_garments_surface_pilling_min_value']?>" required>
            
         </div>
             
         <div class="col-sm-1 text-center">
             
             <input type="text" class="form-control" id="appearance_after_washing_garments_surface_pilling_max_value" name="appearance_after_washing_garments_surface_pilling_max_value" value="<?php echo $row_for_curing_process['appearance_after_washing_garments_surface_pilling_max_value']?>" required>
 ...
 <div class="col-sm-2 text-center">
  ...
  <div class="col-sm-1 text-center">
      ...
      <select  class="form-control" id="appearance_after_washing_garments_crease_after_ironing_tolerance_range_math_operator" name="appearance_after_washing_garments_crease_after_ironing_tolerance_range_math_operator" onchange="appearance_after_washing_crease_after_ironing_garments_cal()">
           ...
           <?php
                                      $appear_after_washing_garments_crease_after_ironing_math_op = $row_for_curing_process['appear_after_washing_garments_crease_after_ironing_math_op'];
   ...
   <div class="col-sm-1 text-center">
       <select  class="form-control" id="appearance_after_washing_garments_crease_after_ironing_tolerance_value" name="appearance_after_washing_garments_crease_after_ironing_tolerance_value" onchange="appearance_after_washing_crease_after_ironing_garments_cal()">
           <option value="">Select Tolerance Value</option>
           <?php
                                      $appear_after_washing_garments_crease_after_ironing_tolerance_val = $row_for_curing_process['appear_after_washing_garments_crease_after_ironing_tolerance_val'];
   ...
   <div class="col-sm-1 text-center" for="min_value">
        ...
        <input type="text" class="form-control" id="appearance_after_washing_garments_crease_after_ironing_min_value" name="appearance_after_washing_garments_crease_after_ironing_min_value" value="<?php echo $row_for_curing_process['appearance_after_washing_garments_crease_after_ironing_min_value']?>" required>
      
   </div>
       
   <div class="col-sm-1 text-center">
       
       <input type="text" class="form-control" id="appearance_after_washing_garments_crease_after_ironing_max_value" name="appearance_after_washing_garments_crease_after_ironing_max_value" value="<?php echo $row_for_curing_process['appearance_after_washing_garments_crease_after_ironing_max_value']?>" required>
  ...
  <div class="col-sm-1 text-center">
   ...
   <div class="col-sm-2 text-center">
       ...
       <select  class="form-control" id="appearance_after_washing_garments_abrasive_mark" name="appearance_after_washing_garments_abrasive_mark">
            ...
            <?php
                                      $appearance_after_washing_garments_abrasive_mark = $row_for_curing_process['appearance_after_washing_garments_abrasive_mark'];
...
<div class="form-group form-group-sm">
 ...
 <div class="col-sm-2 text-center">
  ...
  <div class="col-sm-1 text-center">
   ...
   <div class="col-sm-2 text-center">
        <input type="text"  class="form-control" id="seam_breakdown_garments" name="seam_breakdown_garments"  value="<?php echo $row_for_curing_process['seam_breakdown_garments']?>" required>
   </div> 
 ...
 <div class="col-sm-2 text-center">
  ...
  <div class="col-sm-1 text-center">
      ...
      <select  class="form-control" id="appearance_after_washing_garments_seam_puckering_roping_after_iron_tolerance_range_math_operator" name="appearance_after_washing_garments_seam_puckering_roping_after_iron_tolerance_range_math_operator" onchange="appearance_after_washing_seam_puckering_garments_cal()">
           ...
           <?php
                                      $appear_after_wash_garments_seam_pucker_rop_iron_math_op = $row_for_curing_process['appear_after_wash_garments_seam_pucker_rop_iron_math_op'];
   ...
   <div class="col-sm-1 text-center">
       <select  class="form-control" id="appearance_after_washing_garments_seam_puckering_roping_after_iron_tolerance_value" name="appearance_after_washing_garments_seam_puckering_roping_after_iron_tolerance_value" onchange="appearance_after_washing_seam_puckering_garments_cal()">
           <option value="">Select Tolerance Value</option>
           <?php
                                      $appear_after_washing_garments_seam_pucker_rop_iron_toler_value = $row_for_curing_process['appear_after_washing_garments_seam_pucker_rop_iron_toler_value'];
...
<div class="form-group form-group-sm">
 ...
 <div class="col-sm-2 text-center">
  ...
  <div class="col-sm-1 text-center">
   ...
   <div class="col-sm-2 text-center">
        <input type="text"  class="form-control" id="detachment_of_interlinings_fused_components_garments" name="detachment_of_interlinings_fused_components_garments" value="<?php echo $row_for_curing_process['detachment_of_interlinings_fused_components_garments']?>" required>
   </div> 
...
<div class="form-group form-group-sm">
 ...
 <div class="col-sm-2 text-center">
  ...
  <div class="col-sm-1 text-center">
   ...
   <div class="col-sm-2 text-center">
        <input type="text"  class="form-control" id="change_id_handle_or_appearance" name="change_id_handle_or_appearance" value="<?php echo $row_for_curing_process['change_id_handle_or_appearance']?>" required>
   </div> 
...
<div class="form-group form-group-sm">
 ...
 <div class="col-sm-2 text-center">
  ...
  <div class="col-sm-1 text-center">
   ...
   <div class="col-sm-2 text-center">
        <input type="text"  class="form-control" id="effect_on_accessories_such_as_buttons" name="effect_on_accessories_such_as_buttons"  value="<?php echo $row_for_curing_process['effect_on_accessories_such_as_buttons']?>" required>
   </div>
 ...
 <div class="col-sm-2 text-center">
  ...
  <div class="col-sm-1 text-center">
   ...
   <div class="col-sm-1 text-center" for="min_value">
        ...
        <input type="text" class="form-control" id="appearance_after_washing_garments_spirality_min_value" name="appearance_after_washing_garments_spirality_min_value" value="<?php echo $row_for_curing_process['appearance_after_washing_garments_spirality_min_value']?>" required>
      
   </div>
       
   <div class="col-sm-1 text-center">
       
       <input type="text" class="form-control" id="appearance_after_washing_garments_spirality_max_value" name="appearance_after_washing_garments_spirality_max_value" value="<?php echo $row_for_curing_process['appearance_after_washing_garments_spirality_max_value']?>" required>
...
<div class="form-group form-group-sm">
 ...
 <div class="col-sm-2 text-center">
  ...
  <div class="col-sm-1 text-center">
   ...
   <div class="col-sm-2 text-center">
        <input type="text"  class="form-control" id="detachment_or_fraying_of_ribbons" name="detachment_or_fraying_of_ribbons" value="<?php echo $row_for_curing_process['detachment_or_fraying_of_ribbons']?>" required>
   </div>
...
<div class="form-group form-group-sm">
 ...
 <div class="col-sm-2 text-center">
  ...
  <div class="col-sm-1 text-center">
   ...
   <div class="col-sm-2 text-center">
        <input type="text"  class="form-control" id="loss_of_print_garments" name="loss_of_print_garments" value="<?php echo $row_for_curing_process['loss_of_print_garments']?>" required>
   </div>
...
<div class="form-group form-group-sm">
 ...
 <div class="col-sm-2 text-center">
  ...
  <div class="col-sm-1 text-center">
   ...
   <div class="col-sm-2 text-center">
        <input type="text"  class="form-control" id="care_level_garments" name="care_level_garments" value="<?php echo $row_for_curing_process['care_level_garments']?>" required>
   </div>
...
<div class="form-group form-group-sm">
 ...
 <div class="col-sm-2 text-center">
  ...
  <div class="col-sm-1 text-center">
   ...
   <div class="col-sm-2 text-center">
        <input type="text"  class="form-control" id="odor_garments" name="odor_garments" value="<?php echo $row_for_curing_process['odor_garments']?>" required>
   </div> 
...
<div class="form-group form-group-sm">
 ...
 <div class="col-sm-2 text-center">
   ...
   <div class="col-sm-6 text-center">
      <textarea class="form-control" name="appearance_after_washing_other_observation_garments" id="appearance_after_washing_other_observation_garments" cols="30" rows="2" value="<?php echo $row_for_curing_process['appearance_after_washing_other_observation_garments']?>" required><?php echo $row_for_curing_process['appearance_after_washing_other_observation_garments']?></textarea>
   </div> 
...
<!-- -------------------------------------------------------------------------------Appearance after wash end---------------------------------------------------------------------------------------------------------------------- -->
     ...
     <div class="form-group form-group-sm">
								<div class="col-sm-offset-3 col-sm-5">
									<button type="button" class="btn btn-primary" onClick="sending_data_of_defining_qc_standard_for_curing_process_form_for_saving_in_database()">Save</button>
