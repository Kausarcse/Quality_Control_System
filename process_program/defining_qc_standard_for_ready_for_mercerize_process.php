...
*/  document.getElementById('color').value=splitted_version_details[1];
 ...
 function sending_data_of_defining_qc_standard_for_ready_for_mercerize_process_form_for_saving_in_database()
 {
       ...
       if(validate != false)
	   {
		  	 ...
		  	 $.ajax({
			 		url: 'process_program/defining_qc_standard_for_ready_for_mercerize_process_saving.php',
			 		dataType: 'text',
			 		type: 'post',
			 		contentType: 'application/x-www-form-urlencoded',
...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<?php 
			...
			{
				?>
				<div class="panel-heading" style="color:#191970;"><b>Model For Ready For Mercerize Process</b></div> 
						...
						<div class="panel panel-default">
							<table id="datatable-buttons" class="table table-striped table-bordered">
								...
								<tbody>
									...
									$sql_for_ready_for_mercerize = "SELECT * FROM `model_defining_qc_standard_for_ready_for_mercerize_process` 
                       ...
                       <div class="panel panel-default">
						  ...
						  <tr>
							 ...
							 <td>
                                        ...
                                        <button type="button" id="edit_ready_for_mercerize" name="edit_ready_for_mercerize"  class="btn btn-info btn-xs" onclick="load_page('process_program/edit_defining_qc_standard_for_ready_for_mercerize_process.php?ready_for_mercerize_id=<?php echo $row['id'] ?>')"> Edit </button>
