...
//from new database and form
   ...
   mysqli_query($con,"START TRANSACTION") or die(mysqli_error($con));
	...
	$select_sql_for_duplicacy="select * from `defining_qc_standard_for_finishing_process` where `pp_number`='$pp_number' and `version_number`='$version_number' and `customer_name`='$customer_name' and `color`='$color' and `finish_width_in_inch`='$finish_width_in_inch'";
