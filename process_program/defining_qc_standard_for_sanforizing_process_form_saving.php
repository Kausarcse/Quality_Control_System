...
$uom_of_seam_properties_seam_strength_iso_astm_d_in_weft= $_POST['uom_of_seam_properties_seam_strength_iso_astm_d_in_weft'];
   ...
   mysqli_query($con,"START TRANSACTION") or die(mysqli_error($con));
	...
	$select_sql_for_duplicacy="select * from `defining_qc_standard_for_sanforizing_process` where `pp_number`='$pp_number' and `version_number`='$version_number' and `customer_name`='$customer_name' and `color`='$color' and `finish_width_in_inch`='$finish_width_in_inch'";
	...
	$insert_sql_statement="INSERT INTO `defining_qc_standard_for_sanforizing_process`( 
	  `pp_number`, 
	  `version_id`, 
	  `version_number`, 
	  `customer_name`, 
