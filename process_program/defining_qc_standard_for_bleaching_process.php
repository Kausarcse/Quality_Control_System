...
<div class="col-sm-12 col-md-12 col-lg-12 full">
	...
	<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
		...
		<?php 
			...
			{
				?>
				<div class="panel-heading" style="color:#191970;"><b>Model For Bleaching Process</b></div> 
						...
						<div class="panel panel-default">
							<table id="datatable-buttons" class="table table-striped table-bordered">
								...
								<tbody>
									...
									$sql_for_bleaching = "SELECT * FROM `model_defining_qc_standard_for_bleaching_process` 
			...
			{ 
				?>
				<div class="panel-heading" style="color:#191970;"><b>Defining Qc Standard For Bleaching Process</b></div> <!-- This will create a upper block for FORM (Just Beautification) -->
						        ...
						        <div class="panel panel-default">
                                     ...
                                     <td><?php echo $row_for_pp_style['style_name']; ?></td>
							                ...
							                <td>
                                              ...
                                              <button type="button" id="edit_bleaching" name="edit_bleaching"  class="btn btn-info btn-xs"  onclick="load_page('process_program/edit_defining_qc_standard_for_bleaching_process.php?bleaching_id=<?php echo $row['id'] ?>')"> Edit </button>
	      ...
	      <div class="col-sm-3 text-center">
	       ...
	       <div class="col-sm-2 text-center">
	          ...
	          <div class="col-sm-1 text-center" for="min_value">
	            ...
	            <input type="text" class="form-control" id="whiteness_min_value" name="whiteness_min_value" onblur="fill_all_value_for_table(1)" placeholder="Enter Whiteness Min Value" required>

	          </div>
	              
	          <div class="col-sm-1 text-center">
	              
	           <input type="text" class="form-control" id="whiteness_max_value" name="whiteness_max_value" onblur="fill_all_value_for_table(1)" placeholder="Enter Whiteness Max Value" required>
     ...
     <div class="form-group form-group-sm" >
             ...
             <div class="col-sm-1 text-center">
	          ...
	          <div class="col-sm-1 text-center" for="min_value">
	           ...
	           <input type="text" class="form-control" id="residual_sizing_material_min_value" name="residual_sizing_material_min_value" onblur="fill_all_value_for_table(2)" placeholder="Enter  Min Value" required>

	          </div>
	              
	          <div class="col-sm-1 text-center">
	              
	           <input type="text" class="form-control" id="residual_sizing_material_max_value" name="residual_sizing_material_max_value" onblur="fill_all_value_for_table(2)" placeholder="Enter Max Value" required>
	      ...
	      <div class="col-sm-3 text-center">
	       ...
	       <div class="col-sm-2 text-center">
	          ...
	          <div class="col-sm-1 text-center" for="min_value">
	           ...
	           <input type="text" class="form-control" id="absorbency_min_value" name="absorbency_min_value" onblur="fill_all_value_for_table(3)" placeholder="Enter  Min Value" required>

	          </div>
	              
	          <div class="col-sm-1 text-center">
	              
	           <input type="text" class="form-control" id="absorbency_max_value" name="absorbency_max_value" onblur="fill_all_value_for_table(3)" placeholder="Enter Max Value" required>
...
<div id="div_ph" > 
	<div class="form-group form-group-sm" >
          ...
          <div class="col-sm-1 text-center" for="min_value">
           ...
           <input type="text" class="form-control" id="ph_min_value" name="ph_min_value" onblur="fill_all_value_for_table(5)" placeholder="Enter  Min Value" required>

          </div>
	              
          <div class="col-sm-1 text-center">
              
           <input type="text" class="form-control" id="ph_max_value" name="ph_max_value" onblur="fill_all_value_for_table(5)" placeholder="Enter Max Value" required>
