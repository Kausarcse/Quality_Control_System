...
if(isset($_GET['sanforizing_id']))
{
   $sanforizing_process_id=$_GET['sanforizing_id'];
   $sql_for_sanforizing_process="select * from defining_qc_standard_for_sanforizing_process where `id`='$sanforizing_process_id'";
   $result_for_sanforizing_process= mysqli_query($con,$sql_for_sanforizing_process) or die(mysqli_error($con));
   $row_for_sanforizing_process = mysqli_fetch_array( $result_for_sanforizing_process);
}
else
{
   ...
   $sql_for_sanforizing_process = "SELECT * FROM `defining_qc_standard_for_sanforizing_process`
...
function sending_data_of_defining_qc_standard_for_sanforizing_process_form_for_saving_in_database()
 {
       ...
       var url_encoded_form_data = $("#defining_qc_standard_for_sanforizing_process_form").serialize(); //This will read all control elements value of the form    
             ...
             $.ajax({
                    url: 'process_program/edit_defining_qc_standard_for_sanforizing_process_form_saving.php',
                    dataType: 'text',
                    type: 'post',
                    contentType: 'application/x-www-form-urlencoded',
...
<div class="col-sm-12 col-md-12 col-lg-12">
        ...
        <div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
                ...
                <div class="panel-heading" style="color:#191970;"><b>Edit Defining Qc Standard For Sanforizing Process/Edit</b></div> <!-- This will create a upper block for FORM (Just Beautification) -->
                          ...
                          <div class="panel panel-default">
                              <table id="datatable-buttons" class="table table-striped table-bordered">
                                 ...
                                 <?php 
                                                 ...
                                                 if(isset($sanforizing_process_id))
                                                 {
                                                   $sql_for_sanforizing = "SELECT * FROM `defining_qc_standard_for_sanforizing_process` WHERE `id`='$sanforizing_process_id'";
                                                }
                                                 else
                                                 {
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                           ...
                                           <button type="submit" id="edit_sanforizing" name="edit_sanforizing"  class="btn btn-info btn-xs" onclick="load_page('process_program/edit_defining_qc_standard_for_sanforizing_process.php?sanforizing_id=<?php echo $row['id'] ?>')"> Edit </button>
                                           <?php 
          ...
          <!-------------------------------------------------------- To Load Full Form with Sync------------------------------------------------------------------------------- -->

           <button type="button" class="btn btn-info" id="buttn_for_load_form" onclick="load_full_form('<?php echo $row_for_sanforizing_process['customer_id']?>')">Load Form</button>
           ...
           <div class="full_page_load" id="full_page_load" style="display: none;">
                ...
                <form class="form-horizontal" action="" style="margin-top:10px;" name="defining_qc_standard_for_sanforizing_process_form" id="defining_qc_standard_for_sanforizing_process_form">
                         ...
                         <label>PP Number :<?php echo $row_for_sanforizing_process['pp_number']?><input type="hidden" class="form-control" id="pp_number" name="pp_number" value="<?php echo $row_for_sanforizing_process['pp_number']?>" >  </label>  ,

                        <label>Version Name :<?php echo $row_for_sanforizing_process['version_number']?><input type="hidden" id="version_number" name="version_number" value="<?php echo $row_for_sanforizing_process['version_number']?>" >   </label>  ,

                        <label>Customer Name :<?php echo $row_for_sanforizing_process['customer_name']?><input type="hidden" id="customer_name" name="customer_name" value="<?php echo $row_for_sanforizing_process['customer_name']?>">   </label>  ,

                        <input type="hidden" id="customer_id" name="customer_id" value="<?php echo $row_for_sanforizing_process['customer_id']?>">
                        <label>Color :<?php echo $row_for_sanforizing_process['color']?><input type="hidden" id="color" name="color" value="<?php echo $row_for_sanforizing_process['color']?>" >   </label>  ,

                       <label>Finish Width :<?php echo $row_for_sanforizing_process['finish_width_in_inch']?> <input type="hidden" id="finish_width_in_inch" name="finish_width_in_inch"  value="<?php echo $row_for_sanforizing_process['finish_width_in_inch']?>">    </label>  
  
                        <input type="hidden" id="standard_for_which_process" name="standard_for_which_process"  value="<?php echo $row_for_sanforizing_process['standard_for_which_process']?>">
                        <input type="hidden" id="version_id" name="version_id" value="<?php echo $row_for_sanforizing_process['version_id']?>" >
...
<div id="div_cf_to_rubbing" style="display: none">    
        ...
        <div class="form-group form-group-sm">
          ...
          <div class="col-sm-1 text-center">
              <select  class="form-control" id="cf_to_rubbing_dry_tolerance_range_math_operator" name="cf_to_rubbing_dry_tolerance_range_math_operator" style="color:#00008B; margin-top:23px;" onchange="cf_to_rubbing_dry_cal()">
                  ...
                  <?php
                                      $cf_to_rubbing_dry_tolerance_range_math_operator = $row_for_sanforizing_process['cf_to_rubbing_dry_tolerance_range_math_operator'];
          ...
          <div class="col-sm-1" for="tolerance">
            ...
            <input type="text" class="form-control" id="cf_to_rubbing_dry_tolerance_value" name="cf_to_rubbing_dry_tolerance_value" value="<?php echo $row_for_sanforizing_process['cf_to_rubbing_dry_tolerance_value']?>"  required onchange="cf_to_rubbing_dry_cal()" style="color:#00008B; margin-top:23px;">

          </div>

          <div class="col-sm-1" for="unit">
            <hr style="color:#FF0000;border-top: 2px dashed #FF0000; margin-top:35px;"/>
            <input type="hidden" id="uom_of_cf_to_rubbing_dry" name="uom_of_cf_to_rubbing_dry"  value="<?php echo $row_for_sanforizing_process['uom_of_cf_to_rubbing_dry']?>">
          </div>

                
          <div class="col-sm-1 text-center" for="min_value">

            <input type="text" class="form-control" id="cf_to_rubbing_dry_min_value" name="cf_to_rubbing_dry_min_value" style="color:#00008B; margin-top:23px;" value="<?php echo $row_for_sanforizing_process['cf_to_rubbing_dry_min_value']?>" required>
             
          </div>
                  
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="cf_to_rubbing_dry_max_value" name="cf_to_rubbing_dry_max_value" style="color:#00008B; margin-top:23px;" value="<?php echo $row_for_sanforizing_process['cf_to_rubbing_dry_max_value']?>" required>
      ...
      <div class="form-group form-group-sm">
          ...
          <div class="col-sm-1 text-center">
              <select  class="form-control" id="cf_to_rubbing_wet_tolerance_range_math_operator" name="cf_to_rubbing_wet_tolerance_range_math_operator" onchange="cf_to_rubbing_wet_cal()">
                      ...
                      <?php
                                      $cf_to_rubbing_wet_tolerance_range_math_operator = $row_for_sanforizing_process['cf_to_rubbing_wet_tolerance_range_math_operator'];
          ...
          <div class="col-sm-1" for="tolerance">
            ...
            <input type="text" class="form-control" id="cf_to_rubbing_wet_tolerance_value" name="cf_to_rubbing_wet_tolerance_value" value="<?php echo $row_for_sanforizing_process['cf_to_rubbing_wet_tolerance_value']?>" onchange="cf_to_rubbing_wet_cal()" required>

          </div>

          <div class="col-sm-1" for="unit">
            <hr style="color:#FF0000;border-top: 2px dashed #FF0000; margin-top:13px;"/>
            <input type="hidden" id="uom_of_cf_to_rubbing_wet" name="uom_of_cf_to_rubbing_wet"  value="<?php echo $row_for_sanforizing_process['uom_of_cf_to_rubbing_wet']?>">
          </div>

                
          <div class="col-sm-1 text-center" for="min_value">

            <input type="text" class="form-control" id="cf_to_rubbing_wet_min_value" name="cf_to_rubbing_wet_min_value" value="<?php echo $row_for_sanforizing_process['cf_to_rubbing_wet_min_value']?>" required>
             
          </div>
                  
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="cf_to_rubbing_wet_max_value" name="cf_to_rubbing_wet_max_value" value="<?php echo $row_for_sanforizing_process['cf_to_rubbing_wet_max_value']?>" required>
       ...
       <div class="form-group form-group-sm">
            ...
            <div class="col-sm-3 text-center">
             ...
             <div class="col-sm-2 text-center">
                  ...
                  <input type="hidden" class="form-control" id="test_method_for_dimensional_stability_to_warp_washing_b_iron" name="test_method_for_dimensional_stability_to_warp_washing_b_iron" value="<?php echo $row_for_sanforizing_process['test_method_for_dimensional_stability_to_warp_washing_b_iron']?>">
             ...
             <div class="col-sm-2 text-center">
                  ...
                  <input type="text" class="form-control" id="washing_cycle_for_warp_for_washing_before_iron" name="washing_cycle_for_warp_for_washing_before_iron" value="<?php echo $row_for_sanforizing_process['washing_cycle_for_warp_for_washing_before_iron']?>">
              </div>
          ...
          <div class="col-sm-1 text-center" for="min_value">
            ...
            <input type="text" class="form-control" id="dimensional_stability_to_warp_washing_before_iron_min_value" name="dimensional_stability_to_warp_washing_before_iron_min_value" style="color:#00008B;margin-top:35px;" value="<?php echo $row_for_sanforizing_process['dimensional_stability_to_warp_washing_before_iron_min_value']?>">
             
          </div>
                  
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="dimensional_stability_to_warp_washing_before_iron_max_value" name="dimensional_stability_to_warp_washing_before_iron_max_value" style="color:#00008B;margin-top:35px;" value="<?php echo $row_for_sanforizing_process['dimensional_stability_to_warp_washing_before_iron_max_value']?>">
     ...
     <div class="form-group form-group-sm">
            ...
            <div class="col-sm-3 text-center">
             ...
             <div class="col-sm-2 text-center">
                  ...
                  <input type="hidden" class="form-control" id="test_method_for_dimensional_stability_to_weft_washing_b_iron" name="test_method_for_dimensional_stability_to_weft_washing_b_iron" value="<?php echo $row_for_sanforizing_process['test_method_for_dimensional_stability_to_weft_washing_b_iron']?>">
             ...
             <div class="col-sm-2 text-center">
                  ...
                  <input type="text" class="form-control" id="washing_cycle_for_weft_for_washing_before_iron" name="washing_cycle_for_weft_for_washing_before_iron" value="<?php echo $row_for_sanforizing_process['washing_cycle_for_weft_for_washing_before_iron']?>">
              </div>
 ...
 -->
          ...
          <div class="col-sm-1 text-center" for="min_value">
            ...
            <input type="text" class="form-control" id="dimensional_stability_to_weft_washing_before_iron_min_value" name="dimensional_stability_to_weft_washing_before_iron_min_value" style="color:#00008B;" value="<?php echo $row_for_sanforizing_process['dimensional_stability_to_weft_washing_before_iron_min_value']?>">
             
          </div>
                  
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="dimensional_stability_to_weft_washing_before_iron_max_value" name="dimensional_stability_to_weft_washing_before_iron_max_value" style="color:#00008B;" value="<?php echo $row_for_sanforizing_process['dimensional_stability_to_weft_washing_before_iron_max_value']?>">
      ...
      <div class="form-group form-group-sm">
            ...
            <div class="col-sm-3 text-center">
                 <label class="control-label" for="dimensional_stability_to_warp_washing_after_iron" style="color:#00008B;"><span id="for_dimensional_stability_to_warp_washing_after_iron_test_name_label" style="display: none;">Dimensional Stability to Washing</span>
                <span id="dimensional_stability_to_warp_washing_after_iron_test_method" style="display: none;">(ISO 6330, ISO 5077, 3759)</span>
                 </label>
            </div>
             ...
             <div class="col-sm-2 text-center">
                  ...
                  <input type="hidden" class="form-control" id="test_method_for_dimensional_stability_to_warp_washing_after_iron" name="test_method_for_dimensional_stability_to_warp_washing_after_iron" value="<?php echo $row_for_sanforizing_process['test_method_for_dimensional_stability_to_warp_washing_after_iron']?>">
             ...
             <div class="col-sm-2 text-center">
                  ...
                  <input type="text" class="form-control" id="washing_cycle_for_warp_for_washing_after_iron" name="washing_cycle_for_warp_for_washing_after_iron" value="<?php echo $row_for_sanforizing_process['washing_cycle_for_warp_for_washing_after_iron']?>">
              </div>
          ...
          <div class="col-sm-1" for="unit">
             %
            <input type="hidden" id="uom_of_dimensional_stability_to_warp_washing_after_iron" name="uom_of_dimensional_stability_to_warp_washing_after_iron"  value="<?php echo $row_for_sanforizing_process['uom_of_dimensional_stability_to_warp_washing_after_iron']?>">
          </div>

                
          <div class="col-sm-1 text-center" for="min_value">

            <input type="text" class="form-control" id="dimensional_stability_to_warp_washing_after_iron_min_value" name="dimensional_stability_to_warp_washing_after_iron_min_value" style="color:#00008B;" value="<?php echo $row_for_sanforizing_process['dimensional_stability_to_warp_washing_after_iron_min_value']?>">
             
          </div>
                  
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="dimensional_stability_to_warp_washing_after_iron_max_value" name="dimensional_stability_to_warp_washing_after_iron_max_value" style="color:#00008B;" value="<?php echo $row_for_sanforizing_process['dimensional_stability_to_warp_washing_after_iron_max_value']?>">
     ...
     <div class="form-group form-group-sm">
            ...
            <div class="col-sm-3 text-center">
                 <label class="control-label" for="dimensional_stability_to_weft_washing_after_iron" style="display: none"><span id="for_dimensional_stability_to_weft_washing_after_iron_test_name_label" style="display: none;">Dimensional Stability to Washing</span>
             ...
             <div class="col-sm-2 text-center">
                  ...
                  <input type="hidden" class="form-control" id="test_method_for_dimensional_stability_to_weft_washing_after_iron" name="test_method_for_dimensional_stability_to_weft_washing_after_iron" value="<?php echo $row_for_sanforizing_process['test_method_for_dimensional_stability_to_weft_washing_after_iron']?>">
             ...
             <div class="col-sm-2 text-center">
                  ...
                  <input type="text" class="form-control" id="washing_cycle_for_weft_for_washing_after_iron" name="washing_cycle_for_weft_for_washing_after_iron" value="<?php echo $row_for_sanforizing_process['washing_cycle_for_weft_for_washing_after_iron']?>">
              </div>
          ...
          <div class="col-sm-1" for="unit">
              %
            <input type="hidden" id="uom_of_dimensional_stability_to_weft_washing_after_iron" name="uom_of_dimensional_stability_to_weft_washing_after_iron"  value="<?php echo $row_for_sanforizing_process['uom_of_dimensional_stability_to_weft_washing_after_iron']?>">
          </div>

                
          <div class="col-sm-1 text-center" for="min_value">

            <input type="text" class="form-control" id="dimensional_stability_to_weft_washing_after_iron_min_value" name="dimensional_stability_to_weft_washing_after_iron_min_value" style="color:#00008B;" value="<?php echo $row_for_sanforizing_process['dimensional_stability_to_weft_washing_after_iron_min_value']?>">
             
          </div>
                  
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="dimensional_stability_to_weft_washing_after_iron_max_value" name="dimensional_stability_to_weft_washing_after_iron_max_value" style="color:#00008B;" value="<?php echo $row_for_sanforizing_process['dimensional_stability_to_weft_washing_after_iron_max_value']?>">
  ...
  <div id="div_yarn_count" style="display: none;">  
      ...
      <div class="form-group form-group-sm">
            ...
            <div class="col-sm-3 text-center">
             ...
             <div class="col-sm-1 text-center">
                    <input type="text" class="form-control" id="warp_yarn_count_value" name="warp_yarn_count_value" value="<?php echo $row_for_sanforizing_process['warp_yarn_count_value']?>" onchange="warp_yarn_count_cal()" required>
          ...
          <div class="col-sm-1 text-center">
             <select  class="form-control" id="warp_yarn_count_tolerance_range_math_operator" name="warp_yarn_count_tolerance_range_math_operator" onchange="warp_yarn_count_cal()">
                      <option  value="">Select Warp Yarn Count Tolerance Range Math Operator</option>
                      <?php
                                      $warp_yarn_count_tolerance_range_math_operator = $row_for_sanforizing_process['warp_yarn_count_tolerance_range_math_operator'];
                                     ?>
                                     <?php 
          ...
          <div class="col-sm-1" for="tolerance">
             ...
             <input type="text" class="form-control" id="warp_yarn_count_tolerance_value" name="warp_yarn_count_tolerance_value" value="<?php echo $row_for_sanforizing_process['warp_yarn_count_tolerance_value']?>" onchange="warp_yarn_count_cal()" required>
          ...
          <div class="col-sm-1" for="unit">
            <select  class="form-control" id="uom_of_warp_yarn_count_value" name="uom_of_warp_yarn_count_value">
                      ...
                      <?php
                                      $uom_of_warp_yarn_count_value = $row_for_sanforizing_process['uom_of_warp_yarn_count_value'];
                                     ?>
                                     <?php 
          ...
          <div class="col-sm-1 text-center" for="min_value">
            ...
            <input type="text" class="form-control" id="warp_yarn_count_min_value" name="warp_yarn_count_min_value" value="<?php echo $row_for_sanforizing_process['warp_yarn_count_min_value']?>" required>
             
          </div>
                  
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="warp_yarn_count_max_value" name="warp_yarn_count_max_value" value="<?php echo $row_for_sanforizing_process['warp_yarn_count_max_value']?>" required>
      ...
      <div class="form-group form-group-sm" for="weft_yarn_count">
            ...
            <div class="col-sm-3 text-center">
             ...
             <div class="col-sm-1 text-center">
                    <input type="text" class="form-control" id="weft_yarn_count_value" name="weft_yarn_count_value" value="<?php echo $row_for_sanforizing_process['weft_yarn_count_value']?>" onchange="weft_yarn_count_cal()" required>
          ...
          <div class="col-sm-1 text-center">
             <select  class="form-control" id="weft_yarn_count_tolerance_range_math_operator" name="weft_yarn_count_tolerance_range_math_operator" onchange="weft_yarn_count_cal()">
                      <option  value="" >Select weft Yarn Count Tolerance Range Math Operator</option>
                      <?php
                                      $weft_yarn_count_tolerance_range_math_operator = $row_for_sanforizing_process['weft_yarn_count_tolerance_range_math_operator'];
                                     ?>
                                     <?php 
          ...
          <div class="col-sm-1" for="tolerance">
             ...
             <input type="text" class="form-control" id="weft_yarn_count_tolerance_value" name="weft_yarn_count_tolerance_value" value="<?php echo $row_for_sanforizing_process['weft_yarn_count_tolerance_value']?>" onchange="weft_yarn_count_cal()" required>
          ...
          <div class="col-sm-1" for="unit">
            <select  class="form-control" id="uom_of_weft_yarn_count_value" name="uom_of_weft_yarn_count_value">
                      ...
                      <?php
                                      $uom_of_weft_yarn_count_value = $row_for_sanforizing_process['uom_of_weft_yarn_count_value'];
                                     ?>
                                     <?php 
          ...
          <div class="col-sm-1 text-center" for="min_value">
            ...
            <input type="text" class="form-control" id="weft_yarn_count_min_value" name="weft_yarn_count_min_value" value="<?php echo $row_for_sanforizing_process['weft_yarn_count_min_value']?>" required>
             
          </div>
                  
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="weft_yarn_count_max_value" name="weft_yarn_count_max_value" value="<?php echo $row_for_sanforizing_process['weft_yarn_count_max_value']?>" required>
  ...
  <div id="div_number_of_threads_per_unit_length">
     ...
     <div class="form-group form-group-sm" for="no_of_threads_in_warp_value">
            ...
            <div class="col-sm-3 text-center">
             ...
             <div class="col-sm-1 text-center">
                    <input type="text" class="form-control" id="no_of_threads_in_warp_value" name="no_of_threads_in_warp_value" value="<?php echo $row_for_sanforizing_process['no_of_threads_in_warp_value']?>" onchange="no_of_threads_in_warp_cal()" required>
          ...
          <div class="col-sm-1 text-center">
             <select  class="form-control" id="no_of_threads_in_warp_tolerance_range_math_operator" name="no_of_threads_in_warp_tolerance_range_math_operator" onchange="no_of_threads_in_warp_cal()">
                      ...
                      <?php
                                      $no_of_threads_in_warp_tolerance_range_math_operator = $row_for_sanforizing_process['no_of_threads_in_warp_tolerance_range_math_operator'];
                                     ?>
                                     <?php 
          ...
          <div class="col-sm-1" for="tolerance">
             ...
             <input type="text" class="form-control" id="no_of_threads_in_warp_tolerance_value" name="no_of_threads_in_warp_tolerance_value" value="<?php echo $row_for_sanforizing_process['no_of_threads_in_warp_tolerance_value']?>" onchange="no_of_threads_in_warp_cal()" required>
          ...
          <div class="col-sm-1" for="unit">
            <select  class="form-control" id="uom_of_no_of_threads_in_warp_value" name="uom_of_no_of_threads_in_warp_value">
                      ...
                      <?php
                                      $uom_of_no_of_threads_in_warp_value = $row_for_sanforizing_process['uom_of_no_of_threads_in_warp_value'];
                                     ?>
                                     <?php 
          ...
          <div class="col-sm-1 text-center" for="min_value">
            ...
            <input type="text" class="form-control" id="no_of_threads_in_warp_min_value" name="no_of_threads_in_warp_min_value" value="<?php echo $row_for_sanforizing_process['no_of_threads_in_warp_min_value']?>" required>
          </div>
                  
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="no_of_threads_in_warp_max_value" name="no_of_threads_in_warp_max_value" value="<?php echo $row_for_sanforizing_process['no_of_threads_in_warp_max_value']?>" required>
     ...
     <div class="form-group form-group-sm" for="no_of_threads_in_warp_value">
            ...
            <div class="col-sm-3 text-center">
             ...
             <div class="col-sm-1 text-center">
                    <input type="text" class="form-control" id="no_of_threads_in_weft_value" name="no_of_threads_in_weft_value" value="<?php echo $row_for_sanforizing_process['no_of_threads_in_weft_value']?>" onchange="no_of_threads_in_weft_cal()" required>
          ...
          <div class="col-sm-1 text-center">
              <select  class="form-control" id="no_of_threads_in_weft_tolerance_range_math_operator" name="no_of_threads_in_weft_tolerance_range_math_operator" onchange="no_of_threads_in_weft_cal()">
                      <option  value="">Select No of Threads Count Tolerance Range Math Operator</option>
                      <?php
                                      $no_of_threads_in_weft_tolerance_range_math_operator = $row_for_sanforizing_process['no_of_threads_in_weft_tolerance_range_math_operator'];
                                     ?>
                                     <?php 
          ...
          <div class="col-sm-1" for="tolerance">
              ...
              <input type="text" class="form-control" id="no_of_threads_in_weft_tolerance_value" name="no_of_threads_in_weft_tolerance_value" value="<?php echo $row_for_sanforizing_process['no_of_threads_in_weft_tolerance_value']?>" onchange="no_of_threads_in_weft_cal()" required>
          ...
          <div class="col-sm-1" for="unit">
             <select  class="form-control" id="uom_of_no_of_threads_in_weft_value" name="uom_of_no_of_threads_in_weft_value" >
                      ...
                      <?php
                                      $uom_of_no_of_threads_in_weft_value = $row_for_sanforizing_process['uom_of_no_of_threads_in_weft_value'];
                                     ?>
                                     <?php 
          ...
          <div class="col-sm-1 text-center" for="min_value">
            ...
            <input type="text" class="form-control" id="no_of_threads_in_weft_min_value" name="no_of_threads_in_weft_min_value"  value="<?php echo $row_for_sanforizing_process['no_of_threads_in_weft_min_value']?>" required>
          </div>
                  
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="no_of_threads_in_weft_max_value" name="no_of_threads_in_weft_max_value" value="<?php echo $row_for_sanforizing_process['no_of_threads_in_weft_max_value']?>" required>
  ...
  <div id="div_mass_per_unit_area" style="visibility: none">
      ...
      <div class="form-group form-group-sm" for="mass_per_unit_per_area_value">
            ...
            <div class="col-sm-3 text-center">
             ...
             <div class="col-sm-1 text-center">
                    <input type="text" class="form-control" id="mass_per_unit_per_area_value" name="mass_per_unit_per_area_value" value="<?php echo $row_for_sanforizing_process['mass_per_unit_per_area_value']?>" onchange="mass_per_unit_per_area_cal()" required>
                 
             </div>
                
                 
          <div class="col-sm-1 text-center">
              <input type="text" class="form-control" id="mass_per_unit_per_area_tolerance_range_math_operator" name="mass_per_unit_per_area_tolerance_range_math_operator" onchange="mass_per_unit_per_area_cal()" value="<?php echo $row_for_sanforizing_process['mass_per_unit_per_area_tolerance_range_math_operator']?>" required>
          ...
          <div class="col-sm-1" for="tolerance">
              ...
              <input type="text" class="form-control" id="mass_per_unit_per_area_tolerance_value" name="mass_per_unit_per_area_tolerance_value" onchange="mass_per_unit_per_area_cal()" value="<?php echo $row_for_sanforizing_process['mass_per_unit_per_area_tolerance_value']?>" required>
          ...
          <div class="col-sm-1" for="unit">
             <select  class="form-control" id="uom_of_mass_per_unit_per_area_value" name="uom_of_mass_per_unit_per_area_value">
                      ...
                      <?php
                                      $uom_of_mass_per_unit_per_area_value = $row_for_sanforizing_process['uom_of_mass_per_unit_per_area_value'];
                                     ?>
                                     <?php 
          ...
          <div class="col-sm-1 text-center" for="min_value">
            ...
            <input type="text" class="form-control" id="mass_per_unit_per_area_min_value" name="mass_per_unit_per_area_min_value" value="<?php echo $row_for_sanforizing_process['mass_per_unit_per_area_min_value']?>" required>
          </div>
                  
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="mass_per_unit_per_area_max_value" name="mass_per_unit_per_area_max_value" value="<?php echo $row_for_sanforizing_process['mass_per_unit_per_area_max_value']?>" required>
 ...
 <div id="div_resistance_to_surface_fuzzing_and_pilling"> 
      ...
      <div class="form-group form-group-sm" for="mass_per_unit_per_area_value">
            ...
            <div class="col-sm-3 text-center">
             ...
             <div class="col-sm-2 text-center">
               ...
               <?php
                                      $description_or_type_for_surface_fuzzing_and_pilling = $row_for_sanforizing_process['description_or_type_for_surface_fuzzing_and_pilling'];
                                     ?>
                                     <?php 
          ...
          <div class="col-sm-1 text-center">
              <select  class="form-control" id="surface_fuzzing_and_pilling_tolerance_range_math_operator" name="surface_fuzzing_and_pilling_tolerance_range_math_operator" onchange="surface_fuzzing_and_pilling_cal()">
                ...
                <?php
                                      $surface_fuzzing_and_pilling_tolerance_range_math_operator = $row_for_sanforizing_process['surface_fuzzing_and_pilling_tolerance_range_math_operator'];
          ...
          <div class="col-sm-1" for="tolerance">
              ...
              <select  class="form-control" id="surface_fuzzing_and_pilling_tolerance_value" name="surface_fuzzing_and_pilling_tolerance_value" onchange="surface_fuzzing_and_pilling_cal()">
                    ...
                    <?php
                                      $surface_fuzzing_and_pilling_tolerance_value = $row_for_sanforizing_process['surface_fuzzing_and_pilling_tolerance_value'];
          ...
          <div class="col-sm-1 text-center">
             <input type="text" class="form-control" id="rubs_for_surface_fuzzing_and_pilling" name="rubs_for_surface_fuzzing_and_pilling" value="<?php echo $row_for_sanforizing_process['rubs_for_surface_fuzzing_and_pilling']?>" required>
          ...
          <div class="col-sm-1 text-center" for="min_value">
            ...
            <input type="text" class="form-control" id="surface_fuzzing_and_pilling_min_value" name="surface_fuzzing_and_pilling_min_value" value="<?php echo $row_for_sanforizing_process['surface_fuzzing_and_pilling_min_value']?>" required>
          </div>
                  
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="surface_fuzzing_and_pilling_max_value" name="surface_fuzzing_and_pilling_max_value" value="<?php echo $row_for_sanforizing_process['surface_fuzzing_and_pilling_max_value']?>" required>

           </div>
                    
            <input type="hidden" name="uom_of_surface_fuzzing_and_pilling_value" id="uom_of_surface_fuzzing_and_pilling_value" value="<?php echo $row_for_sanforizing_process['uom_of_surface_fuzzing_and_pilling_value']?>">    
  ...
  <div id="div_tensile_properties" style="visibility: none"> 
      ...
      <div class="form-group form-group-sm" for="tensile_properties_in_warp">
          ...
          <div class="col-sm-1 text-center">
              <select  class="form-control" id="tensile_properties_in_warp_value_tolerance_range_math_operator" name="tensile_properties_in_warp_value_tolerance_range_math_operator" onchange="tensile_properties_in_warp()">
                      ...
                      <?php
                                      $tensile_properties_in_warp_value_tolerance_range_math_operator = $row_for_sanforizing_process['tensile_properties_in_warp_value_tolerance_range_math_operator'];
          ...
          <div class="col-sm-1" for="tolerance">
             ...
             <input type="text" class="form-control" id="tensile_properties_in_warp_value_tolerance_value" name="tensile_properties_in_warp_value_tolerance_value"  value="<?php echo $row_for_sanforizing_process['tensile_properties_in_warp_value_tolerance_value']?>" onchange="tensile_properties_in_warp()" required>
          </div>
          ...
          <div class="col-sm-1" for="unit">
             <select  class="form-control" id="uom_of_tensile_properties_in_warp_value" name="uom_of_tensile_properties_in_warp_value">
                      <option  value="">Select Uom Of Warp Yarn Tensile Properties</option>
                      <?php
                                      $uom_of_tensile_properties_in_warp_value = $row_for_sanforizing_process['uom_of_tensile_properties_in_warp_value'];
          ...
          <div class="col-sm-1 text-center" for="min_value">
            ...
            <input type="text" class="form-control" id="tensile_properties_in_warp_value_min_value" name="tensile_properties_in_warp_value_min_value"  value="<?php echo $row_for_sanforizing_process['tensile_properties_in_warp_value_min_value']?>" required>
          </div>
                  
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="tensile_properties_in_warp_value_max_value" name="tensile_properties_in_warp_value_max_value"  value="<?php echo $row_for_sanforizing_process['tensile_properties_in_warp_value_max_value']?>" required>
      ...
      <div class="form-group form-group-sm" for="tensile_properties_in_weft">
          ...
          <div class="col-sm-1 text-center">
              <select  class="form-control" id="tensile_properties_in_weft_value_tolerance_range_math_operator" name="tensile_properties_in_weft_value_tolerance_range_math_operator" onchange="tensile_properties_in_weft()">
                      ...
                      <?php
                                      $tensile_properties_in_weft_value_tolerance_range_math_operator = $row_for_sanforizing_process['tensile_properties_in_weft_value_tolerance_range_math_operator'];
          ...
          <div class="col-sm-1" for="tolerance">
             ...
             <input type="text" class="form-control" id="tensile_properties_in_weft_value_tolerance_value" name="tensile_properties_in_weft_value_tolerance_value" value="<?php echo $row_for_sanforizing_process['tensile_properties_in_weft_value_tolerance_value']?>" onchange="tensile_properties_in_weft()" required>
          </div>
          ...
          <div class="col-sm-1" for="unit">
             <select  class="form-control" id="uom_of_tensile_properties_in_weft_value" name="uom_of_tensile_properties_in_weft_value">
                      <option  value="">Select Uom Of weft Yarn Tensile Properties</option>
                      <?php
                                      $uom_of_tensile_properties_in_weft_value = $row_for_sanforizing_process['uom_of_tensile_properties_in_weft_value'];
          ...
          <div class="col-sm-1 text-center" for="min_value">
            ...
            <input type="text" class="form-control" id="tensile_properties_in_weft_value_min_value" name="tensile_properties_in_weft_value_min_value" value="<?php echo $row_for_sanforizing_process['tensile_properties_in_weft_value_min_value']?>" required>
          </div>
                  
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="tensile_properties_in_weft_value_max_value" name="tensile_properties_in_weft_value_max_value" value="<?php echo $row_for_sanforizing_process['tensile_properties_in_weft_value_max_value']?>" required>
  ...
  <div id="div_tear_force" style="visibility: none">
        ...
        <div class="form-group form-group-sm" for="tear_force_in_warp_value">
          ...
          <div class="col-sm-1 text-center">
              <select  class="form-control" id="tear_force_in_warp_value_tolerance_range_math_operator" name="tear_force_in_warp_value_tolerance_range_math_operator" onchange="tear_force_in_warp_cal()">
                      ...
                      <?php
                                      $tear_force_in_warp_value_tolerance_range_math_operator = $row_for_sanforizing_process['tear_force_in_warp_value_tolerance_range_math_operator'];
          ...
          <div class="col-sm-1" for="tolerance">
             ...
             <input type="text" class="form-control" id="tear_force_in_warp_value_tolerance_value" name="tear_force_in_warp_value_tolerance_value" value="<?php echo $row_for_sanforizing_process['tear_force_in_warp_value_tolerance_value']?>" onchange="tear_force_in_warp_cal()" required>
          </div>
          ...
          <div class="col-sm-1" for="unit">
             <select  class="form-control" id="uom_of_tear_force_in_warp_value" name="uom_of_tear_force_in_warp_value">
                      ...
                      <?php
                                      $uom_of_tear_force_in_warp_value = $row_for_sanforizing_process['uom_of_tear_force_in_warp_value'];
          ...
          <div class="col-sm-1 text-center" for="min_value">
            ...
            <input type="text" class="form-control" id="tear_force_in_warp_value_min_value" name="tear_force_in_warp_value_min_value" value="<?php echo $row_for_sanforizing_process['tear_force_in_warp_value_min_value']?>" required>
          </div>
                  
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="tear_force_in_warp_value_max_value" name="tear_force_in_warp_value_max_value" value="<?php echo $row_for_sanforizing_process['tear_force_in_warp_value_max_value']?>" required>
     ...
     <div class="form-group form-group-sm" for="tear_force_in_weft_value">
          ...
          <div class="col-sm-1 text-center">
              <select  class="form-control" id="tear_force_in_weft_value_tolerance_range_math_operator" name="tear_force_in_weft_value_tolerance_range_math_operator" onchange="tear_force_in_weft_cal()">
                      ...
                      <?php
                                      $tear_force_in_weft_value_tolerance_range_math_operator = $row_for_sanforizing_process['tear_force_in_weft_value_tolerance_range_math_operator'];
          ...
          <div class="col-sm-1" for="tolerance">
             ...
             <input type="text" class="form-control" id="tear_force_in_weft_value_tolerance_value" name="tear_force_in_weft_value_tolerance_value" value="<?php echo $row_for_sanforizing_process['tear_force_in_weft_value_tolerance_value']?>" onchange="tear_force_in_weft_cal()" required>
          </div>
          ...
          <div class="col-sm-1" for="unit">
             <select  class="form-control" id="uom_of_tear_force_in_weft_value" name="uom_of_tear_force_in_weft_value">
                      ...
                      <?php
                                      $uom_of_tear_force_in_weft_value = $row_for_sanforizing_process['uom_of_tear_force_in_weft_value'];
          ...
          <div class="col-sm-1 text-center" for="min_value">
            ...
            <input type="text" class="form-control" id="tear_force_in_weft_value_min_value" name="tear_force_in_weft_value_min_value" value="<?php echo $row_for_sanforizing_process['tear_force_in_weft_value_min_value']?>" required>
          </div>
              
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="tear_force_in_weft_value_max_value" name="tear_force_in_weft_value_max_value" value="<?php echo $row_for_sanforizing_process['tear_force_in_weft_value_max_value']?>" required>
 ...
 <div id="div_seam_slippage" style="display: none">
      ...
      <div class="form-group form-group-sm" for="seam_slippage_resistance_in_warp">
          ...
          <div class="col-sm-1 text-center">
              <select  class="form-control" id="seam_slippage_resistance_in_warp_tolerance_range_math_operator" name="seam_slippage_resistance_in_warp_tolerance_range_math_operator" onchange="seam_slippage_resistance_in_warp_cal()">
                    ...
                    <?php
                      $seam_slippage_in_warp_tolrence_math_operator = $row_for_sanforizing_process['seam_slippage_resistance_in_warp_tolerance_range_math_operator'];
                 
                          if($seam_slippage_in_warp_tolrence_math_operator=='1')
                          {
                           ?>
                          ...
                          else if($seam_slippage_in_warp_tolrence_math_operator=='2')
                          {
                           ?>
                          ...
                          else if($seam_slippage_in_warp_tolrence_math_operator=='3')
                          {
                           ?>
                                <option value="1">1mm</option>
                                <option value="2" > 2mm </option>
                          ...
                          else if($seam_slippage_in_warp_tolrence_math_operator=='4')
                          {
                           ?>
                                <option value="1">1mm</option>
                                <option value="2" > 2mm </option>
                          ...
                          else if($seam_slippage_in_warp_tolrence_math_operator=='5')
                          {
                           ?>
                                <option value="1">1mm</option>
                                <option value="2" > 2mm </option>
                          ...
                          else if($seam_slippage_in_warp_tolrence_math_operator=='6')
                          {
                           ?>
                                <option value="1">1mm</option>
                                <option value="2" > 2mm </option>
          ...
          <div class="col-sm-1" for="tolerance">
            ...
            <input type="text" class="form-control" id="seam_slippage_resistance_in_warp_tolerance_value" name="seam_slippage_resistance_in_warp_tolerance_value" value="<?php echo $row_for_sanforizing_process['seam_slippage_resistance_in_warp_tolerance_value']?>" onchange="seam_slippage_resistance_in_warp_cal()" required>
          </div>
          ...
          <div class="col-sm-1" for="unit">
             <select  class="form-control" id="uom_of_seam_slippage_resistance_in_warp" name="uom_of_seam_slippage_resistance_in_warp">
                      <option  value="" >Select Uom </option>
                                    ...
                                    <?php
                                      $uom_of_seam_slippage_resistance_in_warp = $row_for_sanforizing_process['uom_of_seam_slippage_resistance_in_warp'];
          ...
          <div class="col-sm-1 text-center" for="min_value">
            ...
            <input type="text" class="form-control" id="seam_slippage_resistance_in_warp_min_value" name="seam_slippage_resistance_in_warp_min_value" value="<?php echo $row_for_sanforizing_process['seam_slippage_resistance_in_warp_min_value']?>" required>
          </div>
                  
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="seam_slippage_resistance_in_warp_max_value" name="seam_slippage_resistance_in_warp_max_value" value="<?php echo $row_for_sanforizing_process['seam_slippage_resistance_in_warp_max_value']?>" required>
           </div>
      ...
      <div class="form-group form-group-sm" for="seam_slippage_resistance_in_weft_value">
          ...
          <div class="col-sm-1 text-center">
              <select  class="form-control" id="seam_slippage_resistance_in_weft_tolerance_range_math_operator" name="seam_slippage_resistance_in_weft_tolerance_range_math_operator" onchange="seam_slippage_resistance_in_weft_cal()">
                      <option  value="">Select weft Yarn Tear Force Tolerance Range Math Operator</option>
                            ...
                            <?php
                      $seam_slippage_resistance_in_weft_tolerance_range_math_operator = $row_for_sanforizing_process['seam_slippage_resistance_in_weft_tolerance_range_math_operator'];
          ...
          <div class="col-sm-1" for="tolerance">
             ...
             <input type="text" class="form-control" id="seam_slippage_resistance_in_weft_tolerance_value" name="seam_slippage_resistance_in_weft_tolerance_value" value="<?php echo $row_for_sanforizing_process['seam_slippage_resistance_in_weft_tolerance_value']?>" onchange="seam_slippage_resistance_in_weft_cal()" required>
          </div>
          ...
          <div class="col-sm-1" for="unit">
             <select  class="form-control" id="uom_of_seam_slippage_resistance_in_weft" name="uom_of_seam_slippage_resistance_in_weft">
                      <option  value="">Select Uom Of weft Yarn Tear Force Properties</option>
                                    ...
                                    <?php
                                      $uom_of_seam_slippage_resistance_in_weft = $row_for_sanforizing_process['uom_of_seam_slippage_resistance_in_weft'];
          ...
          <div class="col-sm-1 text-center" for="min_value">
            ...
            <input type="text" class="form-control" id="seam_slippage_resistance_in_weft_min_value" name="seam_slippage_resistance_in_weft_min_value" value="<?php echo $row_for_sanforizing_process['seam_slippage_resistance_in_weft_min_value']?>" required>
          </div>
                  
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="seam_slippage_resistance_in_weft_max_value" name="seam_slippage_resistance_in_weft_max_value" value="<?php echo $row_for_sanforizing_process['seam_slippage_resistance_in_weft_max_value']?>" required>
     ...
     <div class="form-group form-group-sm" for="seam_slippage_resistance_iso_2_in_warp">
         ...
         <div class="col-sm-2 text-center">
          ...
          <div class="col-sm-1 text-center">
              <select  class="form-control" id="seam_slippage_resistance_iso_2_in_warp_tolerance_range_math_op" name="seam_slippage_resistance_iso_2_in_warp_tolerance_range_math_op" onchange="seam_slippage_resistance_iso_2_in_warp_cal()">
                <option  value="">Select operator Value</option>
                                ...
                                <?php
                                      $seam_slippage_resistance_iso_2_in_warp_tolerance_range_math_op = $row_for_sanforizing_process['seam_slippage_resistance_iso_2_in_warp_tolerance_range_math_op'];
                                      ...
                                      <?php
                                          ...
                                          else if($seam_slippage_resistance_iso_2_in_warp_tolerance_range_math_op=='≤')
                                          {
                                         ?>
                                          <option value="≥">≥</option>
                                          <option value="≤" selected> ≤ </option>
            ...
            <div class="col-sm-1 text-center">
                 <select  class="form-control" id="uom_of_seam_slippage_resistance_iso_2_in_warp_for_load" name="uom_of_seam_slippage_resistance_iso_2_in_warp_for_load">
                      <option  value="">Select Uom </option>
                                ...
                                <?php
                                      $uom_of_seam_slippage_resistance_iso_2_in_warp_for_load = $row_for_sanforizing_process['uom_of_seam_slippage_resistance_iso_2_in_warp_for_load'];
          ...
          <div class="col-sm-1" for="tolerance">
             ...
             <select  class="form-control" id="seam_slippage_resistance_iso_2_in_warp_tolerance_value" name="seam_slippage_resistance_iso_2_in_warp_tolerance_value" onchange="seam_slippage_resistance_iso_2_in_warp_cal()">
                <option  value="">Select  Tolerance Value</option>
                    ...
                    <?php
                      $seam_slippage_resistance_iso_2_in_warp_tolerance_value = $row_for_sanforizing_process['seam_slippage_resistance_iso_2_in_warp_tolerance_value'];
          ...
          <div class="col-sm-1 text-center" for="min_value">
            ...
            <input type="text" class="form-control" id="seam_slippage_resistance_iso_2_in_warp_min_value" name="seam_slippage_resistance_iso_2_in_warp_min_value" value="<?php echo $row_for_sanforizing_process['seam_slippage_resistance_iso_2_in_warp_min_value']?>" required>
          </div>
              
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="seam_slippage_resistance_iso_2_in_warp_max_value" name="seam_slippage_resistance_iso_2_in_warp_max_value" value="<?php echo $row_for_sanforizing_process['seam_slippage_resistance_iso_2_in_warp_max_value']?>" required>
           </div>
     ...
     <div class="form-group form-group-sm" for="seam_slippage_resistance_iso_2_in_weft">
          ...
          <div class="col-sm-1 text-center">
              <select  class="form-control" id="seam_slippage_resistance_iso_2_in_weft_tolerance_range_math_op" name="seam_slippage_resistance_iso_2_in_weft_tolerance_range_math_op" onchange="seam_slippage_resistance_iso_2_in_weft_cal()">
                <option  value="">Select operator Value</option>
                                ...
                                <?php
                                      $seam_slippage_resistance_iso_2_in_weft_tolerance_range_math_op = $row_for_sanforizing_process['seam_slippage_resistance_iso_2_in_weft_tolerance_range_math_op'];
                                      ...
                                      <?php
                                          ...
                                          else if($seam_slippage_resistance_iso_2_in_weft_tolerance_range_math_op=='≤')
                                          {
                                         ?>
                                          <option value="≥">≥</option>
                                          <option value="≤" selected> ≤ </option>
           ...
           <div class="col-sm-1 text-center">
                 <select  class="form-control" id="uom_of_seam_slippage_resistance_iso_2_in_weft_for_load" name="uom_of_seam_slippage_resistance_iso_2_in_weft_for_load">
                      <option  value="">Select Uom</option>
                                    ...
                                    <?php
                                      $uom_of_seam_slippage_resistance_iso_2_in_weft_for_load = $row_for_sanforizing_process['uom_of_seam_slippage_resistance_iso_2_in_weft_for_load'];
          ...
          <div class="col-sm-1" for="tolerance">
             ...
             <select  class="form-control" id="seam_slippage_resistance_iso_2_in_weft_tolerance_value" name="seam_slippage_resistance_iso_2_in_weft_tolerance_value" onchange="seam_slippage_resistance_iso_2_in_weft_cal()">
                <option  value="">Select Tolerance Value</option>
                    ...
                    <?php
                      $seam_slippage_resistance_iso_2_in_weft_tolerance_value = $row_for_sanforizing_process['seam_slippage_resistance_iso_2_in_weft_tolerance_value'];
          ...
          <div class="col-sm-1 text-center" for="min_value">
            ...
            <input type="text" class="form-control" id="seam_slippage_resistance_iso_2_in_weft_min_value" name="seam_slippage_resistance_iso_2_in_weft_min_value" value="<?php echo $row_for_sanforizing_process['seam_slippage_resistance_iso_2_in_weft_min_value']?>" required>
          </div>
              
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="seam_slippage_resistance_iso_2_in_weft_max_value" name="seam_slippage_resistance_iso_2_in_weft_max_value" value="<?php echo $row_for_sanforizing_process['seam_slippage_resistance_iso_2_in_weft_max_value']?>" required>
          </div>
...
<div id="div_seam_strength" style="display: none">
      ...
      <div class="form-group form-group-sm" for="seam_strength_in_warp_value">
          ...
          <div class="col-sm-1 text-center">
              ...
              <select  class="form-control" id="seam_strength_in_warp_value_tolerance_range_math_operator" name="seam_strength_in_warp_value_tolerance_range_math_operator" onchange="seam_strength_in_warp_cal()">
                      <option  value="">Select Seam Strength in Warp Math Operator</option>
                                    ...
                                    <?php
                                      $seam_strength_in_warp_value_tolerance_range_math_operator = $row_for_sanforizing_process['seam_strength_in_warp_value_tolerance_range_math_operator'];
          ...
          <div class="col-sm-1" for="tolerance">
            ...
            <input type="text" class="form-control" id="seam_strength_in_warp_value_tolerance_value" name="seam_strength_in_warp_value_tolerance_value" value="<?php echo $row_for_sanforizing_process['seam_strength_in_warp_value_tolerance_value']?>" onchange="seam_strength_in_warp_cal()" required>
          </div>
          ...
          <div class="col-sm-1" for="unit">
             <select  class="form-control" id="uom_of_seam_strength_in_warp_value" name="uom_of_seam_strength_in_warp_value">
                      <option  value="">Select Uom Of Seam Strength in Warp Properties</option>
                                    ...
                                    <?php
                                      $uom_of_seam_strength_in_warp_value = $row_for_sanforizing_process['uom_of_seam_strength_in_warp_value'];
          ...
          <div class="col-sm-1 text-center" for="min_value">
            ...
            <input type="text" class="form-control" id="seam_strength_in_warp_value_min_value" name="seam_strength_in_warp_value_min_value" value="<?php echo $row_for_sanforizing_process['seam_strength_in_warp_value_min_value']?>" required>
          </div>
                  
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="seam_strength_in_warp_value_max_value" name="seam_strength_in_warp_value_max_value" value="<?php echo $row_for_sanforizing_process['seam_strength_in_warp_value_max_value']?>" required>
     ...
     <div class="form-group form-group-sm" for="seam_strength_in_weft_value">
          ...
          <div class="col-sm-1 text-center">
              ...
              <select  class="form-control" id="seam_strength_in_weft_value_tolerance_range_math_operator" name="seam_strength_in_weft_value_tolerance_range_math_operator" onchange="seam_strength_in_weft_cal()">
                      <option  value="">Select  Math Operator</option>
                                    ...
                                    <?php
                                      $seam_strength_in_weft_value_tolerance_range_math_operator = $row_for_sanforizing_process['seam_strength_in_weft_value_tolerance_range_math_operator'];
          ...
          <div class="col-sm-1" for="tolerance">
            ...
            <input type="text" class="form-control" id="seam_strength_in_weft_value_tolerance_value" name="seam_strength_in_weft_value_tolerance_value" value="<?php echo $row_for_sanforizing_process['seam_strength_in_weft_value_tolerance_value']?>" onchange="seam_strength_in_weft_cal()" required>
          </div>
          ...
          <div class="col-sm-1" for="unit">
             <select  class="form-control" id="uom_of_seam_strength_in_weft_value" name="uom_of_seam_strength_in_weft_value">
                      <option  value="">Select Uom </option>
                                    ...
                                    <?php
                                      $uom_of_seam_strength_in_weft_value = $row_for_sanforizing_process['uom_of_seam_strength_in_weft_value'];
          ...
          <div class="col-sm-1 text-center" for="min_value">
            ...
            <input type="text" class="form-control" id="seam_strength_in_weft_value_min_value" name="seam_strength_in_weft_value_min_value" value="<?php echo $row_for_sanforizing_process['seam_strength_in_weft_value_min_value']?>" required>
          </div>
                  
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="seam_strength_in_weft_value_max_value" name="seam_strength_in_weft_value_max_value" value="<?php echo $row_for_sanforizing_process['seam_strength_in_weft_value_max_value']?>" required>
      ...
      <div class="col-sm-3 text-center">
       ...
       <div class="col-sm-2 text-center">
          ...
          <div class="col-sm-1 text-center">
                <select  class="form-control" id="seam_properties_seam_slippage_iso_astm_d_in_warp_tol_range_mt_op" name="seam_properties_seam_slippage_iso_astm_d_in_warp_tol_range_mt_op" onchange="seam_properties_seam_slippage_iso_astm_d_in_warp_cal()">
                   <option  value="">Select Tolerance Value</option>
                        ...
                        <?php
                      $seam_properties_seam_slippage_iso_astm_d_in_warp_tol_range_mt_op = $row_for_sanforizing_process['seam_properties_seam_slippage_iso_astm_d_in_warp_tol_range_mt_op'];
          ...
          <div class="col-sm-1" for="tolerance">
              ...
              <input type="text" class="form-control" id="seam_properties_seam_slippage_iso_astm_d_in_warp_tolerance_value" name="seam_properties_seam_slippage_iso_astm_d_in_warp_tolerance_value" value="<?php echo $row_for_sanforizing_process['seam_properties_seam_slippage_iso_astm_d_in_warp_tolerance_value']?>" onchange="seam_properties_seam_slippage_iso_astm_d_in_warp_cal()" required>
          </div>
          ...
          <div class="col-sm-1" for="unit">
             <select  class="form-control" id="uom_of_seam_properties_seam_slippage_iso_astm_d_in_warp" name="uom_of_seam_properties_seam_slippage_iso_astm_d_in_warp">
                      <option  value="">Select Uom </option>
                                    ...
                                    <?php
                                      $uom_of_seam_properties_seam_slippage_iso_astm_d_in_warp = $row_for_sanforizing_process['uom_of_seam_properties_seam_slippage_iso_astm_d_in_warp'];
                                      ...
                                      <?php
                                       ...
                                       <?php
                                          ...
                                          else if($uom_of_seam_properties_seam_slippage_iso_astm_d_in_warp=='mm')
                                          {
                                             ...
                                             <option value="kg">kg</option>
                                             <option value="lbf">lbf</option>
                                             <option value="daN">daN</option>   <option value="mm" selected>mm</option>
          ...
          <div class="col-sm-1 text-center" for="min_value">
            ...
            <input type="text" class="form-control" id="seam_properties_seam_slippage_iso_astm_d_in_warp_min_value" name="seam_properties_seam_slippage_iso_astm_d_in_warp_min_value" value="<?php echo $row_for_sanforizing_process['seam_properties_seam_slippage_iso_astm_d_in_warp_min_value']?>" required>
          </div>
              
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="seam_properties_seam_slippage_iso_astm_d_in_warp_max_value" name="seam_properties_seam_slippage_iso_astm_d_in_warp_max_value" value="<?php echo $row_for_sanforizing_process['seam_properties_seam_slippage_iso_astm_d_in_warp_max_value']?>" required>
           </div>
      ...
      <div class="col-sm-3 text-center">
       ...
       <div class="col-sm-2 text-center">
          ...
          <div class="col-sm-1 text-center">
              <select  class="form-control" id="seam_properties_seam_slippage_iso_astm_d_in_weft_tol_range_mt_op" name="seam_properties_seam_slippage_iso_astm_d_in_weft_tol_range_mt_op" onchange="seam_properties_seam_slippage_iso_astm_d_in_weft_cal()">
                <option  value="">Select  Tolerance Value</option>
                    ...
                    <?php
                      $seam_properties_seam_slippage_iso_astm_d_in_weft_tol_range_mt_op = $row_for_sanforizing_process['seam_properties_seam_slippage_iso_astm_d_in_weft_tol_range_mt_op'];
          ...
          <div class="col-sm-1" for="unit">
             <select  class="form-control" id="uom_of_seam_properties_seam_slippage_iso_astm_d_in_weft" name="uom_of_seam_properties_seam_slippage_iso_astm_d_in_weft">
                      <option  value="">Select Uom </option>
                                    ...
                                    <?php
                                      $uom_of_seam_properties_seam_slippage_iso_astm_d_in_weft = $row_for_sanforizing_process['uom_of_seam_properties_seam_slippage_iso_astm_d_in_weft'];
          ...
          <div class="col-sm-1 text-center" for="min_value">
            ...
            <input type="text" class="form-control" id="seam_properties_seam_slippage_iso_astm_d_in_weft_min_value" name="seam_properties_seam_slippage_iso_astm_d_in_weft_min_value" value="<?php echo $row_for_sanforizing_process['seam_properties_seam_slippage_iso_astm_d_in_weft_min_value']?>" required>
          </div>
              
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="seam_properties_seam_slippage_iso_astm_d_in_weft_max_value" name="seam_properties_seam_slippage_iso_astm_d_in_weft_max_value" value="<?php echo $row_for_sanforizing_process['seam_properties_seam_slippage_iso_astm_d_in_weft_max_value']?>" required>
           </div>
       ...
       <div class="col-sm-2 text-center">
        ...
        <select  class="form-control" id="seam_properties_seam_strength_iso_astm_d_in_warp_tol_range_op" name="seam_properties_seam_strength_iso_astm_d_in_warp_tol_range_op" onchange="seam_properties_seam_strength_iso_astm_d_in_warp_cal()">
                      <option  value="">Select Math Operator</option>
                                    ...
                                    <?php
                                      $seam_properties_seam_strength_iso_astm_d_in_warp_tol_range_op = $row_for_sanforizing_process['seam_properties_seam_strength_iso_astm_d_in_warp_tol_range_op'];
          ...
          <div class="col-sm-1" for="tolerance">
            ...
            <input type="text" class="form-control" id="seam_properties_seam_strength_iso_astm_d_in_warp_tolerance_value" name="seam_properties_seam_strength_iso_astm_d_in_warp_tolerance_value" value="<?php echo $row_for_sanforizing_process['seam_properties_seam_strength_iso_astm_d_in_warp_tolerance_value']?>" onchange="seam_properties_seam_strength_iso_astm_d_in_warp_cal()" required>
          </div>
          ...
          <div class="col-sm-1" for="unit">
             <select  class="form-control" id="uom_of_seam_properties_seam_strength_iso_astm_d_in_warp" name="uom_of_seam_properties_seam_strength_iso_astm_d_in_warp">
                      <option  value="">Select Uom </option>
                                    ...
                                    <?php
                                      $uom_of_seam_properties_seam_strength_iso_astm_d_in_warp = $row_for_sanforizing_process['uom_of_seam_properties_seam_strength_iso_astm_d_in_warp'];
          ...
          <div class="col-sm-1 text-center" for="min_value">
            ...
            <input type="text" class="form-control" id="seam_properties_seam_strength_iso_astm_d_in_warp_min_value" name="seam_properties_seam_strength_iso_astm_d_in_warp_min_value"  value="<?php echo $row_for_sanforizing_process['seam_properties_seam_strength_iso_astm_d_in_warp_min_value']?>" required>
          </div>
              
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="seam_properties_seam_strength_iso_astm_d_in_warp_max_value" name="seam_properties_seam_strength_iso_astm_d_in_warp_max_value"  value="<?php echo $row_for_sanforizing_process['seam_properties_seam_strength_iso_astm_d_in_warp_max_value']?>" required>
       ...
       <div class="col-sm-2 text-center">
        ...
        <select  class="form-control" id="seam_properties_seam_strength_iso_astm_d_in_weft_tol_range_op" name="seam_properties_seam_strength_iso_astm_d_in_weft_tol_range_op" onchange="seam_properties_seam_strength_iso_astm_d_in_weft_cal()">
                      <option  value="">Select Math Operator</option>
                                    ...
                                    <?php
                                      $seam_properties_seam_strength_iso_astm_d_in_weft_tol_range_op = $row_for_sanforizing_process['seam_properties_seam_strength_iso_astm_d_in_weft_tol_range_op'];
          ...
          <div class="col-sm-1" for="tolerance">
            ...
            <input type="text" class="form-control" id="seam_properties_seam_strength_iso_astm_d_in_weft_tolerance_value" name="seam_properties_seam_strength_iso_astm_d_in_weft_tolerance_value" value="<?php echo $row_for_sanforizing_process['seam_properties_seam_strength_iso_astm_d_in_weft_tolerance_value']?>" onchange="seam_properties_seam_strength_iso_astm_d_in_weft_cal()" required>
          </div>
          ...
          <div class="col-sm-1" for="unit">
             <select  class="form-control" id="uom_of_seam_properties_seam_strength_iso_astm_d_in_weft" name="uom_of_seam_properties_seam_strength_iso_astm_d_in_weft">
                      <option  value="">Select Uom </option>
                                    ...
                                    <?php
                                      $uom_of_seam_properties_seam_strength_iso_astm_d_in_weft = $row_for_sanforizing_process['uom_of_seam_properties_seam_strength_iso_astm_d_in_weft'];
          ...
          <div class="col-sm-1 text-center" for="min_value">
            ...
            <input type="text" class="form-control" id="seam_properties_seam_strength_iso_astm_d_in_weft_min_value" name="seam_properties_seam_strength_iso_astm_d_in_weft_min_value" value="<?php echo $row_for_sanforizing_process['seam_properties_seam_strength_iso_astm_d_in_weft_min_value']?>" required>
          </div>
              
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="seam_properties_seam_strength_iso_astm_d_in_weft_max_value" name="seam_properties_seam_strength_iso_astm_d_in_weft_max_value" value="<?php echo $row_for_sanforizing_process['seam_properties_seam_strength_iso_astm_d_in_weft_max_value']?>" required>
           ...
           <div class="form-group form-group-sm">
                                <div class="col-sm-offset-3 col-sm-5">
                                    <button type="button" class="btn btn-primary" onClick="sending_data_of_defining_qc_standard_for_sanforizing_process_form_for_saving_in_database()">Save</button>
