...
if(isset($_GET['ready_for_mercerize_id']))
{
...
else
{
   ...
   $sql_for_ready_for_mercerize_process = "SELECT * FROM `defining_qc_standard_for_ready_for_mercerize_process`
...
{  
 ...
 function delete_ready_for_mercerizeing_process(ready_for_mercerize_id)
{
   var value_for_data= 'ready_for_mercerize_id='+ready_for_mercerize_id;
    
				$.ajax({
						url: 'process_program/deleting_ready_for_mercerize_process_standard.php',
						dataType: 'text',
						type: 'post',
						contentType: 'application/x-www-form-urlencoded',
						data: value_for_data,
...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
				...
				<div class="panel-heading" style="color:#191970;"><b>Edit Defining Qc Standard For Ready For Mercerize Process</b></div> <!-- This will create a upper block for FORM (Just Beautification) -->
...
<!--
                          ...
                          <table id="datatable-buttons" class="table table-striped table-bordered">
                           <thead>
                             ...
                             <?php
                                          ...
                                          if(isset($ready_for_mercerize_process_id))
                                          {
                                             $sql_for_ready_for_mercerize = "SELECT * FROM `defining_qc_standard_for_ready_for_mercerize_process` WHERE `id`='$ready_for_mercerize_process_id'";
                                          }
                                          else
                                          {
                                             $sql_for_ready_for_mercerize = "SELECT * FROM `defining_qc_standard_for_ready_for_mercerize_process`
                                             WHERE `standard_for_which_process`='$standard_for_which_process' and `pp_number` = '$pp_number' and `version_id`='$version_id'  ORDER BY id ASC";
                                          }
                           ...
                           <tr>
                              ...
                              <td>
                                    ...
                                    <button type="submit" id="edit_ready_for_mercerize" name="edit_ready_for_mercerize"  class="btn btn-info btn-xs" onclick="load_page('process_program/edit_defining_qc_standard_for_ready_for_mercerize_process.php?ready_for_mercerize_id=<?php echo $row['id'] ?>')"> Edit </button>
                                    ...
                                    <?php 
                                             ...
                                             {
                                                ?>
                                                   <button type="button" id="delete_ready_for_mercerize" name="delete_ready_for_mercerize"  class="btn btn-danger btn-xs" onclick="delete_ready_for_mercerizeing_process(<?php echo $row['id'];?>)" > Delete </button>
                                                <?php
                                             } 
                                       ?>
         ...
         <button type="button" class="btn btn-info" id="buttn_for_load_form" onclick="load_full_form('<?php echo $row_for_ready_for_mercerize_process['customer_id']?>')">Load Form</button>
...
<!-- For Full Entry Form -->
           ...
           <div class="full_page_load" id="full_page_load" style="display: none;"> 
				...
				<form class="form-horizontal" action="" style="margin-top:10px;" name="defining_qc_standard_for_ready_for_mercerize_process_form" id="defining_qc_standard_for_ready_for_mercerize_process_form">
                         ...
                         <label>PP Number :<?php echo $row_for_ready_for_mercerize_process['pp_number']?><input type="hidden" class="form-control" id="pp_number" name="pp_number" value="<?php echo $row_for_ready_for_mercerize_process['pp_number']?>" readonly></label>  ,
                        

                         <label>Version Name :<?php echo $row_for_ready_for_mercerize_process['version_number']?><input type="hidden" id="version_number" name="version_number" value="<?php echo $row_for_ready_for_mercerize_process['version_number']?>" >  </label>  ,
                        

                        <label>Customer Name :<?php echo $row_for_ready_for_mercerize_process['customer_name']?><input type="hidden" id="customer_name" name="customer_name" value="<?php echo $row_for_ready_for_mercerize_process['customer_name']?>"> </label>   ,
                        
                        <input type="hidden" id="customer_id" name="customer_id" value="<?php echo $row_for_ready_for_mercerize_process['customer_id']?>">

                        <label>Color :<?php echo $row_for_ready_for_mercerize_process['color']?><input type="hidden" id="color" name="color" value="<?php echo $row_for_ready_for_mercerize_process['color']?>" > </label>    ,
                        
                        <input type="hidden" id="version_id" name="version_id" value="<?php echo $row_for_ready_for_mercerize_process['version_id']?>" >

                        <label>Finish Width :<?php echo $row_for_ready_for_mercerize_process['finish_width_in_inch']?><input type="hidden" id="finish_width_in_inch" name="finish_width_in_inch"  value="<?php echo $row_for_ready_for_mercerize_process['finish_width_in_inch']?>"> </label>
		...
		<div class="form-group form-group-sm" >
	      ...
	      <div class="col-sm-3 text-center">
	       ...
	       <div class="col-sm-2 text-center">
	                ...
	                <input type="hidden" class="form-control" id="test_method_for_whiteness" name="test_method_for_whiteness" value="<?php echo $row_for_ready_for_mercerize_process['test_method_for_whiteness']?>">
	          ...
	          <div class="col-sm-1" for="unit">
	             ...
	             (°)
	            <input type="hidden" id="uom_of_whiteness" name="uom_of_whiteness"  value="<?php echo $row_for_ready_for_mercerize_process['uom_of_whiteness']?>">
	          </div>
      ...
      <div class="col-sm-3 text-center">
       ...
       <div class="col-sm-2 text-center">
        ...
        <select  class="form-control" id="bowing_and_skew_tolerance_range_math_operator" name="bowing_and_skew_tolerance_range_math_operator" onchange="bowing_and_skew_cal_for_iso()">
          ...
          <div class="col-sm-1" for="unit">
             %
            <input type="hidden" name="uom_of_bowing_and_skew" id="uom_of_bowing_and_skew" value="<?php echo $row_for_ready_for_mercerize_process['uom_of_bowing_and_skew']?>">
          </div>
    ...
    <div class="form-group form-group-sm" for="ph" id="div_ph" >  
       ...
       <div class="form-group form-group-sm" >
          ...
          <div class="col-sm-1" for="unit">
            ...
            <input type="hidden" name="uom_of_ph" id="uom_of_ph" value="<?php echo $row_for_ready_for_mercerize_process['uom_of_ph']?>">
          </div>
           ...
           <input type="text" class="form-control" id="ph_max_value" name="ph_max_value" value="<?php echo $row_for_ready_for_mercerize_process['ph_max_value']?>" required>
                       ...
                       <div class="form-group form-group-sm">
								<div class="col-sm-offset-3 col-sm-5">
									<button type="button" class="btn btn-primary" onClick="sending_data_of_defining_qc_standard_for_ready_for_mercerize_process_form_for_saving_in_database()">Save</button>
