...
//from new database and form
   ...
   mysqli_query($con,"START TRANSACTION") or die(mysqli_error($con));
	 ...
	 $select_sql_for_duplicacy="select * from `defining_qc_standard_for_dyeing_finish_process` where `pp_number`='$pp_number' and `version_number`='$version_number' and 
	...
	else if(mysqli_num_rows($result) < 1)
	{
		...
		$update_sql_statement="UPDATE  `defining_qc_standard_for_dyeing_finish_process` SET
