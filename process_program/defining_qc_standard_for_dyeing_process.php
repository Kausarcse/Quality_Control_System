...
?>
<script type='text/javascript' src='process_program/defining_qc_standard_for_dyeing_process_form_validation.js'></script>
...
*/ document.getElementById('color').value=splitted_version_details[1];
  ...
  document.getElementById('standard_for_which_process').value='Dyeing';
  document.getElementById('process_id').value='proc_12';
 ...
 function sending_data_of_defining_qc_standard_for_dyeing_process_form_for_saving_in_database()
 {
    ...
    //   var validate =true;
      var url_encoded_form_data = $("#defining_qc_standard_for_dyeing_process_form").serialize(); //This will read all control elements value of the form
      //alert(url_encoded_form_data);

		  	 $.ajax({
			 		url: 'process_program/defining_qc_standard_for_dyeing_process_saving.php',
			 		dataType: 'text',
			 		type: 'post',
			 		contentType: 'application/x-www-form-urlencoded',
 ...
 }//End of function sending_data_of_defining_qc_standard_for_dyeing_process_form_for_saving_in_database()
...
function delete_dyeing_process(dyeing_id)
{
	var value_for_data= 'dyeing_id='+dyeing_id;
    
				$.ajax({
						url: 'process_program/deleting_dyeing_process_standard.php',
						dataType: 'text',
						type: 'post',
						contentType: 'application/x-www-form-urlencoded',
						data: value_for_data,
...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<?php 
			...
			{
				?>
				<div class="panel-heading" style="color:#191970;"><b>Model For Dyeing Process</b></div> 
				...
				<div id='search_form_collpapsible_div_1' class="collapse in"> 
					...
					<form class="form-horizontal" action="" style="margin-top:10px;" name="defining_qc_standard_for_dyeing_process_form_view" id="defining_qc_standard_for_dyeing_process_form_view" data-toggle="collapse" data-target="#search_form_collpapsible_div">
						<div class="panel panel-default">
							<table id="datatable-buttons" class="table table-striped table-bordered">
								...
								<tbody>
									<?php
									$s1 = 1;
									$standard_for_which_process='Dyeing';
									$sql_for_dyeing = "SELECT * FROM `model_defining_qc_standard_for_dyeing_process` 
									...
									$res_for_dyeing = mysqli_query($con, $sql_for_dyeing);

									while ($row = mysqli_fetch_assoc($res_for_dyeing))
									{
										...
										<tr>
			                                ...
			                                <!-- <button type="submit" id="edit_model_dyeing" name="edit_model_dyeing"  class="btn btn-info btn-xs" onclick="load_page('auto_sync/edit_model_defining_qc_standard_for_dyeing_process.php?model_dyeing_id=<?php echo $row['id'] ?>')"> Edit </button> -->
			...
			{ 
				...
				<div class="panel-heading" style="color:#191970;"><b>Defining Standard For Dyeing Process</b></div> <!-- This will create a upper block for FORM (Just Beautification) -->
                ...
                <div id='search_form_collpapsible_div_1' class="collapse in"> <!-- For Making Collapsible Section -->
	                    ...
	                    <div class="panel panel-default">
	                       <table id="datatable-buttons" class="table table-striped table-bordered">
	                        <thead>
	                          ...
	                          <?php
                                          $s1 = 1;
                                          $standard_for_which_process='Dyeing';
                                          $sql_for_dyeing = "SELECT * FROM `defining_qc_standard_for_dyeing_process` 
						  ...
						  <tr>
							 ...
							 <td>
                                      ...
                                      <!-- <button type="submit" id="edit_dyeing" name="edit_dyeing"  class="btn btn-info btn-xs" onclick="load_page('process_program/edit_defining_qc_standard_for_dyeing_process.php?dyeing_id=<?php echo $row['id'] ?>')"> Edit </button> -->
									  ...
									  <?php 
											 ...
											 {
												?>
													<button type="button" id="delete_dyeing" name="delete_dyeing"  class="btn btn-danger btn-xs" onclick="delete_dyeing_process(<?php echo $row['id'];?>)" > Delete </button>
												<?php
											 } 
									  ?>

                                       <!-- <button type="submit" id="delete_dyeing" name="delete_dyeing"  class="btn btn-danger btn-xs" onclick="load_page('process_program/deleting_dyeing_process_standard.php?dyeing_id=<?php echo $row['id'] ?>')"> Delete </button> -->
                               </td>
                              <?php
              	 ...
              	 </form>    <!-- End of <form class="form-horizontal" action="" style="margin-top:10px;" name="defining_qc_standard_for_dyeing_process_form" id="defining_qc_standard_for_dyeing_process_form"> -->

            	</div> <!-- End of <div class="panel-heading" style="color:#191970;"><b> dyeing Standard Process List</b></div>  -->
		    	<?php
			}
				?>
				<form class="form-horizontal" action="" style="margin-top:10px;" name="defining_qc_standard_for_dyeing_process_form" id="defining_qc_standard_for_dyeing_process_form">
				...
				<?php
                  ...
                  if (isset($_GET['model_standard'])) 
                  {
                     ...
                     <input type="hidden" id="process_id" name="process_id"  value="proc_12">
...
<div class="form-group form-group-sm full_page_load"   id="full_page_load">
			...
			<div style="padding: 20px;color: red;">
				<h4><strong>There is no test and method for Dyeing process.  Please click to save button for process routing</strong></h4>
			</div>
...
<!-- *********************************** Designing Tabular Formar (Multi-Column Form Elements Here (End))*********************************** -->
						...
						<div class="form-group form-group-sm">
								<div class="col-sm-offset-3 col-sm-5">
									<button type="button" class="btn btn-primary" onClick="sending_data_of_defining_qc_standard_for_dyeing_process_form_for_saving_in_database()">Submit</button>
