...
function Ready_for_Mercerize_Form_Validation()
{
		...
		{
      		alert("Please Provide Whiteness Tolerance Value In ");
		...
		{
      		alert("Whiteness Tolerance Value In  should be Numeric");
		...
		{
      		alert("Please Provide Ph Tolerance Value In ");
		...
		{
      		alert("Ph Tolerance Value In  should be Numeric");
