...
*/
$pp_wise_version_id=$_GET['version_id'];
$sql_for_pp_wise_version_info="select * from pp_wise_version_creation_info where `version_id`='$pp_wise_version_id'";
...
<script type='text/javascript' src='process_program/Edit_PP_Wise_Version_Creation_Form_Validation.js'></script>
<script>
...
function calculate_fiber_cotent()
{
 ...
 {
       var validate = Edit_PP_Wise_Version_Creation_Form_Validation();
	   ...
	   {
		  	 $.ajax({
			 		url: 'process_program/edit_pp_wise_version_creation_info_saving.php',
			 		dataType: 'text',
			 		type: 'post',
		...
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
				...
				<form class="form-horizontal" action="" style="margin-top:10px;" name="pp_wise_version_creation_info_form" id="pp_wise_version_creation_info_form">
						...
						<label class="control-label col-sm-3" for="pp_number" style="margin-right:0px; color:#00008B;">PP Number:<span style="color:red"> *</span></label> 
							<div class="col-sm-5">
								<select  class="form-control pp_wise_version_creation" id="pp_number" name="pp_number">
            ...
            <div class="form-group form-group-sm" id="form-group_for_style_name">
                        ...
                        <div class="col-sm-5">
                           <input type="text" class="form-control" id="style_name" name="style_name" value="<?php echo $row_for_pp_wise_version_info['style_name'];?>" required>
                        </div>
						...
						<div class="form-group form-group-sm" id="form-group_for_greige_width_in_inch">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="greige_width_in_inch" name="greige_width_in_inch" value="<?php echo $row_for_pp_wise_version_info['greige_width_in_inch']?>" required>
								</div>
						...
						<div class="form-group form-group-sm" id="form-group_for_finish_width_in_inch">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="finish_width_in_inch" name="finish_width_in_inch" value="<?php echo $row_for_pp_wise_version_info['finish_width_in_inch']?>" required>
								</div>
						...
						<div class="form-group form-group-sm" id="form-group_for_percentage_of_cotton_content">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="percentage_of_cotton_content" name="percentage_of_cotton_content" value="<?php echo $row_for_pp_wise_version_info['percentage_of_cotton_content']?>" required>
								</div>
						...
						<div class="form-group form-group-sm" id="form-group_for_percentage_of_polyester_content">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="percentage_of_polyester_content" name="percentage_of_polyester_content" value="<?php echo $row_for_pp_wise_version_info['percentage_of_polyester_content']?>" required>
								</div>
                      ...
                      <option value="Viscose">Viscose</option>
						...
						<div class="form-group form-group-sm" id="form-group_for_percentage_of_other_fiber_content">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="percentage_of_other_fiber_content" name="percentage_of_other_fiber_content"  value="<?php echo $row_for_pp_wise_version_info['percentage_of_other_fiber_content']?>" required>
								</div>
						...
						<div class="form-group form-group-sm" id="form-group_for_pp_quantity">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="pp_quantity" name="pp_quantity" value="<?php echo $row_for_pp_wise_version_info['pp_quantity']?>"  onclick="calculate_fiber_cotent()" required>
								</div>
            ...
            <div class="form-group form-group-sm" id="form-group_for_remarks">
                ...
                <div class="col-sm-5">
                  <textarea type="text" class="form-control" id="remarks" name="remarks" value="<?php echo $row_for_pp_wise_version_info['remarks']?>" required><?php echo $row_for_pp_wise_version_info['remarks']?></textarea>
                </div>
   ...
   <?php 
    ...
    <tr >
       ...
       <td>
               ...
               <button type="submit" id="edit_pp_info" name="edit_pp_info"  class="btn btn-primary btn-xs" onclick="load_page('process_program/edit_pp_wise_version_creation_info.php?version_id=<?php echo $row['version_id'] ?>')"> Edit </button>
              <span>  </span>
               ...
               <button type="submit" id="add_process_info" name="add_process_info"  class="btn btn-success btn-xs" onclick="load_page('process_program/version_wise_process_info_creation_from_pp.php?row_id=<?php echo $row['row_id'].'?fs?'.$row['pp_number'] ?>')"> Add Process  </button>
                ...
                <button type="submit" id="delete_pp_info" name="delete_pp_info"  class="btn btn-danger btn-xs" onclick="sending_data_for_delete('<?php echo $row['version_id'] ?>')"> Delete </button>
        </td>
       <?php
