...
$select_sql_for_duplicacy="select * from `defining_qc_standard_for_mercerize_process` where `pp_number`='$pp_number' and
...
else if( mysqli_num_rows($result) < 1)
{
	...
	$update_sql_statement="UPDATE `defining_qc_standard_for_mercerize_process` SET
