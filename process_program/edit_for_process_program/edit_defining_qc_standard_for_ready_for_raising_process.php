...
$sql_for_ready_for_raising_process="select * from defining_qc_standard_for_raising_process where `id`='$ready_for_raising_process_id'";
...
<!--
                   ...
                   <form class="form-horizontal" action="" style="margin-top:10px;" name="defining_qc_standard_for_raising_process_form" id="defining_qc_standard_for_raising_process_form">
                        ...
                        <input type="hidden" id="pp_number" name="pp_number" value="<?php echo $row_for_ready_for_raising_process['pp_number']?>" >
                        <input type="hidden" id="version_number" name="version_number" value="<?php echo $row_for_ready_for_raising_process['version_number']?>" >
                        <input type="hidden" id="customer_name" name="customer_name" value="<?php echo $row_for_ready_for_raising_process['customer_name']?>">
                        <input type="hidden" id="customer_id" name="customer_id" value="<?php echo $row_for_ready_for_raising_process['customer_id']?>">
                        <input type="hidden" id="color" name="color" value="<?php echo $row_for_ready_for_raising_process['color']?>" >
                        <input type="hidden" id="finish_width_in_inch" name="finish_width_in_inch"  value="<?php echo $row_for_ready_for_raising_process['finish_width_in_inch']?>">
