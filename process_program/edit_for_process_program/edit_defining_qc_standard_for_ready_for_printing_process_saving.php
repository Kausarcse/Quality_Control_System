...
$select_sql_for_duplicacy="select * from `defining_qc_standard_for_ready_for_printing_process` where 
...
`whiteness_min_value`='$whiteness_min_value' AND `whiteness_max_value`='$whiteness_max_value' AND `bowing_and_skew_tolerance_range_math_operator`='$bowing_and_skew_tolerance_range_math_operator' AND
`bowing_and_skew_tolerance_value`='$bowing_and_skew_tolerance_value' AND `bowing_and_skew_min_value`='$bowing_and_skew_min_value' AND `bowing_and_skew_max_value`='$bowing_and_skew_max_value' AND 
`ph_min_value`='$ph_min_value' AND `ph_max_value`='$ph_max_value'";
...
else
{
	...
	$update_sql_statement="UPDATE `defining_qc_standard_for_ready_for_printing_process` SET
