...
<!--
                          ...
                          <table id="datatable-buttons" class="table table-striped table-bordered">
                           <thead>
                             ...
                             <?php
                                          ...
                                          $sql_for_scouring = "SELECT * FROM `defining_qc_standard_for_scouring_process` WHERE `standard_for_which_process`='$standard_for_which_process' ORDER BY id ASC";
                           ...
                           <tr>
                              ...
                              <td>
							  		...
							  		<button type="submit" id="edit_scouring" name="edit_scouring"  class="btn btn-primary btn-xs" onclick="load_page('process_program/edit_defining_qc_standard_for_scouring_process.php?scouring_id=<?php echo $row['id'] ?>')"> Edit </button>
				...
				<form class="form-horizontal text-center" action="" style="margin-top:10px;" name="defining_qc_standard_for_scouring_process_form" id="defining_qc_standard_for_scouring_process_form">
					...
					<div class="form-group form-group-sm" >
						...
						<input type="hidden" id="pp_number" name="pp_number" value="<?php echo $row_for_scouring_process['pp_number']?>">
                        <input type="hidden" id="version_number" name="version_number" value="<?php echo $row_for_scouring_process['version_number']?>" >
                        <input type="hidden" id="customer_name" name="customer_name" value="<?php echo $row_for_scouring_process['customer_name']?>">
                        <input type="hidden" id="customer_id" name="customer_id" value="<?php echo $row_for_scouring_process['customer_id']?>">
                        <input type="hidden" id="color" name="color" value="<?php echo $row_for_scouring_process['color']?>" >
                        <input type="hidden" id="finish_width_in_inch" name="finish_width_in_inch"  value="<?php echo $row_for_scouring_process['finish_width_in_inch']?>">
