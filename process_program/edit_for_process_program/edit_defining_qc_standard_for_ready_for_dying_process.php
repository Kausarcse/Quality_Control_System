...
*/  document.getElementById('color').value=splitted_version_details[1];
  ...
  document.getElementById('standard_for_which_process').value='Ready For Dyeing'; 
...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
				...
				<div class="panel-heading" style="color:#191970;"><b>Defining Qc Standard For Ready For Dying Process</b></div> <!-- This will create a upper block for FORM (Just Beautification) -->
...
<!--
                          ...
                          <table id="datatable-buttons" class="table table-striped table-bordered">
                           <thead>
                             ...
                             <?php
                                          ...
                                          $sql_for_ready_for_dying = "SELECT * FROM `defining_qc_standard_for_ready_for_dying_process` WHERE `standard_for_which_process`='$standard_for_which_process' ORDER BY id ASC";
                           ...
                           <tr>
							  ...
							  <button type="submit" id="edit_ready_for_dying" name="edit_ready_for_dying"  class="btn btn-primary btn-xs" onclick="load_page('process_program/edit_defining_qc_standard_for_ready_for_dying_process.php?ready_for_dying_id=<?php echo $row['id'] ?>')"> Edit </button>
				...
				<form class="form-horizontal" action="" style="margin-top:10px;" name="defining_qc_standard_for_ready_for_dying_process_form" id="defining_qc_standard_for_ready_for_dying_process_form">
                        ...
                        <input type="hidden" id="pp_number" name="pp_number" value="<?php echo $row_for_ready_for_dying_process['pp_number']?>" >
                        <input type="hidden" id="version_number" name="version_number" value="<?php echo $row_for_ready_for_dying_process['version_number']?>" >
                        <input type="hidden" id="customer_name" name="customer_name" value="<?php echo $row_for_ready_for_dying_process['customer_name']?>">
                        <input type="hidden" id="customer_id" name="customer_id" value="<?php echo $row_for_ready_for_dying_process['customer_id']?>">
                        <input type="hidden" id="color" name="color" value="<?php echo $row_for_ready_for_dying_process['color']?>" >
                        <input type="hidden" id="finish_width_in_inch" name="finish_width_in_inch"  value="<?php echo $row_for_ready_for_dying_process['finish_width_in_inch']?>">
...
<div class="form-group form-group-sm" for="bowing_and_skew" id="div_bowing_and_skew">   
    ...
    <div class="form-group form-group-sm" >
      ...
      <div class="col-sm-3 text-center">
         <label class="control-label"  style="color:#00008B;">Bowing & Skew (ISO 2819)<span id="bowing_and_skew_test_method"></span></label>
      </div>
           ...
           <input type="text" class="form-control" id="ph_max_value" name="ph_max_value" value="<?php echo $row_for_ready_for_dying_process['ph_max_value']?>" required>
						...
						<div class="form-group form-group-sm">
								<div class="col-sm-offset-3 col-sm-5">
									<button type="button" class="btn btn-primary" onClick="sending_data_of_defining_qc_standard_for_ready_for_dying_process_form_for_saving_in_database()">Submit</button>
