...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
                          ...
                          <div class="panel panel-default">
                              <table id="datatable-buttons" class="table table-striped table-bordered">
                                 ...
                                 <?php 
                                                 ...
                                                 $sql_for_sanforizing = "SELECT * FROM `defining_qc_standard_for_sanforizing_process` WHERE `standard_for_which_process`='$standard_for_which_process' ORDER BY id ASC";
                                  ...
                                  <tr>
                                     ...
                                     <td>
                                           ...
                                           <button type="submit" id="edit_sanforizing" name="edit_sanforizing"  class="btn btn-primary btn-xs" onclick="load_page('process_program/edit_defining_qc_standard_for_sanforizing_process.php?sanforizing_id=<?php echo $row['id'] ?>')"> Edit </button>
				...
				<form class="form-horizontal" action="" style="margin-top:10px;" name="defining_qc_standard_for_sanforizing_process_form" id="defining_qc_standard_for_sanforizing_process_form">
                        ...
                        <input type="hidden" id="pp_number" name="pp_number" value="<?php echo $row_for_sanforizing_process['pp_number']?>" >
                        <input type="hidden" id="version_number" name="version_number" value="<?php echo $row_for_sanforizing_process['version_number']?>" >
                        <input type="hidden" id="customer_name" name="customer_name" value="<?php echo $row_for_sanforizing_process['customer_name']?>">
                        <input type="hidden" id="customer_id" name="customer_id" value="<?php echo $row_for_sanforizing_process['customer_id']?>">
                        <input type="hidden" id="color" name="color" value="<?php echo $row_for_sanforizing_process['color']?>" >
                        <input type="hidden" id="finish_width_in_inch" name="finish_width_in_inch"  value="<?php echo $row_for_sanforizing_process['finish_width_in_inch']?>">
...
<div id="div_number_of_threads_per_unit_length">
     ...
     <div class="form-group form-group-sm" for="no_of_threads_in_warp_value">
			...
			<div class="col-sm-3 text-center">
                 <label class="control-label" for="no_of_threads_in_warp_value" style="color:#00008B;"><span id="for_no_of_threads_in_warp_test_name_label">Number of Threads Per Unit Length</span> <span id="no_of_threads_in_warp_test_method">(ISO 7211-2)</span></label>
            </div>
     ...
     <div class="form-group form-group-sm" for="no_of_threads_in_weft_value">
			...
			<div class="col-sm-3 text-center">
                 <label class="control-label" for="no_of_threads_in_weft_value" style="color:#00008B;"><span id="for_no_of_threads_in_weft_test_name_label" style="display: none;">Number of Threads Per Unit Length</span> <span id="no_of_threads_in_weft_test_method" style="display: none;">(ISO 7211-2)</span></label>
            </div>
  ...
  <div id="div_mass_per_unit_area" >
      ...
      <div class="form-group form-group-sm" for="mass_per_unit_per_area_value">
          ...
          <div class="col-sm-1" for="tolerance">
              ...
              <input type="text" class="form-control" id="mass_per_unit_per_area_tolerance_value" name="mass_per_unit_per_area_tolerance_value" onchange="mass_per_unit_per_area_cal()"  value="<?php echo $row_for_sanforizing_process['no_of_threads_in_weft_max_value']?>" required>
...
<div id="div_resistance_to_surface_fuzzing_and_pilling"> 
      ...
      <div class="form-group form-group-sm" for="surface_fuzzing_and_pilling_value">
          ...
          <div class="col-sm-1" for="unit">
          	...
          	RUBS
             <!-- <hr style="color:#FF0000;border-top: 2px dashed #FF0000; margin-top:13px;"/> -->
             <input type="hidden" class="form-control" id="uom_of_surface_fuzzing_and_pilling_value" name="uom_of_surface_fuzzing_and_pilling_value" value="0">
          </div>
 ...
 <div id="div_tensile_properties"> 
      ...
      <div class="form-group form-group-sm" for="tensile_properties_in_warp">
			...
			<div class="col-sm-3 text-center">
                 <label class="control-label" for="tensile_properties_in_warp" style="color:#00008B;"><span id="for_tensile_properties_in_warp_test_name_label">Tensile Properties <span id="tensile_properties_in_warp_test_method"></span>(ISO 13934-1)</label>
            </div>
...
<div id="div_tear_force"> 
     ...
     <!--  <div class="form-group form-group-sm" for="tear_force_in_weft_value">
			...
			<div class="col-sm-3 text-center">
				 <label class="control-label" for="tear_force_in_weft_value" style="color:#00008B;">Tear Force (ISO 13937-2)</label>
			</div>
...
<div id="div_seam_strength" style="display: none">
     ...
     <div class="form-group form-group-sm" for="seam_strength_in_weft_value">
			...
			<div class="col-sm-3 text-center">
                 <label class="control-label" for="seam_strength_in_weft_value" style="color:#00008B;"><span id="for_seam_strength_in_weft_test_name_label" style="display: none;">Seam Strength</span> <span id="seam_strength_in_weft_test_method"></span>(ISO 13935-2)</label>
            </div>
