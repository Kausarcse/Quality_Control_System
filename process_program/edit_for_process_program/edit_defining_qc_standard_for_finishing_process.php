...
$finishing_id=$_GET['finishing_id'];
$sql_for_finishing="select * from defining_qc_standard_for_finishing_process where `id`='$finishing_id'";
...
//For Dimensional Stability To Washing
 ...
 // For div_yarn_count  
                     ...
                     if((splitted_data.includes('3') || splitted_data.includes('74')  || splitted_data.includes('112')) && $('#div_yarn_count').length !== 0 )  
                     {
...
// 53, 100
 ...
 function sending_data_of_defining_qc_standard_for_finishing_process_form_for_saving_in_database()
 {
       ...
       if(validate != false)
	   {
		  	 ...
		  	 $.ajax({
			 		url: 'process_program/edit_defining_qc_standard_for_finishing_process_saving.php',
			 		dataType: 'text',
			 		type: 'post',
			 		contentType: 'application/x-www-form-urlencoded',
...
<div class="col-sm-12 col-md-12 col-lg-12">
                          ...
                          <table id="datatable-buttons" class="table table-striped table-bordered">
                           <thead>
                             ...
                             <?php
                                          ...
                                          $sql_for_finishing = "SELECT * FROM `defining_qc_standard_for_finishing_process` WHERE `standard_for_which_process`='$standard_for_which_process' ORDER BY id ASC";
                           ...
                           <tr>
                             ...
                             <button type="submit" id="delete_finishing" name="delete_finishing"  class="btn btn-danger btn-xs" onclick="load_page('process_program/deleting_finishing_process_standard.php?finishing_id=<?php echo $row['id'] ?>')"> Delete </button>                               </td>
                              <?php
    ...
    <form class="form-horizontal" action="" style="margin-top:10px;" name="defining_qc_standard_for_finishing_process_form" id="defining_qc_standard_for_finishing_process_form">
        ...
        <!--	<label class="control-label col-sm-4" for="pp_number" style="margin-right:0px; color:#00008B;">PP Number:</label>-->
            ...
            <input type="hidden" id="pp_number" name="pp_number" value="<?php echo $row_for_finishing['pp_number']?>" >
            <input type="hidden" id="version_number" name="version_number" value="<?php echo $row_for_finishing['version_number']?>" >
            <input type="hidden" id="customer_name" name="customer_name" value="<?php echo $row_for_finishing['customer_name']?>">
            <input type="hidden" id="customer_id" name="customer_id" value="<?php echo $row_for_finishing['customer_id']?>">
            <input type="hidden" id="color" name="color" value="<?php echo $row_for_finishing['color']?>" >
            <input type="hidden" id="finish_width_in_inch" name="finish_width_in_inch"  value="<?php echo $row_for_finishing['finish_width_in_inch']?>">
            <input type="hidden" id="standard_for_which_process" name="standard_for_which_process"  value="<?php echo $row_for_finishing['standard_for_which_process']?>">
     ...
     <div class="form-group form-group-sm">
          ...
          <div class="col-sm-1 text-center">
              <select  class="form-control" id="cf_to_rubbing_dry_tolerance_range_math_operator" name="cf_to_rubbing_dry_tolerance_range_math_operator" style="color:#00008B; margin-top:23px;" onchange="cf_to_rubbing_dry_cal()">
                ...
                <?php
                                      $cf_to_rubbing_dry_tolerance_range_math_operator = $row_for_finishing['cf_to_rubbing_dry_tolerance_range_math_operator'];
          ...
          <div class="col-sm-1" for="tolerance">
            ...
            <input type="text" class="form-control" id="cf_to_rubbing_dry_tolerance_value" name="cf_to_rubbing_dry_tolerance_value" value="<?php echo $row_for_finishing['cf_to_rubbing_dry_tolerance_value']?>" required onchange="cf_to_rubbing_dry_cal()" style="color:#00008B; margin-top:23px;">
          ...
          <div class="col-sm-1 text-center" for="min_value">
          	...
          	<input type="text" class="form-control" id="cf_to_rubbing_dry_min_value" name="cf_to_rubbing_dry_min_value" style="color:#00008B; margin-top:23px;" value="<?php echo $row_for_finishing['cf_to_rubbing_dry_min_value']?>" required>
             
          </div>
		          
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="cf_to_rubbing_dry_max_value" name="cf_to_rubbing_dry_max_value" style="color:#00008B; margin-top:23px;" value="<?php echo $row_for_finishing['cf_to_rubbing_dry_max_value']?>" required>
      ...
      <div class="form-group form-group-sm">
          ...
          <div class="col-sm-1 text-center">
              <select  class="form-control" id="cf_to_rubbing_wet_tolerance_range_math_operator" name="cf_to_rubbing_wet_tolerance_range_math_operator" onchange="cf_to_rubbing_wet_cal()">
                      ...
                      <?php
                                      $cf_to_rubbing_wet_tolerance_range_math_operator = $row_for_finishing['cf_to_rubbing_wet_tolerance_range_math_operator'];
          ...
          <div class="col-sm-1" for="tolerance">
            ...
            <input type="text" class="form-control" id="cf_to_rubbing_wet_tolerance_value" name="cf_to_rubbing_wet_tolerance_value"  value="<?php echo $row_for_finishing['cf_to_rubbing_wet_tolerance_value']?>" onchange="cf_to_rubbing_wet_cal()" required>
          ...
          <div class="col-sm-1 text-center" for="min_value">
          	...
          	<input type="text" class="form-control" id="cf_to_rubbing_wet_min_value" name="cf_to_rubbing_wet_min_value" value="<?php echo $row_for_finishing['cf_to_rubbing_wet_min_value']?>" required>
             
          </div>
		          
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="cf_to_rubbing_wet_max_value" name="cf_to_rubbing_wet_max_value" value="<?php echo $row_for_finishing['cf_to_rubbing_wet_max_value']?>" required>
...
<div id="div_yarn_count">
      ...
      <div class="form-group form-group-sm">
			...
			<div class="col-sm-3 text-center">
	         ...
	         <div class="col-sm-1 text-center">
		            <input type="text" class="form-control" id="warp_yarn_count_value" name="warp_yarn_count_value" value="<?php echo $row_for_finishing['warp_yarn_count_value']?>" onchange="warp_yarn_count_cal()" required>
          ...
          <div class="col-sm-1 text-center">
             <select  class="form-control" id="warp_yarn_count_tolerance_range_math_operator" name="warp_yarn_count_tolerance_range_math_operator" onchange="warp_yarn_count_cal()">
                      ...
                      <?php
                                      $warp_yarn_count_tolerance_range_math_operator = $row_for_finishing['warp_yarn_count_tolerance_range_math_operator'];
          ...
          <div class="col-sm-1" for="tolerance">
             ...
             <input type="text" class="form-control" id="warp_yarn_count_tolerance_value" name="warp_yarn_count_tolerance_value" value="<?php echo $row_for_finishing['warp_yarn_count_tolerance_value']?>" onchange="warp_yarn_count_cal()" required>
          ...
          <div class="col-sm-1" for="unit">
          	<select  class="form-control" id="uom_of_warp_yarn_count_value" name="uom_of_warp_yarn_count_value">
                      ...
                      <?php
                                      $uom_of_warp_yarn_count_value = $row_for_finishing['uom_of_warp_yarn_count_value'];
                                     ?>
                                     <?php 
          ...
          <div class="col-sm-1 text-center" for="min_value">
          	...
          	<input type="text" class="form-control" id="warp_yarn_count_min_value" name="warp_yarn_count_min_value" value="<?php echo $row_for_finishing['warp_yarn_count_min_value']?>"  required>
             
          </div>
		          
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="warp_yarn_count_max_value" name="warp_yarn_count_max_value"  value="<?php echo $row_for_finishing['warp_yarn_count_max_value']?>"  required>
      ...
      <div class="form-group form-group-sm" for="weft_yarn_count">
			...
			<div class="col-sm-3 text-center">
	         ...
	         <div class="col-sm-1 text-center">
		            <input type="text" class="form-control" id="weft_yarn_count_value" name="weft_yarn_count_value" value="<?php echo $row_for_finishing['weft_yarn_count_value']?>" onchange="weft_yarn_count_cal()" required>
          ...
          <div class="col-sm-1 text-center">
             <select  class="form-control" id="weft_yarn_count_tolerance_range_math_operator" name="weft_yarn_count_tolerance_range_math_operator" onchange="weft_yarn_count_cal()">
                      ...
                      <?php
                                      $weft_yarn_count_tolerance_range_math_operator = $row_for_finishing['weft_yarn_count_tolerance_range_math_operator'];
          ...
          <div class="col-sm-1" for="tolerance">
             ...
             <input type="text" class="form-control" id="weft_yarn_count_tolerance_value" name="weft_yarn_count_tolerance_value" value="<?php echo $row_for_finishing['weft_yarn_count_tolerance_value']?>" onchange="weft_yarn_count_cal()" required>
          ...
          <div class="col-sm-1" for="unit">
          	<select  class="form-control" id="uom_of_weft_yarn_count_value" name="uom_of_weft_yarn_count_value">
                      ...
                      <?php
                                      $uom_of_weft_yarn_count_value = $row_for_finishing['uom_of_weft_yarn_count_value'];
                                     ?>
                                     <?php 
          ...
          <div class="col-sm-1 text-center" for="min_value">
          	...
          	<input type="text" class="form-control" id="weft_yarn_count_min_value" name="weft_yarn_count_min_value" value="<?php echo $row_for_finishing['weft_yarn_count_min_value']?>" required>
             
          </div>
		          
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="weft_yarn_count_max_value" name="weft_yarn_count_max_value" value="<?php echo $row_for_finishing['weft_yarn_count_max_value']?>" required>
...
<div id="div_number_of_threads_per_unit_length">
     ...
     <div class="form-group form-group-sm" for="no_of_threads_in_warp_value">
			...
			<div class="col-sm-3 text-center">
	         ...
	         <div class="col-sm-1 text-center">
		            <input type="text" class="form-control" id="no_of_threads_in_warp_value" name="no_of_threads_in_warp_value" value="<?php echo $row_for_finishing['no_of_threads_in_warp_value']?>" onchange="no_of_threads_in_warp_cal_for_finishing()" required>
          ...
          <div class="col-sm-1 text-center">
             <select  class="form-control" id="no_of_threads_in_warp_tolerance_range_math_operator" name="no_of_threads_in_warp_tolerance_range_math_operator" onchange="no_of_threads_in_warp_cal_for_finishing()">
                      ...
                      <?php
                                      $no_of_threads_in_warp_tolerance_range_math_operator = $row_for_finishing['no_of_threads_in_warp_tolerance_range_math_operator'];
                                     ?>
                                     <?php 
          ...
          <div class="col-sm-1" for="tolerance">
             ...
             <input type="text" class="form-control" id="no_of_threads_in_warp_tolerance_value" name="no_of_threads_in_warp_tolerance_value" value="<?php echo $row_for_finishing['no_of_threads_in_warp_tolerance_value']?>" onchange="no_of_threads_in_warp_cal_for_finishing()" required>
          ...
          <div class="col-sm-1" for="unit">
          	<select  class="form-control" id="uom_of_no_of_threads_in_warp_value" name="uom_of_no_of_threads_in_warp_value">
                      ...
                      <?php
                                      $uom_of_no_of_threads_in_warp_value = $row_for_finishing['uom_of_no_of_threads_in_warp_value'];
                                     ?>
                                     <?php 
          ...
          <div class="col-sm-1 text-center" for="min_value">
          	...
          	<input type="text" class="form-control" id="no_of_threads_in_warp_min_value" name="no_of_threads_in_warp_min_value" value="<?php echo $row_for_finishing['no_of_threads_in_warp_min_value']?>" required>
          </div>
		          
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="no_of_threads_in_warp_max_value" name="no_of_threads_in_warp_max_value" value="<?php echo $row_for_finishing['no_of_threads_in_warp_max_value']?>" required>
     ...
     <div class="form-group form-group-sm" for="no_of_threads_in_warp_value">
			...
			<div class="col-sm-3 text-center">
	         ...
	         <div class="col-sm-1 text-center">
		            <input type="text" class="form-control" id="no_of_threads_in_weft_value" name="no_of_threads_in_weft_value"  value="<?php echo $row_for_finishing['no_of_threads_in_weft_value']?>" onchange="no_of_threads_in_weft_cal_for_finishing()" required>
          ...
          <div class="col-sm-1 text-center">
              <select  class="form-control" id="no_of_threads_in_weft_tolerance_range_math_operator" name="no_of_threads_in_weft_tolerance_range_math_operator" onchange="no_of_threads_in_weft_cal_for_finishing()">
                      <option select="selected" value="select">Select No of Threads Count Tolerance Range Math Operator</option>
                      <?php
                                      $no_of_threads_in_weft_tolerance_range_math_operator = $row_for_finishing['no_of_threads_in_weft_tolerance_range_math_operator'];
                                     ?>
                                     <?php 
          ...
          <div class="col-sm-1" for="tolerance">
              ...
              <input type="text" class="form-control" id="no_of_threads_in_weft_tolerance_value" name="no_of_threads_in_weft_tolerance_value"  value="<?php echo $row_for_finishing['no_of_threads_in_weft_tolerance_value']?>" onchange="no_of_threads_in_weft_cal_for_finishing()" required>
          ...
          <div class="col-sm-1" for="unit">
          	 <select  class="form-control" id="uom_of_no_of_threads_in_weft_value" name="uom_of_no_of_threads_in_weft_value" >
                      ...
                      <?php
                                      $uom_of_no_of_threads_in_weft_value = $row_for_finishing['uom_of_no_of_threads_in_weft_value'];
                                     ?>
                                     <?php 
          ...
          <div class="col-sm-1 text-center" for="min_value">
          	...
          	<input type="text" class="form-control" id="no_of_threads_in_weft_min_value" name="no_of_threads_in_weft_min_value"   value="<?php echo $row_for_finishing['no_of_threads_in_weft_min_value']?>" required>
          </div>
		          
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="no_of_threads_in_weft_max_value" name="no_of_threads_in_weft_max_value"  value="<?php echo $row_for_finishing['no_of_threads_in_weft_max_value']?>" required>
...
<div id="div_mass_per_unit_area" >
     ...
     <div class="form-group form-group-sm" for="mass_per_unit_per_area_value">
			...
			<div class="col-sm-3 text-center">
	         ...
	         <div class="col-sm-1 text-center">
		            <input type="text" class="form-control" id="mass_per_unit_per_area_value" name="mass_per_unit_per_area_value" value="<?php echo $row_for_finishing['mass_per_unit_per_area_value']?>" onchange="mass_per_unit_per_area_cal()" required>
		         
		     </div>
		        
		         
          <div class="col-sm-1 text-center">
              <input type="text" class="form-control" id="mass_per_unit_per_area_tolerance_range_math_operator" name="mass_per_unit_per_area_tolerance_range_math_operator" value="<?php echo $row_for_finishing['mass_per_unit_per_area_tolerance_range_math_operator']?>" onchange="mass_per_unit_per_area_cal()" required>
          ...
          <div class="col-sm-1" for="tolerance">
              ...
              <input type="text" class="form-control" id="mass_per_unit_per_area_tolerance_value" name="mass_per_unit_per_area_tolerance_value" onchange="mass_per_unit_per_area_cal()"value="<?php echo $row_for_finishing['mass_per_unit_per_area_tolerance_value']?>" required>
          ...
          <div class="col-sm-1" for="unit">
          	 <select  class="form-control" id="uom_of_mass_per_unit_per_area_value" name="uom_of_mass_per_unit_per_area_value">
                      ...
                      <?php
                                      $uom_of_mass_per_unit_per_area_value = $row_for_finishing['uom_of_mass_per_unit_per_area_value'];
                                     ?>
                                     <?php 
                                          if($uom_of_mass_per_unit_per_area_value=='th/inch')
                                          {
                                       ?>
          ...
          <div class="col-sm-1 text-center" for="min_value">
          	...
          	<input type="text" class="form-control" id="mass_per_unit_per_area_min_value" name="mass_per_unit_per_area_min_value" value="<?php echo $row_for_finishing['mass_per_unit_per_area_min_value']?>" required>
          </div>
		          
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="mass_per_unit_per_area_max_value" name="mass_per_unit_per_area_max_value" value="<?php echo $row_for_finishing['mass_per_unit_per_area_max_value']?>" required>
      ...
      <div class="form-group form-group-sm" for="surface_fuzzing_and_pilling_value">
			...
			<div class="col-sm-3 text-center">
			 ...
			 <div class="col-sm-2 text-center">
               ...
               <?php
                                      $description_or_type_for_surface_fuzzing_and_pilling = $row_for_finishing['description_or_type_for_surface_fuzzing_and_pilling'];
                                     ?>
                                     <?php 
            ...
            <div class="col-sm-1 text-center">
		          <input type="text" class="form-control" id="rubs_for_surface_fuzzing_and_pilling" name="rubs_for_surface_fuzzing_and_pilling" value="<?php echo $row_for_finishing['rubs_for_surface_fuzzing_and_pilling']?>" required>
          ...
          <div class="col-sm-1 text-center">
              <select  class="form-control" id="surface_fuzzing_and_pilling_tolerance_range_math_operator" name="surface_fuzzing_and_pilling_tolerance_range_math_operator" onchange="surface_fuzzing_and_pilling_cal()">
				...
				<?php
                                      $surface_fuzzing_and_pilling_tolerance_range_math_operator = $row_for_finishing['surface_fuzzing_and_pilling_tolerance_range_math_operator'];
          ...
          <div class="col-sm-1" for="tolerance">
              ...
              <select  class="form-control" id="surface_fuzzing_and_pilling_tolerance_value" name="surface_fuzzing_and_pilling_tolerance_value" onchange="surface_fuzzing_and_pilling_cal()">
               ...
               <?php
                                      $surface_fuzzing_and_pilling_tolerance_value = $row_for_finishing['surface_fuzzing_and_pilling_tolerance_value'];
          ...
          <div class="col-sm-1 text-center" for="min_value">
          	...
          	<input type="text" class="form-control" id="surface_fuzzing_and_pilling_min_value" name="surface_fuzzing_and_pilling_min_value" value="<?php echo $row_for_finishing['surface_fuzzing_and_pilling_min_value']?>" required>
          </div>
		          
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="surface_fuzzing_and_pilling_max_value" name="surface_fuzzing_and_pilling_max_value" value="<?php echo $row_for_finishing['surface_fuzzing_and_pilling_max_value']?>" required>
     ...
     <div class="form-group form-group-sm" for="tensile_properties_in_warp">
          ...
          <div class="col-sm-1 text-center">
              <select  class="form-control" id="tensile_properties_in_warp_value_tolerance_range_math_operator" name="tensile_properties_in_warp_value_tolerance_range_math_operator" onchange="tensile_properties_in_warp()">
                      ...
                      <?php
                                      $tensile_properties_in_warp_value_tolerance_range_math_operator = $row_for_finishing['tensile_properties_in_warp_value_tolerance_range_math_operator'];
          ...
          <div class="col-sm-1" for="tolerance">
             ...
             <input type="text" class="form-control" id="tensile_properties_in_warp_value_tolerance_value" name="tensile_properties_in_warp_value_tolerance_value" value="<?php echo $row_for_finishing['tensile_properties_in_warp_value_tolerance_value']?>" onchange="tensile_properties_in_warp()" required>
          </div>
          ...
          <div class="col-sm-1" for="unit">
             <select  class="form-control" id="uom_of_tensile_properties_in_warp_value" name="uom_of_tensile_properties_in_warp_value">
                      ...
                      <?php
                                      $tensile_properties_in_warp_value_tolerance_value = $row_for_finishing['tensile_properties_in_warp_value_tolerance_value'];
                                 
                                          if($tensile_properties_in_warp_value_tolerance_value=='N')
                                          {
                                       ?>
                                      ...
                                      <?php
                                          ...
                                          else if($tensile_properties_in_warp_value_tolerance_value=='kg')
                                          {
                                         ?>
                                       ...
                                       <?php
                                          ...
                                          else if($tensile_properties_in_warp_value_tolerance_value=='lbf')
                                          {
                                         ?>
                                             <option value="N">N</option>
                                             <option value="kg">kg</option>
          ...
          <div class="col-sm-1 text-center" for="min_value">
          	...
          	<input type="text" class="form-control" id="tensile_properties_in_warp_value_min_value" name="tensile_properties_in_warp_value_min_value" value="<?php echo $row_for_finishing['tensile_properties_in_warp_value_min_value']?>" required>
          </div>
		          
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="tensile_properties_in_warp_value_max_value" name="tensile_properties_in_warp_value_max_value" value="<?php echo $row_for_finishing['tensile_properties_in_warp_value_max_value']?>" required>
      ...
      <div class="form-group form-group-sm" for="tensile_properties_in_weft">
          ...
          <div class="col-sm-1 text-center">
              <select  class="form-control" id="tensile_properties_in_weft_value_tolerance_range_math_operator" name="tensile_properties_in_weft_value_tolerance_range_math_operator" onchange="tensile_properties_in_weft()">
                      ...
                      <?php
                                      $tensile_properties_in_weft_value_tolerance_range_math_operator = $row_for_finishing['tensile_properties_in_weft_value_tolerance_range_math_operator'];
          ...
          <div class="col-sm-1" for="tolerance">
             ...
             <input type="text" class="form-control" id="tensile_properties_in_weft_value_tolerance_value" name="tensile_properties_in_weft_value_tolerance_value" value="<?php echo $row_for_finishing['tensile_properties_in_weft_value_tolerance_value']?>" onchange="tensile_properties_in_weft()" required>
          </div>
          ...
          <div class="col-sm-1" for="unit">
             <select  class="form-control" id="uom_of_tensile_properties_in_weft_value" name="uom_of_tensile_properties_in_weft_value">
                      ...
                      <?php
                                      $uom_of_tensile_properties_in_weft_value = $row_for_finishing['uom_of_tensile_properties_in_weft_value'];
          ...
          <div class="col-sm-1 text-center" for="min_value">
          	...
          	<input type="text" class="form-control" id="tensile_properties_in_weft_value_min_value" name="tensile_properties_in_weft_value_min_value" value="<?php echo $row_for_finishing['tensile_properties_in_weft_value_min_value']?>" required>
          </div>
		          
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="tensile_properties_in_weft_value_max_value" name="tensile_properties_in_weft_value_max_value" value="<?php echo $row_for_finishing['tensile_properties_in_weft_value_max_value']?>" required>
      ...
      <div class="form-group form-group-sm" for="tear_force_in_warp_value">
          ...
          <div class="col-sm-1 text-center">
              <select  class="form-control" id="tear_force_in_warp_value_tolerance_range_math_operator" name="tear_force_in_warp_value_tolerance_range_math_operator" onchange="tear_force_in_warp_cal()">
                      ...
                      <?php
                                      $tear_force_in_warp_value_tolerance_range_math_operator = $row_for_finishing['tear_force_in_warp_value_tolerance_range_math_operator'];
          ...
          <div class="col-sm-1" for="tolerance">
             ...
             <input type="text" class="form-control" id="tear_force_in_warp_value_tolerance_value" name="tear_force_in_warp_value_tolerance_value" value="<?php echo $row_for_finishing['tear_force_in_warp_value_tolerance_value']?>" onchange="tear_force_in_warp_cal()" required>
          </div>
          ...
          <div class="col-sm-1" for="unit">
             <select  class="form-control" id="uom_of_tear_force_in_warp_value" name="uom_of_tear_force_in_warp_value">
                      ...
                      <?php
                                      $uom_of_tear_force_in_warp_value = $row_for_finishing['uom_of_tear_force_in_warp_value'];
          ...
          <div class="col-sm-1 text-center" for="min_value">
          	...
          	<input type="text" class="form-control" id="tear_force_in_warp_value_min_value" name="tear_force_in_warp_value_min_value" value="<?php echo $row_for_finishing['tear_force_in_warp_value_min_value']?>" required>
          </div>
		          
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="tear_force_in_warp_value_max_value" name="tear_force_in_warp_value_max_value" value="<?php echo $row_for_finishing['tear_force_in_warp_value_max_value']?>" required>
      ...
      <div class="form-group form-group-sm" for="tear_force_in_weft_value">
          ...
          <div class="col-sm-1 text-center">
              <select  class="form-control" id="tear_force_in_weft_value_tolerance_range_math_operator" name="tear_force_in_weft_value_tolerance_range_math_operator" onchange="tear_force_in_weft_cal()">
                      ...
                      <?php
                                      $tear_force_in_weft_value_tolerance_range_math_operator = $row_for_finishing['tear_force_in_weft_value_tolerance_range_math_operator'];
          ...
          <div class="col-sm-1" for="tolerance">
             ...
             <input type="text" class="form-control" id="tear_force_in_weft_value_tolerance_value" name="tear_force_in_weft_value_tolerance_value" value="<?php echo $row_for_finishing['tear_force_in_weft_value_tolerance_value']?>" onchange="tear_force_in_weft_cal()" required>
          </div>
          ...
          <div class="col-sm-1" for="unit">
             <select  class="form-control" id="uom_of_tear_force_in_weft_value" name="uom_of_tear_force_in_weft_value">
                      ...
                      <?php
                                      $uom_of_tear_force_in_weft_value = $row_for_finishing['uom_of_tear_force_in_weft_value'];
          ...
          <div class="col-sm-1 text-center" for="min_value">
          	...
          	<input type="text" class="form-control" id="tear_force_in_weft_value_min_value" name="tear_force_in_weft_value_min_value" value="<?php echo $row_for_finishing['tear_force_in_weft_value_min_value']?>" required>
          </div>
		          
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="tear_force_in_weft_value_max_value" name="tear_force_in_weft_value_max_value" value="<?php echo $row_for_finishing['tear_force_in_weft_value_max_value']?>" required>
...
<div id="div_seam_slippage" style="display: none">
    ...
    <div class="form-group form-group-sm" for="seam_slippage_resistance_in_warp">
			...
			<div class="col-sm-3 text-center">
				 <label class="control-label" for="seam_slippage_resistance_in_warp" style="color:#00008B;"><span id="for_seam_slippage_resistance_in_warp_test_name_label">Seam Slippage</span> <span id="seam_slippage_resistance_in_warp_test_method">(ISO 13936-1)</span></label>
			</div>
     	 ...
     	 <div class="form-group form-group-sm" for="seam_slippage_resistance_in_weft">
			...
			<div class="col-sm-3 text-center">
				 <label class="control-label" for="seam_slippage_resistance_in_weft" style="color:#00008B;"><span id="for_seam_slippage_resistance_in_weft_test_name_label" style="display: none;">Seam Slippage</span> <span id="seam_slippage_resistance_in_weft_test_method" style="display: none;">(ISO 13936-1)</span></label>
			</div>
     ...
     <div class="form-group form-group-sm" for="seam_slippage_resistance_iso_2_in_warp">
      ...
      <div class="col-sm-3 text-center">
         <label class="control-label" for="seam_slippage_resistance_iso_2_in_warp" style="color:#00008B;"><span id="for_seam_slippage_resistance_iso_2_warp_test_name_label">Seam Slippage</span> <span id="seam_slippage_resistance_iso_2_warp">(ISO 13936-2)</span></label>
      </div>
      ...
      <div class="form-group form-group-sm" for="seam_slippage_resistance_iso_2_in_weft">
	      ...
	      <div class="col-sm-3 text-center">
	         <label class="control-label" for="seam_slippage_resistance_iso_2_in_weft" style="color:#00008B;"><span id="for_seam_slippage_resistance_iso_2_weft_test_name_label" style="display: none;">Seam Slippage</span><span id="seam_slippage_resistance_iso_2_weft_test_method" style="display: none;">(ISO 13936-2)</span></label>
	      </div>
...
<div id="div_seam_strength" style="display: none">
     ...
     <div class="form-group form-group-sm" for="seam_strength_in_weft_value">
			...
			<div class="col-sm-3 text-center">
				 <label class="control-label" for="seam_strength_in_weft_value" style="color:#00008B;"><span id="for_seam_strength_in_weft_test_name_label" style="display: none;">Seam Strength</span> <span id="seam_strength_in_weft_test_method" style="display: none">(ISO 13935-2) </span></label>
			</div>
...
<div id="div_seam_properties" style="display: none">
      ...
      <div class="form-group form-group-sm" for="seam_properties_seam_slippage_iso_astm_d_in_warp">
	      ...
	      <div class="col-sm-3 text-center">
	         <label class="control-label" for="seam_properties_seam_slippage_iso_astm_d_in_warp" style="color:#00008B;"><span id="for_seam_properties_seam_slippage_iso_astm_d_in_warp_test_name_label">Seam Properties</span> <span id="seam_properties_seam_slippage_iso_astm_d_in_warp_test_method"></span>(ASTM D 1683)</label>
	      </div>
     ...
     <div class="form-group form-group-sm" for="seam_properties_seam_slippage_iso_astm_d_in_weft">
	      ...
	      <div class="col-sm-3 text-center">
	         <label class="control-label" for="seam_properties_seam_slippage_iso_astm_d_in_weft" style="color:#00008B;"><span id="for_seam_slippage_iso_astm_d_in_weft_test_name_label" style="display: none;">Seam Properties</span> <span id="seam_slippage_iso_astm_d_in_weft_test_method" style="display: none;">(ASTM D 1683)</span></label>
	      </div>
     ...
     <div class="form-group form-group-sm" for="seam_properties_seam_strength_iso_astm_d_in_warp">
	      ...
	      <div class="col-sm-3 text-center">
	         <label class="control-label" for="seam_properties_seam_strength_iso_astm_d_in_warp" style="color:#00008B;"><span id="for_seam_properties_seam_strength_iso_astm_d_in_warp_test_name_label">Seam Properties</span> <span id="seam_properties_seam_strength_iso_astm_d_in_warp_test_method">(ASTM D 1683)</span></label>
	      </div>
     ...
     <div class="form-group form-group-sm" for="seam_properties_seam_strength_iso_astm_d_in_weft">
	      ...
	      <div class="col-sm-3 text-center">
	         <label class="control-label" for="seam_properties_seam_strength_iso_astm_d_in_weft" style="color:#00008B;"><span id="for_seam_properties_seam_strength_iso_astm_d_in_weft_test_name_label" style="display: none;">Seam Properties <span id="seam_properties_seam_strength_iso_astm_d_in_weft_test_method" style="display: none;">(ASTM D 1683)</span></label>
	      </div>
...
<div id="div_cf_to_perspiration_acid"> 
     ...
     <div class="form-group form-group-sm">
                ...
                <div class="col-sm-1 text-center">
                 ...
                 <div class="col-sm-1 text-center">
                    ...
                    <select  class="form-control" id="cf_to_perspiration_acid_color_change_tolerance_range_math_op" name="cf_to_perspiration_acid_color_change_tolerance_range_math_op" onchange="cf_to_perspiration_acid_color_change_cal()">
                      ...
                      <?php
                                      $cf_to_perspiration_acid_color_change_tolerance_range_math_op = $row_for_finishing['cf_to_perspiration_acid_color_change_tolerance_range_math_op'];
                ...
                <div class="col-sm-1 text-center">
                  <select  class="form-control" id="cf_to_perspiration_acid_color_change_tolerance_value" name="cf_to_perspiration_acid_color_change_tolerance_value" onchange="cf_to_perspiration_acid_color_change_cal()">
                    <option select="selected" value="select">Select Tolerance Value</option>
                    <?php
                                      $cf_to_perspiration_acid_color_change_tolerance_value = $row_for_finishing['cf_to_perspiration_acid_color_change_tolerance_value'];
              ...
              <div class="col-sm-1 text-center" for="min_value">
                   ...
                   <input type="text" class="form-control" id="cf_to_perspiration_acid_color_change_min_value" name="cf_to_perspiration_acid_color_change_min_value" value="<?php echo $row_for_finishing['cf_to_perspiration_acid_color_change_min_value']?>" required>
              ...
              <div class="col-sm-1 text-center">
                  ...
                  <input type="text" class="form-control" id="cf_to_perspiration_acid_color_change_max_value" name="cf_to_perspiration_acid_color_change_max_value" value="<?php echo $row_for_finishing['cf_to_perspiration_acid_color_change_max_value']?>" required>
               </div>
     ...
     <div class="form-group form-group-sm">
                ...
                <div class="col-sm-2 text-center">
                 ...
                 <div class="col-sm-1 text-center">
                   ...
                   <select  class="form-control" id="cf_to_perspiration_acid_staining_tolerance_range_math_operator" name="cf_to_perspiration_acid_staining_tolerance_range_math_operator" onchange="cf_to_perspiration_acid_staining_cal()">
                      ...
                      <?php
                                      $cf_to_perspiration_acid_staining_tolerance_range_math_operator = $row_for_finishing['cf_to_perspiration_acid_staining_tolerance_range_math_operator'];
                ...
                <div class="col-sm-1 text-center">
                     <select  class="form-control" id="cf_to_perspiration_acid_staining_value" name="cf_to_perspiration_acid_staining_value" onchange="cf_to_perspiration_acid_staining_cal()">
                        <option select="selected" value="select">Select Tolerance Value</option>
                        <?php
                                      $cf_to_perspiration_acid_staining_value = $row_for_finishing['cf_to_perspiration_acid_staining_value'];
              ...
              <div class="col-sm-1 text-center" for="min_value">
                    ...
                    <input type="text" class="form-control" id="cf_to_perspiration_acid_staining_min_value" name="cf_to_perspiration_acid_staining_min_value" value="<?php echo $row_for_finishing['cf_to_perspiration_acid_staining_min_value']?>" required>
              ...
              <div class="col-sm-1 text-center">
                   ...
                   <input type="text" class="form-control" id="cf_to_perspiration_acid_staining_max_value" name="cf_to_perspiration_acid_staining_max_value" value="<?php echo $row_for_finishing['cf_to_perspiration_acid_staining_max_value']?>" required>
               </div>
     ...
     <div class="form-group form-group-sm">
                ...
                <div class="col-sm-2 text-center">
                 ...
                 <div class="col-sm-1 text-center">
                   ...
                   <select  class="form-control" id="cf_to_perspiration_acid_cross_staining_tolerance_range_math_op" name="cf_to_perspiration_acid_cross_staining_tolerance_range_math_op" onchange="cf_to_perspiration_acid_cross_staining_cal()">
                      ...
                      <?php
                                      $cf_to_perspiration_acid_cross_staining_tolerance_range_math_op = $row_for_finishing['cf_to_perspiration_acid_cross_staining_tolerance_range_math_op'];
                ...
                <div class="col-sm-1 text-center">
                     <select  class="form-control" id="cf_to_perspiration_acid_cross_staining_tolerance_value" name="cf_to_perspiration_acid_cross_staining_tolerance_value" onchange="cf_to_perspiration_acid_cross_staining_cal()">
                        <option select="selected" value="select">Select Tolerance Value</option>
                        <?php
                                      $cf_to_perspiration_acid_cross_staining_tolerance_value = $row_for_finishing['cf_to_perspiration_acid_cross_staining_tolerance_value'];
              ...
              <div class="col-sm-1 text-center" for="min_value">
                    ...
                    <input type="text" class="form-control" id="cf_to_perspiration_acid_cross_staining_min_value" name="cf_to_perspiration_acid_cross_staining_min_value" value="<?php echo $row_for_finishing['cf_to_perspiration_acid_cross_staining_min_value']?>" required>
              ...
              <div class="col-sm-1 text-center">
                   ...
                   <input type="text" class="form-control" id="cf_to_perspiration_acid_cross_staining_max_value" name="cf_to_perspiration_acid_cross_staining_max_value" value="<?php echo $row_for_finishing['cf_to_perspiration_acid_cross_staining_max_value']?>" required>
               </div>
...
<div id="div_cf_to_perspiration_alkali"> 	
     ...
     <div class="form-group form-group-sm">
                ...
                <div class="col-sm-1 text-center">
                 ...
                 <div class="col-sm-1 text-center">
                   ...
                   <select  class="form-control" id="cf_to_perspiration_alkali_color_change_tolerance_range_math_op" name="cf_to_perspiration_alkali_color_change_tolerance_range_math_op" onchange="cf_to_perspiration_alkali_color_change_cal()">
                      ...
                      <?php
                                      $cf_to_perspiration_alkali_color_change_tolerance_range_math_op = $row_for_finishing['cf_to_perspiration_alkali_color_change_tolerance_range_math_op'];
                ...
                <div class="col-sm-1 text-center">
                      <select  class="form-control" id="cf_to_perspiration_alkali_color_change_tolerance_value" name="cf_to_perspiration_alkali_color_change_tolerance_value" onchange="cf_to_perspiration_alkali_color_change_cal()">
                            <option select="selected" value="select">Select Tolerance Value</option>
                            <?php
                                      $cf_to_perspiration_alkali_color_change_tolerance_value = $row_for_finishing['cf_to_perspiration_alkali_color_change_tolerance_value'];
              ...
              <div class="col-sm-1 text-center" for="min_value">
                  ...
                  <input type="text" class="form-control" id="cf_to_perspiration_alkali_color_change_min_value" name="cf_to_perspiration_alkali_color_change_min_value" value="<?php echo $row_for_finishing['cf_to_perspiration_alkali_color_change_min_value']?>" required>
              ...
              <div class="col-sm-1 text-center">
                  ...
                  <input type="text" class="form-control" id="cf_to_perspiration_alkali_color_change_max_value" name="cf_to_perspiration_alkali_color_change_max_value" value="<?php echo $row_for_finishing['cf_to_perspiration_alkali_color_change_max_value']?>" required>
              </div>
     ...
     <div class="form-group form-group-sm">
                ...
                <div class="col-sm-1 text-center">
                 ...
                 <div class="col-sm-1 text-center">
                   ...
                   <select  class="form-control" id="cf_to_perspiration_alkali_staining_tolerance_range_math_op" name="cf_to_perspiration_alkali_staining_tolerance_range_math_op" onchange="cf_to_perspiration_alkali_staining_cal()">
                      <option select="selected" value="select">Select CF To Perspiration Alkali Color Change Range Math Operator</option>
                      <?php
                                      $cf_to_perspiration_alkali_staining_tolerance_range_math_op = $row_for_finishing['cf_to_perspiration_alkali_staining_tolerance_range_math_op'];
                ...
                <div class="col-sm-1 text-center">
                      <select  class="form-control" id="cf_to_perspiration_alkali_staining_tolerance_value" name="cf_to_perspiration_alkali_staining_tolerance_value" onchange="cf_to_perspiration_alkali_staining_cal()">
                            <option select="selected" value="select">Select Tolerance Value</option>
                            <?php
                                      $cf_to_perspiration_alkali_staining_tolerance_value = $row_for_finishing['cf_to_perspiration_alkali_staining_tolerance_value'];
              ...
              <div class="col-sm-1 text-center" for="min_value">
                  ...
                  <input type="text" class="form-control" id="cf_to_perspiration_alkali_staining_min_value" name="cf_to_perspiration_alkali_staining_min_value" value="<?php echo $row_for_finishing['cf_to_perspiration_alkali_staining_min_value']?>" required>
              ...
              <div class="col-sm-1 text-center">
                  ...
                  <input type="text" class="form-control" id="cf_to_perspiration_alkali_staining_max_value" name="cf_to_perspiration_alkali_staining_max_value" value="<?php echo $row_for_finishing['cf_to_perspiration_alkali_staining_max_value']?>" required>
              </div>
     ...
     <div class="form-group form-group-sm">
                ...
                <div class="col-sm-2 text-center">
                 ...
                 <div class="col-sm-1 text-center">
                   ...
                   <select  class="form-control" id="cf_to_perspiration_alkali_cross_staining_tolerance_range_math_op" name="cf_to_perspiration_alkali_cross_staining_tolerance_range_math_op" onchange="cf_to_perspiration_alkali_cross_staining_cal()">
                      <option select="selected" value="select">Select CF To Perspiration Alkali Color Change Range Math Operator</option>
                      <?php
                                      $cf_to_perspiration_alkali_cross_staining_tolerance_range_math_op = $row_for_finishing['cf_to_perspiration_alkali_cross_staining_tolerance_range_math_op'];
                ...
                <div class="col-sm-1 text-center">
                      <select  class="form-control" id="cf_to_perspiration_alkali_cross_staining_tolerance_value" name="cf_to_perspiration_alkali_cross_staining_tolerance_value" onchange="cf_to_perspiration_alkali_cross_staining_cal()">
                            <option select="selected" value="select">Select Tolerance Value</option>
                            <?php
                                      $cf_to_perspiration_alkali_cross_staining_tolerance_value = $row_for_finishing['cf_to_perspiration_alkali_cross_staining_tolerance_value'];
              ...
              <div class="col-sm-1 text-center" for="min_value">
                  ...
                  <input type="text" class="form-control" id="cf_to_perspiration_alkali_cross_staining_min_value" name="cf_to_perspiration_alkali_cross_staining_min_value" value="<?php echo $row_for_finishing['cf_to_perspiration_alkali_cross_staining_min_value']?>" required>
              ...
              <div class="col-sm-1 text-center">
                  ...
                  <input type="text" class="form-control" id="cf_to_perspiration_alkali_cross_staining_max_value" name="cf_to_perspiration_alkali_cross_staining_max_value" value="<?php echo $row_for_finishing['cf_to_perspiration_alkali_cross_staining_max_value']?>" required>
              </div>
...
<div class="form-group form-group-sm" id="div_cf_to_peroxide_bleach" style="display: none">
 ...
 <div class="form-group form-group-sm" id="div_formaldehyde_content" >
                ...
                <div class="col-sm-1 text-center">
                 ...
                 <div class="col-sm-1 text-center">
                    ...
                    <select  class="form-control" id="formaldehyde_content_tolerance_range_math_operator" name="formaldehyde_content_tolerance_range_math_operator" onchange="formaldehyde_content_Cal()">
                      ...
                      <?php
                                      $formaldehyde_content_tolerance_range_math_operator = $row_for_finishing['formaldehyde_content_tolerance_range_math_operator'];
                ...
                <div class="col-sm-1 text-center">
                      <input type="text" class="form-control" id="formaldehyde_content_tolerance_value" name="formaldehyde_content_tolerance_value" value="<?php echo $row_for_finishing['formaldehyde_content_tolerance_value']?>" onchange="formaldehyde_content_Cal()" required>
                </div>
              ...
              <div class="col-sm-1" for="unit">
                 ...
                 <select  class="form-control" id="uom_of_formaldehyde_content" name="uom_of_formaldehyde_content">
                      ...
                      <?php
                                      $uom_of_formaldehyde_content = $row_for_finishing['uom_of_formaldehyde_content'];
              ...
              <div class="col-sm-1 text-center" for="min_value">
                  <input type="text" class="form-control" id="formaldehyde_content_min_value" name="formaldehyde_content_min_value" value="<?php echo $row_for_finishing['formaldehyde_content_min_value']?>" required>
                 
              </div>
                  
              <div class="col-sm-1 text-center">
                   <input type="text" class="form-control" id="formaldehyde_content_max_value" name="formaldehyde_content_max_value" value="<?php echo $row_for_finishing['formaldehyde_content_max_value']?>" required>
              </div>
...
<div class="form-group form-group-sm" id="div_ph">
 ...
 -->
              ...
              <div class="col-sm-1 text-center" for="min_value">
                  <input type="text" class="form-control" id="ph_value_min_value" name="ph_value_min_value" value="<?php echo $row_for_finishing['ph_value_min_value']?>" required>
                 
              </div>
                  
              <div class="col-sm-1 text-center">
                  <input type="text" class="form-control" id="ph_value_max_value" name="ph_value_max_value" value="<?php echo $row_for_finishing['ph_value_max_value']?>" required>
              </div>
...
<span id="for_water_absorption_test_name_label"> Water Absorption</span> <span id="water_absorption_test_method"> (ISO 9073-12) </span>
 ...
 -->
    ...
    <div class="form-group form-group-sm" id="div_spirality" style="display: none">
     ...
     <div class="form-group form-group-sm" id="div_cf_to_artificial_day_light">
            ...
            <div class="col-sm-2 text-center">
             ...
             <div class="col-sm-1 text-center">
                    <select  class="form-control" id="color_fastess_to_artificial_daylight_blue_wool_scale" name="color_fastess_to_artificial_daylight_blue_wool_scale" onchange="color_fastess_to_artificial_daylight_blue_wool_scale_cal()">
                      ...
                      <?php
                                      $color_fastess_to_artificial_daylight_blue_wool_scale = $row_for_finishing['color_fastess_to_artificial_daylight_blue_wool_scale'];
                                 
                                          if($color_fastess_to_artificial_daylight_blue_wool_scale=='Normal')
                                          {
                                       ?>
                                      ...
                                      <?php
                                          ...
                                          else if($color_fastess_to_artificial_daylight_blue_wool_scale=='AFU')
                                          {
                                         ?>
                                            <option value="Normal">1</option>
                                             ...
                                             <option value="AFU" selected> 5 AFU </option>
                                             <option value="AFU"> 10 AFU </option>
                                             <option value="AFU"> 20 AFU </option>
                                             <option value="AFU"> 40 AFU </option>
                                       <?php
                                          ...
                                          else
                                          {
                                             ?>
                                                <option value="Normal">1</option>
                                                 ...
                                                 <option value="AFU"> 10 AFU </option>
                                                 <option value="AFU"> 20 AFU </option>
                                                 <option value="AFU" selected> 40 AFU </option>
                                           <?php
                                              }
                                       ?>
                </select>
             ...
             <div class="col-sm-1 text-center">
                 ...
                 <select  class="form-control" id="color_fastess_to_artificial_daylight_tolerance_range_math_op" name="color_fastess_to_artificial_daylight_tolerance_range_math_op" onchange="color_fastess_to_artificial_daylight_cal()">
                      ...
                      <?php
                                      $color_fastess_to_artificial_daylight_tolerance_range_math_op = $row_for_finishing['color_fastess_to_artificial_daylight_tolerance_range_math_op'];
              ...
              <div class="col-sm-1 text-center n" >
                  <select  class="form-control normal" id="color_fastess_to_artificial_daylight_tolerance_value" name="color_fastess_to_artificial_daylight_tolerance_value" onchange="color_fastess_to_artificial_daylight_cal()" style="display: block">
                      ...
                      <?php
                                      $color_fastess_to_artificial_daylight_tolerance_value = $row_for_finishing['color_fastess_to_artificial_daylight_tolerance_value'];
                                 
                                          if($color_fastess_to_artificial_daylight_tolerance_value=='1.0')
                                          {
                                       ?>
                                      ...
                                      <?php
                                          ...
                                          else if($color_fastess_to_artificial_daylight_tolerance_value=='1.5')
                                          {
                                         ?>
                                            <option value="1.0">1</option>
                                             <option value="1.5" selected>1-2</option>
                                       ...
                                       <?php
                                          ...
                                          else if($color_fastess_to_artificial_daylight_tolerance_value=='2.0')
                                          {
                                         ?>
                                            <option value="1.0">1</option>
                                             <option value="1.5">1-2</option>
                                       ...
                                       <?php
                                          ...
                                          else if($color_fastess_to_artificial_daylight_tolerance_value=='2.5')
                                          {
                                         ?>
                                            <option value="1.0" >1</option>
                                             <option value="1.5">1-2</option>
                                       ...
                                       <?php
                                          ...
                                          else if($color_fastess_to_artificial_daylight_tolerance_value=='3.0')
                                          {
                                         ?>
                                            <option value="1.0" >1</option>
                                             <option value="1.5">1-2</option>
                                       ...
                                       <?php
                                          ...
                                          else if($color_fastess_to_artificial_daylight_tolerance_value=='3.5')
                                          {
                                         ?>
                                             <option value="1.0" >1</option>
                                             <option value="1.5">1-2</option>
                                       ...
                                       <?php
                                          ...
                                          else if($color_fastess_to_artificial_daylight_tolerance_value=='4.0')
                                          {
                                         ?>
                                           <option value="1.0" >1</option>
                                             <option value="1.5">1-2</option>
                                       ...
                                       <?php
                                          ...
                                          else if($color_fastess_to_artificial_daylight_tolerance_value=='4.5')
                                          {
                                         ?>
                                            <option value="1.0" >1</option>
                                             <option value="1.5">1-2</option>
                                       ...
                                       <?php
                                          ...
                                          else if($color_fastess_to_artificial_daylight_tolerance_value=='5.0')
                                          {
                                         ?>
                                            <option value="1.0" >1</option>
                                             <option value="1.5">1-2</option>
                                       ...
                                       <?php
                                          ...
                                          else if($color_fastess_to_artificial_daylight_tolerance_value=='5.5')
                                          {
                                         ?>
                                            <option value="1.0" >1</option>
                                             <option value="1.5">1-2</option>
                                             ...
                                             <option value="4.5" > 4-5 </option>
                                             <option value="5.0"> 5 </option>
                                             <option value="5.5" selected> 5-6 </option>
                                             <option value="6"> 6 </option>
                                             <option value="6.5"> 6-7 </option>
                                             <option value="7"> 7 </option>
                                             <option value="7.5"> 7-8 </option>
                                       ...
                                       <?php
                                          ...
                                          else if($color_fastess_to_artificial_daylight_tolerance_value=='6.0')
                                          {
                                         ?>
                                            <option value="1.0" >1</option>
                                             <option value="1.5">1-2</option>
                                       ...
                                       <?php
                                          ...
                                          else if($color_fastess_to_artificial_daylight_tolerance_value=='6.5')
                                          {
                                         ?>
                                            <option value="1.0" >1</option>
                                             <option value="1.5">1-2</option>
                                             ...
                                             <option value="5.5"> 5-6 </option>
                                             <option value="6"> 6 </option>
                                             <option value="6.5" selected> 6-7 </option>
                                             <option value="7"> 7 </option>
                                             <option value="7.5"> 7-8 </option>
                                             <option value="8"> 8 </option>
                                       <?php
                                          }
                                          else if($color_fastess_to_artificial_daylight_tolerance_value=='7.0')
                                          {
                                         ?>
                                            <option value="1.0" >1</option>
                                             <option value="1.5">1-2</option>
                                       ...
                                       <?php
                                          ...
                                          else if($color_fastess_to_artificial_daylight_tolerance_value=='7.5')
                                          {
                                         ?>
                                            <option value="1.0" >1</option>
                                             <option value="1.5">1-2</option>
                                             ...
                                             <option value="6.5"> 6-7 </option>
                                             <option value="7"> 7 </option>
                                             <option value="7.5" selected> 7-8 </option>
                                             <option value="8"> 8 </option>
                                       <?php
                                          }
                                          else 
              ...
              <div class="col-sm-1 text-center" for="min_value">
                   ...
                   <input type="text" class="form-control" id="color_fastess_to_artificial_daylight_min_value" name="color_fastess_to_artificial_daylight_min_value" value="<?php echo $row_for_finishing['color_fastess_to_artificial_daylight_min_value']?>" required>
                 
              </div>
                  
              <div class="col-sm-1 text-center">
                  
                  <input type="text" class="form-control" id="color_fastess_to_artificial_daylight_max_value" name="color_fastess_to_artificial_daylight_max_value" value="<?php echo $row_for_finishing['color_fastess_to_artificial_daylight_max_value']?>" required>
...
</div>   <!-- End of <div class="full_page_load" id="full_page_load" style="visibility: none;"> -->  
