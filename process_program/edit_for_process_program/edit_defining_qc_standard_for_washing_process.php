...
<!--
                          ...
                          <table id="datatable-buttons" class="table table-striped table-bordered">
                           <thead>
                             ...
                             <?php
                                          ...
                                          $sql_for_washing = "SELECT * FROM `defining_qc_standard_for_washing_process` WHERE `standard_for_which_process`='$standard_for_which_process' ORDER BY id ASC";
				...
				<form class="form-horizontal" action="" style="margin-top:10px;" name="defining_qc_standard_for_washing_process_form" id="defining_qc_standard_for_washing_process_form">
                        ...
                        <input type="hidden" id="pp_number" name="pp_number" value="<?php echo $row_for_washing_process['pp_number']?>" >
                        <input type="hidden" id="version_number" name="version_number" value="<?php echo $row_for_washing_process['version_number']?>" >
                        <input type="hidden" id="customer_name" name="customer_name" value="<?php echo $row_for_washing_process['customer_name']?>">
                        <input type="hidden" id="customer_id" name="customer_id" value="<?php echo $row_for_washing_process['customer_id']?>">
                        <input type="hidden" id="color" name="color" value="<?php echo $row_for_washing_process['color']?>" >
                        <input type="hidden" id="finish_width_in_inch" name="finish_width_in_inch"  value="<?php echo $row_for_washing_process['finish_width_in_inch']?>">
...
<div id="div_color_fastness_to_washing">
...
<div id="div_cf_to_oxidative_bleach_damage" style="display: none">
    ...
    <div id="div_cf_to_phenolic_yellowing" style="display: none">
	   ...
	   <div class="form-group form-group-sm">
	            ...
	            <div class="col-sm-3 text-center">
                   <label class="control-label" for="test_name_and_method" style="color:#00008B;"> <span id="cf_to_pvc_migration_staining_test_name_label" style="display: none;">Migration of Color into PVC</span> <span id="cf_to_pvc_migration_staining_test_method">(ISO 105 X 10)</span>
                   </label>
                </div>
