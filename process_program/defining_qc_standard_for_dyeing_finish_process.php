...
<script type='text/javascript' src='process_program/defining_qc_standard_for_dyeing_finish_process_form_validation.js'></script>
...
<script>
    ...
    function sending_data_of_defining_qc_standard_for_dyeing_finish_process_form_for_saving_in_database()
    {
        var validate = Dyeing_Finish_Form_Validation();
        var url_encoded_form_data = $("#defining_qc_standard_for_dyeing_finish_process_form").serialize(); //This will read all control elements value of the form	
        
        if(validate != false)
        {
            $.ajax({
                url: 'process_program/defining_qc_standard_for_dyeing_finish_process_saving.php',
                dataType: 'text',
                type: 'post',
                contentType: 'application/x-www-form-urlencoded',
    ...
    function delete_dyeing_finish_process(dyeing_finish_id)
    {
        var value_for_data= 'dyeing_finish_id='+dyeing_finish_id;
        
        $.ajax({
                url: 'process_program/deleting_dyeing_finish_process_standard.php',
                dataType: 'text',
                type: 'post',
                contentType: 'application/x-www-form-urlencoded',
                data: value_for_data,
...
<div class="col-sm-12 col-md-12 col-lg-12">
    ...
    <div class="panel panel-default" id="full_panel_div"> 

      <?php 
			if ($model_standard == 'model_standard') 
			{
				?>
				<div class="panel-heading" style="color:#191970;"><b>Model For Dyeing-Finish Process</b></div> 
				...
				<div id='search_form_collpapsible_div_1' class="collapse in"> 
					...
					<form class="form-horizontal" action="" style="margin-top:10px;" name="defining_qc_standard_for_dyeing_finish_process_form_view" id="defining_qc_standard_for_dyeing_finish_process_form_view" data-toggle="collapse" data-target="#search_form_collpapsible_div">
						<div class="panel panel-default">
							<table id="datatable-buttons" class="table table-striped table-bordered">
								...
								<tbody>
									<?php
									$s1 = 1;
									$standard_for_which_process='Dyeing-Finish';
									$sql_for_dyeing_finish = "SELECT * FROM `model_defining_qc_standard_for_dyeing_finish_process` 
									...
									$res_for_dyeing_finish = mysqli_query($con, $sql_for_dyeing_finish);

									while ($row = mysqli_fetch_assoc($res_for_dyeing_finish))
									{
										...
										<tr>
											...
											<button type="submit" id="edit_model_dyeing_finish" name="edit_model_dyeing_finish"  class="btn btn-info btn-xs" onclick="load_page('auto_sync/edit_model_defining_qc_standard_for_dyeing_finish_process.php?model_dyeing_finish_id=<?php echo $row['id'] ?>')"> Edit </button>
			...
			{ 
				?>
                <div class="panel-heading" style="color:#191970;"><b>Defining Qc Standard For Dyeing-Finish Process</b></div> 

                    <div class="row" data-toggle="collapse" data-target="#search_form_collpapsible_div_1" onClick="change_up_down_arrow_icon_1(this.childNodes[5].childNodes[1].id)">
                        <div align="right" style="padding-right:13px; text-align:center" id='test'> 
                            <i class="glyphicon glyphicon-chevron-up text-right"  id='panel_heading_icon_1'></i>
                        </div>
                    </div>  
                        ...
                        <form class="form-horizontal" action="" style="margin-top:10px;" name="defining_qc_standard_for_dyeing_finish_process_form_view" id="defining_qc_standard_for_dyeing_finish_process_form_view" data-toggle="collapse" data-target="#search_form_collpapsible_div">
                            ...
                            <div class="panel panel-default">
                                ...
                                <tbody>
                                    ...
                                    $sql_for_dyeing_finish = "SELECT * FROM `defining_qc_standard_for_dyeing_finish_process` 
                                                                WHERE `standard_for_which_process`='$standard_for_which_process' 
                                    ...
                                    while ($row = mysqli_fetch_assoc($res_for_dyeing_finish))
                                    {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" id="edit_dyeing_finish" name="edit_dyeing_finish"  class="btn btn-primary btn-xs" onclick="load_page('process_program/edit_defining_qc_standard_for_dyeing_finish_process.php?dyeing_finish_id=<?php echo $row['id'] ?>')"> Edit </button>
                                                ...
                                                <?php 
                                                    ...
                                                    $sql_for_pp_wise_version ="SELECT * FROM `partial_test_for_test_result_info` 
                                                    ...
                                                    {
                                                    ?>
                                                        <button type="button" id="delete_dyeing_finish" name="delete_dyeing_finish"  class="btn btn-danger btn-xs" onclick="delete_dyeing_finish_process(<?php echo $row['id'];?>)" > Delete </button>
                                                    <?php
                                                    } 
                                                ?>
                                                <!-- <button type="submit" id="delete_dyeing_finish" name="delete_dyeing_finish"  class="btn btn-danger btn-xs" onclick="load_page('process_program/deleting_dyeing_finish_process_standard.php?dyeing_finish_id=<?php echo $row['id'] ?>')"> Delete </button> -->
                                            </td>
                                        </tr>
                                        <?php
                                        $s1++;
            ...
            ?>
			<form class="form-horizontal" action="" style="margin-top:10px;" name="defining_qc_standard_for_dyeing_finish_process_form" id="defining_qc_standard_for_dyeing_finish_process_form">
            ...
            <?php
                if (isset($_GET['model_standard'])) 
                {
                    ...
                    <input type="hidden" id="process_id" name="process_id"  value="proc_23">
        ...
        <div class="full_page_load" id="full_page_load" style="display :none">
	        ...
	        <div class="form-group form-group-sm">
                ...
                <div class="col-sm-1">
                    <label for="max_value" style="font-size:12px; color:#008000;">Maximum</label>
                                        ...
                                        <!-- Start Color Fastness to Rubbing [Dry] -->
            ...
            <div id="div_cf_to_rubbing" style="display: none;">
                ...
                <div class="form-group form-group-sm">     
                    ...
                    <div class="col-sm-3 text-center">
                        <label class="control-label" for="cf_to_rubbing_dry_value" style="color:#00008B; margin-top:23px;">
                            <span id="for_cf_to_rubbing_dry_test_name_label">Color Fastness to Rubbing</span> 
                            <span id="cf_to_rubbing_dry_test_method">(ISO 105 X12)</span>
                        </label>
                    </div>
                ...
                <div class="form-group form-group-sm">
                    ...
                    <div class="col-sm-3 text-center">
                        <label class="hidden" for="cf_to_rubbing_dry_value" style="color:#00008B;">
                            <span id="for_cf_to_rubbing_wet_test_name_label" style="display: none;">Color Fastness to Rubbing </span>
                            <span id="cf_to_rubbing_wet_test_method" style="display: none;">(ISO 105 X12)</span>
                        </label>
                    </div>
            ...
            <div id="div_dimensional_stability_to_washing" style="display: none">
     	        ...
     	        <div class="form-group form-group-sm">
                    ...
                    <div class="col-sm-3 text-center">
                        <label class="control-label" for="dimensional_stability_to_warp_washing_before_iron" style="color:#00008B; margin-top:35px;">
                            <span id="for_dimensional_stability_to_warp_washing_before_iron_test_name_label">Dimensional Stability to Washing</span>
                ...
                <div class="form-group form-group-sm">
                    ...
                    <div class="col-sm-3 text-center">
                        <label class="hidden" for="dimensional_stability_to_weft_washing_before_iron" style="color:#00008B;">
                            <span id="for_dimensional_stability_to_weft_washing_before_iron_test_name_label" style="display: none;">Dimensional Stability to Washing </span>
                ...
                <div class="form-group form-group-sm">
                    ...
                    <div class="col-sm-3 text-center">
                        <label class="hidden" for="dimensional_stability_to_warp_washing_after_iron" style="color:#00008B;">
                            <span id="for_dimensional_stability_to_warp_washing_after_iron_test_name_label">Dimensional Stability to Washing</span>
                ...
                <div class="form-group form-group-sm">
                    ...
                    <div class="col-sm-3 text-center">
                        <label class="hidden" for="dimensional_stability_to_weft_washing_after_iron" style="color:#00008B;">
                            <span id="for_dimensional_stability_to_weft_washing_after_iron_test_name_label" style="display: none;">Dimensional Stability to Washing</span>
        ...
        <div id="div_yarn_count" style="display: none">
			...
			<div class="col-sm-3 text-center">
				 <label class="control-label" for="warp_yarn_count_value" style="color:#00008B;">
                    <span id="for_warp_yarn_count_test_name_label">Yarn Count</span> 
                    <span id="warp_yarn_count_test_method">(ISO 7211-5)</span>
                </label>
			</div>
        ...
        <div class="form-group form-group-sm" for="weft_yarn_count">
			...
			<div class="col-sm-3 text-center">
				 <label class="hidden" for="weft_yarn_count_value" style="color:#00008B;">
                    <span id="for_weft_yarn_count_test_name_label" style="display: none;">Yarn Count</span>
                    <span id="weft_yarn_count_test_method" style="display: none;">(ISO 7211-5)</span>
                </label>
			</div>
    ...
    <div id="div_number_of_threads_per_unit_length" style="display: none">
        ...
        <div class="form-group form-group-sm" for="no_of_threads_in_warp_value">
			...
			<div class="col-sm-3 text-center">
				 <label class="control-label" for="weft_yarn_count_value" style="color:#00008B;">
                    <span id="for_no_of_threads_in_warp_test_name_label">Number of Threads Per Unit Length</span> 
                    <span id="no_of_threads_in_warp_test_method">(ISO 7211-2)</span>
                </label>
			</div>
        ...
        <div class="form-group form-group-sm" for="no_of_threads_in_warp_value">
			...
			<div class="col-sm-3 text-center">
				 <label class="control-label" for="weft_yarn_count_value" style="color:#00008B;">
                    <span id="for_no_of_threads_in_weft_test_name_label" style="display: none;">Number of Threads Per Unit Length</span> 
                    <span id="no_of_threads_in_weft_test_method" style="display: none;">(ISO 7211-2)</span>
                </label>
			</div>
    ...
    <div id="div_mass_per_unit_area" style="display: none">
        ...
        <div class="form-group form-group-sm" for="mass_per_unit_per_area_value">
			...
			<div class="col-sm-3 text-center">
				 <label class="control-label" for="mass_per_unit_per_area_value" style="color:#00008B;">
                    <span id="for_mass_per_unit_per_area_test_name_label">Mass Per Unit Area</span> 
                    <span id="mass_per_unit_per_area_test_method">(ISO 3801)</span>
                </label>
			</div>
    ...
    <div id="div_resistance_to_surface_fuzzing_and_pilling" style="display: none"> 
        ...
        <div class="form-group form-group-sm" for="surface_fuzzing_and_pilling_value">
			...
			<div class="col-sm-3 text-center">
				 <label class="control-label" for="surface_fuzzing_and_pilling_tolerance_range_math_operator" style="color:#00008B;">
                    <span id="for_surface_fuzzing_and_pilling_test_name_label">Resistance to Surface Fuzzing & Pilling</span>
                    <span id="surface_fuzzing_and_pilling_test_method">(ISO 12945-2)</span>
                </label>
			</div>
        ...
        <div id="div_tensile_properties" style="display: none"> 
            ...
            <div class="form-group form-group-sm" for="tensile_properties_in_warp">
                ...
                <div class="col-sm-3 text-center">
                    <label class="control-label" for="tensile_properties_in_warp" style="color:#00008B;">
                        <span id="for_tensile_properties_in_warp_test_name_label">Tensile Properties </span>
                        <span id="tensile_properties_in_warp_test_method">(ISO 13934-1)</span>
                    </label>
                </div>
        ...
        <div class="form-group form-group-sm" for="tensile_properties_in_weft">
			...
			<div class="col-sm-3 text-center">
				 <label class="control-label" for="tensile_properties_in_weft" style="color:#00008B;">
                    <span id="for_tensile_properties_in_weft_test_name_label" style="display: none;">Tensile Properties</span>
                    <span id="tensile_properties_in_weft_test_method" style="display: none;">(ISO 13934-1)</span>
                </label>
			</div>
    ...
    <div id="div_tear_force" style="display: none"> 	
      ...
      <div class="form-group form-group-sm" for="tear_force_in_warp_value">
			...
			<div class="col-sm-3 text-center">
				 <label class="control-label" for="tear_force_in_warp_value" style="color:#00008B;">
                    <span id="for_tear_force_in_warp_test_name_label">Tear Force</span>     
                    <span id="tear_force_in_warp_test_method">(ISO 13937-2)</span>
                </label>
			</div>
      ...
      <div class="form-group form-group-sm" for="tear_force_in_weft_value">
			...
			<div class="col-sm-3 text-center">
	         <label class="control-label" for="tear_force_in_weft_value" style="color:#00008B;">
                <span id="for_tear_force_in_weft_test_name_label" style="display: none;">Tear Force</span> 
                <span id="tear_force_in_weft_test_method" style="display: none;">(ISO 13937-2)</span>
            </label>
	        </div>
    ...
    <div id="div_seam_slippage" style="display: none">
        ...
        <div class="form-group form-group-sm" for="seam_slippage_resistance_in_warp">
            ...
            <div class="col-sm-3 text-center">
				 <label class="control-label" for="seam_slippage_resistance_in_warp" style="color:#00008B;">
                    <span id="for_seam_slippage_resistance_in_warp_test_name_label">Seam Slippage</span>
                    <span id="seam_slippage_resistance_in_warp_test_method"></span>
                </label>
			</div>
...
<div class="form-group form-group-sm" for="seam_slippage_resistance_in_weft_value">
   ...
   <div class="col-sm-3 text-center">
       <label class="control-label" for="seam_slippage_resistance_in_weft_value" style="display: none">
        <span id="for_seam_slippage_resistance_in_weft_test_name_label">Seam Slippage </span>
        <span id="seam_slippage_resistance_in_weft_test_method">(ISO 13936-1)</span>
    </label>
   </div>
...
<div class="form-group form-group-sm" for="seam_slippage_resistance_iso_2_in_warp">
   ...
   <div class="col-sm-3 text-center">
      <label class="control-label" for="seam_slippage_resistance_iso_2_in_warp" style="color:#00008B;">
        <span id="for_seam_slippage_resistance_iso_2_in_warp_test_name_label">Seam Slippage</span> 
        <span id="seam_slippage_resistance_iso_2_warp">(ISO 13936-2)</span>
    </label>
   </div>
...
<div class="form-group form-group-sm" for="seam_slippage_resistance_iso_2_in_weft">
   ...
   <div class="col-sm-3 text-center">
      <label class="control-label" for="seam_slippage_resistance_iso_2_in_weft" style="display: none;">
        <span id="for_seam_slippage_resistance_iso_2_in_weft_test_name_label">Seam Slippage</span> 
        <span id="seam_slippage_resistance_iso_2_weft_test_method">(ISO 13936-2)</span>
    </label>
   </div>
...
<div class="form-group form-group-sm" for="seam_strength_in_warp_value">
   ...
   <div class="col-sm-3 text-center">
       <label class="control-label" for="seam_strength_in_warp_value" style="color:#00008B;">
        <span id="for_seam_strength_in_warp_test_name_label">Seam Strength</span> 
        <span id="seam_strength_in_warp_test_method">(ISO 13935-2)</span>
    </label>
   </div>
...
<div class="form-group form-group-sm" for="seam_strength_in_weft_value">
   ...
   <div class="col-sm-3 text-center">
       <label class="control-label" for="seam_strength_in_weft_value" style="display: none;">
            <span id="for_seam_strength_in_weft_test_name_label">Seam Strength</span> 
            <span id="seam_strength_in_weft_test_method">(ISO 13935-2)</span>
        </label>
   </div>
...
<div class="col-sm-3 text-center">
   <label class="control-label" for="seam_properties_seam_slippage_iso_astm_d_in_warp" style="color:#00008B;">
        <span id="for_seam_properties_seam_slippage_iso_astm_d_in_warp_test_name_label">Seam Properties </span>
        <span id="seam_properties_seam_slippage_iso_astm_d_in_warp_test_method">(ASTM D 1683)</span>
    </label>
</div>
...
<div class="col-sm-3 text-center">
   <label class="control-label" for="seam_properties_seam_slippage_iso_astm_d_in_weft" style="display: none">
        <span id="for_seam_properties_seam_slippage_iso_astm_d_in_weft_test_name_label">Seam Properties </span>
        <span id="seam_properties_seam_slippage_iso_astm_d_in_weft_test_method">(ASTM D 1683)</span>
    </label>
</div>
...
<div class="col-sm-3 text-center">
   <label class="control-label" for="seam_properties_seam_strength_iso_astm_d_in_warp" style="display: none">
        <span id="for_seam_properties_seam_slippage_iso_astm_d_in_warp_test_name_label">Seam Properties</span> 
        <span id="seam_properties_seam_strength_iso_astm_d_in_warp_test_method">(ASTM D 1683)</span>
    </label>
</div>
...
<div class="col-sm-3 text-center">
   <label class="control-label" for="seam_properties_seam_strength_iso_astm_d_in_weft" style="display: none">
        <span id="for_seam_properties_seam_slippage_iso_astm_d_in_weft_test_name_label">Seam Properties</span> 
        <span id="seam_properties_seam_strength_iso_astm_d_in_weft_test_method">(ASTM D 1683)</span>
    </label>
</div>
...
<div id="div_abrasion_resistance" style="display: none">
     ...
     <div class="form-group form-group-sm">
			...
			<div class="col-sm-3 text-center">
				 <label class="control-label" for="abrasion_resistance_thread_break" style="color:#00008B;">
                    <span id="for_abrasion_resistance_no_of_thread_break_test_name_label">Abrasion Resistance </span>
                        <span id="abrasion_resistance_no_of_thread_break_test_method">(ISO 12947-2)</span>
				 </label>
			</div>
     ...
     <div class="form-group form-group-sm">
			...
			<div class="col-sm-3 text-center">
				 <label class="control-label" for="abrasion_resistance_thread_break" style="color:#00008B;">
                    <span id="for_abrasion_resistance_c_change_test_name_label" style="display: none;">Abrasion Resistance</span> 
                    <span id="abrasion_resistance_c_change_test_method" style="display: none;">(ISO 12947-2)</span>
				 </label>
			</div>
...
<div id="div_mass_loss_in_abrasion" style="display: none">
      ...
      <div class="form-group form-group-sm">
    			...
    			<div class="col-sm-3 text-center">
    				 <label class="control-label" for="mass_loss_in_abrasion_test_value" style="color:#00008B;">
                        <span id="for_mass_loss_in_abrasion_test_name_label"> Mass Loss in Abrasion</span> 
                        <span id="mass_loss_in_abrasion_test_method">(ISO 12947-3)</span>
    				 </label>
    			</div>
...
<div id="div_color_fastness_to_washing" style="display: none">
     ...
     <div class="form-group form-group-sm">
    			...
    			<div class="col-sm-3 text-center">
    				 <label class="control-label" for="cf_to_washing_color_change_value" style="color:#00008B;">
                        <span id="for_cf_to_washing_color_change_test_name_label"> Color Fastness to Washing</span> 
                        <span id="cf_to_washing_color_change_test_method">(DIN EN ISO 105 -C06)</span>
    				 </label>
    			</div>
      ...
      <div class="form-group form-group-sm">
    			...
    			<div class="col-sm-3 text-center">
    				 <label class="control-label" for="mass_loss_in_abrasion_test_value" style="color:#00008B;">
                        <span id="for_cf_to_washing_staining_test_name_label" style="display: none;"> Color Fastness to Washing</span> 
                        <span id="cf_to_washing_staining_test_method" style="display: none;">(ISO 105 C6)</span>
    				 </label>
    			</div>
     ...
     <div class="form-group form-group-sm">
          ...
          <div class="col-sm-3 text-center">
             <label class="control-label" for="mass_loss_in_abrasion_test_value" style="color:#00008B;">
                <span id="for_cf_to_washing_cross_staining_test_name_label" style="display: none;"> Color Fastness to Washing</span> 
                <span id="cf_to_washing_cross_staining_test_method" style="display: none;">(ISO 105 C6)</span>
             </label>
          </div>
     ...
     <div class="form-group form-group-sm">
                ...
                <div class="col-sm-3 text-center">
                   <label class="control-label" for="test_name_and_method" style="color:#00008B;"> 
                        <span id="for_cf_to_dry_cleaning_color_change_test_name_label">Color Fastness to Dry-cleaning</span> 
                        <span id="cf_to_dry_cleaning_color_change_test_method">(ISO 105 D01)</span>
...
<div id="div_cf_to_perspiration_acid" style="display: none"> 
     ...
     <div class="form-group form-group-sm">
                ...
                <div class="col-sm-3 text-center">
                   <label class="control-label" for="test_name_and_method" style="color:#00008B;">
                        <span id="for_perspiration_acid_color_change_test_name_label"> Color Fastness to Perspiration Acid </span>
                            <span id="perspiration_acid_color_change_test_method">(ISO 105 E04)</span>
                   </label>
                </div>
     ...
     <div class="form-group form-group-sm">
                ...
                <div class="col-sm-3 text-center">
                   <label class="control-label" for="test_name_and_method" style="color:#00008B;">
                        <span id="for_cf_to_perspiration_acid_staining_test_name_label" style="display: none;"> Color Fastness to Perspiration Acid</span> 
                        <span id="cf_to_perspiration_acid_staining_test_method" style="display: none;">(ISO 105 E04)</span>
                   </label>
                </div>
     ...
     <div class="form-group form-group-sm">
                ...
                <div class="col-sm-3 text-center">
                   <label class="control-label" for="test_name_and_method" style="color:#00008B;">
                        <span id="for_cf_to_perspiration_acid_cross_staining_test_name_label" style="display: none;"> Color Fastness to Perspiration Acid </span>
                        <span id="cf_to_perspiration_acid_cross_staining_test_method" style="display: none;">(ISO 105 E04)</span>
                   </label>
                </div>
...
<div id="div_cf_to_perspiration_alkali" style="display: none"> 	
     ...
     <div class="form-group form-group-sm">
                ...
                <div class="col-sm-3 text-center">
                   <label class="control-label" for="test_name_and_method" style="color:#00008B;">
                        <span id="for_cf_to_perspiration_alkali_color_change_test_name_label"> Color Fastness to Perspiration Alkali</span> 
                        <span id="cf_to_perspiration_alkali_color_change_test_method">(ISO 105 E04)</span>
                   </label>
                </div>
     ...
     <div class="form-group form-group-sm">
                ...
                <div class="col-sm-3 text-center">
                   <label class="control-label" for="test_name_and_method" style="color:#00008B;">
                        <span id="for_cf_to_perspiration_alkali_staining_test_name_label" style="display: none;"> Color Fastness to Perspiration Alkali </span> 
                        <span id="cf_to_perspiration_alkali_staining_test_method" style="display: none;">(ISO 105 E04)</span>
                   </label>
                </div>
     ...
     <div class="form-group form-group-sm">
                ...
                <div class="col-sm-3 text-center">
                   <label class="control-label" for="test_name_and_method" style="color:#00008B;">
                        <span id="for_cf_to_perspiration_alkali_cross_staining_test_name_label" style="display: none;"> Color Fastness to Perspiration Alkali</span> 
                        <span id="cf_to_perspiration_alkali_cross_staining_test_method" style="display: none;">(ISO 105 E04)</span>
                   </label>
                </div>
...
<div id="div_color_fastness_to_water" style="display: none">
     ...
     <div class="form-group form-group-sm">
                ...
                <div class="col-sm-3 text-center">
                   <label class="control-label" for="test_name_and_method" style="color:#00008B;">
                        <span id="for_cf_to_water_color_change_test_name_label"> Color Fastness to Water</span> 
                        <span id="cf_to_water_color_change_test_method">(ISO 105 E01)</span>
                   </label>
                </div>
     ...
     <div class="form-group form-group-sm">
                ...
                <div class="col-sm-3 text-center">
                   <label class="control-label" for="test_name_and_method" style="color:#00008B;"> 
                        <span id="for_cf_to_water_staining_test_name_label" style="display: none;">Color Fastness to Water </span>
                        <span id="cf_to_water_staining_test_method" style="display: none;">(ISO 105 E01)</span>
                   </label>
                </div>
     ...
     <div class="form-group form-group-sm">
                ...
                <div class="col-sm-3 text-center">
                   <label class="control-label" for="test_name_and_method" style="color:#00008B;">
                        <span id="for_cf_to_water_cross_staining_test_name_label" style="display: none;">Color Fastness to Water</span> 
                        <span id="cf_to_water_cross_staining_test_method" style="display: none;">(ISO 105 E01)</span>
                   </label>
                </div>
     ...
     <div class="form-group form-group-sm">
                ...
                <div class="col-sm-3 text-center">
                   <label class="control-label" for="test_name_and_method" style="color:#00008B;">
                    <span id="for_cf_to_water_spotting_surface_test_name_label">Color fastness to Water Spotting</span> 
                    <span id="cf_to_water_spotting_surface_test_method"></span>
                   </label>
                </div>
      ...
      <div class="form-group form-group-sm">
                ...
                <div class="col-sm-3 text-center">
                   <label class="control-label" for="test_name_and_method" style="color:#00008B;">
                   <span id="for_cf_to_water_spotting_edge_test_name_label" style="display: none;"> Color fastness to Water Spotting </span>
                   <span id="cf_to_water_spotting_edge_test_method" style="display: none;"></span>
                   </label>
                </div>
     ...
     <div class="form-group form-group-sm">
                ...
                <div class="col-sm-3 text-center">
                   <label class="control-label" for="test_name_and_method" style="color:#00008B;">
                    <span id="for_cf_to_water_spotting_cross_staining_test_name_label" style="display: none;"> Color fastness to Water Spotting </span>
                    <span id="cf_to_water_spotting_cross_staining_test_method" style="display: none;"></span>
                   </label>
                </div>
...
<div id="div_resistance_to_surface_wetting" style="display: none">
     ...
     <div class="form-group form-group-sm">
                ...
                <div class="col-sm-3 text-center">
                   <label class="control-label" for="test_name_and_method" style="color:#00008B;">
                        <span id="for_resistance_to_surface_wetting_before_wash_test_name_label"> Resistance to Surface Wetting </span>
     ...
     <div class="form-group form-group-sm">
                ...
                <div class="col-sm-3 text-center">
                   <label class="control-label" for="test_name_and_method" style="color:#00008B;"> 
                        <span id="for_resistance_to_surface_wetting_after_one_wash_test_name_label" style="display: none;">Resistance to Surface Wetting</span> 
                        <span id="resistance_to_surface_wetting_after_one_wash_test_method" style="display: none;">
     ...
     <div class="form-group form-group-sm">
                ...
                <div class="col-sm-3 text-center">
                    <label class="control-label" for="test_name_and_method" style="color:#00008B;"> 
                        <span id="for_resistance_to_surface_wetting_after_five_wash_test_name_label" style="display: none;">Resistance to Surface Wetting</span> 
...
<div id="div_cf_to_hydrolysis_of_reactive_dyes" style="display: none">
      ...
      <div class="form-group form-group-sm">
                ...
                <div class="col-sm-3 text-center">
                   <label class="control-label" for="test_name_and_method" style="color:#00008B;">
                   <span id="for_cf_to_hydrolysis_of_reactive_dyes_color_change_test_name_label"> Color fastness to Hydrolysis of Reactive dyes</span> 
                   <span id="cf_to_hydrolysis_of_reactive_dyes_color_change_test_method">(C11)</span>
                   </label>
                </div>
...
<div id="div_cf_to_oxidative_bleach_damage" style="display: none">
     ...
     <div class="form-group form-group-sm">
                ...
                <div class="col-sm-3 text-center">
                   <label class="control-label" for="test_name_and_method" style="color:#00008B;">
                   <span id="for_cf_to_oxidative_bleach_damage_color_change_test_name_label">Color Fastness to Oxidative Bleach Damage</span> 
                   <span id="cf_to_oxidative_bleach_damage_color_change">(C10A)</span>
                   </label>
                </div>
     ...
     <div class="form-group form-group-sm">
                ...
                <div class="col-sm-3 text-center">
                   <label class="control-label" for="test_name_and_method" style="color:#00008B;">
                   <span id="for_cf_to_oxidative_bleach_damage_tone_test_name_label" style="display: none;">Color Fastness to Oxidative Bleach Damage </span> 
                   <span id="cf_to_oxidative_bleach_damage_tone_test_method" style="display: none;">(C10A)</span>
                   </label>
                </div>
 ...
 <div id="div_cf_to_phenolic_yellowing" style="display: none">
		<div class="form-group form-group-sm">
                ...
                <div class="col-sm-3 text-center">
                   <label class="control-label" for="test_name_and_method" style="color:#00008B;">
                   <span id="for_cf_to_phenolic_yellowing_staining_test_name_label"> Color Fastness to Phenolic Yellowing</span> 
                   <span id="cf_to_phenolic_yellowing_staining_test_method">(ISO 105 X 18)</span>
                   </label>
                </div>
 ...
 <div class="form-group form-group-sm" id="div_migration_of_color_into_pvc" style="display: none">
	                ...
	                <div class="col-sm-3 text-center">
	                   <label class="control-label" for="test_name_and_method" style="color:#00008B;">
                       <span id="for_cf_to_pvc_migration_staining_test_name_label"> Migration of Color into PVC</span> 
                       <span id="cf_to_pvc_migration_staining_test_method" value="ISO 105 X 10">(ISO 105 X 10)</span>
	                   </label>
	                </div>
    ...
    <div class="form-group form-group-sm" id="div_cf_to_saliva" style="display: none">
	     <div class="form-group form-group-sm" >
                ...
                <div class="col-sm-3 text-center">
                   <label class="control-label" for="test_name_and_method" style="color:#00008B;">
                   <span id="for_cf_to_saliva_color_change_test_name_label"> Color Fastness to Saliva</span> 
                   <span id="cf_to_saliva_color_change_test_method">(DIN V 53160-1)</span> 
                   </label>
                </div>
	     ...
	     <div class="form-group form-group-sm">
                ...
                <div class="col-sm-3 text-center">
                   <label class="control-label" for="test_name_and_method" style="color:#00008B;">
                   <span id="for_cf_to_saliva_staining_test_name_label" style="display: none;"> Color Fastness to Saliva</span> 
                   <span id="cf_to_saliva_staining_test_method" style="display: none;">(DIN V 53160-1) </span>
                   </label>
                </div>
     ...
     <div class="form-group form-group-sm" id="div_cf_to_chlorinated_water" style="display: none">
                ...
                <div class="col-sm-3 text-center">
                   <label class="control-label" for="test_name_and_method" style="color:#00008B;">
                   <span id="for_cf_to_chlorinated_water_color_change_test_name_label">Color Fastness to Chlorinated Water</span>
                   <span id="cf_to_chlorinated_water_color_change_test_method">(ISO 105 E03)</span>
                   </label>
                </div>
     ...
     <div class="form-group form-group-sm" id="div_cf_to_chlorine_bleach" style="display: none">
                ...
                <div class="col-sm-3 text-center">
                   <label class="control-label" for="test_name_and_method" style="color:#00008B;">
                    <span id="for_cf_to_cholorine_bleach_color_change_test_name_label">Color Fastness to Chlorine Bleach </span>
                    <span id="cf_to_cholorine_bleach_color_change_test_method">(ISO 105 N01)</span>
                </label>
                </div>
...
<div class="form-group form-group-sm" id="div_cf_to_peroxide_bleach" style="display: none">
                ...
                <div class="col-sm-3 text-center">
                   <label class="control-label" for="test_name_and_method" style="color:#00008B;">
                   <span id="for_cf_to_peroxide_bleach_color_change_test_name_label">Color Fastness to Peroxide Bleach</span> 
                   <span id="cf_to_peroxide_bleach_color_change_test_method">(ISO 105 N02)</span>
                   </label>
                </div>
     ...
     <div class="form-group form-group-sm" id="div_cross_staining" style="display: none">
                ...
                <div class="col-sm-3 text-center">
                   <label class="control-label" for="test_name_and_method" style="color:#00008B;">
                   <span id="for_cross_staining_test_name_label">Cross Staining</span> 
                   <span id="cross_staining_test_method"></span>
                   </label>
                </div>
 ...
 <div class="form-group form-group-sm" id="div_formaldehyde_content" style="display: none">
                ...
                <div class="col-sm-3 text-center">
                   <label class="control-label" for="test_name_and_method" style="color:#00008B;">
                   <span id="for_formaldehyde_content_test_name_label">Formaldehyde Content</span> 
                   <span id="formaldehyde_content_test_method">(ISO 14184-1)</span>
                   </label>
                </div>
...
<div class="form-group form-group-sm" id="div_ph" style="display: none">
                ...
                <div class="col-sm-3 text-center">
                   <label class="control-label" for="test_name_and_method" style="color:#00008B;">
                   <span id="for_ph_test_name_label">pH</span> 
                   <span id="ph_test_method"></span>
                   </label>
                </div>
             
                <div class="col-sm-2 text-center">
                        
                <input type="hidden" class="form-control" id="test_method_for_ph_value" name="test_method_for_ph_value" value="">
    ...
    <div class="form-group form-group-sm" id="div_water_absorption" style="display: none">
        <div class="form-group form-group-sm">
                ...
                <div class="col-sm-3 text-center">
                   <label class="control-label" for="test_name_and_method" style="color:#00008B;">
                        <span id="for_water_absorption_test_name_label"> Water Absorption</span> 
                        <span id="water_absorption_test_method"> (ISO 9073-12) </span>
                   </label>
                </div>
                ...
                <input type="hidden" class="form-control" id="test_method_for_water_absorption" name="test_method_for_water_absorption" value="ISO 9073-12">
     	...
     	<div class="form-group form-group-sm" >
          ...
          <div class="col-sm-3 text-center">
             <label class="control-label"  style="color:#00008B;">
             <span id="for_water_absorption_b_wash_thirty_sec_test_name_label" style="display: none;">  Water Absorption</span> 
             <span id="water_absorption_b_wash_thirty_sec_test_method" style="display: none;">(ISO 9073-12) </span>
             </label>
          </div>
     ...
     <div class="form-group form-group-sm" >
          ...
          <div class="col-sm-3 text-center">
             <label class="control-label" style="color:#00008B;">
             <span id="for_water_absorption_b_wash_max_test_name_label" style="display: none;"> Water Absorption</span> 
             <span id="water_absorption_b_wash_max_test_method" style="display: none;">(ISO 9073-12) </span>
             </label>
             </label>
          </div>
    ...
    <div class="form-group form-group-sm" >
     ...
     <div class="form-group form-group-sm" id="div_wicking_test" style="display: none">
                ...
                <div class="col-sm-3 text-center">
                   <label class="control-label" for="test_name_and_method" style="color:#00008B;"> 
                   <span id="for_wicking_test_test_name_label">Wicking Test</span>
                   <span id="for_wicking_test_test_method"> (TM 09)</span>
                   </label>
                </div>
             
                <div class="col-sm-2 text-center">
                <input type="hidden" class="form-control" id="test_method_for_wicking_test" name="test_method_for_wicking_test" value="TM 09">
    ...
    <div class="form-group form-group-sm" id="div_spirality" style="display: none">
                ...
                <div class="col-sm-3 text-center">
                   <label class="control-label" for="test_name_and_method" style="color:#00008B;">
                   <span id="for_spirality_test_name_label">Spirality</span>
                   <span id="spirality_test_method"> (ISO 16322)</span>
                   </label>
                </div>
             
                <div class="col-sm-2 text-center">
                        
                <input type="hidden" class="form-control" id="test_method_for_spirality_value" name="test_method_for_spirality_value" value="ISO 16322">
     ...
     <div class="form-group form-group-sm" id="div_smoothness_appearance" style="display: none">
          ...
          <label class="control-label" for="" style="color:#00008B;"></label><br>
             <label class="control-label"  style="color:#00008B;">
             <span id="for_smoothness_appearance_test_name_label">Smoothness Appearance</span>
             <span id="smoothness_appearance_test_method"> (AATCC 124) </span>
             </label>
          </div>
     ...
     <div class="form-group form-group-sm" id="div_print_durability" style="display: none">
          ...
          <div class="col-sm-3 text-center">
             <label class="control-label"  style="color:#00008B;">
             <span id="for_print_durability_test_name_label">Print Durability</span> 
             <span id="print_durability_test_method">(M&S C15)</span>
             </label>
          </div>
           
            <div class="col-sm-2 text-center">
                    
            <input type="hidden" class="form-control" id="test_method_for_print_duribility" name="test_method_for_print_duribility" value="M&S C15">
     ...
     <div class="form-group form-group-sm" id="div_iron_ability_of_woven_fabric" style="display: none">
          ...
          <div class="col-sm-3 text-center">
             <label class="control-label"  style="color:#00008B;">
             <span id="for_iron_ability_of_woven_fabric_test_name_label">Iron Ability of Woven Fabric</span> 
             <span id="iron_ability_of_woven_fabric_test_method">(M&S P91)</span>
             </label>
     ...
     <div class="form-group form-group-sm" id="div_cf_to_artificial_day_light" style="display: none">
          ...
          <div class="col-sm-3 text-center">
             <label class="control-label"  style="color:#00008B;">
             <span id="for_cf_to_artificial_day_light_test_name_label"> Color Fastness to Artificial Day Light</span> 
             <span id="cf_to_artificial_day_light_test_method">(ISO 105 B02)</span>
             </label>
          </div>
     ...
     <div class="form-group form-group-sm" id="div_moisture_content" style="display: none">
          ...
          <div class="col-sm-3 text-center">
             <label class="control-label"  style="color:#00008B;">
             <span id="for_moisture_content_test_name_label">Moisture Content</span>
             </label>
          </div>
     ...
     <div class="form-group form-group-sm" id="div_evaporation_rate" style="display: none">
          ...
          <div class="col-sm-3 text-center">
             <label class="control-label" for="evaporation_rate_quick_drying" style="color:#00008B;">
             <span id="for_evaporation_rate_test_name_label"> Evaporation Rate (Quick Drying)</span> 
             <span id="evaporation_rate_test_method">(TM 10)</span>
             </label>
          </div>
 ...
 <div class="form-group form-group-sm" id="div_fiber_content" style="display: none">
     ...
     <div class="form-group form-group-sm" >
        ...
        <div class="col-sm-3 text-center">
           <label class="control-label"  style="color:#00008B;">
           <span id="for_warp_cotton_content_test_name_label">Fiber Content</span>   
           <span id="warp_cotton_content_test_method">(In house test method)</span></label>
        </div>
     ...
     <div class="form-group form-group-sm" >
        ...
        <div class="col-sm-3 text-center">
           <label class="control-label"  style="color:#00008B;">
           <span id="for_warp_other_fibe_test_name_label" style="display: none;">Fiber Content </span> 
            <span id="warp_other_fiber_content_test_method" style="display: none;">(In house test method)</span></label>
        </div>
     ...
     <div class="form-group form-group-sm" >
        ...
        <div class="col-sm-3 text-center">
           <label class="control-label"  style="color:#00008B;">
           <span id="for_weft_cotton_content_test_name_label">Fiber Content</span>   
           <span id="weft_cotton_content_test_method">(In house test method)</span>
        </label>
        </div>
    ...
    <div class="form-group form-group-sm" >
        ...
        <div class="col-sm-3 text-center">
           <label class="control-label"  style="color:#00008B;">
           <span id="for_weft_polyester_content_test_name_label" style="display: none;">Fiber Content </span>  
           <span id="weft_polyester_content_test_method">(In house test method)</span>
        </label>
        </div>
      ...
      <div class="form-group form-group-sm" >
        ...
        <div class="col-sm-3 text-center">
           <label class="control-label"  style="color:#00008B;">
           <span id="for_weft_other_fiber_test_name_label" style="display: none;">Fiber Content</span>   
           <span id="weft_other_content_test_method">(In house test method)</span>
        </label>
        </div>
...
<div id="div_appearance_after_wash">
   ...
   <div class="form-group form-group-sm">
      ...
      <div class="col-sm-3 text-center">
         <label class="control-label" for="appearance_after_wash_value" style="color:#00008B;">
         <span id="appearance_after_wash_label"> Appearance After Wash</span> 
         <span id="appearance_after_wash_test_method"></span>
         </label>
      </div>
...
<!-- -------------------------------------------------------------------------------Appearance after wash end---------------------------------------------------------------------------------------------------------------------- -->
						...
						<div class="form-group form-group-sm">
								<div class="col-sm-offset-4 col-sm-5">
									<button type="button" class="btn btn-primary" onClick="sending_data_of_defining_qc_standard_for_dyeing_finish_process_form_for_saving_in_database()">Submit</button>
