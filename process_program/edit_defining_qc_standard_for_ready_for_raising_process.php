...
{
   $ready_for_raising_process_id=$_GET['raising_id'];
   $sql_for_ready_for_raising_process="select * from defining_qc_standard_for_ready_for_raising_process where `id`='$ready_for_raising_process_id'";
   $result_for_ready_for_raising_process= mysqli_query($con,$sql_for_ready_for_raising_process) or die(mysqli_error($con));
   $row_for_ready_for_raising_process = mysqli_fetch_array( $result_for_ready_for_raising_process);
}
else
{
   ...
   $sql_for_ready_for_raising_process = "SELECT * FROM `defining_qc_standard_for_ready_for_raising_process`
...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
				...
				<div class="panel-heading" style="color:#191970;"><b>Edit Defining Qc Standard For ready for Raising Process / <a href="#">Edit</a></b></div> <!-- This will create a upper block for FORM (Just Beautification) -->
...
<!--
                          ...
                          <table id="datatable-buttons" class="table table-striped table-bordered">
                           <thead>
                             ...
                             <?php
                                          ...
                                          if(isset($ready_for_raising_process_id))
                                          {
                                             $sql_for_raising = "SELECT * FROM `defining_qc_standard_for_ready_for_raising_process` WHERE `id`='$ready_for_raising_process_id'";
                                          }
                                          else
                                          {
                 ...
                 <button type="button" class="btn btn-info" id="buttn_for_load_form" onclick="load_full_form('<?php echo $row_for_ready_for_raising_process['customer_id']?>')">Load Form</button>
...
<div class="full_page_load" id="full_page_load" style="display: none;"> 
                   ...
                   <label>PP Number :<?php echo $row_for_ready_for_raising_process['pp_number']?><input type="hidden" class="form-control" id="pp_number" name="pp_number" value="<?php echo $row_for_ready_for_raising_process['pp_number']?>" readonly></label>  ,
						      <label>Version Name :<?php echo $row_for_ready_for_raising_process['version_number']?><input type="hidden" id="version_number" name="version_number" value="<?php echo $row_for_ready_for_raising_process['version_number']?>" >  </label>  ,
                        <label>Customer Name :<?php echo $row_for_ready_for_raising_process['customer_name']?><input type="hidden" id="customer_name" name="customer_name" value="<?php echo $row_for_ready_for_raising_process['customer_name']?>"> </label>   ,
                        <input type="hidden" id="customer_id" name="customer_id" value="<?php echo $row_for_ready_for_raising_process['customer_id']?>">
                        <label>Color :<?php echo $row_for_ready_for_raising_process['color']?><input type="hidden" id="color" name="color" value="<?php echo $row_for_ready_for_raising_process['color']?>" > </label>    ,
                        <label>Finish Width :<?php echo $row_for_ready_for_raising_process['finish_width_in_inch']?><input type="hidden" id="finish_width_in_inch" name="finish_width_in_inch"  value="<?php echo $row_for_ready_for_raising_process['finish_width_in_inch']?>"> </label>
                        <input type="hidden" id="version_id" name="version_id" value="<?php echo $row_for_ready_for_raising_process['version_id']?>" >

                        <input type="hidden" id="standard_for_which_process" name="standard_for_which_process"  value="<?php echo $row_for_ready_for_raising_process['standard_for_which_process']?>">
        ...
        <div class="form-group form-group-sm" for="tensile_properties_in_warp">
          ...
          <div class="col-sm-1 text-center">
              <select  class="form-control" id="tensile_properties_in_warp_value_tolerance_range_math_operator" name="tensile_properties_in_warp_value_tolerance_range_math_operator" onchange="tensile_properties_in_warp()">
                      ...
                      <?php
                                      $tensile_properties_in_warp_value_tolerance_range_math_operator = $row_for_ready_for_raising_process['tensile_properties_in_warp_value_tolerance_range_math_operator'];
          ...
          <div class="col-sm-1" for="tolerance">
             ...
             <input type="text" class="form-control" id="tensile_properties_in_warp_value_tolerance_value" name="tensile_properties_in_warp_value_tolerance_value" value="<?php echo $row_for_ready_for_raising_process['tensile_properties_in_warp_value_tolerance_value']?>" onchange="tensile_properties_in_warp()" required>
          </div>
          ...
          <div class="col-sm-1" for="unit">
             <select  class="form-control" id="uom_of_tensile_properties_in_warp_value" name="uom_of_tensile_properties_in_warp_value">
                      ...
                      <?php
                                      $uom_of_tensile_properties_in_warp_value = $row_for_ready_for_raising_process['uom_of_tensile_properties_in_warp_value'];
          ...
          <div class="col-sm-1 text-center" for="min_value">
          	...
          	<input type="text" class="form-control" id="tensile_properties_in_warp_value_min_value" name="tensile_properties_in_warp_value_min_value" value="<?php echo $row_for_ready_for_raising_process['tensile_properties_in_warp_value_min_value']?>" required>
          </div>
		          
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="tensile_properties_in_warp_value_max_value" name="tensile_properties_in_warp_value_max_value" value="<?php echo $row_for_ready_for_raising_process['tensile_properties_in_warp_value_max_value']?>" required>
     ...
     <div class="form-group form-group-sm" for="tensile_properties_in_weft">
          ...
          <div class="col-sm-1 text-center">
              <select  class="form-control" id="tensile_properties_in_weft_value_tolerance_range_math_operator" name="tensile_properties_in_weft_value_tolerance_range_math_operator" onchange="tensile_properties_in_weft()">
                      ...
                      <?php
                                      $tensile_properties_in_weft_value_tolerance_range_math_operator = $row_for_ready_for_raising_process['tensile_properties_in_weft_value_tolerance_range_math_operator'];
          ...
          <div class="col-sm-1" for="tolerance">
             ...
             <input type="text" class="form-control" id="tensile_properties_in_weft_value_tolerance_value" name="tensile_properties_in_weft_value_tolerance_value" value="<?php echo $row_for_ready_for_raising_process['tensile_properties_in_weft_value_tolerance_value']?>" onchange="tensile_properties_in_weft()" required>
          </div>
          ...
          <div class="col-sm-1" for="unit">
             <select  class="form-control" id="uom_of_tensile_properties_in_weft_value" name="uom_of_tensile_properties_in_weft_value">
                      ...
                      <?php
                                      $uom_of_tensile_properties_in_weft_value = $row_for_ready_for_raising_process['uom_of_tensile_properties_in_weft_value'];
          ...
          <div class="col-sm-1 text-center" for="min_value">
          	...
          	<input type="text" class="form-control" id="tensile_properties_in_weft_value_min_value" name="tensile_properties_in_weft_value_min_value" value="<?php echo $row_for_ready_for_raising_process['tensile_properties_in_weft_value_min_value']?>" required>
          </div>
		          
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="tensile_properties_in_weft_value_max_value" name="tensile_properties_in_weft_value_max_value" value="<?php echo $row_for_ready_for_raising_process['tensile_properties_in_weft_value_max_value']?>" required>
 ...
 <div id="div_tear_force_value" >
      ...
      <div class="form-group form-group-sm" for="tear_force_in_warp_value">
          ...
          <div class="col-sm-1 text-center">
              <select  class="form-control" id="tear_force_in_warp_value_tolerance_range_math_operator" name="tear_force_in_warp_value_tolerance_range_math_operator" onchange="tear_force_in_warp_cal()">
                      ...
                      <?php
                                      $tear_force_in_warp_value_tolerance_range_math_operator = $row_for_ready_for_raising_process['tear_force_in_warp_value_tolerance_range_math_operator'];
          ...
          <div class="col-sm-1" for="tolerance">
             ...
             <input type="text" class="form-control" id="tear_force_in_warp_value_tolerance_value" name="tear_force_in_warp_value_tolerance_value" value="<?php echo $row_for_ready_for_raising_process['tear_force_in_warp_value_tolerance_value']?>" onchange="tear_force_in_warp_cal()" required>
          </div>
          ...
          <div class="col-sm-1" for="unit">
             <select  class="form-control" id="uom_of_tear_force_in_warp_value" name="uom_of_tear_force_in_warp_value">
                      ...
                      <?php
                                      $uom_of_tear_force_in_warp_value = $row_for_ready_for_raising_process['uom_of_tear_force_in_warp_value'];
          ...
          <div class="col-sm-1 text-center" for="min_value">
          	...
          	<input type="text" class="form-control" id="tear_force_in_warp_value_min_value" name="tear_force_in_warp_value_min_value" value="<?php echo $row_for_ready_for_raising_process['tear_force_in_warp_value_min_value']?>" required>
          </div>
		          
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="tear_force_in_warp_value_max_value" name="tear_force_in_warp_value_max_value" value="<?php echo $row_for_ready_for_raising_process['tear_force_in_warp_value_max_value']?>" required>
     ...
     <div class="form-group form-group-sm" for="tear_force_in_weft_value">
          ...
          <div class="col-sm-1 text-center" for="min_value">
            ...
            <input type="text" class="form-control" id="tear_force_in_weft_value_min_value" name="tear_force_in_weft_value_min_value" value="<?php echo $row_for_ready_for_raising_process['tear_force_in_weft_value_min_value']?>" required>
          </div>
              
          <div class="col-sm-1 text-center">
              
            <input type="text" class="form-control" id="tear_force_in_weft_value_max_value" name="tear_force_in_weft_value_max_value" value="<?php echo $row_for_ready_for_raising_process['tear_force_in_weft_value_max_value']?>" required>
