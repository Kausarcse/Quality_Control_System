...
$uom_of_tear_force_in_weft_value= $_POST['uom_of_tear_force_in_weft_value'];
   ...
   mysqli_query($con,"START TRANSACTION") or die(mysqli_error($con));
	...
	$select_sql_for_duplicacy="select * from `defining_qc_standard_for_ready_for_raising_process` where 
	...
	$update_sql_statement="UPDATE `defining_qc_standard_for_ready_for_raising_process` SET
