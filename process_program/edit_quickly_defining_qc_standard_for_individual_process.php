...
<script>
	...
	// document.getElementById('version_number_for_searching').innerHTML='<?php echo $version_number ?>';
...
function fetching_qc_standard_defining_form()
{
       ...
       if(validate != false)
	   {
         ...
         var version_number = splitted_selected_version_number_value[4];
			...
			{   
				"Singeing & Desizing"	: "process_program\\edit_defining_qc_standard_for_singe_and_desize_process.php?pp_number=" + selected_pp_number_value+"&version_number="+version_number,
				"Bleaching"		 	: "process_program\\edit_defining_qc_standard_for_bleaching_process.php?pp_number=" + selected_pp_number_value+"&version_number="+version_number, 
				"Mercerize"			: "process_program\\edit_defining_qc_standard_for_mercerize_proces.php?pp_number=" + selected_pp_number_value+"&version_number="+version_number,
				"Ready For Mercerize": "process_program\\edit_defining_qc_standard_for_ready_for_mercerize_process.php?pp_number=" + selected_pp_number_value+"&version_number="+version_number,
				"Equalize"          : "process_program\\edit_defining_qc_standard_for_equalize_process.php?pp_number=" + selected_pp_number_value+"&version_number="+version_number,
				"Printing"          : "process_program\\edit_defining_qc_standard_for_printing_process.php?pp_number=" + selected_pp_number_value+"&version_number="+version_number,
				"Curing"		 	: "process_program\\edit_defining_qc_standard_for_curing_process.php?pp_number=" + selected_pp_number_value+"&version_number="+version_number, 
				"Washing"		 	: "process_program\\edit_defining_qc_standard_for_washing_process.php?pp_number=" + selected_pp_number_value+"&version_number="+version_number, 
				"Finishing"		 	: "process_program\\edit_defining_qc_standard_for_finishing_process.php?pp_number=" + selected_pp_number_value+"&version_number="+version_number, 
				"Calander"		 	: "process_program\\edit_defining_qc_standard_for_calendering_process.php?pp_number=" + selected_pp_number_value+"&version_number="+version_number, 
				"Sanforizing"		 	: "process_program\\edit_defining_qc_standard_for_sanforizing_process.php?pp_number=" + selected_pp_number_value+"&version_number="+version_number, 
				"Raising"		 	: "process_program\\edit_defining_qc_standard_for_raising_process.php?pp_number=" + selected_pp_number_value+"&version_number="+version_number, 
				"Scouring & Bleaching"		 	: "process_program\\edit_defining_qc_standard_for_scouring_bleaching_process.php?pp_number=" + selected_pp_number_value+"&version_number="+version_number, 
				"Scouring"		 	: "process_program\\edit_defining_qc_standard_for_scouring_process.php?pp_number=" + selected_pp_number_value+"&version_number="+version_number, 
				"Ready For Print"		 	: "process_program\\edit_defining_qc_standard_for_ready_for_printing_process.php?pp_number=" + selected_pp_number_value+"&version_number="+version_number, 
				"Ready For Dyeing"		 	: "process_program\\edit_defining_qc_standard_for_ready_for_dying_process.php?pp_number=" + selected_pp_number_value+"&version_number="+version_number, 
				"Ready For Raising"		 	: "process_program\\edit_defining_qc_standard_for_ready_for_raising_process.php?pp_number=" + selected_pp_number_value+"&version_number="+version_number, 
				"Greige Receiving"		 	: "process_program\\edit_defining_qc_standard_for_greige_receiving_process.php?pp_number=" + selected_pp_number_value+"&version_number="+version_number, 
		...
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
				...
				<div class="panel-heading" style="color:#191970;">
	                ...
	                <div class="row" data-toggle="collapse" data-target="#search_form_collpapsible_div" onClick="change_up_down_arrow_icon(this.childNodes[5].childNodes[1].id)"> <!-- Row for Panel Heading and Chevron Up Alingment -->
	                    <span class="col-sm-8"><b>Edit Defining QC Standard For Individual Process Form</b></span>
                 ...
                 <div>
                 	 <nav aria-label="breadcrumb">
						  <ol class="breadcrumb">
						    ...
						    <li class="breadcrumb-item"><a onclick="load_page('process_program/quickly_defining_qc_standard_for_individual_process.php')">Defining QC Standard For Individual Process</a></li>
						  </ol>
					 </nav>
                 </div> -->
						...
						<label class="control-label col-sm-3" for="standard_for_for_searching" style="margin-right:0px; color:#00008B;">Standard For:</label>
							<div class="col-sm-5">
								<select  class="form-control" id="standard_for_for_searching" name="standard_for_for_searching">
											...
											<?php 
												 $sql = 'select process_name from `process_name` order by `process_name` ASC';
												 $result= mysqli_query($con,$sql) or die(mysqli_error($con));
												 while( $row = mysqli_fetch_array($result))
												 {
