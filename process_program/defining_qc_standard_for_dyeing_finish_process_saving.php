...
//from new database and form
   ...
   mysqli_query($con,"START TRANSACTION") or die(mysqli_error($con));
	...
	$select_sql_for_duplicacy="SELECT * from `defining_qc_standard_for_dyeing_finish_process` 
								where `pp_number`='$pp_number' and `version_number`='$version_number' and `customer_name`='$customer_name' and `color`='$color' and 
	...
	else if(mysqli_num_rows($result) < 1)
	{
		...
		$insert_sql_statement="INSERT INTO `defining_qc_standard_for_dyeing_finish_process`( 
		`pp_number`, 
		`version_id`, 
		`version_number`, 
		`customer_name`, 
