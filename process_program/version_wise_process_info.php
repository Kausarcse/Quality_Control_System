    ...
    <div id="div_full_form">
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
				...
				<form class="form-horizontal" action="" style="margin-top:10px;" name="version_wise_process_info_form" id="version_wise_process_info_form">
					...
					<input type="hidden" id="possible_number_of_process" name="possible_number_of_process" value="10">
                                    ...
                                    <tr>
                                        ...
                                        for($i=2;$i<=10;$i++)
                                        {
                                            ...
                                            <tr>
                                                <td><?php echo $i ?></td>
                                                <td>
                                                    <select class="form-control" name="process_name_<?php echo $i ?>" id="process_name_<?php echo $i ?>">
                                                        <option  value="select">Select Process Name</option>
                                                        <?php 
                                                ...
                                                <td align="center">
                                                    <input type="text" class="form-control"  id="process_serial_<?php echo $i ?>" name="process_serial_<?php echo $i ?>" value="<?php echo $i ?>">
                                                </td>
                                                <td>
                                                    <select  class="form-control" id="process_or_reprocess_<?php echo $i ?>" name="process_or_reprocess_<?php echo $i ?>">
