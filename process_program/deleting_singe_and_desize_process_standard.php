...
$singe_and_desize_id=$_POST['singe_and_desize_id'];
...
mysqli_query($con,"START TRANSACTION") or die(mysqli_error($con));
	...
	$delete_sql_statement="DELETE FROM `defining_qc_standard_for_singe_and_desize_process` WHERE `id`='$singe_and_desize_id'";
