...
function Fill_Value_Of_Version_Number_Field_For_Searching(pp_number_for_searching)
{
 ...
 //  function sending_data_for_update(value)
 // {
        ...
        <div class="panel panel-default" id="version_wise_process_info_list">
             ...
             <div class="form-group form-group-sm" id="form-group_for_test_method_name">
					         ...
					         <table id="datatable-buttons" class="table table-striped table-bordered">
					            ...
					            <?php 
					                            $s1 = 1;
					                            $sql_for_color = "SELECT * FROM adding_process_to_version ORDER BY row_id ASC";
					             ...
					             <tr>
					                ...
					                <td>
					                       ...
					                       <!--  <button type="submit" id="delete_pp_info" name="delete_pp_info"  class="btn btn-primary btn-xs" onclick="load_page('process_program/deleting_pp_info.php?pp_id=<?php echo $row['row_id'] ?>')"> Edit </button>
					                       <span>  </span>
					                        -->
					                       
					                        <!--  <button type="submit" id="delete_pp_info" name="delete_pp_info"  class="btn btn-danger btn-xs" onclick="load_page('process_program/deleting_version_wise_process_info.php?process_id=<?php echo $row['process_id'] ?>')"> Delete </button> -->
											 ...
											 <?php 
													...
													if($process_id == 'proc_10' || $process_id == 'proc_12' || $process_id == 'proc_19')
													{
														?>
															<button type="button" id="delete_pp_info" name="delete_pp_info"  class="btn btn-danger btn-xs" onclick="sending_data_for_delete('<?php echo $value; ?>')"> Delete </button>
														<?php
