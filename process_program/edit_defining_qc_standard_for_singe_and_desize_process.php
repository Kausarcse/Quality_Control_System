...
if(isset($_GET['singe_and_desize_id']))
{
...
else
{
   ...
   $sql_for_singe_desige = "SELECT * FROM `defining_qc_standard_for_singe_and_desize_process`
...
{  
 ...
 }//End of function sending_data_of_edit_defining_qc_standard_for_singe_and_desize_process_form_for_saving_in_database()
...
function delete_singe_and_desizing_process(singe_and_desize_id)
{
	var value_for_data= 'singe_and_desize_id='+singe_and_desize_id;
    
				$.ajax({
						url: 'process_program/deleting_singe_and_desize_process_standard.php',
						dataType: 'text',
						type: 'post',
						contentType: 'application/x-www-form-urlencoded',
						data: value_for_data,
...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
            ...
            <div class="panel-heading" style="color:#191970;"><b>Edit Defining Standard For Singe And Desize Process</b></div> 
                     ...
                     <table id="datatable-buttons" class="table table-striped table-bordered">
                        ...
                        <tbody>
                           <?php
                              ...
                              {
                                 $sql_for_singe_and_desize = "SELECT * FROM `defining_qc_standard_for_singe_and_desize_process` WHERE `id`='$singe_and_desize_id'";
                              }
                              else
                              {
                                 $sql_for_singe_and_desize = "SELECT * FROM `defining_qc_standard_for_singe_and_desize_process`
                                 WHERE `standard_for_which_process`='$standard_for_which_process' and `pp_number` = '$pp_number' and `version_id`='$version_id'  ORDER BY id ASC";
                              }
                              ...
                              while ($row = mysqli_fetch_assoc($res_for_singe_and_desize))
                              {
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                       ...
                                       {
                                          ?>
                                             <button type="button" id="delete_singe_and_desize" name="delete_singe_and_desize"  class="btn btn-danger btn-xs" onclick="delete_singe_and_desizing_process(<?php echo $row['id'];?>)" > Delete </button>
                                          <?php
                                       } 
                                       ?>
   ...
   <div class="full_page_load" id="full_page_load" style="display: none;">	
      ...
      <form class="form-horizontal" action="" style="margin-top:10px;" name="defining_qc_standard_for_singe_and_desize_process_form" id="defining_qc_standard_for_singe_and_desize_process_form">
					...
					<!--	<label class="control-label col-sm-4" for="pp_number" style="margin-right:0px; color:#00008B;">PP Number:</label>-->
                        ...
                        <input type="hidden" class="form-control" id="pp_number" name="pp_number" value="<?php echo $row_for_singe_desige['pp_number']?>" >
                        ...
                        <input type="hidden" id="process_name" name="process_name" value="<?php echo $row_for_singe_desige['standard_for_which_process']; ?>">
...
<!-- <input type="hidden" class="form-control" id="version_id" name="version_id" value="<?php echo $row_for_singe_desige['version_id']; ?>">
<input type="hidden" class="form-control" id="color_name" name="color_name" value="<?php echo $row_for_singe_desige['color_id']; ?>">
...
<input type="hidden" class="form-control" id="process_technique_id" name="process_technique_id" value="<?php echo $row_for_singe_desige['process_technique']; ?>"> -->
...
<!-- *********************************** Designing Tabular Formar (Multi-Column Form Elements Here (End))*********************************** -->
						...
						<div class="form-group form-group-sm">
								<div class="col-sm-offset-3 col-sm-5">
									<button type="button" class="btn btn-primary" onClick="sending_data_of_edit_defining_qc_standard_for_singe_and_desize_process_form_for_saving_in_database()">Submit</button>
