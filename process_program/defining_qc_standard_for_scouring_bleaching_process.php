...
*/ document.getElementById('color').value=splitted_version_details[1];
 ...
 function sending_data_of_defining_qc_standard_for_scouring_bleaching_process_form_for_saving_in_database()
 {
       ...
       if(validate != false)
	   {
		  	 ...
		  	 $.ajax({
			 		url: 'process_program/defining_qc_standard_for_scouring_bleaching_process_form_saving.php',
			 		dataType: 'text',
			 		type: 'post',
			 		contentType: 'application/x-www-form-urlencoded',
...
<div class="col-sm-12 col-md-12 col-lg-12">
	...
	<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
		...
		<?php 
			...
			{
				?>
				<div class="panel-heading" style="color:#191970;"><b>Model For Scouring & Bleaching Process</b></div> 
						...
						<div class="panel panel-default">
							<table id="datatable-buttons" class="table table-striped table-bordered">
								...
								<tbody>
									...
									$sql_for_scouring_bleaching = "SELECT * FROM `model_defining_qc_standard_for_scouring_bleaching_process` 
                       ...
                       <div class="panel panel-default">
						  ...
						  <tr>
							 ...
							 <td>
                                       ...
                                       <button type="button" id="edit_scouring_bleaching" name="edit_scouring_bleaching"  class="btn btn-info btn-xs" onclick="load_page('process_program/edit_defining_qc_standard_for_scouring_bleaching_process.php?scouring_bleaching_id=<?php echo $row['id'] ?>')"> Edit </button>
                                       ...
                                       <!-- <button type="button" id="delete_scouring_bleaching" name="delete_scouring_bleaching"  class="btn btn-danger btn-xs" onclick="load_page('process_program/deleting_scouring_bleaching_process_standard.php?scouring_bleaching_id=<?php echo $row['id'] ?>')"> Delete </button> -->
                               </td>
                              <?php
...
<div id="div_resistance_to_surface_fuzzing_and_pilling" > 
      ...
      <div class="form-group form-group-sm" for="surface_fuzzing_and_pilling_value">
          ...
          <div class="col-sm-1 text-center">
            ...
            <input type="hidden" name="uom_of_resistance_to_surface_fuzzing_and_pilling" id="uom_of_resistance_to_surface_fuzzing_and_pilling" value="">    
