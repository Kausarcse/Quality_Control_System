...
*/ document.getElementById('color').value=splitted_version_details[1];
  ...
  document.getElementById('process_id').value='proc_1';
...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
                	...
                	<?php 
                		...
                		{
                			?>
							<div class="panel-heading" style="color:#191970;"><b>Model For Singe And Desize Process</b></div> <!-- This will create a upper block for FORM (Just Beautification) -->
										...
										<table id="datatable-buttons" class="table table-striped table-bordered">
					                        <thead>
					                          ...
					                          <?php
		                                        	...
		                                        	$sql_for_singe_and_desize = "SELECT * FROM `model_defining_qc_standard_for_singe_and_desize_process` 
										...
										<thead>
										  ...
										  <tr>
											 ...
											 <td>
				                                      ...
				                                      <button type="submit" id="edit_singe_and_desize" name="edit_singe_and_desize"  class="btn btn-info btn-xs" onclick="load_page('process_program/edit_defining_qc_standard_for_singe_and_desize_process.php?singe_and_desize_id=<?php echo $row['id'] ?>')"> Edit </button>
