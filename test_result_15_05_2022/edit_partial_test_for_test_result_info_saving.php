...
$process_id=$splitted_data_for_process[1];  //changed
...
mysqli_query($con,"START TRANSACTION") or die(mysqli_error($con));
 ...
 $select_sql_for_duplicacy="select * from `partial_test_for_test_result_info` where `pp_number`='$pp_number' and `process_id`='$process_id' and `version_number`='$version_number' AND
