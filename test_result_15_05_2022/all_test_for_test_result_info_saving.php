...
$all_test_for_test_result_creation_date= $_POST['all_test_for_test_result_creation_date'];
$alternate_all_test_for_test_result_creation_date_time= $_POST['alternate_all_test_for_test_result_creation_date_time'];
$splitted_pp_creation_date= explode("/",$all_test_for_test_result_creation_date);
$all_test_for_test_result_creation_date= $splitted_pp_creation_date[2]."-".$splitted_pp_creation_date[1]."-".$splitted_pp_creation_date[0];
...
else if( mysqli_num_rows($result) < 1)
{
	...
	$insert_sql_statement="INSERT INTO `partial_test_for_test_result_info`
	     ...
	     VALUES
	   (
	   '$all_test_for_test_result_creation_date',
	   '$alternate_all_test_for_test_result_creation_date_time',
	   '$trf_id',
	   '$employee_id',
	   '$employee_name',
	   '$shift',
