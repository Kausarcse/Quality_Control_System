...
$splitted_data_for_process= explode('?fs?', $process_names);
$process_name=$splitted_data_for_process[0];  //changed
...
$select_sql_for_duplicacy="select * from `partial_test_for_test_result_info` where `pp_number`='$pp_number' and `process_name`='$process_name' and `version_number`='$version_number' AND
`partial_test_for_test_result_creation_date`='$partial_test_for_test_result_creation_date' AND
	`alternate_partial_test_for_test_result_creation_date_time`='$alternate_partial_test_for_test_result_creation_date_time' AND
...
else if( mysqli_num_rows($result) < 1)
{
	...
	$update_sql_statement="UPDATE `partial_test_for_test_result_info` SET
