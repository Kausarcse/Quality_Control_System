...
{ 
	...
	$result_duplicate_adding_process_to_version= mysqli_query($con,$duplicate_adding_process_to_version) or die(mysqli_error($con));
	...
	if ($check_duplicate_adding_process_to_version >= 1) 
	{
			   ...
			   $new_pp_version_select="select * from `pp_wise_version_creation_info` where `pp_number`='$pp_number' and `version_id`='$new_pp_version_id'";
				...
				$result = mysqli_query($con,$new_pp_version_select) or die(mysqli_error($con));
				...
				while($row = mysqli_fetch_array($result)) 
				{
					...
					$customer_id= $row_new_pp_info_select['customer_id'];
						...
						$result_adding_process_to_version = mysqli_query($con,$adding_process_to_version) or die(mysqli_error($con));
							...
							while($row_adding_process_to_version = mysqli_fetch_array($result_adding_process_to_version))
							{
                             ...
                             $finish_width_in_inch_for_pp_monitoring=$row_adding_process_to_version['finish_width_in_inch'];
							  ...
							  /*if($new_pp_version_id=='')
							  {
								...
								$adding_pp_monitoring="select current_status,current_state from `pp_monitoring` where `pp_number`='$pp_number' and `version_number` = '$version_name' and `style_name`='$style_name' and `finish_width_in_inch`='$finish_width_in_inch'";
				...
				$result_duplicate_calendering_process= mysqli_query($con,$duplicate_calendering_process) or die(mysqli_error($con));
				...
				else
				{
				    ...
				    $result_old_pp_version_calendering_process = mysqli_query($con,$old_pp_version_calendering_process) or die(mysqli_error($con));
                    ...
                    /*............................................................Copy Scouring & Bleaching..............................................................*/
							...
							$result_duplicate_scouring_bleaching_process= mysqli_query($con,$duplicate_scouring_bleaching_process) or die(mysqli_error($con));
							...
							else
							{
							    ...
							    $result_old_pp_version_scouring_bleaching_process = mysqli_query($con,$old_pp_version_scouring_bleaching_process) or die(mysqli_error($con));
								...
								$old_data_for_all_ = "select * from `data_for_all_standard` where `version_id`='$old_version_name'";
								    $result_old_data_for_all = mysqli_query($con,$old_data_for_all_) or die(mysqli_error($con));
							...
							$result_duplicate_bleaching_process= mysqli_query($con,$duplicate_bleaching_process) or die(mysqli_error($con));
							...
							else
							{
							    ...
							    $result_old_pp_version_bleaching_process = mysqli_query($con,$old_pp_version_bleaching_process) or die(mysqli_error($con));
							...
							$result_duplicate_curing_process= mysqli_query($con,$duplicate_curing_process) or die(mysqli_error($con));
							...
							else
							{
							    ...
							    $result_old_pp_version_curing_process = mysqli_query($con,$old_pp_version_curing_process) or die(mysqli_error($con));
								...
								$appearance_after_washing_garments_surface_pilling_tolerance_range_math_operator=$row_old_pp_version_curing_process['appear_after_washing_garments_surface_pilling_math_op'];
								...
								$appearance_after_washing_fabric_cross_staining_tolerance_range_math_operator=$row_old_pp_version_curing_process['appearance_after_washing_fabric_cross_staining_math_op'];
								...
								$appearance_after_washing_fabric_surface_fuzzing_tolerance_range_math_operator=$row_old_pp_version_curing_process['appearance_after_washing_fabric_surface_fuzzing_math_op'];
								...
								$appearance_after_washing_fabric_surface_pilling_tolerance_range_math_operator=$row_old_pp_version_curing_process['appearance_after_washing_fabric_surface_pilling_math_op'];
								...
								$appearance_after_washing_fabric_crease_before_ironing_tolerance_range_math_operator=$row_old_pp_version_curing_process['appearance_after_washing_fabric_crease_before_iron_math_op'];
								...
								$appearance_after_washing_fabric_crease_after_ironing_tolerance_range_math_operator=$row_old_pp_version_curing_process['appearance_after_washing_fabric_crease_after_iron_math_op'];
								...
								$appearance_after_washing_garments_color_change_without_suppressor_tolerance_range_math_operator=$row_old_pp_version_curing_process['appear_after_washing_garments_color_change_without_sup_math_op'];
								...
								$appearance_after_washing_garments_color_change_with_suppressor_tolerance_range_math_operator=$row_old_pp_version_curing_process['appear_after_washing_garments_color_change_with_sup_math_op'];
								...
								$appearance_after_washing_garments_cross_staining_tolerance_range_math_operator=$row_old_pp_version_curing_process['appear_after_washing_garments_cross_staining_math_op'];
								...
								$appearance_after_washing_garments_differential_shrinkage_tolerance_range_math_operator=$row_old_pp_version_curing_process['appear_after_washing_garments_differential_shrink_math_op'];
								...
								$appearance_after_washing_garments_surface_fuzzing_tolerance_range_math_operator=$row_old_pp_version_curing_process['appear_after_washing_garments_surface_fuzzing_math_op'];
								...
								$appearance_after_washing_garments_crease_after_ironing_tolerance_range_math_operator=$row_old_pp_version_curing_process['appear_after_washing_garments_crease_after_ironing_math_op'];
								...
								$appearance_after_washing_garments_seam_puckering_roping_after_iron_tolerance_range_math_operator=$row_old_pp_version_curing_process['appear_after_wash_garments_seam_pucker_rop_iron_math_op'];
							...
							$result_duplicate_finishing_process= mysqli_query($con,$duplicate_finishing_process) or die(mysqli_error($con));
						    ...
						    $result_old_pp_version_finishing_process = mysqli_query($con,$old_pp_version_finishing_process) or die(mysqli_error($con));
...
$test_method_for_cf_to_rubbing_dry= $row_old_pp_version_finishing_process['test_method_for_cf_to_rubbing_dry'];
						...
						$appearance_after_washing_fabric_cross_staining_tolerance_range_math_operator=$row_old_pp_version_finishing_process['appearance_after_washing_fabric_cross_staining_math_op'];
						...
						$appearance_after_washing_fabric_surface_fuzzing_tolerance_range_math_operator=$row_old_pp_version_finishing_process['appearance_after_washing_fabric_surface_fuzzing_math_op'];
						...
						$appearance_after_washing_fabric_surface_pilling_tolerance_range_math_operator=$row_old_pp_version_finishing_process['appearance_after_washing_fabric_surface_pilling_math_op'];
						...
						$appearance_after_washing_fabric_crease_before_ironing_tolerance_range_math_operator=$row_old_pp_version_finishing_process['appearance_after_washing_fabric_crease_before_iron_math_op'];
						...
						$appearance_after_washing_fabric_crease_after_ironing_tolerance_range_math_operator=$row_old_pp_version_finishing_process['appearance_after_washing_fabric_crease_after_iron_math_op'];
						...
						$appearance_after_washing_cycle_garments_wash=$row_old_pp_version_finishing_process['appearance_after_washing_cycle_garments_wash'];
						...
						$appearance_after_washing_garments_color_change_without_suppressor_tolerance_range_math_operator=$row_old_pp_version_finishing_process['appear_after_washing_garments_color_change_without_sup_math_op'];
						...
						$appearance_after_washing_garments_color_change_with_suppressor_tolerance_range_math_operator=$row_old_pp_version_finishing_process['appear_after_washing_garments_color_change_with_sup_math_op'];
						...
						$appearance_after_washing_garments_cross_staining_tolerance_range_math_operator=$row_old_pp_version_finishing_process['appear_after_washing_garments_cross_staining_math_op'];
						...
						$appearance_after_washing_garments_differential_shrinkage_tolerance_range_math_operator=$row_old_pp_version_finishing_process['appear_after_washing_garments_differential_shrink_math_op'];
						...
						$appearance_after_washing_garments_surface_fuzzing_tolerance_range_math_operator=$row_old_pp_version_finishing_process['appear_after_washing_garments_surface_fuzzing_math_op'];
						...
						$appearance_after_washing_garments_surface_pilling_tolerance_range_math_operator=$row_old_pp_version_finishing_process['appear_after_washing_garments_surface_pilling_math_op'];
						...
						$appearance_after_washing_garments_crease_after_ironing_tolerance_range_math_operator=$row_old_pp_version_finishing_process['appear_after_washing_garments_crease_after_ironing_math_op'];
						...
						$appearance_after_washing_garments_seam_puckering_roping_after_iron_tolerance_range_math_operator=$row_old_pp_version_finishing_process['appear_after_wash_garments_seam_pucker_rop_iron_math_op'];
						...
						$odor_garments=$row_old_pp_version_finishing_process['odor_garments'];
							...
							$result_duplicate_greige_receiving_process= mysqli_query($con,$duplicate_greige_receiving_process) or die(mysqli_error($con));
							...
							else
							{
							    ...
							    $result_old_pp_version_greige_receiving_process = mysqli_query($con,$old_pp_version_greige_receiving_process) or die(mysqli_error($con));
							...
							$result_duplicate_mercerize_process= mysqli_query($con,$duplicate_mercerize_process) or die(mysqli_error($con));
							...
							else
							{
							    ...
							    $result_old_pp_version_mercerize_process = mysqli_query($con,$old_pp_version_mercerize_process) or die(mysqli_error($con));
							...
							$result_duplicate_printing_process= mysqli_query($con,$duplicate_printing_process) or die(mysqli_error($con));
							...
							else
							{
							    ...
							    $result_old_pp_version_printing_process = mysqli_query($con,$old_pp_version_printing_process) or die(mysqli_error($con));
							...
							$result_duplicate_raising_process= mysqli_query($con,$duplicate_raising_process) or die(mysqli_error($con));
							...
							else
							{
							    ...
							    $result_old_pp_version_raising_process = mysqli_query($con,$old_pp_version_raising_process) or die(mysqli_error($con));
							...
							$result_duplicate_ready_for_dying_process= mysqli_query($con,$duplicate_ready_for_dying_process) or die(mysqli_error($con));
							...
							else
							{
							    ...
							    $result_old_pp_version_ready_for_dying_process = mysqli_query($con,$old_pp_version_ready_for_dying_process) or die(mysqli_error($con));
							...
							$result_duplicate_ready_for_mercerize_process= mysqli_query($con,$duplicate_ready_for_mercerize_process) or die(mysqli_error($con));
							...
							else
							{
							    ...
							    $result_old_pp_version_ready_for_mercerize_process = mysqli_query($con,$old_pp_version_ready_for_mercerize_process) or die(mysqli_error($con));
      ...
      /*............................................................Copy ready_for_printing..............................................................*/
							...
							$result_duplicate_ready_for_printing_process= mysqli_query($con,$duplicate_ready_for_printing_process) or die(mysqli_error($con));
							...
							else
							{
							    ...
							    $result_old_pp_version_ready_for_printing_process = mysqli_query($con,$old_pp_version_ready_for_printing_process) or die(mysqli_error($con));
							...
							$result_duplicate_ready_for_raising_process= mysqli_query($con,$duplicate_ready_for_raising_process) or die(mysqli_error($con));
							...
							else
							{
							    ...
							    $result_old_pp_version_ready_for_raising_process = mysqli_query($con,$old_pp_version_ready_for_raising_process) or die(mysqli_error($con));
				...
				$result_duplicate_sanforizing_process= mysqli_query($con,$duplicate_sanforizing_process) or die(mysqli_error($con));
				...
				else
				{
				    ...
				    $result_old_pp_version_sanforizing_process = mysqli_query($con,$old_pp_version_sanforizing_process) or die(mysqli_error($con));
					...
					$uom_of_seam_properties_seam_strength_iso_astm_d_in_weft= $row_old_pp_version_sanforizing_process['uom_of_seam_properties_seam_strength_iso_astm_d_in_weft'];
					 ...
					 $insert_sql_statement_for_sanforizing="INSERT INTO `defining_qc_standard_for_sanforizing_process`( 
                      ...
                      $result_of_data_for_sanforizing = mysqli_query($con,$insert_sql_statement_for_sanforizing) or die(mysqli_error($con));
							...
							$result_duplicate_scouring_process= mysqli_query($con,$duplicate_scouring_process) or die(mysqli_error($con));
							...
							{    echo "  Data is Successfully Copied";
							    ...
							    $result_old_pp_version_scouring_process = mysqli_query($con,$old_pp_version_scouring_process) or die(mysqli_error($con));
							...
							$result_duplicate_singe_and_desize_process= mysqli_query($con,$duplicate_singe_and_desize_process) or die(mysqli_error($con));
							...
							else
							{
							    ...
							    $result_old_pp_version_singe_and_desize_process = mysqli_query($con,$old_pp_version_singe_and_desize_process) or die(mysqli_error($con));
      ...
      /*............................................................Copy washing..............................................................*/
							...
							$result_duplicate_washing_process= mysqli_query($con,$duplicate_washing_process) or die(mysqli_error($con));
							...
							else
							{
							    ...
							    $result_old_pp_version_washing_process = mysqli_query($con,$old_pp_version_washing_process) or die(mysqli_error($con));
