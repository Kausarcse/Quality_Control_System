...
function calculate_fiber_cotent()
{
 ...
 function sending_data_of_copy_form_previous_pp_for_saving_in_database()
 {
       ...
       var url_encoded_form_data = $("#copy_form_previous_pp").serialize(); 
		  	 ...
		  	 $.ajax({
			 		url: 'copy/copy_from_previous_pp.php',
			 		dataType: 'text',
			 		type: 'post',
			 		contentType: 'application/x-www-form-urlencoded',
...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
				...
				<div class="panel-heading" style="color:#191970;"><b>Copy from Previous PP Info</b></div> <!-- This will create a upper block for FORM (Just Beautification) -->
            ...
            <label class="control-label col-sm-3" for="new_pp_number" style="margin-right:0px; color:#00008B;">PP Number:</label> 
              <div class="col-sm-5">
                <select  class="form-control for_auto_complete" id="new_pp_number" name="new_pp_number">
                      ...
                      <?php 
                         ...
                         while( $row = mysqli_fetch_array( $result))
                         {
                           ...
                           echo '<option value="'.$row['pp_num_id'].'?fs?'.$row['pp_number'].'">'.$row['pp_number'].'</option>';
