...
$select_sql_for_duplicacy="select * from `model_defining_qc_standard_for_calendering_process` where 
...
else if( mysqli_num_rows($result) < 1)
{
	 ...
	 $update_sql_statement_for_model="UPDATE model_defining_qc_standard_for_calendering_process SET
...
if($data_previously_saved == "Yes")
{
	...
	echo "Calander Model is previously saved.";
...
else if($data_insertion_hampering == "No" )
{
	...
	echo "Calander Model is successfully updated.";
...
else
{
	...
	mysqli_query($con,"ROLLBACK");
	echo "Calander Model is not successfully updated.";
