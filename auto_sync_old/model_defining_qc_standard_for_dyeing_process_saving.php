...
$select_sql_for_duplicacy="select * from `model_defining_qc_standard_for_dyeing_process` where 
...
else if( mysqli_num_rows($result) < 1)
{
    ...
    $insert_sql_for_define_model="insert into `model_defining_qc_standard_for_dyeing_process`
    ( 
        `customer_id`,
        `customer_name`,
        `version_number`,
