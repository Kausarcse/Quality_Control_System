...
$model_scouring_bleaching_id = '';

if(isset($_GET['model_scouring_bleaching_id']))
{
   $model_scouring_bleaching_id=$_GET['model_scouring_bleaching_id'];
   $sql_for_model_scouring_bleaching="select * from model_defining_qc_standard_for_scouring_bleaching_process where `id`='$model_scouring_bleaching_id'";
   $result_for_model_scouring_bleaching= mysqli_query($con,$sql_for_model_scouring_bleaching) or die(mysqli_error($con));
   $row_for_model_scouring_bleaching = mysqli_fetch_array( $result_for_model_scouring_bleaching);
}
...
{  
 ...
 function sending_data_of_edit_defining_qc_standard_for_model_scouring_bleaching_process_form_for_saving_in_database()
{
       var url_encoded_form_data = $("#defining_qc_standard_for_model_scouring_bleaching_process_form").serialize();

       $.ajax({
        url: 'auto_sync/edit_model_defining_qc_standard_for_scouring_bleaching_process_saving.php',
        dataType: 'text',
        type: 'post',
        contentType: 'application/x-www-form-urlencoded',
...
}//End of function sending_data_of_defining_qc_standard_for_model_scouring_bleaching_process_form_for_saving_in_database()
...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
				...
				<div class="panel-heading" style="color:#191970;"><b>Edit Model Defining Standard For Scouring and Bleaching Process</b></div> 
                ...
                <div id='search_form_collpapsible_div_1' class="collapse in"> 
                     ...
                     <form class="form-horizontal" action="" style="margin-top:10px;" name="defining_qc_standard_for_model_scouring_bleaching_process_form_view" id="defining_qc_standard_for_model_scouring_bleaching_process_form_view" data-toggle="collapse" data-target="#search_form_collpapsible_div">
	                       ...
	                       <table id="datatable-buttons" class="table table-striped table-bordered">
	                        <thead>
	                          ...
	                          <?php
                                  ...
                                  if(isset($model_scouring_bleaching_id))
                                  {
                                     $sql_for_model_scouring_bleaching = "SELECT * FROM `model_defining_qc_standard_for_scouring_bleaching_process` WHERE `id`='$model_scouring_bleaching_id'";
                                  }


                                  $res_for_model_scouring_bleaching = mysqli_query($con, $sql_for_model_scouring_bleaching);

                                  while ($row = mysqli_fetch_assoc($res_for_model_scouring_bleaching))
                                  {
	                           ...
	                           ?>
	                           		...
	                           		<tr>
                                         ...
                                         <button type="submit" id="edit_model_scouring_bleaching" name="edit_model_scouring_bleaching"  class="btn btn-info btn-xs" onclick="load_page('auto_sync/edit_model_defining_qc_standard_for_scouring_bleaching_process.php?model_scouring_bleaching_id=<?php echo $row['id'] ?>')"> Edit </button>
               ...
               </form>    <!-- End of <form class="form-horizontal" action="" style="margin-top:10px;" name="defining_qc_standard_for_model_scouring_bleaching_process_form" id="defining_qc_standard_for_model_scouring_bleaching_process_form"> -->

	</div> <!-- End of <div class="panel-heading" style="color:#191970;"><b> model_scouring_bleaching Standard Process List</b></div>  -->

   <button type="button" class="btn btn-info" id="buttn_for_load_form" onclick="load_full_form('<?php echo $row_for_model_scouring_bleaching['customer_id']?>')">Load Form</button>
    ...
    <form class="form-horizontal" action="" style="margin-top:10px;" name="defining_qc_standard_for_model_scouring_bleaching_process_form" id="defining_qc_standard_for_model_scouring_bleaching_process_form">
						...
						<input type="hidden" class="form-control" id="version_number" name="version_number" value="<?php echo $row_for_model_scouring_bleaching['version_number']; ?>">
						<input type="hidden" class="form-control" id="customer_id" name="customer_id" value="<?php echo $row_for_model_scouring_bleaching['customer_id']; ?>">
						<input type="hidden" class="form-control" id="customer_name" name="customer_name" value="<?php echo $row_for_model_scouring_bleaching['customer_name']; ?>">
						<input type="hidden" class="form-control" id="color_name" name="color_name" value="<?php echo $row_for_model_scouring_bleaching['color']; ?>">
						<input type="hidden" class="form-control" id="process_name" name="process_name" value="<?php echo $row_for_model_scouring_bleaching['process_name']; ?>">
						<input type="hidden" class="form-control" id="process_serial" name="process_serial" value="<?php echo $row_for_model_scouring_bleaching['process_serial']; ?>">
						<input type="hidden" class="form-control" id="process_technique_name" name="process_technique_name" value="<?php echo $row_for_model_scouring_bleaching['process_technique']; ?>">
  ...
  <div class="col-sm-3 text-center">
   ...
   <div class="col-sm-2 text-center">
      ...
      <div class="col-sm-1 text-center" for="min_value">
        ...
        <input type="text" class="form-control" id="whiteness_min_value" name="whiteness_min_value"  value="<?php echo $row_for_model_scouring_bleaching['whiteness_min_value']?>" required>

      </div>
          
      <div class="col-sm-1 text-center">
          
       <input type="text" class="form-control" id="whiteness_max_value" name="whiteness_max_value" value="<?php echo $row_for_model_scouring_bleaching['whiteness_max_value']?>" required>
...
<div class="form-group form-group-sm" >
     ...
     <div class="col-sm-1 text-center">
      ...
      <div class="col-sm-1 text-center" for="min_value">
       ...
       <input type="text" class="form-control" id="residual_sizing_material_min_value" name="residual_sizing_material_min_value" value="<?php echo $row_for_model_scouring_bleaching['residual_sizing_material_min_value']?>" required>

      </div>
          
      <div class="col-sm-1 text-center">
          
       <input type="text" class="form-control" id="residual_sizing_material_max_value" name="residual_sizing_material_max_value" value="<?php echo $row_for_model_scouring_bleaching['residual_sizing_material_max_value']?>" required>
  ...
  <div class="col-sm-3 text-center">
   ...
   <div class="col-sm-2 text-center">
      ...
      <div class="col-sm-1 text-center" for="min_value">
       ...
       <input type="text" class="form-control" id="absorbency_min_value" name="absorbency_min_value"  value="<?php echo $row_for_model_scouring_bleaching['absorbency_min_value']?>" required>

      </div>
          
      <div class="col-sm-1 text-center">
          
       <input type="text" class="form-control" id="absorbency_max_value" name="absorbency_max_value"  value="<?php echo $row_for_model_scouring_bleaching['absorbency_max_value']?>" required>
...
<div class="form-group form-group-sm" for="surface_fuzzing_and_pilling_value">
    ...
    <div class="col-sm-3 text-center">
     ...
     <div class="col-sm-2 text-center">
          ...
          <select  class="form-control" id="description_or_type_for_surface_fuzzing_and_pilling" name="description_or_type_for_surface_fuzzing_and_pilling" >
            ...
            <?php
                              $description_or_type_for_surface_fuzzing_and_pilling = $row_for_model_scouring_bleaching['description_or_type_for_surface_fuzzing_and_pilling'];
                             ?>
                             <?php 
     ...
     <div class="col-sm-1 text-center">
     <input type="text" class="form-control" id="rubs_for_surface_fuzzing_and_pilling" name="rubs_for_surface_fuzzing_and_pilling" value="<?php echo $row_for_model_scouring_bleaching['rubs_for_surface_fuzzing_and_pilling']?>" required>
  ...
  <div class="col-sm-1 text-center">
      <select  class="form-control" id="surface_fuzzing_and_pilling_tolerance_range_math_operator" name="surface_fuzzing_and_pilling_tolerance_range_math_operator" onchange="surface_fuzzing_and_pilling_cal()">
        ...
        <?php
                              $surface_fuzzing_and_pilling_tolerance_range_math_operator = $row_for_model_scouring_bleaching['surface_fuzzing_and_pilling_tolerance_range_math_operator'];
  ...
  <div class="col-sm-1" for="tolerance">
      ...
      <select  class="form-control" id="surface_fuzzing_and_pilling_tolerance_value" name="surface_fuzzing_and_pilling_tolerance_value" onchange="surface_fuzzing_and_pilling_cal()">
            ...
            <?php
                              $surface_fuzzing_and_pilling_tolerance_value = $row_for_model_scouring_bleaching['surface_fuzzing_and_pilling_tolerance_value'];
  ...
  <div class="col-sm-1 text-center" for="min_value">
    ...
    <input type="text" class="form-control" id="surface_fuzzing_and_pilling_min_value" name="surface_fuzzing_and_pilling_min_value" value="<?php echo $row_for_model_scouring_bleaching['surface_fuzzing_and_pilling_min_value']?>" required>
  </div>
          
  <div class="col-sm-1 text-center">
      
    <input type="text" class="form-control" id="surface_fuzzing_and_pilling_max_value" name="surface_fuzzing_and_pilling_max_value" value="<?php echo $row_for_model_scouring_bleaching['surface_fuzzing_and_pilling_max_value']?>" required>
...
<div class="form-group form-group-sm" >
  ...
  <div class="col-sm-1 text-center" for="min_value">
   ...
   <input type="text" class="form-control" id="ph_min_value" name="ph_min_value" value="<?php echo $row_for_model_scouring_bleaching['ph_min_value']?>" required>

  </div>
          
  <div class="col-sm-1 text-center">
      
   <input type="text" class="form-control" id="ph_max_value" name="ph_max_value" value="<?php echo $row_for_model_scouring_bleaching['ph_max_value']?>" required>
...
<!-- *********************************** Designing Tabular Formar (Multi-Column Form Elements Here (End))*********************************** -->
						...
						<div class="form-group form-group-sm">
								<div class="col-sm-offset-3 col-sm-5">
									<button type="button" class="btn btn-primary" onClick="sending_data_of_edit_defining_qc_standard_for_model_scouring_bleaching_process_form_for_saving_in_database()">Edit</button>
