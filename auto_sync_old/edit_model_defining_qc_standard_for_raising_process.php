...
if(isset($_GET['model_raising_id']))
{
   $model_raising_id=$_GET['model_raising_id'];
   $sql_for_model_raising="select * from model_defining_qc_standard_for_raising_process where `id`='$model_raising_id'";
   $result_for_model_raising= mysqli_query($con,$sql_for_model_raising) or die(mysqli_error($con));
   $row_for_model_raising = mysqli_fetch_array( $result_for_model_raising);
}
...
{  
 ...
 function sending_data_of_edit_defining_qc_standard_for_model_raising_process_form_for_saving_in_database()
{
       var url_encoded_form_data = $("#defining_qc_standard_for_model_raising_process_form").serialize();

       $.ajax({
        url: 'auto_sync/edit_model_defining_qc_standard_for_raising_process_saving.php',
        dataType: 'text',
        type: 'post',
...
}//End of function sending_data_of_defining_qc_standard_for_model_raising_process_form_for_saving_in_database()
...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
				...
				<div class="panel-heading" style="color:#191970;"><b>Edit Model Defining Standard For Raising Process</b></div> 
                ...
                <div id='search_form_collpapsible_div_1' class="collapse in"> 
                     ...
                     <form class="form-horizontal" action="" style="margin-top:10px;" name="defining_qc_standard_for_model_raising_process_form_view" id="defining_qc_standard_for_model_raising_process_form_view" data-toggle="collapse" data-target="#search_form_collpapsible_div">
	                       ...
	                       <table id="datatable-buttons" class="table table-striped table-bordered">
	                        <thead>
	                          ...
	                          <?php
                                  ...
                                  if(isset($model_raising_id))
                                  {
                                    $sql_for_model_raising = "SELECT * FROM `model_defining_qc_standard_for_raising_process` WHERE `id`='$model_raising_id'";
                                  }


                                  $res_for_model_raising = mysqli_query($con, $sql_for_model_raising);

                                  while ($row = mysqli_fetch_assoc($res_for_model_raising))
                                  {
	                           ...
	                           ?>
	                           		...
	                           		<tr>
										 ...
										 <td>
                                         <button type="submit" id="edit_model_raising" name="edit_model_raising"  class="btn btn-info btn-xs" onclick="load_page('auto_sync/edit_model_defining_qc_standard_for_raising_process.php?model_raising_id=<?php echo $row['id'] ?>')"> Edit </button>
			                             </td>
	                              <?php
               ...
               </form>    <!-- End of <form class="form-horizontal" action="" style="margin-top:10px;" name="defining_qc_standard_for_model_raising_process_form" id="defining_qc_standard_for_model_raising_process_form"> -->

	</div> <!-- End of <div class="panel-heading" style="color:#191970;"><b> model_raising Standard Process List</b></div>  -->

   <button type="button" class="btn btn-info" id="buttn_for_load_form" onclick="load_full_form('<?php echo $row_for_model_raising['customer_id']?>')">Load Form</button>
    ...
    <form class="form-horizontal" action="" style="margin-top:10px;" name="defining_qc_standard_for_model_raising_process_form" id="defining_qc_standard_for_model_raising_process_form">
						
						<input type="hidden" id="process_id" name="process_id"  value="proc_15">
						...
						<input type="hidden" class="form-control" id="version_number" name="version_number" value="<?php echo $row_for_model_raising['version_number']; ?>">
						<input type="hidden" class="form-control" id="customer_id" name="customer_id" value="<?php echo $row_for_model_raising['customer_id']; ?>">
						<input type="hidden" class="form-control" id="customer_name" name="customer_name" value="<?php echo $row_for_model_raising['customer_name']; ?>">
						<input type="hidden" class="form-control" id="color_name" name="color_name" value="<?php echo $row_for_model_raising['color']; ?>">
						<input type="hidden" class="form-control" id="process_name" name="process_name" value="<?php echo $row_for_model_raising['process_name']; ?>">
						<input type="hidden" class="form-control" id="process_serial" name="process_serial" value="<?php echo $row_for_model_raising['process_serial']; ?>">
						<input type="hidden" class="form-control" id="process_technique_name" name="process_technique_name" value="<?php echo $row_for_model_raising['process_technique']; ?>">
...
<div class="form-group form-group-sm" for="tensile_properties_in_warp">
  ...
  <div class="col-sm-1 text-center" >
      <select  class="form-control" id="tensile_properties_in_warp_value_tolerance_range_math_operator" name="tensile_properties_in_warp_value_tolerance_range_math_operator" onchange="tensile_properties_in_warp()">
              ...
              <?php
                              $tensile_properties_in_warp_value_tolerance_range_math_operator = $row_for_model_raising['tensile_properties_in_warp_value_tolerance_range_math_operator'];
  ...
  <div class="col-sm-1" for="tolerance">
     ...
     <input type="text" class="form-control" id="tensile_properties_in_warp_value_tolerance_value" name="tensile_properties_in_warp_value_tolerance_value" value="<?php echo $row_for_model_raising['tensile_properties_in_warp_value_tolerance_value']?>" onchange="tensile_properties_in_warp()" required>
  </div>
  ...
  <div class="col-sm-1" for="unit">
     <select  class="form-control" id="uom_of_tensile_properties_in_warp_value" name="uom_of_tensile_properties_in_warp_value">
              ...
              <?php
                              $uom_of_tensile_properties_in_warp_value = $row_for_model_raising['uom_of_tensile_properties_in_warp_value'];
  ...
  <div class="col-sm-1 text-center" for="min_value">
      ...
      <input type="text" class="form-control" id="tensile_properties_in_warp_value_min_value" name="tensile_properties_in_warp_value_min_value" value="<?php echo $row_for_model_raising['tensile_properties_in_warp_value_min_value']?>" required>
  </div>
          
  <div class="col-sm-1 text-center">
      
    <input type="text" class="form-control" id="tensile_properties_in_warp_value_max_value" name="tensile_properties_in_warp_value_max_value" value="<?php echo $row_for_model_raising['tensile_properties_in_warp_value_max_value']?>" required>
...
<div class="form-group form-group-sm" for="tensile_properties_in_weft">
  ...
  <div class="col-sm-1 text-center">
      <select  class="form-control" id="tensile_properties_in_weft_value_tolerance_range_math_operator" name="tensile_properties_in_weft_value_tolerance_range_math_operator" onchange="tensile_properties_in_weft()">
              ...
              <?php
                              $tensile_properties_in_weft_value_tolerance_range_math_operator = $row_for_model_raising['tensile_properties_in_weft_value_tolerance_range_math_operator'];
  ...
  <div class="col-sm-1" for="tolerance">
     ...
     <input type="text" class="form-control" id="tensile_properties_in_weft_value_tolerance_value" name="tensile_properties_in_weft_value_tolerance_value" value="<?php echo $row_for_model_raising['tensile_properties_in_weft_value_tolerance_value']?>" onchange="tensile_properties_in_weft()" required>
  </div>
  ...
  <div class="col-sm-1" for="unit">
     <select  class="form-control" id="uom_of_tensile_properties_in_weft_value" name="uom_of_tensile_properties_in_weft_value">
              ...
              <?php
                              $uom_of_tensile_properties_in_weft_value = $row_for_model_raising['uom_of_tensile_properties_in_weft_value'];
  ...
  <div class="col-sm-1 text-center" for="min_value">
      ...
      <input type="text" class="form-control" id="tensile_properties_in_weft_value_min_value" name="tensile_properties_in_weft_value_min_value" value="<?php echo $row_for_model_raising['tensile_properties_in_weft_value_min_value']?>" required>
  </div>
          
  <div class="col-sm-1 text-center">
      
    <input type="text" class="form-control" id="tensile_properties_in_weft_value_max_value" name="tensile_properties_in_weft_value_max_value" value="<?php echo $row_for_model_raising['tensile_properties_in_weft_value_max_value']?>" required>
...
<div class="form-group form-group-sm" for="tear_force_in_warp_value">
  ...
  <div class="col-sm-1 text-center">
      <select  class="form-control" id="tear_force_in_warp_value_tolerance_range_math_operator" name="tear_force_in_warp_value_tolerance_range_math_operator" onchange="tear_force_in_warp_cal()">
              ...
              <?php
                              $tear_force_in_warp_value_tolerance_range_math_operator = $row_for_model_raising['tear_force_in_warp_value_tolerance_range_math_operator'];
  ...
  <div class="col-sm-1" for="tolerance">
     ...
     <input type="text" class="form-control" id="tear_force_in_warp_value_tolerance_value" name="tear_force_in_warp_value_tolerance_value" value="<?php echo $row_for_model_raising['tear_force_in_warp_value_tolerance_value']?>" onchange="tear_force_in_warp_cal()" required>
  </div>
  ...
  <div class="col-sm-1" for="unit">
     <select  class="form-control" id="uom_of_tear_force_in_warp_value" name="uom_of_tear_force_in_warp_value">
              ...
              <?php
                              $uom_of_tear_force_in_warp_value = $row_for_model_raising['uom_of_tear_force_in_warp_value'];
  ...
  <div class="col-sm-1 text-center" for="min_value">
      ...
      <input type="text" class="form-control" id="tear_force_in_warp_value_min_value" name="tear_force_in_warp_value_min_value" value="<?php echo $row_for_model_raising['tear_force_in_warp_value_min_value']?>" required>
  </div>
          
  <div class="col-sm-1 text-center">
      
    <input type="text" class="form-control" id="tear_force_in_warp_value_max_value" name="tear_force_in_warp_value_max_value" value="<?php echo $row_for_model_raising['tear_force_in_warp_value_max_value']?>" required>
...
<div class="form-group form-group-sm" for="tear_force_in_weft_value">
  ...
  <div class="col-sm-1 text-center">
      <select  class="form-control" id="tear_force_in_weft_value_tolerance_range_math_operator" name="tear_force_in_weft_value_tolerance_range_math_operator" onchange="tear_force_in_weft_cal()">
              ...
              <?php
                              $tear_force_in_weft_value_tolerance_range_math_operator = $row_for_model_raising['tear_force_in_weft_value_tolerance_range_math_operator'];
  ...
  <div class="col-sm-1" for="tolerance">
     ...
     <input type="text" class="form-control" id="tear_force_in_weft_value_tolerance_value" name="tear_force_in_weft_value_tolerance_value" value="<?php echo $row_for_model_raising['tear_force_in_weft_value_tolerance_value']?>" onchange="tear_force_in_weft_cal()" required>
  </div>
  ...
  <div class="col-sm-1" for="unit">
     <select  class="form-control" id="uom_of_tear_force_in_weft_value" name="uom_of_tear_force_in_weft_value">
              ...
              <?php
                              $uom_of_tear_force_in_weft_value = $row_for_model_raising['uom_of_tear_force_in_weft_value'];
  ...
  <div class="col-sm-1 text-center" for="min_value">
    ...
    <input type="text" class="form-control" id="tear_force_in_weft_value_min_value" name="tear_force_in_weft_value_min_value" value="<?php echo $row_for_model_raising['tear_force_in_weft_value_min_value']?>" required>
  </div>
      
  <div class="col-sm-1 text-center">
      
    <input type="text" class="form-control" id="tear_force_in_weft_value_max_value" name="tear_force_in_weft_value_max_value" value="<?php echo $row_for_model_raising['tear_force_in_weft_value_max_value']?>" required>
...
<!-- *********************************** Designing Tabular Formar (Multi-Column Form Elements Here (End))*********************************** -->
						...
						<div class="form-group form-group-sm">
								<div class="col-sm-offset-3 col-sm-5">
									<button type="button" class="btn btn-primary" onClick="sending_data_of_edit_defining_qc_standard_for_model_raising_process_form_for_saving_in_database()">Edit</button>
