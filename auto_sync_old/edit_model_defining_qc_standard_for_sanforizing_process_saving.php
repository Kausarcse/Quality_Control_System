...
$select_sql_for_duplicacy="select * from `model_defining_qc_standard_for_sanforizing_process` where 
                            ...
                            `washing_cycle_for_warp_for_washing_before_iron` = '$washing_cycle_for_warp_for_washing_before_iron' and 
                             ...
                             `uom_of_dimensional_stability_to_warp_washing_before_iron` = '$uom_of_dimensional_stability_to_warp_washing_before_iron' and 
                              ...
                              `uom_of_dimensional_stability_to_weft_washing_before_iron` = '$uom_of_dimensional_stability_to_weft_washing_before_iron' and
                              ...
                              `uom_of_dimensional_stability_to_warp_washing_after_iron` = '$uom_of_dimensional_stability_to_warp_washing_after_iron' and 
                               ...
                               `uom_of_dimensional_stability_to_weft_washing_after_iron` = '$uom_of_dimensional_stability_to_weft_washing_after_iron' and
...
else if( mysqli_num_rows($result) < 1)
{
	 ...
	 $update_sql_statement_for_model="UPDATE model_defining_qc_standard_for_sanforizing_process SET
                                        ...
                                        `uom_of_dimensional_stability_to_warp_washing_before_iron` = '$uom_of_dimensional_stability_to_warp_washing_before_iron', 
                                        ...
                                        `uom_of_dimensional_stability_to_weft_washing_before_iron` = '$uom_of_dimensional_stability_to_weft_washing_before_iron',
                                        ...
                                        `uom_of_dimensional_stability_to_warp_washing_after_iron` = '$uom_of_dimensional_stability_to_warp_washing_after_iron', 
                                        ...
                                        `uom_of_dimensional_stability_to_weft_washing_after_iron` = '$uom_of_dimensional_stability_to_weft_washing_after_iron',
...
if($data_previously_saved == "Yes")
{
	...
	echo "Sanforizing Model is previously saved.";
...
else if($data_insertion_hampering == "No" )
{
	...
	echo "Sanforizing Model is successfully updated.";
...
else
{
	...
	mysqli_query($con,"ROLLBACK");
	echo "Sanforizing Model is not successfully updated.";
