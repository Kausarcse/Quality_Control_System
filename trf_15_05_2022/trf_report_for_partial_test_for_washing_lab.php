...
/*$sql_for_trf="select * from `partial_test_for_trf_info`,`test_method_for_customer` where `partial_test_for_trf_info`.`trf_id`='$trf_id' OR `test_method_for_customer`.`customer_id`='$customer_id'";*/
...
function generate_pdf(){
    ...
    html2pdf(element,{
        margin: 10,
        filename: 'partial_test_for_washing_lab.pdf',
     ...
     <div class="col-sm-12 col-md-12 col-lg-12" id="full_div">
				...
				<form class="form-horizontal" action="" style="margin-top:10px;" name="trf_form" id="trf_form"> 
                     ...
                     <div class="form-group" id="form-group_for_care_instruction">
                      ...
                      <fieldset class="col-sm-6 col-sm-offset-1"  style="border: 2px solid black; border-radius: 12px">
                      	<legend></legend>
                                 ...
                                 <label class="control-label col-sm-5" for="care_instruction" >Care Instruction </label>
                    ...
                    <div class="panel panel-default" style="background-color:#ffcc00;border: 2px solid; border-radius: 12px;text-align: center;margin:0 auto;">
	                     ...
	                     <div class="form-group form-group-sm" id="form-group_for_report_type" >
									...
									<label class="control-label" for="report_type" ><h5><b>Test Report Type:Partial Test</b></h5></label>
                 ...
                 <div class="panel panel-default" style="background-color:#ffff00;border: 2px solid ; border-radius: 12px;text-align: center;margin:0 auto;">
                  ...
                  <div class="panel panel-default" style="background-color:#3399ff;border: 2px solid; border-radius: 12px;text-align: center;">
			         ...
			         <div class="form-group form-group-sm" id="form-group_for_report_type">
								<label class="control-label" for="report_type" ><h5><b>Required Test(Washing Lab)</b> </h5></label>
                       ...
                       <tbody>
							...
							while($row = mysqli_fetch_assoc($res_for_trf))
							{
						     ...
						     if($row['criteria_or_testing_lab']=='Washing Lab'){
				    ...
				    <div class="form-group form-group-sm">
								<div class="col-sm-offset-3 col-sm-5">
									...
									<a href="trf/pdf_file_for_partial_test_trf_washing_lab.php?customer_id=<?php echo $value; ?>">
										<button type="button" id="pdf_file_for_partial_test_trf_washing_lab" name="pdf_file_for_partial_test_trf_washing_lab"  class="btn btn-success">Generate pdf file</button>
									</a>									<!-- <button type="button" class="btn btn-primary" id="btn_print" onClick="printContent()">Print</button> -->
