...
*/   
		...
		/* $sql = 'select percentage_of_cotton_content,design,version_number  from `pp_wise_version_creation_info` order by `percentage_of_cotton_content`';*/
		 $sql = "select * FROM `trf_info` WHERE trf_id='$trf_id'";

		 $result= mysqli_query($con,$sql) or die(mysqli_error($con));

		 while( $row = mysqli_fetch_array( $result))
		 {    
		 	 $partial_test_creation_date=$row['partial_test_creation_date'];
		 	 $shift=$row['shift'];
