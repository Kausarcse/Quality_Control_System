function partial_test_for_trf_Form_Validation()
{
   
    if(document.getElementById("partial_test_for_trf_creation_date").value.trim()=="")
    {
        alert("Please Provide Trf Creation Date");
        document.getElementById("partial_test_for_trf_creation_date").focus();
        return false;
    }
    else if(document.getElementById("alternate_partial_test_for_trf_creation_date_time").value.trim()=="")
    {
        alert("Please Provide Trf Creation Time");
        document.getElementById("alternate_partial_test_for_trf_creation_date_time").focus();
        return false;
    }
    ...
    else if(document.getElementById("pp_number").value.trim()=="select")
    {
    ...
    else if(document.getElementById("process_name_from").value.trim()=="select")
    {
        alert("Please Provide process name");
        document.getElementById("process_name_from").focus();
        return false;
    }
    else if(document.getElementById("process_name_to").value.trim()=="select")
    {
        alert("Please Provide process name");
        document.getElementById("process_name_to").focus();
        return false;
    }
    else if((document.getElementById("after_trolley_number_or_batcher_number").value.trim()=="select") && (document.getElementById("process_name_from").value.trim() != "proc_20?fs?Greige Receiving"))
    {
    ...
    else if((document.getElementById("process_name_from").value.trim() != "proc_20?fs?Greige Receiving") || (document.getElementById("process_name_from").value.trim() != "proc_1?fs?Singeing & Desizing") || (document.getElementById("process_name_from").value.trim() != "proc_21?fs?Singeing") || (document.getElementById("process_name_from").value.trim() != "proc_22?fs?Desizing"))
    {
