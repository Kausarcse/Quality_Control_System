				    ...
				    <div class="form-group form-group-sm">
								<div class="col-sm-offset-3 col-sm-5">
									...
									<a href="trf/pdf_file_for_partial_test_trf_physical_lab.php?customer_id=<?php echo $value; ?>">
										<button type="button" id="pdf_file_for_partial_test_trf_physical_lab" name="pdf_file_for_partial_test_trf_physical_lab"  class="btn btn-success">Generate pdf file</button>
									</a>
