...
*/   
		 ...
		 //$sql = "select * FROM `partial_test_for_trf_info`,`partial_test_for_trf_info` WHERE `partial_test_for_trf_info`.`trf_id`='$trf_id' OR `partial_test_for_trf_info`.`trf_id`='$trf_id'";
