...
$table="<div id='desizing_table' style='display:none;'><table class='table table-bordered'>
<thead><tr>
<th>Test Name</th>
<th>Test Result</th>
<th>Requirements</th>
<th>Remarks</th>
 ...
 <tbody> 
  ";
	...
	$result_for_desizing_process=mysqli_query($con,$sql_for_desizing_process) or die(mysqli_error($con));
	$row_for_defining_process=mysqli_fetch_array($result_for_desizing_process);
	...
	$result_for_desizing_process_qc=mysqli_query($con,$sql_for_desizing_process_qc_result) or die(mysqli_error($con));
	$row_for_qc=mysqli_fetch_array($result_for_desizing_process_qc);
...
$row_for_customer = mysqli_fetch_assoc($result_for_customer);
 ...
 $customer_type =  $row_for_customer['customer_type'];
	...
	$result= mysqli_query($con,$sql) or die(mysqli_error($con));
				 ...
				 {
                    if (in_array($row['id'], ['46']))       // machine speed
                    {
                    ...
                    if (in_array($row['id'], ['47']))         // bath temperature
                    {
