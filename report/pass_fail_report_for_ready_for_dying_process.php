...
$table="<div id='ready_for_dyeing_table' style='display:none'><table class='table table-bordered'>
<thead><tr>
<th>Test Name</th>
<th>Test Result</th>
<th>Requirements</th>
<th>Remarks</th>
 ...
 <tbody> 
  ";
	...
	$sql_for_ready_for_dying="select * from defining_qc_standard_for_ready_for_dying_process WHERE customer_name='$customer_name' and pp_number= '$pp_number' and version_number='$version_number'  and `finish_width_in_inch`='$finish_width_in_inch'";

	$result_for_ready_for_dying=mysqli_query($con,$sql_for_ready_for_dying) or die(mysqli_error($con));
	$row_for_defining_process=mysqli_fetch_array($result_for_ready_for_dying);
					 ...
					 if (in_array($row['id'], ['49']))
					 {
...

					  {
						...
						if($row_for_defining_process['whiteness_min_value']<=$row_for_qc['whiteness_left_value'] && $row_for_defining_process['whiteness_max_value']>=$row_for_qc['whiteness_left_value'] && $row_for_defining_process['whiteness_min_value']<=$row_for_qc['whiteness_center_value'] && $row_for_defining_process['whiteness_max_value']>=$row_for_qc['whiteness_center_value'] && $row_for_defining_process['whiteness_min_value']<=$row_for_qc['whiteness_right_value'] && $row_for_defining_process['whiteness_max_value']>=$row_for_qc['whiteness_right_value'])
						{
							...
							<td>Left: ".$row_for_qc['whiteness_left_value'].' Center: '.$row_for_qc['whiteness_center_value'].' Right '.$row_for_qc['whiteness_right_value'].' '.$row_for_defining_process['uom_of_whiteness']."</td>	
