...
$table ='
		...
		$sql = " SELECT DISTINCT 
					...
					,ptfti.partial_test_for_trf_creation_date 
					...
					,(SELECT qty from partial_test_for_trf_info pt 
					...
					,partial_test_for_trf_info ptfti  
					where 1=1
		 ...
		 {    
              $table .='<tr>
			                 <td>'.$row['partial_test_for_trf_creation_date'].'</td>
			                 <td>'.$row['GW'].'</td>
			                 <td>'.$row['FW'].'</td>
