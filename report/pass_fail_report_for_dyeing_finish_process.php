...
$table="<div id='dyeing_finish_table' style='display:none'><table class='table table-bordered'>
<thead><tr>
<th>Test Name</th>
<th>Test Result</th>
<th>Requirements</th>
 ...
 <tbody> 
  ";
	...
	/***************** Displaying Result from qc_standard table [Start] *****************/
	 $sql_for_dyeing_finish_process="SELECT * from defining_qc_standard_for_dyeing_finish_process 
                                    WHERE customer_name='$customer_name' and pp_number= '$pp_number' and 
                                    version_number='$version_number' and `finish_width_in_inch`='$finish_width_in_inch' ";

	$report_for_dyeing_finish_process=mysqli_query($con,$sql_for_dyeing_finish_process) or die(mysqli_error($con));
	$row_for_defining_process=mysqli_fetch_array($report_for_dyeing_finish_process);
	...
	/************ Displaying Result from qc_result table [Start] ************/
	 $sql_for_dyeing_finish_process_qc_result="SELECT * from qc_result_for_dyeing_finish_process 
                                            WHERE customer_name='$customer_name' and pp_number= '$pp_number' and 
		...
		$report_for_dyeing_finish_process_qc=mysqli_query($con,$sql_for_dyeing_finish_process_qc_result) or die(mysqli_error($con));
	$row_for_qc=mysqli_fetch_array($report_for_dyeing_finish_process_qc);
