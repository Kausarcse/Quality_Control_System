...
$table="<div id='raising_table'><table class='table table-bordered'>
<thead><tr>
<th>Test Name</th>
<th>Test Result</th>
<th>Requirements</th>
<th>Remarks</th>
 ...
 <tbody> 
  ";
	...
	$sql_for_raising="select * from defining_qc_standard_for_raising_process WHERE customer_name='$customer_name' and pp_number= '$pp_number' and version_number='$version_number'  and `finish_width_in_inch`='$finish_width_in_inch'";

	$result_for_raising=mysqli_query($con,$sql_for_raising) or die(mysqli_error($con));
	$row_for_defining_process=mysqli_fetch_array($result_for_raising);
	...
	$sql_for_raising_qc_result="select * from qc_result_for_raising_process WHERE customer_name='$customer_name' and pp_number= '$pp_number' and version_number='$version_number' and `finish_width_in_inch`='$finish_width_in_inch' and `before_trolley_number_or_batcher_number`='$before_trolley_number_or_batcher_number' and `after_trolley_number_or_batcher_number`='$after_trolley_number_or_batcher_number'";
    

	$result_for_raising_qc=mysqli_query($con,$sql_for_raising_qc_result) or die(mysqli_error($con));
