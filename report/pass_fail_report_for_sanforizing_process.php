...
$table="<div id='sanforizing_table' style='display:none'><table class='table table-bordered'>
<thead><tr>
<th>Test Name</th>
<th>Test Result</th>
...
//   echo $sql_for_sanforizing_process_qc_result;
	...
	$result= mysqli_query($con,$sql) or die(mysqli_error($con));
				 while( $row = mysqli_fetch_array( $result))
				 {
                    ...
                    if (in_array($row['id'], ['1']))
					 {
						if ( $row_for_qc['cf_to_rubbing_dry_value']<>0) 

						{
							...
							if ( $row_for_qc['cf_to_rubbing_wet_value']<>0) {
								$total_test++;
