...
$new_process_id= $row_for_trf['process_id']; 
...
$pdf->Cell(124,5,"Partial Test Report - ".$process_name,"0","0","L");
$pdf->Ln(2);
$pdf->SetFont('Arial','',8);
if($trf_id!='')
{
...
$pdf->Cell(110,5,"Sample Information : ","0","1","L");
$pdf->Ln(1);
...
// $pdf->Cell(100,5,$process_name_v,1,0,'L');

// $pdf->setLeftMargin(5);
$pdf->SetFont('Arial','B',12);
$pdf->Cell(110,5,"Test Result : ","0","1","L");
// $pdf->setLeftMargin(12);
...
if($new_process_id == 'proc_1')		//--------------------------------------Singe_and_desize----------------------------------
{
	...
	$report_for_singe_and_desize_process_qc=mysqli_query($con,$sql_for_singe_and_desize_process_qc_result) or die(mysqli_error($con));
	$row_for_qc=mysqli_fetch_array($report_for_singe_and_desize_process_qc);

}
else if($new_process_id == 'proc_2')		//---------------------------Scouring-----------------------------------
{
	/***************** Displaying Result from qc_standard table [Start] *****************/
	...
	/************ Displaying Result from qc_result table [Start] ************/
	$sql_for_scouring_process_qc_result="select * from qc_result_for_scouring_process WHERE customer_name='$customer_name' and pp_number= '$pp_number' and version_number='$version_number' and `finish_width_in_inch`='$finish_width_in_inch' and `before_trolley_number_or_batcher_number`='$before_trolley_number_or_batcher_number' and `after_trolley_number_or_batcher_number`='$after_trolley_number_or_batcher_number'";

	$report_for_scouring_process_qc=mysqli_query($con,$sql_for_scouring_process_qc_result) or die(mysqli_error($con));
	$row_for_qc=mysqli_fetch_array($report_for_scouring_process_qc);

}
else if($new_process_id == 'proc_3')		//------------------------------Bleacing-------------------------------------------
{
...
{        
	...
	/************ Displaying Result from qc_result table [Start] ************/
	$sql_for_scouring_bleaching_process_qc_result="select * from qc_result_for_scouring_bleaching_process WHERE customer_name='$customer_name' and pp_number= '$pp_number' and version_number='$version_number' and `finish_width_in_inch`='$finish_width_in_inch' and `before_trolley_number_or_batcher_number`='$before_trolley_number_or_batcher_number' and `after_trolley_number_or_batcher_number`='$after_trolley_number_or_batcher_number'";

	$report_for_scouring_bleaching_process_qc=mysqli_query($con,$sql_for_scouring_bleaching_process_qc_result) or die(mysqli_error($con));
	$row_for_qc=mysqli_fetch_array($report_for_scouring_bleaching_process_qc);

}
else if($new_process_id == 'proc_5')		//---------------------------Ready For Mercerize--------------------------
{
	/***************** Displaying Result from qc_standard table [Start] *****************/
	...
	/************ Displaying Result from qc_result table [Start] ************/
	$sql_for_ready_for_mercerize_process_qc_result="select * from qc_result_for_ready_for_mercerize_process WHERE customer_name='$customer_name' and pp_number= '$pp_number' and version_number='$version_number' and `finish_width_in_inch`='$finish_width_in_inch' and `before_trolley_number_or_batcher_number`='$before_trolley_number_or_batcher_number' and `after_trolley_number_or_batcher_number`='$after_trolley_number_or_batcher_number'";

	$report_for_ready_for_mercerize_process_qc=mysqli_query($con,$sql_for_ready_for_mercerize_process_qc_result) or die(mysqli_error($con));
	$row_for_qc=mysqli_fetch_array($report_for_ready_for_mercerize_process_qc);

}



if($new_process_id == 'proc_6')		//--------------------------Mercerize----------------------------------------
{
	/***************** Displaying Result from qc_standard table [Start] *****************/
	...
	/************ Displaying Result from qc_result table [Start] ************/
	$sql_for_mercerize_process_qc_result="select * from qc_result_for_mercerize_process WHERE customer_name='$customer_name' and pp_number= '$pp_number' and version_number='$version_number' and `finish_width_in_inch`='$finish_width_in_inch' and `before_trolley_number_or_batcher_number`='$before_trolley_number_or_batcher_number' and `after_trolley_number_or_batcher_number`='$after_trolley_number_or_batcher_number'";

	$report_for_mercerize_process_qc=mysqli_query($con,$sql_for_mercerize_process_qc_result) or die(mysqli_error($con));
	$row_for_qc=mysqli_fetch_array($report_for_mercerize_process_qc);

}



if($new_process_id == 'proc_7')		//---------------------------Ready For Print---------------------
{
	/***************** Displaying Result from qc_standard table [Start] *****************/
	...
	/************ Displaying Result from qc_result table [Start] ************/
	$sql_for_ready_for_printing_process_qc_result="select * from qc_result_for_ready_for_printing_process WHERE customer_name='$customer_name' and pp_number= '$pp_number' and version_number='$version_number' and `finish_width_in_inch`='$finish_width_in_inch' and `before_trolley_number_or_batcher_number`='$before_trolley_number_or_batcher_number' and `after_trolley_number_or_batcher_number`='$after_trolley_number_or_batcher_number'";

	$report_for_ready_for_printing_process_qc=mysqli_query($con,$sql_for_ready_for_printing_process_qc_result) or die(mysqli_error($con));
	$row_for_qc=mysqli_fetch_array($report_for_ready_for_printing_process_qc);

}
else if($new_process_id == 'proc_8')		//----------------------------Printing-----------------------------------------
{
	...
	/************ Displaying Result from qc_result table [Start] ************/
	$sql_for_printing_process_qc_result="select * from qc_result_for_printing_process WHERE customer_name='$customer_name' and pp_number= '$pp_number' and version_number='$version_number' and `finish_width_in_inch`='$finish_width_in_inch' and `before_trolley_number_or_batcher_number`='$before_trolley_number_or_batcher_number' and `after_trolley_number_or_batcher_number`='$after_trolley_number_or_batcher_number'";

	$report_for_printing_process_qc=mysqli_query($con,$sql_for_printing_process_qc_result) or die(mysqli_error($con));
	$row_for_qc=mysqli_fetch_array($report_for_printing_process_qc);

}
else if($new_process_id == 'proc_9')		//----------------------------Curing---------------------------------
{
...
else if($new_process_id == 'proc_10')		//--------------------------------------Steaming------------------------
{
        /***************** Displaying Result from qc_standard table [Start] *****************/
        ...
        /************ Displaying Result from qc_result table [Start] ************/
        $sql_for_steaming_process_qc_result="select * from qc_result_for_steaming_process WHERE customer_name='$customer_name' and pp_number= '$pp_number' and version_number='$version_number' and `finish_width_in_inch`='$finish_width_in_inch' and `before_trolley_number_or_batcher_number`='$before_trolley_number_or_batcher_number' and `after_trolley_number_or_batcher_number`='$after_trolley_number_or_batcher_number'";

        $report_for_steaming_process_qc=mysqli_query($con,$sql_for_steaming_process_qc_result) or die(mysqli_error($con));
        $row_for_qc=mysqli_fetch_array($report_for_steaming_process_qc);

}
else if($new_process_id == 'proc_11')		//----------------------------Ready for Dyeing---------------------------------
{
	/***************** Displaying Result from qc_standard table [Start] *****************/
	...
	/************ Displaying Result from qc_result table [Start] ************/
	$sql_for_ready_for_dying_process_qc_result="select * from qc_result_for_ready_for_dying_process WHERE customer_name='$customer_name' and pp_number= '$pp_number' and version_number='$version_number' and `finish_width_in_inch`='$finish_width_in_inch' and `before_trolley_number_or_batcher_number`='$before_trolley_number_or_batcher_number' and `after_trolley_number_or_batcher_number`='$after_trolley_number_or_batcher_number'";

	$report_for_ready_for_dying_process_qc=mysqli_query($con,$sql_for_ready_for_dying_process_qc_result) or die(mysqli_error($con));
	$row_for_qc=mysqli_fetch_array($report_for_ready_for_dying_process_qc);

}



if($new_process_id == 'proc_13')		//-----------------------------------Washing---------------------------
{
	/***************** Displaying Result from qc_standard table [Start] *****************/
	...
	$report_for_washing_process_qc=mysqli_query($con,$sql_for_washing_process_qc_result) or die(mysqli_error($con));
	$row_for_qc=mysqli_fetch_array($report_for_washing_process_qc);

}


if($new_process_id == 'proc_14')		//-------------------------------Ready For Raising------------------------------
{
	/***************** Displaying Result from qc_standard table [Start] *****************/
	...
	$report_for_ready_for_raising_process_qc=mysqli_query($con,$sql_for_ready_for_raising_process_qc_result) or die(mysqli_error($con));
	$row_for_qc=mysqli_fetch_array($report_for_ready_for_raising_process_qc);

}
else if($new_process_id == 'proc_15')		//------------------------------------------Raising------------------------------
{
	/***************** Displaying Result from qc_standard table [Start] *****************/
	...
	/************ Displaying Result from qc_result table [Start] ************/
	$sql_for_raising_process_qc_result="select * from qc_result_for_raising_process WHERE customer_name='$customer_name' and pp_number= '$pp_number' and version_number='$version_number' and `finish_width_in_inch`='$finish_width_in_inch' and `before_trolley_number_or_batcher_number`='$before_trolley_number_or_batcher_number' and `after_trolley_number_or_batcher_number`='$after_trolley_number_or_batcher_number'";

	$report_for_raising_process_qc=mysqli_query($con,$sql_for_raising_process_qc_result) or die(mysqli_error($con));
	$row_for_qc=mysqli_fetch_array($report_for_raising_process_qc);

}



if($new_process_id == 'proc_16')		//----------------------------------------- Finishing process------------------------------
{
         /***************** Displaying Result from qc_standard table [Start] *****************/
...
else if($new_process_id == 'proc_17')	//------------------------------Calender--------------------------------
{
        /***************** Displaying Result from qc_standard table [Start] *****************/
...
else if($new_process_id == 'proc_18')	//------------------------------Sanforizing--------------------------------
{
        /***************** Displaying Result from qc_standard table [Start] *****************/
        ...
        /************ Displaying Result from qc_result table [Start] ************/
        $sql_for_sanforizing_process_qc_result="select * from qc_result_for_sanforizing_process WHERE customer_name='$customer_name' and pp_number= '$pp_number' and version_number='$version_number' and `finish_width_in_inch`='$finish_width_in_inch' and `before_trolley_number_or_batcher_number`='$before_trolley_number_or_batcher_number' and `after_trolley_number_or_batcher_number`='$after_trolley_number_or_batcher_number'";

        $report_for_sanforizing_process_qc=mysqli_query($con,$sql_for_sanforizing_process_qc_result) or die(mysqli_error($con));
        $row_for_qc=mysqli_fetch_array($report_for_sanforizing_process_qc);

}
else if($new_process_id == 'proc_20')	//-------------------------------Greige Receiving----------------------------
{
    /***************** Displaying Result from qc_standard table [Start] *****************/
...
else if($new_process_id == 'proc_21')	//------------------------------Singeing--------------------------------
{
        /***************** Displaying Result from qc_standard table [Start] *****************/
        ...
        $report_for_singeing_process=mysqli_query($con,$sql_for_singeing_process) or die(mysqli_error($con));
        $row_for_defining_process=mysqli_fetch_array($report_for_singeing_process);
        ...
        $report_for_singeing_process_qc=mysqli_query($con,$sql_for_singeing_process_qc_result) or die(mysqli_error($con));
        $row_for_qc=mysqli_fetch_array($report_for_singeing_process_qc);

}
else if($new_process_id == 'proc_22')	//------------------------------Desizing--------------------------------
{
        /***************** Displaying Result from qc_standard table [Start] *****************/
        $sql_for_desizing_process="select * from defining_qc_standard_for_desizing_process WHERE customer_name='$customer_name' and pp_number= '$pp_number' and version_number='$version_number' and `finish_width_in_inch`='$finish_width_in_inch' ";

        $report_for_desizing_process=mysqli_query($con,$sql_for_desizing_process) or die(mysqli_error($con));
        $row_for_defining_process=mysqli_fetch_array($report_for_desizing_process);

        /************ Displaying Result from qc_result table [Start] ************/
        $sql_for_desizing_process_qc_result="select * from qc_result_for_desizing_process WHERE customer_name='$customer_name' and pp_number= '$pp_number' and version_number='$version_number' and `finish_width_in_inch`='$finish_width_in_inch' and `before_trolley_number_or_batcher_number`='$before_trolley_number_or_batcher_number' and `after_trolley_number_or_batcher_number`='$after_trolley_number_or_batcher_number'";

        $report_for_desizing_process_qc=mysqli_query($con,$sql_for_desizing_process_qc_result) or die(mysqli_error($con));
        $row_for_qc=mysqli_fetch_array($report_for_desizing_process_qc);

}
else if($new_process_id == 'proc_23')	//------------------------------Desizing--------------------------------
{
        /***************** Displaying Result from qc_standard table [Start] *****************/
        $sql_for_desizing_process="SELECT * from defining_qc_standard_for_dyeing_finish_process 
									WHERE customer_name='$customer_name' and pp_number= '$pp_number' and version_number='$version_number' and 
        ...
        /************ Displaying Result from qc_result table [Start] ************/
        $sql_for_desizing_process_qc_result="SELECT * from qc_result_for_dyeing_finish_process 
											WHERE customer_name='$customer_name' and pp_number= '$pp_number' and 
											version_number='$version_number' and `finish_width_in_inch`='$finish_width_in_inch' and 
...
$result= mysqli_query($con,$sql) or die(mysqli_error($con));
               ...
               if (in_array($row['id'], ['74']))
                  ...
                  if ($row_for_defining_process['weft_yarn_count_max_value']<>0 && $row_for_qc['weft_yarn_count_value']<>0) 
                   ...
                   if (in_array($row['id'], ['6']))
                   {
                     ...
                     if ($row_for_defining_process['surface_fuzzing_and_pilling_max_value']<>0 && $row_for_qc['resistance_to_surface_fuzzing_and_pilling_value']<>0) {
                           $total_test++;
                           ...
                           if($customer_type == 'american')
							{
								$surface_fuzzing_and_pilling_tolerance_value = $row_for_defining_process['surface_fuzzing_and_pilling_tolerance_value'];
								$resistance_to_surface_fuzzing_and_pilling_value = $row_for_qc['resistance_to_surface_fuzzing_and_pilling_value'];
							...
							if($customer_type == 'european')
							{
								...
								$surface_fuzzing_and_pilling = $row_for_qc['resistance_to_surface_fuzzing_and_pilling_value'];
							
									if($surface_fuzzing_and_pilling ==1.0)
									{
										$resistance_to_surface_fuzzing_and_pilling_value = '1';
									}
									elseif($surface_fuzzing_and_pilling ==1.5)
									{
										$resistance_to_surface_fuzzing_and_pilling_value = '1-2';
									}
									elseif($surface_fuzzing_and_pilling ==2.0)
									{
										$resistance_to_surface_fuzzing_and_pilling_value = '2';
									}
									elseif($surface_fuzzing_and_pilling ==2.5)
									{
										$resistance_to_surface_fuzzing_and_pilling_value = '2-3';
									}
									elseif($surface_fuzzing_and_pilling ==3.0)
									{
										$resistance_to_surface_fuzzing_and_pilling_value = '3';
									}
									elseif($surface_fuzzing_and_pilling ==3.5)
									{
										$resistance_to_surface_fuzzing_and_pilling_value = '3-4';
									}
									elseif($surface_fuzzing_and_pilling ==4.0)
									{
										$resistance_to_surface_fuzzing_and_pilling_value = '4';
									}
									elseif($surface_fuzzing_and_pilling ==4.5)
									{
										$resistance_to_surface_fuzzing_and_pilling_value = '4-5';
									}
									elseif($surface_fuzzing_and_pilling ==5.0)
									{
										$resistance_to_surface_fuzzing_and_pilling_value = '5';
									} 				// for test result

							}


                        if($row_for_defining_process['surface_fuzzing_and_pilling_min_value']<=$row_for_qc['resistance_to_surface_fuzzing_and_pilling_value'] && $row_for_defining_process['surface_fuzzing_and_pilling_max_value']>=$row_for_qc['resistance_to_surface_fuzzing_and_pilling_value'])
                        {
                           $p++;
                           $pdf->Cell(124,5,$row['test_name_method'],"1", "0","L");
                          $pdf->Cell(21,5,$resistance_to_surface_fuzzing_and_pilling_value.' ' .$row_for_defining_process['uom_of_surface_fuzzing_and_pilling_value'], "1", "0","L");
                           $pdf->Cell(30,5,$surface_fuzzing_and_pilling_tolerance_range_math_operator.' '.$surface_fuzzing_and_pilling_tolerance_value.''.$row_for_defining_process['uom_of_surface_fuzzing_and_pilling_value'], "1", "0","L");
                           $pdf->Cell(15,5,"Pass", "1", "0","C");
                           $pdf->Ln();
                   ...
                   if (in_array($row['id'], ['8']))
                    ...
                    if (in_array($row['id'], ['9']))
					 ...
					 if (in_array($row['id'], ['11']))
					 {
						...
						if ($row_for_defining_process['seam_strength_in_warp_value_max_value']<>0 && $row_for_qc['seam_strength_in_warp_value']<>0) {
							...
							if($row_for_defining_process['seam_strength_in_warp_value_tolerance_range_math_operator'] == '≥')
							{
							   // $tear_force_in_weft_value_tolerance_range_math_operator = '>=';
							   $seam_strength_in_warp_value_tolerance_range_math_operator = $pdf->Image('../img/greater_equal.png',156, $pdf->GetY()+1.5, 1.7).'   ';

							}
							else if($row_for_defining_process['seam_strength_in_warp_value_tolerance_range_math_operator'] == '≤')
							{
							   // $tear_force_in_weft_value_tolerance_range_math_operator = '<=';
							   $seam_strength_in_warp_value_tolerance_range_math_operator = $pdf->Image('../img/less_equal.png',156, $pdf->GetY()+1.5, 1.7).'   ';
							...
							if($row_for_defining_process['seam_strength_in_warp_value_min_value']<=$row_for_qc['seam_strength_in_warp_value'] && $row_for_defining_process['seam_strength_in_warp_value_max_value']>=$row_for_qc['seam_strength_in_warp_value'])
							{
                               ...
                               $pdf->Cell(21,5,$row_for_qc['seam_strength_in_warp_value'].' ' .$row_for_defining_process['uom_of_seam_strength_in_warp_value'], "1", "0","L");
                                $pdf->Cell(30,5,$seam_strength_in_warp_value_tolerance_range_math_operator.' '.$row_for_defining_process['seam_strength_in_warp_value_tolerance_value'].' '.$row_for_defining_process['uom_of_seam_strength_in_warp_value'], "1", "0","L");
                                $pdf->Cell(15,5,"Pass", "1", "0","C");
                                $pdf->SetTextColor(0,0,0);
                                $pdf->Ln();
							}
						...
						if ($row_for_defining_process['seam_strength_in_weft_value_max_value']<>0 && $row_for_qc['seam_strength_in_weft_value']<>0) 
						{
								...
								if($row_for_defining_process['seam_strength_in_weft_value_tolerance_range_math_operator'] == '≥')
							{
							   // $tear_force_in_weft_value_tolerance_range_math_operator = '>=';
							   $seam_strength_in_weft_value_tolerance_range_math_operator = $pdf->Image('../img/greater_equal.png',156, $pdf->GetY()+1.5, 1.7).'   ';

							}
							else if($row_for_defining_process['seam_strength_in_weft_value_tolerance_range_math_operator'] == '≤')
							{
							   // $tear_force_in_weft_value_tolerance_range_math_operator = '<=';
							   $seam_strength_in_weft_value_tolerance_range_math_operator = $pdf->Image('../img/less_equal.png',156, $pdf->GetY()+1.5, 1.7).'   ';
							...
							if($row_for_defining_process['seam_strength_in_weft_value_min_value']<=$row_for_qc['seam_strength_in_weft_value'] && $row_for_defining_process['seam_strength_in_weft_value_max_value']>=$row_for_qc['seam_strength_in_weft_value'])
							{
                               ...
                               $pdf->Cell(21,5,$row_for_qc['seam_strength_in_weft_value'].' ' .$row_for_defining_process['uom_of_seam_strength_in_weft_value'], "1", "0","L");
                                $pdf->Cell(30,5,$seam_strength_in_weft_value_tolerance_range_math_operator.' '.$row_for_defining_process['seam_strength_in_weft_value_tolerance_value'].' '.$row_for_defining_process['uom_of_seam_strength_in_weft_value'], "1", "0","L");
                                $pdf->Cell(15,5,"Pass", "1", "0","C");
                                $pdf->SetTextColor(0,0,0);
                                $pdf->Ln();
							}
					 ...
					 if (in_array($row['id'], ['15','59']))
					{
						...
						if ($row_for_defining_process['cf_to_washing_color_change_max_value']<>0 && $row_for_qc['cf_to_washing_color_change_value']<>0) {
							...
							if($row_for_defining_process['cf_to_washing_color_change_min_value']<=$row_for_qc['cf_to_washing_color_change_value'] && $row_for_defining_process['cf_to_washing_color_change_max_value']>=$row_for_qc['cf_to_washing_color_change_value'])
							{
								$p++;
								$pdf->Cell(124,5,$row['test_name_method'].' (Color Change)',"1", "0","L");
                               $pdf->Cell(21,5,$cf_to_washing_color_change_value, "1", "0","L");
                                $pdf->Cell(30,5,$cf_to_washing_color_change_tolerance_range_math_operator.' '.$cf_to_washing_color_change_tolerance_value, "1", "0","L");
                                $pdf->Cell(15,5,"Pass", "1", "0","C");
                                $pdf->SetTextColor(0,0,0);
                                $pdf->Ln();
							}
                        ...
                        if($customer_type == 'american')
							...
							if($row_for_defining_process['cf_to_washing_staining_min_value']<=$row_for_qc['cf_to_washing_staining_value'] && $row_for_defining_process['cf_to_washing_staining_max_value']>=$row_for_qc['cf_to_washing_staining_value'])
							{
                               ...
                               $pdf->Cell(21,5,$cf_to_washing_staining_value, "1", "0","L");
                                $pdf->Cell(30,5,$cf_to_washing_staining_tolerance_range_math_operator.' '.$cf_to_washing_staining_tolerance_value, "1", "0","L");
                                $pdf->Cell(15,5,"Pass", "1", "0","C");
                                $pdf->SetTextColor(0,0,0);
                                $pdf->Ln();
							}
                        ...
                        if($customer_type == 'american')
							...
							if($row_for_defining_process['cf_to_washing_cross_staining_min_value']<=$row_for_qc['cf_to_washing_cross_staining_value'] && $row_for_defining_process['cf_to_washing_cross_staining_max_value']>=$row_for_qc['cf_to_washing_cross_staining_value'])
							{
                               ...
                               $pdf->Cell(21,5,$cf_to_washing_cross_staining_value, "1", "0","L");
                                $pdf->Cell(30,5,$cf_to_washing_cross_staining_tolerance_range_math_operator.' '.$cf_to_washing_cross_staining_tolerance_value, "1", "0","L");
                                $pdf->Cell(15,5,"Pass", "1", "0","C");
                                $pdf->SetTextColor(0,0,0);
                                $pdf->Ln();
							}
                    ...
                    if (in_array($row['id'], ['16']))
					{
						...
						if ($row_for_defining_process['cf_to_dry_cleaning_color_change_max_value']<>0 && $row_for_qc['cf_to_dry_cleaning_color_change_value']<>0) {
							...
							$total_test++;
                     if($row_for_defining_process['cf_to_dry_cleaning_color_change_tolerance_range_math_operator'] == '≥')
                     {
                        // $cf_to_dry_cleaning_color_change_tolerance_range_math_operator = '>=';
						$cf_to_dry_cleaning_color_change_tolerance_range_math_operator = $pdf->Image('../img/greater_equal.png',156, $pdf->GetY()+1.5, 1.7).'   ';

                     }
                     else if($row_for_defining_process['cf_to_dry_cleaning_color_change_tolerance_range_math_operator'] == '≤')
                     {
                        // $cf_to_dry_cleaning_color_change_tolerance_range_math_operator = '<=';
						$cf_to_dry_cleaning_color_change_tolerance_range_math_operator = $pdf->Image('../img/less_equal.png',156, $pdf->GetY()+1.5, 1.7).'   ';
                     ...
                     if($customer_type == 'american')
							...
							if($row_for_defining_process['cf_to_dry_cleaning_color_change_min_value']<=$row_for_qc['cf_to_dry_cleaning_color_change_value'] && $row_for_defining_process['cf_to_dry_cleaning_color_change_max_value']>=$row_for_qc['cf_to_dry_cleaning_color_change_value'])
							{
                               ...
                               $pdf->Cell(21,5,$cf_to_dry_cleaning_color_change_value.' ' .$row_for_defining_process['uom_of_cf_to_dry_cleaning_color_change'], "1", "0","L");
                                $pdf->Cell(30,5,$cf_to_dry_cleaning_color_change_tolerance_range_math_operator.' '.$cf_to_dry_cleaning_color_change_tolerance_value.' '.$row_for_defining_process['uom_of_cf_to_dry_cleaning_color_change'], "1", "0","L");
                                $pdf->Cell(15,5,"Pass", "1", "0","C");
                                $pdf->SetTextColor(0,0,0);
                                $pdf->Ln();
							...
							if ($row_for_defining_process['cf_to_dry_cleaning_staining_max_value']<>0 && $row_for_qc['cf_to_dry_cleaning_staining_value']<>0) {
								...
								$total_test++;
                        if($row_for_defining_process['cf_to_dry_cleaning_staining_tolerance_range_math_operator'] == '≥')
                        {
                        //    $cf_to_dry_cleaning_staining_tolerance_range_math_operator = '>=';
						   $cf_to_dry_cleaning_staining_tolerance_range_math_operator = $pdf->Image('../img/greater_equal.png',156, $pdf->GetY()+1.5, 1.7).'   ';

                        }
                        else if($row_for_defining_process['cf_to_dry_cleaning_staining_tolerance_range_math_operator'] == '≤')
                        {
                        //    $cf_to_dry_cleaning_staining_tolerance_range_math_operator = '<=';
						   $cf_to_dry_cleaning_staining_tolerance_range_math_operator = $pdf->Image('../img/less_equal.png',156, $pdf->GetY()+1.5, 1.7).'   ';
                        ...
                        if($customer_type == 'american')
							...
							if($row_for_defining_process['cf_to_dry_cleaning_staining_min_value']<=$row_for_qc['cf_to_dry_cleaning_staining_value'] && $row_for_defining_process['cf_to_dry_cleaning_staining_max_value']>=$row_for_qc['cf_to_dry_cleaning_staining_value'])
							{
                               ...
                               $pdf->Cell(21,5,$cf_to_dry_cleaning_staining_value.' ' .$row_for_defining_process['uom_of_cf_to_dry_cleaning_staining'], "1", "0","L");
                                $pdf->Cell(30,5,$cf_to_dry_cleaning_staining_tolerance_range_math_operator.' '.$cf_to_dry_cleaning_staining_tolerance_value.' '.$row_for_defining_process['uom_of_cf_to_dry_cleaning_staining'], "1", "0","L");
                                $pdf->Cell(15,5,"Pass", "1", "0","C");
                                $pdf->SetTextColor(0,0,0);
                                $pdf->Ln();
							}
					 ...
					 { 
						 ...
						 if($row_for_defining_process['cf_to_water_color_change_max_value']<>0 && $row_for_qc['cf_to_water_color_change_value']<>0)
                        {
                           ...
                           if($row_for_defining_process['cf_to_water_color_change_min_value']<=$row_for_qc['cf_to_water_color_change_value'] && $row_for_defining_process['cf_to_water_color_change_max_value']>=$row_for_qc['cf_to_water_color_change_value'])
                           {
                              $p++;
                              $pdf->Cell(124,5,$row['test_name_method'].' (Color Change)',"1", "0","L");
                             $pdf->Cell(21,5,$cf_to_water_color_change_value, "1", "0","L");
                              $pdf->Cell(30,5,$cf_to_water_color_change_tolerance_range_math_operator.' '.$cf_to_water_color_change_tolerance_value, "1", "0","L");
                              $pdf->Cell(15,5,"Pass", "1", "0","C");
                              $pdf->SetTextColor(0,0,0);
                              $pdf->Ln();
                           }
                         ...
                         if($row_for_defining_process['cf_to_water_staining_max_value']<>0 && $row_for_qc['cf_to_water_staining_value']<>0)
                        {
                           ...
                           if($row_for_defining_process['cf_to_water_staining_min_value']<=$row_for_qc['cf_to_water_staining_value'] && $row_for_defining_process['cf_to_water_staining_max_value']>=$row_for_qc['cf_to_water_staining_value'])
                           {
                              $p++;
							  $pdf->Cell(124,5,$row['test_name_method'].' (Staining)',"1", "0","L");
                             $pdf->Cell(21,5,$cf_to_water_staining_value, "1", "0","L");
                              $pdf->Cell(30,5,$cf_to_water_staining_tolerance_range_math_operator.' '.$cf_to_water_staining_tolerance_value, "1", "0","L");
                              $pdf->Cell(15,5,"Pass", "1", "0","C");
                              $pdf->SetTextColor(0,0,0);
                              $pdf->Ln();
                           }
                        ...
                        if($row_for_defining_process['cf_to_water_cross_staining_max_value']<>0 && $row_for_qc['cf_to_water_cross_staining_value']<>0)
                        {
                           ...
                           if($row_for_defining_process['cf_to_water_cross_staining_min_value']<=$row_for_qc['cf_to_water_cross_staining_value'] && $row_for_defining_process['cf_to_water_cross_staining_max_value']>=$row_for_qc['cf_to_water_cross_staining_value'])
                           {
                              $p++;
                              $pdf->Cell(124,5,$row['test_name_method'].' (Cross Staining)',"1", "0","L");
                             $pdf->Cell(21,5,$cf_to_water_cross_staining_value, "1", "0","L");
                              $pdf->Cell(30,5,$cf_to_water_cross_staining_tolerance_range_math_operator.' '.$cf_to_water_cross_staining_tolerance_value, "1", "0","L");
                              $pdf->Cell(15,5,"Pass", "1", "0","C");
                              $pdf->SetTextColor(0,0,0);
                              $pdf->Ln();
                    ...
                    if (in_array($row['id'], ['20']))
					 {
                        ...
                        if($row_for_defining_process['cf_to_water_spotting_surface_max_value']<>0 && $row_for_qc['cf_to_water_spotting_surface_value']<>0)
                        {
                           ...
                           {
							$cf_to_water_spotting_surface_tolerance_range_math_op = $pdf->Image('../img/greater_equal.png',156, $pdf->GetY()+1.5, 1.7).'   ';
                           }
                           else if($row_for_defining_process['cf_to_water_spotting_surface_tolerance_range_math_op'] == '≤')
                           {
							$cf_to_water_spotting_surface_tolerance_range_math_op = $pdf->Image('../img/less_equal.png',156, $pdf->GetY()+1.5, 1.7).'   ';
                           }
                           else if($row_for_defining_process['cf_to_water_spotting_surface_tolerance_range_math_op'] == '>')
                           {
                        ...
                        if($row_for_defining_process['cf_to_water_spotting_edge_max_value']<>0 && $row_for_qc['cf_to_water_spotting_edge_value']<>0)
                        {
                           ...
                           {
							$cf_to_water_spotting_edge_tolerance_range_math_op = $pdf->Image('../img/greater_equal.png',156, $pdf->GetY()+1.5, 1.7).'   ';
                           }
                           else if($row_for_defining_process['cf_to_water_spotting_edge_tolerance_range_math_op'] == '≤')
                           {
							$cf_to_water_spotting_edge_tolerance_range_math_op = $pdf->Image('../img/less_equal.png',156, $pdf->GetY()+1.5, 1.7).'   ';
                           }
                           else if($row_for_defining_process['cf_to_water_spotting_edge_tolerance_range_math_op'] == '>')
                           {
                        ...
                        if($row_for_defining_process['cf_to_water_spotting_cross_staining_max_value']<>0 && $row_for_qc['cf_to_water_spotting_cross_staining_value']<>0)
                        {
                           ...
                           {
							$cf_to_water_spotting_cross_staining_tolerance_range_math_op = $pdf->Image('../img/greater_equal.png',156, $pdf->GetY()+1.5, 1.7).'   ';
                           }
                           else if($row_for_defining_process['cf_to_water_spotting_cross_staining_tolerance_range_math_op'] == '≤')
                           {
							$cf_to_water_spotting_cross_staining_tolerance_range_math_op = $pdf->Image('../img/less_equal.png',156, $pdf->GetY()+1.5, 1.7).'   ';
                           }
                           else if($row_for_defining_process['cf_to_water_spotting_cross_staining_tolerance_range_math_op'] == '>')
                           {
               ...
               if (in_array($row['id'], ['26', '70']))
                       ...
                       if($row_for_defining_process['cf_to_saliva_color_change_max_value']<>0 && $row_for_qc['cf_to_saliva_color_change_value']<>0)
                        {
                           ...
                           {
							  $cf_to_saliva_color_change_tolerance_range_math_operator = $pdf->Image('../img/greater_equal.png',156, $pdf->GetY()+1.5, 1.7).'   ';

                           }
                           else if($row_for_defining_process['cf_to_saliva_color_change_tolerance_range_math_operator'] == '≤')
                           {
							  $cf_to_saliva_color_change_tolerance_range_math_operator = $pdf->Image('../img/less_equal.png',156, $pdf->GetY()+1.5, 1.7).'   ';
                       ...
                       if($row_for_defining_process['cf_to_cholorine_bleach_color_change_max_value']<>0 && $row_for_qc['cf_to_cholorine_bleach_color_change_value']<>0)
                        {
                           ...
                           if($row_for_defining_process['cf_to_cholorine_bleach_color_change_min_value']<=$row_for_qc['cf_to_cholorine_bleach_color_change_value'] && $row_for_defining_process['cf_to_cholorine_bleach_color_change_max_value']>=$row_for_qc['cf_to_cholorine_bleach_color_change_value'])
                           {
                             ...
                             $pdf->Cell(21,5,$cf_to_cholorine_bleach_color_change_value.' ' .$row_for_defining_process['uom_of_cf_to_cholorine_bleach_color_change'], "1", "0","L");
                              $pdf->Cell(30,5,$row_for_defining_process['cf_to_chlorinated_water_color_change_tolerance_range_math_op'].' '.$cf_to_chlorinated_water_color_change_tolerance_value.' '.$row_for_defining_process['uom_of_cf_to_cholorine_bleach_color_change'], "1", "0","L");
                              $pdf->Cell(15,5,"Pass", "1", "0","C");
                              $pdf->SetTextColor(0,0,0);
                              $pdf->Ln();
                       ...
                       if($row_for_defining_process['ph_value_max_value']<>0 && $row_for_qc['ph_value']<>0)
                        {
                           ...
                           {
                              $p++;
                              $pdf->Cell(124,5,$row['test_name_method'],"1", "0","c");
                             $pdf->Cell(21,5,$row_for_qc['ph_value'], "1", "0","L");
                              $pdf->Cell(30,5,$row_for_defining_process['ph_value_min_value'].' to '.$row_for_defining_process['ph_value_max_value'], "1", "0","");
                              $pdf->Cell(15,5,"Pass", "1", "0","C");
                              $pdf->SetTextColor(0,0,0);
                              $pdf->Ln();
                           }
                           ...
                           if($row_for_defining_process['ph_min_value']<=$row_for_qc['ph_left_value'] && $row_for_defining_process['ph_max_value']>=$row_for_qc['ph_left_value'] && $row_for_defining_process['ph_min_value']<=$row_for_qc['ph_left_value'] && $row_for_defining_process['ph_max_value']>=$row_for_qc['ph_right_value'] && $row_for_defining_process['ph_max_value']>=$row_for_qc['ph_right_value'])
                              {
                                 $p++;
                                    ...
                                    $pdf->Cell(110,5,"pH(Drop Test Method)","1", "0","L");
                                          $pdf->Cell(30,5,'L:'.$row_for_qc['ph_left_value'].' C:'.$row_for_qc['ph_center_value'].' R:'.$row_for_qc['ph_right_value'], "1", "0","L");
                                          $pdf->Cell(30,5,$row_for_defining_process['ph_min_value'].' to '.$row_for_defining_process['ph_max_value'], "1", "0","L");
                                          $pdf->Cell(15,5,"Pass", "1", "0","C");
                                          $pdf->SetTextColor(0,0,0);
                                          $pdf->Ln();
                                 }
                    ...
                    if (in_array($row['id'], ['170']))
                    {
                     ...
                     if ($row_for_defining_process['ph_max_value']<>0 && $row_for_qc['Ph_value_in_left_side_of_fabric']<>0) 
                        {
                           $total_test++;
                           if($row_for_defining_process['ph_min_value']<=$row_for_qc['Ph_value_in_left_side_of_fabric'] && $row_for_defining_process['ph_max_value']>=$row_for_qc['Ph_value_in_left_side_of_fabric'] && $row_for_defining_process['ph_min_value']<=$row_for_qc['Ph_value_in_right_of_fabric'] && $row_for_defining_process['ph_max_value']>=$row_for_qc['Ph_value_in_right_of_fabric'])
                              {
                                 $p++;
                                    $split_ph=explode('(', $row['test_name_method']);
                                    $ph_test_name=$split_ph[0];
                                    $pdf->Cell(110,5,"pH(Drop Test Method)","1", "0","L");
                                          $pdf->Cell(30,5,'L:'.$row_for_qc['Ph_value_in_left_side_of_fabric'].' C:'.$row_for_qc['Ph_value_in_center_of_fabric'].' R:'.$row_for_qc['Ph_value_in_right_of_fabric'], "1", "0","L");
                                          $pdf->Cell(30,5,$row_for_defining_process['ph_min_value'].' to '.$row_for_defining_process['ph_max_value'], "1", "0","L");
                                          $pdf->Cell(15,5,"Pass", "1", "0","C");
                                          $pdf->SetTextColor(0,0,0);
                                          $pdf->Ln();
                    ...
                    if (in_array($row['id'], ['170']))
                    {
                     ...
                     if ($row_for_defining_process['ph_max_value']<>0 && $row_for_qc['ph_value']<>0) 
                        {
                           
                           $total_test++;
                           if($row_for_defining_process['ph_min_value']<=$row_for_qc['ph_value'] && $row_for_defining_process['ph_max_value']>=$row_for_qc['ph_value'])
                           {
                              $p++;
                              $pdf->Cell(124,5,$row['test_name_method'],"1", "0","L");
                             $pdf->Cell(21,5,$row_for_qc['ph_value'], "1", "0","L");
               ...
               if (in_array($row['id'], ['10']))
					 {
...

					  {
                        ...
                        if($row_for_defining_process['bowing_and_skew_tolerance_range_math_operator'] == '≥')
                           {
							$bowing_and_skew_tolerance_range_math_operator = $pdf->Image('../img/greater_equal.png',156, $pdf->GetY()+1.5, 1.7).'   ';
                           }
                           else if($row_for_defining_process['bowing_and_skew_tolerance_range_math_operator'] == '≤')
                           {
							$bowing_and_skew_tolerance_range_math_operator = $pdf->Image('../img/less_equal.png',156, $pdf->GetY()+1.5, 1.7).'   ';
                           }
                           else if($row_for_defining_process['bowing_and_skew_tolerance_range_math_operator'] == '>')
                           {
						...
						if($row_for_defining_process['bowing_and_skew_min_value']<=$row_for_qc['bowing_and_skew_value'] && $row_for_defining_process['bowing_and_skew_max_value']>=$row_for_qc['bowing_and_skew_value'])
						{
							$p++;
							$pdf->Cell(124,5,$row['test_name_method'],"1", "0","L");
							$pdf->Cell(30,5,$row_for_qc['bowing_and_skew_value'].' '.$row_for_defining_process['uom_of_bowing_and_skew'],"1","0","L");	
							$pdf->Cell(30,5,$bowing_and_skew_tolerance_range_math_operator.' '.$row_for_defining_process['bowing_and_skew_tolerance_value'].' '.$row_for_defining_process['uom_of_bowing_and_skew'],"1","0","L");
							$pdf->Cell(15,5,"Pass", "1", "0","C");
                              $pdf->SetTextColor(0,0,0);
                              $pdf->Ln();
						}
            ...
            if (in_array($row['id'], ['49']))
                     ...
                     if ($row_for_defining_process['whiteness_max_value']<>0 && $row_for_qc['whiteness_left_value']<>0) 
                     {
                        $total_test++;
                              ...
                              $content_of_uom_of_whiteness = urlencode($row_for_defining_process['uom_of_whiteness']);
                              $uom_of_whiteness = urldecode($pdf->sp_character($content_of_uom_of_whiteness));
                        ...
                        if($row_for_defining_process['whiteness_min_value']<=$row_for_qc['whiteness_left_value'] && $row_for_defining_process['whiteness_max_value']>=$row_for_qc['whiteness_left_value'] && $row_for_defining_process['whiteness_min_value']<=$row_for_qc['whiteness_center_value'] && $row_for_defining_process['whiteness_max_value']>=$row_for_qc['whiteness_center_value'] && $row_for_defining_process['whiteness_min_value']<=$row_for_qc['whiteness_right_value'] && $row_for_defining_process['whiteness_max_value']>=$row_for_qc['whiteness_right_value'])
                        {
                           $p++;
                                    $pdf->Cell(124,5,$row['test_name_method'],"1", "0","L");
                                    $pdf->Cell(30,5,'L:'.$row_for_qc['whiteness_left_value'].$uom_of_whiteness.' C:'.$row_for_qc['whiteness_center_value'].$uom_of_whiteness.' R:'.$row_for_qc['whiteness_right_value'].' '.$uom_of_whiteness, "1", "0","L");
                                    $pdf->Cell(30,5,$row_for_defining_process['whiteness_min_value'].$uom_of_whiteness.' to '.$row_for_defining_process['whiteness_max_value'].$uom_of_whiteness, "1", "0","L");
                                    $pdf->Cell(15,5,"Pass", "1", "0","C");
                                    $pdf->SetTextColor(0,0,0);
                                    $pdf->Ln();
                        }
					 ...
					 }  /*End of if (in_array($row['id'], ['49','95']))*/

                if (in_array($row['id'], ['49']))
					 {

					  if ($row_for_defining_process['whiteness_max_value']<>0 && $row_for_qc['whiteness_value']<>0) 
					  {	
						$total_test++;
                  ...
                  $uom_of_whiteness = urldecode($pdf->sp_character($content_of_uom_of_whiteness));
						...
						if($row_for_defining_process['whiteness_min_value']<=$row_for_qc['whiteness_value'] && $row_for_defining_process['whiteness_max_value']>=$row_for_qc['whiteness_value'])
						{
							$p++;
                     $pdf->Cell(124,5,$row['test_name_method'],"1", "0","L");
                    $pdf->Cell(21,5,$row_for_qc['whiteness_value'].' '.$uom_of_whiteness, "1", "0","L");
                     $pdf->Cell(30,5,$row_for_defining_process['whiteness_min_value'].$uom_of_whiteness.' to '.$row_for_defining_process['whiteness_max_value'].' '.$uom_of_whiteness, "1", "0","L");
                     $pdf->Cell(15,5,"Pass", "1", "0","C");
                     $pdf->SetTextColor(0,0,0);
                     $pdf->Ln();
                ...
                if (in_array($row['id'], ['49']))
                  ...
                  $uom_of_whiteness = urldecode($pdf->sp_character($content_of_uom_of_whiteness));
						...
						if($row_for_defining_process['whiteness_min_value']<=$row_for_qc['whiteness_value_in_left_side_of_fabric'] && $row_for_defining_process['whiteness_max_value']>=$row_for_qc['whiteness_value_in_left_side_of_fabric'] && $row_for_defining_process['whiteness_min_value']<=$row_for_qc['whiteness_value_in_center_of_fabric'] && $row_for_defining_process['whiteness_max_value']>=$row_for_qc['whiteness_value_in_center_of_fabric'] && $row_for_defining_process['whiteness_min_value']<=$row_for_qc['whiteness_value_in_right_side_of_fabric'] && $row_for_defining_process['whiteness_max_value']>=$row_for_qc['whiteness_value_in_right_side_of_fabric'])
						{
							$p++;
							$pdf->Cell(124,5,$row['test_name_method'],"1", "0","L");
							$pdf->Cell(30,5,'L:'.$row_for_qc['whiteness_value_in_left_side_of_fabric'].$uom_of_whiteness.' C:'.$row_for_qc['whiteness_value_in_center_of_fabric'].$uom_of_whiteness.' R:'.$row_for_qc['whiteness_value_in_right_side_of_fabric'].' '.$uom_of_whiteness, "1", "0","L");
							$pdf->Cell(30,5,$row_for_defining_process['whiteness_min_value'].$uom_of_whiteness.' to '.$row_for_defining_process['whiteness_max_value'].$uom_of_whiteness, "1", "0","C");
							$pdf->Cell(15,5,"Pass", "1", "0","C");
							$pdf->SetTextColor(0,0,0);
							$pdf->Ln();
						}
               ...
               if (in_array($row['id'], ['51','98']))
					 {   
					  if ($row_for_defining_process['absorbency_max_value']<>0 && $row_for_qc['absorbency_value_in_left_side_of_fabric']<>0) {
                         $total_test++;
						 if($row_for_defining_process['absorbency_min_value']<=$row_for_qc['absorbency_value_in_left_side_of_fabric'] && $row_for_defining_process['absorbency_max_value']>=$row_for_qc['absorbency_value_in_left_side_of_fabric'] && $row_for_defining_process['absorbency_min_value']<=$row_for_qc['absorbency_value_in_center_of_fabric'] && $row_for_defining_process['absorbency_max_value']>=$row_for_qc['absorbency_value_in_right_side_of_fabric'] && $row_for_defining_process['absorbency_max_value']>=$row_for_qc['absorbency_value_in_right_side_of_fabric'])
		                     {
		                        $p++;
		                        $pdf->Cell(124,5,$row['test_name_method'],"1", "0","L");
                                $pdf->Cell(30,5,'L:'.$row_for_qc['absorbency_value_in_left_side_of_fabric'].' C:'.$row_for_qc['absorbency_value_in_center_of_fabric'].' R:'.$row_for_qc['absorbency_value_in_right_side_of_fabric'].' '.$row_for_defining_process['uom_of_absorbency'], "1", "0","L");
                                $pdf->Cell(30,5,$row_for_defining_process['absorbency_min_value'].' to '.$row_for_defining_process['absorbency_max_value'].' '.$row_for_defining_process['uom_of_absorbency'], "1", "0","L");
                                $pdf->Cell(15,5,"Pass", "1", "0","C");
                                $pdf->SetTextColor(0,0,0);
                                $pdf->Ln();
		                     }
                         ...
                         } /* End of if ($row_for_defining_process['absorbency_max_value']<>0)*/
		                           
	                  }     /*End of if (in_array($row['id'], ['51','98']))*/

               if (in_array($row['id'], ['50','97']))
					 {
					 	if ($row_for_defining_process['residual_sizing_material_max_value']<>0 && $row_for_qc['residual_sizing_value_in_left_side_of_fabric']<>0) {
								$total_test++;

	                     
	                      if($row_for_defining_process['residual_sizing_material_min_value']<=$row_for_qc['residual_sizing_value_in_left_side_of_fabric'] && $row_for_defining_process['residual_sizing_material_max_value']>=$row_for_qc['residual_sizing_value_in_left_side_of_fabric'] && $row_for_defining_process['residual_sizing_material_min_value']<=$row_for_qc['residual_sizing_value_in_center_of_fabric'] && $row_for_defining_process['residual_sizing_material_max_value']>=$row_for_qc['residual_sizing_value_in_right_side_of_fabric'] && $row_for_defining_process['residual_sizing_material_max_value']>=$row_for_qc['residual_sizing_value_in_right_side_of_fabric'])
		                     {
		                        $p++;
                                $pdf->Cell(124,5,$row['test_name_method'],"1", "0","L");
                                $pdf->Cell(30,5,'L:'.$row_for_qc['residual_sizing_value_in_left_side_of_fabric'].' C:'.$row_for_qc['residual_sizing_value_in_center_of_fabric'].' R:'.$row_for_qc['residual_sizing_value_in_right_side_of_fabric'].' '.$row_for_defining_process['uom_of_residual_sizing_material'], "1", "0","L");
                                $pdf->Cell(30,5,$row_for_defining_process['residual_sizing_material_min_value'].' to '.$row_for_defining_process['residual_sizing_material_max_value'].' '.$row_for_defining_process['uom_of_residual_sizing_material'], "1", "0","L");
                                $pdf->Cell(15,5,"Pass", "1", "0","C");
                                $pdf->SetTextColor(0,0,0);
                                $pdf->Ln();
		                     }
	                       ...
	                       } /*End of if ($row_for_defining_process['residual_sizing_material_max_value']<>0) */
	                     ...
	                     if($row_for_defining_process['smoothness_appearance_max_value']<>0 && $row_for_qc['smoothness_appearance_value']<>0)
	                        {
	                           $total_test++;
		                           if($row_for_defining_process['smoothness_appearance_min_value']<=$row_for_qc['smoothness_appearance_value'] && $row_for_defining_process['smoothness_appearance_max_value']>=$row_for_qc['smoothness_appearance_value'])
				                     {
				                        $p++;
										$pdf->Cell(124,5,$row['test_name_method'].' ('.$row_for_defining_process['smoothness_appearance_tolerance_washing_cycle'].')',"1", "0","L");
               ...
               { 
                    ...
                    {  
                     ...
                     if($row_for_defining_process['percentage_of_total_cotton_content_min_value']<=$row_for_qc['cotton_fiber_content_value'] && $row_for_defining_process['percentage_of_total_cotton_content_max_value']>=$row_for_qc['cotton_fiber_content_value'])
                     {
                        $p++;
                        $pdf->Cell(124,5,$row['test_name_method'].'(Total Cotton)',"1", "0","L");
                       $pdf->Cell(21,5,$row_for_qc['cotton_fiber_content_value'].' ' .$row_for_defining_process['uom_of_percentage_of_total_cotton_content'], "1", "0","L");
                        $pdf->Cell(30,5,$row_for_defining_process['percentage_of_total_cotton_content_value'].' '.$row_for_defining_process['uom_of_percentage_of_total_cotton_content'].' ('.$percentage_of_total_cotton_content_tolerance_range_math_operator.'  '.$row_for_defining_process['percentage_of_total_cotton_content_tolerance_value']." %)", "1", "0","L");
                        $pdf->Cell(15,5,"Pass", "1", "0","C");
                        $pdf->SetTextColor(0,0,0);
                        $pdf->Ln();
                  ...
                  if($row_for_defining_process['percentage_of_total_polyester_content_max_value']<>0 && $row_for_qc['polyester_fiber_content_value']<>0)
                 {
                     ...
                     if($row_for_defining_process['percentage_of_total_polyester_content_min_value']<=$row_for_qc['polyester_fiber_content_value'] && $row_for_defining_process['percentage_of_total_polyester_content_max_value']>=$row_for_qc['polyester_fiber_content_value'])
                     {
                        $p++;
                        $pdf->Cell(124,5,$row['test_name_method'].'(Total Polyester)',"1", "0","L");
                       $pdf->Cell(21,5,$row_for_qc['polyester_fiber_content_value'].' ' .$row_for_defining_process['uom_of_percentage_of_total_polyester_content'], "1", "0","L");
                        $pdf->Cell(30,5,$row_for_defining_process['percentage_of_total_polyester_content_value'].' '.$row_for_defining_process['uom_of_percentage_of_total_polyester_content'].' ('.$percentage_of_total_polyester_content_tolerance_range_math_op.'  '.$row_for_defining_process['percentage_of_total_polyester_content_tolerance_value']." %)", "1", "0","L");
                        $pdf->Cell(15,5,"Pass", "1", "0","C");
                        $pdf->SetTextColor(0,0,0);
                        $pdf->Ln();
                     }
                  ...
                  if($row_for_defining_process['percentage_of_total_other_fiber_content_max_value']<>0 && $row_for_qc['other_fiber_content_value']<>0)
                 {
                     ...
                     {
                        $p++;
                        $pdf->Cell(124,5,$row['test_name_method'].'('.$row_for_defining_process['description_or_type_for_total_other_fiber'].')',"1", "0","L");
                       $pdf->Cell(21,5,$row_for_qc['other_fiber_content_value'].' ' .$row_for_defining_process['uom_of_percentage_of_total_other_fiber_content'], "1", "0","L");
                        $pdf->Cell(30,5,$row_for_defining_process['percentage_of_total_other_fiber_content_value'].' '.$row_for_defining_process['uom_of_percentage_of_total_other_fiber_content'].' ('.$percentage_of_total_other_fiber_content_tolerance_range_math_op.'  '.$row_for_defining_process['percentage_of_total_other_fiber_content_tolerance_value']." %)", "1", "0","L");
                        $pdf->Cell(15,5,"Pass", "1", "0","C");
                        $pdf->SetTextColor(0,0,0);
                        $pdf->Ln();
               ...
               $f++;
                 ...
                 if($row_for_defining_process['percentage_of_warp_cotton_content_max_value']<>0 && $row_for_qc['cotton_fiber_content_value']<>0)
                 {
                     ...
                     if($row_for_defining_process['percentage_of_warp_cotton_content_min_value']<=$row_for_qc['cotton_fiber_content_value'] && $row_for_defining_process['percentage_of_warp_cotton_content_max_value']>=$row_for_qc['cotton_fiber_content_value'])
                     {
                        $p++;
                        $pdf->Cell(124,5,$row['test_name_method'].'(Warp Cotton)',"1", "0","L");
                       $pdf->Cell(21,5,$row_for_qc['cotton_fiber_content_value'].' ' .$row_for_defining_process['uom_of_percentage_of_warp_cotton_content'], "1", "0","L");
                        $pdf->Cell(30,5,$row_for_defining_process['percentage_of_warp_cotton_content_value'].' '.$row_for_defining_process['uom_of_percentage_of_warp_cotton_content'].' ('.$percentage_of_warp_cotton_content_tolerance_range_math_operator.'  '.$row_for_defining_process['percentage_of_warp_cotton_content_tolerance_value']." %)", "1", "0","L");
                        $pdf->Cell(15,5,"Pass", "1", "0","C");
                        $pdf->SetTextColor(0,0,0);
                        $pdf->Ln();
                ...
                if($row_for_defining_process['percentage_of_warp_polyester_content_max_value']<>0 && $row_for_qc['polyester_fiber_content_value']<>0)
                 {
                     ...
                     if($row_for_defining_process['percentage_of_warp_polyester_content_min_value']<=$row_for_qc['polyester_fiber_content_value'] && $row_for_defining_process['percentage_of_warp_polyester_content_max_value']>=$row_for_qc['polyester_fiber_content_value'])
                     {
                        $p++;
                        $pdf->Cell(124,5,$row['test_name_method'].'(Warp Polyester)',"1", "0","L");
                       $pdf->Cell(21,5,$row_for_qc['polyester_fiber_content_value'].' ' .$row_for_defining_process['uom_of_percentage_of_warp_polyester_content'], "1", "0","L");
                        $pdf->Cell(30,5,$row_for_defining_process['percentage_of_warp_polyester_content_value'].' '.$row_for_defining_process['uom_of_percentage_of_warp_polyester_content'].' ('.$percentage_of_warp_polyester_content_tolerance_range_math_op.'  '.$row_for_defining_process['percentage_of_warp_polyester_content_tolerance_value']." %)", "1", "0","L");
                        $pdf->Cell(15,5,"Pass", "1", "0","C");
                        $pdf->SetTextColor(0,0,0);
                        $pdf->Ln();
                 ...
                 if($row_for_defining_process['percentage_of_warp_other_fiber_content_max_value']<>0 && $row_for_qc['other_fiber_content_value']<>0)
                 {
                     ...
                     {
                        $p++;
                        $pdf->Cell(124,5,$row['test_name_method'].'('.$row_for_defining_process['description_or_type_for_warp_other_fiber'].')',"1", "0","L");
                       $pdf->Cell(21,5,$row_for_qc['other_fiber_content_value'].' ' .$row_for_defining_process['uom_of_percentage_of_warp_other_fiber_content'], "1", "0","L");
                        $pdf->Cell(30,5,$row_for_defining_process['percentage_of_warp_other_fiber_content_value'].' '.$row_for_defining_process['uom_of_percentage_of_warp_other_fiber_content'].' ('.$percentage_of_warp_other_fiber_content_tolerance_range_math_op.'  '.$row_for_defining_process['percentage_of_warp_other_fiber_content_tolerance_value']." %)", "1", "0","L");
                        $pdf->Cell(15,5,"Pass", "1", "0","C");
                        $pdf->SetTextColor(0,0,0);
                        $pdf->Ln();
                 ...
                 if($row_for_defining_process['percentage_of_weft_cotton_content_max_value']<>0 && $row_for_qc['cotton_fiber_content_value']<>0)
                 {
                     ...
                     if($row_for_defining_process['percentage_of_weft_cotton_content_min_value']<=$row_for_qc['cotton_fiber_content_value'] && $row_for_defining_process['percentage_of_weft_cotton_content_max_value']>=$row_for_qc['cotton_fiber_content_value'])
                     {
                        $p++;
                        $pdf->Cell(124,5,$row['test_name_method'].'(Weft Cotton)',"1", "0","L");
                       $pdf->Cell(21,5,$row_for_qc['cotton_fiber_content_value'].' ' .$row_for_defining_process['uom_of_percentage_of_weft_cotton_content'], "1", "0","L");
                        $pdf->Cell(30,5,$row_for_defining_process['percentage_of_weft_cotton_content_value'].' '.$row_for_defining_process['uom_of_percentage_of_weft_cotton_content'].' ('.$percentage_of_weft_cotton_content_tolerance_range_math_op.'  '.$row_for_defining_process['percentage_of_weft_cotton_content_tolerance_value']." %)", "1", "0","L");
                        $pdf->Cell(15,5,"Pass", "1", "0","C");
                        $pdf->SetTextColor(0,0,0);
                        $pdf->Ln();
                  ...
                  if($row_for_defining_process['percentage_of_weft_polyester_content_max_value']<>0 && $row_for_qc['polyester_fiber_content_value']<>0)
                 {
                     ...
                     if($row_for_defining_process['percentage_of_weft_polyester_content_min_value']<=$row_for_qc['polyester_fiber_content_value'] && $row_for_defining_process['percentage_of_weft_polyester_content_max_value']>=$row_for_qc['polyester_fiber_content_value'])
                     {
                        $p++;
                 $pdf->Cell(124,5,$row['test_name_method'].'(Weft Polyester)',"1", "0","L");
                       $pdf->Cell(21,5,$row_for_qc['polyester_fiber_content_value'].' ' .$row_for_defining_process['uom_of_percentage_of_weft_polyester_content'], "1", "0","L");
                        $pdf->Cell(30,5,$row_for_defining_process['percentage_of_weft_polyester_content_value'].' '.$row_for_defining_process['uom_of_percentage_of_weft_polyester_content'].' ('.$percentage_of_weft_polyester_content_tolerance_range_math_op.'  '.$row_for_defining_process['percentage_of_weft_polyester_content_tolerance_value']." %)", "1", "0","L");
                        $pdf->Cell(15,5,"Pass", "1", "0","C");
                        $pdf->SetTextColor(0,0,0);
                        $pdf->Ln();
                 ...
                 if($row_for_defining_process['percentage_of_weft_other_fiber_content_max_value']<>0 && $row_for_qc['other_fiber_content_value']<>0)
                 {
                     ...
                     {
                        $p++;
                        $pdf->Cell(124,5,$row['test_name_method'].'('.$row_for_defining_process['description_or_type_for_weft_other_fiber'].')',"1", "0","L");
                       $pdf->Cell(21,5,$row_for_qc['other_fiber_content_value'].' ' .$row_for_defining_process['uom_of_percentage_of_weft_other_fiber_content'], "1", "0","L");
                        $pdf->Cell(30,5,$row_for_defining_process['percentage_of_weft_other_fiber_content_value'].' '.$row_for_defining_process['uom_of_percentage_of_weft_other_fiber_content'].' ('.$percentage_of_weft_other_fiber_content_tolerance_range_math_op.'  '.$row_for_defining_process['percentage_of_weft_other_fiber_content_tolerance_value']." %)", "1", "0","L");
                        $pdf->Cell(15,5,"Pass", "1", "0","C");
                        $pdf->SetTextColor(0,0,0);
                        $pdf->Ln();
         ...
         if (in_array($row['id'], ['44']))
         {
...

          {
            ...
            $content_greige_width = urlencode($row_for_defining_process['greige_width_range_math_operator']);
            $greige_width_range_math_operator = urldecode($pdf->sp_character($content_greige_width));
            ...
            if($row_for_defining_process['greige_width_min_value']<=$row_for_qc['gerige_width_value'] && $row_for_defining_process['greige_width_max_value']>=$row_for_qc['gerige_width_value'])
            {
                $p++;
                        $pdf->Cell(124,5,$row['test_name_method'],"1", "0","L");
                       $pdf->Cell(21,5,$row_for_qc['gerige_width_value'].' ' .$row_for_defining_process['uom_of_greige_width_value'], "1", "0","L");
                        $pdf->Cell(30,5,$row_for_defining_process['greige_width_value'].' '.$row_for_defining_process['uom_of_greige_width_value'].' ('.$greige_width_range_math_operator.'  '.$row_for_defining_process['greige_width_tolerance_value']." %)", "1", "0","L");
                        $pdf->Cell(15,5,"Pass", "1", "0","C");
                        $pdf->SetTextColor(0,0,0);
                        $pdf->Ln();
            }
         ...
         if (in_array($row['id'], ['45']))
         {
           ...
           if ($row_for_defining_process['flame_intensity_max_value']<>0 && $row_for_qc['flame_intensity_value']<>0) {
              ...
              if($row_for_defining_process['flame_intensity_min_value']<=$row_for_qc['flame_intensity_value'] && $row_for_defining_process['flame_intensity_max_value']>=$row_for_qc['flame_intensity_value'])
              {
                 $p++;
                        $pdf->Cell(124,5,$row['test_name_method'],"1", "0","L");
                       $pdf->Cell(21,5,$row_for_qc['flame_intensity_value'].' ' .$row_for_defining_process['uom_of_flame_intensity'], "1", "0","L");
                        $pdf->Cell(30,5,'('.$row_for_defining_process['flame_intensity_min_value'].' to '.$row_for_defining_process['flame_intensity_max_value'].') '.$row_for_defining_process['uom_of_flame_intensity'], "1", "0","L");
                        $pdf->Cell(15,5,"Pass", "1", "0","C");
                        $pdf->SetTextColor(0,0,0);
                        $pdf->Ln();
         ...
         if (in_array($row['id'], ['46']))
					 {
						...
						if ($row_for_defining_process['machine_speed_max_value']<>0 && $row_for_qc['machine_speed']<>0) {
							...
							if($row_for_defining_process['machine_speed_min_value']<=$row_for_qc['machine_speed'] && $row_for_defining_process['machine_speed_max_value']>=$row_for_qc['machine_speed'])
							{
								$p++;
                        $pdf->Cell(124,5,$row['test_name_method'],"1", "0","L");
                       $pdf->Cell(21,5,$row_for_qc['machine_speed'].' ' .$row_for_defining_process['uom_of_machine_speed'], "1", "0","L");
                        $pdf->Cell(30,5,'('.$row_for_defining_process['machine_speed_min_value'].' to '.$row_for_defining_process['machine_speed_max_value'].') '.$row_for_defining_process['uom_of_machine_speed'], "1", "0","L");
                        $pdf->Cell(15,5,"Pass", "1", "0","C");
                        $pdf->SetTextColor(0,0,0);
                        $pdf->Ln();
							}
                ...
                if (in_array($row['id'], ['47']))
                     ...
                     $content_bath_temperature = urlencode($row_for_defining_process['uom_of_bath_temperature']);
                     $uom_of_bath_temperature = urldecode($pdf->sp_character($content_bath_temperature));
							...
							if($row_for_defining_process['bath_temperature_min_value']<=$row_for_qc['bath_temperature'] && $row_for_defining_process['bath_temperature_max_value']>=$row_for_qc['bath_temperature'])
							{
								 $p++;
								   $pdf->Cell(124,5,$row['test_name_method'],"1", "0","L");
                          $pdf->Cell(21,5,$row_for_qc['bath_temperature'].'' .$uom_of_bath_temperature, "1", "0","L");
                           $pdf->Cell(30,5,$row_for_defining_process['bath_temperature_min_value'].' to '.$row_for_defining_process['bath_temperature_max_value'].''.$uom_of_bath_temperature, "1", "0","L");
                           $pdf->Cell(15,5,"Pass", "1", "0","C");
                           $pdf->SetTextColor(0,0,0);
                           $pdf->Ln();
							}
						...
						if ($row_for_defining_process['bath_ph_max_value']<>0 && $row_for_qc['bath_ph']<>0)
						 {
							...
							if($bath_ph_min_value<=$bath_ph && $bath_ph_max_value>=$bath_ph)
							{
								$p++;
                        $pdf->Cell(124,5,$row['test_name_method'],"1", "0","L");
                       $pdf->Cell(21,5,$row_for_qc['bath_ph'].'' .$row_for_defining_process['uom_of_bath_ph'], "1", "0","L");
                        $pdf->Cell(30,5,$row_for_defining_process['bath_ph_min_value'].' to '.$row_for_defining_process['bath_ph_max_value'].''.$row_for_defining_process['uom_of_bath_ph'], "1", "0","L");
                        $pdf->Cell(15,5,"Pass", "1", "0","C");
                        $pdf->SetTextColor(0,0,0);
                        $pdf->Ln();
							}
                ...
                if (in_array($row['id'], ['50']))
					...
					if ($row_for_defining_process['residual_sizing_material_max_value']<>0 && $row_for_qc['residual_sizing_material_left_value']<>0) 
					   ...
					   if($row_for_defining_process['residual_sizing_material_min_value']<=$row_for_qc['residual_sizing_material_left_value'] && $row_for_defining_process['residual_sizing_material_max_value']>=$row_for_qc['residual_sizing_material_left_value'] && $row_for_defining_process['residual_sizing_material_min_value']<=$row_for_qc['residual_sizing_material_center_value'] && $row_for_defining_process['residual_sizing_material_max_value']>=$row_for_qc['residual_sizing_material_center_value'] && $row_for_defining_process['residual_sizing_material_min_value']<=$row_for_qc['residual_sizing_material_right_value'] && $row_for_defining_process['residual_sizing_material_max_value']>=$row_for_qc['residual_sizing_material_right_value'])
					   {
						   $p++;
                     $pdf->Cell(124,5,$row['test_name_method'],"1", "0","L");
                     $pdf->Cell(30,5,"L:".$row_for_qc['residual_sizing_material_left_value'].' C: '.$row_for_qc['residual_sizing_material_center_value'].' R: '.$row_for_qc['residual_sizing_material_right_value'].' '.$row_for_defining_process['uom_of_residual_sizing_material'], "1", "0","L");
                     $pdf->Cell(30,5,$row_for_defining_process['residual_sizing_material_min_value'].' to '.$row_for_defining_process['residual_sizing_material_max_value'], "1", "0","L");
                     $pdf->Cell(15,5,"Pass", "1", "0","C");
                     $pdf->SetTextColor(0,0,0);
                     $pdf->Ln();
					   }
            ...
            if (in_array($row['id'], ['50']))
					 {
					  if ($row_for_defining_process['residual_sizing_material_max_value']<>0 && $row_for_qc['residual_sizing_material_value']<>0) 
					   {
						      $total_test++;
                         if($row_for_defining_process['residual_sizing_material_min_value']<=$row_for_qc['residual_sizing_material_value'] && $row_for_defining_process['residual_sizing_material_max_value']>=$row_for_qc['residual_sizing_material_value'])
                              {
                                 $p++;
                                 $pdf->Cell(124,5,$row['test_name_method'],"1", "0","L");
                                $pdf->Cell(21,5,$row_for_qc['residual_sizing_material_value'].' ' .$row_for_defining_process['uom_of_residual_sizing_material'], "1", "0","L");
                                 $pdf->Cell(30,5,$row_for_defining_process['residual_sizing_material_min_value'].' to '.$row_for_defining_process['residual_sizing_material_max_value'].' '.$row_for_defining_process['uom_of_residual_sizing_material'], "1", "0","L");
                                 $pdf->Cell(15,5,"Pass", "1", "0","C");
                                 $pdf->SetTextColor(0,0,0);
                                 $pdf->Ln();
                   ...
                   {
                     if ($row_for_defining_process['absorbency_min_value']<>0 && $row_for_qc['absorbency_left_value']<>0) 
                     {
                             $total_test++;
                       if($row_for_defining_process['absorbency_min_value']<=$row_for_qc['absorbency_left_value'] && $row_for_defining_process['absorbency_max_value']>=$row_for_qc['absorbency_left_value'] && $row_for_defining_process['absorbency_min_value']<=$row_for_qc['absorbency_center_value'] && $row_for_defining_process['absorbency_max_value']>=$row_for_qc['absorbency_center_value'] && $row_for_defining_process['absorbency_min_value']<=$row_for_qc['absorbency_right_value'] && $row_for_defining_process['absorbency_max_value']>=$row_for_qc['absorbency_right_value'])
                              {
                                 $p++;
                                 $pdf->Cell(124,5,$row['test_name_method'],"1", "0","L");
                                 $pdf->Cell(30,5,"L:".$row_for_qc['absorbency_left_value'].' C: '.$row_for_qc['absorbency_center_value'].' R: '.$row_for_qc['absorbency_right_value'].' '.$row_for_defining_process['uom_of_absorbency'], "1", "0","L");
                                 $pdf->Cell(30,5,'('.$row_for_defining_process['absorbency_min_value'].' to '.$row_for_defining_process['absorbency_max_value'].') '.$row_for_defining_process['uom_of_absorbency'], "1", "0","L");
                                 $pdf->Cell(15,5,"Pass", "1", "0","C");
                                 $pdf->SetTextColor(0,0,0);
                                 $pdf->Ln();
               ...
               if (in_array($row['id'], ['51']))
                     {
                        ...
                        if ($row_for_defining_process['absorbency_max_value']<>0 && $row_for_qc['absorbency_value']<>0) 
                        {

                        $total_test++;
                        if($row_for_defining_process['absorbency_min_value']<=$row_for_qc['absorbency_value'] && $row_for_defining_process['absorbency_max_value']>=$row_for_qc['absorbency_value'])
                        {
                           $p++;
                           $pdf->Cell(124,5,$row['test_name_method'],"1", "0","L");
                          $pdf->Cell(21,5,$row_for_qc['absorbency_value'].' ' .$row_for_defining_process['uom_of_absorbency'], "1", "0","L");
                           $pdf->Cell(30,5,$row_for_defining_process['absorbency_min_value'].' to '.$row_for_defining_process['absorbency_max_value'].' '.$row_for_defining_process['uom_of_absorbency'], "1", "0","L");
                           $pdf->Cell(15,5,"Pass", "1", "0","C");
                           $pdf->SetTextColor(0,0,0);
                           $pdf->Ln();
               ...
               if (in_array($row['id'], ['6']))
					 { 
						  if ($row_for_defining_process['resistance_to_surface_fuzzing_and_pilling_max_value']<>0 && $row_for_qc['resistance_to_surface_fuzzing_and_pilling_left_value']<>0) 
						{
							$total_test++;

                     
							if($row_for_defining_process['resistance_to_surface_fuzzing_and_pilling_min_value']<=$row_for_qc['resistance_to_surface_fuzzing_and_pilling_left_value'] && $row_for_defining_process['resistance_to_surface_fuzzing_and_pilling_max_value']>=$row_for_qc['resistance_to_surface_fuzzing_and_pilling_left_value'] && $row_for_defining_process['resistance_to_surface_fuzzing_and_pilling_min_value']<=$row_for_qc['resistance_to_surface_fuzzing_and_pilling_center_value'] && $row_for_defining_process['resistance_to_surface_fuzzing_and_pilling_max_value']>=$row_for_qc['resistance_to_surface_fuzzing_and_pilling_center_value'] && $row_for_defining_process['resistance_to_surface_fuzzing_and_pilling_min_value']<=$row_for_qc['resistance_to_surface_fuzzing_and_pilling_right_value'] && $row_for_defining_process['resistance_to_surface_fuzzing_and_pilling_max_value']>=$row_for_qc['resistance_to_surface_fuzzing_and_pilling_right_value'])
							{
								$p++;
                        $pdf->Cell(124,5,$row['test_name_method'],"1", "0","L");
                        $pdf->Cell(30,5,"L:".$row_for_qc['resistance_to_surface_fuzzing_and_pilling_left_value'].' C: '.$row_for_qc['resistance_to_surface_fuzzing_and_pilling_center_value'].' R: '.$row_for_qc['resistance_to_surface_fuzzing_and_pilling_right_value'].' '.$row_for_defining_process['uom_of_resistance_to_surface_fuzzing_and_pilling'], "1", "0","L");
                        $pdf->Cell(30,5,$row_for_defining_process['resistance_to_surface_fuzzing_and_pilling_min_value'].' to '.$row_for_defining_process['resistance_to_surface_fuzzing_and_pilling_max_value'], "1", "0","C");
                        $pdf->Cell(15,5,"Pass", "1", "0","C");
                        $pdf->SetTextColor(0,0,0);
                        $pdf->Ln();
							}
                      ...
                      if ($row_for_defining_process['surface_fuzzing_and_pilling_max_value']<>0 && $row_for_qc['resistance_to_surface_fuzzing_and_pilling_left_value']<>0) 
                        {
                           ...
                           if($row_for_defining_process['surface_fuzzing_and_pilling_min_value']<=$row_for_qc['resistance_to_surface_fuzzing_and_pilling_left_value'] && $row_for_defining_process['surface_fuzzing_and_pilling_max_value']>=$row_for_qc['resistance_to_surface_fuzzing_and_pilling_left_value'] && $row_for_defining_process['surface_fuzzing_and_pilling_min_value']<=$row_for_qc['resistance_to_surface_fuzzing_and_pilling_center_value'] && $row_for_defining_process['surface_fuzzing_and_pilling_max_value']>=$row_for_qc['resistance_to_surface_fuzzing_and_pilling_center_value'] && $row_for_defining_process['surface_fuzzing_and_pilling_min_value']<=$row_for_qc['resistance_to_surface_fuzzing_and_pilling_right_value'] && $row_for_defining_process['surface_fuzzing_and_pilling_max_value']>=$row_for_qc['resistance_to_surface_fuzzing_and_pilling_right_value'])
                           {
                              ...
                              $pdf->Cell(124,5,$row['test_name_method'],"1", "0","L");
                              $pdf->Cell(30,5,"L:".$row_for_qc['resistance_to_surface_fuzzing_and_pilling_left_value'].' C: '.$row_for_qc['resistance_to_surface_fuzzing_and_pilling_center_value'].' R: '.$row_for_qc['resistance_to_surface_fuzzing_and_pilling_right_value'].' '.$row_for_defining_process['uom_of_resistance_to_surface_fuzzing_and_pilling'], "1", "0","L");
                              $pdf->Cell(30,5,$surface_fuzzing_and_pilling_tolerance_range_math_operator.' '.$row_for_defining_process['surface_fuzzing_and_pilling_tolerance_value'].' '.$row_for_defining_process['uom_of_resistance_to_surface_fuzzing_and_pilling'], "1", "0","L");
                              $pdf->Cell(15,5,"Pass", "1", "0","C");
                              $pdf->SetTextColor(0,0,0);
                              $pdf->Ln();
                           }
               ...
               if (in_array($row['id'], ['3']))
					{ 
							 ...
							 if($customer_type == 'american')
									...
									$appear_after_wash_fabric_color_change = $row_for_qc['appear_after_wash_fabric_color_change_value'];
										...
										if($row_for_defining_process['appearance_after_washing_fabric_color_change_min_value']<=$row_for_qc['appear_after_wash_fabric_color_change_value'] && $row_for_defining_process['appearance_after_washing_fabric_color_change_max_value']>=$row_for_qc['appear_after_wash_fabric_color_change_value'])
										  {
											 $p++;
											 $pdf->Cell(124,5,$row['test_name_method']. '(Fabric (Color Change))('.$row_for_defining_process['appearance_after_washing_cycle_fabric_wash'].')',"1", "0","L");
							 ...
							 if($customer_type == 'american')
									...
									$appearance_after_washing_fabric_cross_staining = $row_for_qc['appearance_after_washing_fabric_cross_staining_value'];
										...
										if($row_for_defining_process['appearance_after_washing_fabric_cross_staining_min_value']<=$row_for_qc['appearance_after_washing_fabric_cross_staining_value'] && $row_for_defining_process['appearance_after_washing_fabric_cross_staining_max_value']>=$row_for_qc['appearance_after_washing_fabric_cross_staining_value'])
										  {
											 $p++;
											 $pdf->Cell(124,5,$row['test_name_method']. '(Fabric (Cross Staining))('.$row_for_defining_process['appearance_after_washing_cycle_fabric_wash'].')',"1", "0","L");
							 ...
							 if($customer_type == 'american')
									...
									$appearance_after_washing_fabric_surface_fuzzing = $row_for_qc['appearance_after_washing_fabric_surface_fuzzing_value'];
										...
										if($row_for_defining_process['appearance_after_washing_fabric_surface_fuzzing_min_value']<=$row_for_qc['appearance_after_washing_fabric_surface_fuzzing_value'] && $row_for_defining_process['appearance_after_washing_fabric_surface_fuzzing_max_value']>=$row_for_qc['appearance_after_washing_fabric_surface_fuzzing_value'])
										  {
											 $p++;
											 $pdf->Cell(124,5,$row['test_name_method']. '(Fabric (Surface Fuzzing))('.$row_for_defining_process['appearance_after_washing_cycle_fabric_wash'].')',"1", "0","L");
							 ...
							 if($customer_type == 'american')
									...
									$appearance_after_washing_fabric_surface_pilling = $row_for_qc['appearance_after_washing_fabric_surface_pilling_value'];
										...
										if($row_for_defining_process['appearance_after_washing_fabric_surface_pilling_min_value']<=$row_for_qc['appearance_after_washing_fabric_surface_pilling_value'] && $row_for_defining_process['appearance_after_washing_fabric_surface_pilling_max_value']>=$row_for_qc['appearance_after_washing_fabric_surface_pilling_value'])
										  {
											 $p++;
											 $pdf->Cell(124,5,$row['test_name_method']. '(Fabric (Surface Pilling))('.$row_for_defining_process['appearance_after_washing_cycle_fabric_wash'].')',"1", "0","L");
							 ...
							 if($customer_type == 'american')
									...
									$appearance_after_washing_fabric_crease_before_ironing = $row_for_qc['appearance_after_washing_fabric_crease_before_ironing_value'];
										...
										if($row_for_defining_process['appearance_after_washing_fabric_crease_before_ironing_min_value']<=$row_for_qc['appearance_after_washing_fabric_crease_before_ironing_value'] && $row_for_defining_process['appearance_after_washing_fabric_crease_before_ironing_max_value']>=$row_for_qc['appearance_after_washing_fabric_crease_before_ironing_value'])
										  {
											 $p++;
											 $pdf->Cell(124,5,$row['test_name_method']. '(Fabric (Crease before ironing))('.$row_for_defining_process['appearance_after_washing_cycle_fabric_wash'].')',"1", "0","L");
							 ...
							 if($customer_type == 'american')
									...
									$appearance_after_washing_fabric_crease_after_ironing = $row_for_qc['appearance_after_washing_fabric_crease_after_ironing_value'];
										...
										if($row_for_defining_process['appearance_after_washing_fabric_crease_after_ironing_min_value']<=$row_for_qc['appearance_after_washing_fabric_crease_after_ironing_value'] && $row_for_defining_process['appearance_after_washing_fabric_crease_after_ironing_max_value']>=$row_for_qc['appearance_after_washing_fabric_crease_after_ironing_value'])
										  {
											 $p++;
											 $pdf->Cell(124,5,$row['test_name_method']. '(Fabric(Crease after ironing))('.$row_for_defining_process['appearance_after_washing_cycle_fabric_wash'].')',"1", "0","L");
						...
						{
								  $pdf->Cell(124,5,$row['test_name_method']. ' (Fabric (Loss of Print))('.$row_for_defining_process['appearance_after_washing_cycle_fabric_wash'].')',"1", "0","L");
						...
						{
								  $pdf->Cell(124,5,$row['test_name_method']. ' (Fabric (Abrasive Mark))('.$row_for_defining_process['appearance_after_washing_cycle_fabric_wash'].')',"1", "0","L");
...
if($row_for_trf['verified_signature'] <> '')
{
	...
	// $pdf->Cell(95,6,"Verified By :    ".$pdf->Image('../img/less_equal.png',160, $pdf->GetY(), 2),"0","0","C");
...
$pdf->Output('I', "partial_test_for_'$process_name'_process.pdf", true);
// ob_end_flush();
?>
