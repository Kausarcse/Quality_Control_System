...
$table="<div id='scouring_table' style='display:none'><table class='table table-bordered'>
<thead><tr>
<th>Test Name</th>
<th>Test Result</th>
<th>Requirements</th>
<th>Remarks</th>
 ...
 <tbody> 
  ";
	...
	$sql_for_scouring="select * from defining_qc_standard_for_scouring_process WHERE customer_name='$customer_name' and pp_number= '$pp_number' and version_number='$version_number'  and `finish_width_in_inch`='$finish_width_in_inch'";
	$result_for_scouring=mysqli_query($con,$sql_for_scouring) or die(mysqli_error($con));
	$row_for_defining_process=mysqli_fetch_array($result_for_scouring);
	...
	$sql_for_scouring_qc_result="select * from qc_result_for_scouring_process WHERE customer_name='$customer_name' and pp_number= '$pp_number' and version_number='$version_number' and `finish_width_in_inch`='$finish_width_in_inch' and `before_trolley_number_or_batcher_number`='$before_trolley_number_or_batcher_number' and `after_trolley_number_or_batcher_number`='$after_trolley_number_or_batcher_number'";
	$result_for_scouring_qc=mysqli_query($con,$sql_for_scouring_qc_result) or die(mysqli_error($con));
	$row_for_qc=mysqli_fetch_array($result_for_scouring_qc);
						  ...
						  if($row_for_defining_process['absorbency_min_value']<=$row_for_qc['absorbency_left_value'] && $row_for_defining_process['absorbency_max_value']>=$row_for_qc['absorbency_left_value'] && $row_for_defining_process['absorbency_min_value']<=$row_for_qc['absorbency_center_value'] && $row_for_defining_process['absorbency_max_value']>=$row_for_qc['absorbency_center_value'] && $row_for_defining_process['absorbency_min_value']<=$row_for_qc['absorbency_right_value'] && $row_for_defining_process['absorbency_max_value']>=$row_for_qc['absorbency_right_value'])
									{
										...
										$table.="<tr>
										<td>".$row['test_name_method']."</td>
										<td>Left:".$row_for_qc['absorbency_left_value'].' Center: '.$row_for_qc['absorbency_center_value'].' Right: '.$row_for_qc['absorbency_right_value'].' '.$row_for_defining_process['uom_of_absorbency']."</td>	
					 ...
					 { 
						  if ($row_for_defining_process['resistance_to_surface_fuzzing_and_pilling_max_value']<>0 && $row_for_qc['resistance_to_surface_fuzzing_and_pilling_left_value']<>0) 
						{
							...
							if($row_for_defining_process['resistance_to_surface_fuzzing_and_pilling_min_value']<=$row_for_qc['resistance_to_surface_fuzzing_and_pilling_left_value'] && $row_for_defining_process['resistance_to_surface_fuzzing_and_pilling_max_value']>=$row_for_qc['resistance_to_surface_fuzzing_and_pilling_left_value'] && $row_for_defining_process['resistance_to_surface_fuzzing_and_pilling_min_value']<=$row_for_qc['resistance_to_surface_fuzzing_and_pilling_center_value'] && $row_for_defining_process['resistance_to_surface_fuzzing_and_pilling_max_value']>=$row_for_qc['resistance_to_surface_fuzzing_and_pilling_center_value'] && $row_for_defining_process['resistance_to_surface_fuzzing_and_pilling_min_value']<=$row_for_qc['resistance_to_surface_fuzzing_and_pilling_right_value'] && $row_for_defining_process['resistance_to_surface_fuzzing_and_pilling_max_value']>=$row_for_qc['resistance_to_surface_fuzzing_and_pilling_right_value'])
							{
								...
								<td>".$row_for_defining_process['resistance_to_surface_fuzzing_and_pilling_min_value'].' to '.$row_for_defining_process['resistance_to_surface_fuzzing_and_pilling_max_value']."</td>
								<td>Pass</td>
								</tr>";
							}
							else 
				  ...
				  if ($row_for_defining_process['ph_max_value']<>0 && $row_for_qc['ph_left_value']<>0) 
	                        ...
	                        if($row_for_defining_process['ph_min_value']<=$row_for_qc['ph_left_value'] && $row_for_defining_process['ph_max_value']>=$row_for_qc['ph_left_value'] && $row_for_defining_process['ph_min_value']<=$row_for_qc['ph_left_value'] && $row_for_defining_process['ph_max_value']>=$row_for_qc['ph_right_value'] && $row_for_defining_process['ph_max_value']>=$row_for_qc['ph_right_value'])
							{
								$p++;
									...
									<td>Left:".$row_for_qc['ph_left_value'].' Center:'.$row_for_qc['ph_center_value'].' Right:'.$row_for_qc['ph_right_value']."</td>	
