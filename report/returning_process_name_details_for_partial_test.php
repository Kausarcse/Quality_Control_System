...
$obj->connection();
  ...
  $result_for_porcess_selection= mysqli_query($con,$sql_for_porcess_selection) or die(mysqli_error($con));
         ...
         $option='<option value=""> Select Before Trolley</option>';
		...
		/* $sql = "SELECT ptfti.process_name
		 ...
		 {    
		  ...
		  $option=$option.'<option value="'.$row['before_trolley_number_or_batcher_number'].'"> '.$row['before_trolley_number_or_batcher_number'].' </option>';
