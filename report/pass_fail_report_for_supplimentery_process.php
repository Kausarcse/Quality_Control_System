...
$table="<div id='supplimentery_process_table' style='display:none;'><table class='table table-bordered'>
<thead><tr>
<th>Test Name</th>
<th>Test Result</th>
<th>Unit</th>
 ...
 $f= 0;
	...
	$result= mysqli_query($con,$sql) or die(mysqli_error($con));
				 while( $row = mysqli_fetch_array( $result))
				 {
					...
					{
						if ($row_for_defining_process['dimensional_stability_to_warp_washing_before_iron_max_value']<>0 && $row_for_qc_supplimentery['dimensional_stability_to_warp_washing_before_iron_value']<>0) 
						{
							...
							if($row_for_defining_process['dimensional_stability_to_warp_washing_before_iron_min_value']<=$row_for_qc_supplimentery['dimensional_stability_to_warp_washing_before_iron_value'] && $row_for_defining_process['dimensional_stability_to_warp_washing_before_iron_max_value']>=$row_for_qc_supplimentery['dimensional_stability_to_warp_washing_before_iron_value'])
							{
								$p++;
								 ...
								 $table.="<tr>
									...
									<td>".$row_for_qc_supplimentery['dimensional_stability_to_warp_washing_before_iron_value'].' ('.$row_for_defining_process['uom_of_dimensional_stability_to_warp_washing_before_iron'].")</td>
						...
						if ($row_for_defining_process['dimensional_stability_to_weft_washing_before_iron_max_value']<>0 && $row_for_qc_supplimentery['dimensional_stability_to_weft_washing_before_iron_value']<>0) 
						{
							$total_test++;

							if($row_for_defining_process['dimensional_stability_to_weft_washing_before_iron_min_value']<=$row_for_qc_supplimentery['dimensional_stability_to_weft_washing_before_iron_value'] && $row_for_defining_process['dimensional_stability_to_weft_washing_before_iron_max_value']>=$row_for_qc_supplimentery['dimensional_stability_to_weft_washing_before_iron_value'])
							{
								$p++;

								 $table.="<tr>
									<td>".$row['test_name_method'].'(Before Iron-Weft)('.$row_for_defining_process['washing_cycle_for_weft_for_washing_before_iron'].' Wash)'."</td>
									<td>".$row_for_qc_supplimentery['dimensional_stability_to_weft_washing_before_iron_value'].' ('.$row_for_defining_process['uom_of_dimensional_stability_to_weft_washing_before_iron'].")</td>
						...
						if ($row_for_defining_process['dimensional_stability_to_warp_washing_after_iron_max_value']<>0 && $row_for_qc_supplimentery['dimensional_stability_to_warp_washing_after_iron_value']<>0) 
						{

							$total_test++;

							if($row_for_defining_process['dimensional_stability_to_warp_washing_after_iron_min_value']<=$row_for_qc_supplimentery['dimensional_stability_to_warp_washing_after_iron_value'] && $row_for_defining_process['dimensional_stability_to_warp_washing_after_iron_max_value']>=$row_for_qc_supplimentery['dimensional_stability_to_warp_washing_after_iron_value'])
							{
								$p++;

								$table.="<tr>
									<td>".$row['test_name_method'].'(After Iron-Warp)('.$row_for_defining_process['washing_cycle_for_warp_for_washing_after_iron'].' Wash)'."</td>
									<td>".$row_for_qc_supplimentery['dimensional_stability_to_warp_washing_after_iron_value'].' ('.$row_for_defining_process['uom_of_dimensional_stability_to_warp_washing_after_iron'].")</td>
						...
						if ($row_for_defining_process['dimensional_stability_to_weft_washing_after_iron_max_value']<>0 && $row_for_qc_supplimentery['dimensional_stability_to_weft_washing_after_iron_value']<>0) 
						{

							$total_test++;

							if($row_for_defining_process['dimensional_stability_to_weft_washing_after_iron_min_value']<=$row_for_qc_supplimentery['dimensional_stability_to_weft_washing_after_iron_value'] && $row_for_defining_process['dimensional_stability_to_weft_washing_after_iron_max_value']>=$row_for_qc_supplimentery['dimensional_stability_to_weft_washing_after_iron_value'])
							{
								$p++;

								 $table.="<tr>
									<td>".$row['test_name_method'].'(After Iron-Weft)('.$row_for_defining_process['washing_cycle_for_weft_for_washing_after_iron'].' Wash)'."</td>
									<td>".$row_for_qc_supplimentery['dimensional_stability_to_weft_washing_after_iron_value'].' (' .$row_for_defining_process['uom_of_dimensional_stability_to_weft_washing_after_iron'].")</td>
					...
					if (in_array($row['id'], ['4']))
					{
						...
						if ($row_for_defining_process['no_of_threads_in_warp_max_value']<>0 && $row_for_qc_supplimentery['no_of_threads_in_warp_value']<>0) 
						{
                            
                            $total_test++;

							if($row_for_defining_process['no_of_threads_in_warp_min_value']<=$row_for_qc_supplimentery['no_of_threads_in_warp_value'] && $row_for_defining_process['no_of_threads_in_warp_max_value']>=$row_for_qc_supplimentery['no_of_threads_in_warp_value'])
							{
								$p++;
								 $table.="<tr>
									<td>".$row['test_name_method'].'(Warp)'."</td>
									<td>".$row_for_qc_supplimentery['no_of_threads_in_warp_value'].' '.$row_for_defining_process['uom_of_no_of_threads_in_warp_value']."</td>
							...
							if ($row_for_defining_process['no_of_threads_in_weft_max_value']<>0 && $row_for_qc_supplimentery['no_of_threads_in_weft_value']<>0) 
							{
							
							$total_test++;

							if($row_for_defining_process['no_of_threads_in_weft_min_value']<=$row_for_qc_supplimentery['no_of_threads_in_weft_value'] && $row_for_defining_process['no_of_threads_in_weft_max_value']>=$row_for_qc_supplimentery['no_of_threads_in_weft_value'])
							{
								$p++;

								$table.="<tr>
									<td>".$row['test_name_method'].'(Weft)'."</td>
									<td>".$row_for_qc_supplimentery['no_of_threads_in_weft_value'].' '.$row_for_defining_process['uom_of_no_of_threads_in_weft_value']."</td>
					...
					if (in_array($row['id'], ['13']))
					 {
						...
						if ($row_for_defining_process['abrasion_resistance_c_change_value_max_value']<>0 && $row_for_qc['abrasion_resistance_c_change_value']<>0) {
							...
							if($row_for_defining_process['abrasion_resistance_c_change_value_min_value']<=$row_for_qc['abrasion_resistance_c_change_value'] && $row_for_defining_process['abrasion_resistance_c_change_value_max_value']>=$row_for_qc['abrasion_resistance_c_change_value'])
							{
								...
								<td>".$row_for_qc['abrasion_resistance_c_change_value'].' '.$row_for_defining_process['uom_of_abrasion_resistance_c_change_value']."</td>
					 ...
					 if (in_array($row['id'], ['13']))
					{
						...
						if ($row_for_defining_process['mass_loss_in_abrasion_test_value_max_value']<>0 && $row_for_qc['mass_loss_in_abrasion_value']<>0) {
							...
							if($row_for_defining_process['mass_loss_in_abrasion_test_value_min_value']<=$row_for_qc['mass_loss_in_abrasion_value'] && $row_for_defining_process['mass_loss_in_abrasion_test_value_max_value']>=$row_for_qc['mass_loss_in_abrasion_value'])
							{
								...
								$table.="<tr>
								<td>".$row['test_name_method']."</td>
								<td>".$row_for_qc['mass_loss_in_abrasion_value'].' '.$row_for_defining_process['uom_of_mass_loss_in_abrasion_test_value']."</td>
                   ...
                   if (in_array($row['id'], ['37']))
                      ...
                      if($row_for_defining_process['percentage_of_warp_polyester_content_max_value']<>0 && $row_for_qc['warp_Polyester_content_value']<>0)
                       ...
                       if($row_for_defining_process['percentage_of_warp_other_fiber_content_max_value']<>0 && $row_for_qc['warp_other_fiber_value']<>0)
                       {
                           ...
                           if($row_for_defining_process['percentage_of_warp_other_fiber_content_min_value']<=$row_for_qc['warp_other_fiber_value'] && $row_for_defining_process['percentage_of_warp_other_fiber_content_max_value']>=$row_for_qc['warp_other_fiber_value'])
                           {
							  ...
							  <td>".$row_for_defining_process['percentage_of_warp_other_fiber_content_value'].' '.$row_for_defining_process['uom_of_percentage_of_warp_other_fiber_content'].'  ('.$row_for_defining_process['percentage_of_warp_other_fiber_content_tolerance_range_math_op'].'  '.$row_for_defining_process['percentage_of_warp_other_fiber_content_tolerance_value']." %)</td>
							  <td>Pass</td>
							  </tr>";
                           }
                           else {
					...
					{ 
								  ...
								  if($row_for_defining_process['appearance_after_washing_fabric_color_change_min_value']<=$row_for_qc['appear_after_wash_fabric_color_change_value'] && $row_for_defining_process['appearance_after_washing_fabric_color_change_max_value']>=$row_for_qc['appear_after_wash_fabric_color_change_value'])
									{
									   $p++;
									   $table.="<tr>
									   <td>".$row['test_name_method']. '(Fabric (Color Change))'."</td>
									   <td>".$appear_after_wash_fabric_color_change_value.' '.$row_for_defining_process['uom_of_appearance_after_washing_fabric_color_change']."</td>
									   <td>".$row_for_defining_process['appearance_after_washing_fabric_color_change_math_op'].' '.$appearance_after_washing_fabric_color_change_tolerance_value.' '.$row_for_defining_process['uom_of_appearance_after_washing_fabric_color_change']."</td>
									   <td>Pass</td>
									   </tr>";
									}
									else {
								  ...
								  if($row_for_defining_process['appearance_after_washing_fabric_cross_staining_min_value']<=$row_for_qc['appearance_after_washing_fabric_cross_staining_value'] && $row_for_defining_process['appearance_after_washing_fabric_cross_staining_max_value']>=$row_for_qc['appearance_after_washing_fabric_cross_staining_value'])
									{
									   $p++;
									   $table.="<tr>
									   <td>".$row['test_name_method']. '(Fabric (Cross Staining))'."</td>
									   <td>".$appearance_after_washing_fabric_cross_staining_value.' '.$row_for_defining_process['uom_of_appearance_after_washing_fabric_cross_staining']."</td>
									   <td>".$row_for_defining_process['appearance_after_washing_fabric_cross_staining_math_op'].' '.$appearance_after_washing_fabric_cross_staining_tolerance_value.' '.$row_for_defining_process['uom_of_appearance_after_washing_fabric_cross_staining']."</td>
									   <td>Pass</td>
									   </tr>";
									}
									else {
								  ...
								  if($row_for_defining_process['appearance_after_washing_fabric_surface_fuzzing_min_value']<=$row_for_qc['appearance_after_washing_fabric_surface_fuzzing_value'] && $row_for_defining_process['appearance_after_washing_fabric_surface_fuzzing_max_value']>=$row_for_qc['appearance_after_washing_fabric_surface_fuzzing_value'])
									{
									   $p++;
									   $table.="<tr>
									   <td>".$row['test_name_method']. '(Fabric (Surface Fuzzing))'."</td>
									   <td>".$appearance_after_washing_fabric_surface_fuzzing_value.' '.$row_for_defining_process['uom_of_appearance_after_washing_fabric_surface_fuzzing']."</td>
									   <td>".$row_for_defining_process['appearance_after_washing_fabric_surface_fuzzing_math_op'].' '.$appearance_after_washing_fabric_surface_fuzzing_tolerance_value.' '.$row_for_defining_process['uom_of_appearance_after_washing_fabric_surface_fuzzing']."</td>
									   <td>Pass</td>
									   </tr>";
									}
									else {
								  ...
								  if($row_for_defining_process['appearance_after_washing_fabric_surface_pilling_min_value']<=$row_for_qc['appearance_after_washing_fabric_surface_pilling_value'] && $row_for_defining_process['appearance_after_washing_fabric_surface_pilling_max_value']>=$row_for_qc['appearance_after_washing_fabric_surface_pilling_value'])
									{
									   $p++;
									   $table.="<tr>
									   <td>".$row['test_name_method']. '(Fabric (Surface Pilling))'."</td>
									   <td>".$appearance_after_washing_fabric_surface_pilling_value.' '.$row_for_defining_process['uom_of_appearance_after_washing_fabric_surface_pilling']."</td>
									   <td>".$row_for_defining_process['appearance_after_washing_fabric_surface_pilling_math_op'].' '.$appearance_after_washing_fabric_surface_pilling_tolerance_value.' '.$row_for_defining_process['uom_of_appearance_after_washing_fabric_surface_pilling']."</td>
									   <td>Pass</td>
									   </tr>";
									}
									else {
								  ...
								  if($row_for_defining_process['appearance_after_washing_fabric_crease_before_ironing_min_value']<=$row_for_qc['appearance_after_washing_fabric_crease_before_ironing_value'] && $row_for_defining_process['appearance_after_washing_fabric_crease_before_ironing_max_value']>=$row_for_qc['appearance_after_washing_fabric_crease_before_ironing_value'])
									{
									   $p++;
									   $table.="<tr>
									   <td>".$row['test_name_method']. '(Fabric (Crease before ironing))'."</td>
									   <td>".$appearance_after_washing_fabric_crease_before_ironing_value.' '.$row_for_defining_process['uom_of_appearance_after_washing_fabric_crease_before_ironing']."</td>
									   <td>".$row_for_defining_process['appearance_after_washing_fabric_crease_before_iron_math_op'].' '.$appearance_after_washing_fabric_crease_before_iron_tolerance_val.' '.$row_for_defining_process['uom_of_appearance_after_washing_fabric_crease_before_ironing']."</td>
									   <td>Pass</td>
									   </tr>";
									}
									else {
								  ...
								  if($row_for_defining_process['appearance_after_washing_fabric_crease_after_ironing_min_value']<=$row_for_qc['appearance_after_washing_fabric_crease_after_ironing_value'] && $row_for_defining_process['appearance_after_washing_fabric_crease_after_ironing_max_value']>=$row_for_qc['appearance_after_washing_fabric_crease_after_ironing_value'])
									{
									   $p++;
									   $table.="<tr>
									   <td>".$row['test_name_method']. '(Fabric (Crease after ironing))'."</td>
									   <td>".$appearance_after_washing_fabric_crease_after_ironing_value.' '.$row_for_defining_process['uom_of_appearance_after_washing_fabric_crease_after_ironing']."</td>
									   <td>".$row_for_defining_process['appearance_after_washing_fabric_crease_after_iron_math_op'].' '.$appearance_after_washing_fabric_crease_after_iron_tolerance_val.' '.$row_for_defining_process['uom_of_appearance_after_washing_fabric_crease_after_ironing']."</td>
									   <td>Pass</td>
									   </tr>";
									}
									else {
						...
						if($row_for_defining_process['appearance_after_washing_loss_of_print_fabric']<>0 && $row_for_qc['appearance_after_washing_fabric_loss_of_print_value']<>0)
						   {
							 
									   $table.="<tr>
									   <td>".$row['test_name_method']. '(Fabric (Loss of Print))'."</td>
						...
						if($row_for_defining_process['appearance_after_washing_fabric_abrasive_mark']<>'' && $row_for_qc['appearance_after_washing_fabric_abrasive_mark_value']<>'')
						   {
									   ...
									   $table.="<tr>
									   <td>".$row['test_name_method']. '(Fabric (Abrasive Mark))'."</td>
						...
						if($row_for_defining_process['appearance_after_washing_odor_fabric']<>0 && $row_for_qc['appearance_after_washing_fabric_odor_value']<>0)
						   {
							 
									   $table.="<tr>
									   <td>".$row['test_name_method']. '(Fabric (Odor))'."</td>
								  ...
								  if($row_for_defining_process['appear_after_washing_garments_color_change_without_sup_min_value']<=$row_for_qc['appear_after_wash_garments_color_change_without_sup_value'] && $row_for_defining_process['appear_after_washing_garments_color_change_without_sup_max_val']>=$row_for_qc['appear_after_wash_garments_color_change_without_sup_value'])
									{
									   $p++;
									   $table.="<tr>
									   <td>".$row['test_name_method']. '(Garments (Color Change (Without Suppressor)))'."</td>
									   <td>".$appear_after_wash_garments_color_change_without_sup_value.' '.$row_for_defining_process['uom_of_appear_after_washing_garments_color_change_without_sup']."</td>
									   <td>".$row_for_defining_process['appear_after_washing_garments_color_change_without_sup_math_op'].' '.$appear_after_washing_garments_color_change_without_sup_toler_val.' '.$row_for_defining_process['uom_of_appear_after_washing_garments_color_change_without_sup']."</td>
									   <td>Pass</td>
									   </tr>";
									}
									else {
								  ...
								  if($row_for_defining_process['appear_after_washing_garments_color_change_with_sup_min_value']<=$row_for_qc['appear_after_wash_garments_color_change_with_sup_value'] && $row_for_defining_process['appear_after_washing_garments_color_change_with_sup_max_value']>=$row_for_qc['appear_after_wash_garments_color_change_with_sup_value'])
									{
									   $p++;
									   $table.="<tr>
									   <td>".$row['test_name_method']. '(Garments (Color Change (With Suppressor)))'."</td>
									   <td>".$appear_after_wash_garments_color_change_with_sup_value.' '.$row_for_defining_process['uom_of_appear_after_washing_garments_color_change_with_sup']."</td>
									   <td>".$row_for_defining_process['appear_after_washing_garments_color_change_with_sup_math_op'].' '.$appear_after_washing_garments_color_change_with_sup_toler_value.' '.$row_for_defining_process['uom_of_appear_after_washing_garments_color_change_with_sup']."</td>
									   <td>Pass</td>
									   </tr>";
									}
									else {
								  ...
								  if($row_for_defining_process['appearance_after_washing_garments_cross_staining_min_value']<=$row_for_qc['appearance_after_washing_garments_cross_staining_value'] && $row_for_defining_process['appearance_after_washing_garments_cross_staining_max_value']>=$row_for_qc['appearance_after_washing_garments_cross_staining_value'])
									{
									   $p++;
									   $table.="<tr>
									   <td>".$row['test_name_method']. '(Garments (Cross Staining))'."</td>
									   <td>".$appearance_after_washing_garments_cross_staining_value.' '.$row_for_defining_process['uom_of_appearance_after_washing_garments_cross_staining']."</td>
									   <td>".$row_for_defining_process['appear_after_washing_garments_cross_staining_math_op'].' '.$appear_after_washing_garments_cross_staining_tolerance_value.' '.$row_for_defining_process['uom_of_appearance_after_washing_garments_cross_staining']."</td>
									   <td>Pass</td>
									   </tr>";
									}
									else {
								  ...
								  if($row_for_defining_process['appearance_after_washing_garments__differential_shrink_min_value']<=$row_for_qc['appearance_after_washing_garments_differential_shrinkage_value'] && $row_for_defining_process['appearance_after_washing_garments__differential_shrink_max_value']>=$row_for_qc['appearance_after_washing_garments_differential_shrinkage_value'])
									{
									   $p++;
									   $table.="<tr>
									   <td>".$row['test_name_method']. '(Garments (Differential Shrinking))'."</td>
									   <td>".$appearance_after_washing_garments_differential_shrinkage_value.' '.$row_for_defining_process['uom_of_appearance_after_washing_garments__differential_shrinkage']."</td>
									   <td>".$row_for_defining_process['appear_after_washing_garments_differential_shrink_math_op'].' '.$appear_after_washing_garments__differential_shrink_tolerance_val.' '.$row_for_defining_process['uom_of_appearance_after_washing_garments__differential_shrinkage']."</td>
									   <td>Pass</td>
									   </tr>";
									}
									else {
								  ...
								  if($row_for_defining_process['appearance_after_washing_garments_surface_fuzzing_min_value']<=$row_for_qc['appearance_after_washing_garments_surface_fuzzing_value'] && $row_for_defining_process['appearance_after_washing_garments_surface_fuzzing_max_value']>=$row_for_qc['appearance_after_washing_garments_surface_fuzzing_value'])
									{
									   $p++;
									   $table.="<tr>
									   <td>".$row['test_name_method']. '(Garments (Surface Fuzzing))'."</td>
									   <td>".$appearance_after_washing_garments_surface_fuzzing_value.' '.$row_for_defining_process['uom_of_appearance_after_washing_garments_surface_fuzzing']."</td>
									   <td>".$row_for_defining_process['appear_after_washing_garments_surface_fuzzing_math_op'].' '.$appearance_after_washing_garments_surface_fuzzing_tolerance_val.' '.$row_for_defining_process['uom_of_appearance_after_washing_garments_surface_fuzzing']."</td>
									   <td>Pass</td>
									   </tr>";
									}
									else {
								  ...
								  if($row_for_defining_process['appearance_after_washing_garments_surface_pilling_min_value']<=$row_for_qc['appearance_after_washing_garments_surface_pilling_value'] && $row_for_defining_process['appearance_after_washing_garments_surface_pilling_max_value']>=$row_for_qc['appearance_after_washing_garments_surface_pilling_value'])
									{
									   $p++;
									   $table.="<tr>
									   <td>".$row['test_name_method']. '(Garments (Surface Pilling))'."</td>
									   <td>".$appearance_after_washing_garments_surface_pilling_value.' '.$row_for_defining_process['uom_of_appearance_after_washing_garments_surface_pilling']."</td>
									   <td>".$row_for_defining_process['appear_after_washing_garments_surface_pilling_math_op'].' '.$appearance_after_washing_garments_surface_pilling_tolerance_val.' '.$row_for_defining_process['uom_of_appearance_after_washing_garments_surface_pilling']."</td>
									   <td>Pass</td>
									   </tr>";
									}
									else {
								  ...
								  if($row_for_defining_process['appearance_after_washing_garments_crease_after_ironing_min_value']<=$row_for_qc['appearance_after_washing_garments_crease_after_ironing_value'] && $row_for_defining_process['appearance_after_washing_garments_crease_after_ironing_max_value']>=$row_for_qc['appearance_after_washing_garments_crease_after_ironing_value'])
									{
									   $p++;
									   $table.="<tr>
									   <td>".$row['test_name_method']. '(Garments (Crease After Ironing))'."</td>
									   <td>".$appearance_after_washing_garments_crease_after_ironing_value.' '.$row_for_defining_process['uom_of_appear_after_washing_garments_crease_after_ironing']."</td>
									   <td>".$row_for_defining_process['appear_after_washing_garments_crease_after_ironing_math_op'].' '.$appear_after_washing_garments_crease_after_ironing_tolerance_val.' '.$row_for_defining_process['uom_of_appear_after_washing_garments_crease_after_ironing']."</td>
									   <td>Pass</td>
									   </tr>";
									}
									else {
						...
						if($row_for_defining_process['appearance_after_washing_garments_abrasive_mark']<>'' && $row_for_qc['appearance_after_washing_garments_abrasive_mark_value']<>'')
						   {
									   ...
									   $table.="<tr>
									   <td>".$row['test_name_method']. '(Garments (Abrasive Mark))'."</td>
						...
						if($row_for_defining_process['seam_breakdown_garments']<>0 && $row_for_qc['appearance_after_washing_garments_seam_breakdown_value']<>0)
						   {
									   ...
									   $table.="<tr>
									   <td>".$row['test_name_method']. '(Garments (Seam Breakdown))'."</td>
								  ...
								  if($row_for_defining_process['appear_after_washing_garments_seam_pucker_rop_iron_min_value']<=$row_for_qc['appearance_after_washing_garments_seam_puckering_roping_after_ir'] && $row_for_defining_process['appear_after_washing_garments_seam_pucker_rop_iron_max_value']>=$row_for_qc['appearance_after_washing_garments_seam_puckering_roping_after_ir'])
									{
									   $p++;
									   $table.="<tr>
									   <td>".$row['test_name_method']. '(Garments (Seam puckering or roping After Iron))'."</td>
									   <td>".$appearance_after_washing_garments_seam_puckering_roping_after_ir.' '.$row_for_defining_process['uom_of_appear_after_washing_garments_seam_pucker_rop_rion']."</td>
									   <td>".$row_for_defining_process['appear_after_wash_garments_seam_pucker_rop_iron_math_op'].' '.$appear_after_washing_garments_seam_pucker_rop_iron_toler_value.' '.$row_for_defining_process['uom_of_appear_after_washing_garments_seam_pucker_rop_rion']."</td>
									   <td>Pass</td>
									   </tr>";
									}
									else {
						...
						if($row_for_defining_process['detachment_of_interlinings_fused_components_garments']<>0 && $row_for_qc['appearance_after_washing_garments_detachment_of_interlining_valu']<>0)
						   {
							 
									   $table.="<tr>
									   <td>".$row['test_name_method']. '(Garments (Detachment of interlinings / fused components))'."</td>
						...
						if($row_for_defining_process['change_id_handle_or_appearance']<>0 && $row_for_qc['appearance_after_washing_garments_change_in_handle_value']<>0)
						   {
							 
									   $table.="<tr>
									   <td>".$row['test_name_method']. '(Garments (Change in handle or appearance))'."</td>
						...
						if($row_for_defining_process['effect_on_accessories_such_as_buttons']<>0 && $row_for_qc['appearance_after_washing_garments_effect_accessories_value']<>0)
						   {
							 
									   $table.="<tr>
									   <td>".$row['test_name_method']. '(Garments (Effect on accessories such as buttons, zips etc.))'."</td>
								  ...
								  if($row_for_defining_process['appearance_after_washing_garments_spirality_min_value']<=$row_for_qc['appearance_after_washing_garments_spirality_value'] && $row_for_defining_process['appearance_after_washing_garments_spirality_max_value']>=$row_for_qc['appearance_after_washing_garments_spirality_value'])
									{
									   $p++;
									   $table.="<tr>
									   <td>".$row['test_name_method']. '(Garments (Spirality (%)))'."</td>
						...
						if($row_for_defining_process['detachment_or_fraying_of_ribbons']<>0 && $row_for_qc['appearance_after_washing_garments_detachment_or_fraying_of_ribbo']<>0)
						   {
							 
									   $table.="<tr>
									   <td>".$row['test_name_method']. '(Garments (Detachment or Fraying of ribbons / trims))'."</td>
						...
						if($row_for_defining_process['loss_of_print_garments']<>0 && $row_for_qc['appearance_after_washing_garments_loss_of_print_value']<>0)
						   {
							 
									   $table.="<tr>
									   <td>".$row['test_name_method']. '(Garments (Loss of Print))'."</td>
						...
						if($row_for_defining_process['care_level_garments']<>0 && $row_for_qc['appearance_after_washing_garments_care_level_value']<>0)
						   {
							 
									   $table.="<tr>
									   <td>".$row['test_name_method']. '(Garments (Care Level))'."</td>
						...
						if($row_for_defining_process['odor_garments']<>0 && $row_for_qc['appearance_after_washing_garments_odor_value']<>0)
						   {
							 
									   $table.="<tr>
									   <td>".$row['test_name_method']. '(Garments (Odor)'."</td>
...
?>
<script>
		$('#supplimentery_process_table').show();
</script>