...
$password = $_SESSION['password'];
  ...
  $result = mysqli_query($con,$select_department) or die(mysqli_error($con));
				...
				<form class="form-horizontal" action="" style="margin-top:10px;" name="department_info_form" id="department_info_form">
						...
						<div class="form-group form-group-sm" id="form-group_for_department_name">
								...
								<div class="col-sm-5">
									...
									<input type="hidden" class="form-control" id="department_id" name="department_id" value="<?php echo $row['id'] ?>" required>
								</div>
