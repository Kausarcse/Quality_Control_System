...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
				...
				<div class="panel-heading" style="color:#191970;"><b> Add Trolley </b></div> <!-- This will create a upper block for FORM (Just Beautification) -->
				...
				<form class="form-horizontal" action="" style="margin-top:10px;" name="trolley_form" id="trolley_form">
						...
						<div class="form-group form-group-sm" id="form-group_for_trolley_no">
								<label class="control-label col-sm-3" for="trolley_no" style="color:#00008B;">Trolley No:</label>
								<div class="col-sm-5">
   ...
   <div class="panel panel-default">
       ...
       <div class="form-group form-group-sm">
	   <div class="form-group form-group-sm">
				<label class="control-label col-sm-12" style="font-size: 25px; text-align:center; padding-top:10px" for="search">Trolley List</label>
			</div> 	  	   
