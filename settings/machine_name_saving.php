...
else if( mysqli_num_rows($result) < 1)
{
	...
	$insert_sql_statement="insert into `machine_name` (`row_id`,`machine_id`,`machine_name`,`process_id`,`process_name`,`recording_person_id`,`recording_person_name`,`recording_time`,`machine_wise_monthly_target` ) values ('$row_id','$current_machine_id','$machine_name','$process_id','$process_name','$user_id','$user_name',NOW(),'$machine_wise_monthly_target')";
