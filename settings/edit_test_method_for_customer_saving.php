...
$select_sql_for_duplicacy="select * from `test_method_for_customer` where `customer_name`='$customer_name' and `customer_id` = '$customer_id' and `checking_field`='$temp_test_method_name'";
	...
	{    
        ...
        /* echo $individual_value_for_insert;
         ...
         $splitted_receiving_date_individual= explode("fs",$individual_value_for_insert);
          ...
          /*echo $test_name_for_use=$splitted_receiving_date_individual[4];*/ 
          $iso_or_aatcc=$splitted_receiving_date_individual[5]; 
         


		$insert_sql_statement="insert into `test_method_for_customer` ( `row_id`,`test_method_for_customer_id`,`customer_name`,`customer_id`,`test_name`,`test_id`,`test_method_id`,`test_method_name`,`iso_or_aatcc`,`checking_field`,`recording_person_id`,`recording_person_name`,`recording_time` ) values ('$row_id','$current_test_method_for_customer_id','$customer_name','$customer_id','$test_name','$test_id','$test_method_id','$test_method_name','$iso_or_aatcc','$temp_test_method_name','$user_id','$user_name',NOW())";
