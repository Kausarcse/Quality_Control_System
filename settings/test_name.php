...
<script>
 function sending_data_of_test_name_form_for_saving_in_database()
 {
       ...
       if(validate != false)
	   {
		  	 ...
		  	 $.ajax({
			 		url: 'settings/test_name_saving.php',
			 		dataType: 'text',
			 		type: 'post',
  ...
  function sending_data_for_delete(test_id)
 {
      
       var url_encoded_form_data = 'test_id='+test_id;
       
         $.ajax({
          url: 'settings/test_name_deleting.php',
          dataType: 'text',
          type: 'post',
          contentType: 'application/x-www-form-urlencoded',
          data: url_encoded_form_data,
...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
				...
				<div class="panel-heading" style="color:#191970;"><b>Test Name</b></div> <!-- This will create a upper block for FORM (Just Beautification) -->

				<nav aria-label="breadcrumb">
					  <ol class="breadcrumb">
					    <li class="breadcrumb-item active" aria-current="page">Home</li>
					    <li class="breadcrumb-item"><a onclick="load_page('settings/test_name.php')">Add Test Name</a></li>
					  </ol>
				 </nav>
				...
				<form class="form-horizontal" action="" style="margin-top:10px;" name="test_name_form" id="test_name_form">
						...
						<div class="form-group form-group-sm">
								<div class="col-sm-offset-3 col-sm-5">
									<button type="button" class="btn btn-primary" onClick="sending_data_of_test_name_form_for_saving_in_database()">Submit</button>
	...
	<div class="panel panel-default">
        ...
        <div class="form-group form-group-sm">
        <div class="form-group form-group-sm">
				<label class="control-label col-sm-12" style="font-size: 25px; text-align:center; padding-top:10px" for="search">Test Name List</label>
			</div> 	  
        ...
        <div class="form-group form-group-sm">
          ...
          <table id="datatable-buttons" class="table table-striped table-bordered">
            ...
            <?php 
                            $s1 = 1;
                            $sql_for_color = "SELECT * FROM test_name_and_method_for_all_process ORDER BY id ASC";
             ...
             <tr>
                ...
                <td>
                      <form  method="post" style="display: inline;">
                        ...
                        <button type="submit" id="" name="" class="btn btn-primary btn-xs" onclick="load_page('settings/edit_test_name.php?test_id=<?php echo $row['test_id'];?>')"> Edit </button>

                         <button type="submit" id="" name="" class="btn btn-danger btn-xs" onclick="sending_data_for_delete('<?php echo $row['test_id'];?>')"> Delete </button>
                      </form>
                    </td>
                <?php
