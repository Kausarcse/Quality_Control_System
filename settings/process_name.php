...
<script>
 function sending_data_of_process_name_form_for_saving_in_database()
 {
       ...
       if(validate != false)
	   {
		  	 ...
		  	 $.ajax({
			 		url: 'settings/process_name_saving.php',
			 		dataType: 'text',
			 		type: 'post',
 ...
 function sending_data_for_delete(process_id)
 {
      
       var url_encoded_form_data = 'process_id='+process_id;
       
		  	 $.ajax({
			 		url: 'settings/process_name_deleting.php',
			 		dataType: 'text',
			 		type: 'post',
			 		contentType: 'application/x-www-form-urlencoded',
			 		data: url_encoded_form_data,
...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
				...
				<form class="form-horizontal" action="" style="margin-top:10px;" name="process_name_form" id="process_name_form">
						...
						<div class="form-group form-group-sm" id="form-group_for_description_of_process">
								...
								<div class="col-sm-5">
									<textarea class='form-control' id='description_of_process' name='description_of_process' rows='5' placeholder="Enter Description Of Process"></textarea>
								</div>
						...
						<div class="form-group form-group-sm">
								<div class="col-sm-offset-3 col-sm-5">
									<button type="button" class="btn btn-primary" onClick="sending_data_of_process_name_form_for_saving_in_database()">Submit</button>
     ...
     <div class="panel panel-default">
	   ...
	   <div class="form-group form-group-sm">
				<label class="control-label col-sm-12" style="font-size: 25px; text-align:center; padding-top:10px" for="search">Process List</label>
			</div> 	  
	    ...
	    <div class="form-group form-group-sm">
          ...
          <table id="datatable-buttons" class="table table-striped table-bordered">
            ...
            <?php 
                            $s1 = 1;
                            $sql_for_color = "SELECT * FROM process_name ORDER BY row_id ASC";
             ...
             <tr>
                ...
                <td><?php echo $row['description_of_process']; ?></td>
                
                
                <td>
                      
                        <button type="submit" id="" name="" class="btn btn-primary btn-xs" onclick="load_page('settings/edit_process_name.php?process_id=<?php echo $row['process_id']?>')"> Edit </button>

                         <button type="submit" id="" name="" class="btn btn-danger btn-xs" onclick="sending_data_for_delete('<?php echo $row['process_id']?>')"> Delete </button>
