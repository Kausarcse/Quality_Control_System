...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
				...
				<div class="panel-heading" style="color:#191970;"><b>Construction</b></div> <!-- This will create a upper block for FORM (Just Beautification) -->


				<nav aria-label="breadcrumb">
					  <ol class="breadcrumb">
					    <li class="breadcrumb-item active" aria-current="page">Home</li>
					    <li class="breadcrumb-item"><a onclick="load_page('settings/construction_for_version.php')">Add Construction</a></li>
					  </ol>
				 </nav>
       ...
       <div class="form-group form-group-sm" id="form-group_for_warp_yarn_count">
          ...
          <div class="form-group form-group-sm">
		  <div class="form-group form-group-sm">
				<label class="control-label col-sm-12" style="font-size: 25px; text-align:center; padding-top:10px" for="search">Construction List</label>
			</div> 	  	      </div> <!-- End of <div class="form-group form-group-sm" -->
