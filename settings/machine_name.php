...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
				...
				<form class="form-horizontal" action="" style="margin-top:10px;" name="machine_name_form" id="machine_name_form">
						...
						<div class="form-group form-group-sm" id="form-group_for_machine_wise_monthly_target">
                                <label class="control-label col-sm-3" for="machine_wise_monthly_target" style="color:#00008B;">Monthly Target:</label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="machine_wise_monthly_target" name="machine_wise_monthly_target" placeholder="Enter Machine Name" required>
                                </div>
                                <i class="glyphicon glyphicon-remove" onclick="Remove_Value_Of_This_Element('machine_wise_monthly_target')"></i>
                        </div> <!-- End of <div class="form-group form-group-sm" id="form-group_for_machine_wise_monthly_target"> -->
    ...
    <div class="panel panel-default">
	   ...
	   <div class="form-group form-group-sm">
				<label class="control-label col-sm-12" style="font-size: 25px; text-align:center; padding-top:10px" for="search">Machine List</label>
			</div> 	  
          ...
          <table id="datatable-buttons" class="table table-striped table-bordered">
            ...
            <?php 
             ...
             <tr>
                ...
                <td><?php echo $row['machine_wise_monthly_target']; ?></td>
