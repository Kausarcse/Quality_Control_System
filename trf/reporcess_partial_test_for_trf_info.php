...
<script type='text/javascript' src='trf/reprocess_partial_test_for_trf_info_form_validation.js'></script>
...
function get_qc_standard_additional_info(pp_number)
{
 ...
 function returning_value_for_shift(alternate_partial_test_for_trf_creation_date_time)
{
    splitted_time = alternate_partial_test_for_trf_creation_date_time.split(':');
...
{  
    ...
    $.ajax({
            url: 'trf/returning_re_process_name.php',
            dataType: 'text',
            type: 'post',
            contentType: 'application/x-www-form-urlencoded',
            data: version_id ,
            ...
            {       
                ...
                $.ajax({
                        url: 'trf/returning_all_for_process_name_for_reprocess_form.php',
                        dataType: 'text',
                        type: 'post',
                        contentType: 'application/x-www-form-urlencoded',
                        data: version_id ,
...
{ 
    ...
    else
    {
        ...
        $.ajax({
                url: 'trf/returning_process_name_details_for_reprocess.php',
                dataType: 'text',
                type: 'post',
                contentType: 'application/x-www-form-urlencoded',
...
function return_trolley_quantity(before_trolley_number_or_batcher_number)
{
    ...
    $.ajax({
            url: 'trf/returning_before_quantity_details_for_partial_test_for_reporcess.php',
            dataType: 'text',
            type: 'post',
            contentType: 'application/x-www-form-urlencoded',
            data: value_for_trolley_data,
...
function sending_data_of_partial_test_for_trf_form_for_saving_in_database()
{
    ...
    {
        $.ajax({
                  url: 'trf/reprocess_partial_test_for_trf_info_saving.php',
                  dataType: 'text',
                  type: 'post',
                  contentType: 'application/x-www-form-urlencoded',
...
}//End of function sending_data_of_partial_test_for_trf_form_for_saving_in_database()
...
/***************************************************** FOR AUTO COMPLETE********************************************************************/
    ...
    <div class="col-sm-12 col-md-12 col-lg-12">
        <div class="panel panel-default" id="div_full_form">
            ...
            <div class="panel-heading" style="color:#191970;"><b>Test Request Form (Reprocess For Trf)</b></div> <!-- This will create a upper block for FORM (Just Beautification) -->
            ...
            <form id='partial_test_for_trf_form' name='partial_test_for_trf_form'  action="" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left" style="margin-bottom: 20px;">
                ...
                <div class="form-group form-group-sm" id="form-group_for_partial_test_for_trf_creation_date">
                    <label class="control-label col-sm-3" for="partial_test_for_trf_creation_date" style="color:#00008B;">Date: <span style="color:red">*</span> </label>
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="partial_test_for_trf_creation_date" name="partial_test_for_trf_creation_date" placeholder="Please Provide Date" required>
                    </div>
                    <div class="col-sm-2">
                        <input type="time" class="form-control" id="alternate_partial_test_for_trf_creation_date_time" name="alternate_partial_test_for_trf_creation_date_time"   placeholder="Hour:Minute" onchange="returning_value_for_shift(this.value)" >
                    </div>
                    <div class="col-sm-1">
                ...
                <script>
                    $( function()
                    {
                        $( "#partial_test_for_trf_creation_date" ).datepicker(
                        {
                            showWeek: true, // This is for Showing Week in Datepicker Calender.
                            //altField: "#alternate_partial_test_for_trf_creation_date_time", // This is for Descriptive Date Showing in Alternative Field.
                            altFormat: "DD, d MM, yy" // This is for Descriptive Date Format in Alternative Field.
                        }
                        ); // End of $( "#pp_creation_date" ).datepicker(

                        $( "#partial_test_for_trf_creation_date" ).datepicker( "option", "dateFormat", "dd/mm/yy" ); // This is for Date Format in Actual Date Field.
                        $( "#partial_test_for_trf_creation_date" ).datepicker( "option", "showAnim", "drop" ); // This is for Datepicker Calender Animation in Actual Date Field.
                    }
                    ); // End of $( function()
                </script>
                   ...
                   <label class="control-label col-sm-3" for="care_label" style="color:#00008B;">Care Label:  </label>
						...
						<div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                              ...
                              <button type="button" name="submit" id="submit" class="btn btn-primary" onClick="sending_data_of_partial_test_for_trf_form_for_saving_in_database()">Submit</button>
                         ...
                         if(($data_for_process_name == 'Re' || $data_for_process_name == '2nd' || $data_for_process_name == '3rd' || $data_for_process_name == '4th') && $process_name != '')
                         {
                             ...
                             <div class="form-group form-group-sm">
                                 <div class="col-sm-offset-3 col-sm-5">
                                     ...
                                     <a href="trf/pdf_file_for_partial_test_trf_washing_lab.php?customer_id=<?php echo $value; ?>" target="_blank">
                                 ...
                                 <div class="col-sm-offset-3 col-sm-5">
                                     <?php $value= $row['customer_id']."?fs?".$row['trf_id']."?fs?".$row['process_id']."?fs?".$row['pp_number']."?fs?".$row['version_id']?> 
                                     <a href="trf/pdf_file_for_partial_test_trf_r_and_d_lab.php?customer_id=<?php echo $value; ?>" target="_blank">
                                 ...
                                 <div class="col-sm-offset-3 col-sm-5">
                                 <?php $value= $row['customer_id']."?fs?".$row['trf_id']."?fs?".$row['process_id']."?fs?".$row['pp_number']."?fs?".$row['version_id']?> 
                                 <a href="trf/pdf_file_for_partial_test_trf_physical_lab.php?customer_id=<?php echo $value; ?>" target="_blank">
                             ...
                             <button type="submit" id="" name=""  class="btn btn-info btn-xs" onclick="load_page('trf/edit_reporcess_partial_test_for_trf_info.php?trf_id=<?php echo $row['trf_id']; ?>')"> Edit</button>
