...
function generate_pdf(){
    ...
    html2pdf(element,{
        margin: 10,
        filename: 'all_test_for_washing_lab.pdf',
				  ...
				  <div class="form-group form-group-sm">
								<div class="col-sm-offset-3 col-sm-8">
									...
									<a href="trf/pdf_file_for_all_test_trf_washing_lab.php?customer_id=<?php echo $value; ?>">
										<button type="button" id="pdf_file_for_all_test_trf_washing_lab" name="pdf_file_for_all_test_trf_washing_lab"  class="btn btn-success">Generate pdf file</button>
									</a>
