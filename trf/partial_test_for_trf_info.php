...
{ 
    ...
    {
        $.ajax({
                url: 'trf/returning_value_for_first_after_trolley_or_batcher_quantity.php',
                dataType: 'text',
                type: 'post',
                contentType: 'application/x-www-form-urlencoded',
...
function sending_data_of_partial_test_for_trf_form_for_saving_in_database()
{
    ...
    {
        $.ajax({
                  url: 'trf/partial_test_for_trf_info_saving.php',
                  dataType: 'text',
                  type: 'post',
                  contentType: 'application/x-www-form-urlencoded',
...
/***************************************************** FOR AUTO COMPLETE********************************************************************/
    ...
    <div class="col-sm-12 col-md-12 col-lg-12">
        <div class="panel panel-default" id="div_full_form">
            ...
            <div class="panel-heading" style="color:#191970;"><b>Test Request Form (Partial Test For Trf)</b></div> <!-- This will create a upper block for FORM (Just Beautification) -->
     ...
     <thead>
      ...
      <tbody>
         ...
         while ($row = mysqli_fetch_assoc($res_for_trf_for_partial_test)) 
         {
           ...
           if($data_for_at=='PT' && $data_for_process_name != 'Re' && $data_for_process_name != '2nd' && $data_for_process_name != '3rd' && $data_for_process_name != '4th' && $process_name != '')
           {
