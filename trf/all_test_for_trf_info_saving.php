...
$partial_test_for_trf_creation_date= $_POST['all_test_for_trf_creation_date'];

$alternate_partial_test_for_trf_creation_date_time= $_POST['alternate_all_test_for_trf_creation_date_time'];
...
$employee_id=$splitted_employee_name[1];
	...
	$process_serial_no= $split_process_name[2];
...
$select_sql_for_duplicacy="SELECT * FROM partial_test_for_trf_info 
							...
							style = '$style' AND 
							process_serial_no = '$process_serial_no' AND 
...
else if( mysqli_num_rows($result) < 1)
{
    ...
    if($row_for_max_primary_key['trf_id']==0)
    {
      ...
      $current_trf_id='ZZZFL_AT_1';

    }
    else
    {

      $current_trf_id ="ZZZFL_AT_".($row_for_max_primary_key['trf_id']+1);
