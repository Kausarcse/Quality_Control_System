function all_test_for_trf_Form_Validation()
{
   
    if(document.getElementById("all_test_for_trf_creation_date").value.trim()=="")
    {
        alert("Please Provide Trf Creation Date");
        document.getElementById("all_test_for_trf_creation_date").focus();
        return false;
    }
    else if(document.getElementById("alternate_all_test_for_trf_creation_date_time").value.trim()=="")
    {
        alert("Please Provide Trf Creation Time");
        document.getElementById("alternate_all_test_for_trf_creation_date_time").focus();
        return false;
    }
