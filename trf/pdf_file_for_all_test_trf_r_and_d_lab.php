...
$pdf->Cell(95,4,"Required Test (R & D Lab)", "1", "0","C",true);
$pdf->Ln(5);
...
//                             WHERE das.pp_number='$pp_number'  and das.customer_id='$customer_id'  and das.process_id='$process_id' and das.version_id='$version_id'";
							...
							{
								if($row_for_test['criteria_or_testing_lab']=='R&D Lab')
                                {
                                    ...
                                    // $pdf->Ln();
                                     ...
                                     ///////////////   Formaldehyde   ////////////////////////
                                    if (in_array($row_for_test['id'], ['32']))
                                    {
                                        if($row_for_defining_process['uom_of_formaldehyde_content']<>'')
                                        {
                                            $uom_of_formaldehyde_content = $row_for_defining_process['uom_of_formaldehyde_content'];
                                            $arr_uom_of_formaldehyde_content = explode(' ',trim($uom_of_formaldehyde_content));
                                            if( ($arr_uom_of_formaldehyde_content[0] == 'Select') || ($arr_uom_of_formaldehyde_content[0] == 'select') || ($arr_uom_of_formaldehyde_content[0] == '') )
                                            {
                                        ...
                                        $pdf->SetFont('Times','',6.5);
                                        $b = 4.8;
                                        $pdf->MultiCell(11,$b,$uom_of_formaldehyde_content,'1','L',TRUE);
                                        $pdf->SetXY($x + 86, $y);
                                        $pdf->MultiCell(9,$b,'','1','L',TRUE);
                                    }

                                    ///////////////   Colourfastness To Light   ////////////////////////
                                    if (in_array($row_for_test['id'], ['40']))
                                    {
                                    ...
                                    ///////////////   Deviation of Fibre Content   ////////////////////////
                                    if (in_array($row_for_test['id'], ['43']))
                                    {
