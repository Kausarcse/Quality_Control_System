...
if(isset($_GET['model_greige_receiving_id']))
{
    $greige_receiving_id=$_GET['model_greige_receiving_id'];
    $sql_for_greige_receiving="select * from model_defining_qc_standard_for_greige_receiving_process where `id`='$greige_receiving_id'";
...
// 53, 100
 ...
 function sending_data_of_edit_defining_qc_standard_for_greige_receiving_process_form_for_saving_in_database()
 {
      ...
      //  if(validate != false)
	   // {
		  	 ...
		  	 $.ajax({
			 		url: 'auto_sync/edit_model_defining_qc_standard_for_greige_receiving_process_saving.php',
			 		dataType: 'text',
			 		type: 'post',
			 		contentType: 'application/x-www-form-urlencoded',
 ...
 }//End of function sending_data_of_edit_defining_qc_standard_for_greige_receiving_process_form_for_saving_in_database()
...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
				...
				<div class="panel-heading" style="color:#191970;"><b>Edit Model Defining Standard For Greige Receiving Process</b></div> <!-- This will create a upper block for FORM (Just Beautification) -->
    ...
    <div class="form-group form-group-sm" id="form-group_for_pp_number">
        <!--	<label class="control-label col-sm-4" for="pp_number" style="margin-right:0px; color:#00008B;">PP Number:</label>-->
						...
						<input type="hidden" class="form-control" id="color_name" name="color_name" value="<?php echo $row_for_greige_receiving['color']; ?>">
						<input type="hidden" class="form-control" id="process_name" name="process_name" value="<?php echo $row_for_greige_receiving['process_name']; ?>">
						<input type="hidden" class="form-control" id="process_serial" name="process_serial" value="<?php echo $row_for_greige_receiving['process_serial']; ?>">
						<input type="hidden" class="form-control" id="process_technique_name" name="process_technique_name" value="<?php echo $row_for_greige_receiving['process_technique']; ?>">
...
<div class="form-group form-group-sm" id="div_fiber_content" style="display: none">
 ...
 <div class="form-group form-group-sm">
								<div class="col-sm-offset-3 col-sm-5">
									<button type="button" class="btn btn-primary" onClick="sending_data_of_edit_defining_qc_standard_for_greige_receiving_process_form_for_saving_in_database()">Save</button>
