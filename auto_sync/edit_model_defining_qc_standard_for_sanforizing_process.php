...
$model_sanforizing_id = '';

if(isset($_GET['model_sanforizing_id']))
{
   $model_sanforizing_id=$_GET['model_sanforizing_id'];
   $sql_for_model_sanforizing="select * from model_defining_qc_standard_for_sanforizing_process where `id`='$model_sanforizing_id'";
   $result_for_model_sanforizing= mysqli_query($con,$sql_for_model_sanforizing) or die(mysqli_error($con));
   $row_for_model_sanforizing = mysqli_fetch_array( $result_for_model_sanforizing);
}
...
$.ajax({
 ...
 function sending_data_of_edit_defining_qc_standard_for_model_sanforizing_process_form_for_saving_in_database()
{
       var url_encoded_form_data = $("#defining_qc_standard_for_model_sanforizing_process_form").serialize();

       $.ajax({
        url: 'auto_sync/edit_model_defining_qc_standard_for_sanforizing_process_saving.php',
        dataType: 'text',
        type: 'post',
        contentType: 'application/x-www-form-urlencoded',
...
}//End of function sending_data_of_defining_qc_standard_for_model_sanforizing_process_form_for_saving_in_database()
...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
				...
				<div class="panel-heading" style="color:#191970;"><b>Edit Model Defining Standard For Sanforizing Process</b></div> 
                ...
                <div id='search_form_collpapsible_div_1' class="collapse in"> 
                     ...
                     <form class="form-horizontal" action="" style="margin-top:10px;" name="defining_qc_standard_for_model_sanforizing_process_form_view" id="defining_qc_standard_for_model_sanforizing_process_form_view" data-toggle="collapse" data-target="#search_form_collpapsible_div">
	                       ...
	                       <table id="datatable-buttons" class="table table-striped table-bordered">
	                        <thead>
	                          ...
	                          <?php
                                  ...
                                  if(isset($model_sanforizing_id))
                                  {
                                     $sql_for_model_sanforizing = "SELECT * FROM `model_defining_qc_standard_for_sanforizing_process` WHERE `id`='$model_sanforizing_id'";
                                  }


                                  $res_for_model_sanforizing = mysqli_query($con, $sql_for_model_sanforizing);

                                  while ($row = mysqli_fetch_assoc($res_for_model_sanforizing))
                                  {
               ...
               </form>    <!-- End of <form class="form-horizontal" action="" style="margin-top:10px;" name="defining_qc_standard_for_model_sanforizing_process_form" id="defining_qc_standard_for_model_sanforizing_process_form"> -->

	</div> <!-- End of <div class="panel-heading" style="color:#191970;"><b> model_sanforizing Standard Process List</b></div>  -->

   <button type="button" class="btn btn-info" id="buttn_for_load_form" onclick="load_full_form('<?php echo $row_for_model_sanforizing['customer_id']?>')">Load Form</button>
    ...
    <form class="form-horizontal" action="" style="margin-top:10px;" name="defining_qc_standard_for_model_sanforizing_process_form" id="defining_qc_standard_for_model_sanforizing_process_form">
						...
						<input type="hidden" class="form-control" id="version_number" name="version_number" value="<?php echo $row_for_model_sanforizing['version_number']; ?>">
						<input type="hidden" class="form-control" id="customer_id" name="customer_id" value="<?php echo $row_for_model_sanforizing['customer_id']; ?>">
						<input type="hidden" class="form-control" id="customer_name" name="customer_name" value="<?php echo $row_for_model_sanforizing['customer_name']; ?>">
						<input type="hidden" class="form-control" id="color_name" name="color_name" value="<?php echo $row_for_model_sanforizing['color']; ?>">
						<input type="hidden" class="form-control" id="process_name" name="process_name" value="<?php echo $row_for_model_sanforizing['process_name']; ?>">
						<input type="hidden" class="form-control" id="process_serial" name="process_serial" value="<?php echo $row_for_model_sanforizing['process_serial']; ?>">
						<input type="hidden" class="form-control" id="process_technique_name" name="process_technique_name" value="<?php echo $row_for_model_sanforizing['process_technique']; ?>">
...
<div class="form-group form-group-sm">
  ...
  <div class="col-sm-1 text-center">
      <select  class="form-control" id="cf_to_rubbing_dry_tolerance_range_math_operator" name="cf_to_rubbing_dry_tolerance_range_math_operator" style="color:#00008B; margin-top:23px;" onchange="cf_to_rubbing_dry_cal()">
          ...
          <?php
                              $cf_to_rubbing_dry_tolerance_range_math_operator = $row_for_model_sanforizing['cf_to_rubbing_dry_tolerance_range_math_operator'];
  ...
  <div class="col-sm-1" for="tolerance">
    ...
    <input type="text" class="form-control" id="cf_to_rubbing_dry_tolerance_value" name="cf_to_rubbing_dry_tolerance_value" value="<?php echo $row_for_model_sanforizing['cf_to_rubbing_dry_tolerance_value']?>"  required onchange="cf_to_rubbing_dry_cal()" style="color:#00008B; margin-top:23px;">

  </div>

  <div class="col-sm-1" for="unit">
    <hr style="color:#FF0000;border-top: 2px dashed #FF0000; margin-top:35px;"/>
    <input type="hidden" id="uom_of_cf_to_rubbing_dry" name="uom_of_cf_to_rubbing_dry"  value="<?php echo $row_for_model_sanforizing['uom_of_cf_to_rubbing_dry']?>">
  </div>

        
  <div class="col-sm-1 text-center" for="min_value">

    <input type="text" class="form-control" id="cf_to_rubbing_dry_min_value" name="cf_to_rubbing_dry_min_value" style="color:#00008B; margin-top:23px;" value="<?php echo $row_for_model_sanforizing['cf_to_rubbing_dry_min_value']?>" required>
     
  </div>
          
  <div class="col-sm-1 text-center">
      
    <input type="text" class="form-control" id="cf_to_rubbing_dry_max_value" name="cf_to_rubbing_dry_max_value" style="color:#00008B; margin-top:23px;" value="<?php echo $row_for_model_sanforizing['cf_to_rubbing_dry_max_value']?>" required>
...
<div class="form-group form-group-sm">
  ...
  <div class="col-sm-1 text-center">
      <select  class="form-control" id="cf_to_rubbing_wet_tolerance_range_math_operator" name="cf_to_rubbing_wet_tolerance_range_math_operator" onchange="cf_to_rubbing_wet_cal()">
              ...
              <?php
                              $cf_to_rubbing_wet_tolerance_range_math_operator = $row_for_model_sanforizing['cf_to_rubbing_wet_tolerance_range_math_operator'];
  ...
  <div class="col-sm-1" for="tolerance">
    ...
    <input type="text" class="form-control" id="cf_to_rubbing_wet_tolerance_value" name="cf_to_rubbing_wet_tolerance_value" value="<?php echo $row_for_model_sanforizing['cf_to_rubbing_wet_tolerance_value']?>" onchange="cf_to_rubbing_wet_cal()" required>

  </div>

  <div class="col-sm-1" for="unit">
    <hr style="color:#FF0000;border-top: 2px dashed #FF0000; margin-top:13px;"/>
    <input type="hidden" id="uom_of_cf_to_rubbing_wet" name="uom_of_cf_to_rubbing_wet"  value="<?php echo $row_for_model_sanforizing['uom_of_cf_to_rubbing_wet']?>">
  </div>

        
  <div class="col-sm-1 text-center" for="min_value">

    <input type="text" class="form-control" id="cf_to_rubbing_wet_min_value" name="cf_to_rubbing_wet_min_value" value="<?php echo $row_for_model_sanforizing['cf_to_rubbing_wet_min_value']?>" required>
     
  </div>
          
  <div class="col-sm-1 text-center">
      
    <input type="text" class="form-control" id="cf_to_rubbing_wet_max_value" name="cf_to_rubbing_wet_max_value" value="<?php echo $row_for_model_sanforizing['cf_to_rubbing_wet_max_value']?>" required>
...
<div class="form-group form-group-sm">
    ...
    <div class="col-sm-3 text-center">
     ...
     <div class="col-sm-2 text-center">
          ...
          <input type="hidden" class="form-control" id="test_method_for_dimensional_stability_to_warp_washing_b_iron" name="test_method_for_dimensional_stability_to_warp_washing_b_iron" value="<?php echo $row_for_model_sanforizing['test_method_for_dimensional_stability_to_warp_washing_b_iron']?>">
     ...
     <div class="col-sm-2 text-center">
          ...
          <input type="text" class="form-control" id="washing_cycle_for_warp_for_washing_before_iron" name="washing_cycle_for_warp_for_washing_before_iron" value="<?php echo $row_for_model_sanforizing['washing_cycle_for_warp_for_washing_before_iron']?>">
      </div>
  ...
  <div class="col-sm-1 text-center" for="min_value">
    ...
    <input type="text" class="form-control" id="dimensional_stability_to_warp_washing_before_iron_min_value" name="dimensional_stability_to_warp_washing_before_iron_min_value" style="color:#00008B;margin-top:35px;" value="<?php echo $row_for_model_sanforizing['dimensional_stability_to_warp_washing_before_iron_min_value']?>">
     
  </div>
          
  <div class="col-sm-1 text-center">
      
    <input type="text" class="form-control" id="dimensional_stability_to_warp_washing_before_iron_max_value" name="dimensional_stability_to_warp_washing_before_iron_max_value" style="color:#00008B;margin-top:35px;" value="<?php echo $row_for_model_sanforizing['dimensional_stability_to_warp_washing_before_iron_max_value']?>">
...
<div class="form-group form-group-sm">
    ...
    <div class="col-sm-3 text-center">
     ...
     <div class="col-sm-2 text-center">
          ...
          <input type="hidden" class="form-control" id="test_method_for_dimensional_stability_to_weft_washing_b_iron" name="test_method_for_dimensional_stability_to_weft_washing_b_iron" value="<?php echo $row_for_model_sanforizing['test_method_for_dimensional_stability_to_weft_washing_b_iron']?>">
     ...
     <div class="col-sm-2 text-center">
          ...
          <input type="text" class="form-control" id="washing_cycle_for_weft_for_washing_before_iron" name="washing_cycle_for_weft_for_washing_before_iron" value="<?php echo $row_for_model_sanforizing['washing_cycle_for_weft_for_washing_before_iron']?>">
      </div>
...
-->
  ...
  <div class="col-sm-1 text-center" for="min_value">
    ...
    <input type="text" class="form-control" id="dimensional_stability_to_weft_washing_before_iron_min_value" name="dimensional_stability_to_weft_washing_before_iron_min_value" style="color:#00008B;" value="<?php echo $row_for_model_sanforizing['dimensional_stability_to_weft_washing_before_iron_min_value']?>">
     
  </div>
          
  <div class="col-sm-1 text-center">
      
    <input type="text" class="form-control" id="dimensional_stability_to_weft_washing_before_iron_max_value" name="dimensional_stability_to_weft_washing_before_iron_max_value" style="color:#00008B;" value="<?php echo $row_for_model_sanforizing['dimensional_stability_to_weft_washing_before_iron_max_value']?>">
...
<div class="form-group form-group-sm">
    ...
    <div class="col-sm-3 text-center">
     ...
     <div class="col-sm-2 text-center">
          ...
          <input type="hidden" class="form-control" id="test_method_for_dimensional_stability_to_warp_washing_after_iron" name="test_method_for_dimensional_stability_to_warp_washing_after_iron" value="<?php echo $row_for_model_sanforizing['test_method_for_dimensional_stability_to_warp_washing_after_iron']?>">
     ...
     <div class="col-sm-2 text-center">
          ...
          <input type="text" class="form-control" id="washing_cycle_for_warp_for_washing_after_iron" name="washing_cycle_for_warp_for_washing_after_iron" value="<?php echo $row_for_model_sanforizing['washing_cycle_for_warp_for_washing_after_iron']?>">
      </div>
  ...
  <div class="col-sm-1" for="unit">
     %
    <input type="hidden" id="uom_of_dimensional_stability_to_warp_washing_after_iron" name="uom_of_dimensional_stability_to_warp_washing_after_iron"  value="<?php echo $row_for_model_sanforizing['uom_of_dimensional_stability_to_warp_washing_after_iron']?>">
  </div>

        
  <div class="col-sm-1 text-center" for="min_value">

    <input type="text" class="form-control" id="dimensional_stability_to_warp_washing_after_iron_min_value" name="dimensional_stability_to_warp_washing_after_iron_min_value" style="color:#00008B;" value="<?php echo $row_for_model_sanforizing['dimensional_stability_to_warp_washing_after_iron_min_value']?>">
     
  </div>
          
  <div class="col-sm-1 text-center">
      
    <input type="text" class="form-control" id="dimensional_stability_to_warp_washing_after_iron_max_value" name="dimensional_stability_to_warp_washing_after_iron_max_value" style="color:#00008B;" value="<?php echo $row_for_model_sanforizing['dimensional_stability_to_warp_washing_after_iron_max_value']?>">
...
<div class="form-group form-group-sm">
    ...
    <div class="col-sm-3 text-center">
     ...
     <div class="col-sm-2 text-center">
          ...
          <input type="hidden" class="form-control" id="test_method_for_dimensional_stability_to_weft_washing_after_iron" name="test_method_for_dimensional_stability_to_weft_washing_after_iron" value="<?php echo $row_for_model_sanforizing['test_method_for_dimensional_stability_to_weft_washing_after_iron']?>">
     ...
     <div class="col-sm-2 text-center">
          ...
          <input type="text" class="form-control" id="washing_cycle_for_weft_for_washing_after_iron" name="washing_cycle_for_weft_for_washing_after_iron" value="<?php echo $row_for_model_sanforizing['washing_cycle_for_weft_for_washing_after_iron']?>">
      </div>
  ...
  <div class="col-sm-1" for="unit">
      %
    <input type="hidden" id="uom_of_dimensional_stability_to_weft_washing_after_iron" name="uom_of_dimensional_stability_to_weft_washing_after_iron"  value="<?php echo $row_for_model_sanforizing['uom_of_dimensional_stability_to_weft_washing_after_iron']?>">
  </div>

        
  <div class="col-sm-1 text-center" for="min_value">

    <input type="text" class="form-control" id="dimensional_stability_to_weft_washing_after_iron_min_value" name="dimensional_stability_to_weft_washing_after_iron_min_value" style="color:#00008B;" value="<?php echo $row_for_model_sanforizing['dimensional_stability_to_weft_washing_after_iron_min_value']?>">
     
  </div>
          
  <div class="col-sm-1 text-center">
      
    <input type="text" class="form-control" id="dimensional_stability_to_weft_washing_after_iron_max_value" name="dimensional_stability_to_weft_washing_after_iron_max_value" style="color:#00008B;" value="<?php echo $row_for_model_sanforizing['dimensional_stability_to_weft_washing_after_iron_max_value']?>">
...
<div class="form-group form-group-sm">
    ...
    <div class="col-sm-3 text-center">
     ...
     <div class="col-sm-1 text-center">
            <input type="text" class="form-control" id="warp_yarn_count_value" name="warp_yarn_count_value" value="<?php echo $row_for_model_sanforizing['warp_yarn_count_value']?>" onchange="warp_yarn_count_cal()" required>
  ...
  <div class="col-sm-1 text-center">
     <select  class="form-control" id="warp_yarn_count_tolerance_range_math_operator" name="warp_yarn_count_tolerance_range_math_operator" onchange="warp_yarn_count_cal()">
              ...
              <?php
                              $warp_yarn_count_tolerance_range_math_operator = $row_for_model_sanforizing['warp_yarn_count_tolerance_range_math_operator'];
                             ?>
                             <?php 
  ...
  <div class="col-sm-1" for="tolerance">
     ...
     <input type="text" class="form-control" id="warp_yarn_count_tolerance_value" name="warp_yarn_count_tolerance_value" value="<?php echo $row_for_model_sanforizing['warp_yarn_count_tolerance_value']?>" onchange="warp_yarn_count_cal()" required>
  ...
  <div class="col-sm-1" for="unit">
    <select  class="form-control" id="uom_of_warp_yarn_count_value" name="uom_of_warp_yarn_count_value">
              ...
              <?php
                              $uom_of_warp_yarn_count_value = $row_for_model_sanforizing['uom_of_warp_yarn_count_value'];
                             ?>
                             <?php 
  ...
  <div class="col-sm-1 text-center" for="min_value">
    ...
    <input type="text" class="form-control" id="warp_yarn_count_min_value" name="warp_yarn_count_min_value" value="<?php echo $row_for_model_sanforizing['warp_yarn_count_min_value']?>" required>
     
  </div>
          
  <div class="col-sm-1 text-center">
      
    <input type="text" class="form-control" id="warp_yarn_count_max_value" name="warp_yarn_count_max_value" value="<?php echo $row_for_model_sanforizing['warp_yarn_count_max_value']?>" required>
...
<div class="form-group form-group-sm" for="weft_yarn_count">
    ...
    <div class="col-sm-3 text-center">
     ...
     <div class="col-sm-1 text-center">
            <input type="text" class="form-control" id="weft_yarn_count_value" name="weft_yarn_count_value" value="<?php echo $row_for_model_sanforizing['weft_yarn_count_value']?>" onchange="weft_yarn_count_cal()" required>
  ...
  <div class="col-sm-1 text-center">
     <select  class="form-control" id="weft_yarn_count_tolerance_range_math_operator" name="weft_yarn_count_tolerance_range_math_operator" onchange="weft_yarn_count_cal()">
              ...
              <?php
                              $weft_yarn_count_tolerance_range_math_operator = $row_for_model_sanforizing['weft_yarn_count_tolerance_range_math_operator'];
                             ?>
                             <?php 
  ...
  <div class="col-sm-1" for="tolerance">
     ...
     <input type="text" class="form-control" id="weft_yarn_count_tolerance_value" name="weft_yarn_count_tolerance_value" value="<?php echo $row_for_model_sanforizing['weft_yarn_count_tolerance_value']?>" onchange="weft_yarn_count_cal()" required>
  ...
  <div class="col-sm-1" for="unit">
    <select  class="form-control" id="uom_of_weft_yarn_count_value" name="uom_of_weft_yarn_count_value">
              ...
              <?php
                              $uom_of_weft_yarn_count_value = $row_for_model_sanforizing['uom_of_weft_yarn_count_value'];
                             ?>
                             <?php 
  ...
  <div class="col-sm-1 text-center" for="min_value">
    ...
    <input type="text" class="form-control" id="weft_yarn_count_min_value" name="weft_yarn_count_min_value" value="<?php echo $row_for_model_sanforizing['weft_yarn_count_min_value']?>" required>
     
  </div>
          
  <div class="col-sm-1 text-center">
      
    <input type="text" class="form-control" id="weft_yarn_count_max_value" name="weft_yarn_count_max_value" value="<?php echo $row_for_model_sanforizing['weft_yarn_count_max_value']?>" required>
...
<div class="form-group form-group-sm" for="no_of_threads_in_warp_value">
    ...
    <div class="col-sm-3 text-center">
     ...
     <div class="col-sm-1 text-center">
            <input type="text" class="form-control" id="no_of_threads_in_warp_value" name="no_of_threads_in_warp_value" value="<?php echo $row_for_model_sanforizing['no_of_threads_in_warp_value']?>" onchange="no_of_threads_in_warp_cal()" required>
  ...
  <div class="col-sm-1 text-center">
     <select  class="form-control" id="no_of_threads_in_warp_tolerance_range_math_operator" name="no_of_threads_in_warp_tolerance_range_math_operator" onchange="no_of_threads_in_warp_cal()">
              ...
              <?php
                              $no_of_threads_in_warp_tolerance_range_math_operator = $row_for_model_sanforizing['no_of_threads_in_warp_tolerance_range_math_operator'];
                             ?>
                             <?php 
  ...
  <div class="col-sm-1" for="tolerance">
     ...
     <input type="text" class="form-control" id="no_of_threads_in_warp_tolerance_value" name="no_of_threads_in_warp_tolerance_value" value="<?php echo $row_for_model_sanforizing['no_of_threads_in_warp_tolerance_value']?>" onchange="no_of_threads_in_warp_cal()" required>
  ...
  <div class="col-sm-1" for="unit">
    <select  class="form-control" id="uom_of_no_of_threads_in_warp_value" name="uom_of_no_of_threads_in_warp_value">
              ...
              <?php
                              $uom_of_no_of_threads_in_warp_value = $row_for_model_sanforizing['uom_of_no_of_threads_in_warp_value'];
                             ?>
                             <?php 
  ...
  <div class="col-sm-1 text-center" for="min_value">
    ...
    <input type="text" class="form-control" id="no_of_threads_in_warp_min_value" name="no_of_threads_in_warp_min_value" value="<?php echo $row_for_model_sanforizing['no_of_threads_in_warp_min_value']?>" required>
  </div>
          
  <div class="col-sm-1 text-center">
      
    <input type="text" class="form-control" id="no_of_threads_in_warp_max_value" name="no_of_threads_in_warp_max_value" value="<?php echo $row_for_model_sanforizing['no_of_threads_in_warp_max_value']?>" required>
...
<div class="form-group form-group-sm" for="no_of_threads_in_warp_value">
    ...
    <div class="col-sm-3 text-center">
     ...
     <div class="col-sm-1 text-center">
            <input type="text" class="form-control" id="no_of_threads_in_weft_value" name="no_of_threads_in_weft_value" value="<?php echo $row_for_model_sanforizing['no_of_threads_in_weft_value']?>" onchange="no_of_threads_in_weft_cal()" required>
  ...
  <div class="col-sm-1 text-center">
      <select  class="form-control" id="no_of_threads_in_weft_tolerance_range_math_operator" name="no_of_threads_in_weft_tolerance_range_math_operator" onchange="no_of_threads_in_weft_cal()">
              <option  value="">Select No of Threads Count Tolerance Range Math Operator</option>
              <?php
                              $no_of_threads_in_weft_tolerance_range_math_operator = $row_for_model_sanforizing['no_of_threads_in_weft_tolerance_range_math_operator'];
                             ?>
                             <?php 
  ...
  <div class="col-sm-1" for="tolerance">
      ...
      <input type="text" class="form-control" id="no_of_threads_in_weft_tolerance_value" name="no_of_threads_in_weft_tolerance_value" value="<?php echo $row_for_model_sanforizing['no_of_threads_in_weft_tolerance_value']?>" onchange="no_of_threads_in_weft_cal()" required>
  ...
  <div class="col-sm-1" for="unit">
     <select  class="form-control" id="uom_of_no_of_threads_in_weft_value" name="uom_of_no_of_threads_in_weft_value" >
              ...
              <?php
                              $uom_of_no_of_threads_in_weft_value = $row_for_model_sanforizing['uom_of_no_of_threads_in_weft_value'];
                             ?>
                             <?php 
  ...
  <div class="col-sm-1 text-center" for="min_value">
    ...
    <input type="text" class="form-control" id="no_of_threads_in_weft_min_value" name="no_of_threads_in_weft_min_value"  value="<?php echo $row_for_model_sanforizing['no_of_threads_in_weft_min_value']?>" required>
  </div>
          
  <div class="col-sm-1 text-center">
      
    <input type="text" class="form-control" id="no_of_threads_in_weft_max_value" name="no_of_threads_in_weft_max_value" value="<?php echo $row_for_model_sanforizing['no_of_threads_in_weft_max_value']?>" required>
...
<div class="form-group form-group-sm" for="mass_per_unit_per_area_value">
    ...
    <div class="col-sm-3 text-center">
     ...
     <div class="col-sm-1 text-center">
            <input type="text" class="form-control" id="mass_per_unit_per_area_value" name="mass_per_unit_per_area_value" value="<?php echo $row_for_model_sanforizing['mass_per_unit_per_area_value']?>" onchange="mass_per_unit_per_area_cal()" required>
         
     </div>
        
         
  <div class="col-sm-1 text-center">
      <input type="text" class="form-control" id="mass_per_unit_per_area_tolerance_range_math_operator" name="mass_per_unit_per_area_tolerance_range_math_operator" onchange="mass_per_unit_per_area_cal()" value="<?php echo $row_for_model_sanforizing['mass_per_unit_per_area_tolerance_range_math_operator']?>" required>
  ...
  <div class="col-sm-1" for="tolerance">
      ...
      <input type="text" class="form-control" id="mass_per_unit_per_area_tolerance_value" name="mass_per_unit_per_area_tolerance_value" onchange="mass_per_unit_per_area_cal()" value="<?php echo $row_for_model_sanforizing['mass_per_unit_per_area_tolerance_value']?>" required>
  ...
  <div class="col-sm-1" for="unit">
     <select  class="form-control" id="uom_of_mass_per_unit_per_area_value" name="uom_of_mass_per_unit_per_area_value">
              ...
              <?php
                              $uom_of_mass_per_unit_per_area_value = $row_for_model_sanforizing['uom_of_mass_per_unit_per_area_value'];
                             ?>
                             <?php 
  ...
  <div class="col-sm-1 text-center" for="min_value">
    ...
    <input type="text" class="form-control" id="mass_per_unit_per_area_min_value" name="mass_per_unit_per_area_min_value" value="<?php echo $row_for_model_sanforizing['mass_per_unit_per_area_min_value']?>" required>
  </div>
          
  <div class="col-sm-1 text-center">
      
    <input type="text" class="form-control" id="mass_per_unit_per_area_max_value" name="mass_per_unit_per_area_max_value" value="<?php echo $row_for_model_sanforizing['mass_per_unit_per_area_max_value']?>" required>
...
<div class="form-group form-group-sm" for="mass_per_unit_per_area_value">
    ...
    <div class="col-sm-3 text-center">
     ...
     <div class="col-sm-2 text-center">
       ...
       <?php
                              $description_or_type_for_surface_fuzzing_and_pilling = $row_for_model_sanforizing['description_or_type_for_surface_fuzzing_and_pilling'];
                             ?>
                             <?php 
  ...
  <div class="col-sm-1 text-center">
      <select  class="form-control" id="surface_fuzzing_and_pilling_tolerance_range_math_operator" name="surface_fuzzing_and_pilling_tolerance_range_math_operator" onchange="surface_fuzzing_and_pilling_cal()">
        ...
        <?php
                              $surface_fuzzing_and_pilling_tolerance_range_math_operator = $row_for_model_sanforizing['surface_fuzzing_and_pilling_tolerance_range_math_operator'];
  ...
  <div class="col-sm-1" for="tolerance">
      ...
      <select  class="form-control" id="surface_fuzzing_and_pilling_tolerance_value" name="surface_fuzzing_and_pilling_tolerance_value" onchange="surface_fuzzing_and_pilling_cal()">
            ...
            <?php
                              $surface_fuzzing_and_pilling_tolerance_value = $row_for_model_sanforizing['surface_fuzzing_and_pilling_tolerance_value'];
  ...
  <div class="col-sm-1 text-center">
     <input type="text" class="form-control" id="rubs_for_surface_fuzzing_and_pilling" name="rubs_for_surface_fuzzing_and_pilling" value="<?php echo $row_for_model_sanforizing['rubs_for_surface_fuzzing_and_pilling']?>" required>
  ...
  <div class="col-sm-1 text-center" for="min_value">
    ...
    <input type="text" class="form-control" id="surface_fuzzing_and_pilling_min_value" name="surface_fuzzing_and_pilling_min_value" value="<?php echo $row_for_model_sanforizing['surface_fuzzing_and_pilling_min_value']?>" required>
  </div>
          
  <div class="col-sm-1 text-center">
      
    <input type="text" class="form-control" id="surface_fuzzing_and_pilling_max_value" name="surface_fuzzing_and_pilling_max_value" value="<?php echo $row_for_model_sanforizing['surface_fuzzing_and_pilling_max_value']?>" required>

   </div>
            
    <input type="hidden" name="uom_of_surface_fuzzing_and_pilling_value" id="uom_of_surface_fuzzing_and_pilling_value" value="<?php echo $row_for_model_sanforizing['uom_of_surface_fuzzing_and_pilling_value']?>">    
...
<div class="form-group form-group-sm" for="tensile_properties_in_warp">
  ...
  <div class="col-sm-1 text-center">
      <select  class="form-control" id="tensile_properties_in_warp_value_tolerance_range_math_operator" name="tensile_properties_in_warp_value_tolerance_range_math_operator" onchange="tensile_properties_in_warp()">
              ...
              <?php
                              $tensile_properties_in_warp_value_tolerance_range_math_operator = $row_for_model_sanforizing['tensile_properties_in_warp_value_tolerance_range_math_operator'];
  ...
  <div class="col-sm-1" for="tolerance">
     ...
     <input type="text" class="form-control" id="tensile_properties_in_warp_value_tolerance_value" name="tensile_properties_in_warp_value_tolerance_value"  value="<?php echo $row_for_model_sanforizing['tensile_properties_in_warp_value_tolerance_value']?>" onchange="tensile_properties_in_warp()" required>
  </div>
  ...
  <div class="col-sm-1" for="unit">
     <select  class="form-control" id="uom_of_tensile_properties_in_warp_value" name="uom_of_tensile_properties_in_warp_value">
              <option  value="">Select Uom Of Warp Yarn Tensile Properties</option>
              <?php
                              $uom_of_tensile_properties_in_warp_value = $row_for_model_sanforizing['uom_of_tensile_properties_in_warp_value'];
  ...
  <div class="col-sm-1 text-center" for="min_value">
    ...
    <input type="text" class="form-control" id="tensile_properties_in_warp_value_min_value" name="tensile_properties_in_warp_value_min_value"  value="<?php echo $row_for_model_sanforizing['tensile_properties_in_warp_value_min_value']?>" required>
  </div>
          
  <div class="col-sm-1 text-center">
      
    <input type="text" class="form-control" id="tensile_properties_in_warp_value_max_value" name="tensile_properties_in_warp_value_max_value"  value="<?php echo $row_for_model_sanforizing['tensile_properties_in_warp_value_max_value']?>" required>
...
<div class="form-group form-group-sm" for="tensile_properties_in_weft">
  ...
  <div class="col-sm-1 text-center">
      <select  class="form-control" id="tensile_properties_in_weft_value_tolerance_range_math_operator" name="tensile_properties_in_weft_value_tolerance_range_math_operator" onchange="tensile_properties_in_weft()">
              ...
              <?php
                              $tensile_properties_in_weft_value_tolerance_range_math_operator = $row_for_model_sanforizing['tensile_properties_in_weft_value_tolerance_range_math_operator'];
  ...
  <div class="col-sm-1" for="tolerance">
     ...
     <input type="text" class="form-control" id="tensile_properties_in_weft_value_tolerance_value" name="tensile_properties_in_weft_value_tolerance_value" value="<?php echo $row_for_model_sanforizing['tensile_properties_in_weft_value_tolerance_value']?>" onchange="tensile_properties_in_weft()" required>
  </div>
  ...
  <div class="col-sm-1" for="unit">
     <select  class="form-control" id="uom_of_tensile_properties_in_weft_value" name="uom_of_tensile_properties_in_weft_value">
              <option  value="">Select Uom Of weft Yarn Tensile Properties</option>
              <?php
                              $uom_of_tensile_properties_in_weft_value = $row_for_model_sanforizing['uom_of_tensile_properties_in_weft_value'];
  ...
  <div class="col-sm-1 text-center" for="min_value">
    ...
    <input type="text" class="form-control" id="tensile_properties_in_weft_value_min_value" name="tensile_properties_in_weft_value_min_value" value="<?php echo $row_for_model_sanforizing['tensile_properties_in_weft_value_min_value']?>" required>
  </div>
          
  <div class="col-sm-1 text-center">
      
    <input type="text" class="form-control" id="tensile_properties_in_weft_value_max_value" name="tensile_properties_in_weft_value_max_value" value="<?php echo $row_for_model_sanforizing['tensile_properties_in_weft_value_max_value']?>" required>
...
<div class="form-group form-group-sm" for="tear_force_in_warp_value">
  ...
  <div class="col-sm-1 text-center">
      <select  class="form-control" id="tear_force_in_warp_value_tolerance_range_math_operator" name="tear_force_in_warp_value_tolerance_range_math_operator" onchange="tear_force_in_warp_cal()">
              ...
              <?php
                              $tear_force_in_warp_value_tolerance_range_math_operator = $row_for_model_sanforizing['tear_force_in_warp_value_tolerance_range_math_operator'];
  ...
  <div class="col-sm-1" for="tolerance">
     ...
     <input type="text" class="form-control" id="tear_force_in_warp_value_tolerance_value" name="tear_force_in_warp_value_tolerance_value" value="<?php echo $row_for_model_sanforizing['tear_force_in_warp_value_tolerance_value']?>" onchange="tear_force_in_warp_cal()" required>
  </div>
  ...
  <div class="col-sm-1" for="unit">
     <select  class="form-control" id="uom_of_tear_force_in_warp_value" name="uom_of_tear_force_in_warp_value">
              ...
              <?php
                              $uom_of_tear_force_in_warp_value = $row_for_model_sanforizing['uom_of_tear_force_in_warp_value'];
  ...
  <div class="col-sm-1 text-center" for="min_value">
    ...
    <input type="text" class="form-control" id="tear_force_in_warp_value_min_value" name="tear_force_in_warp_value_min_value" value="<?php echo $row_for_model_sanforizing['tear_force_in_warp_value_min_value']?>" required>
  </div>
          
  <div class="col-sm-1 text-center">
      
    <input type="text" class="form-control" id="tear_force_in_warp_value_max_value" name="tear_force_in_warp_value_max_value" value="<?php echo $row_for_model_sanforizing['tear_force_in_warp_value_max_value']?>" required>
...
<div class="form-group form-group-sm" for="tear_force_in_weft_value">
  ...
  <div class="col-sm-1 text-center">
      <select  class="form-control" id="tear_force_in_weft_value_tolerance_range_math_operator" name="tear_force_in_weft_value_tolerance_range_math_operator" onchange="tear_force_in_weft_cal()">
              ...
              <?php
                              $tear_force_in_weft_value_tolerance_range_math_operator = $row_for_model_sanforizing['tear_force_in_weft_value_tolerance_range_math_operator'];
  ...
  <div class="col-sm-1" for="tolerance">
     ...
     <input type="text" class="form-control" id="tear_force_in_weft_value_tolerance_value" name="tear_force_in_weft_value_tolerance_value" value="<?php echo $row_for_model_sanforizing['tear_force_in_weft_value_tolerance_value']?>" onchange="tear_force_in_weft_cal()" required>
  </div>
  ...
  <div class="col-sm-1" for="unit">
     <select  class="form-control" id="uom_of_tear_force_in_weft_value" name="uom_of_tear_force_in_weft_value">
              ...
              <?php
                              $uom_of_tear_force_in_weft_value = $row_for_model_sanforizing['uom_of_tear_force_in_weft_value'];
  ...
  <div class="col-sm-1 text-center" for="min_value">
    ...
    <input type="text" class="form-control" id="tear_force_in_weft_value_min_value" name="tear_force_in_weft_value_min_value" value="<?php echo $row_for_model_sanforizing['tear_force_in_weft_value_min_value']?>" required>
  </div>
      
  <div class="col-sm-1 text-center">
      
    <input type="text" class="form-control" id="tear_force_in_weft_value_max_value" name="tear_force_in_weft_value_max_value" value="<?php echo $row_for_model_sanforizing['tear_force_in_weft_value_max_value']?>" required>
...
<div class="form-group form-group-sm" for="seam_slippage_resistance_in_warp">
  ...
  <div class="col-sm-1 text-center">
      <select  class="form-control" id="seam_slippage_resistance_in_warp_tolerance_range_math_operator" name="seam_slippage_resistance_in_warp_tolerance_range_math_operator" onchange="seam_slippage_resistance_in_warp_cal()">
            ...
            <?php
              $seam_slippage_in_warp_tolrence_math_operator = $row_for_model_sanforizing['seam_slippage_resistance_in_warp_tolerance_range_math_operator'];
  ...
  <div class="col-sm-1" for="tolerance">
    ...
    <input type="text" class="form-control" id="seam_slippage_resistance_in_warp_tolerance_value" name="seam_slippage_resistance_in_warp_tolerance_value" value="<?php echo $row_for_model_sanforizing['seam_slippage_resistance_in_warp_tolerance_value']?>" onchange="seam_slippage_resistance_in_warp_cal()" required>
  </div>
  ...
  <div class="col-sm-1" for="unit">
     <select  class="form-control" id="uom_of_seam_slippage_resistance_in_warp" name="uom_of_seam_slippage_resistance_in_warp">
              <option  value="" >Select Uom </option>
                            ...
                            <?php
                              $uom_of_seam_slippage_resistance_in_warp = $row_for_model_sanforizing['uom_of_seam_slippage_resistance_in_warp'];
  ...
  <div class="col-sm-1 text-center" for="min_value">
    ...
    <input type="text" class="form-control" id="seam_slippage_resistance_in_warp_min_value" name="seam_slippage_resistance_in_warp_min_value" value="<?php echo $row_for_model_sanforizing['seam_slippage_resistance_in_warp_min_value']?>" required>
  </div>
          
  <div class="col-sm-1 text-center">
      
    <input type="text" class="form-control" id="seam_slippage_resistance_in_warp_max_value" name="seam_slippage_resistance_in_warp_max_value" value="<?php echo $row_for_model_sanforizing['seam_slippage_resistance_in_warp_max_value']?>" required>
   </div>
...
<div class="form-group form-group-sm" for="seam_slippage_resistance_in_weft_value">
  ...
  <div class="col-sm-1 text-center">
      <select  class="form-control" id="seam_slippage_resistance_in_weft_tolerance_range_math_operator" name="seam_slippage_resistance_in_weft_tolerance_range_math_operator" onchange="seam_slippage_resistance_in_weft_cal()">
              <option  value="">Select weft Yarn Tear Force Tolerance Range Math Operator</option>
                    ...
                    <?php
              $seam_slippage_resistance_in_weft_tolerance_range_math_operator = $row_for_model_sanforizing['seam_slippage_resistance_in_weft_tolerance_range_math_operator'];
  ...
  <div class="col-sm-1" for="tolerance">
     ...
     <input type="text" class="form-control" id="seam_slippage_resistance_in_weft_tolerance_value" name="seam_slippage_resistance_in_weft_tolerance_value" value="<?php echo $row_for_model_sanforizing['seam_slippage_resistance_in_weft_tolerance_value']?>" onchange="seam_slippage_resistance_in_weft_cal()" required>
  </div>
  ...
  <div class="col-sm-1" for="unit">
     <select  class="form-control" id="uom_of_seam_slippage_resistance_in_weft" name="uom_of_seam_slippage_resistance_in_weft">
              <option  value="">Select Uom Of weft Yarn Tear Force Properties</option>
                            ...
                            <?php
                              $uom_of_seam_slippage_resistance_in_weft = $row_for_model_sanforizing['uom_of_seam_slippage_resistance_in_weft'];
  ...
  <div class="col-sm-1 text-center" for="min_value">
    ...
    <input type="text" class="form-control" id="seam_slippage_resistance_in_weft_min_value" name="seam_slippage_resistance_in_weft_min_value" value="<?php echo $row_for_model_sanforizing['seam_slippage_resistance_in_weft_min_value']?>" required>
  </div>
          
  <div class="col-sm-1 text-center">
      
    <input type="text" class="form-control" id="seam_slippage_resistance_in_weft_max_value" name="seam_slippage_resistance_in_weft_max_value" value="<?php echo $row_for_model_sanforizing['seam_slippage_resistance_in_weft_max_value']?>" required>
...
<div class="form-group form-group-sm" for="seam_slippage_resistance_iso_2_in_warp">
 ...
 <div class="col-sm-2 text-center">
  ...
  <div class="col-sm-1 text-center">
      <select  class="form-control" id="seam_slippage_resistance_iso_2_in_warp_tolerance_range_math_op" name="seam_slippage_resistance_iso_2_in_warp_tolerance_range_math_op" onchange="seam_slippage_resistance_iso_2_in_warp_cal()">
        <option  value="">Select operator Value</option>
                        ...
                        <?php
                              $seam_slippage_resistance_iso_2_in_warp_tolerance_range_math_op = $row_for_model_sanforizing['seam_slippage_resistance_iso_2_in_warp_tolerance_range_math_op'];
    ...
    <div class="col-sm-1 text-center">
         <select  class="form-control" id="uom_of_seam_slippage_resistance_iso_2_in_warp_for_load" name="uom_of_seam_slippage_resistance_iso_2_in_warp_for_load">
              <option  value="">Select Uom </option>
                        ...
                        <?php
                              $uom_of_seam_slippage_resistance_iso_2_in_warp_for_load = $row_for_model_sanforizing['uom_of_seam_slippage_resistance_iso_2_in_warp_for_load'];
  ...
  <div class="col-sm-1" for="tolerance">
     ...
     <select  class="form-control" id="seam_slippage_resistance_iso_2_in_warp_tolerance_value" name="seam_slippage_resistance_iso_2_in_warp_tolerance_value" onchange="seam_slippage_resistance_iso_2_in_warp_cal()">
        <option  value="">Select  Tolerance Value</option>
            ...
            <?php
              $seam_slippage_resistance_iso_2_in_warp_tolerance_value = $row_for_model_sanforizing['seam_slippage_resistance_iso_2_in_warp_tolerance_value'];
  ...
  <div class="col-sm-1 text-center" for="min_value">
    ...
    <input type="text" class="form-control" id="seam_slippage_resistance_iso_2_in_warp_min_value" name="seam_slippage_resistance_iso_2_in_warp_min_value" value="<?php echo $row_for_model_sanforizing['seam_slippage_resistance_iso_2_in_warp_min_value']?>" required>
  </div>
      
  <div class="col-sm-1 text-center">
      
    <input type="text" class="form-control" id="seam_slippage_resistance_iso_2_in_warp_max_value" name="seam_slippage_resistance_iso_2_in_warp_max_value" value="<?php echo $row_for_model_sanforizing['seam_slippage_resistance_iso_2_in_warp_max_value']?>" required>
   </div>
...
<div class="form-group form-group-sm" for="seam_slippage_resistance_iso_2_in_weft">
  ...
  <div class="col-sm-1 text-center">
      <select  class="form-control" id="seam_slippage_resistance_iso_2_in_weft_tolerance_range_math_op" name="seam_slippage_resistance_iso_2_in_weft_tolerance_range_math_op" onchange="seam_slippage_resistance_iso_2_in_weft_cal()">
        <option  value="">Select operator Value</option>
                        ...
                        <?php
                              $seam_slippage_resistance_iso_2_in_weft_tolerance_range_math_op = $row_for_model_sanforizing['seam_slippage_resistance_iso_2_in_weft_tolerance_range_math_op'];
   ...
   <div class="col-sm-1 text-center">
         <select  class="form-control" id="uom_of_seam_slippage_resistance_iso_2_in_weft_for_load" name="uom_of_seam_slippage_resistance_iso_2_in_weft_for_load">
              <option  value="">Select Uom</option>
                            ...
                            <?php
                              $uom_of_seam_slippage_resistance_iso_2_in_weft_for_load = $row_for_model_sanforizing['uom_of_seam_slippage_resistance_iso_2_in_weft_for_load'];
  ...
  <div class="col-sm-1" for="tolerance">
     ...
     <select  class="form-control" id="seam_slippage_resistance_iso_2_in_weft_tolerance_value" name="seam_slippage_resistance_iso_2_in_weft_tolerance_value" onchange="seam_slippage_resistance_iso_2_in_weft_cal()">
        <option  value="">Select Tolerance Value</option>
            ...
            <?php
              $seam_slippage_resistance_iso_2_in_weft_tolerance_value = $row_for_model_sanforizing['seam_slippage_resistance_iso_2_in_weft_tolerance_value'];
  ...
  <div class="col-sm-1 text-center" for="min_value">
    ...
    <input type="text" class="form-control" id="seam_slippage_resistance_iso_2_in_weft_min_value" name="seam_slippage_resistance_iso_2_in_weft_min_value" value="<?php echo $row_for_model_sanforizing['seam_slippage_resistance_iso_2_in_weft_min_value']?>" required>
  </div>
      
  <div class="col-sm-1 text-center">
      
    <input type="text" class="form-control" id="seam_slippage_resistance_iso_2_in_weft_max_value" name="seam_slippage_resistance_iso_2_in_weft_max_value" value="<?php echo $row_for_model_sanforizing['seam_slippage_resistance_iso_2_in_weft_max_value']?>" required>
  </div>
...
<div class="form-group form-group-sm" for="seam_strength_in_warp_value">
  ...
  <div class="col-sm-1 text-center">
      ...
      <select  class="form-control" id="seam_strength_in_warp_value_tolerance_range_math_operator" name="seam_strength_in_warp_value_tolerance_range_math_operator" onchange="seam_strength_in_warp_cal()">
              <option  value="">Select Seam Strength in Warp Math Operator</option>
                            ...
                            <?php
                              $seam_strength_in_warp_value_tolerance_range_math_operator = $row_for_model_sanforizing['seam_strength_in_warp_value_tolerance_range_math_operator'];
  ...
  <div class="col-sm-1" for="tolerance">
    ...
    <input type="text" class="form-control" id="seam_strength_in_warp_value_tolerance_value" name="seam_strength_in_warp_value_tolerance_value" value="<?php echo $row_for_model_sanforizing['seam_strength_in_warp_value_tolerance_value']?>" onchange="seam_strength_in_warp_cal()" required>
  </div>
  ...
  <div class="col-sm-1" for="unit">
     <select  class="form-control" id="uom_of_seam_strength_in_warp_value" name="uom_of_seam_strength_in_warp_value">
              <option  value="">Select Uom Of Seam Strength in Warp Properties</option>
                            ...
                            <?php
                              $uom_of_seam_strength_in_warp_value = $row_for_model_sanforizing['uom_of_seam_strength_in_warp_value'];
  ...
  <div class="col-sm-1 text-center" for="min_value">
    ...
    <input type="text" class="form-control" id="seam_strength_in_warp_value_min_value" name="seam_strength_in_warp_value_min_value" value="<?php echo $row_for_model_sanforizing['seam_strength_in_warp_value_min_value']?>" required>
  </div>
          
  <div class="col-sm-1 text-center">
      
    <input type="text" class="form-control" id="seam_strength_in_warp_value_max_value" name="seam_strength_in_warp_value_max_value" value="<?php echo $row_for_model_sanforizing['seam_strength_in_warp_value_max_value']?>" required>
...
<div class="form-group form-group-sm" for="seam_strength_in_weft_value">
  ...
  <div class="col-sm-1 text-center">
      ...
      <select  class="form-control" id="seam_strength_in_weft_value_tolerance_range_math_operator" name="seam_strength_in_weft_value_tolerance_range_math_operator" onchange="seam_strength_in_weft_cal()">
              <option  value="">Select  Math Operator</option>
                            ...
                            <?php
                              $seam_strength_in_weft_value_tolerance_range_math_operator = $row_for_model_sanforizing['seam_strength_in_weft_value_tolerance_range_math_operator'];
  ...
  <div class="col-sm-1" for="tolerance">
    ...
    <input type="text" class="form-control" id="seam_strength_in_weft_value_tolerance_value" name="seam_strength_in_weft_value_tolerance_value" value="<?php echo $row_for_model_sanforizing['seam_strength_in_weft_value_tolerance_value']?>" onchange="seam_strength_in_weft_cal()" required>
  </div>
  ...
  <div class="col-sm-1" for="unit">
     <select  class="form-control" id="uom_of_seam_strength_in_weft_value" name="uom_of_seam_strength_in_weft_value">
              <option  value="">Select Uom </option>
                            ...
                            <?php
                              $uom_of_seam_strength_in_weft_value = $row_for_model_sanforizing['uom_of_seam_strength_in_weft_value'];
  ...
  <div class="col-sm-1 text-center" for="min_value">
    ...
    <input type="text" class="form-control" id="seam_strength_in_weft_value_min_value" name="seam_strength_in_weft_value_min_value" value="<?php echo $row_for_model_sanforizing['seam_strength_in_weft_value_min_value']?>" required>
  </div>
          
  <div class="col-sm-1 text-center">
      
    <input type="text" class="form-control" id="seam_strength_in_weft_value_max_value" name="seam_strength_in_weft_value_max_value" value="<?php echo $row_for_model_sanforizing['seam_strength_in_weft_value_max_value']?>" required>
...
<div class="col-sm-2 text-center">
  ...
  <div class="col-sm-1 text-center">
        <select  class="form-control" id="seam_properties_seam_slippage_iso_astm_d_in_warp_tol_range_mt_op" name="seam_properties_seam_slippage_iso_astm_d_in_warp_tol_range_mt_op" onchange="seam_properties_seam_slippage_iso_astm_d_in_warp_cal()">
           <option  value="">Select Tolerance Value</option>
                ...
                <?php
              $seam_properties_seam_slippage_iso_astm_d_in_warp_tol_range_mt_op = $row_for_model_sanforizing['seam_properties_seam_slippage_iso_astm_d_in_warp_tol_range_mt_op'];
  ...
  <div class="col-sm-1" for="tolerance">
      ...
      <input type="text" class="form-control" id="seam_properties_seam_slippage_iso_astm_d_in_warp_tolerance_value" name="seam_properties_seam_slippage_iso_astm_d_in_warp_tolerance_value" value="<?php echo $row_for_model_sanforizing['seam_properties_seam_slippage_iso_astm_d_in_warp_tolerance_value']?>" onchange="seam_properties_seam_slippage_iso_astm_d_in_warp_cal()" required>
  </div>
  ...
  <div class="col-sm-1" for="unit">
     <select  class="form-control" id="uom_of_seam_properties_seam_slippage_iso_astm_d_in_warp" name="uom_of_seam_properties_seam_slippage_iso_astm_d_in_warp">
              <option  value="">Select Uom </option>
                            ...
                            <?php
                              $uom_of_seam_properties_seam_slippage_iso_astm_d_in_warp = $row_for_model_sanforizing['uom_of_seam_properties_seam_slippage_iso_astm_d_in_warp'];
  ...
  <div class="col-sm-1 text-center" for="min_value">
    ...
    <input type="text" class="form-control" id="seam_properties_seam_slippage_iso_astm_d_in_warp_min_value" name="seam_properties_seam_slippage_iso_astm_d_in_warp_min_value" value="<?php echo $row_for_model_sanforizing['seam_properties_seam_slippage_iso_astm_d_in_warp_min_value']?>" required>
  </div>
      
  <div class="col-sm-1 text-center">
      
    <input type="text" class="form-control" id="seam_properties_seam_slippage_iso_astm_d_in_warp_max_value" name="seam_properties_seam_slippage_iso_astm_d_in_warp_max_value" value="<?php echo $row_for_model_sanforizing['seam_properties_seam_slippage_iso_astm_d_in_warp_max_value']?>" required>
   </div>
...
<div class="col-sm-2 text-center">
  ...
  <div class="col-sm-1 text-center">
      <select  class="form-control" id="seam_properties_seam_slippage_iso_astm_d_in_weft_tol_range_mt_op" name="seam_properties_seam_slippage_iso_astm_d_in_weft_tol_range_mt_op" onchange="seam_properties_seam_slippage_iso_astm_d_in_weft_cal()">
        <option  value="">Select  Tolerance Value</option>
            ...
            <?php
              $seam_properties_seam_slippage_iso_astm_d_in_weft_tol_range_mt_op = $row_for_model_sanforizing['seam_properties_seam_slippage_iso_astm_d_in_weft_tol_range_mt_op'];
  ...
  <div class="col-sm-1" for="unit">
     <select  class="form-control" id="uom_of_seam_properties_seam_slippage_iso_astm_d_in_weft" name="uom_of_seam_properties_seam_slippage_iso_astm_d_in_weft">
              <option  value="">Select Uom </option>
                            ...
                            <?php
                              $uom_of_seam_properties_seam_slippage_iso_astm_d_in_weft = $row_for_model_sanforizing['uom_of_seam_properties_seam_slippage_iso_astm_d_in_weft'];
  ...
  <div class="col-sm-1 text-center" for="min_value">
    ...
    <input type="text" class="form-control" id="seam_properties_seam_slippage_iso_astm_d_in_weft_min_value" name="seam_properties_seam_slippage_iso_astm_d_in_weft_min_value" value="<?php echo $row_for_model_sanforizing['seam_properties_seam_slippage_iso_astm_d_in_weft_min_value']?>" required>
  </div>
      
  <div class="col-sm-1 text-center">
      
    <input type="text" class="form-control" id="seam_properties_seam_slippage_iso_astm_d_in_weft_max_value" name="seam_properties_seam_slippage_iso_astm_d_in_weft_max_value" value="<?php echo $row_for_model_sanforizing['seam_properties_seam_slippage_iso_astm_d_in_weft_max_value']?>" required>
   </div>
...
<select  class="form-control" id="seam_properties_seam_strength_iso_astm_d_in_warp_tol_range_op" name="seam_properties_seam_strength_iso_astm_d_in_warp_tol_range_op" onchange="seam_properties_seam_strength_iso_astm_d_in_warp_cal()">
              <option  value="">Select Math Operator</option>
                            ...
                            <?php
                              $seam_properties_seam_strength_iso_astm_d_in_warp_tol_range_op = $row_for_model_sanforizing['seam_properties_seam_strength_iso_astm_d_in_warp_tol_range_op'];
  ...
  <div class="col-sm-1" for="tolerance">
    ...
    <input type="text" class="form-control" id="seam_properties_seam_strength_iso_astm_d_in_warp_tolerance_value" name="seam_properties_seam_strength_iso_astm_d_in_warp_tolerance_value" value="<?php echo $row_for_model_sanforizing['seam_properties_seam_strength_iso_astm_d_in_warp_tolerance_value']?>" onchange="seam_properties_seam_strength_iso_astm_d_in_warp_cal()" required>
  </div>
  ...
  <div class="col-sm-1" for="unit">
     <select  class="form-control" id="uom_of_seam_properties_seam_strength_iso_astm_d_in_warp" name="uom_of_seam_properties_seam_strength_iso_astm_d_in_warp">
              <option  value="">Select Uom </option>
                            ...
                            <?php
                              $uom_of_seam_properties_seam_strength_iso_astm_d_in_warp = $row_for_model_sanforizing['uom_of_seam_properties_seam_strength_iso_astm_d_in_warp'];
  ...
  <div class="col-sm-1 text-center" for="min_value">
    ...
    <input type="text" class="form-control" id="seam_properties_seam_strength_iso_astm_d_in_warp_min_value" name="seam_properties_seam_strength_iso_astm_d_in_warp_min_value"  value="<?php echo $row_for_model_sanforizing['seam_properties_seam_strength_iso_astm_d_in_warp_min_value']?>" required>
  </div>
      
  <div class="col-sm-1 text-center">
      
    <input type="text" class="form-control" id="seam_properties_seam_strength_iso_astm_d_in_warp_max_value" name="seam_properties_seam_strength_iso_astm_d_in_warp_max_value"  value="<?php echo $row_for_model_sanforizing['seam_properties_seam_strength_iso_astm_d_in_warp_max_value']?>" required>
...
<select  class="form-control" id="seam_properties_seam_strength_iso_astm_d_in_weft_tol_range_op" name="seam_properties_seam_strength_iso_astm_d_in_weft_tol_range_op" onchange="seam_properties_seam_strength_iso_astm_d_in_weft_cal()">
              <option  value="">Select Math Operator</option>
                            ...
                            <?php
                              $seam_properties_seam_strength_iso_astm_d_in_weft_tol_range_op = $row_for_model_sanforizing['seam_properties_seam_strength_iso_astm_d_in_weft_tol_range_op'];
  ...
  <div class="col-sm-1" for="tolerance">
    ...
    <input type="text" class="form-control" id="seam_properties_seam_strength_iso_astm_d_in_weft_tolerance_value" name="seam_properties_seam_strength_iso_astm_d_in_weft_tolerance_value" value="<?php echo $row_for_model_sanforizing['seam_properties_seam_strength_iso_astm_d_in_weft_tolerance_value']?>" onchange="seam_properties_seam_strength_iso_astm_d_in_weft_cal()" required>
  </div>
  ...
  <div class="col-sm-1" for="unit">
     <select  class="form-control" id="uom_of_seam_properties_seam_strength_iso_astm_d_in_weft" name="uom_of_seam_properties_seam_strength_iso_astm_d_in_weft">
              <option  value="">Select Uom </option>
                            ...
                            <?php
                              $uom_of_seam_properties_seam_strength_iso_astm_d_in_weft = $row_for_model_sanforizing['uom_of_seam_properties_seam_strength_iso_astm_d_in_weft'];
  ...
  <div class="col-sm-1 text-center" for="min_value">
    ...
    <input type="text" class="form-control" id="seam_properties_seam_strength_iso_astm_d_in_weft_min_value" name="seam_properties_seam_strength_iso_astm_d_in_weft_min_value" value="<?php echo $row_for_model_sanforizing['seam_properties_seam_strength_iso_astm_d_in_weft_min_value']?>" required>
  </div>
      
  <div class="col-sm-1 text-center">
      
    <input type="text" class="form-control" id="seam_properties_seam_strength_iso_astm_d_in_weft_max_value" name="seam_properties_seam_strength_iso_astm_d_in_weft_max_value" value="<?php echo $row_for_model_sanforizing['seam_properties_seam_strength_iso_astm_d_in_weft_max_value']?>" required>
...
<!-- *********************************** Designing Tabular Formar (Multi-Column Form Elements Here (End))*********************************** -->
						...
						<div class="form-group form-group-sm">
								<div class="col-sm-offset-3 col-sm-5">
									<button type="button" class="btn btn-primary" onClick="sending_data_of_edit_defining_qc_standard_for_model_sanforizing_process_form_for_saving_in_database()">Edit</button>
