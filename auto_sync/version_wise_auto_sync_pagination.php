...
if(isset($_GET['search'])) {
    ...
    ?>
    <input type="hidden" class="form-control" value="<?php echo $_GET['search'] ?>" id="search" name="search"
           placeholder="Search">
...
{
    $sql_for_color = "SELECT * FROM adding_process_to_version_model ORDER BY row_id ASC limit $offset,10";
...
<nav aria-label="Page navigation example">
    <ul class="pagination">
        ...
        $cout="SELECT COUNT(row_id) as count FROM `adding_process_to_version_model` WHERE 1";
