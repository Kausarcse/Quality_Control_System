...
if(isset($_GET['model_washing_id']))
{
   $model_washing_id=$_GET['model_washing_id'];
   $sql_for_model_washing="select * from model_defining_qc_standard_for_washing_process where `id`='$model_washing_id'";
   $result_for_model_washing= mysqli_query($con,$sql_for_model_washing) or die(mysqli_error($con));
   $row_for_model_washing = mysqli_fetch_array( $result_for_model_washing);
}
...
$.ajax({
 ...
 function sending_data_of_edit_defining_qc_standard_for_model_washing_process_form_for_saving_in_database()
{
       var url_encoded_form_data = $("#defining_qc_standard_for_model_washing_process_form").serialize();

       $.ajax({
        url: 'auto_sync/edit_model_defining_qc_standard_for_washing_process_saving.php',
        dataType: 'text',
        type: 'post',
        contentType: 'application/x-www-form-urlencoded',
...
}//End of function sending_data_of_defining_qc_standard_for_model_washing_process_form_for_saving_in_database()
...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
				...
				<div class="panel-heading" style="color:#191970;"><b>Edit Model Defining Standard For Washing Process</b></div> 
                ...
                <div id='search_form_collpapsible_div_1' class="collapse in"> 
                     ...
                     <form class="form-horizontal" action="" style="margin-top:10px;" name="defining_qc_standard_for_model_washing_process_form_view" id="defining_qc_standard_for_model_washing_process_form_view" data-toggle="collapse" data-target="#search_form_collpapsible_div">
	                       ...
	                       <table id="datatable-buttons" class="table table-striped table-bordered">
	                        <thead>
	                          ...
	                          <?php
                                  ...
                                  if(isset($model_washing_id))
                                  {
                                     $sql_for_model_washing = "SELECT * FROM `model_defining_qc_standard_for_washing_process` WHERE `id`='$model_washing_id'";
                                  }


                                  $res_for_model_washing = mysqli_query($con, $sql_for_model_washing);

                                  while ($row = mysqli_fetch_assoc($res_for_model_washing))
                                  {
               ...
               </form>    <!-- End of <form class="form-horizontal" action="" style="margin-top:10px;" name="defining_qc_standard_for_model_washing_process_form" id="defining_qc_standard_for_model_washing_process_form"> -->

	</div> <!-- End of <div class="panel-heading" style="color:#191970;"><b> model_washing Standard Process List</b></div>  -->

   <button type="button" class="btn btn-info" id="buttn_for_load_form" onclick="load_full_form('<?php echo $row_for_model_washing['customer_id']?>')">Load Form</button>
    ...
    <form class="form-horizontal" action="" style="margin-top:10px;" name="defining_qc_standard_for_model_washing_process_form" id="defining_qc_standard_for_model_washing_process_form">
						...
						<input type="hidden" class="form-control" id="version_number" name="version_number" value="<?php echo $row_for_model_washing['version_number']; ?>">
						<input type="hidden" class="form-control" id="customer_id" name="customer_id" value="<?php echo $row_for_model_washing['customer_id']; ?>">
						<input type="hidden" class="form-control" id="customer_name" name="customer_name" value="<?php echo $row_for_model_washing['customer_name']; ?>">
						<input type="hidden" class="form-control" id="color_name" name="color_name" value="<?php echo $row_for_model_washing['color']; ?>">
						<input type="hidden" class="form-control" id="process_name" name="process_name" value="<?php echo $row_for_model_washing['process_name']; ?>">
						<input type="hidden" class="form-control" id="process_serial" name="process_serial" value="<?php echo $row_for_model_washing['process_serial']; ?>">
						<input type="hidden" class="form-control" id="process_technique_name" name="process_technique_name" value="<?php echo $row_for_model_washing['process_technique']; ?>">
...
<div class="form-group form-group-sm">
     ...
     <div class="col-sm-1 text-center">
         <select  class="form-control" id="cf_to_rubbing_dry_tolerance_range_math_operator" name="cf_to_rubbing_dry_tolerance_range_math_operator" style="color:#00008B; margin-top:23px;" onchange="cf_to_rubbing_dry_cal()">
             ...
             <?php
                                 $cf_to_rubbing_dry_tolerance_range_math_operator = $row_for_model_washing['cf_to_rubbing_dry_tolerance_range_math_operator'];
     ...
     <div class="col-sm-1" for="tolerance">
       ...
       <input type="text" class="form-control" id="cf_to_rubbing_dry_tolerance_value" name="cf_to_rubbing_dry_tolerance_value" value="<?php echo $row_for_model_washing['cf_to_rubbing_dry_tolerance_value']?>"  required onchange="cf_to_rubbing_dry_cal()" style="color:#00008B; margin-top:23px;">
     ...
     <div class="col-sm-1 text-center" for="min_value">
         ...
         <input type="text" class="form-control" id="cf_to_rubbing_dry_min_value" name="cf_to_rubbing_dry_min_value" style="color:#00008B; margin-top:23px;" value="<?php echo $row_for_model_washing['cf_to_rubbing_dry_min_value']?>" required>
        
     </div>
             
     <div class="col-sm-1 text-center">
         
       <input type="text" class="form-control" id="cf_to_rubbing_dry_max_value" name="cf_to_rubbing_dry_max_value" style="color:#00008B; margin-top:23px;" value="<?php echo $row_for_model_washing['cf_to_rubbing_dry_max_value']?>" required>
 ...
 <div class="form-group form-group-sm">
     ...
     <div class="col-sm-1 text-center">
         <select  class="form-control" id="cf_to_rubbing_wet_tolerance_range_math_operator" name="cf_to_rubbing_wet_tolerance_range_math_operator" onchange="cf_to_rubbing_wet_cal()">
                 ...
                 <?php
                                 $cf_to_rubbing_wet_tolerance_range_math_operator = $row_for_model_washing['cf_to_rubbing_wet_tolerance_range_math_operator'];
     ...
     <div class="col-sm-1" for="tolerance">
       ...
       <input type="text" class="form-control" id="cf_to_rubbing_wet_tolerance_value" name="cf_to_rubbing_wet_tolerance_value" value="<?php echo $row_for_model_washing['cf_to_rubbing_wet_tolerance_value']?>" onchange="cf_to_rubbing_wet_cal()" required>
     ...
     <div class="col-sm-1 text-center" for="min_value">
         ...
         <input type="text" class="form-control" id="cf_to_rubbing_wet_min_value" name="cf_to_rubbing_wet_min_value" value="<?php echo $row_for_model_washing['cf_to_rubbing_wet_min_value']?>" required>
        
     </div>
             
     <div class="col-sm-1 text-center">
         
       <input type="text" class="form-control" id="cf_to_rubbing_wet_max_value" name="cf_to_rubbing_wet_max_value" value="<?php echo $row_for_model_washing['cf_to_rubbing_wet_max_value']?>" required>
...
<div class="form-group form-group-sm">
           ...
           <div class="col-sm-3 text-center">
            ...
            <div class="col-sm-1 text-center">
                 ...
                 <?php
                                 $cf_to_washing_color_change_tolerance_range_math_operator = $row_for_model_washing['cf_to_washing_color_change_tolerance_range_math_operator'];
             ...
             <div class="col-sm-1 text-center">
               ...
               <?php
                                 $cf_to_washing_color_change_tolerance_value = $row_for_model_washing['cf_to_washing_color_change_tolerance_value'];
         ...
         <div class="col-sm-1 text-center" for="min_value">
               ...
               <input type="text" class="form-control" id="cf_to_washing_color_change_min_value" name="cf_to_washing_color_change_min_value" value="<?php echo $row_for_model_washing['cf_to_washing_color_change_min_value']?>" required>
         </div>
                 
         <div class="col-sm-1 text-center">
             
             <input type="text" class="form-control" id="cf_to_washing_color_change_max_value" name="cf_to_washing_color_change_max_value" value="<?php echo $row_for_model_washing['cf_to_washing_color_change_max_value']?>" required>
 ...
 <div class="form-group form-group-sm">
          ...
          <div class="col-sm-1 text-center">
                ...
                <select  class="form-control" id="cf_to_washing_staining_tolerance_range_math_operator" name="cf_to_washing_staining_tolerance_range_math_operator" onchange="cf_to_washing_staining_cal()">
                 ...
                 <?php
                                 $cf_to_washing_staining_tolerance_range_math_operator = $row_for_model_washing['cf_to_washing_staining_tolerance_range_math_operator'];
             ...
             <div class="col-sm-1 text-center">
                  <select  class="form-control" id="cf_to_washing_staining_tolerance_value" name="cf_to_washing_staining_tolerance_value" onchange="cf_to_washing_staining_cal()">
                     <option value="">Select Tolerance Value</option>
                     <?php
                                 $cf_to_washing_staining_tolerance_value = $row_for_model_washing['cf_to_washing_staining_tolerance_value'];
         ...
         <div class="col-sm-1 text-center" for="min_value">
              ...
              <input type="text" class="form-control" id="cf_to_washing_staining_min_value" name="cf_to_washing_staining_min_value" value="<?php echo $row_for_model_washing['cf_to_washing_staining_min_value']?>" required>
            
         </div>
                 
         <div class="col-sm-1 text-center">
             
             <input type="text" class="form-control" id="cf_to_washing_staining_max_value" name="cf_to_washing_staining_max_value" value="<?php echo $row_for_model_washing['cf_to_washing_staining_max_value']?>" required>
       ...
       <div class="col-sm-2 text-center">
        ...
        <div class="col-sm-1 text-center">
            ...
            <select  class="form-control" id="cf_to_washing_cross_staining_tolerance_range_math_operator" name="cf_to_washing_cross_staining_tolerance_range_math_operator" onchange="cf_to_washing_cross_staining_cal()">
                 ...
                 <?php
                                 $cf_to_washing_cross_staining_tolerance_range_math_operator = $row_for_model_washing['cf_to_washing_cross_staining_tolerance_range_math_operator'];
         ...
         <div class="col-sm-1 text-center">
             <select  class="form-control" id="cf_to_washing_cross_staining_tolerance_value" name="cf_to_washing_cross_staining_tolerance_value" onchange="cf_to_washing_cross_staining_cal()">
                 <option value="">Select Tolerance Value</option>
                 <?php
                                 $cf_to_washing_cross_staining_tolerance_value = $row_for_model_washing['cf_to_washing_cross_staining_tolerance_value'];
         ...
         <div class="col-sm-1 text-center" for="min_value">
              ...
              <input type="text" class="form-control" id="cf_to_washing_cross_staining_min_value" name="cf_to_washing_cross_staining_min_value" value="<?php echo $row_for_model_washing['cf_to_washing_cross_staining_min_value']?>" required>
            
         </div>
             
         <div class="col-sm-1 text-center">
             
             <input type="text" class="form-control" id="cf_to_washing_cross_staining_max_value" name="cf_to_washing_cross_staining_max_value" value="<?php echo $row_for_model_washing['cf_to_washing_cross_staining_max_value']?>" required>
...
<div class="form-group form-group-sm">
           ...
           <div class="col-sm-1 text-center">
            ...
            <div class="col-sm-1 text-center">
               ...
               <select  class="form-control" id="cf_to_dry_cleaning_color_change_tolerance_range_math_operator" name="cf_to_dry_cleaning_color_change_tolerance_range_math_operator" onchange="cf_to_dry_cleaning_color_change_cal()">
                 ...
                 <?php
                                 $cf_to_dry_cleaning_color_change_tolerance_range_math_operator = $row_for_model_washing['cf_to_dry_cleaning_color_change_tolerance_range_math_operator'];
           ...
           <div class="col-sm-1 text-center">
                <select  class="form-control" id="cf_to_dry_cleaning_color_change_tolerance_value" name="cf_to_dry_cleaning_color_change_tolerance_value" onchange="cf_to_dry_cleaning_color_change_cal()">
                   <option value="">Select Tolerance Value</option>
                   <?php
                                 $cf_to_dry_cleaning_color_change_tolerance_value = $row_for_model_washing['cf_to_dry_cleaning_color_change_tolerance_value'];
         ...
         <div class="col-sm-1 text-center" for="min_value">
              ...
              <input type="text" class="form-control" id="cf_to_dry_cleaning_color_change_min_value" name="cf_to_dry_cleaning_color_change_min_value" value="<?php echo $row_for_model_washing['cf_to_dry_cleaning_color_change_min_value']?>"  required>
         ...
         <div class="col-sm-1 text-center">
             ...
             <input type="text" class="form-control" id="cf_to_dry_cleaning_color_change_max_value" name="cf_to_dry_cleaning_color_change_max_value" value="<?php echo $row_for_model_washing['cf_to_dry_cleaning_color_change_max_value']?>" required>
          </div>
...
<div class="form-group form-group-sm">
           ...
           <div class="col-sm-2 text-center">
            ...
            <div class="col-sm-1 text-center">
               ...
               <select  class="form-control" id="cf_to_dry_cleaning_staining_tolerance_range_math_operator" name="cf_to_dry_cleaning_staining_tolerance_range_math_operator" onchange="cf_to_dry_cleaning_staining_cal()">
                 <option value="">Select CF To Dry Cleaning Staining Range Math Operator</option>
                 <?php
                                 $cf_to_dry_cleaning_staining_tolerance_range_math_operator = $row_for_model_washing['cf_to_dry_cleaning_staining_tolerance_range_math_operator'];
           ...
           <div class="col-sm-1 text-center">
                <select  class="form-control" id="cf_to_dry_cleaning_staining_tolerance_value" name="cf_to_dry_cleaning_staining_tolerance_value" onchange="cf_to_dry_cleaning_staining_cal()">
                   <option value="">Select Tolerance Value</option>
                   <?php
                                 $cf_to_dry_cleaning_staining_tolerance_value = $row_for_model_washing['cf_to_dry_cleaning_staining_tolerance_value'];
         ...
         <div class="col-sm-1 text-center" for="min_value">
               ...
               <input type="text" class="form-control" id="cf_to_dry_cleaning_staining_min_value" name="cf_to_dry_cleaning_staining_min_value"  value="<?php echo $row_for_model_washing['cf_to_dry_cleaning_staining_min_value']?>" required>
            
         </div>
             
         <div class="col-sm-1 text-center">
             
             <input type="text" class="form-control" id="cf_to_dry_cleaning_staining_max_value" name="cf_to_dry_cleaning_staining_max_value"  value="<?php echo $row_for_model_washing['cf_to_dry_cleaning_staining_max_value']?>" required>
...
<div class="form-group form-group-sm">
           ...
           <div class="col-sm-1 text-center">
            ...
            <div class="col-sm-1 text-center">
               ...
               <select  class="form-control" id="cf_to_perspiration_acid_color_change_tolerance_range_math_op" name="cf_to_perspiration_acid_color_change_tolerance_range_math_op" onchange="cf_to_perspiration_acid_color_change_cal()">
                 ...
                 <?php
                                 $cf_to_perspiration_acid_color_change_tolerance_range_math_op = $row_for_model_washing['cf_to_perspiration_acid_color_change_tolerance_range_math_op'];
           ...
           <div class="col-sm-1 text-center">
             <select  class="form-control" id="cf_to_perspiration_acid_color_change_tolerance_value" name="cf_to_perspiration_acid_color_change_tolerance_value" onchange="cf_to_perspiration_acid_color_change_cal()">
               <option value="">Select Tolerance Value</option>
               <?php
                                 $cf_to_perspiration_acid_color_change_tolerance_value = $row_for_model_washing['cf_to_perspiration_acid_color_change_tolerance_value'];
         ...
         <div class="col-sm-1 text-center" for="min_value">
              ...
              <input type="text" class="form-control" id="cf_to_perspiration_acid_color_change_min_value" name="cf_to_perspiration_acid_color_change_min_value" value="<?php echo $row_for_model_washing['cf_to_perspiration_acid_color_change_min_value']?>" required>
         ...
         <div class="col-sm-1 text-center">
             ...
             <input type="text" class="form-control" id="cf_to_perspiration_acid_color_change_max_value" name="cf_to_perspiration_acid_color_change_max_value" value="<?php echo $row_for_model_washing['cf_to_perspiration_acid_color_change_max_value']?>" required>
          </div>
...
<div class="form-group form-group-sm">
           ...
           <div class="col-sm-2 text-center">
            ...
            <div class="col-sm-1 text-center">
              ...
              <select  class="form-control" id="cf_to_perspiration_acid_staining_tolerance_range_math_operator" name="cf_to_perspiration_acid_staining_tolerance_range_math_operator" onchange="cf_to_perspiration_acid_staining_cal()">
                 ...
                 <?php
                                 $cf_to_perspiration_acid_staining_tolerance_range_math_operator = $row_for_model_washing['cf_to_perspiration_acid_staining_tolerance_range_math_operator'];
           ...
           <div class="col-sm-1 text-center">
                <select  class="form-control" id="cf_to_perspiration_acid_staining_value" name="cf_to_perspiration_acid_staining_value" onchange="cf_to_perspiration_acid_staining_cal()">
                   <option value="">Select Tolerance Value</option>
                   <?php
                                 $cf_to_perspiration_acid_staining_value = $row_for_model_washing['cf_to_perspiration_acid_staining_value'];
         ...
         <div class="col-sm-1 text-center" for="min_value">
               ...
               <input type="text" class="form-control" id="cf_to_perspiration_acid_staining_min_value" name="cf_to_perspiration_acid_staining_min_value" value="<?php echo $row_for_model_washing['cf_to_perspiration_acid_staining_min_value']?>" required>
         ...
         <div class="col-sm-1 text-center">
              ...
              <input type="text" class="form-control" id="cf_to_perspiration_acid_staining_max_value" name="cf_to_perspiration_acid_staining_max_value" value="<?php echo $row_for_model_washing['cf_to_perspiration_acid_staining_max_value']?>" required>
          </div>
...
<div class="form-group form-group-sm">
           ...
           <div class="col-sm-2 text-center">
            ...
            <div class="col-sm-1 text-center">
              ...
              <select  class="form-control" id="cf_to_perspiration_acid_cross_staining_tolerance_range_math_op" name="cf_to_perspiration_acid_cross_staining_tolerance_range_math_op" onchange="cf_to_perspiration_acid_cross_staining_cal()">
                 ...
                 <?php
                                 $cf_to_perspiration_acid_cross_staining_tolerance_range_math_op = $row_for_model_washing['cf_to_perspiration_acid_cross_staining_tolerance_range_math_op'];
           ...
           <div class="col-sm-1 text-center">
                <select  class="form-control" id="cf_to_perspiration_acid_cross_staining_tolerance_value" name="cf_to_perspiration_acid_cross_staining_tolerance_value" onchange="cf_to_perspiration_acid_cross_staining_cal()">
                   <option value="">Select Tolerance Value</option>
                   <?php
                                 $cf_to_perspiration_acid_cross_staining_tolerance_value = $row_for_model_washing['cf_to_perspiration_acid_cross_staining_tolerance_value'];
         ...
         <div class="col-sm-1 text-center" for="min_value">
               ...
               <input type="text" class="form-control" id="cf_to_perspiration_acid_cross_staining_min_value" name="cf_to_perspiration_acid_cross_staining_min_value" value="<?php echo $row_for_model_washing['cf_to_perspiration_acid_cross_staining_min_value']?>" required>
         ...
         <div class="col-sm-1 text-center">
              ...
              <input type="text" class="form-control" id="cf_to_perspiration_acid_cross_staining_max_value" name="cf_to_perspiration_acid_cross_staining_max_value" value="<?php echo $row_for_model_washing['cf_to_perspiration_acid_cross_staining_max_value']?>" required>
          </div>
...
<div class="form-group form-group-sm">
           ...
           <div class="col-sm-1 text-center">
            ...
            <div class="col-sm-1 text-center">
              ...
              <select  class="form-control" id="cf_to_perspiration_alkali_color_change_tolerance_range_math_op" name="cf_to_perspiration_alkali_color_change_tolerance_range_math_op" onchange="cf_to_perspiration_alkali_color_change_cal()">
                 ...
                 <?php
                                 $cf_to_perspiration_alkali_color_change_tolerance_range_math_op = $row_for_model_washing['cf_to_perspiration_alkali_color_change_tolerance_range_math_op'];
           ...
           <div class="col-sm-1 text-center">
                 <select  class="form-control" id="cf_to_perspiration_alkali_color_change_tolerance_value" name="cf_to_perspiration_alkali_color_change_tolerance_value" onchange="cf_to_perspiration_alkali_color_change_cal()">
                       <option value="">Select Tolerance Value</option>
                       <?php
                                 $cf_to_perspiration_alkali_color_change_tolerance_value = $row_for_model_washing['cf_to_perspiration_alkali_color_change_tolerance_value'];
         ...
         <div class="col-sm-1 text-center" for="min_value">
             ...
             <input type="text" class="form-control" id="cf_to_perspiration_alkali_color_change_min_value" name="cf_to_perspiration_alkali_color_change_min_value" value="<?php echo $row_for_model_washing['cf_to_perspiration_alkali_color_change_min_value']?>" required>
         ...
         <div class="col-sm-1 text-center">
             ...
             <input type="text" class="form-control" id="cf_to_perspiration_alkali_color_change_max_value" name="cf_to_perspiration_alkali_color_change_max_value" value="<?php echo $row_for_model_washing['cf_to_perspiration_alkali_color_change_max_value']?>" required>
         </div>
...
<div class="form-group form-group-sm">
           ...
           <div class="col-sm-1 text-center">
            ...
            <div class="col-sm-1 text-center">
              ...
              <select  class="form-control" id="cf_to_perspiration_alkali_staining_tolerance_range_math_op" name="cf_to_perspiration_alkali_staining_tolerance_range_math_op" onchange="cf_to_perspiration_alkali_staining_cal()">
                 <option value="">Select CF To Perspiration Alkali Color Change Range Math Operator</option>
                 <?php
                                 $cf_to_perspiration_alkali_staining_tolerance_range_math_op = $row_for_model_washing['cf_to_perspiration_alkali_staining_tolerance_range_math_op'];
           ...
           <div class="col-sm-1 text-center">
                 <select  class="form-control" id="cf_to_perspiration_alkali_staining_tolerance_value" name="cf_to_perspiration_alkali_staining_tolerance_value" onchange="cf_to_perspiration_alkali_staining_cal()">
                       <option value="">Select Tolerance Value</option>
                       <?php
                                 $cf_to_perspiration_alkali_staining_tolerance_value = $row_for_model_washing['cf_to_perspiration_alkali_staining_tolerance_value'];
         ...
         <div class="col-sm-1 text-center" for="min_value">
             ...
             <input type="text" class="form-control" id="cf_to_perspiration_alkali_staining_min_value" name="cf_to_perspiration_alkali_staining_min_value" value="<?php echo $row_for_model_washing['cf_to_perspiration_alkali_staining_min_value']?>" required>
         ...
         <div class="col-sm-1 text-center">
             ...
             <input type="text" class="form-control" id="cf_to_perspiration_alkali_staining_max_value" name="cf_to_perspiration_alkali_staining_max_value" value="<?php echo $row_for_model_washing['cf_to_perspiration_alkali_staining_max_value']?>" required>
         </div>
...
<div class="form-group form-group-sm">
           ...
           <div class="col-sm-2 text-center">
            ...
            <div class="col-sm-1 text-center">
              ...
              <select  class="form-control" id="cf_to_perspiration_alkali_cross_staining_tolerance_range_math_op" name="cf_to_perspiration_alkali_cross_staining_tolerance_range_math_op" onchange="cf_to_perspiration_alkali_cross_staining_cal()">
                 <option value="">Select CF To Perspiration Alkali Color Change Range Math Operator</option>
                 <?php
                                 $cf_to_perspiration_alkali_cross_staining_tolerance_range_math_op = $row_for_model_washing['cf_to_perspiration_alkali_cross_staining_tolerance_range_math_op'];
           ...
           <div class="col-sm-1 text-center">
                 <select  class="form-control" id="cf_to_perspiration_alkali_cross_staining_tolerance_value" name="cf_to_perspiration_alkali_cross_staining_tolerance_value" onchange="cf_to_perspiration_alkali_cross_staining_cal()">
                       <option value="">Select Tolerance Value</option>
                       <?php
                                 $cf_to_perspiration_alkali_cross_staining_tolerance_value = $row_for_model_washing['cf_to_perspiration_alkali_cross_staining_tolerance_value'];
         ...
         <div class="col-sm-1 text-center" for="min_value">
             ...
             <input type="text" class="form-control" id="cf_to_perspiration_alkali_cross_staining_min_value" name="cf_to_perspiration_alkali_cross_staining_min_value"  value="<?php echo $row_for_model_washing['cf_to_perspiration_alkali_cross_staining_min_value']?>"  required>
         ...
         <div class="col-sm-1 text-center">
             ...
             <input type="text" class="form-control" id="cf_to_perspiration_alkali_cross_staining_max_value" name="cf_to_perspiration_alkali_cross_staining_max_value"  value="<?php echo $row_for_model_washing['cf_to_perspiration_alkali_cross_staining_max_value']?>"  required>
         </div>
...
<div class="form-group form-group-sm">
           ...
           <div class="col-sm-1 text-center">
            ...
            <div class="col-sm-1 text-center">
              ...
              <select  class="form-control" id="cf_to_water_color_change_tolerance_range_math_operator" name="cf_to_water_color_change_tolerance_range_math_operator" onchange="cf_to_water_color_change_cal()">
                 ...
                 <?php
                                 $cf_to_water_color_change_tolerance_range_math_operator = $row_for_model_washing['cf_to_water_color_change_tolerance_range_math_operator'];
           ...
           <div class="col-sm-1 text-center">
                 <select  class="form-control" id="cf_to_water_color_change_tolerance_value" name="cf_to_water_color_change_tolerance_value" onchange="cf_to_water_color_change_cal()">
                   <option value="">Select Tolerance Value</option>
                   <?php
                                 $cf_to_water_color_change_tolerance_value = $row_for_model_washing['cf_to_water_color_change_tolerance_value'];
         ...
         <div class="col-sm-1 text-center" for="min_value">
              ...
              <input type="text" class="form-control" id="cf_to_water_color_change_min_value" name="cf_to_water_color_change_min_value" value="<?php echo $row_for_model_washing['cf_to_water_color_change_min_value']?>"  required>
            
         </div>
             
         <div class="col-sm-1 text-center">
             
               <input type="text" class="form-control" id="cf_to_water_color_change_max_value" name="cf_to_water_color_change_max_value" value="<?php echo $row_for_model_washing['cf_to_water_color_change_max_value']?>"  required>
         </div>
...
<div class="form-group form-group-sm">
           ...
           <div class="col-sm-2 text-center">
            ...
            <div class="col-sm-1 text-center">
              ...
              <select  class="form-control" id="cf_to_water_staining_tolerance_range_math_operator" name="cf_to_water_staining_tolerance_range_math_operator" onchange="cf_to_water_staining_cal()">
                 <option value="">Select CF To Water Color Change Range Math Operator</option>
                 <?php
                                 $cf_to_water_staining_tolerance_range_math_operator = $row_for_model_washing['cf_to_water_staining_tolerance_range_math_operator'];
           ...
           <div class="col-sm-1 text-center">
                 <select  class="form-control" id="cf_to_water_staining_tolerance_value" name="cf_to_water_staining_tolerance_value" onchange="cf_to_water_staining_cal()">
                   <option value="">Select Tolerance Value</option>
                   <?php
                                 $cf_to_water_staining_tolerance_value = $row_for_model_washing['cf_to_water_staining_tolerance_value'];
         ...
         <div class="col-sm-1 text-center" for="min_value">
              ...
              <input type="text" class="form-control" id="cf_to_water_staining_min_value" name="cf_to_water_staining_min_value" value="<?php echo $row_for_model_washing['cf_to_water_staining_min_value']?>" required>
            
         </div>
             
         <div class="col-sm-1 text-center">
             
               <input type="text" class="form-control" id="cf_to_water_staining_max_value" name="cf_to_water_staining_max_value" value="<?php echo $row_for_model_washing['cf_to_water_staining_max_value']?>" required>
         </div>
...
<div class="form-group form-group-sm">
           ...
           <div class="col-sm-2 text-center">
            ...
            <div class="col-sm-1 text-center">
              ...
              <select  class="form-control" id="cf_to_water_cross_staining_tolerance_range_math_operator" name="cf_to_water_cross_staining_tolerance_range_math_operator" onchange="cf_to_water_cross_staining_cal()">
                 <option value="">Select CF To Water Color Change Range Math Operator</option>
                 <?php
                                 $cf_to_water_cross_staining_tolerance_range_math_operator = $row_for_model_washing['cf_to_water_cross_staining_tolerance_range_math_operator'];
           ...
           <div class="col-sm-1 text-center">
                 <select  class="form-control" id="cf_to_water_cross_staining_tolerance_value" name="cf_to_water_cross_staining_tolerance_value" onchange="cf_to_water_cross_staining_cal()">
                   <option value="">Select Tolerance Value</option>
                   <?php
                                 $cf_to_water_cross_staining_tolerance_value = $row_for_model_washing['cf_to_water_cross_staining_tolerance_value'];
         ...
         <div class="col-sm-1 text-center" for="min_value">
              ...
              <input type="text" class="form-control" id="cf_to_water_cross_staining_min_value" name="cf_to_water_cross_staining_min_value" value="<?php echo $row_for_model_washing['cf_to_water_cross_staining_min_value']?>" required>
            
         </div>
             
         <div class="col-sm-1 text-center">
             
               <input type="text" class="form-control" id="cf_to_water_cross_staining_max_value" name="cf_to_water_cross_staining_max_value" value="<?php echo $row_for_model_washing['cf_to_water_cross_staining_max_value']?>" required>
         </div>
...
<div class="form-group form-group-sm">
           ...
           <div class="col-sm-1 text-center">
            ...
            <div class="col-sm-1 text-center">
              ...
              <select  class="form-control" id="cf_to_water_spotting_surface_tolerance_range_math_op" name="cf_to_water_spotting_surface_tolerance_range_math_op" onchange="cf_to_water_spotting_surface_cal()">
                 ...
                 <?php
                                 $cf_to_water_spotting_surface_tolerance_range_math_op = $row_for_model_washing['cf_to_water_spotting_surface_tolerance_range_math_op'];
           ...
           <div class="col-sm-1 text-center">
                 <select  class="form-control" id="cf_to_water_spotting_surface_tolerance_value" name="cf_to_water_spotting_surface_tolerance_value" onchange="cf_to_water_spotting_surface_cal()">
                   <option value="">Select Tolerance Value</option>
                   <?php
                                 $cf_to_water_spotting_surface_tolerance_value = $row_for_model_washing['cf_to_water_spotting_surface_tolerance_value'];
         ...
         <div class="col-sm-1 text-center" for="min_value">
              ...
              <input type="text" class="form-control" id="cf_to_water_spotting_surface_min_value" name="cf_to_water_spotting_surface_min_value" value="<?php echo $row_for_model_washing['cf_to_water_spotting_surface_min_value']?>" required>
            
         </div>
             
         <div class="col-sm-1 text-center">
             
               <input type="text" class="form-control" id="cf_to_water_spotting_surface_max_value" name="cf_to_water_spotting_surface_max_value" value="<?php echo $row_for_model_washing['cf_to_water_spotting_surface_max_value']?>" required>
         </div>
 ...
 <div class="form-group form-group-sm">
           ...
           <div class="col-sm-2 text-center">
            ...
            <div class="col-sm-1 text-center">
              ...
              <select  class="form-control" id="cf_to_water_spotting_edge_tolerance_range_math_op" name="cf_to_water_spotting_edge_tolerance_range_math_op" onchange="cf_to_water_spotting_edge_cal()">
                 <option value="">Select Math Operator</option>
                 <?php
                                 $cf_to_water_spotting_edge_tolerance_range_math_op = $row_for_model_washing['cf_to_water_spotting_edge_tolerance_range_math_op'];
           ...
           <div class="col-sm-1 text-center">
                 <select  class="form-control" id="cf_to_water_spotting_edge_tolerance_value" name="cf_to_water_spotting_edge_tolerance_value" onchange="cf_to_water_spotting_edge_cal()">
                   <option value="">Select Tolerance Value</option>
                   <?php
                                 $cf_to_water_spotting_edge_tolerance_value = $row_for_model_washing['cf_to_water_spotting_edge_tolerance_value'];
         ...
         <div class="col-sm-1 text-center" for="min_value">
              ...
              <input type="text" class="form-control" id="cf_to_water_spotting_edge_min_value" name="cf_to_water_spotting_edge_min_value" value="<?php echo $row_for_model_washing['cf_to_water_spotting_edge_min_value']?>" required>
            
         </div>
             
         <div class="col-sm-1 text-center">
             
               <input type="text" class="form-control" id="cf_to_water_spotting_edge_max_value" name="cf_to_water_spotting_edge_max_value" value="<?php echo $row_for_model_washing['cf_to_water_spotting_edge_max_value']?>" required>
         </div>
...
<div class="form-group form-group-sm">
           ...
           <div class="col-sm-2 text-center">
            ...
            <div class="col-sm-1 text-center">
              ...
              <select  class="form-control" id="cf_to_water_spotting_cross_staining_tolerance_range_math_op" name="cf_to_water_spotting_cross_staining_tolerance_range_math_op" onchange="cf_to_water_spotting_cross_staining_cal()">
                 <option value="">Select Math Operator</option>
                 <?php
                                 $cf_to_water_spotting_cross_staining_tolerance_range_math_op = $row_for_model_washing['cf_to_water_spotting_cross_staining_tolerance_range_math_op'];
           ...
           <div class="col-sm-1 text-center">
                 <select  class="form-control" id="cf_to_water_spotting_cross_staining_tolerance_value" name="cf_to_water_spotting_cross_staining_tolerance_value" onchange="cf_to_water_spotting_cross_staining_cal()">
                   <option value="">Select Tolerance Value</option>
                   <?php
                                 $cf_to_water_spotting_cross_staining_tolerance_value = $row_for_model_washing['cf_to_water_spotting_cross_staining_tolerance_value'];
         ...
         <div class="col-sm-1 text-center" for="min_value">
              ...
              <input type="text" class="form-control" id="cf_to_water_spotting_cross_staining_min_value" name="cf_to_water_spotting_cross_staining_min_value" value="<?php echo $row_for_model_washing['cf_to_water_spotting_cross_staining_min_value']?>" required>
            
         </div>
             
         <div class="col-sm-1 text-center">
             
               <input type="text" class="form-control" id="cf_to_water_spotting_cross_staining_max_value" name="cf_to_water_spotting_cross_staining_max_value" value="<?php echo $row_for_model_washing['cf_to_water_spotting_cross_staining_max_value']?>" required>
         </div>
 ...
 <div class="form-group form-group-sm">
           ...
           <div class="col-sm-2 text-center">
            ...
            <div class="col-sm-1 text-center">
              ...
              <select  class="form-control" id="cf_to_hydrolysis_of_reactive_dyes_color_change_tol_rang_mat_op" name="cf_to_hydrolysis_of_reactive_dyes_color_change_tol_rang_mat_op" onchange="cf_to_hydrolysis_of_reactive_dyes_color_change_cal()">
                 <option value="">Select Math Operator</option>
                 <?php
                                 $cf_to_hydrolysis_of_reactive_dyes_color_change_tol_rang_mat_op = $row_for_model_washing['cf_to_hydrolysis_of_reactive_dyes_color_change_tol_rang_mat_op'];
           ...
           <div class="col-sm-1 text-center">
                 <select  class="form-control" id="cf_to_hydrolysis_of_reactive_dyes_color_change_tolerance_value" name="cf_to_hydrolysis_of_reactive_dyes_color_change_tolerance_value" onchange="cf_to_hydrolysis_of_reactive_dyes_color_change_cal()">
                   <option value="">Select Tolerance Value</option>
                   <?php
                                 $cf_to_hydrolysis_of_reactive_dyes_color_change_tolerance_value = $row_for_model_washing['cf_to_hydrolysis_of_reactive_dyes_color_change_tolerance_value'];
         ...
         <div class="col-sm-1 text-center" for="min_value">
              ...
              <input type="text" class="form-control" id="cf_to_hydrolysis_of_reactive_dyes_color_change_min_value" name="cf_to_hydrolysis_of_reactive_dyes_color_change_min_value" value="<?php echo $row_for_model_washing['cf_to_hydrolysis_of_reactive_dyes_color_change_min_value']?>" required>
            
         </div>
             
         <div class="col-sm-1 text-center">
             
               <input type="text" class="form-control" id="cf_to_hydrolysis_of_reactive_dyes_color_change_max_value" name="cf_to_hydrolysis_of_reactive_dyes_color_change_max_value" value="<?php echo $row_for_model_washing['cf_to_hydrolysis_of_reactive_dyes_color_change_max_value']?>" required>
         </div>
...
<div class="form-group form-group-sm">
           ...
           <select  class="form-control" id="cf_to_oxidative_bleach_damage_color_change_tol_range_math_op" name="cf_to_oxidative_bleach_damage_color_change_tol_range_math_op" onchange="cf_to_oxidative_bleach_damage_color_change_cal()">
                 ...
                 <?php
                                 $cf_to_oxidative_bleach_damage_color_change_tol_range_math_op = $row_for_model_washing['cf_to_oxidative_bleach_damage_color_change_tol_range_math_op'];
           ...
           <div class="col-sm-1 text-center">
                 <select  class="form-control" id="cf_to_oxidative_bleach_damage_color_change_tolerance_value" name="cf_to_oxidative_bleach_damage_color_change_tolerance_value" onchange="cf_to_oxidative_bleach_damage_color_change_cal()">
                   <option value="">Select Tolerance Value</option>
                   <?php
                                 $cf_to_oxidative_bleach_damage_color_change_tolerance_value = $row_for_model_washing['cf_to_oxidative_bleach_damage_color_change_tolerance_value'];
         ...
         <div class="col-sm-1 text-center" for="min_value">
             ...
             <input type="text" class="form-control" id="cf_to_oxidative_bleach_damage_color_change_min_value" name="cf_to_oxidative_bleach_damage_color_change_min_value" value="<?php echo $row_for_model_washing['cf_to_oxidative_bleach_damage_color_change_min_value']?>" required>
            
         </div>
             
         <div class="col-sm-1 text-center">
             
               <input type="text" class="form-control" id="cf_to_oxidative_bleach_damage_color_change_max_value" name="cf_to_oxidative_bleach_damage_color_change_max_value" value="<?php echo $row_for_model_washing['cf_to_oxidative_bleach_damage_color_change_max_value']?>" required>
         </div>
   ...
   <div class="form-group form-group-sm">
           ...
           <div class="col-sm-1 text-center">
               <select  class="form-control" id="cf_to_phenolic_yellowing_staining_tolerance_range_math_operator" name="cf_to_phenolic_yellowing_staining_tolerance_range_math_operator" onchange="cf_to_phenolic_yellowing_staining_cal()">
                     ...
                     <?php
                                 $cf_to_phenolic_yellowing_staining_tolerance_range_math_operator = $row_for_model_washing['cf_to_phenolic_yellowing_staining_tolerance_range_math_operator'];
           ...
           <div class="col-sm-1 text-center">
            <select  class="form-control" id="cf_to_phenolic_yellowing_staining_tolerance_value" name="cf_to_phenolic_yellowing_staining_tolerance_value" onchange="cf_to_phenolic_yellowing_staining_cal()">
                       <option value="">Select Tolerance Value</option>
                       <?php
                                 $cf_to_phenolic_yellowing_staining_tolerance_value = $row_for_model_washing['cf_to_phenolic_yellowing_staining_tolerance_value'];
         ...
         <div class="col-sm-1 text-center" for="min_value">
            ...
            <input type="text" class="form-control" id="cf_to_phenolic_yellowing_staining_min_value" name="cf_to_phenolic_yellowing_staining_min_value" value="<?php echo $row_for_model_washing['cf_to_phenolic_yellowing_staining_min_value']?>" required>
            
         </div>
             
         <div class="col-sm-1 text-center">
             
               <input type="text" class="form-control" id="cf_to_phenolic_yellowing_staining_max_value" name="cf_to_phenolic_yellowing_staining_max_value" value="<?php echo $row_for_model_washing['cf_to_phenolic_yellowing_staining_max_value']?>" required>
         </div>
           ...
           <div class="col-sm-2 text-center">
               ...
               <div class="col-sm-1 text-center">
                   <select  class="form-control" id="cf_to_pvc_migration_staining_tolerance_range_math_operator" name="cf_to_pvc_migration_staining_tolerance_range_math_operator" onchange="cf_to_pvc_migration_staining_cal()">
                    ...
                    <?php
                                 $cf_to_pvc_migration_staining_tolerance_range_math_operator = $row_for_model_washing['cf_to_pvc_migration_staining_tolerance_range_math_operator'];
               ...
               <div class="col-sm-1 text-center">
                <select  class="form-control" id="cf_to_pvc_migration_staining_tolerance_value" name="cf_to_pvc_migration_staining_tolerance_value" onchange="cf_to_pvc_migration_staining_cal()">
                     <option value="">Select Tolerance Value</option>
                     <?php
                                 $cf_to_pvc_migration_staining_tolerance_value = $row_for_model_washing['cf_to_pvc_migration_staining_tolerance_value'];
             ...
             <div class="col-sm-1 text-center" for="min_value">
                ...
                <input type="text" class="form-control" id="cf_to_pvc_migration_staining_min_value" name="cf_to_pvc_migration_staining_min_value" value="<?php echo $row_for_model_washing['cf_to_pvc_migration_staining_min_value']?>" required>
                
             </div>
                 
             <div class="col-sm-1 text-center">
                 
                  <input type="text" class="form-control" id="cf_to_pvc_migration_staining_max_value" name="cf_to_pvc_migration_staining_max_value" value="<?php echo $row_for_model_washing['cf_to_pvc_migration_staining_max_value']?>" required>
             </div>
    ...
    <div class="form-group form-group-sm" >
           ...
           <div class="col-sm-1 text-center">
                <select  class="form-control" id="cf_to_saliva_color_change_tolerance_range_math_operator" name="cf_to_saliva_color_change_tolerance_range_math_operator" onchange="cf_to_saliva_color_change_cal()">
                 ...
                 <?php
                                 $cf_to_saliva_color_change_tolerance_range_math_operator = $row_for_model_washing['cf_to_saliva_color_change_tolerance_range_math_operator'];
           ...
           <div class="col-sm-1 text-center">
              <select  class="form-control" id="cf_to_saliva_color_change_tolerance_value" name="cf_to_saliva_color_change_tolerance_value" onchange="cf_to_saliva_color_change_cal()">
                 <option value="">Select Tolerance Value</option>
                 <?php
                                 $cf_to_saliva_color_change_tolerance_value = $row_for_model_washing['cf_to_saliva_color_change_tolerance_value'];
         ...
         <div class="col-sm-1 text-center" for="min_value">
            <input type="text" class="form-control" id="cf_to_saliva_color_change_staining_min_value" name="cf_to_saliva_color_change_staining_min_value" value="<?php echo $row_for_model_washing['cf_to_saliva_color_change_staining_min_value']?>" required>
            
         </div>
             
         <div class="col-sm-1 text-center">
             
               <input type="text" class="form-control" id="cf_to_saliva_color_change_max_value" name="cf_to_saliva_color_change_max_value" value="<?php echo $row_for_model_washing['cf_to_saliva_color_change_max_value']?>" required>
         </div>
    ...
    <div class="form-group form-group-sm">
           ...
           <div class="col-sm-1 text-center">
                <select  class="form-control" id="cf_to_saliva_staining_tolerance_range_math_operator" name="cf_to_saliva_staining_tolerance_range_math_operator" onchange="cf_to_saliva_staining_cal()">
                 <option value="">Select CF To Saliva Staining Math Operator</option>
                 <?php
                                 $cf_to_saliva_staining_tolerance_range_math_operator = $row_for_model_washing['cf_to_saliva_staining_tolerance_range_math_operator'];
           ...
           <div class="col-sm-1 text-center">
              <select  class="form-control" id="cf_to_saliva_staining_tolerance_value" name="cf_to_saliva_staining_tolerance_value" onchange="cf_to_saliva_staining_cal()">
                 <option value="">Select Tolerance Value</option>
                 <?php
                                 $cf_to_saliva_staining_tolerance_value = $row_for_model_washing['cf_to_saliva_staining_tolerance_value'];
         ...
         <div class="col-sm-1 text-center" for="min_value">
            <input type="text" class="form-control" id="cf_to_saliva_staining_staining_min_value" name="cf_to_saliva_staining_staining_min_value" value="<?php echo $row_for_model_washing['cf_to_saliva_staining_staining_min_value']?>" required>
            
         </div>
             
         <div class="col-sm-1 text-center">
             
               <input type="text" class="form-control" id="cf_to_saliva_staining_max_value" name="cf_to_saliva_staining_max_value" value="<?php echo $row_for_model_washing['cf_to_saliva_staining_max_value']?>" required>
         </div>
...
<div class="form-group form-group-sm" id="div_cf_to_chlorinated_water" style="display: none">
           ...
           <div class="col-sm-2 text-center">
            ...
            <div class="col-sm-1 text-center">
                  ...
                  <select  class="form-control" id="cf_to_chlorinated_water_color_change_tolerance_range_math_op" name="cf_to_chlorinated_water_color_change_tolerance_range_math_op" onchange="cf_to_chlorinated_water_color_change_cal()">
                       ...
                       <?php
                                 $cf_to_chlorinated_water_color_change_tolerance_range_math_op = $row_for_model_washing['cf_to_chlorinated_water_color_change_tolerance_range_math_op'];
           ...
           <div class="col-sm-1 text-center">
                  <select  class="form-control" id="cf_to_chlorinated_water_color_change_tolerance_value" name="cf_to_chlorinated_water_color_change_tolerance_value" onchange="cf_to_chlorinated_water_color_change_cal()">
                     <option value="">Select Tolerance Value</option>
                     <?php
                                 $cf_to_chlorinated_water_color_change_tolerance_value = $row_for_model_washing['cf_to_chlorinated_water_color_change_tolerance_value'];
         ...
         <div class="col-sm-1 text-center" for="min_value">
                ...
                <input type="text" class="form-control" id="cf_to_chlorinated_water_color_change_min_value" name="cf_to_chlorinated_water_color_change_min_value" value="<?php echo $row_for_model_washing['cf_to_chlorinated_water_color_change_min_value']?>" required>
            
         </div>
             
         <div class="col-sm-1 text-center">
             
                <input type="text" class="form-control" id="cf_to_chlorinated_water_color_change_max_value" name="cf_to_chlorinated_water_color_change_max_value" value="<?php echo $row_for_model_washing['cf_to_chlorinated_water_color_change_max_value']?>" required>
         </div>
...
<div class="form-group form-group-sm" id="div_cf_to_chlorine_bleach" style="display: none">
           ...
           <div class="col-sm-2 text-center">
            ...
            <div class="col-sm-1 text-center">
                  ...
                  <select  class="form-control" id="cf_to_cholorine_bleach_color_change_tolerance_range_math_op" name="cf_to_cholorine_bleach_color_change_tolerance_range_math_op" onchange="cf_to_cholorine_bleach_color_change_cal()">
                     ...
                     <?php
                                 $cf_to_cholorine_bleach_color_change_tolerance_range_math_op = $row_for_model_washing['cf_to_cholorine_bleach_color_change_tolerance_range_math_op'];
           ...
           <div class="col-sm-1 text-center">
                   <select  class="form-control" id="cf_to_cholorine_bleach_color_change_tolerance_value" name="cf_to_cholorine_bleach_color_change_tolerance_value" onchange="cf_to_cholorine_bleach_color_change_cal()">
                       <option value="">Select Tolerance Value</option>
                       <?php
                                 $cf_to_cholorine_bleach_color_change_tolerance_value = $row_for_model_washing['cf_to_cholorine_bleach_color_change_tolerance_value'];
         ...
         <div class="col-sm-1 text-center" for="min_value">
           <input type="text" class="form-control" id="cf_to_cholorine_bleach_color_change_min_value" name="cf_to_cholorine_bleach_color_change_min_value" value="<?php echo $row_for_model_washing['cf_to_cholorine_bleach_color_change_min_value']?>" required>
            
         </div>
             
         <div class="col-sm-1 text-center">
             
                 <input type="text" class="form-control" id="cf_to_cholorine_bleach_color_change_max_value" name="cf_to_cholorine_bleach_color_change_max_value" value="<?php echo $row_for_model_washing['cf_to_cholorine_bleach_color_change_max_value']?>" required>
         </div>
...
<div class="form-group form-group-sm" id="div_cf_to_peroxide_bleach" style="display: none">
           ...
           <div class="col-sm-2 text-center">
            ...
            <div class="col-sm-1 text-center">
                  ...
                  <select  class="form-control" id="cf_to_peroxide_bleach_color_change_tolerance_range_math_operator" name="cf_to_peroxide_bleach_color_change_tolerance_range_math_operator" onchange="cf_to_peroxide_bleach_cal()">
                     ...
                     <?php
                                 $cf_to_peroxide_bleach_color_change_tolerance_range_math_operator = $row_for_model_washing['cf_to_peroxide_bleach_color_change_tolerance_range_math_operator'];
           ...
           <div class="col-sm-1 text-center">
                    <select  class="form-control" id="cf_to_peroxide_bleach_color_change_tolerance_value" name="cf_to_peroxide_bleach_color_change_tolerance_value" onchange="cf_to_peroxide_bleach_cal()">
                       <option value="">Select Tolerance Value</option>
                       <?php
                                 $cf_to_peroxide_bleach_color_change_tolerance_value = $row_for_model_washing['cf_to_peroxide_bleach_color_change_tolerance_value'];
         ...
         <div class="col-sm-1 text-center" for="min_value">
           <input type="text" class="form-control" id="cf_to_peroxide_bleach_color_change_min_value" name="cf_to_peroxide_bleach_color_change_min_value" value="<?php echo $row_for_model_washing['cf_to_peroxide_bleach_color_change_min_value']?>" required>
            
         </div>
             
         <div class="col-sm-1 text-center">
             
                  <input type="text" class="form-control" id="cf_to_peroxide_bleach_color_change_max_value" name="cf_to_peroxide_bleach_color_change_max_value" value="<?php echo $row_for_model_washing['cf_to_peroxide_bleach_color_change_max_value']?>" required>
         </div>
 ...
 <div class="form-group form-group-sm" id="div_cross_staining" style="display: none">
           ...
           <div class="col-sm-1 text-center">
            ...
            <div class="col-sm-1 text-center">
                 ...
                 <select  class="form-control" id="cross_staining_tolerance_range_math_operator" name="cross_staining_tolerance_range_math_operator" onchange="cross_staining_cal()">
                   ...
                   <?php
                                 $cross_staining_tolerance_range_math_operator = $row_for_model_washing['cross_staining_tolerance_range_math_operator'];
           ...
           <div class="col-sm-1 text-center">
                  <select  class="form-control" id="cross_staining_tolerance_value" name="cross_staining_tolerance_value" onchange="cross_staining_cal()">
                       <option value="">Select Tolerance Value</option>
                       <?php
                                 $cross_staining_tolerance_value = $row_for_model_washing['cross_staining_tolerance_value'];
         ...
         <div class="col-sm-1 text-center" for="min_value">
            <input type="text" class="form-control" id="cross_staining_min_value" name="cross_staining_min_value" value="<?php echo $row_for_model_washing['cross_staining_min_value']?>" required>
            
         </div>
             
         <div class="col-sm-1 text-center">
             
                  <input type="text" class="form-control" id="cross_staining_max_value" name="cross_staining_max_value" value="<?php echo $row_for_model_washing['cross_staining_max_value']?>" required>
         </div>
...
-->
         ...
         <div class="col-sm-1 text-center" for="min_value">
             <input type="text" class="form-control" id="ph_value_min_value" name="ph_value_min_value" value="<?php echo $row_for_model_washing['ph_value_min_value']?>" required>
            
         </div>
             
         <div class="col-sm-1 text-center">
             <input type="text" class="form-control" id="ph_value_max_value" name="ph_value_max_value" value="<?php echo $row_for_model_washing['ph_value_max_value']?>" required>
         </div>
...
<!-- *********************************** Designing Tabular Formar (Multi-Column Form Elements Here (End))*********************************** -->
						...
						<div class="form-group form-group-sm">
								<div class="col-sm-offset-3 col-sm-5">
									<button type="button" class="btn btn-primary" onClick="sending_data_of_edit_defining_qc_standard_for_model_washing_process_form_for_saving_in_database()">Edit</button>
