   ...
   function sending_data_of_defining_qc_standard_for_dyeing_finish_process_form_for_saving_in_database()
    {
        var url_encoded_form_data = $("#defining_qc_standard_for_dyeing_finish_process_form").serialize(); //This will read all control elements value of the form	
            ...
            $.ajax({
                url: 'auto_sync//model_defining_qc_standard_for_dyeing_finish_process_saving.php',
                dataType: 'text',
                type: 'post',
                contentType: 'application/x-www-form-urlencoded',
                data: url_encoded_form_data,
...
function searching_data_from_model_db()
{
   ...
   if(validate != false)
   {
        ...
        //alert(process_serial);
        var process_technique_name = document.getElementById('process_technique_name').value;
         // alert(process_name);

         //given process list start

         $.ajax({
               url: 'auto_sync/returning_customer_version_wise_process_list.php',
               dataType: 'text',
               type: 'GET',
               contentType: 'application/x-www-form-urlencoded',
               data: url_encoded_form_data,
               ...
               {
                  //alert(data);
                  document.getElementById('customer_process_wise_list_show').innerHTML = data;
               },
               error: function( jqXhr, textStatus, errorThrown )
               {
                   //console.log( errorThrown );
         ...
         {
            $.ajax({
               url: 'process_program/defining_qc_standard_for_dyeing_finish_process.php',
               dataType: 'text',
               type: 'get',
               contentType: 'application/x-www-form-urlencoded',
               data: url_encoded_form_data,
	...
	<div class="panel panel-default"> 
      ...
      <div id='search_form_collpapsible_div' class="collapse in"> <!-- For Making Collapsible Section -->
         <form class="form-horizontal" action="" style="margin-top:10px;" name="auto_sync_info_form" id="auto_sync_info_form">
            ...
            <input type="hidden" class="form-control" id="color" name="color" value="color" required>
...
<div class="container-fluid">
   <div id="customer_process_wise_list_show">
