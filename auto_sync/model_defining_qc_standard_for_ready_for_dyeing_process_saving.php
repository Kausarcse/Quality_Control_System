...
$select_sql_for_duplicacy="select * from `model_defining_qc_standard_for_ready_for_dying_process` where `customer_id`='$customer_id' and `customer_name`='$customer_name' and `version_number`='$version_number' and `color`='$color_name' and `process_name`='$process_name' and `process_technique`='$process_technique_name' ";
...
else if( mysqli_num_rows($result) < 1)
{
	 ...
	 $insert_sql_for_define_model="insert into `model_defining_qc_standard_for_ready_for_dying_process`
	 ( 
	    `customer_id`,
        `customer_name`,
	    `version_number`,
